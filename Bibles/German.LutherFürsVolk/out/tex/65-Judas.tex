...
\footnote{\textbf{1:7} 1Mo 19,-1} \bibleverse{8} Desgleichen sind auch
diese Träumer, die das Fleisch beflecken, die Herrschaft aber verachten
und die Majestäten lästern. \bibleverse{9} Michael aber, der Erzengel,
...
\bibleverse{13} wilde Wellen des Meeres, die ihre eigene Schande
ausschäumen, irre Sterne, welchen behalten ist das Dunkel der Finsternis
in Ewigkeit. \footnote{\textbf{1:13} Jes 57,20} \bibleverse{14} Es hat
...
\footnote{\textbf{1:14} 1Mo 5,21} \bibleverse{15} Gericht zu halten über
...
gottlosen Sünder wider ihn geredet haben.`` \bibleverse{16} Diese murren
