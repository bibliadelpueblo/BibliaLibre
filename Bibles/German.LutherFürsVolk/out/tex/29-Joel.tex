...
hat Zähne wie Löwen und Backenzähne wie Löwinnen. \footnote{\textbf{1:6}
  Joe 2,2; Joe 2,25} \bibleverse{7} Das verwüstet meinen Weinberg und
streift meinen Feigenbaum ab, schält ihn und verwirft ihn, dass seine
Zweige weiß dastehen. \bibleverse{8} Heule wie eine Jungfrau, die einen
Sack anlegt um ihren Bräutigam! \bibleverse{9} Denn das Speisopfer und
Trankopfer ist vom Hause des \textsc{Herrn} weg, und die Priester, des
\textsc{Herrn} Diener, trauern. \bibleverse{10} Das Feld ist verwüstet,
und der Acker steht jämmerlich; das Getreide ist verdorben, der Wein
steht jämmerlich und das Öl kläglich. \bibleverse{11} Die Ackerleute
...
\bibleverse{12} So steht der Weinstock auch jämmerlich und der
...
zum Jammer geworden. \bibleverse{13} Begürtet euch und klaget, ihr
...
\bibleverse{14} Heiliget ein Fasten, rufet die Gemeinde zusammen;
...
\footnote{\textbf{2:2} Joe 1,6; 2Mo 10,14} \bibleverse{3} Vor ihm her
...
\bibleverse{4} Sie sind gestaltet wie Rosse und rennen wie die Reiter.
\bibleverse{5} Sie sprengen daher oben auf den Bergen, wie die Wagen
rasseln, und wie eine Flamme lodert im Stroh, wie ein mächtiges Volk,
das zum Streit gerüstet ist. \bibleverse{6} Die Völker werden sich vor
ihm entsetzen, aller Angesichter werden bleich. \bibleverse{7} Sie
...
\bibleverse{8} Keiner wird den anderen irren; sondern ein jeglicher wird
in seiner Ordnung daherfahren und werden durch die Waffen brechen und
nicht verwundet werden. \bibleverse{9} Sie werden in der Stadt
umherrennen, auf der Mauer laufen und in die Häuser steigen und wie ein
Dieb durch die Fenster hineinkommen. \bibleverse{10} Vor ihm erzittert
...
Sterne verhalten ihren Schein. \footnote{\textbf{2:10} Joe 3,4; Jes
  13,10} \bibleverse{11} Denn der \textsc{Herr} wird seinen Donner vor
...
groß und sehr erschrecklich: wer kann ihn leiden? \footnote{\textbf{2:11}
  Joe 2,25} \bibleverse{12} Doch spricht auch jetzt der \textsc{Herr}:
Bekehret euch zu mir von ganzem Herzen mit Fasten, mit Weinen, mit
Klagen! \footnote{\textbf{2:12} Hes 33,11} \bibleverse{13} Zerreißet
...
von großer Güte, und ihn reut bald der Strafe. \footnote{\textbf{2:13}
  2Mo 34,6} \bibleverse{14} Wer weiß, es mag ihn wiederum gereuen, und
...
Trankopfer dem \textsc{Herrn}, eurem Gott. \footnote{\textbf{2:14} Jon
  3,9} \bibleverse{15} Blaset mit Posaunen zu Zion, heiliget ein Fasten,
...
ihr Gott? \footnote{\textbf{2:17} Ps 79,10} \bibleverse{18} So wird denn
der \textsc{Herr} um sein Land eifern und sein Volk verschonen.
\bibleverse{19} Und der \textsc{Herr} wird antworten und sagen zu seinem
...
den Heiden zu Schanden werden, \bibleverse{20} und will den von
...
Dinge getan. \footnote{\textbf{2:20} Joe 1,4; Joe 1,6} \bibleverse{21}
Fürchte dich nicht, liebes Land, sondern sei fröhlich und getrost; denn
der \textsc{Herr} kann auch große Dinge tun. \bibleverse{22} Fürchtet
...
Weinstöcke sollen wohl tragen. \bibleverse{23} Und ihr, Kinder Zions,
...
\bibleverse{27} Und ihr sollt erfahren, dass ich mitten unter Israel sei
und dass ich, der \textsc{Herr}, euer Gott sei und keiner mehr; und mein
Volk soll nicht mehr zu Schanden werden. \# 3 \bibleverse{1} Und nach
...
und eure Jünglinge sollen Gesichte sehen; \footnote{\textbf{3:1} 4Mo
  11,29; Jes 44,3; Hes 39,29; Apg 2,16-21; Tit 3,6} \bibleverse{2} auch
will ich zur selben Zeit über Knechte und Mägde meinen Geist ausgießen.
\bibleverse{3} Und ich will Wunderzeichen geben am Himmel und auf Erden:
Blut, Feuer und Rauchdampf; \bibleverse{4} die Sonne soll in Finsternis
und der Mond in Blut verwandelt werden, ehe denn der große und
schreckliche Tag des \textsc{Herrn} kommt. \bibleverse{5} Und es soll
...
das Gefängnis Judas und Jerusalems wenden werde, \^{}\^{} \bibleverse{2}
...
in mein Land geteilt \^{}\^{} \bibleverse{3} und das Los um mein Volk
geworfen haben; und haben die Knaben um Speise gegeben und die Mägdlein
um Wein verkauft und vertrunken. \^{}\^{} \bibleverse{4} Und ihr von
...
geredet. \bibleverse{9} Rufet dies aus unter den Heiden! Heiliget einen
...
laufen über; denn ihre Bosheit ist groß. \^{}\^{} \bibleverse{14} Es
...
Fremder mehr durch sie wandeln. \^{}\^{} \bibleverse{18} Zur selben Zeit
...
wässern. \^{}\^{} \bibleverse{19} Aber Ägypten soll wüst werden und Edom
eine wüste Einöde um den Frevel, an den Kindern Juda begangen, dass sie
unschuldig Blut in ihrem Lande vergossen haben. \^{}\^{} \bibleverse{20}
