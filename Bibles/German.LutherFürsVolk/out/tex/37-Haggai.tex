...
\footnote{\textbf{1:1} Esr 4,24; Esr 5,1-2} \bibleverse{2} So spricht
der \textsc{Herr} Zebaoth: Dieses Volk spricht: Die Zeit ist noch nicht
da, dass man des \textsc{Herrn} Haus baue.

\bibleverse{3} Und des \textsc{Herrn} Wort geschah durch den Propheten
...
Häusern wohnt, -- und dies Haus muss wüst stehen? \footnote{\textbf{1:4}
  2Sam 7,2} \bibleverse{5} Nun, so spricht der \textsc{Herr} Zebaoth:
Schauet, wie es euch geht! \bibleverse{6} Ihr säet viel, und bringet
...
Erdreich sein Gewächs. \footnote{\textbf{1:10} 1Kö 17,1} \bibleverse{11}
...
im zweiten Jahr des Königs Darius. \# 2 \bibleverse{1} Am
einundzwanzigsten Tage des siebenten Monats geschah des \textsc{Herrn}
Wort durch den Propheten Haggai und sprach: \bibleverse{2} Sage zu
...
der \textsc{Herr} Zebaoth. \bibleverse{5} Nach dem Wort, da ich mit euch
einen Bund machte, da ihr aus Ägypten zogt, soll mein Geist unter euch
bleiben. Fürchtet euch nicht! \bibleverse{6} Denn so spricht der
...
und Erde, das Meer und das Trockene bewegen werde. \footnote{\textbf{2:6}
  Hebr 12,26} \bibleverse{7} Ja, alle Heiden will ich bewegen. Da soll
...
fünfzig Eimer zu schöpfen, so waren kaum zwanzig da. \footnote{\textbf{2:16}
  Haggai 1,6} \bibleverse{17} Denn ich plagte euch mit Dürre, Brandkorn
