...
\bibleverse{7} von Juda sei Nahesson, der Sohn Amminadabs; \footnote{\textbf{1:7}
  2Mo 6,23}
...
\bibleverse{17} Und Mose und Aaron nahmen sie zu sich, wie sie da mit
Namen genannt sind, \bibleverse{18} und sammelten auch die ganze
...
\footnote{\textbf{1:50} 4Mo 4,-1; 4Mo 3,23-38} \bibleverse{51} Und wenn
...
Fremder sich dazumacht, der soll sterben. \footnote{\textbf{1:51} 4Mo
  3,10; 4Mo 3,38} \bibleverse{52} Die Kinder Israel sollen sich lagern,
ein jeglicher in sein Lager und zu dem Panier seiner Schar.
\bibleverse{53} Aber die Leviten sollen sich um die Wohnung des
...
dem Mose geboten hatte. \# 2 \bibleverse{1} Und der \textsc{Herr} redete
mit Mose und Aaron und sprach: \bibleverse{2} Die Kinder Israel sollen
...
der \textsc{Herr} mit Mose redete auf dem Berge Sinai. \footnote{\textbf{3:1}
  2Mo 6,23} \bibleverse{2} Und dies sind die Namen der Söhne Aarons: der
...
\bibleverse{7} und seiner und der ganzen Gemeinde Hut warten vor der
Hütte des Stifts und dienen am Dienst der Wohnung \bibleverse{8} und
warten alles Gerätes der Hütte des Stifts und der Hut der Kinder Israel,
zu dienen am Dienst der Wohnung. \bibleverse{9} Und sollst die Leviten
Aaron und seinen Söhnen zuordnen zum Geschenk von den Kindern Israel.
\bibleverse{10} Aaron aber und seine Söhne sollst du setzen, dass sie
...
und des Tuchs und was sonst zu ihrem Dienst gehört. \footnote{\textbf{3:31}
  4Mo 7,9} \bibleverse{32} Aber der Oberste über alle Obersten der
...
\textsc{Herrn}, seien. \footnote{\textbf{3:45} 4Mo 3,12} \bibleverse{46}
...
der \textsc{Herr} dem Mose geboten hatte. \# 4 \bibleverse{1} Und der
\textsc{Herr} redete mit Mose und Aaron und sprach: \bibleverse{2} Nimm
die Summe der Kinder Kahath aus den Kindern Levi nach ihren
Geschlechtern und Vaterhäusern, \bibleverse{3} von 30 Jahren an und
...
geboten hatte. \# 5 \bibleverse{1} Und der \textsc{Herr} redete mit Mose
und sprach: \bibleverse{2} Gebiete den Kindern Israel, dass sie aus dem
...
\bibleverse{3} Beide, Mann und Weib, sollt ihr hinaustun vor das Lager,
...
\footnote{\textbf{5:6} 3Mo 5,21-26} \bibleverse{7} und sie sollen ihre
...
an dem sie sich verschuldigt haben. \bibleverse{8} Ist aber niemand da,
...
\bibleverse{9} Desgleichen soll alle Hebe von allem, was die Kinder
Israel heiligen und dem Priester opfern, sein sein. \bibleverse{10} Und
...
\footnote{\textbf{5:17} 2Mo 30,18} \bibleverse{18} Und soll das Weib vor
...
seiner Hand bitteres verfluchtes Wasser haben \bibleverse{19} und soll
...
\bibleverse{20} Wo du aber deinem Mann untreu geworden bist, dass du
unrein wurdest, und hat jemand bei dir gelegen außer deinem Mann,
\bibleverse{21} so soll der Priester das Weib beschwören mit solchem
...
schwinden und deinen Bauch schwellen lasse! \bibleverse{22} So gehe nun
...
Missetat; aber das Weib soll ihre Missetat tragen. \# 6 \bibleverse{1}
Und der \textsc{Herr} redete mit Mose und sprach: \bibleverse{2} Sage
...
\bibleverse{3} der soll sich Weins und starken Getränks enthalten;
...
dürre Weinbeeren essen. \footnote{\textbf{6:3} Lk 1,15} \bibleverse{4}
...
seinem Haupt. \footnote{\textbf{6:7} 3Mo 21,11} \bibleverse{8} Die ganze
...
\footnote{\textbf{6:10} 3Mo 5,7} \bibleverse{11} Und der Priester soll
...
sein Haupt desselben Tages heiligen, \bibleverse{12} dass er dem
...
\textsc{Herr} segne dich und behüte dich; \footnote{\textbf{6:24} Ps
  121,-1} \bibleverse{25} der \textsc{Herr} lasse sein Angesicht
...
dass ich sie segne. \# 7 \bibleverse{1} Und da Mose die Wohnung
...
\bibleverse{2} da opferten die Fürsten Israels, die Häupter waren in
ihren Vaterhäusern; denn sie waren die Obersten unter den Stämmen und
standen obenan unter denen, die gezählt waren. \bibleverse{3} Und sie
...
einen, und brachten sie vor die Wohnung. \bibleverse{4} Und der
\textsc{Herr} sprach zu Mose: \bibleverse{5} Nimm's von ihnen, dass es
...
Aarons, des Priesters; \footnote{\textbf{7:8} 2Mo 38,21; 4Mo 4,28; 4Mo
  4,33} \bibleverse{9} den Kindern Kahath aber gab er nichts, darum dass
...
\bibleverse{19} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
...
\bibleverse{25} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{31} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{37} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{43} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{49} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{55} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{61} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{67} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{73} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{79} Seine Gabe war eine silberne Schüssel, 130 Lot schwer,
eine silberne Schale, 70 Lot schwer nach dem Lot des Heiligtums, beide
voll Semmelmehl, mit Öl gemengt, zum Speisopfer;
...
\bibleverse{86} Und der zwölf goldenen Löffel voll Räuchwerk hatte je
...
\bibleverse{88} Und die Summe der Rinder zum Dankopfer war 24 Farren, 60
...
ward mit ihm geredet. \# 8 \bibleverse{1} Und der \textsc{Herr} redete
mit Mose und sprach: \bibleverse{2} Rede mit Aaron und sprich zu ihm:
...
sieben vorwärts von dem Leuchter scheinen. \footnote{\textbf{8:2} 2Mo
  25,31-40} \bibleverse{3} Und Aaron tat also und setzte die Lampen auf,
vorwärts von dem Leuchter zu scheinen, wie der \textsc{Herr} dem Mose
geboten hatte. \bibleverse{4} Der Leuchter aber war getriebenes Gold,
...
rein abscheren und ihre Kleider waschen, so sind sie rein. \footnote{\textbf{8:7}
  4Mo 5,17; 4Mo 19,9; 4Mo 19,17; 3Mo 14,8} \bibleverse{8} Dann sollen
...
\bibleverse{9} Und sollst die Leviten vor die Hütte des Stifts bringen
und die ganze Gemeinde der Kinder Israel versammeln \bibleverse{10} und
die Leviten vor den \textsc{Herrn} bringen; und die Kinder Israel sollen
ihre Hände auf die Leviten legen, \bibleverse{11} und Aaron soll die
...
den Kindern Israel, dass sie mein seien. \footnote{\textbf{8:14} 4Mo
  3,45} \bibleverse{15} Darnach sollen sie hineingehen, dass sie dienen
in der Hütte des Stifts. Also sollst du sie reinigen und weben;
\bibleverse{16} denn sie sind mein Geschenk von den Kindern Israel, und
ich habe sie mir genommen für alles, was die Mutter bricht, nämlich für
die Erstgeburt aller Kinder Israel. \bibleverse{17} Denn alle Erstgeburt
...
\footnote{\textbf{8:17} 2Mo 13,2} \bibleverse{18} und nahm die Leviten
an für alle Erstgeburt unter den Kindern Israel \bibleverse{19} und gab
...
Plage, wenn sie sich nahen wollten zum Heiligtum. \bibleverse{20} Und
...
\bibleverse{21} Und die Leviten entsündigten sich und wuschen ihre
Kleider, und Aaron webte sie vor dem \textsc{Herrn} und versöhnte sie,
dass sie rein wurden. \footnote{\textbf{8:21} 4Mo 8,11} \bibleverse{22}
...
ein jeglicher seines Dienstes warte. \# 9 \bibleverse{1} Und der
...
\bibleverse{2} Lass die Kinder Israel Passah halten zu seiner Zeit,
\footnote{\textbf{9:2} 2Mo 12,3; 3Mo 23,5} \bibleverse{3} am 14. Tage
dieses Monats gegen Abend; zu seiner Zeit sollen sie es halten nach
aller seiner Satzung und seinem Recht. \bibleverse{4} Und Mose redete
mit den Kindern Israel, dass sie das Passah hielten. \bibleverse{5} Und
...
taten die Kinder Israel. \bibleverse{6} Da waren etliche Männer unrein
geworden an einem toten Menschen, dass sie nicht konnten Passah halten
des Tages. Die traten vor Mose und Aaron desselben Tages \bibleverse{7}
...
der \textsc{Herr} gebietet. \bibleverse{9} Und der \textsc{Herr} redete
mit Mose und sprach: \bibleverse{10} Sage den Kindern Israel und sprich:
...
halten, \bibleverse{11} aber im zweiten Monat, am 14. Tage gegen Abend,
...
hat zu seiner Zeit; er soll seine Sünde tragen. \bibleverse{14} Und wenn
...
an den Morgen war über der Wohnung eine Gestalt des Feuers. \footnote{\textbf{9:15}
  2Mo 40,34-38} \bibleverse{16} Also geschah's immerdar, dass die Wolke
sie bedeckte, und des Nachts die Gestalt des Feuers. \bibleverse{17} Und
...
10 \bibleverse{1} Und der \textsc{Herr} redete mit Mose und sprach:
...
drommeten. \bibleverse{8} Es sollen aber solch Blasen mit den Drommeten
die Söhne Aarons, die Priester, tun; und das soll euer Recht sein
ewiglich bei euren Nachkommen. \bibleverse{9} Wenn ihr in einen Streit
...
Gott. Ich bin der \textsc{Herr}, euer Gott. \footnote{\textbf{10:10} 3Mo
  23,24; 2Kö 11,14; 2Chr 7,6} \bibleverse{11} Am 20. Tage im zweiten
Monat des zweiten Jahres erhob sich die Wolke von der Wohnung des
Zeugnisses. \bibleverse{12} Und die Kinder Israel brachen auf und zogen
...
Heer des Stammes der Kinder Gad. \bibleverse{21} Da zogen auch die
Kahathiten und trugen das Heiligtum; und jene richteten die Wohnung auf,
bis diese nachkamen. \bibleverse{22} Darnach zog das Panier des Lagers
der Kinder Ephraim mit ihrem Heer, und über ihr Heer war Elisama, der
Sohn Ammihuds; \bibleverse{23} und Gamliel, der Sohn Pedazurs, über das
Heer des Stammes der Kinder Manasse; \bibleverse{24} und Abidan, der
...
mein Land zu meiner Freundschaft ziehen. \bibleverse{31} Er sprach:
Verlass uns doch nicht; denn du weißt, wo wir in der Wüste uns lagern
sollen, und sollst unser Auge sein. \bibleverse{32} Und wenn du mit uns
ziehst: was der \textsc{Herr} Gutes an uns tut, das wollen wir an dir
tun. \bibleverse{33} Also zogen sie von dem Berge des \textsc{Herrn}
...
zerstreut und die dich hassen, flüchtig werden vor dir! \footnote{\textbf{10:35}
  Ps 68,2; Ps 132,8} \bibleverse{36} Und wenn sie ruhte, so sprach er:
...
unter ihnen des \textsc{Herrn} Feuer angezündet hatte. \bibleverse{4}
...
essen geben? \footnote{\textbf{11:4} 2Mo 16,3} \bibleverse{5} Wir
gedenken der Fische, die wir in Ägypten umsonst aßen, und der Kürbisse,
der Melonen, des Lauchs, der Zwiebeln und des Knoblauchs. \bibleverse{6}
Nun aber ist unsere Seele matt; denn unsere Augen sehen nichts als das
Man. \bibleverse{7} Es war aber das Man wie Koriandersamen und anzusehen
wie Bedellion. \bibleverse{8} Und das Volk lief hin und her und sammelte
...
wie ein Ölkuchen. \bibleverse{9} Und wenn des Nachts der Tau über die
Lager fiel, so fiel das Man mit darauf. \bibleverse{10} Da nun Mose das
...
auch bange. \bibleverse{11} Und Mose sprach zu dem \textsc{Herrn}: Warum
...
\bibleverse{12} Habe ich nun all das Volk empfangen oder geboren, dass
du zu mir sagen magst: Trag es in deinen Armen, wie eine Amme ein Kind
trägt, in das Land, das du ihren Vätern geschworen hast? \bibleverse{13}
...
\bibleverse{14} Ich vermag alles das Volk nicht allein zu ertragen; denn
es ist mir zu schwer. \bibleverse{15} Und willst du also mit mir tun, so
...
dass ich nicht mein Unglück so sehen müsse. \footnote{\textbf{11:15} 2Mo
  32,32} \bibleverse{16} Und der \textsc{Herr} sprach zu Mose: Sammle
mir 70 Männer unter den Ältesten Israels, von denen du weißt, dass sie
...
Stifts und stelle sie daselbst vor dich, \footnote{\textbf{11:16} 2Mo
  18,21; 2Mo 24,1} \bibleverse{17} so will ich herniederkommen und mit
...
allein tragest. \bibleverse{18} Und zum Volk sollst du sagen: Heiliget
...
\textsc{Herr} Fleisch geben, dass ihr esset, \footnote{\textbf{11:18}
  2Mo 19,10} \bibleverse{19} nicht einen Tag, nicht zwei, nicht fünf,
nicht zehn, nicht zwanzig Tage lang, \bibleverse{20} sondern einen Monat
...
versammeln, dass es ihnen genug sei? \bibleverse{23} Der \textsc{Herr}
...
nicht. \footnote{\textbf{11:23} Jes 50,2; Jes 59,1} \bibleverse{24} Und
...
die Hütte her. \bibleverse{25} Da kam der \textsc{Herr} hernieder in der
...
weissagten sie und hörten nicht auf. \bibleverse{26} Es waren aber noch
...
\bibleverse{27} Da lief ein Knabe hin und sagte es Mose an und sprach:
...
Mose, wehre ihnen. \bibleverse{29} Aber Mose sprach zu ihm: Bist du der
Eiferer für mich? Wollte Gott, dass all das Volk des \textsc{Herrn}
weissagte und der \textsc{Herr} seinen Geist über sie gäbe! \footnote{\textbf{11:29}
  Mk 9,39; Joe 3,1} \bibleverse{30} Also sammelte sich Mose zum Lager
mit den Ältesten Israels. \bibleverse{31} Da fuhr aus der Wind von dem
...
her, zwei Ellen hoch über der Erde. \bibleverse{32} Da machte sich das
...
\bibleverse{33} Da aber das Fleisch noch unter ihren Zähnen war und ehe
es aufgezehrt war, da ergrimmte der Zorn des \textsc{Herrn} unter dem
Volk, und schlug sie mit einer sehr großen Plage. \bibleverse{34} Daher
heißt diese Stätte Lustgräber, darum dass man daselbst begrub das
lüsterne Volk. \footnote{\textbf{11:34} 1Kor 10,6} \bibleverse{35} Von
den Lustgräbern aber zog das Volk aus gen Hazeroth, und sie blieben zu
Hazeroth. \# 12 \bibleverse{1} Und Mirjam und Aaron redeten wider Mose
um seines Weibes willen, der Mohrin, die er genommen hatte, darum dass
er eine Mohrin zum Weibe genommen hatte, \bibleverse{2} und sprachen:
Redet denn der \textsc{Herr} allein durch Mose? Redet er nicht auch
durch uns? Und der \textsc{Herr} hörte es. \bibleverse{3} Aber Mose war
ein sehr geplagter Mensch über alle Menschen auf Erden. \bibleverse{4}
...
alle drei heraus. \bibleverse{5} Da kam der \textsc{Herr} hernieder in
...
\bibleverse{6} Und er sprach: Höret meine Worte: Ist jemand unter euch
ein Prophet des \textsc{Herrn}, dem will ich mich kundmachen in einem
Gesicht oder will mit ihm reden in einem Traum. \bibleverse{7} Aber
...
\bibleverse{9} Und der Zorn des \textsc{Herrn} ergrimmte über sie, und
er wandte sich weg; \bibleverse{10} dazu die Wolke wich auch von der
Hütte. Und siehe, da war Mirjam aussätzig wie der Schnee. Und Aaron
wandte sich zu Mirjam und wird gewahr, dass sie aussätzig ist,
...
Gott, heile sie! \footnote{\textbf{12:13} 2Mo 15,26} \bibleverse{14} Der
...
\footnote{\textbf{12:14} 3Mo 13,46} \bibleverse{15} Also ward Mirjam
sieben Tage verschlossen außerhalb des Lagers. Und das Volk zog nicht
weiter, bis Mirjam aufgenommen ward. \bibleverse{16} Darnach zog das
...
vornehmen Mann. \bibleverse{3} Mose, der sandte sie aus der Wüste Pharan
nach dem Wort des \textsc{Herrn}, die alle vornehme Männer waren unter
den Kindern Israel. \bibleverse{4} Und hießen also: Sammua, der Sohn
Sakkurs, des Stammes Ruben; \bibleverse{5} Saphat, der Sohn Horis, des
Stammes Simeon; \bibleverse{6} Kaleb, der Sohn Jephunnes, des Stammes
Juda; \footnote{\textbf{13:6} Jos 14,7} \bibleverse{7} Jigeal, der Sohn
Josephs, des Stammes Isaschar; \bibleverse{8} Hosea, der Sohn Nuns, des
Stammes Ephraim; \bibleverse{9} Palti, der Sohn Raphus, des Stammes
Benjamin; \bibleverse{10} Gaddiel, der Sohn Sodis, des Stammes Sebulon;
\bibleverse{11} Gaddi, der Sohn Susis, des Stammes Joseph von Manasse;
\bibleverse{12} Ammiel, der Sohn Gemallis, des Stammes Dan;
\bibleverse{13} Sethur, der Sohn Michaels, des Stammes Asser;
\bibleverse{14} Nahebi, der Sohn Vaphsis, des Stammes Naphthali;
\bibleverse{15} Guel, der Sohn Machis, des Stammes Gad. \bibleverse{16}
...
Aber den Hosea, den Sohn Nuns, nannte Mose Josua. \footnote{\textbf{13:16}
  4Mo 11,28} \bibleverse{17} Da sie nun Mose sandte, das Land Kanaan zu
erkunden, sprach er zu ihnen: Ziehet hinauf ins Mittagsland und geht auf
das Gebirge \bibleverse{18} und besehet das Land, wie es ist, und das
...
nach 40 Tagen, \bibleverse{26} gingen hin und kamen zu Mose und Aaron
...
und ließen sie die Früchte des Landes sehen. \bibleverse{27} Und
...
\bibleverse{28} nur, dass starkes Volk darin wohnt und sehr große und
feste Städte sind; und wir sahen auch Enaks Kinder daselbst.
\bibleverse{29} So wohnen die Amalekiter im Lande gegen Mittag, die
Hethiter und Jebusiter und Amoriter wohnen auf dem Gebirge, die
Kanaaniter aber wohnen am Meer und um den Jordan. \bibleverse{30} Kaleb
...
das Land einnehmen; denn wir können es überwältigen. \footnote{\textbf{13:30}
  4Mo 13,6} \bibleverse{31} Aber die Männer, die mit ihm waren
hinaufgezogen, sprachen: Wir vermögen nicht hinaufzuziehen gegen das
Volk; denn sie sind uns zu stark, -- \bibleverse{32} und machten dem
...
sind Leute von großer Länge. \bibleverse{33} Wir sahen auch Riesen
...
\footnote{\textbf{14:2} 2Mo 16,3} \bibleverse{3} Warum führt uns der
...
wieder nach Ägypten? \footnote{\textbf{14:3} Ps 106,24} \bibleverse{4}
Und einer sprach zu dem anderen: Lasst uns einen Hauptmann aufwerfen und
wieder nach Ägypten ziehen! \bibleverse{5} Mose aber und Aaron fielen
auf ihr Angesicht vor der ganzen Versammlung der Gemeinde der Kinder
Israel. \footnote{\textbf{14:5} 4Mo 16,4} \bibleverse{6} Und Josua, der
...
hatten, zerrissen ihre Kleider \footnote{\textbf{14:6} 4Mo 13,16; 4Mo
  13,30} \bibleverse{7} und sprachen zu der ganzen Gemeinde der Kinder
Israel: Das Land, das wir durchwandelt haben, es zu erkunden, ist sehr
gut. \bibleverse{8} Wenn der \textsc{Herr} uns gnädig ist, so wird er
uns in das Land bringen und es uns geben, ein Land, darin Milch und
Honig fließt. \footnote{\textbf{14:8} 4Mo 13,27} \bibleverse{9} Fallet
...
nicht vor ihnen. \bibleverse{10} Da sprach das ganze Volk, man sollte
sie steinigen. Da erschien die Herrlichkeit des \textsc{Herrn} in der
Hütte des Stifts allen Kindern Israel. \bibleverse{11} Und der
...
ich unter ihnen getan habe? \bibleverse{12} So will ich sie mit
...
mächtigeren Volk machen, denn dies ist. \footnote{\textbf{14:12} 2Mo
  32,10-14} \bibleverse{13} Mose aber sprach zu dem \textsc{Herrn}: So
werden's die Ägypter hören; denn du hast dieses Volk mit deiner Kraft
mitten aus ihnen geführt. \bibleverse{14} Und man wird es sagen zu den
...
der Wolkensäule des Tages und Feuersäule des Nachts. \bibleverse{15}
Würdest du nun dieses Volk töten, wie einen Mann, so würden die Heiden
sagen, die solch Gerücht von dir hörten, und sprechen: \bibleverse{16}
Der \textsc{Herr} konnte mitnichten dieses Volk in das Land bringen, das
er ihnen geschworen hatte; darum hat er sie geschlachtet in der Wüste.
...
\footnote{\textbf{14:18} 2Mo 34,6-7} \bibleverse{19} So sei nun gnädig
der Missetat dieses Volks nach deiner großen Barmherzigkeit, wie du auch
vergeben hast diesem Volk aus Ägypten bis hierher. \bibleverse{20} Und
der \textsc{Herr} sprach: Ich habe es vergeben, wie du gesagt hast.
\bibleverse{21} Aber so wahr als ich lebe, so soll alle Welt der
Herrlichkeit des \textsc{Herrn} voll werden. \bibleverse{22} Denn alle
...
versucht und meiner Stimme nicht gehorcht haben, \bibleverse{23} deren
...
keiner soll es sehen, der mich verlästert hat. \footnote{\textbf{14:23}
  Ps 95,11; Hebr 3,17-19} \bibleverse{24} Aber meinen Knecht Kaleb,
...
\bibleverse{25} dazu die Amalekiter und Kanaaniter, die im Tale wohnen.
...
innewerdet, was es sei, wenn ich die Hand abziehe. \footnote{\textbf{14:34}
  Jer 2,19} \bibleverse{35} Ich, der \textsc{Herr}, habe es gesagt; das
...
sterben. \bibleverse{36} Also starben durch die Plage vor dem
...
ganze Gemeinde, \bibleverse{37} damit dass sie dem Lande ein Geschrei
machten, dass es böse wäre. \bibleverse{38} Aber Josua, der Sohn Nuns,
...
hat; denn wir haben gesündigt. \bibleverse{41} Mose aber sprach: Warum
übertretet ihr also das Wort des \textsc{Herrn}? Es wird euch nicht
gelingen. \bibleverse{42} Ziehet nicht hinauf -- denn der \textsc{Herr}
ist nicht unter Euch --, dass ihr nicht geschlagen werdet vor euren
Feinden. \bibleverse{43} Denn die Amalekiter und Kanaaniter sind vor
...
euch sein. \bibleverse{44} Aber sie waren störrig, hinaufzuziehen auf
die Höhe des Gebirges; aber die Lade des Bundes des \textsc{Herrn} und
Mose kamen nicht aus dem Lager. \bibleverse{45} Da kamen die Amalekiter
...
Trankopfer sein. \bibleverse{13} Wer ein Einheimischer ist, der soll
solches tun, dass er dem \textsc{Herrn} opfere ein Opfer zum süßen
Geruch. \bibleverse{14} Und wenn ein Fremdling bei euch wohnt oder unter
euch bei euren Nachkommen ist, und will dem \textsc{Herrn} ein Opfer zum
süßen Geruch tun, der soll tun, wie ihr tut. \bibleverse{15} Der ganzen
...
Fremdling sei wie ihr. \bibleverse{16} Ein Gesetz, ein Recht soll euch
und dem Fremdling sein, der bei euch wohnt. \bibleverse{17} Und der
\textsc{Herr} redete mit Mose und sprach: \bibleverse{18} Rede mit den
Kindern Israel und sprich zu ihnen: Wenn ihr in das Land kommt, darein
ich euch bringen werde, \bibleverse{19} dass ihr esset von dem Brot im
Lande, sollt ihr dem \textsc{Herrn} eine Hebe geben: \footnote{\textbf{15:19}
  2Mo 23,16; 2Mo 23,19} \bibleverse{20} als eures Teiges Erstling sollt
ihr einen Kuchen zur Hebe geben; wie die Hebe von der Scheune,
\bibleverse{21} also sollt ihr auch dem \textsc{Herrn} eures Teiges
Erstling zur Hebe geben bei euren Nachkommen. \bibleverse{22} Und wenn
ihr aus Versehen dieser Gebote irgendeins nicht tut, die der
\textsc{Herr} zu Mose geredet hat, \bibleverse{23} alles, was der
\textsc{Herr} euch durch Mose geboten hat, von dem Tage an, da er anfing
zu gebieten auf eure Nachkommen; \bibleverse{24} wenn nun ohne Wissen
...
soll eine jährige Ziege zum Sündopfer bringen. \footnote{\textbf{15:27}
  3Mo 4,27-28} \bibleverse{28} Und der Priester soll versöhnen solche
Seele, die aus Versehen gesündigt hat, vor dem \textsc{Herrn}, dass er
sie versöhne und ihr vergeben werde. \bibleverse{29} Und es soll ein
...
war nicht klar ausgedrückt, was man mit ihm tun sollte. \footnote{\textbf{15:34}
  3Mo 24,12; 2Mo 31,14; 2Mo 35,2} \bibleverse{35} Der \textsc{Herr} aber
sprach zu Mose: Der Mann soll des Todes sterben; die ganze Gemeinde soll
ihn steinigen draußen vor dem Lager. \bibleverse{36} Da führte die ganze
Gemeinde ihn hinaus vor das Lager und steinigten ihn, dass er starb, wie
der \textsc{Herr} dem Mose geboten hatte. \bibleverse{37} Und der
\textsc{Herr} sprach zu Mose: \bibleverse{38} Rede mit den Kindern
...
Quasten an die Zipfel tun; \bibleverse{39} und sollen euch die Quasten
...
\bibleverse{40} Darum sollt ihr gedenken und tun alle meine Gebote und
heilig sein eurem Gott. \bibleverse{41} Ich bin der \textsc{Herr}, euer
Gott, der euch aus Ägyptenland geführt hat, dass ich euer Gott wäre,
ich, der \textsc{Herr}, euer Gott. \# 16 \bibleverse{1} Und Korah, der
...
\bibleverse{2} die empörten sich wider Mose samt etlichen Männern unter
den Kindern Israel, 250, Vornehmste in der Gemeinde, Ratsherren und
namhafte Leute. \footnote{\textbf{16:2} 4Mo 12,1-2} \bibleverse{3} Und
...
des \textsc{Herrn}? \bibleverse{4} Da das Mose hörte, fiel er auf sein
Angesicht \footnote{\textbf{16:4} 4Mo 14,5} \bibleverse{5} und sprach zu
...
der soll zu ihm nahen. \footnote{\textbf{16:5} 2Tim 2,19} \bibleverse{6}
...
heilig. Ihr macht's zu viel, ihr Kinder Levi. \bibleverse{8} Und Mose
sprach zu Korah: Höret doch, ihr Kinder Levi! \bibleverse{9} Ist's euch
...
\footnote{\textbf{16:9} 4Mo 3,6-13; 4Mo 4,4-20} \bibleverse{10} Er hat
dich und alle deine Brüder, die Kinder Levi, samt dir zu sich genommen;
und ihr sucht nun auch das Priestertum? \bibleverse{11} Du und deine
ganze Rotte macht einen Aufruhr wider den \textsc{Herrn}. Was ist Aaron,
dass ihr wider ihn murret? \bibleverse{12} Und Mose schickte hin und
ließ Dathan und Abiram rufen, die Söhne Eliabs. Sie aber sprachen: Wir
kommen nicht hinauf. \bibleverse{13} Ist's zu wenig, dass du uns aus dem
Lande geführt hast, darin Milch und Honig fließt, dass du uns tötest in
der Wüste? Du musst auch noch über uns herrschen? \bibleverse{14} Wie
...
auch die Augen ausreißen? Wir kommen nicht hinauf. \footnote{\textbf{16:14}
  2Mo 3,8; 2Mo 3,17} \bibleverse{15} Da ergrimmte Mose sehr und sprach
...
getan. \footnote{\textbf{16:15} 1Sam 12,3; Apg 20,33} \bibleverse{16}
Und er sprach zu Korah: Du und deine ganze Rotte sollt morgen vor dem
\textsc{Herrn} sein; du, sie auch und Aaron. \bibleverse{17} Und ein
...
Gemeinde. \footnote{\textbf{16:19} 4Mo 14,10} \bibleverse{20} Und der
\textsc{Herr} redete mit Mose und Aaron und sprach: \bibleverse{21}
...
Wohnung Korahs und Dathans und Abirams. \bibleverse{25} Und Mose stand
auf und ging zu Dathan und Abiram, und die Ältesten Israels folgten ihm
nach, \bibleverse{26} und er redete mit der Gemeinde und sprach: Weichet
...
ihrer Hütten mit ihren Weibern und Söhnen und Kindern. \bibleverse{28}
...
Herzen: \bibleverse{29} werden sie sterben, wie alle Menschen sterben,
oder heimgesucht, wie alle Menschen heimgesucht werden, so hat mich der
\textsc{Herr} nicht gesandt; \bibleverse{30} wird aber der \textsc{Herr}
...
gelästert haben. \bibleverse{31} Und als er diese Worte hatte alle
ausgeredet, zerriss die Erde unter ihnen \footnote{\textbf{16:31} 5Mo
  11,6} \bibleverse{32} und tat ihren Mund auf und verschlang sie mit
ihren Häusern, mit allen Menschen, die bei Korah waren, und mit aller
ihrer Habe; \bibleverse{33} und sie fuhren hinunter lebendig in die
Hölle mit allem, was sie hatten, und die Erde deckte sie zu, und kamen
um aus der Gemeinde. \bibleverse{34} Und ganz Israel, das um sie her
war, floh vor ihrem Geschrei; denn sie sprachen: dass uns die Erde nicht
auch verschlinge! \bibleverse{35} Dazu fuhr das Feuer aus von dem
\textsc{Herrn} und fraß die 250 Männer, die das Räuchwerk opferten. \#
17 \bibleverse{1} Und der \textsc{Herr} redete mit Mose und sprach:
...
\bibleverse{6} Des anderen Morgens aber murrte die ganze Gemeinde der
Kinder Israel wider Mose und Aaron, und sprachen: Ihr habt des
\textsc{Herrn} Volk getötet. \bibleverse{7} Und da sich die Gemeinde
...
\textsc{Herrn} erschien. \bibleverse{8} Und Mose und Aaron gingen herzu
vor die Hütte des Stifts. \bibleverse{9} Und der \textsc{Herr} redete
mit Mose und sprach: \bibleverse{10} Hebt euch aus dieser Gemeinde; ich
will sie plötzlich vertilgen! Und sie fielen auf ihr Angesicht.
\footnote{\textbf{17:10} 4Mo 16,4; 4Mo 16,22} \bibleverse{11} Und Mose
...
\bibleverse{12} Und Aaron nahm, wie ihm Mose gesagt hatte, und lief
mitten unter die Gemeinde (und siehe, die Plage war angegangen unter dem
Volk) und räucherte und versöhnte das Volk \bibleverse{13} und stand
zwischen den Toten und den Lebendigen. Da ward der Plage gewehrt.
\bibleverse{14} Derer aber, die an der Plage gestorben waren, waren
14.700, ohne die, die mit Korah starben. \bibleverse{15} Und Aaron kam
wieder zu Mose vor die Tür der Hütte des Stifts, und der Plage ward
gewehrt. \bibleverse{16} Und der \textsc{Herr} redete mit Mose und
sprach: \bibleverse{17} Sage den Kindern Israel und nimm von ihnen zwölf
Stecken, von jeglichem Fürsten seines Vaterhauses einen, und schreib
eines jeglichen Namen auf seinen Stecken. \bibleverse{18} Aber den Namen
Aarons sollst du schreiben auf den Stecken Levis. Denn je für ein Haupt
ihrer Vaterhäuser soll ein Stecken sein. \bibleverse{19} Und lege sie in
die Hütte des Stifts vor dem Zeugnis, da ich mich euch bezeuge.
\footnote{\textbf{17:19} 2Mo 25,22} \bibleverse{20} Und welchen ich
...
tragen. \footnote{\textbf{18:1} 2Mo 28,38; 3Mo 16,32-33} \bibleverse{2}
...
\bibleverse{7} Du aber und deine Söhne mit dir sollt eures Priestertums
...
Geschenk. Wenn ein Fremder sich herzutut, der soll sterben. \footnote{\textbf{18:7}
  4Mo 1,51} \bibleverse{8} Und der \textsc{Herr} sagte zu Aaron: Siehe,
...
heiligen, als Gebühr dir und deinen Söhnen zum ewigen Recht. \footnote{\textbf{18:8}
  3Mo 2,3; 3Mo 2,10; 3Mo 6,9-11; 3Mo 6,19-22; 3Mo 7,6-10} \bibleverse{9}
...
dir und deinen Söhnen ein Hochheiliges sein. \bibleverse{10} An einem
hochheiligen Ort sollst du es essen. Was männlich ist, soll davon essen;
denn es soll dir heilig sein. \bibleverse{11} Ich habe auch das Hebopfer
...
Hause, soll davon essen. \bibleverse{12} Alles beste Öl und alles Beste
vom Most und Korn, nämlich ihre Erstlinge, die sie dem \textsc{Herrn}
geben, habe ich dir gegeben. \bibleverse{13} Die erste Frucht, die sie
...
sein; wer rein ist in deinem Hause, soll davon essen. \footnote{\textbf{18:13}
  2Mo 23,19; 5Mo 18,4} \bibleverse{14} Alles Verbannte in Israel soll
dein sein. \footnote{\textbf{18:14} 3Mo 27,28} \bibleverse{15} Alles,
...
Viehs auch lösen lassest. \footnote{\textbf{18:15} 2Mo 13,12-13; 2Mo
  34,19-20} \bibleverse{16} Sie sollen's aber lösen, wenn's einen Monat
alt ist; und sollst es zu lösen geben um Geld, um fünf Silberlinge nach
dem Lot des Heiligtums, das hat 20 Gera. \bibleverse{17} Aber die erste
...
\bibleverse{22} Dass hinfort die Kinder Israel nicht zur Hütte des
Stifts sich tun, Sünde auf sich zu laden, und sterben; \bibleverse{23}
...
\bibleverse{24} Denn den Zehnten der Kinder Israel, den sie dem
...
besitzen sollen. \bibleverse{25} Und der \textsc{Herr} redete mit Mose
und sprach: \bibleverse{26} Sage den Leviten und sprich zu ihnen: Wenn
...
Kinder Israel und nicht sterben. \# 19 \bibleverse{1} Und der
\textsc{Herr} redete mit Mose und Aaron und sprach: \bibleverse{2} Diese
...
\bibleverse{3} Und gebt sie dem Priester Eleasar; der soll sie hinaus
vor das Lager führen und daselbst vor ihm schlachten lassen.
\bibleverse{4} Und Eleasar, der Priester, soll von ihrem Blut mit seinem
Finger nehmen und stracks gegen die Hütte des Stifts siebenmal sprengen
\bibleverse{5} und die Kuh vor ihm verbrennen lassen, beides, ihr Fell
und ihr Fleisch, dazu ihr Blut samt ihrem Mist. \bibleverse{6} Und der
...
\footnote{\textbf{19:7} 3Mo 16,28} \bibleverse{8} Und der sie verbrannt
hat, soll auch seine Kleider mit Wasser waschen und seinen Leib in
Wasser baden und unrein sein bis an den Abend. \bibleverse{9} Und ein
...
ein Sündopfer. \bibleverse{10} Und derselbe, der die Asche der Kuh
...
Fremdlingen, die unter euch wohnen: \bibleverse{11} Wer nun irgendeinen
toten Menschen anrührt, der wird sieben Tage unrein sein.
\bibleverse{12} Der soll sich hiermit entsündigen am dritten Tage und am
...
\bibleverse{13} Wenn aber jemand irgendeinen toten Menschen anrührt und
...
unrein; seine Unreinigkeit bleibt an ihm. \footnote{\textbf{19:13} 3Mo
  15,31} \bibleverse{14} Das ist das Gesetz: Wenn ein Mensch in der
Hütte stirbt, soll jeder, der in die Hütte geht und wer in der Hütte
ist, unrein sein sieben Tage. \bibleverse{15} Und alles offene Gerät,
das keinen Deckel noch Band hat, ist unrein. \bibleverse{16} Auch wer
...
sieben Tage. \bibleverse{17} So sollen sie nun für den Unreinen nehmen
Asche von diesem verbrannten Sündopfer und fließendes Wasser darauf tun
in ein Gefäß. \bibleverse{18} Und ein reiner Mann soll Isop nehmen und
...
anrühren wird, soll unrein sein bis an den Abend. \# 20 \bibleverse{1}
Und die Kinder Israel kamen mit der ganzen Gemeinde in die Wüste Zin im
ersten Monat, und das Volk lag zu Kades. Und Mirjam starb daselbst und
ward daselbst begraben. \bibleverse{2} Und die Gemeinde hatte kein
Wasser, und sie versammelten sich wider Mose und Aaron. \footnote{\textbf{20:2}
  2Mo 17,1-7} \bibleverse{3} Und das Volk haderte mit Mose und sprach:
...
\bibleverse{11} Und Mose hob seine Hand auf und schlug den Fels mit dem
Stab zweimal. Da ging viel Wasser heraus, dass die Gemeinde trank und
ihr Vieh. \bibleverse{12} Der \textsc{Herr} aber sprach zu Mose und
...
das ich ihnen geben werde. \bibleverse{13} Das ist das Haderwasser,
...
Mühsal, die uns betroffen hat, \footnote{\textbf{20:14} 1Mo 32,4; Ri
  11,17; 5Mo 23,8} \bibleverse{15} dass unsere Väter nach Ägypten
hinabgezogen sind und wir lange Zeit in Ägypten gewohnt haben, und die
Ägypter behandelten uns und unsere Väter übel. \bibleverse{16} Und wir
...
in der Stadt an deinen Grenzen. \footnote{\textbf{20:16} 2Mo 23,20}
\bibleverse{17} Lass uns durch dein Land ziehen. Wir wollen nicht durch
...
weichen, bis wir durch deine Grenze kommen. \footnote{\textbf{20:17} 4Mo
  21,22} \bibleverse{18} Edom aber sprach zu ihnen: Du sollst nicht
durch mich ziehen, oder ich will dir mit dem Schwert entgegenziehen.
\bibleverse{19} Die Kinder Israel sprachen zu ihm: Wir wollen auf der
...
hindurchziehen. \bibleverse{20} Er aber sprach: Du sollst nicht
herdurchziehen. Und die Edomiter zogen aus, ihnen entgegen, mit
mächtigem Volk und starker Hand. \bibleverse{21} Also weigerten sich die
Edomiter, Israel zu vergönnen, durch ihr Gebiet zu ziehen. Und Israel
wich von ihnen. \bibleverse{22} Und die Kinder Israel brachen auf von
Kades und kamen mit der ganzen Gemeinde an den Berg Hor. \bibleverse{23}
Und der \textsc{Herr} redete mit Mose und Aaron am Berge Hor, an den
Grenzen des Landes der Edomiter, und sprach: \bibleverse{24} Lass sich
...
ungehorsam gewesen seid bei dem Haderwasser. \bibleverse{25} Nimm aber
...
\footnote{\textbf{20:26} 3Mo 21,10} \bibleverse{27} Da tat Mose, wie ihm
der \textsc{Herr} geboten hatte, und sie stiegen auf den Berg Hor vor
der ganzen Gemeinde. \bibleverse{28} Und Mose zog Aaron seine Kleider
...
\bibleverse{29} Und da die ganze Gemeinde sah, dass Aaron dahin war,
beweinten sie ihn 30 Tage, das ganze Haus Israel. \# 21 \bibleverse{1}
...
wider Israel und führte etliche gefangen. \bibleverse{2} Da gelobte
...
unter meine Hand gibst, so will ich ihre Städte verbannen. \footnote{\textbf{21:2}
  5Mo 13,16; Jos 6,17; Ri 1,17; 1Sam 15,3} \bibleverse{3} Und der
...
\bibleverse{4} Da zogen sie von dem Berge Hor auf dem Wege gegen das
Schilfmeer, dass sie um der Edomiter Land hinzögen. Und das Volk ward
verdrossen auf dem Wege \bibleverse{5} und redete wider Gott und wider
...
vor dieser mageren Speise. \bibleverse{6} Da sandte der \textsc{Herr}
feurige Schlangen unter das Volk; die bissen das Volk, dass viel Volks
in Israel starb. \footnote{\textbf{21:6} 1Kor 10,9} \bibleverse{7} Da
...
\bibleverse{8} Da sprach der \textsc{Herr} zu Mose: Mache dir eine
eherne Schlange und richte sie zum Zeichen auf; wer gebissen ist und
sieht sie an, der soll leben. \bibleverse{9} Da machte Mose eine eherne
...
König der Amoriter, und ließ ihm sagen: \footnote{\textbf{21:21} 5Mo
  2,26-37} \bibleverse{22} Lass mich durch dein Land ziehen. Wir wollen
nicht weichen in die Äcker noch in die Weingärten, wollen auch
Brunnenwasser nicht trinken; die Landstraße wollen wir ziehen, bis wir
durch deine Grenze kommen. \bibleverse{23} Aber Sihon gestattete den
...
Jahza kam, stritt er wider Israel. \bibleverse{24} Israel aber schlug
...
Ammon waren fest. \bibleverse{25} Also nahm Israel alle diese Städte und
wohnte in allen Städten der Amoriter, zu Hesbon und in allen seinen
Ortschaften. \bibleverse{26} Denn Hesbon war die Stadt Sihons, des
...
\bibleverse{27} Daher sagt man im Lied: „Kommt gen Hesbon, dass man die
Stadt Sihons baue und aufrichte; \bibleverse{28} denn Feuer ist aus
Hesbon gefahren, eine Flamme von der Stadt Sihons, die hat gefressen Ar
der Moabiter und die Bürger der Höhen am Arnon. \bibleverse{29} Weh dir,
...
Amoriter. \bibleverse{30} Ihre Herrlichkeit ist zunichte worden von
Hesbon bis gen Dibon; sie ist verstört bis gen Nophah, die da langt bis
gen Medeba.`` \bibleverse{31} Also wohnte Israel im Lande der Amoriter.
\bibleverse{32} Und Mose sandte aus Kundschafter gen Jaser, und sie
gewannen seine Ortschaften und nahmen die Amoriter ein, die darin waren,
\bibleverse{33} und wandten sich und zogen hinauf den Weg nach Basan. Da
zog aus, ihnen entgegen, Og, der König von Basan, mit allem seinem Volk,
zu streiten in Edrei. \bibleverse{34} Und der \textsc{Herr} sprach zu
...
\footnote{\textbf{21:34} Ps 136,17-22} \bibleverse{35} Und sie schlugen
ihn und seine Söhne und all sein Volk, bis dass keiner übrigblieb, und
nahmen das Land ein. \# 22 \bibleverse{1} Darnach zogen die Kinder
Israel und lagerten sich in das Gefilde Moab jenseits des Jordans,
gegenüber Jericho. \bibleverse{2} Und Balak, der Sohn Zippors, sah
alles, was Israel getan hatte den Amoritern; \bibleverse{3} und die
Moabiter fürchteten sich sehr vor dem Volk, das so groß war, und den
Moabitern graute vor den Kindern Israel; \bibleverse{4} und sie sprachen
zu den Ältesten der Midianiter: Nun wird dieser Haufe auffressen, was um
uns ist, wie ein Ochse Kraut auf dem Felde auffrisst. Balak aber, der
Sohn Zippors, war zu der Zeit König der Moabiter. \bibleverse{5} Und er
...
das Angesicht der Erde und liegt mir gegenüber. \bibleverse{6} So komm
...
verflucht. \bibleverse{7} Und die Ältesten der Moabiter gingen hin mit
...
Händen und kamen zu Bileam und sagten ihm die Worte Balaks. \footnote{\textbf{22:7}
  2Petr 2,15} \bibleverse{8} Und er sprach zu ihnen: Bleibt hier über
Nacht, so will ich euch wieder sagen, wie mir der \textsc{Herr} sagen
wird. Also blieben die Fürsten der Moabiter bei Bileam. \bibleverse{9}
...
Moabiter König, hat zu mir gesandt: \bibleverse{11} Siehe, ein Volk ist
...
\bibleverse{12} Gott aber sprach zu Bileam: Gehe nicht mit ihnen,
verfluche das Volk auch nicht; denn es ist gesegnet. \bibleverse{13} Da
...
mit euch ziehe. \bibleverse{14} Und die Fürsten der Moabiter machten
sich auf, kamen zu Balak und sprachen: Bileam weigert sich, mit uns zu
ziehen. \bibleverse{15} Da sandte Balak noch größere und herrlichere
Fürsten, denn jene waren. \bibleverse{16} Da die zu Bileam kamen,
sprachen sie zu ihm: Also lässt dir sagen Balak, der Sohn Zippors: Wehre
dich doch nicht, zu mir zu ziehen; \bibleverse{17} denn ich will dich
hoch ehren, und was du mir sagst, das will ich tun; komm doch und fluche
mir diesem Volk. \bibleverse{18} Bileam antwortete und sprach zu den
...
Gottes, Kleines oder Großes zu tun. \bibleverse{19} So bleibt doch nur
hier auch ihr diese Nacht, dass ich erfahre, was der \textsc{Herr}
weiter mit mir reden werde. \bibleverse{20} Da kam Gott des Nachts zu
...
du tun. \bibleverse{21} Da stand Bileam des Morgens auf und sattelte
seine Eselin und zog mit den Fürsten der Moabiter. \bibleverse{22} Aber
...
auf seiner Eselin, und zwei Knechte waren mit ihm. \bibleverse{23} Und
...
\footnote{\textbf{22:23} 1Mo 3,24; Jos 5,13} \bibleverse{24} Da trat der
Engel des \textsc{Herrn} in den Pfad bei den Weinbergen, da auf beiden
Seiten Wände waren. \bibleverse{25} Und da die Eselin den Engel des
...
reden. \bibleverse{39} Also zog Bileam mit Balak, und sie kamen in die
...
\bibleverse{13} Balak sprach zu ihm: Komm doch mit mir an einen anderen
Ort, von wo du nur sein Ende sehest und es nicht ganz sehest, und fluche
mir ihm daselbst. \bibleverse{14} Und er führte ihn auf einen freien
Platz auf der Höhe Pisga und baute sieben Altäre und opferte je auf
einem Altar einen Farren und einen Widder. \bibleverse{15} Und (Bileam)
sprach zu Balak: Tritt her zu deinem Brandopfer; ich will dort warten.
\bibleverse{16} Und der \textsc{Herr} begegnete Bileam und gab ihm das
Wort in seinen Mund und sprach: Gehe wieder zu Balak und rede also.
\bibleverse{17} Und da er wieder zu ihm kam, siehe, da stand er bei
seinem Brandopfer samt den Fürsten der Moabiter. Und Balak sprach zu
ihm: Was hat der \textsc{Herr} gesagt? \bibleverse{18} Und er hob an
seinen Spruch und sprach: Stehe auf, Balak, und höre! nimm zu Ohren was
ich sage, du Sohn Zippors! \bibleverse{19} Gott ist nicht ein Mensch,
...
\bibleverse{20} Siehe, zu segnen bin ich hergebracht; er segnet, und ich
kann's nicht wenden. \bibleverse{21} Man sieht keine Mühe in Jakob und
keine Arbeit in Israel. Der \textsc{Herr}, sein Gott, ist bei ihm und
das Drommeten des Königs unter ihm. \bibleverse{22} Gott hat sie aus
Ägypten geführt; seine Freudigkeit ist wie eines Einhorns.
\bibleverse{23} Denn es ist kein Zauberer in Jakob und kein Wahrsager in
Israel. Zu seiner Zeit wird Jakob gesagt und Israel, was Gott tut.
\bibleverse{24} Siehe, das Volk wird aufstehen, wie ein junger Löwe und
...
Raub fresse und das Blut der Erschlagenen saufe. \footnote{\textbf{23:24}
  4Mo 24,9} \bibleverse{25} Da sprach Balak zu Bileam: Du sollst ihm
weder fluchen noch es segnen. \bibleverse{26} Bileam antwortete und
...
sieht. \footnote{\textbf{23:28} 4Mo 25,3} \bibleverse{29} Und Bileam
sprach zu Balak: Baue mir hier sieben Altäre und schaffe mir sieben
Farren und sieben Widder. \footnote{\textbf{23:29} 4Mo 23,1}
\bibleverse{30} Balak tat, wie Bileam sagte, und opferte je auf einem
Altar einen Farren und einen Widder. \# 24 \bibleverse{1} Da nun Bileam
...
stracks zu der Wüste, \bibleverse{2} hob auf seine Augen und sah Israel,
wie sie lagen nach ihren Stämmen. Und der Geist Gottes kam auf ihn,
\bibleverse{3} und er hob an seinen Spruch und sprach: Es sagt Bileam,
der Sohn Beors, es sagt der Mann, dem die Augen geöffnet sind,
\footnote{\textbf{24:3} 1Sam 9,9} \bibleverse{4} es sagt der Hörer
...
\bibleverse{5} Wie fein sind deine Hütten, Jakob, und deine Wohnungen,
Israel! \bibleverse{6} Wie die Täler, die sich ausbreiten, wie die
Gärten an den Wassern, wie die Aloebäume, die der \textsc{Herr} pflanzt,
wie die Zedern an den Wassern. \bibleverse{7} Es wird Wasser aus seinem
...
\bibleverse{8} Gott hat ihn aus Ägypten geführt; seine Freudigkeit ist
...
\bibleverse{9} Er hat sich niedergelegt wie ein Löwe und wie ein junger
...
und verflucht, der dir flucht! \footnote{\textbf{24:9} 4Mo 23,24; 1Mo
  49,9; 1Mo 12,3} \bibleverse{10} Da ergrimmte Balak im Zorn wider
...
sie nun dreimal gesegnet. \bibleverse{11} Und nun hebe dich an deinen
Ort! Ich gedachte, ich wollte dich ehren; aber der \textsc{Herr} hat dir
die Ehre verwehrt. \bibleverse{12} Bileam antwortete ihm: Habe ich nicht
...
würde, das würde ich auch reden? \bibleverse{14} Und nun siehe, ich
ziehe zu meinem Volk. So komm, ich will dir verkündigen, was dieses Volk
deinem Volk tun wird zur letzten Zeit. \bibleverse{15} Und er hob an
...
Feinden unterworfen sein; Israel aber wird Sieg haben. \footnote{\textbf{24:18}
  2Sam 8,14; Am 9,11; Am 1,9-12} \bibleverse{19} Aus Jakob wird der
Herrscher kommen und umbringen, was übrig ist von den Städten.
\footnote{\textbf{24:19} Mi 5,1; Mi 5,7-8} \bibleverse{20} Und da er sah
...
unter den Heiden; aber zuletzt wirst du gar umkommen. \footnote{\textbf{24:20}
  2Mo 17,14} \bibleverse{21} Und da er die Keniter sah, hob er an seinen
Spruch und sprach: Fest ist deine Wohnung, und hast dein Nest in einen
Fels gelegt. \footnote{\textbf{24:21} 1Sam 15,6; Ob 1,3} \bibleverse{22}
Aber, o Kain, du wirst verbrannt werden, wenn Assur dich gefangen
wegführen wird. \bibleverse{23} Und er hob abermals an seinen Spruch und
sprach: Ach, wer wird leben, wenn Gott solches tun wird? \bibleverse{24}
Und Schiffe aus Chittim werden verderben den Assur und Eber; er aber
wird auch umkommen. \footnote{\textbf{24:24} 1Makk 1,1} \bibleverse{25}
Und Bileam machte sich auf und zog hin und kam wieder an seinen Ort, und
Balak zog seinen Weg. \# 25 \bibleverse{1} Und Israel wohnte in Sittim.
Und das Volk hob an zu huren mit der Moabiter Töchtern, \bibleverse{2}
welche luden das Volk zum Opfer ihrer Götter. Und das Volk aß und betete
ihre Götter an. \bibleverse{3} Und Israel hängte sich an den Baal-Peor.
Da ergrimmte des \textsc{Herrn} Zorn über Israel, \footnote{\textbf{25:3}
  5Mo 4,3} \bibleverse{4} und er sprach zu Mose: nimm alle Obersten des
...
grimmige Zorn des \textsc{Herrn} von Israel gewandt werde. \footnote{\textbf{25:4}
  2Sam 21,6; 2Sam 21,9; 5Mo 21,22-23} \bibleverse{5} Und Mose sprach zu
...
weinten vor der Tür der Hütte des Stifts. \bibleverse{7} Da das sah
Pinehas, der Sohn Eleasars, des Sohnes Aarons, des Priesters, stand er
auf aus der Gemeinde und nahm einen Spieß in seine Hand \bibleverse{8}
...
Bauch. Da hörte die Plage auf von den Kindern Israel. \bibleverse{9} Und
es wurden getötet in der Plage 24.000. \footnote{\textbf{25:9} 1Kor 10,8}
\bibleverse{10} Und der \textsc{Herr} redete mit Mose und sprach:
\bibleverse{11} Pinehas, der Sohn Eleasars, des Sohnes Aarons, des
...
geeifert und die Kinder Israel versöhnt hat. \footnote{\textbf{25:13} Ps
  106,30-31} \bibleverse{14} Der israelitische Mann aber, der erschlagen
ward mit der Midianitin, hieß Simri, der Sohn Salus, der Fürst eines
Vaterhauses der Simeoniter. \bibleverse{15} Das midianitische Weib, das
auch erschlagen ward, hieß Kosbi, eine Tochter Zurs, der ein Fürst war
eines Geschlechts unter den Midianitern. \bibleverse{16} Und der
\textsc{Herr} redete mit Mose und sprach: \bibleverse{17} Tut den
Midianitern Schaden und schlagt sie; \footnote{\textbf{25:17} 4Mo
  31,2-10} \bibleverse{18} denn sie haben euch Schaden getan mit ihrer
...
ist am Tag der Plage um des Peor willen. \# 26 \bibleverse{1} Und es
geschah, nach der Plage sprach der \textsc{Herr} zu Mose und Eleasar,
dem Sohn des Priesters Aaron: \bibleverse{2} Nehmt die Summe der ganzen
Gemeinde der Kinder Israel, von 20 Jahren und darüber, nach ihren
Vaterhäusern, alle, die ins Heer zu ziehen taugen in Israel.
\bibleverse{3} Und Mose redete mit ihnen samt Eleasar, dem Priester, in
...
von dem das Geschlecht der Palluiter kommt; \footnote{\textbf{26:5} 1Mo
  46,8-27; 1Chr 4,1-7} \bibleverse{6} Hezron, von dem das Geschlecht der
Hezroniter kommt; Charmi, von dem das Geschlecht der Charmiter kommt.
\bibleverse{7} Das sind die Geschlechter von Ruben, und ihre Zahl war
43.730. \bibleverse{8} Aber die Kinder Pallus waren: Eliab.
\bibleverse{9} Und die Kinder Eliabs waren: Nemuel und Dathan und
...
beide starben im Lande Kanaan. \footnote{\textbf{26:19} 1Mo 38,7; 1Mo
  38,10} \bibleverse{20} Es waren aber die Kinder Judas in ihren
...
der Serahiter kommt. \bibleverse{21} Aber die Kinder des Perez waren:
Hezron, daher das Geschlecht der Hezroniter kommt; Hamul, daher das
Geschlecht der Hamuliter kommt. \bibleverse{22} Das sind die
...
\bibleverse{30} Dies sind aber die Kinder Gileads: Hieser, daher kommt
das Geschlecht der Hieseriter; Helek, daher kommt das Geschlecht der
Helekiter; \bibleverse{31} Asriel, daher kommt das Geschlecht der
Asrieliter; Sichem, daher kommt das Geschlecht der Sichemiter;
\bibleverse{32} Semida, daher kommt das Geschlecht der Semiditer;
Hepher, daher kommt das Geschlecht der Hepheriter. \bibleverse{33}
Zelophehad aber war Hephers Sohn und hatte keine Söhne, sondern Töchter;
die hießen Mahela, Noa, Hogla, Milka und Thirza. \bibleverse{34} Das
sind die Geschlechter Manasses, an ihrer Zahl 52.700. \bibleverse{35}
Die Kinder Ephraims in ihren Geschlechtern waren: Suthelah, daher kommt
das Geschlecht der Suthelahiter; Becher, daher kommt das Geschlecht der
Becheriter; Thahan, daher kommt das Geschlecht der Thahaniter.
\bibleverse{36} Die Kinder aber Suthelahs waren: Eran, daher kommt das
Geschlecht der Eraniter. \bibleverse{37} Das sind die Geschlechter der
Kinder Ephraims, an ihrer Zahl 32.500. Das sind die Kinder Josephs in
ihren Geschlechtern. \bibleverse{38} Die Kinder Benjamins in ihren
...
Geschlecht der Ahiramiter; \bibleverse{39} Supham, daher kommt das
Geschlecht der Suphamiter; Hupham, daher kommt das Geschlecht der
Huphamiter. \bibleverse{40} Die Kinder aber Belas waren: Ard und Naeman,
daher kommt das Geschlecht der Arditer und Naemaniter. \bibleverse{41}
Das sind die Kinder Benjamins in ihren Geschlechtern, an der Zahl
45.600. \bibleverse{42} Die Kinder Dans in ihren Geschlechtern waren:
Suham, daher kommt das Geschlecht der Suhamiter. \bibleverse{43} Das
sind die Geschlechter Dans in ihren Geschlechtern, allesamt an der Zahl
64.400. \bibleverse{44} Die Kinder Assers in ihren Geschlechtern waren:
...
\bibleverse{45} Aber die Kinder Berias waren: Heber, daher kommt das
Geschlecht der Hebriter; Melchiel, daher kommt das Geschlecht der
Melchieliter. \bibleverse{46} Und die Tochter Assers hieß Sarah.
\bibleverse{47} Das sind die Geschlechter der Kinder Assers, an ihrer
Zahl 53.400. \bibleverse{48} Die Kinder Naphthalis in ihren
...
daher kommt das Geschlecht der Sillemiter. \bibleverse{50} Das sind die
Geschlechter von Naphthali, an ihrer Zahl 45.400. \bibleverse{51} Das
ist die Summe der Kinder Israel 601.730. \bibleverse{52} Und der
\textsc{Herr} redete mit Mose und sprach: \bibleverse{53} Diesen sollst
du das Land austeilen zum Erbe nach der Zahl der Namen. \bibleverse{54}
Vielen sollst du viel zum Erbe geben, und wenigen wenig; jeglichen soll
man geben nach ihrer Zahl. \bibleverse{55} Doch man soll das Land durchs
Los teilen; nach den Namen der Stämme ihrer Väter sollen sie Erbe
nehmen. \footnote{\textbf{26:55} 4Mo 33,54; Jos 14,2} \bibleverse{56}
Denn nach dem Los sollst du ihr Erbe austeilen zwischen den vielen und
den wenigen. \bibleverse{57} Und das ist die Summe der Leviten in ihren
...
Merariter. \bibleverse{58} Dies sind die Geschlechter Levis: das
...
Kahath zeugte Amram. \bibleverse{59} Und Amrams Weib hieß Jochebed, eine
Tochter Levis, die ihm geboren ward in Ägypten; und sie gebar dem Amram
Aaron und Mose und ihre Schwester Mirjam. \bibleverse{60} Dem Aaron aber
ward geboren: Nadab, Abihu, Eleasar und Ithamar. \bibleverse{61} Nadab
aber und Abihu starben, da sie fremdes Feuer opferten vor dem
\textsc{Herrn}. \footnote{\textbf{26:61} 3Mo 10,1-2} \bibleverse{62} Und
...
ihnen kein Erbe unter den Kindern Israel. \bibleverse{63} Das ist die
...
Hogla, Milka und Thirza, kamen herzu \footnote{\textbf{27:1} 4Mo 26,33;
  4Mo 36,2; Jos 17,3-6} \bibleverse{2} und traten vor Mose und vor
Eleasar, den Priester, und vor die Fürsten und die ganze Gemeinde vor
der Tür der Hütte des Stifts und sprachen: \bibleverse{3} Unser Vater
...
an seiner Sünde gestorben, und hatte keine Söhne. \footnote{\textbf{27:3}
  4Mo 16,2; 4Mo 26,65} \bibleverse{4} Warum soll denn unseres Vaters
Name unter seinem Geschlecht untergehen, weil er keinen Sohn hat? Gebt
uns auch ein Gut unter unseres Vaters Brüdern! \bibleverse{5} Mose
brachte ihre Sache vor den \textsc{Herrn}. \bibleverse{6} Und der
\textsc{Herr} sprach zu ihm: \bibleverse{7} Die Töchter Zelophehads
...
\bibleverse{8} Und sage den Kindern Israel: Wenn jemand stirbt und hat
nicht Söhne, so sollt ihr sein Erbe seiner Tochter zuwenden.
\bibleverse{9} Hat er keine Tochter, sollt ihr's seinen Brüdern geben.
\bibleverse{10} Hat er keine Brüder, sollt ihr's seines Vaters Brüdern
geben. \bibleverse{11} Hat er nicht Vatersbrüder, sollt ihr's seinen
...
sein, wie der \textsc{Herr} dem Mose geboten hat. \bibleverse{12} Und
...
besiehe das Land, das ich den Kindern Israel gebe werde. \footnote{\textbf{27:12}
  5Mo 32,48-49} \bibleverse{13} Und wenn du es gesehen hast, sollst du
dich sammeln zu deinem Volk, wie dein Bruder Aaron versammelt ist,
\footnote{\textbf{27:13} 4Mo 20,24; 4Mo 20,28} \bibleverse{14} dieweil
...
Das ist das Haderwasser zu Kades in der Wüste Zin. \footnote{\textbf{27:14}
  4Mo 20,12-13} \bibleverse{15} Und Mose redete mit dem \textsc{Herrn}
und sprach: \bibleverse{16} Der \textsc{Herr}, der Gott der Geister
...
ohne Hirten. \footnote{\textbf{27:17} Mt 9,36} \bibleverse{18} Und der
...
Mann, in dem der Geist ist, und lege deine Hände auf ihn \footnote{\textbf{27:18}
  5Mo 3,21; 5Mo 34,9} \bibleverse{19} und stelle ihn vor den Priester
...
gehorche die ganze Gemeinde der Kinder Israel. \footnote{\textbf{27:20}
  2Kö 2,9; 2Kö 2,15} \bibleverse{21} Und er soll treten vor den Priester
...
alle Kinder Israel mit ihm und die ganze Gemeinde. \footnote{\textbf{27:21}
  2Mo 28,30} \bibleverse{22} Mose tat, wie ihm der \textsc{Herr} geboten
hatte, und nahm Josua und stellte ihn vor den Priester Eleasar und vor
die ganze Gemeinde \bibleverse{23} und legte seine Hand auf ihn und
...
\bibleverse{3} Und sprich zu ihnen: Das sind die Opfer, die ihr dem
...
\bibleverse{4} Ein Lamm des Morgens, das andere gegen Abend;
...
gemengt, das gestoßen ist, ein viertel Hin. \footnote{\textbf{28:5} 3Mo
  2,1} \bibleverse{6} Das ist das tägliche Brandopfer, das ihr am Berge
Sinai opfertet, zum süßen Geruch ein Feuer dem \textsc{Herrn}.
\bibleverse{7} Dazu sein Trankopfer je zu einem Lamm ein viertel Hin. Im
Heiligtum soll man den Wein des Trankopfers opfern dem \textsc{Herrn}.
\bibleverse{8} Das andere Lamm sollst du gegen Abend zurichten; mit dem
Speisopfer wie am Morgen und mit seinem Trankopfer sollst du es machen
zum Opfer des süßen Geruchs dem \textsc{Herrn}. \bibleverse{9} Am
Sabbattag aber zwei jährige Lämmer ohne Fehl und zwei Zehntel Semmelmehl
zum Speisopfer, mit Öl gemengt, und sein Trankopfer. \bibleverse{10} Das
ist das Brandopfer eines jeglichen Sabbats außer dem täglichen
Brandopfer samt seinem Trankopfer. \bibleverse{11} Aber des ersten Tages
eurer Monate sollt ihr dem \textsc{Herrn} ein Brandopfer opfern: zwei
junge Farren, einen Widder, sieben jährige Lämmer ohne Fehl; \footnote{\textbf{28:11}
  4Mo 10,10} \bibleverse{12} und je drei Zehntel Semmelmehl zum
...
zum Speisopfer, mit Öl gemengt, zu dem einen Widder; \footnote{\textbf{28:12}
  4Mo 28,20; 4Mo 28,28; 4Mo 15,2-13} \bibleverse{13} und je ein Zehntel
...
das Brandopfer eines jeglichen Monats im Jahr. \bibleverse{15} Dazu soll
...
täglichen Brandopfer und seinem Trankopfer. \footnote{\textbf{28:15} 4Mo
  28,22} \bibleverse{16} Aber am 14. Tage des ersten Monats ist das
...
soll man ungesäuertes Brot essen. \bibleverse{18} Der erste Tag soll
heilig heißen, dass ihr zusammenkommt; keine Dienstarbeit sollt ihr an
dem tun \footnote{\textbf{28:18} 4Mo 28,25-26} \bibleverse{19} und sollt
dem \textsc{Herrn} Brandopfer tun: zwei junge Farren, einen Widder,
sieben jährige Lämmer ohne Fehl; \bibleverse{20} samt ihren Speisopfern:
drei Zehntel Semmelmehl, mit Öl gemengt, zu einem Farren, und zwei
Zehntel zu dem Widder, \bibleverse{21} und je ein Zehntel auf ein Lamm
unter den sieben Lämmern; \bibleverse{22} dazu einen Bock zum Sündopfer,
...
gemengt, zu einem Farren, zwei Zehntel zu dem Widder, \bibleverse{29}
und je ein Zehntel zu einem Lamm der sieben Lämmer; \bibleverse{30} und
einen Ziegenbock, euch zu versöhnen. \footnote{\textbf{28:30} 4Mo 28,15}
...
da tun, \footnote{\textbf{29:7} 3Mo 23,27-32} \bibleverse{8} sondern
Brandopfer dem \textsc{Herrn} zum süßen Geruch opfern: einen jungen
Farren, einen Widder, sieben jährige Lämmer ohne Fehl; \bibleverse{9}
mit ihren Speisopfern: drei Zehntel Semmelmehl, mit Öl gemengt, zu dem
Farren, zwei Zehntel zu dem Widder, \bibleverse{10} und ein Zehntel je
zu einem der sieben Lämmer; \bibleverse{11} dazu einen Ziegenbock zum
Sündopfer, -- außer dem Sündopfer der Versöhnung und dem täglichen
Brandopfer mit seinem Speisopfer und mit ihrem Trankopfer.
\bibleverse{12} Der 15. Tag des siebenten Monats soll bei euch heilig
...
und sollt dem \textsc{Herrn} sieben Tage feiern \footnote{\textbf{29:12}
  3Mo 23,34-43} \bibleverse{13} und sollt dem \textsc{Herrn} Brandopfer
tun zum Opfer des süßen Geruchs dem \textsc{Herrn}: 13 junge Farren,
zwei Widder; 14 jährige Lämmer ohne Fehl; \bibleverse{14} samt ihrem
Speisopfer: drei Zehntel Semmelmehl, mit Öl gemengt, je zu einem der 13
Farren, zwei Zehntel je zu einem der zwei Widder, \bibleverse{15} und
ein Zehntel je zu einem der 14 Lämmer; \bibleverse{16} dazu einen
Ziegenbock zum Sündopfer, -- außer dem täglichen Brandopfer mit seinem
Speisopfer und seinem Trankopfer. \bibleverse{17} Am zweiten Tage: zwölf
junge Farren, zwei Widder, 14 jährige Lämmer ohne Fehl; \bibleverse{18}
mit ihrem Speisopfer und Trankopfer zu den Farren, zu den Widdern und zu
den Lämmern in ihrer Zahl, wie es recht ist; \bibleverse{19} dazu einen
Ziegenbock zum Sündopfer, -- außer dem täglichen Brandopfer mit seinem
Speisopfer und mit ihrem Trankopfer. \bibleverse{20} Am dritten Tage:
elf Farren, zwei Widder, 14 jährige Lämmer ohne Fehl; \bibleverse{21}
mit ihren Speisopfern und Trankopfern zu den Farren, zu den Widdern und
zu den Lämmern in ihrer Zahl, wie es recht ist; \bibleverse{22} dazu
einen Bock zum Sündopfer, -- außer dem täglichen Brandopfer mit seinem
Speisopfer und mit seinem Trankopfer. \bibleverse{23} Am vierten Tage:
zehn Farren, zwei Widder, 14 jährige Lämmer ohne Fehl; \bibleverse{24}
samt ihren Speisopfern und Trankopfern zu den Farren, zu den Widdern und
zu den Lämmern in ihrer Zahl, wie es recht ist; \bibleverse{25} dazu
einen Ziegenbock zum Sündopfer, -- außer dem täglichen Brandopfer mit
seinem Speisopfer und seinem Trankopfer. \bibleverse{26} Am fünften
Tage: neun Farren, zwei Widder, 14 jährige Lämmer ohne Fehl;
\bibleverse{27} samt ihren Speisopfern und Trankopfern zu den Farren, zu
den Widdern und zu den Lämmern in ihrer Zahl, wie es recht ist;
\bibleverse{28} dazu einen Bock zum Sündopfer, -- außer dem täglichen
Brandopfer mit seinem Speisopfer und seinem Trankopfer. \bibleverse{29}
Am sechsten Tage: acht Farren, zwei Widder, 14 jährige Lämmer ohne Fehl;
\bibleverse{30} samt ihren Speisopfern und Trankopfern zu den Farren, zu
den Widdern und zu den Lämmern in ihrer Zahl, wie es recht ist;
...
ist; \bibleverse{34} dazu einen Bock zum Sündopfer, -- außer dem
...
Dienstarbeit sollt ihr da tun \bibleverse{36} und sollt Brandopfer
opfern zum Opfer des süßen Geruchs dem \textsc{Herrn}: einen Farren,
einen Widder, sieben jährige Lämmer ohne Fehl; \bibleverse{37} samt
ihren Speisopfern und Trankopfern zu dem Farren, zu dem Widder und zu
den Lämmern in ihrer Zahl, wie es recht ist; \bibleverse{38} dazu einen
Bock zum Sündopfer, -- außer dem täglichen Brandopfer mit seinem
Speisopfer und seinem Trankopfer. \bibleverse{39} Solches sollt ihr dem
...
\# 30 \bibleverse{1} Und Mose sagte den Kindern Israel alles, was ihm
der \textsc{Herr} geboten hatte. \bibleverse{2} Und Mose redete mit den
...
sein. \bibleverse{10} Das Gelübde einer Witwe und Verstoßenen, alles
...
einem Eide verbindet über ihre Seele, \bibleverse{12} und ihr Mann hört
es, und schweigt dazu und wehrt es nicht, so gilt all dasselbe Gelübde
und alles Verbündnis, das sie auflegt ihrer Seele. \bibleverse{13}
...
\textsc{Herr} wird ihr gnädig sein. \bibleverse{14} Alle Gelübde und
Eide, die verbinden, den Leib zu kasteien, mag ihr Mann bekräftigen oder
aufheben also: \bibleverse{15} wenn er dazu schweigt von einem Tage zum
...
\bibleverse{16} wird er's aber aufheben, nachdem er's gehört hat, so
soll er ihre Missetat tragen. \bibleverse{17} Das sind die Satzungen,
die der \textsc{Herr} dem Mose geboten hat zwischen Mann und Weib,
zwischen Vater und Tochter, solange sie noch ledig ist in ihres Vaters
Hause. \# 31 \bibleverse{1} Und der \textsc{Herr} redete mit Mose und
sprach: \bibleverse{2} Räche die Kinder Israel an den Midianitern, dass
du darnach dich sammelst zu deinem Volk. \footnote{\textbf{31:2} 4Mo
  25,17; 4Mo 27,13} \bibleverse{3} Da redete Mose mit dem Volk und
sprach: Rüstet unter euch Leute zum Heer wider die Midianiter, dass sie
den \textsc{Herrn} rächen an den Midianitern, \bibleverse{4} aus
jeglichem Stamm 1000, dass ihr aus allen Stämmen Israels in das Heer
schickt. \bibleverse{5} Und sie nahmen aus den Tausenden Israels je 1000
eines Stammes, 12.000 gerüstet zum Heer. \bibleverse{6} Und Mose
schickte sie mit Pinehas, dem Sohn Eleasars, des Priesters, ins Heer und
die heiligen Geräte und die Halldrommeten in seiner Hand. \bibleverse{7}
...
Mose geboten hatte, und erwürgten alles, was männlich war. \footnote{\textbf{31:7}
  2Mo 20,13} \bibleverse{8} Dazu die Könige der Midianiter erwürgten sie
...
\bibleverse{9} Und die Kinder Israel nahmen gefangen die Weiber der
Midianiter und ihre Kinder; all ihr Vieh, alle ihre Habe und alle ihre
Güter raubten sie, \bibleverse{10} und verbrannten mit Feuer alle ihre
Städte ihrer Wohnung und alle Zeltdörfer. \bibleverse{11} Und nahmen
allen Raub und alles, was zu nehmen war, Menschen und Vieh,
\bibleverse{12} und brachten's zu Mose und zu Eleasar, dem Priester, und
...
das am Jordan liegt gegenüber Jericho. \bibleverse{13} Und Mose und
Eleasar, der Priester, und alle Fürsten der Gemeinde gingen ihnen
entgegen, hinaus vor das Lager. \bibleverse{14} Und Mose ward zornig
über die Hauptleute des Heeres, die Hauptleute über 1000 und über 100
waren, die aus dem Heer und Streit kamen, \bibleverse{15} und sprach zu
ihnen: Warum habt ihr alle Weiber leben lassen? \bibleverse{16} Siehe,
...
eine Plage der Gemeinde des \textsc{Herrn} widerfuhr? \footnote{\textbf{31:16}
  4Mo 25,1; Offb 2,14} \bibleverse{17} So erwürget nun alles, was
männlich ist unter den Kindern, und alle Weiber, die Männer erkannt und
beigelegen haben; \footnote{\textbf{31:17} Ri 21,11} \bibleverse{18}
aber alle Kinder, die weiblich sind und nicht Männer erkannt haben, die
lasst für euch leben. \bibleverse{19} Und lagert euch draußen vor dem
...
samt denen, die ihr gefangen genommen habt. \footnote{\textbf{31:19} 4Mo
  19,11} \bibleverse{20} Und alle Kleider und alles Gerät von Fellen und
...
dem Mose geboten hat: \bibleverse{22} Gold, Silber, Erz, Eisen, Zinn und
Blei \bibleverse{23} und alles was das Feuer leidet, sollt ihr durchs
...
Wasser gehen lassen. \bibleverse{24} Und sollt eure Kleider waschen am
siebenten Tage, so werdet ihr rein; darnach sollt ihr ins Lager kommen.
\bibleverse{25} Und der \textsc{Herr} redete mit Mose und sprach:
...
Gemeinde. \bibleverse{28} Du sollst aber dem \textsc{Herrn} heben von
den Kriegsleuten, die ins Heer gezogen sind, je von fünf Hunderten eine
Seele, an Menschen, Rindern, Eseln und Schafen. \bibleverse{29} Von
ihrer Hälfte sollst du es nehmen und dem Priester Eleasar geben zur Hebe
dem \textsc{Herrn}. \bibleverse{30} Aber von der Hälfte der Kinder
...
\bibleverse{33} 72.000 Rinder, \bibleverse{34} 61.000 Esel
\bibleverse{35} und der Mädchen, die nicht Männer erkannt hatten, 32.000
Seelen. \bibleverse{36} Und die Hälfte, die denen, welche ins Heer
gezogen waren, gehörte, war an der Zahl 337.500 Schafe; \bibleverse{37}
davon wurden dem \textsc{Herrn} 675 Schafe. \bibleverse{38} Desgleichen
36.000 Rinder; davon wurden dem \textsc{Herrn} 72. \bibleverse{39}
Desgleichen 30.500 Esel; davon wurden dem \textsc{Herrn} 61.
\bibleverse{40} Desgleichen Menschenseelen, 16.000 Seelen; davon wurden
dem \textsc{Herrn} 32 Seelen. \bibleverse{41} Und Mose gab solche Hebe
...
Kindern Israel zuteilte von den Kriegsleuten, \bibleverse{43} nämlich
die Hälfte, der Gemeinde zuständig, war auch 337.500 Schafe,
\bibleverse{44} 36.000 Rinder, \bibleverse{45} 30.500 Esel
\bibleverse{46} und 16.000 Menschenseelen. \bibleverse{47} Und Mose nahm
...
Mose geboten hatte. \bibleverse{48} Und es traten herzu die Hauptleute
über die Tausende des Kriegsvolks, nämlich die über 1000 und über 100
waren, zu Mose \bibleverse{49} und sprachen zu ihm: Deine Knechte haben
die Summe genommen der Kriegsleute, die unter unseren Händen gewesen
sind, und fehlt nicht einer. \bibleverse{50} Darum bringen wir dem
...
unsere Seelen versöhnt werden vor dem \textsc{Herrn}. \bibleverse{51}
Und Mose samt dem Priester Eleasar nahm von ihnen das Gold von allerlei
Geräte. \bibleverse{52} Und alles Goldes Hebe, das sie dem
\textsc{Herrn} hoben, war 16.750 Lot von den Hauptleuten über 1000 und
100. \bibleverse{53} Denn die Kriegsleute hatten geraubt ein jeglicher
für sich. \bibleverse{54} Und Mose mit Eleasar, dem Priester, nahm das
...
32 \bibleverse{1} Die Kinder Ruben und die Kinder Gad hatten sehr viel
...
\bibleverse{9} und da sie hinaufgekommen waren bis an den Bach Eskol und
...
\bibleverse{10} Und des \textsc{Herrn} Zorn ergrimmte zur selben Zeit,
und er schwur und sprach: \bibleverse{11} Diese Leute, die aus Ägypten
...
dass sie mir nicht treulich nachgefolgt sind; \bibleverse{12}
...
\bibleverse{13} Also ergrimmte des \textsc{Herrn} Zorn über Israel, und
...
\bibleverse{14} Und siehe, ihr seid aufgetreten an eurer Väter Statt,
dass der Sünder desto mehr seien und ihr auch den Zorn und Grimm des
\textsc{Herrn} noch mehr macht wider Israel. \bibleverse{15} Denn wo ihr
euch von ihm wendet, so wird er auch noch länger sie lassen in der
Wüste, und ihr werdet dies Volk alles verderben. \bibleverse{16} Da
traten sie herzu und sprachen: Wir wollen nur Schafhürden hier bauen für
unser Vieh und Städte für unsere Kinder; \bibleverse{17} wir aber wollen
...
um der Einwohner willen des Landes. \bibleverse{18} Wir wollen nicht
...
gefallen sein. \bibleverse{20} Mose sprach zu Ihnen: Wenn ihr das tun
wollt, dass ihr euch rüstet zum Streit vor dem \textsc{Herrn},
\footnote{\textbf{32:20} Jos 1,13-15} \bibleverse{21} so ziehet über den
Jordan vor dem \textsc{Herrn}, wer unter euch gerüstet ist, bis dass er
seine Feinde austreibe von seinem Angesicht \bibleverse{22} und das Land
...
und Hürden für euer Vieh und tut, was ihr geredet habt. \bibleverse{25}
Die Kinder Gad und die Kinder Ruben sprachen zu Mose: Deine Knechte
sollen tun, wie mein Herr geboten hat. \bibleverse{26} Unsere Kinder,
...
das Land Gilead zu eigen; \bibleverse{30} ziehen sie aber nicht mit euch
...
tun. \bibleverse{32} Wir wollen gerüstet ziehen vor dem \textsc{Herrn}
...
das Land samt den Städten in dem ganzen Gebiete umher. \footnote{\textbf{32:33}
  Jos 13,8-31} \bibleverse{34} Da bauten die Kinder Gad Dibon, Ataroth,
Aroer, \bibleverse{35} Atroth-Sophan, Jaser, Jogbeha, \bibleverse{36}
...
gaben den Städten Namen, die sie bauten. \bibleverse{39} Und die Kinder
Machirs, des Sohnes Manasses, gingen nach Gilead und gewannen's und
vertrieben die Amoriter, die darin waren. \bibleverse{40} Da gab Mose
...
Dörfer und hieß sie Dörfer Jairs. \bibleverse{42} Nobah ging hin und
gewann Knath mit seinen Ortschaften und hieß sie Nobah nach seinem
Namen. \# 33 \bibleverse{1} Das sind die Reisen der Kinder Israel, da
...
sahen, \footnote{\textbf{33:3} 2Mo 1,11; 2Mo 14,8} \bibleverse{4} als
...
Gericht geübt. \footnote{\textbf{33:4} 2Mo 12,12} \bibleverse{5} Als sie
von Raemses auszogen, lagerten sie sich in Sukkoth. \footnote{\textbf{33:5}
  2Mo 12,37} \bibleverse{6} Und zogen aus von Sukkoth und lagerten sich
in Etham, welches liegt an dem Ende der Wüste. \footnote{\textbf{33:6}
  2Mo 13,20} \bibleverse{7} Von Etham zogen sie aus und blieben in
Pihachiroth, welches liegt gegen Baal-Zephon, und lagerten sich gegen
Migdol. \footnote{\textbf{33:7} 2Mo 14,2} \bibleverse{8} Von Hachiroth
...
\footnote{\textbf{33:8} 2Mo 14,22; 2Mo 15,23} \bibleverse{9} Von Mara
...
zu trinken. \footnote{\textbf{33:14} 2Mo 17,1} \bibleverse{15} Von
Raphidim zogen sie aus und lagerten sich in der Wüste Sinai. \footnote{\textbf{33:15}
  2Mo 19,1} \bibleverse{16} Von Sinai zogen sie aus und lagerten sich
bei den Lustgräbern. \footnote{\textbf{33:16} 4Mo 11,34} \bibleverse{17}
Von den Lustgräbern zogen sie aus und lagerten sich in Hazeroth.
\footnote{\textbf{33:17} 4Mo 11,35} \bibleverse{18} Von Hazeroth zogen
sie aus und lagerten sich in Rithma. \footnote{\textbf{33:18} 4Mo 12,16}
\bibleverse{19} Von Rithma zogen sie aus und lagerten sich in
Rimmon-Perez. \bibleverse{20} Von Rimmon-Perez zogen sie aus und
lagerten sich in Libna. \bibleverse{21} Von Libna zogen sie aus und
lagerten sich in Rissa. \bibleverse{22} Von Rissa zogen sie aus und
lagerten sich in Kehelatha. \bibleverse{23} Von Kehelatha zogen sie aus
und lagerten sich im Gebirge Sepher. \bibleverse{24} Vom Gebirge Sepher
zogen sie aus und lagerten sich in Harada. \bibleverse{25} Von Harada
zogen sie aus und lagerten sich in Makheloth. \bibleverse{26} Von
Makheloth zogen sie aus und lagerten sich in Thahath. \bibleverse{27}
Von Thahath zogen sie aus und lagerten sich in Tharah. \bibleverse{28}
Von Tharah zogen sie aus und lagerten sich in Mithka. \bibleverse{29}
Von Mithka zogen sie aus und lagerten sich in Hasmona. \bibleverse{30}
Von Hasmona zogen sie aus und lagerten sich in Moseroth. \bibleverse{31}
Von Moseroth zogen sie aus und lagerten sich in Bne-Jaakan.
\bibleverse{32} Von Bne-Jaakan zogen sie aus und lagerten sich in
Horgidgad. \bibleverse{33} Von Horgidgad zogen sie aus und lagerten sich
in Jotbatha. \footnote{\textbf{33:33} 5Mo 10,7} \bibleverse{34} Von
Jotbatha zogen sie aus und lagerten sich in Abrona. \bibleverse{35} Von
Abrona zogen sie aus und lagerten sich in Ezeon-Geber. \bibleverse{36}
Von Ezeon-Geber zogen sie aus und lagerten sich in der Wüste Zin, das
ist Kades. \bibleverse{37} Von Kades zogen sie aus und lagerten sich an
dem Berge Hor, an der Grenze des Landes Edom. \footnote{\textbf{33:37}
  4Mo 20,22-29} \bibleverse{38} Da ging der Priester Aaron auf den Berg
...
Monats, \bibleverse{39} da er 123 Jahre alt war. \bibleverse{40} Und der
König der Kanaaniter zu Arad, der da wohnte gegen Mittag des Landes
Kanaan, hörte, dass die Kinder Israel kamen. \bibleverse{41} Und von dem
Berge Hor zogen sie aus und lagerten sich in Zalmona. \bibleverse{42}
Von Zalmona zogen sie aus und lagerten sich in Phunon. \bibleverse{43}
Von Phunon zogen sie aus und lagerten sich in Oboth. \footnote{\textbf{33:43}
  4Mo 21,10} \bibleverse{44} Von Oboth zogen sie aus und lagerten sich
in Ije-Abarim, in der Moabiter Gebiet. \footnote{\textbf{33:44} 4Mo
  21,11} \bibleverse{45} Von Ijim zogen sie aus und lagerten sich in
Dibon-Gad. \bibleverse{46} Von Dibon-Gad zogen sie aus und lagerten sich
in Almon-Diblathaim. \bibleverse{47} Von Almon-Diblathaim zogen sie aus
und lagerten sich in dem Gebirge Abarim vor dem Nebo. \footnote{\textbf{33:47}
  4Mo 21,20} \bibleverse{48} Von dem Gebirge Abarim zogen sie aus und
lagerten sich in das Gefilde der Moabiter an dem Jordan gegenüber
Jericho. \footnote{\textbf{33:48} 4Mo 22,1; 5Mo 32,49} \bibleverse{49}
...
\bibleverse{50} Und der \textsc{Herr} redete mit Mose in dem Gefilde der
Moabiter an dem Jordan gegenüber Jericho und sprach: \bibleverse{51}
Rede mit den Kindern Israel und sprich zu ihnen: Wenn ihr über den
Jordan gegangen seid in das Land Kanaan, \bibleverse{52} so sollt ihr
...
\bibleverse{53} dass ihr also das Land einnehmet und darin wohnet; denn
euch habe ich das Land gegeben, dass ihr's einnehmet. \bibleverse{54}
...
ihr's austeilen. \bibleverse{55} Werdet ihr aber die Einwohner des
...
\footnote{\textbf{33:55} Jos 23,13} \bibleverse{56} So wird's dann
gehen, dass ich euch gleich tun werde, wie ich gedachte ihnen zu tun. \#
34 \bibleverse{1} Und der \textsc{Herr} redete mit Mose und sprach:
...
\footnote{\textbf{34:3} Jos 15,1} \bibleverse{4} und das die Grenze sich
...
gehe durch Azmon \bibleverse{5} und lenke sich von Azmon an den Bach
Ägyptens, und ihr Ende sei an dem Meer. \bibleverse{6} Aber die Grenze
gegen Abend soll diese sein, nämlich das große Meer. Das sei eure Grenze
gegen Abend. \bibleverse{7} Die Grenze gegen Mitternacht soll diese
sein: ihr sollt messen von dem großen Meer bis an den Berg Hor,
\bibleverse{8} und von dem Berge Hor messen, bis man kommt gen Hamath,
dass der Ausgang der Grenze sei gen Zedad \bibleverse{9} und die Grenze
ausgehe gen Siphron und ihr Ende sei am Dorf Enan. Das sei eure Grenze
gegen Mitternacht. \bibleverse{10} Und sollt euch messen die Grenze
gegen Morgen vom Dorf Enan gen Sepham, \bibleverse{11} und die Grenze
...
\bibleverse{12} und komme herab an den Jordan, dass ihr Ende sei das
Salzmeer. Das sei euer Land mit seiner Grenze umher. \bibleverse{13} Und
...
den neun Stämmen und dem halben Stamm zu geben. \bibleverse{14} Denn der
...
genommen. \footnote{\textbf{34:14} 4Mo 32,33} \bibleverse{15} Also haben
die zwei Stämme und der halbe Stamm ihr Erbteil dahin, diesseits des
Jordans gegenüber Jericho gegen Morgen. \bibleverse{16} Und der
\textsc{Herr} redete mit Mose und sprach: \bibleverse{17} Das sind die
Namen der Männer, die das Land unter euch teilen sollen: der Priester
Eleasar und Josua, der Sohn Nuns. \bibleverse{18} Dazu sollt ihr nehmen
von einem jeglichen Stamm einen Fürsten, das Land auszuteilen.
\bibleverse{19} Und das sind der Männer Namen: Kaleb, der Sohn
Jephunnes, des Stammes Juda; \footnote{\textbf{34:19} 4Mo 13,6; 4Mo
  13,30} \bibleverse{20} Samuel, der Sohn Ammihuds, des Stammes Simeon;
\bibleverse{21} Elidad, der Sohn Chislons, des Stammes Benjamin;
\bibleverse{22} Bukki, der Sohn Joglis, Fürst des Stammes der Kinder
Dan; \bibleverse{23} Hanniel, der Sohn Ephods, Fürst des Stammes der
Kinder Manasse, von den Kindern Joseph; \bibleverse{24} Kemuel, der Sohn
Siphtans, Fürst des Stammes der Kinder Ephraim; \bibleverse{25}
Elizaphan, der Sohn Parnachs, Fürst des Stammes der Kinder Sebulon;
\bibleverse{26} Paltiel, der Sohn Assans, Fürst des Stammes der Kinder
Isaschar; \bibleverse{27} Ahihud, der Sohn Selomis, Fürst des Stammes
der Kinder Asser; \bibleverse{28} Pedahel, der Sohn Ammihuds, Fürst des
Stammes der Kinder Naphthali. \bibleverse{29} Dies sind die, denen der
\textsc{Herr} gebot, dass sie den Kindern Israel Erbe austeilten im
Lande Kanaan. \# 35 \bibleverse{1} Und der \textsc{Herr} redete mit Mose
auf den Gefilde der Moabiter am Jordan gegenüber Jericho und sprach:
\bibleverse{2} Gebiete den Kindern Israel, dass sie den Leviten Städte
geben von ihren Erbgütern zur Wohnung; \bibleverse{3} dazu die Vorstädte
...
haben. \bibleverse{4} Die Weite aber der Vorstädte, die ihr den Leviten
gebt, soll 1000 Ellen draußen vor der Stadtmauer umher haben.
\bibleverse{5} So sollt ihr nun messen außen an der Stadt von der Ecke
gegen Morgen 2000 Ellen und von der Ecke gegen Mittag 2000 Ellen und von
der Ecke gegen Abend 2000 Ellen und von der Ecke gegen Mitternacht 2000
...
\footnote{\textbf{35:6} 2Mo 21,13; 5Mo 4,41; 5Mo 19,2; 5Mo 19,9; Jos
  20,-1} \bibleverse{7} dass alle Städte, die ihr den Leviten gebt,
seien 48 mit ihren Vorstädten. \bibleverse{8} Und sollt derselben desto
...
\bibleverse{10} Rede mit den Kindern Israel und sprich zu ihnen: Wenn
ihr über den Jordan ins Land Kanaan kommt, \bibleverse{11} sollt ihr
Städte auswählen, dass sie Freistädte seien, wohin fliehe, wer einen
Totschlag unversehens tut. \bibleverse{12} Und sollen unter euch solche
...
gestanden sei. \bibleverse{13} Und der Städte, die ihr geben werdet zu
Freistädten, sollen sechs sein. \bibleverse{14} Drei sollt ihr geben
diesseits des Jordans und drei im Lande Kanaan. \bibleverse{15} Das sind
...
unversehens. \bibleverse{16} Wer jemand mit einem Eisen schlägt, dass er
stirbt, der ist ein Totschläger und soll des Todes sterben.
\bibleverse{17} Wirft er ihn mit einem Stein, mit dem jemand mag getötet
werden, dass er davon stirbt, so ist er ein Totschläger und soll des
Todes sterben. \bibleverse{18} Schlägt er ihn aber mit einem Holz, mit
dem jemand mag totgeschlagen werden, dass er stirbt, so ist er ein
Totschläger und soll des Todes sterben. \bibleverse{19} Der Rächer des
Bluts soll den Totschläger zum Tode bringen; wo er ihm begegnet, soll er
ihn töten. \bibleverse{20} Stößt er ihn aus Hass oder wirft etwas auf
ihn aus List, dass er stirbt, \bibleverse{21} oder schlägt ihn aus
...
des Bluts soll ihn zum Tode bringen, wo er ihm begegnet. \bibleverse{22}
Wenn er ihn aber ungefähr stößt, ohne Feindschaft, oder wirft irgend
etwas auf ihn unversehens \bibleverse{23} oder wirft irgendeinen Stein
...
\bibleverse{24} so soll die Gemeinde richten zwischen dem, der
geschlagen hat, und dem Rächer des Bluts nach diesen Rechten.
\bibleverse{25} Und die Gemeinde soll den Totschläger erretten von der
...
\footnote{\textbf{35:25} 3Mo 21,10} \bibleverse{26} Wird aber der
Totschläger aus seiner Freistadt Grenze gehen, dahin er geflohen ist,
\bibleverse{27} und der Bluträcher findet ihn außerhalb der Grenze
seiner Freistadt und schlägt ihn tot, so soll er des Bluts nicht
schuldig sein. \bibleverse{28} Denn er sollte in seiner Freistadt
bleiben bis an den Tod des Hohenpriesters, und nach des Hohenpriesters
Tod wieder zum Lande seines Erbguts kommen. \bibleverse{29} Das soll
euch ein Recht sein bei euren Nachkommen, überall, wo ihr wohnt.
\bibleverse{30} Den Totschläger soll man töten nach dem Mund zweier
Zeugen. Ein Zeuge soll nicht aussagen über eine Seele zum Tode.
\bibleverse{31} Und ihr sollt keine Versühnung nehmen für die Seele des
Totschlägers; denn er ist des Todes schuldig, und er soll des Todes
sterben. \bibleverse{32} Und sollt keine Versühnung nehmen für den, der
zur Freistadt geflohen ist, dass er wiederkomme, zu wohnen im Lande, bis
der Priester sterbe. \bibleverse{33} Und schändet das Land nicht, darin
...
außer durch das Blut des, der es vergossen hat. \footnote{\textbf{35:33}
  1Mo 9,6} \bibleverse{34} Verunreinigt das Land nicht, darin ihr
...
\bibleverse{3} Wenn sie jemand aus den Stämmen der Kinder Israel zu
...
also wird das Los unseres Erbteils verringert. \bibleverse{4} Wenn nun
...
unserer Väter verringert, so viel sie haben. \bibleverse{5} Mose gebot
den Kindern Israel nach dem Befehl des \textsc{Herrn} und sprach: Der
Stamm der Kinder Joseph hat recht geredet. \bibleverse{6} Das ist's, was
