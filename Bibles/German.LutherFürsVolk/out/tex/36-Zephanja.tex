...
\footnote{\textbf{1:1} Jer 1,2} \bibleverse{2} Ich will alles aus dem
Lande wegnehmen, spricht der \textsc{Herr}. \bibleverse{3} Ich will
...
aus dem Lande, spricht der \textsc{Herr}. \bibleverse{4} Ich will meine
...
\bibleverse{5} und die, die auf den Dächern des Himmels Heer anbeten;
die es anbeten und schwören doch bei dem \textsc{Herrn} und zugleich bei
Milkom; \footnote{\textbf{1:5} Jer 19,13; Jer 49,1} \bibleverse{6} und
die vom \textsc{Herrn} abfallen, und die nach dem \textsc{Herrn} nichts
fragen und ihn nicht achten. \bibleverse{7} Seid still vor dem Herrn
\textsc{Herrn}, denn des \textsc{Herrn} Tag ist nahe; denn der
\textsc{Herr} hat ein Schlachtopfer zubereitet und seine Gäste dazu
geladen. \footnote{\textbf{1:7} Hab 2,20} \bibleverse{8} Und am Tage des
...
werden, als wäre es Staub, und ihr Leib als wäre es Kot. \bibleverse{18}
...
\textsc{Herrn} möget verborgen werden. \bibleverse{4} Denn Gaza muss
verlassen und Askalon wüst werden; Asdod soll am Mittag vertrieben und
Ekron ausgewurzelt werden. \bibleverse{5} Weh denen, die am Meer hinab
...
niemand mehr da wohnen soll. \bibleverse{6} Es sollen am Meer hinab
eitel Hirtenhäuser und Schafhürden sein. \bibleverse{7} Und dasselbe
...
Gefängnis gewendet hat. \footnote{\textbf{2:7} Zeph 3,20} \bibleverse{8}
...
\footnote{\textbf{2:8} Jer 48,-1; Jer 49,1} \bibleverse{9} Wohlan, so
...
sollen sie erben. \footnote{\textbf{2:9} 1Mo 19,24} \bibleverse{10} Das
soll ihnen begegnen für ihre Hoffart, dass sie des \textsc{Herrn}
Zebaoth Volk geschmäht und sich gerühmt haben. \bibleverse{11}
...
Heiden, ein jeglicher an seinem Ort. \bibleverse{12} Auch sollt ihr
Mohren durch mein Schwert erschlagen werden. \bibleverse{13} Und er wird
...
öde machen, dürr wie eine Wüste, \footnote{\textbf{2:13} Jes 13,21; Jes
  34,11} \bibleverse{14} dass darin sich lagern werden allerlei Tiere
...
werden. \bibleverse{15} Das ist die fröhliche Stadt, die so sicher
...
pfeift sie an und klatscht mit der Hand über sie. \# 3 \bibleverse{1}
Weh der gräulichen, unflätigen, tyrannischen Stadt! \bibleverse{2} Sie
...
\^{}\^{} \bibleverse{4} Ihre Propheten sind leichtfertig und Verächter;
ihre Priester entweihen das Heiligtum und deuten das Gesetz freventlich.
\^{}\^{} \bibleverse{5} Der \textsc{Herr}, der unter ihnen ist, ist
...
schämen lernen. \bibleverse{6} Ich habe Völker ausgerottet, ihre
...
\bibleverse{7} Ich ließ dir sagen: Mich sollst du fürchten und dich
...
Bosheit zu üben. \bibleverse{8} Darum, spricht der \textsc{Herr}, müsset
...
\^{}\^{} \bibleverse{9} Alsdann will ich den Völkern reine Lippen geben,
dass sie alle sollen des \textsc{Herrn} Namen anrufen und ihm
einträchtig dienen. \bibleverse{10} Man wird mir meine Anbeter, mein
zerstreutes Volk, von jenseits des Wassers im Mohrenlande herbeibringen
zum Geschenk. \bibleverse{11} Zur selben Zeit wirst du dich nicht mehr
...
überheben auf meinem heiligen Berge. \bibleverse{12} Ich will in dir
lassen übrigbleiben ein armes, geringes Volk; die werden auf des
\textsc{Herrn} Namen trauen. \^{}\^{} \bibleverse{13} Die Übrigen in
...
ruhen ohne alle Furcht. \bibleverse{14} Jauchze, du Tochter Zion! Rufe,
Israel! Freue dich und sei fröhlich von ganzem Herzen, du Tochter
Jerusalem! \bibleverse{15} denn der \textsc{Herr} hat deine Strafe
...
darfst. \bibleverse{16} Zur selben Zeit wird man sprechen zu Jerusalem:
Fürchte dich nicht! und zu Zion: Lass deine Hände nicht lass werden!
\bibleverse{17} denn der \textsc{Herr}, dein Gott, ist bei dir, ein
