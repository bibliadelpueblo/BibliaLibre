...
\bibleverse{2} Und er sprach: Der \textsc{Herr} wird aus Zion brüllen
...
\bibleverse{7} sondern ich will ein Feuer in die Mauern zu Gaza
schicken, das soll ihre Paläste verzehren. \bibleverse{8} Und ich will
...
\textsc{Herr}. \# 2 \bibleverse{1} So spricht der \textsc{Herr}: Um drei
...
\bibleverse{2} sondern ich will ein Feuer schicken nach Moab, das soll
die Paläste zu Karioth verzehren; und Moab soll sterben im Getümmel und
Geschrei und Posaunenhall. \bibleverse{3} Und ich will den Richter unter
...
\footnote{\textbf{2:8} 2Mo 22,25} \bibleverse{9} Und ich habe doch den
...
unten seine Wurzel. \footnote{\textbf{2:9} 4Mo 21,21-28} \bibleverse{10}
Auch habe ich euch aus Ägyptenland geführt und vierzig Jahre in der
Wüste geleitet, dass ihr der Amoriter Land besäßet. \bibleverse{11} Und
...
\textsc{Herr}. \bibleverse{12} So gebt ihr den Geweihten Wein zu trinken
und gebietet den Propheten und sprecht: Ihr sollt nicht weissagen!
\footnote{\textbf{2:12} Am 7,13; Am 1,7-16; Jer 11,21} \bibleverse{13}
Siehe, ich will's unter euch knarren machen, wie ein Wagen voll Garben
knarrt, \bibleverse{14} dass der, der schnell ist, soll nicht entfliehen
noch der Starke etwas vermögen und der Mächtige nicht soll sein Leben
erretten können; \bibleverse{15} und die Bogenschützen sollen nicht
bestehen, und der schnell laufen kann, soll nicht entlaufen, und der da
reitet, soll sein Leben nicht erretten; \bibleverse{16} und der unter
den Starken der mannhafteste ist, soll nackt entfliehen müssen zu der
Zeit, spricht der \textsc{Herr}. \# 3 \bibleverse{1} Höret, was der
\textsc{Herr} mit euch redet, ihr Kinder Israel, mit allen
Geschlechtern, die ich aus Ägyptenland geführt habe: \bibleverse{2} Aus
allen Geschlechtern auf Erden habe ich allein euch erkannt; darum will
ich auch euch heimsuchen in all eurer Missetat. \bibleverse{3} Mögen
auch zwei miteinander wandeln, sie seien denn eins untereinander?
\bibleverse{4} Brüllt auch ein Löwe im Walde, wenn er keinen Raub hat?
Schreit auch ein junger Löwe aus seiner Höhle, er habe denn etwas
gefangen? \bibleverse{5} Fällt auch ein Vogel in den Strick auf der
Erde, da kein Vogler ist? Hebt man auch den Strick auf von der Erde, der
noch nichts gefangen hat? \bibleverse{6} Bläst man auch die Posaune in
...
Unglück in der Stadt, dass der \textsc{Herr} nicht tue? \footnote{\textbf{3:6}
  Jes 45,7; Kla 3,37} \bibleverse{7} Denn der Herr \textsc{Herr} tut
...
\textsc{Herr} redet; wer sollte nicht weissagen? \bibleverse{9}
...
großes Zetergeschrei und Unrecht darin ist! \bibleverse{10} Sie achten
...
Häuser verderbt werden, spricht der \textsc{Herr}. \# 4 \bibleverse{1}
...
euren Herren: Bringe her, lass uns saufen! \bibleverse{2} Der Herr
...
werden, spricht der \textsc{Herr}. \bibleverse{4} Ja, kommt her gen
...
Tages, \footnote{\textbf{4:4} 5Mo 14,28} \bibleverse{5} und räuchert vom
...
\textsc{Herr}. \footnote{\textbf{4:5} 3Mo 2,11} \bibleverse{6} Darum
...
verdorrte. \footnote{\textbf{4:7} 1Kö 17,1} \bibleverse{8} Und es zogen
...
spricht der \textsc{Herr}. \bibleverse{9} Ich plagte euch mit dürrer
...
\textsc{Herr}. \footnote{\textbf{4:10} 2Mo 9,3} \bibleverse{11} Ich
...
euch nicht zu mir, spricht der \textsc{Herr}. \footnote{\textbf{4:11}
  1Mo 19,24-25; Sach 3,2} \bibleverse{12} Darum will ich dir weiter also
tun, Israel. Weil ich denn dir also tun will, so schicke dich, Israel,
und begegne deinem Gott. \bibleverse{13} Denn siehe, er ist's, der die
...
Gerechtigkeit zu Boden stoßt. \bibleverse{8} Er macht die Plejaden und
...
den Erdboden: er heißt \textsc{Herr}; \footnote{\textbf{5:8} Hi 38,31;
  Am 9,6} \bibleverse{9} der über den Starken eine Verstörung anrichtet
und bringt eine Verstörung über die feste Stadt. \bibleverse{10} Aber
sie sind dem gram, der sie im Tor straft, und halten den für einen
Gräuel, der heilsam lehrt. \bibleverse{11} Darum, weil ihr die Armen
...
\footnote{\textbf{5:11} Zeph 1,13} \bibleverse{12} Denn ich weiß euer
...
ist eine böse Zeit. \bibleverse{14} Suchet das Gute und nicht das Böse,
auf dass ihr leben möget, so wird der \textsc{Herr}, der Gott Zebaoth,
bei euch sein, wie ihr rühmet. \bibleverse{15} Hasset das Böse und
...
und nicht Licht. \footnote{\textbf{5:18} Joe 2,11} \bibleverse{19}
...
eine Schlange stäche ihn. \bibleverse{20} Denn des \textsc{Herrn} Tag
...
der Gott Zebaoth heißt. \# 6 \bibleverse{1} Weh den Stolzen zu Zion und
...
\bibleverse{2} Gehet hin gen Kalne und schauet, und von da gen Hamath,
...
Grenze. \bibleverse{3} Die ihr euch weit vom bösen Tag achtet und
...
Kälber, \footnote{\textbf{6:4} Am 3,15} \bibleverse{5} und spielet auf
dem Psalter und erdichtet euch Lieder wie David, \footnote{\textbf{6:5}
  Jes 5,12} \bibleverse{6} und trinket Wein aus den Schalen und salbet
...
Galle und die Frucht der Gerechtigkeit in Wermut \footnote{\textbf{6:12}
  Am 5,7} \bibleverse{13} und tröstet euch des, das so gar nichts ist,
...
der Wüste. \# 7 \bibleverse{1} Der Herr \textsc{Herr} zeigte mir ein
...
hatte mähen lassen. \bibleverse{2} Als sie nun das Kraut im Lande gar
...
und weissage meinem Volk Israel! \bibleverse{16} So höre nun des
\textsc{Herrn} Wort. Du sprichst: Weissage nicht wider Israel und
predige nicht wider das Haus Isaak! \bibleverse{17} Darum spricht der
...
werden. \# 8 \bibleverse{1} Der Herr \textsc{Herr} zeigte mir ein
...
ich solcher ihrer Werke ewig vergessen werde? \bibleverse{8} Sollte
...
\footnote{\textbf{8:10} Jer 6,26} \bibleverse{11} Siehe, es kommt die
...
sondern nach dem Wort des \textsc{Herrn}, zu hören; \bibleverse{12} dass
...
werden. \footnote{\textbf{8:12} Mi 3,7} \bibleverse{13} Zu der Zeit
werden die schönen Jungfrauen und die Jünglinge verschmachten vor Durst,
\bibleverse{14} die jetzt schwören bei dem Fluch Samarias und sprechen:
...
Unglück und nicht zum Guten. \^{}\^{} \bibleverse{5} Denn der Herr
...
dem Fluss Ägyptens. \^{}\^{} \bibleverse{6} Er ist's, der seinen Saal in
...
\^{}\^{} \bibleverse{7} Seid ihr Kinder Israel mir nicht gleichwie die
...
Unglück nicht so nahe sein noch uns begegnen. \^{}\^{} \bibleverse{11}
