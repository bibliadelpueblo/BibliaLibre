...
\bibleverse{8} Wir wissen aber, dass das Gesetz gut ist, so es jemand
recht braucht \bibleverse{9} und weiß solches, dass dem Gerechten kein
...
Vatermördern und Muttermördern, den Totschlägern \footnote{\textbf{1:9}
  1Kor 6,9-11} \bibleverse{10} den Hurern, den Knabenschändern, den
...
\bibleverse{18} Dies Gebot befehle ich dir, mein Sohn Timotheus, nach
den vorigen Weissagungen über dich, dass du in ihnen eine gute
Ritterschaft übest \bibleverse{19} und habest den Glauben und gutes
...
\bibleverse{8} Desgleichen die Diener sollen ehrbar sein, nicht
...
\footnote{\textbf{3:9} 1Tim 1,19} \bibleverse{10} Und diese lasse man
zuvor versuchen; darnach lasse man sie dienen, wenn sie unsträflich
sind. \bibleverse{11} Desgleichen ihre Weiber sollen ehrbar sein, nicht
Lästerinnen, nüchtern, treu in allen Dingen. \bibleverse{12} Die Diener
lass einen jeglichen sein eines Weibes Mann, die ihren Kindern wohl
vorstehen und ihren eigenen Häusern. \bibleverse{13} Welche aber wohl
...
\bibleverse{12} Niemand verachte deine Jugend; sondern sei ein Vorbild
...
\bibleverse{3} Ehre die Witwen, welche rechte Witwen sind.
\bibleverse{4} So aber eine Witwe Enkel oder Kinder hat, solche lass
...
\bibleverse{5} Das ist aber eine rechte Witwe, die einsam ist, die ihre
Hoffnung auf Gott stellt und bleibt am Gebet und Flehen Tag und Nacht.
\footnote{\textbf{5:5} Lk 2,37} \bibleverse{6} Welche aber in Wollüsten
lebt, die ist lebendig tot. \bibleverse{7} Solches gebiete, auf dass sie
...
\bibleverse{9} Lass keine Witwe erwählt werden unter sechzig Jahren, und
die da gewesen sei eines Mannes Weib, \bibleverse{10} und die ein
...
\bibleverse{19} Wider einen Ältesten nimm keine Klage an ohne zwei oder
...
\bibleverse{2} Welche aber gläubige Herren haben, sollen sie nicht
...
Lästerung, böser Argwohn. \footnote{\textbf{6:4} 2Tim 2,14; Tit 3,10;
  Tit 1,3-11} \bibleverse{5} Schulgezänke solcher Menschen, die
...
\bibleverse{6} Es ist aber ein großer Gewinn, wer gottselig ist und
lässet sich genügen. \bibleverse{7} Denn wir haben nichts in die Welt
gebracht; darum offenbar ist, wir werden auch nichts hinausbringen.
\bibleverse{8} Wenn wir aber Nahrung und Kleider haben, so lasset uns
genügen. \footnote{\textbf{6:8} Spr 30,8} \bibleverse{9} Denn die da
...
vor vielen Zeugen. \footnote{\textbf{6:12} 1Tim 1,18; 1Tim 4,14; 1Kor
  9,25-26; 2Tim 4,7; Hebr 3,1} \bibleverse{13} Ich gebiete dir vor Gott,
...
Pilatus bezeugt hat ein gutes Bekenntnis, \footnote{\textbf{6:13} Joh
  18,36-37; Offb 1,5} \bibleverse{14} dass du haltest das Gebot ohne
...
Gewaltige, der König aller Könige und Herr aller Herren, \footnote{\textbf{6:15}
  5Mo 10,17; Offb 17,14} \bibleverse{16} der allein Unsterblichkeit hat,
...
\footnote{\textbf{6:17} Ps 62,11; Lk 12,15-21} \bibleverse{18} dass sie
Gutes tun, reich werden an guten Werken, gern geben, behilflich seien,
\bibleverse{19} Schätze sammeln, sich selbst einen guten Grund aufs
...
Kunst, \^{}\^{} \bibleverse{21} welche etliche vorgeben und gehen vom
