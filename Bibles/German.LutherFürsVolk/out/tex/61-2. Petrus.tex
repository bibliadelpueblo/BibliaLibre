...
berufen hat durch seine Herrlichkeit und Tugend, \footnote{\textbf{1:3}
  1Petr 2,9} \bibleverse{4} durch welche uns die teuren und allergrößten
...
\bibleverse{5} so wendet allen euren Fleiß daran und reichet dar in
eurem Glauben Tugend und in der Tugend Erkenntnis \bibleverse{6} und in
der Erkenntnis Mäßigkeit und in der Mäßigkeit Geduld und in der Geduld
Gottseligkeit \bibleverse{7} und in der Gottseligkeit brüderliche Liebe
und in der brüderlichen Liebe allgemeine Liebe. \footnote{\textbf{1:7}
  Gal 6,10} \bibleverse{8} Denn wo solches reichlich bei euch ist,
...
dieser Hütte bin, euch zu erinnern und zu erwecken; \footnote{\textbf{1:13}
  2Kor 5,1} \bibleverse{14} denn ich weiß, dass ich meine Hütte bald
ablegen muss, wie mir denn auch unser Herr Jesus Christus eröffnet hat.
\footnote{\textbf{1:14} Joh 21,18-19} \bibleverse{15} Ich will aber
...
\bibleverse{18} Und diese Stimme haben wir gehört vom Himmel geschehen,
...
geredet, getrieben von dem heiligen Geist. \# 2 \bibleverse{1} Es waren
...
herbeiführen eine schnelle Verdammnis. \footnote{\textbf{2:1} Mt 24,11;
  1Tim 4,1} \bibleverse{2} Und viele werden nachfolgen ihrem Verderben;
um welcher willen wird der Weg der Wahrheit verlästert werden.
\bibleverse{3} Und durch Geiz mit erdichteten Worten werden sie an euch
...
Gottlosen, die hernach kommen würden; \footnote{\textbf{2:6} 1Mo
  19,24-25} \bibleverse{7} und hat erlöst den gerechten Lot, welchem die
schändlichen Leute alles Leid taten mit ihrem unzüchtigen Wandel;
\bibleverse{8} denn dieweil er gerecht war und unter ihnen wohnte, dass
er's sehen und hören musste, quälten sie die gerechte Seele von Tag zu
Tage mit ihren ungerechten Werken. \bibleverse{9} Der Herr weiß die
Gottseligen aus der Versuchung zu erlösen, die Ungerechten aber zu
behalten zum Tage des Gerichts, sie zu peinigen, \bibleverse{10}
...
vor dem Herrn. \bibleverse{12} Aber sie sind wie die unvernünftigen
...
ihrem verderblichen Wesen umkommen \bibleverse{13} und den Lohn der
...
prassen mit dem Euren, \bibleverse{14} haben Augen voll Ehebruchs,
...
\bibleverse{15} Sie haben verlassen den richtigen Weg und gehen irre und
...
kehren von dem heiligen Gebot, das ihnen gegeben ist. \footnote{\textbf{2:21}
  Lk 12,47-48} \bibleverse{22} Es ist ihnen widerfahren das wahre
...
\footnote{\textbf{3:1} 2Petr 1,13} \bibleverse{2} dass ihr gedenket an
...
\bibleverse{3} Und wisset das aufs erste, dass in den letzten Tagen
kommen werden Spötter, die nach ihren eigenen Lüsten wandeln
\bibleverse{4} und sagen: Wo ist die Verheißung seiner Zukunft? denn
...
der Kreatur gewesen ist. \footnote{\textbf{3:4} Jes 5,19; Hes 12,22; Mt
  24,48} \bibleverse{5} Aber aus Mutwillen wollen sie nicht wissen, dass
...
bestanden durch Gottes Wort; \footnote{\textbf{3:5} Mt 24,38; 1Mo 1,2;
  1Mo 1,6; 1Mo 1,9; Ps 24,2} \bibleverse{6} dennoch ward zu der Zeit die
Welt durch dieselben mit der Sintflut verderbt. \footnote{\textbf{3:6}
  2Petr 2,5; 1Mo 7,21} \bibleverse{7} Also auch der Himmel, der jetzund
...
\footnote{\textbf{3:9} Hab 2,3; 1Tim 2,4} \bibleverse{10} Es wird aber
...
erfunden werdet; \^{}\^{} \bibleverse{15} und die Geduld unseres Herrn
achtet für eure Seligkeit, wie auch unser lieber Bruder Paulus nach der
Weisheit, die ihm gegeben ist, euch geschrieben hat, \bibleverse{16} wie
...
\bibleverse{17} Ihr aber, meine Lieben, weil ihr das zuvor wisset, so
...
\bibleverse{18} Wachset aber in der Gnade und Erkenntnis unseres Herrn
