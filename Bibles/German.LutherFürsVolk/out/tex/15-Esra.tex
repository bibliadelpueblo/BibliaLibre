...
außer dem, Was sie freiwillig gaben. \bibleverse{7} Und der König Kores
...
\bibleverse{8} Aber Kores, der König in Persien, tat sie heraus durch
Mithredath, den Schatzmeister; der zählte sie dar Sesbazar, dem Fürsten
Judas. \bibleverse{9} Und dies ist ihre Zahl: 30 goldene Becken und 1000
...
Babel heraufzogen gen Jerusalem. \# 2 \bibleverse{1} Dies sind die
...
Städte und alles Israel in seine Städte. \# 3 \bibleverse{1} Und da
herbeikam der siebente Monat und die Kinder Israel nun in ihren Städten
waren, kam das Volk zusammen wie ein Mann gen Jerusalem. \bibleverse{2}
...
geschrieben steht im Gesetz Moses, des Mannes Gottes, \footnote{\textbf{3:2}
  Esr 2,2; 1Chr 3,17-19; 2Mo 27,1; 3Mo 6,2} \bibleverse{3} und richteten
...
darauf des Morgens und des Abends. \bibleverse{4} Und hielten der
...
\bibleverse{5} darnach auch die täglichen Brandopfer und der Neumonde
...
\bibleverse{6} Am ersten Tage des siebenten Monats fingen sie an, dem
\textsc{Herrn} Brandopfer zu tun. Aber der Grund des Tempels des
\textsc{Herrn} war noch nicht gelegt. \bibleverse{7} Sie gaben aber Geld
...
des Königs in Persien. \# 5 \bibleverse{1} Es weissagten aber die
...
und Jerusalem waren, im Namen des Gottes Israels. \footnote{\textbf{5:1}
  Haggai 1,1; Sach 1,1} \bibleverse{2} Da machten sich auf Serubabel,
...
des Königs Meinung darüber. \# 6 \bibleverse{1} Da befahl der König
Darius, dass man suchen sollte in der Kanzlei im Schatzhause des Königs,
die zu Babel lag. \bibleverse{2} Da fand man zu Ahmetha im Schloss, das
in Medien liegt, ein Buch, und stand also darin eine Geschichte
geschrieben: \bibleverse{3} Im ersten Jahr des Königs Kores befahl der
...
60 Ellen; \bibleverse{4} und drei Reihen von behauenen Steinen und eine
Reihe von Holz; und die Kosten sollen vom Hause des Königs gegeben
werden; \bibleverse{5} dazu die goldenen und silbernen Gefäße des Hauses
...
gen Jerusalem, im siebenten Jahr Arthahsasthas, des Königs. \footnote{\textbf{7:7}
  Esr 2,43} \bibleverse{8} Und er kam gen Jerusalem im fünften Monat,
