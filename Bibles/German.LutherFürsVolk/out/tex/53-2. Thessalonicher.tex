...
\footnote{\textbf{1:1} 1Thes 1,1} \bibverse{2} Gnade sei mit euch und
...
jeglichen unter euch allen nimmt zu gegeneinander, \bibverse{4} also
...
\footnote{\textbf{1:4} 2Kor 7,4} \bibverse{5} welches anzeigt, dass Gott
recht richten wird und ihr würdig werdet zum Reich Gottes, für das ihr
auch leidet; \footnote{\textbf{1:5} Phil 1,28} \bibverse{6} nach dem es
recht ist bei Gott, zu vergelten Trübsal denen, die euch Trübsal antun,
\footnote{\textbf{1:6} Röm 12,19; Offb 18,6-7} \bibverse{7} euch aber,
...
offenbart werden vom Himmel samt den Engeln seiner Kraft \footnote{\textbf{1:7}
  Mt 16,27; Mt 25,31-46; 1Thes 4,16} \bibverse{8} und mit Feuerflammen,
...
\footnote{\textbf{1:8} Röm 2,8} \bibverse{9} welche werden Pein leiden,
das ewige Verderben von dem Angesichte des Herrn und von seiner
herrlichen Macht, \bibverse{10} wenn er kommen wird, dass er herrlich
...
\bibverse{11} Und derhalben beten wir auch allezeit für euch, dass unser
Gott euch würdig mache der Berufung und erfülle alles Wohlgefallen der
Güte und das Werk des Glaubens in der Kraft, \bibverse{12} auf dass an
...
werde der Mensch der Sünde, das Kind des Verderbens, \footnote{\textbf{2:3}
  1Tim 4,1; 1Jo 2,18} \bibverse{4} der da ist der Widersacher und sich
...
\footnote{\textbf{2:4} Mt 24,15; Dan 11,36} \bibverse{5} Gedenket ihr
...
lügenhaftigen Kräften und Zeichen und Wundern \footnote{\textbf{2:9} Mt
  24,24; Offb 13,11-14} \bibverse{10} und mit allerlei Verführung zur
...
\bibverse{11} Darum wird ihnen Gott kräftige Irrtümer senden, dass sie
glauben der Lüge, \bibverse{12} auf dass gerichtet werden alle, die der
Wahrheit nicht glauben, sondern haben Lust an der Ungerechtigkeit.

\bibverse{13} Wir aber sollen Gott danken allezeit um euch, vom Herrn
...
der Heiligung des Geistes und im Glauben der Wahrheit, \footnote{\textbf{2:13}
  Röm 8,30} \bibverse{14} darein er euch berufen hat durch unser
...
\bibverse{2} und dass wir erlöst werden von den unverständigen und argen
Menschen. Denn der Glaube ist nicht jedermanns Ding. \bibverse{3} Aber
der Herr ist treu; der wird euch stärken und bewahren vor dem Argen.
\bibverse{4} Wir versehen uns aber zu euch in dem Herrn, dass ihr tut
und tun werdet, was wir euch gebieten. \footnote{\textbf{3:4} 2Kor 7,16;
  Gal 5,10} \bibverse{5} Der Herr aber richte eure Herzen zu der Liebe
Gottes und zu der Geduld Christi.

\bibverse{6} Wir gebieten euch aber, liebe Brüder, in dem Namen unseres
...
\footnote{\textbf{3:7} 1Thes 1,6} \bibverse{8} haben auch nicht umsonst
...
\footnote{\textbf{3:8} 1Thes 2,9} \bibverse{9} Nicht darum, dass wir des
...
\bibverse{10} Und da wir bei euch waren, geboten wir euch solches, dass,
wenn jemand nicht will arbeiten, der soll auch nicht essen. \footnote{\textbf{3:10}
  1Mo 3,19; 2Mo 20,9} \bibverse{11} Denn wir hören, dass etliche unter
...
tun. \footnote{\textbf{3:13} Gal 6,9} \bibverse{14} So aber jemand nicht
gehorsam ist unserem Wort, den zeiget an durch einen Brief, und habt
nichts mit ihm zu schaffen, auf dass er schamrot werde; \bibverse{15}
