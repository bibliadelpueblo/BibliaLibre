...
ihr auch leidet; \footnote{\textbf{1:5} Phil 1,28} \bibleverse{6} nach
dem es recht ist bei Gott, zu vergelten Trübsal denen, die euch Trübsal
antun, \footnote{\textbf{1:6} Röm 12,19; Offb 18,6-7} \bibleverse{7}
...
\footnote{\textbf{1:7} Mt 16,27; Mt 25,31-46; 1Thes 4,16} \bibleverse{8}
...
Christi, \footnote{\textbf{1:8} Röm 2,8} \bibleverse{9} welche werden
Pein leiden, das ewige Verderben von dem Angesichte des Herrn und von
seiner herrlichen Macht, \bibleverse{10} wenn er kommen wird, dass er
...
werde der Mensch der Sünde, das Kind des Verderbens, \footnote{\textbf{2:3}
  1Tim 4,1; 1Jo 2,18} \bibleverse{4} der da ist der Widersacher und sich
...
\footnote{\textbf{2:4} Mt 24,15; Dan 11,36} \bibleverse{5} Gedenket ihr
nicht daran, dass ich euch solches sagte, da ich noch bei euch war?
\bibleverse{6} Und was es noch aufhält, wisset ihr, dass er offenbart
werde zu seiner Zeit. \bibleverse{7} Denn es regt sich bereits das
Geheimnis der Bosheit, nur dass, der es jetzt aufhält, muss hinweggetan
werden; \bibleverse{8} und alsdann wird der Boshafte offenbart werden,
welchen der Herr umbringen wird mit dem Geist seines Mundes und durch
die Erscheinung seiner Zukunft ihm ein Ende machen, \bibleverse{9} ihm,
...
lügenhaftigen Kräften und Zeichen und Wundern \footnote{\textbf{2:9} Mt
  24,24; Offb 13,11-14} \bibleverse{10} und mit allerlei Verführung zur
...
stärke euch in allerlei Lehre und gutem Werk. \# 3 \bibleverse{1}
...
gepriesen werde wie bei euch, \footnote{\textbf{3:1} Kol 4,3; Eph
  6,18-19; 1Thes 5,25} \bibleverse{2} und dass wir erlöst werden von den
unverständigen und argen Menschen. Denn der Glaube ist nicht jedermanns
Ding. \bibleverse{3} Aber der Herr ist treu; der wird euch stärken und
bewahren vor dem Argen. \bibleverse{4} Wir versehen uns aber zu euch in
dem Herrn, dass ihr tut und tun werdet, was wir euch gebieten.
\footnote{\textbf{3:4} 2Kor 7,16; Gal 5,10} \bibleverse{5} Der Herr aber
...
beschwerlich wären. \footnote{\textbf{3:8} 1Thes 2,9} \bibleverse{9}
...
zum Vorbilde euch gäben, uns nachzufolgen. \footnote{\textbf{3:9} Apg
  20,35; Phil 3,17; Mt 10,10} \bibleverse{10} Und da wir bei euch waren,
