...
\bibverse{6} Ein Sohn soll seinen Vater ehren und ein Knecht seinen
...
\footnote{\textbf{1:6} 2Mo 20,12; Joh 8,49} \bibverse{7} Damit dass ihr
...
\bibverse{9} So bittet nun Gott, dass er uns gnädig sei! denn solches
ist geschehen von euch. Meint ihr, er werde eure Person ansehen? spricht
der HErr Zebaoth.

\bibverse{10} Dass doch einer unter euch die Türen zuschlösse, damit ihr
...
Zebaoth. \footnote{\textbf{1:11} Jes 60,1-7} \bibverse{12} Ihr aber
entheiligt ihn damit, dass ihr sagt: „Des HErrn Tisch ist unheilig, und
sein Opfer ist verachtet samt seiner Speise.`` \bibverse{13} Und ihr
...
\bibverse{14} Verflucht sei der Betrüger, der in seiner Herde ein
...
das Gesetz suche; denn er ist ein Engel des HErrn Zebaoth. \footnote{\textbf{2:7}
  5Mo 33,10; Haggai 1,13} \bibverse{8} Ihr aber seid von dem Wege
abgetreten und ärgert viele im Gesetz und habt den Bund Levis gebrochen,
spricht der HErr Zebaoth. \bibverse{9} Darum habe ich auch euch gemacht,
dass ihr verachtet und unwert seid vor dem ganzen Volk, weil ihr meine
Wege nicht haltet und seht Personen an im Gesetz. \bibverse{10} Haben
...
unseren Vätern gemacht? \bibverse{11} Denn Juda ist ein Verächter
...
\bibverse{12} Aber der HErr wird den, der solches tut, ausrotten aus der
Hütte Jakobs, beide, Meister und Schüler, samt dem, der dem HErrn
Zebaoth Speisopfer bringt.

\bibverse{13} Weiter tut ihr auch das: ihr bedeckt den Altar des HErrn
...
\bibverse{14} Und so sprecht ihr: „Warum das?{}`` Darum dass der HErr
...
\bibverse{15} Also tat der Eine nicht, und war doch eines großen
...
seiner Jugend. \footnote{\textbf{2:15} Jes 51,2; Hes 33,24; 1Mo 15,5-6;
  1Mo 21,12} \bibverse{16} Wer ihr aber gram ist und verstößt sie,
...
spricht der HErr Zebaoth. \footnote{\textbf{3:1} Mt 11,10; Mk 1,2; Lk
  1,17} \bibverse{2} Wer wird aber den Tag seiner Zukunft erleiden
...
das Feuer eines Goldschmieds und wie die Seife der Wäscher. \footnote{\textbf{3:2}
  Jes 1,25} \bibverse{3} Er wird sitzen und schmelzen und das Silber
...
\footnote{\textbf{3:3} Sach 13,9} \bibverse{4} und wird dem HErrn wohl
...
\bibverse{6} Denn ich bin der HErr und wandle mich nicht; und es soll
mit euch Kindern Jakobs nicht gar aus sein. \bibverse{7} Ihr seid von
...
\bibverse{8} Ist's recht, dass ein Mensch Gott täuscht, wie ihr mich
täuschet? So sprecht ihr: „Womit täuschen wir dich?{}`` Am Zehnten und
Hebopfer. \bibverse{9} Darum seid ihr auch verflucht, dass euch alles
unter den Händen zerrinnt; denn ihr täuscht mich allesamt. \bibverse{10}
...
Fülle. \bibverse{11} Und ich will für euch den Fresser schelten, dass er
...
\bibverse{12} dass euch alle Heiden sollen selig preisen, denn ihr sollt
ein wertes Land sein, spricht der HErr Zebaoth.

\bibverse{13} Ihr redet hart wider mich, spricht der HErr. So sprecht
ihr: „Was reden wir wider dich?{}`` \bibverse{14} Damit dass ihr sagt:
...
\footnote{\textbf{3:14} Ps 73,13-14} \bibverse{15} Darum preisen wir die
Verächter; denn die Gottlosen nehmen zu; sie versuchen Gott, und alles
geht ihnen wohl aus.

\bibverse{16} Aber die Gottesfürchtigen trösten sich untereinander also:
...
der ihm nicht dient. \bibverse{19} Denn siehe, es kommt ein Tag, der
...
und wird ihnen weder Wurzel noch Zweige lassen. \bibverse{20} Euch aber,
...
wie die Mastkälber. \^{}\^{} \bibverse{21} Ihr werdet die Gottlosen
zertreten; denn sie sollen Asche unter euren Füßen werden des Tages, den
ich machen will, spricht der HErr Zebaoth. \^{}\^{} \bibverse{22}
...
\bibverse{23} Siehe, ich will euch senden den Propheten Elia, ehe denn
da komme der große und schreckliche Tag des HErrn. \^{}\^{}
\bibverse{24} Der soll das Herz der Väter bekehren zu den Kindern und
