...
zu aller Zeit, von Ewigkeit zu Ewigkeit! Amen. \# 4 \bibleverse{1} So
ermahne nun euch ich Gefangener in dem Herrn, dass ihr wandelt, wie
sich's gebührt eurer Berufung, mit der ihr berufen seid, \bibleverse{2}
mit aller Demut und Sanftmut, mit Geduld, und vertraget einer den
anderen in der Liebe \footnote{\textbf{4:2} Kol 3,12-13} \bibleverse{3}
und seid fleißig, zu halten die Einigkeit im Geist durch das Band des
Friedens: \footnote{\textbf{4:3} Phil 2,2; Kol 3,15} \bibleverse{4} ein
Leib und ein Geist, wie ihr auch berufen seid auf einerlei Hoffnung
eurer Berufung; \footnote{\textbf{4:4} Röm 12,5} \bibleverse{5} ein
Herr, ein Glaube, eine Taufe; \footnote{\textbf{4:5} 1Kor 8,6}
\bibleverse{6} ein Gott und Vater unser aller, der da ist über euch
allen und durch euch alle und in euch allen. \footnote{\textbf{4:6} 1Kor
  12,6} \bibleverse{7} Einem jeglichen aber unter uns ist gegeben die
Gnade nach dem Maß der Gabe Christi. \footnote{\textbf{4:7} Röm 12,3;
  Röm 12,6; 1Kor 12,11} \bibleverse{8} Darum heißt es: „Er ist
...
dem Vater in dem Namen unseres Herrn Jesu Christi, \footnote{\textbf{5:20}
  1Thes 5,18} \bibleverse{21} und seid untereinander untertan in der
...
Mann. \# 6 \bibleverse{1} Ihr Kinder, seid gehorsam euren Eltern in dem
Herrn, denn das ist billig. \bibleverse{2} „Ehre Vater und Mutter,`` das
ist das erste Gebot, das Verheißung hat: \footnote{\textbf{6:2} 2Mo
  20,12} \bibleverse{3} „auf dass dir's wohl gehe und du lange lebest
auf Erden.``
