...
\bibverse{1} Una profecía:\footnote{\textbf{1:1} Literalmente,
  ``carga.''} Este mensaje vino del Señor respecto a Israel, a través de
Malaquías.

\bibverse{2} Yo te he amado,\footnote{\textbf{1:2} El tiempo verbal
...
José \bibverse{3} y desprecié a Esaú. He destruido las montañas de Esaú
y transformé su heredad en un desierto para chacales.

\bibverse{4} El pueblo de Edom podrá decir: ``Hemos sido golpeados hasta
...
y el pueblo de los que enojan\footnote{\textbf{1:4} La ira divina no
  ...
  egoísta.} al Señor para siempre. \bibverse{5} Tú\footnote{\textbf{1:5}
...
\bibverse{6} Un hijo honra a su padre, y un siervo respeta a su amo. Si
...
\bibverse{7} Presentando ofrendas contaminadas\footnote{\textbf{1:7}
...
\bibverse{8} Cuando presentan un animal ciego como sacrificio, ¿está
...
\bibverse{9} ¿Por qué, entonces, no tratan de agradar a Dios, y piden su
...
\bibverse{10} Desearía que uno de ustedes cerrara las puertas del
...
\bibverse{11} Me siento honrado por las naciones desde el extremo más
...
\bibverse{12} Pero ustedes me deshonran cuando dicen que la mesa del
Señor no merece respeto, y que su comida puede ser tratada con
desprecio. \bibverse{13} Ustedes dicen: ``¡Esto es demasiada molestia!''
...
el Señor. \bibverse{14} Malditos son los que engañan y juran traer un
...
\bibverse{1} ¡Ahora este mandamiento\footnote{\textbf{2:1}
  ``Mandamiento'' en el sentido de las instrucciones que debían seguir,
  o una advertencia.} es para tus sacerdotes! \bibverse{2} Si no
...
sus corazones para oír mi palabra. \bibverse{3} ¡Tengan cuidado! Yo voy
...
serán expulsados con el estiércol también. \bibverse{4} Entonces sabrán
...
Todopoderoso. \bibverse{5} Mi acuerdo con él era de vida y paz, lo cual
le otorgué, y también había respeto. Él me respetaba. Se maravillaba de
mi. \bibverse{6} Le enseñó al pueblo la verdad, y no había nada falso en
su enseñanza. Él caminó onmigo en paz e hizo lo recto, y ayudó a muchos
a alejarse del pecado. \bibverse{7} Un sacerdote debe enseñar la verdad
...
\bibverse{8} Pero ustedes se han desviado de mi camino. Han hecho caer a
muchos en el pecado. Con su enseñanza han quebrantado el acuerdo con
Leví, dice el Señor Todopoderoso. \bibverse{9} Por eso yo he destruido
...
\bibverse{10} ¿Acaso no tenemos todos un mismo Padre? ¿No nos creó a
todos el mismo Dios? ¿Por qué, entonces, somos desleales unos con otros,
violando el acuerdo que hicieron nuestros antiguos padres? \bibverse{11}
...
que adoran ídolos. \bibverse{12} ¡Que el Señor expulse a la familia de
...
\bibverse{13} Otra cosa que haces es que derramas lágrimas sobre el
altar del Señor, llorando y lamentándote porque ya el Señor no presta
atención a tus ofrendas o no quiere aceptarlas.

\bibverse{14} ``¿Por qué no?'' preguntas. Porque el Señor fue testigo de
...
\bibverse{15} ¿Acaso no los hizo uno solo, y les dio de su Espíritu? ¿Y
...
jóvenes. \bibverse{16} Porque yo aborrezco el divorcio, dice el Señor,
...
\bibverse{17} Ustedes han cansado al Señor con sus palabras\footnote{\textbf{2:17}
...
\bibverse{1} ¡Miren! Yo envío a mi mensajero,\footnote{\textbf{3:1}
...
\bibverse{2} ¿Quién podrá sobrevivir en el día de su venida? ¿Quién
...
limpia las manchas. \bibverse{3} Él se sentará como el que refina y
...
\bibverse{4} Entonces las ofrendas de Judá y de Jerusalén agradarán al
Señor, como en los días de antaño. \bibverse{5} Yo vendré y los probaré.
...
\bibverse{6} Porque yo soy el Señor, y no he cambiado, y ustedes no han
...
\bibverse{7} Desde el tiempo de sus antiguos padres y hasta ahora,
...
Pero ustedes preguntan: ``¿Cómo debemos volver?''\footnote{\textbf{3:7}
  El sentido parece ser que las personas no ven la necesidad de
  regresar, y no reconocen que han hecho algo malo.}

\bibverse{8} ¿Debe el pueblo defraudar a Dios? ¡Aún así ustedes me han
...
En los diezmos y en las ofrendas. \bibverse{9} Ustedes están bajo
maldición, porque ustedes y toda la nación me están defraudando.
\bibverse{10} Traigan todo el diezmo a la tesorería para que haya
...
bendiciones tanto que no tendrán lugar para ellas. \bibverse{11} Yo
evitaré que vengan plagas de langostas\footnote{\textbf{3:11}
  Literalmente, ``la devoradora.''} en tus cosechas, y tus viñedos no
cesarán de dar fruto, dice el Señor Todopoderoso. \bibverse{12} Todas
...
Pero ustedes dicen: ``¿Qué hemos dicho contra ti?'' \bibverse{14}
...
Todopoderoso con caras largas?\footnote{\textbf{3:14} ``caras largas'':
  ...
  estuviera sinceramente arrepentida.} \bibverse{15} Desde ahora diremos
...
Señor y que le prestaron atención.\footnote{\textbf{3:16} ``le prestaron
  atención'': Literalmente, ``Meditaron en su nombre.''} \bibverse{17}
...
un hijo obediente. \bibverse{18} Entonces ustedes podrán volver a
...
\bibverse{1} ¡Tengan cuidado! Viene el día---ardiente como un horno---en
...
ramas, dice el Señor Todopoderoso. \bibverse{2} Pero para los que tienen
