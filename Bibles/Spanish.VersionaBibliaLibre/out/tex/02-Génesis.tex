...
\bibverse{6} Entonces Dios dijo: ``Que haya expansión\footnote{\textbf{1:6}
...
Dios, como varón y hembra.\footnote{\textbf{1:27} La repetición de
  ...
  coloca en primer lugar en cada frase.} \bibverse{28} Dios los bendijo
...
ellos\footnote{\textbf{2:1} ``Todo lo que hay en ellos'': literalmente,
  ...
  de soldados.}quedó terminada. \bibverse{2} Cuando llegó el séptimo
...
\bibverse{7} Entonces el Señor formó al hombre Adán\footnote{\textbf{2:7}
...
\bibverse{13} El segundo brazo fue llamado Gijón y rodea toda la tierra
de Cus.\footnote{\textbf{2:13} ``Cus'': en gran parte del Antiguo
  ...
  el caso aquí.} \bibverse{14} El tercer brazo fue llamado
...
\bibverse{25} Adán y su esposa Eva\footnote{\textbf{2:25} Ver la nota en
...
\bibverse{17} Y Dios le dijo a Adán: ``Por haber hecho\footnote{\textbf{3:17}
...
silvestres.\footnote{\textbf{3:18} Las plantas fueron originalmente
  asignadas a los animales. Ver 1:30.} \bibverse{19} Tendrás que sudar
...
otro hijo para tomar el lugar de Abel, el que mató Caín''. \bibverse{26}
...
maldijo''. \bibverse{30} Después del Nacimiento de Noé, Lamec vivió 595
años más y tuvo más hijos e hijas. \bibverse{31} Y Lamec vivió en total
...
\bibverse{4} Y en esos días había gigantes\footnote{\textbf{6:4}
...
\bibverse{14} Construye un arca\footnote{\textbf{6:14} La palabra usada
...
del arca, y cúbrela con alquitrán, por dentro y por fuera. \bibverse{15}
Y así es como deberás construirla: El arca debe medir 300 codos de
largo, 50 codos de ancho, y 30 codos de alto. \bibverse{16} Hazle un
...
\bibverse{13} Ese fue el día\footnote{\textbf{7:13} ``Ese fue el día'':
...
\bibverse{21} El Señor aceptó\footnote{\textbf{8:21} ``Aceptó'':
...
seres vivos como lo acabo de hacer. \bibverse{22} En tanto exista la
...
así como las plantas verdes.\footnote{\textbf{9:3} De acuerdo con Gén.
  ...
  poca comida disponible inmediatamente.} \bibverse{4} Pero no comerás
carne que aún tenga sangre de vida en ella. \bibverse{5} Si tu sangre es
derramada por causa de un animal, yo pediré cuentas por ello; y si tu
sangre es derramada por otra personas, yo se lo reclamaré. \bibverse{6}
...
\bibverse{1} Las siguientes son las genealogías\footnote{\textbf{10:1}
...
\bibverse{2} Los hijos\footnote{\textbf{10:2} Nótese que ``hijos'' en
...
Señor''. \bibverse{10} Su reino comenzó en las ciudades de
...
Acad, y Calné, todas ellas ubicadas en la tierra de Sinar.\footnote{\textbf{10:10}
  ``Sinar'': o ``Babilonia''.} \bibverse{11} De allí se mudó a
...
\bibverse{21} Sem, cuyo herman mayor\footnote{\textbf{10:21} Ver la nota
...
\bibverse{23} Los hijos de Aram: Uz, Hul, Guéter, y Mas.\footnote{\textbf{10:23}
  ``Mas'': En la Septuaginta y 1 Crónicas 1:17 se lee ``Mesec''.}

\bibverse{24} Arfaxad fue el padre de Selaj. Y Selaj fue el padre de
Éber.

\bibverse{25} Éber tuvo dos hijos. Uno se llamó Péleg,\footnote{\textbf{10:25}
...
alquitrán en lugar de cemento).\footnote{\textbf{11:3} Esto se debía a
  ...
  construcciones.} \bibverse{4} Y entonces dijeron: ``Construyamos ahora
...
\bibverse{9} Por eso la ciudad fue llamada Babel,\footnote{\textbf{11:9}
...
yo te mostraré. \bibverse{2} Te convertiré en el predecesor de una gran
...
\bibverse{1} En aquél tiempo Amrafel era el rey de Sumeria,\footnote{\textbf{14:1}
...
\bibverse{3} Todos estos en el segundo grupo\footnote{\textbf{14:3} ``En
  el segundo grupo'', añadido para mayor claridad}se aliaron en el Valle
de Sidín (el valle del Mar Muerto). \bibverse{4} Habían estado bajo el
...
corrieron hacia las montañas. \bibverse{11} Los invasores saquearon
todas las posesiones y alimento de Sodoma y Gomorra, y se fueron.
\bibverse{12} También capturaron a Lot, el sobrino de Abrán, y tomaron
sus posesiones, porque también vivía en Sodoma. \bibverse{13} Pero uno
...
lo que tengo es Eliezer de Damasco''.\footnote{\textbf{15:2} Era una
  ...
  sirviente de más confianza como su heredero.} \bibverse{3} Y Abrán
...
Egypto\footnote{\textbf{15:18} ``Wadi de Egipto'': No el Nilo, sino lo
  ...
  Josué 15:47.}hasta el gran Río Éufrates, \bibverse{19} e incluye el
territorioo de los quenitas, los quenizitas, los cadmoneos,
\bibverse{20} los heteos, los ferezeos, los refaítas, \bibverse{21} los
...
\bibverse{12} Él será como un asno salvaje, que peleará con todos, y
...
\bibverse{14} Es por ese que ese pozo\footnote{\textbf{16:14} Este pozo
...
Abraham\footnote{\textbf{17:5} El cambio de nombre suele interpretarse
  ...
  muchos'').}porque yo te haré padre de muchas naciones. \bibverse{6} Yo
...
de tu linaje. \bibverse{7} Yo te prometo guardar mi pacto contigo, y con
...
descendientes como un pacto eterno. \bibverse{20} Ahora bien, en lo que
...
príncipes, y yo lo convertiré en una gran nación. \bibverse{21} Pero
guardaré mi pacto con Isaac, el hijo que tendrá Sara para estos días el
próximo año''. \bibverse{22} Cuando Dios terminó de hablar con Abraham,
...
\bibverse{3} Entonces les dijo: ``Señor,\footnote{\textbf{18:3} Parece
...
\bibverse{1} Los dos ángeles\footnote{\textbf{19:1} ``Ángeles'': el
...
\bibverse{38} La hija menor también tuvo un hijo, al que llamó
...
que escuchen acerca de esto se reirán conmigo''. \bibverse{7} Además
...
\bibverse{31} Por eso llamaron ese lugar Beerseba,\footnote{\textbf{21:31}
...
bajo mi muslo,\footnote{\textbf{24:2} Era costumbre hacer esto al jurar
  y hacer pacto.} \bibverse{3} y júrame por el Señor, el Dios del cielo
y de la tierra, que no dejarás que mi hijo se case con una de las hijas
de los caananitas entre los cuales vino. \bibverse{4} En lugar de ello,
...
en Aram-Najaraim.\footnote{\textbf{24:10} ``Aram-naharaim'': or
  ``Mesopotamia''.} \bibverse{11} Al llegar en la noche, hizo que los
...
mi señor Abraham. \bibverse{13} Ahora pues, me encuentro junto a esta
Fuente, y las mujeres jóvenes de la ciudad vendrán a buscar agua.
\bibverse{14} Haz que suceda de la siguiente manera: Que la joven a
...
Esaú.\footnote{\textbf{25:25} Esaú suena como la palabra usada para
  ``cabello''.} \bibverse{26} Luego salió su hermano gemelo, quien salió
...
llamó ``Oposición''.\footnote{\textbf{26:21} ``Oposición'': La palabra
  ...
  decir oponente o adversario.} \bibverse{22} Así que se fueron de allí
...
Isaac.\footnote{\textbf{26:26} Ver 21:22. En vista del tiempo que
  ...
  nombres personales.} \bibverse{27} ``¿Por qué han venido a verme?''
...
descendientes la tierra en la que estás acostado ahora. \bibverse{14}
...
tierra serán benditos por tus descendientes. \bibverse{15} ¡Escucha! Yo
...
\bibverse{1} Jacob se apresuró y se puso en marcha,\footnote{\textbf{29:1}
  ``Se apresuró y se puso en marcha'': literalmente, ``levantó los
  pies''.}y llegó a la tierra de los orientales. \bibverse{2} Al
...
cubría la boca del pozo. \bibverse{3} La práctica común era
...
apariencia hermosa. \bibverse{18} Jacob se enamoró de Raquel, así que le
...
\bibverse{22} Y Labán organizó un banquete de bodas\footnote{\textbf{29:22}
...
hijo''.Y a este hijo lo llamó Dan.\footnote{\textbf{30:6} Dan significa
  ``juez''.} \bibverse{7} Bila, la criada personal de Raquel volvió a
quedar embarazada y tuvo un segundo hijo de Jacob. \bibverse{8} Y Raquel
...
hijos''.Y a este hijo lo llamó Zabulón.\footnote{\textbf{30:20} Zabulón
  se asocia con las palabras para ``regalo'' y ``honra''.} \bibverse{21}
...
\bibverse{24} Y a este hijo lo llamó José,\footnote{\textbf{30:24} José
...
él para comer. \bibverse{47} Labán lo llamóYegar-Saduta, pero Jacob lo
...
vigile de cerca a los dos cuando no estemos juntos. \bibverse{50} Si
...
dos. \bibverse{52} También son testimonio de nuestras solemnes promesas
...
con sólo mi bastón, y ahora tengo dos grandes campamentos. \bibverse{11}
Por favor, sálvame de mi hermano; ¡defiéndeme de Esaú! Me aterra que
venga a atacarme a mí, a mis mujeres y a mis hijos. \bibverse{12} Tú
...
\bibverse{20} Construyó un altar allí y lo llamó
...
\bibverse{5} Jacob descubrió que Siquem había violado\footnote{\textbf{34:5}
...
\bibverse{9} De hecho, podemos tener más matrimonios. Pueden darnos a
sus hijas y pueden tener a nuestras hijas. \bibverse{10} Puedes vivir
...
estabas huyendo de tu hermano Esaú''.\footnote{\textbf{35:1} Ver 28:11
  en adelante.} \bibverse{2} Entonces Jacob le dijo a su familia y a
todos los que estaban con él: ``Deshazte de los ídolos paganos que
tienes contigo. Purifíquense y cambien su ropa. \bibverse{3} Debemos
...
\bibverse{21} Israel\footnote{\textbf{35:21} ``Israel'': refiriéndose
...
eran Temán, Omar, Zefo, Quenaz, \bibverse{16} Coré,\footnote{\textbf{36:16}
...
\bibverse{3} Israel\footnote{\textbf{37:3} ``Israel'', es decir, Jacob.}amaba
...
posee. \bibverse{9} ¡Nadie en esta casa tiene más autoridad que yo! No
...
todas mis fuerzas. \bibverse{15} Cuando me oyó gritar pidiendo ayuda,
...
gira de inspección\footnote{\textbf{41:46} ``Gira de inspección'':
  añadido para mayor claridad.}por todo Egipto. \bibverse{47} Durante
los siete años de buenas cosechas, la tierra produjo muchos alimentos.
\bibverse{48} Recolectó todos los alimentos durante los siete años
buenos, y almacenó el grano producido en los campos locales de cada
ciudad. \bibverse{49} JJosé apiló tanto grano que era como la arena de
...
problemas y toda la familia de mi padre''. \bibverse{52} A su segundo
...
que le hicimos.''\footnote{\textbf{42:22} Literalmente, ``Ahora se
  ...
  por venganza.} \bibverse{23} No se daban cuenta de que José entendía
lo que decían porque le hablaban a través de un intérprete.
\bibverse{24} José se alejó de ellos porque empezó a llorar. Volvió
...
\bibverse{24} El mayordomo los llevó dentro de la casa de José, les dio
agua para que se lavaran los pies, y les dio comida para sus asnos.
\bibverse{25} Prepararon sus regalos para cuando José viniera al
...
y se fue a su habitación para llorar allí. \bibverse{31} Luego se lavó
...
con absoluta sorpresa.\footnote{\textbf{43:33} Por supuesto, esto habría
  ...
  familia.} \bibverse{34} La comida se les sirvió de la mesa de José, y
...
\bibverse{5} Esta es la copa de la que él personalmente bebe, y que usa
...
hijos para mí. \bibverse{28} Uno ya no está, sin duda quedó hecho
pedazos,\footnote{\textbf{44:28} Ver 37:33.}porque no lo he visto desde
entonces. \bibverse{29} Si me quitan a éste también, y le pasa algo
...
de esta forma milagrosa.\footnote{\textbf{45:7} ``De esta forma
  milagrosa'': o ``con muchos sobrevivientes''.} \bibverse{8} Así que no
...
\bibverse{12} Entonces José dijo a sus hermanos,\footnote{\textbf{45:12}
...
nación. \bibverse{4} Iré a Egipto contigo, y prometo traerte de vuelta.
...
\bibverse{13} Los hijos de Isacar: Tola, Fuvá, Job,\footnote{\textbf{46:13}
...
mayores. \bibverse{7} Hago esto porque\footnote{\textbf{48:7} ``Hago
...
\bibverse{6} Me niego a ser parte de sus decisiones; me niego a
...
naciones le obedecerán. \bibverse{11} Ata su asno a la vid, y el potro
...
jugo rojo de las uvas.\footnote{\textbf{49:11} La intención de este
  ...
  pudieran lavar sus ropas con él.} \bibverse{12} Sus ojos brillan más
...
\bibverse{15} Ve que el lugar donde descansa es bueno, y la tierra es
encantadora, por lo que está dispuesto a inclinar la espalda para
aceptar la carga y trabajar como esclavo.

\bibverse{16} Dan juzgará\footnote{\textbf{49:16} Dan significa juez,
  ver Gén 30:6.}a su pueblo como una de las tribus de Israel.
\bibverse{17} Dan será tan peligroso como una serpiente al lado del
...
muchos hijos.\footnote{\textbf{49:25} ``Muchos hijos'': literalmente
  ``pechos y matriz''.} \bibverse{26} Las bendiciones que recibió tu
...
\bibverse{21} Así que no se preocupen. Seguiré cuidando de ustedes y de
