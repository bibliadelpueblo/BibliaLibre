...
\bibleverse{2} So spricht der \textsc{Herr} Zebaoth: Dieses Volk
spricht: Die Zeit ist noch nicht da, dass man des \textsc{Herrn} Haus
baue. \bibleverse{3} Und des \textsc{Herrn} Wort geschah durch den
Propheten Haggai: \bibleverse{4} Aber eure Zeit ist da, dass ihr in
getäfelten Häusern wohnt, -- und dies Haus muss wüst stehen?
\bibleverse{5} Nun, so spricht der \textsc{Herr} Zebaoth: Schauet, wie
es euch geht! \bibleverse{6} Ihr säet viel, und bringet wenig ein; ihr
...
Geld verdient, der legt's in einen löchrigen Beutel. \bibleverse{7} So
...
spricht der \textsc{Herr}. \bibleverse{9} Denn ihr wartet wohl auf viel,
...
\bibleverse{10} Darum hat der Himmel über euch den Tau verhalten und das
Erdreich sein Gewächs. \bibleverse{11} Und ich habe die Dürre gerufen
...
\bibleverse{13} Da sprach Haggai, der Engel des \textsc{Herrn}, der die
Botschaft des \textsc{Herrn} hatte an das Volk: Ich bin mit euch,
spricht der \textsc{Herr}. \bibleverse{14} Und der \textsc{Herr}
...
des \textsc{Herrn} Zebaoth, ihres Gottes, \bibleverse{15} am
...
\bibleverse{2} Sage zu Serubabel, dem Sohn Sealthiels, dem Fürsten
Judas, und zu Josua, dem Sohn Jozadaks, dem Hohenpriester, und zum
übrigen Volk und sprich: \bibleverse{3} Wer ist unter euch
...
zu sein? \bibleverse{4} Und nun Serubabel, sei getrost! spricht der
...
nicht! \bibleverse{6} Denn so spricht der \textsc{Herr} Zebaoth: Es ist
noch ein kleines dahin, dass ich Himmel und Erde, das Meer und das
Trockene bewegen werde. \bibleverse{7} Ja, alle Heiden will ich bewegen.
Da soll dann kommen aller Heiden Bestes; und ich will dieses Haus voll
Herrlichkeit machen, spricht der \textsc{Herr} Zebaoth. \bibleverse{8}
Denn mein ist Silber und Gold, spricht der \textsc{Herr} Zebaoth.
\bibleverse{9} Es soll die Herrlichkeit dieses letzten Hauses größer
...
Zebaoth. \bibleverse{10} Am vierundzwanzigsten Tage des neunten Monats,
im zweiten Jahr des Darius, geschah des \textsc{Herrn} Wort zu dem
Propheten Haggai und sprach: \bibleverse{11} So spricht der
\textsc{Herr} Zebaoth: Frage die Priester um das Gesetz und sprich:
\bibleverse{12} Wenn jemand heiliges Fleisch trüge in seines Kleides
...
\bibleverse{16} dass, wenn einer zum Kornhaufen kam, der zwanzig Maß
haben sollte, so waren kaum zehn da; kam er zur Kelter und meinte
fünfzig Eimer zu schöpfen, so waren kaum zwanzig da. \bibleverse{17}
...
diesem Tage an will ich Segen geben. \bibleverse{20} Und des
...
bewegen \bibleverse{22} und will die Stühle der Königreiche umkehren und
...
durch des anderen Schwert. \bibleverse{23} Zur selben Zeit, spricht der
