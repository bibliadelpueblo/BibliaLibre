...
Erdbeben. \bibleverse{2} Und er sprach: Der \textsc{Herr} wird aus Zion
...
\bibleverse{3} So spricht der \textsc{Herr}: Um drei und vier Frevel
willen der Damasker will ich ihrer nicht schonen, darum dass sie Gilead
mit eisernen Zacken gedroschen haben; \bibleverse{4} sondern ich will
ein Feuer schicken in das Haus Hasaels, das soll die Paläste Benhadads
verzehren. \bibleverse{5} Und ich will die Riegel zu Damaskus zerbrechen
...
werden, spricht der \textsc{Herr}. \bibleverse{6} So spricht der
...
überantwortet haben; \bibleverse{7} sondern ich will ein Feuer in die
...
\bibleverse{9} So spricht der \textsc{Herr}: Um drei und vier Frevel
...
Bund der Brüder; \bibleverse{10} sondern ich will ein Feuer in die
Mauern zu Tyrus schicken, das soll ihre Paläste verzehren.

\bibleverse{11} So spricht der \textsc{Herr}: Um drei und vier Frevel
...
\bibleverse{12} sondern ich will ein Feuer schicken gen Theman, das soll
die Paläste zu Bozra verzehren.

\bibleverse{13} So spricht der \textsc{Herr}: Um drei und vier Frevel
...
machten; \bibleverse{14} sondern ich will ein Feuer anzünden in den
...
\bibleverse{15} Da wird dann ihr König samt seinen Fürsten gefangen
weggeführt werden, spricht der \textsc{Herr}.

\hypertarget{section-1}{%
\section{2}\label{section-1}}

\bibleverse{1} So spricht der \textsc{Herr}: Um drei und vier Frevel
willen Moabs will ich ihrer nicht schonen, darum dass sie die Gebeine
des Königs zu Edom haben zu Asche verbrannt; \bibleverse{2} sondern ich
...
Posaunenhall. \bibleverse{3} Und ich will den Richter unter ihnen
ausrotten und alle ihre Fürsten samt ihm töten, spricht der
\textsc{Herr}. \bibleverse{4} So spricht der \textsc{Herr}: Um drei und
...
\bibleverse{5} sondern ich will ein Feuer nach Juda schicken, das soll
die Paläste zu Jerusalem verzehren.

\bibleverse{6} So spricht der \textsc{Herr}: Um drei und vier Frevel
...
\bibleverse{7} Sie treten den Kopf der Armen in den Kot und hindern den
Weg der Elenden. Es geht Sohn und Vater zur Dirne, dass sie meinen
heiligen Namen entheiligen. \bibleverse{8} Und bei allen Altären
schlemmen sie auf den verpfändeten Kleidern und trinken Wein in ihrer
Götter Hause von den Gebüßten. \bibleverse{9} Und ich habe doch den
...
unten seine Wurzel. \bibleverse{10} Auch habe ich euch aus Ägyptenland
...
Kinder Israel? spricht der \textsc{Herr}. \bibleverse{12} So gebt ihr
den Geweihten Wein zu trinken und gebietet den Propheten und sprecht:
Ihr sollt nicht weissagen! \bibleverse{13} Siehe, ich will's unter euch
knarren machen, wie ein Wagen voll Garben knarrt, \bibleverse{14} dass
...
\bibleverse{15} und die Bogenschützen sollen nicht bestehen, und der
schnell laufen kann, soll nicht entlaufen, und der da reitet, soll sein
Leben nicht erretten; \bibleverse{16} und der unter den Starken der
...
\bibleverse{1} Höret, was der \textsc{Herr} mit euch redet, ihr Kinder
...
\bibleverse{7} Denn der Herr \textsc{Herr} tut nichts, er offenbare denn
sein Geheimnis den Propheten, seinen Knechten. \bibleverse{8} Der Löwe
brüllt; wer sollte sich nicht fürchten? Der Herr \textsc{Herr} redet;
wer sollte nicht weissagen? \bibleverse{9} Verkündigt in den Palästen zu
...
darin ist! \bibleverse{10} Sie achten keines Rechts, spricht der
\textsc{Herr}, sammeln Schätze von Frevel und Raub in ihren Palästen.
\bibleverse{11} Darum spricht der Herr \textsc{Herr} also: Man wird
dieses Land ringsumher bedrängen und dich von deiner Macht
herunterreißen und deine Häuser plündern.

\bibleverse{12} So spricht der \textsc{Herr}: Gleichwie ein Hirte dem
...
\bibleverse{13} Höret und zeuget im Hause Jakob, spricht der Herr
\textsc{Herr}, der Gott Zebaoth. \bibleverse{14} Denn zu der Zeit, wenn
...
sollen, \bibleverse{15} und will beide, Winterhaus und Sommerhaus,
...
eure Nachkommen mit Fischhaken. \bibleverse{3} Und ihr werdet zu den
Lücken hinausgehen, eine jegliche vor sich hin, und gen Harmon
weggeworfen werden, spricht der \textsc{Herr}. \bibleverse{4} Ja, kommt
...
dritten Tages, \bibleverse{5} und räuchert vom Sauerteig zum Dankopfer
und ruft aus freiwillige Opfer und verkündigt es; denn so habt ihr's
gern, ihr Kinder Israel, spricht der Herr \textsc{Herr}. \bibleverse{6}
...
mir, spricht der \textsc{Herr}. \bibleverse{7} Auch habe ich den Regen
...
verdorrte. \bibleverse{8} Und es zogen zwei, drei Städte zu einer Stadt,
...
mir, spricht der \textsc{Herr}. \bibleverse{10} Ich schickte Pestilenz
...
ihr euch nicht zu mir, spricht der \textsc{Herr}. \bibleverse{11} Ich
...
euch nicht zu mir, spricht der \textsc{Herr}. \bibleverse{12} Darum will
ich dir weiter also tun, Israel. Weil ich denn dir also tun will, so
schicke dich, Israel, und begegne deinem Gott. \bibleverse{13} Denn
...
\bibleverse{3} Denn so spricht der Herr \textsc{Herr}: Die Stadt, da
tausend ausgehen, soll nur hundert übrig behalten; und da hundert
ausgehen, die soll nur zehn übrig behalten im Hause Israel.

\bibleverse{4} Darum so spricht der \textsc{Herr} zum Hause Israel:
Suchet mich, so werdet ihr leben. \bibleverse{5} Suchet nicht Bethel und
...
\bibleverse{6} Suchet den \textsc{Herrn}, so werdet ihr leben! dass
nicht ein Feuer im Hause Joseph überhand nehme, das da verzehre und das
niemand löschen könne zu Bethel; \bibleverse{7} die ihr das Recht in
Wermut verkehrt und die Gerechtigkeit zu Boden stoßt. \bibleverse{8} Er
...
schüttet es auf den Erdboden: er heißt \textsc{Herr}; \bibleverse{9} der
über den Starken eine Verstörung anrichtet und bringt eine Verstörung
über die feste Stadt. \bibleverse{10} Aber sie sind dem gram, der sie im
...
in den feinen Weinbergen gepflanzt habt. \bibleverse{12} Denn ich weiß
...
unterdrückt. \bibleverse{13} Darum muss der Kluge zur selben Zeit
schweigen; denn es ist eine böse Zeit. \bibleverse{14} Suchet das Gute
und nicht das Böse, auf dass ihr leben möget, so wird der \textsc{Herr},
der Gott Zebaoth, bei euch sein, wie ihr rühmet. \bibleverse{15} Hasset
...
\bibleverse{16} Darum, so spricht der \textsc{Herr}, der Gott Zebaoth,
...
rufen, und zum Wehklagen, wer da weinen kann. \bibleverse{17} In allen
Weinbergen wird Wehklagen sein; denn ich will unter euch fahren, spricht
der \textsc{Herr}. \bibleverse{18} Weh denen, die des \textsc{Herrn} Tag
begehren! Was soll er euch? Denn des \textsc{Herrn} Tag ist Finsternis
und nicht Licht. \bibleverse{19} Gleich als wenn jemand vor dem Löwen
...
\bibleverse{20} Denn des \textsc{Herrn} Tag wird ja finster und nicht
licht sein, dunkel und nicht hell. \bibleverse{21} Ich bin euren
Feiertagen gram und verachte sie und mag eure Versammlungen nicht
riechen. \bibleverse{22} Und ob ihr mir gleich Brandopfer und Speisopfer
opfert, so habe ich keinen Gefallen daran; so mag ich auch eure feisten
Dankopfer nicht ansehen. \bibleverse{23} Tue nur weg von mir das Geplärr
deiner Lieder; denn ich mag dein Psalterspiel nicht hören!
\bibleverse{24} Es soll aber das Recht offenbart werden wie Wasser und
die Gerechtigkeit wie ein starker Strom. \bibleverse{25} Habt ihr vom
Hause Israel mir in der Wüste die vierzig Jahre lang Schlachtopfer und
Speisopfer geopfert? \bibleverse{26} Ihr truget den Sikkuth, euren
König, und Chiun, euer Bild, den Stern eurer Götter, welche ihr euch
selbst gemacht hattet. \bibleverse{27} So will ich euch wegführen lassen
...
\bibleverse{4} und schlaft auf elfenbeinernen Lagern und pranget auf
euren Ruhebetten; ihr esset die Lämmer aus der Herde und die gemästeten
Kälber, \bibleverse{5} und spielet auf dem Psalter und erdichtet euch
Lieder wie David, \bibleverse{6} und trinket Wein aus den Schalen und
salbet euch mit Balsam und bekümmert euch nicht um den Schaden Josephs.
\bibleverse{7} Darum sollen sie nun vornan gehen unter denen, die
gefangen weggeführt werden, und soll das Schlemmen der Pranger aufhören.
\bibleverse{8} Denn der Herr \textsc{Herr} hat geschworen bei seiner
...
übergeben mit allem, was darin ist. \bibleverse{9} Und wenngleich zehn
...
\bibleverse{11} Denn siehe, der \textsc{Herr} hat geboten, dass man die
großen Häuser schlagen soll, dass sie Risse gewinnen, und die kleinen
Häuser, dass sie Lücken gewinnen. \bibleverse{12} Wer kann mit Rossen
rennen oder mit Ochsen pflügen auf Felsen? Denn ihr wandelt das Recht in
Galle und die Frucht der Gerechtigkeit in Wermut \bibleverse{13} und
tröstet euch des, das so gar nichts ist, und sprecht: Sind wir denn
nicht stark genug mit unseren Hörnern? \bibleverse{14} Darum siehe, ich
...
\bibleverse{1} Der Herr \textsc{Herr} zeigte mir ein Gesicht, und siehe,
...
lassen. \bibleverse{2} Als sie nun das Kraut im Lande gar abgefressen
hatten, sprach ich: Ach Herr \textsc{Herr}, sei gnädig! Wer will Jakob
wieder aufhelfen? denn er ist ja gering.

\bibleverse{3} Da reute es den \textsc{Herrn}, und er sprach: Wohlan, es
soll nicht geschehen.

\bibleverse{4} Der Herr \textsc{Herr} zeigte mir ein Gesicht, und siehe,
der Herr \textsc{Herr} rief dem Feuer, damit zu strafen; das verzehrte
die große Tiefe und fraß das Ackerland. \bibleverse{5} Da sprach ich:
Ach Herr \textsc{Herr}, lass ab! Wer will Jakob wieder aufhelfen? denn
er ist ja gering.

\bibleverse{6} Da reute den \textsc{Herrn} das auch, und der Herr
\textsc{Herr} sprach: Es soll auch nicht geschehen.

\bibleverse{7} Er zeigte mir abermals ein Gesicht, und siehe, der
\textsc{Herr} stand auf einer Mauer, mit einer Bleischnur gemessen; und
er hatte die Bleischnur in seiner Hand. \bibleverse{8} Und der
...
\bibleverse{10} Da sandte Amazja, der Priester zu Bethel, zu Jerobeam,
...
\bibleverse{11} Denn so spricht Amos: Jerobeam wird durchs Schwert
...
\bibleverse{13} Und weissage nicht mehr zu Bethel; denn es ist des
...
Maulbeeren abliest; \bibleverse{15} aber der \textsc{Herr} nahm mich von
der Herde und sprach zu mir: Gehe hin und weissage meinem Volk Israel!
\bibleverse{16} So höre nun des \textsc{Herrn} Wort. Du sprichst:
Weissage nicht wider Israel und predige nicht wider das Haus Isaak!
\bibleverse{17} Darum spricht der \textsc{Herr} also: Deine Frau wird in
...
hinwerfen wird. \bibleverse{4} Höret dies, die ihr den Armen unterdrückt
und die Elenden im Lande verderbt \bibleverse{5} und sprecht: „Wann will
...
Preis steigern und die Waage fälschen, \bibleverse{6} auf dass wir die
Armen um Geld und die Dürftigen um ein Paar Schuhe unter uns bringen und
Spreu für Korn verkaufen?{}`` \bibleverse{7} Der \textsc{Herr} hat
...
überschwemmt werden wie mit dem Fluss Ägyptens. \bibleverse{9} Zur
...
werden. \bibleverse{10} Ich will eure Feiertage in Trauern und alle eure
...
nehmen. \bibleverse{11} Siehe, es kommt die Zeit, spricht der Herr
...
\textsc{Herrn}, zu hören; \bibleverse{12} dass sie hin und her von einem
Meer zum anderen, von Mitternacht gegen Morgen umlaufen und des
\textsc{Herrn} Wort suchen, und doch nicht finden werden.
\bibleverse{13} Zu der Zeit werden die schönen Jungfrauen und die
Jünglinge verschmachten vor Durst, \bibleverse{14} die jetzt schwören
...
dass keiner entfliehen noch irgendeiner entgehen soll. \bibleverse{2}
...
herunterstoßen; \bibleverse{3} und wenn sie sich gleich versteckten oben
...
\bibleverse{4} und wenn sie vor ihren Feinden hin gefangen gingen, so
...
Guten. \bibleverse{5} Denn der Herr \textsc{Herr} Zebaoth ist ein
...
\bibleverse{6} Er ist's, der seinen Saal in den Himmel baut und seine
Hütte auf Erden gründet; er ruft dem Wasser im Meer und schüttet's auf
das Erdreich, -- er heißt \textsc{Herr}. \bibleverse{7} Seid ihr Kinder
...
und die Syrer aus Kir? \bibleverse{8} Siehe, die Augen des Herrn
...
spricht der \textsc{Herr}. \bibleverse{9} Denn siehe, ich will befehlen
...
\bibleverse{10} Alle Sünder in meinem Volk sollen durchs Schwert
sterben, die da sagen: Es wird das Unglück nicht so nahe sein noch uns
begegnen. \bibleverse{11} Zur selben Zeit will ich die zerfallene Hütte
...
\bibleverse{12} auf dass sie besitzen die Übrigen zu Edom und alle
Heiden, über welche mein Name genannt ist, spricht der \textsc{Herr},
der solches tut. \bibleverse{13} Siehe, es kommt die Zeit, spricht der
...
Hügel werden fruchtbar sein. \bibleverse{14} Denn ich will das Gefängnis
...
Früchte daraus essen. \bibleverse{15} Denn ich will sie in ihr Land
