...
será dada. \footnote{\textbf{1:5} Prov 2,3-6; Sant 3,15} \bibleverse{6}
...
\footnote{\textbf{1:6} Mar 11,24; 1Tim 2,8} \bibleverse{7} No piense
pues el tal hombre que recibirá ninguna cosa del Señor. \bibleverse{8}
...
\footnote{\textbf{1:9} Sant 2,5} \bibleverse{10} Mas el que es rico, en
su bajeza; porque él se pasará como la flor de la hierba. \footnote{\textbf{1:10}
  1Pe 1,24; 1Tim 6,17} \bibleverse{11} Porque salido el sol con ardor,
...
propia concupiscencia es atraído, y cebado. \footnote{\textbf{1:14} Rom
  7,7-8} \bibleverse{15} Y la concupiscencia, después que ha concebido,
pare el pecado: y el pecado, siendo cumplido, engendra muerte.
\footnote{\textbf{1:15} Rom 7,10} \bibleverse{16} Amados hermanos míos,
...
mudanza, ni sombra de variación. \footnote{\textbf{1:17} Mat 7,11; 1Jn
  1,5} \bibleverse{18} El, de su voluntad nos ha engendrado por la
...
para oir, tardío para hablar, tardío para airarse: \footnote{\textbf{1:19}
  Prov 29,20; Ecl 5,1-2; Ecl 7,9} \bibleverse{20} Porque la ira del
hombre no obra la justicia de Dios. \footnote{\textbf{1:20} Prov 29,22;
  Efes 4,26} \bibleverse{21} Por lo cual, dejando toda inmundicia y
...
oidores, engañándoos á vosotros mismos. \footnote{\textbf{1:22} Mat
  7,26; Rom 2,13} \bibleverse{23} Porque si alguno oye la palabra, y no
la pone por obra, este tal es semejante al hombre que considera en un
espejo su rostro natural. \bibleverse{24} Porque él se consideró á sí
mismo, y se fué, y luego se olvidó qué tal era. \bibleverse{25} Mas el
...
vana. \footnote{\textbf{1:26} 1Pe 3,10} \bibleverse{27} La religión pura
...
\bibleverse{6} Mas vosotros habéis afrentado al pobre. ¿No os oprimen
los ricos, y no son ellos los mismos que os arrastran á los juzgados?
\bibleverse{7} ¿No blasfeman ellos el buen nombre que fué invocado sobre
vosotros?
...
sois reconvenidos de la ley como transgresores. \footnote{\textbf{2:9}
  Deut 1,17} \bibleverse{10} Porque cualquiera que hubiere guardado toda
la ley, y ofendiere en un punto, es hecho culpado de todos. \footnote{\textbf{2:10}
  Mat 5,19} \bibleverse{11} Porque el que dijo: No cometerás adulterio,
...
\bibleverse{12} Así hablad, y así obrad, como los que habéis de ser
juzgados por la ley de libertad. \bibleverse{13} Porque juicio sin
...
fe, y no tiene obras? ¿Podrá la fe salvarle? \footnote{\textbf{2:14} Mat
  7,21} \bibleverse{15} Y si el hermano ó la hermana están desnudos, y
tienen necesidad del mantenimiento de cada día, \bibleverse{16} Y alguno
...
\footnote{\textbf{2:16} 1Jn 3,18} \bibleverse{17} Así también la fe, si
no tuviere obras, es muerta en sí misma. \bibleverse{18} Pero alguno
...
cuando ofreció á su hijo Isaac sobre el altar? \footnote{\textbf{2:21}
  Gén 22,-1; Heb 11,17} \bibleverse{22} ¿No ves que la fe obró con sus
obras, y que la fe fué perfecta por las obras? \bibleverse{23} Y fué
cumplida la Escritura que dice: Abraham creyó á Dios, y le fué imputado
á justicia, y fué llamado amigo de Dios. \bibleverse{24} Vosotros veis,
pues, que el hombre es justificado por las obras, y no solamente por la
fe. \bibleverse{25} Asimismo también Rahab la ramera, ¿no fué
justificada por obras, cuando recibió los mensajeros, y los echó fuera
por otro camino? \bibleverse{26} Porque como el cuerpo sin espíritu está
...
inflamada del infierno. \footnote{\textbf{3:6} Mat 15,11; Mat 15,18; Mat
  12,36-37; Prov 16,27} \bibleverse{7} Porque toda naturaleza de
...
Hermanos míos, no conviene que estas cosas sean así hechas. \footnote{\textbf{3:10}
  Efes 4,29} \bibleverse{11} ¿Echa alguna fuente por una misma abertura
agua dulce y amarga? \bibleverse{12} Hermanos míos, ¿puede la higuera
...
mundo, se constituye enemigo de Dios. \footnote{\textbf{4:4} Luc 6,26;
  Rom 8,7; 1Jn 2,15} \bibleverse{5} ¿Pensáis que la Escritura dice sin
causa: El espíritu que mora en nosotros codicia para envidia?
\footnote{\textbf{4:5} Éxod 20,3; Éxod 20,5} \bibleverse{6} Mas él da
...
\bibleverse{7} Someteos pues á Dios; resistid al diablo, y de vosotros
huirá. \footnote{\textbf{4:7} 1Pe 5,8-9} \bibleverse{8} Allegaos á Dios,
...
doblado ánimo, purificad los corazones. \footnote{\textbf{4:8} Zac 1,3;
  Is 1,16} \bibleverse{9} Afligíos, y lamentad, y llorad. Vuestra risa
se convierta en lloro, y vuestro gozo en tristeza. \bibleverse{10}
...
\footnote{\textbf{4:13} Prov 27,1} \bibleverse{14} Y no sabéis lo que
...
aparece por un poco de tiempo, y luego se desvanece. \footnote{\textbf{4:14}
  Luc 12,20} \bibleverse{15} En lugar de lo cual deberíais decir: Si el
Señor quisiere, y si viviéremos, haremos esto ó aquello. \footnote{\textbf{4:15}
  Hech 18,21; 1Cor 4,19} \bibleverse{16} Mas ahora os jactáis en
vuestras soberbias. Toda jactancia semejante es mala. \bibleverse{17} El
...
\bibleverse{2} Vuestras riquezas están podridas: vuestras ropas están
comidas de polilla. \footnote{\textbf{5:2} Mat 6,19} \bibleverse{3}
...
sacrificios. \footnote{\textbf{5:5} Luc 16,19; Luc 16,25; Jer 12,3; Jer
  25,34} \bibleverse{6} Habéis condenado y muerto al justo; y él no os
resiste.

\footnote{\textbf{5:6} Sant 2,6}
...
\footnote{\textbf{5:7} Luc 21,19; Heb 10,36} \bibleverse{8} Tened
...
¿Está alguno alegre? cante salmos. \footnote{\textbf{5:13} Sal 50,15;
  Col 3,16} \bibleverse{14} ¿Está alguno enfermo entre vosotros? llame á
los ancianos de la iglesia, y oren por él, ungiéndole con aceite en el
nombre del Señor. \footnote{\textbf{5:14} Mar 6,13} \bibleverse{15} Y la
...
estuviere en pecados, le serán perdonados. \footnote{\textbf{5:15} Mar
  16,18} \bibleverse{16} Confesaos vuestras faltas unos á otros, y rogad
...
tierra en tres años y seis meses. \footnote{\textbf{5:17} 1Re 17,1; Luc
  4,25} \bibleverse{18} Y otra vez oró, y el cielo dió lluvia, y la
