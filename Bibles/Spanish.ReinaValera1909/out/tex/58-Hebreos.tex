...
de todo, por el cual asimismo hizo el universo: \footnote{\textbf{1:2}
  Sal 2,8; Juan 1,3; Col 1,16} \bibleverse{3} El cual siendo el
...
diestra de la Majestad en las alturas, \footnote{\textbf{1:3} 2Cor 4,4;
  Col 1,15; Heb 9,14; Heb 9,26; Mar 16,19} \bibleverse{4} Hecho tanto
...
confirmada hasta nosotros por los que oyeron; \footnote{\textbf{2:3} Heb
  10,29; Heb 12,25} \bibleverse{4} Testificando juntamente con ellos
...
salud de ellos. \footnote{\textbf{2:10} Heb 12,2} \bibleverse{11} Porque
...
cual no se avergüenza de llamarlos hermanos, \footnote{\textbf{2:11} Mar
  3,34-35; Juan 17,19; Juan 20,17} \bibleverse{12} Diciendo: Anunciaré á
...
Dios, para expiar los pecados del pueblo. \footnote{\textbf{2:17} Fil
  2,7} \bibleverse{18} Porque en cuanto él mismo padeció siendo tentado,
...
Cristo Jesús; \footnote{\textbf{3:1} Heb 4,14} \bibleverse{2} El cual es
fiel al que le constituyó, como también lo fué Moisés sobre toda su
casa. \footnote{\textbf{3:2} Núm 12,7} \bibleverse{3} Porque de tanto
...
su voz, \footnote{\textbf{3:7} Heb 4,7} \bibleverse{8} No endurezcáis
...
\bibleverse{9} Donde me tentaron vuestros padres; me probaron, y vieron
mis obras cuarenta años. \bibleverse{10} A causa de lo cual me enemisté
con esta generación, y dije: Siempre divagan ellos de corazón, y no han
conocido mis caminos. \bibleverse{11} Juré, pues, en mi ira: No entrarán
en mi reposo.
...
\footnote{\textbf{3:14} Heb 6,11} \bibleverse{15} Entre tanto que se
...
cuyos cuerpos cayeron en el desierto? \footnote{\textbf{3:17} Núm 14,29;
  1Cor 10,10} \bibleverse{18} ¿Y á quiénes juró que no entrarían en su
reposo, sino á aquellos que no obedecieron? \bibleverse{19} Y vemos que
...
pensamientos y las intenciones del corazón. \footnote{\textbf{4:12} Jer
  23,29; Apoc 2,12} \bibleverse{13} Y no hay cosa criada que no sea
...
cielos, Jesús el Hijo de Dios, retengamos nuestra profesión. \footnote{\textbf{4:14}
  Heb 3,1; Heb 9,11-12; Heb 10,23} \bibleverse{15} Porque no tenemos un
...
en todo según nuestra semejanza, pero sin pecado. \footnote{\textbf{4:15}
  Heb 2,18; Juan 8,46} \bibleverse{16} Lleguémonos pues confiadamente al
...
Dios, como Aarón. \footnote{\textbf{5:4} Éxod 28,1} \bibleverse{5} Así
...
\bibleverse{8} Y aunque era Hijo, por lo que padeció aprendió la
obediencia; \footnote{\textbf{5:8} Fil 2,8} \bibleverse{9} Y consumado,
vino á ser causa de eterna salud á todos los que le obedecen;
\bibleverse{10} Nombrado de Dios pontífice según el orden de
Melchîsedec.
...
\footnote{\textbf{5:13} Efes 4,14} \bibleverse{14} Mas la vianda firme
...
\footnote{\textbf{6:10} Heb 10,32-34} \bibleverse{11} Mas deseamos que
...
confirmación. \footnote{\textbf{6:16} Éxod 22,10} \bibleverse{17} Por lo
...
\bibleverse{2} Al cual asimismo dió Abraham los diezmos de todo,
primeramente él se interpreta Rey de justicia; y luego también Rey de
Salem, que es, Rey de paz; \bibleverse{3} Sin padre, sin madre, sin
...
Moisés tocante al sacerdocio. \footnote{\textbf{7:14} Gén 49,10; Is
  11,1; Mat 1,1-3} \bibleverse{15} Y aun más manifiesto es, si á
semejanza de Melchîsedec se levanta otro sacerdote, \bibleverse{16} El
cual no es hecho conforme á la ley del mandamiento carnal, sino según la
virtud de vida indisoluble; \bibleverse{17} Pues se da testimonio de él:
...
mismo. \footnote{\textbf{7:27} Lev 16,6; Lev 16,15} \bibleverse{28}
...
el monte. \footnote{\textbf{8:5} Col 2,17} \bibleverse{6} Mas ahora
...
\footnote{\textbf{8:8} Heb 10,16-17} \bibleverse{9} No como el pacto que
...
\footnote{\textbf{9:3} Éxod 26,33} \bibleverse{4} El cual tenía un
...
y la vara de Aarón que reverdeció, y las tablas del pacto; \footnote{\textbf{9:4}
  Éxod 16,33; Éxod 25,10-22; Núm 17,23-25} \bibleverse{5} Y sobre ella
...
á la conciencia, al que servía con ellos; \footnote{\textbf{9:9} Heb
  7,19; Heb 10,1-2} \bibleverse{10} Consistiendo sólo en viandas y en
...
para la purificación de la carne, \footnote{\textbf{9:13} Núm 19,2; Núm
  19,9; Núm 19,17} \bibleverse{14} ¿Cuánto más la sangre de Cristo, el
...
\bibleverse{16} Porque donde hay testamento, necesario es que intervenga
muerte del testador. \bibleverse{17} Porque el testamento con la muerte
...
tabernáculo y todos los vasos del ministerio. \footnote{\textbf{9:21}
  Lev 8,15; Lev 8,19} \bibleverse{22} Y casi todo es purificado según la
...
Dios. \footnote{\textbf{9:24} Heb 7,25; 1Jn 2,1} \bibleverse{25} Y no
para ofrecerse muchas veces á sí mismo, como entra el pontífice en el
santuario cada año con sangre ajena; \bibleverse{26} De otra manera
...
\bibleverse{27} Y de la manera que está establecido á los hombres que
...
que se allegan. \footnote{\textbf{10:1} Heb 8,5} \bibleverse{2} De otra
manera cesarían de ofrecerse; porque los que tributan este culto,
limpios de una vez, no tendrían más conciencia de pecado. \bibleverse{3}
Empero en estos sacrificios cada año se hace conmemoración de los
pecados. \bibleverse{4} Porque la sangre de los toros y de los machos
cabríos no puede quitar los pecados. \bibleverse{5} Por lo cual,
entrando en el mundo, dice: Sacrificio y presente no quisiste; mas me
apropiaste cuerpo: \bibleverse{6} Holocaustos y expiaciones por el
pecado no te agradaron. \bibleverse{7} Entonces dije: Heme aquí (en la
...
siempre, está sentado á la diestra de Dios, \bibleverse{13} Esperando lo
que resta, hasta que sus enemigos sean puestos por estrado de sus pies.
\footnote{\textbf{10:13} Sal 110,1} \bibleverse{14} Porque con una sola
...
\footnote{\textbf{10:20} Heb 9,8} \bibleverse{21} Y teniendo un gran
sacerdote sobre la casa de Dios, \bibleverse{22} Lleguémonos con corazón
...
pecado. \footnote{\textbf{10:26} Heb 6,4-8} \bibleverse{27} Sino una
...
gracia? \footnote{\textbf{10:29} Heb 2,3; Heb 12,25} \bibleverse{30}
...
aflicciones: \footnote{\textbf{10:32} Heb 6,4} \bibleverse{33} Por una
...
tal estado. \footnote{\textbf{10:33} 1Cor 4,9} \bibleverse{34} Porque de
...
sustancia en los cielos, y que permanece. \footnote{\textbf{10:34} Mat
  6,20; Mat 19,21; Mat 19,29} \bibleverse{35} No perdáis pues vuestra
confianza, que tiene grande remuneración de galardón: \bibleverse{36}
Porque la paciencia os es necesaria; para que, habiendo hecho la
voluntad de Dios, obtengáis la promesa. \bibleverse{37} Porque aun un
poquito, y el que ha de venir vendrá, y no tardará. \bibleverse{38}
...
\bibleverse{6} Empero sin fe es imposible agradar á Dios; porque es
...
\footnote{\textbf{11:7} Gén 6,8-9; Gén 6,13-22}
...
\footnote{\textbf{11:8} Gén 12,1-21} \bibleverse{9} Por fe habitó en la
tierra prometida como en tierra ajena, morando en cabañas con Isaac y
Jacob, herederos juntamente de la misma promesa: \bibleverse{10} Porque
...
\footnote{\textbf{11:13} Gén 23,4; Gén 47,9} \bibleverse{14} Porque los
que esto dicen, claramente dan á entender que buscan una patria.
\bibleverse{15} Que si se acordaran de aquella de donde salieron, cierto
tenían tiempo para volverse: \bibleverse{16} Empero deseaban la mejor,
...
ofrecía al unigénito el que había recibido las promesas, \footnote{\textbf{11:17}
  Gén 22,-1; Sant 2,21} \bibleverse{18} Habiéndole sido dicho: En Isaac
te será llamada simiente: \bibleverse{19} Pensando que aun de los
...
paralizadas; \footnote{\textbf{12:12} Is 35,3} \bibleverse{13} Y haced
...
\bibleverse{15} Mirando bien que ninguno se aparte de la gracia de Dios,
que ninguna raíz de amargura brotando os impida, y por ella muchos sean
contaminados; \footnote{\textbf{12:15} Deut 29,17} \bibleverse{16} Que
ninguno sea fornicario, ó profano, como Esaú, que por una vianda vendió
su primogenitura. \footnote{\textbf{12:16} Gén 25,33-34} \bibleverse{17}
...
la cual los que la oyeron rogaron que no se les hablase más; \footnote{\textbf{12:19}
  Éxod 20,19} \bibleverse{20} Porque no podían tolerar lo que se
mandaba: Si bestia tocare al monte, será apedreada, ó pasada con dardo.
\bibleverse{21} Y tan terrible cosa era lo que se veía, que Moisés dijo:
...
millares de ángeles, \footnote{\textbf{12:22} Gal 4,26; Efes 2,6; Fil
  3,20; Apoc 5,11; Apoc 21,2} \bibleverse{23} Y á la congregación de los
...
todos, y á los espíritus de los justos hechos perfectos, \footnote{\textbf{12:23}
  Luc 10,20} \bibleverse{24} Y á Jesús el Mediador del nuevo testamento,
...
nosotros, si desecháramos al que habla de los cielos. \footnote{\textbf{12:25}
  Heb 2,2; Heb 10,28-29} \bibleverse{26} La voz del cual entonces
conmovió la tierra; mas ahora ha denunciado, diciendo: Aun una vez, y yo
conmoveré no solamente la tierra, mas aun el cielo. \bibleverse{27} Y
...
\bibleverse{28} Así que, tomando el reino inmóvil, retengamos la gracia
por la cual sirvamos á Dios agradándole con temor y reverencia;
\bibleverse{29} Porque nuestro Dios es fuego consumidor. \footnote{\textbf{12:29}
  Heb 10,31; Deut 4,24}
...
\bibleverse{1} Permanezca el amor fraternal. \footnote{\textbf{13:1}
  Juan 13,34; 2Pe 1,7} \bibleverse{2} No olvidéis la hospitalidad,
...
afligidos, como que también vosotros mismos sois del cuerpo. \footnote{\textbf{13:3}
  Mat 25,36} \bibleverse{4} Honroso es en todos el matrimonio, y el
...
\footnote{\textbf{13:5} 1Tim 6,6} \bibleverse{6} De tal manera que
...
sangre, padeció fuera de la puerta. \footnote{\textbf{13:12} Juan 19,17;
  Mat 21,39} \bibleverse{13} Salgamos pues á él fuera del real, llevando
su vituperio. \footnote{\textbf{13:13} Heb 11,26; Heb 12,2}
\bibleverse{14} Porque no tenemos aquí ciudad permanente, mas buscamos
la por venir. \footnote{\textbf{13:14} Heb 11,10; Heb 12,22}
\bibleverse{15} Así que, ofrezcamos por medio de él á Dios siempre
...
conciencia, deseando conversar bien en todo. \footnote{\textbf{13:18}
  Rom 15,30; 2Cor 1,11-12} \bibleverse{19} Y más os ruego que lo hagáis
...
eterno, \footnote{\textbf{13:20} Juan 10,12; 1Pe 2,25} \bibleverse{21}
