...
resurrección de Jesucristo de los muertos, \footnote{\textbf{1:3} Col
  1,5} \bibleverse{4} Para una herencia incorruptible, y que no puede
contaminarse, ni marchitarse, reservada en los cielos \footnote{\textbf{1:4}
  Col 1,12} \bibleverse{5} Para nosotros que somos guardados en la
...
ser manifestada en el postrimero tiempo. \footnote{\textbf{1:5} Juan
  10,28} \bibleverse{6} En lo cual vosotros os alegráis, estando al
presente un poco de tiempo afligidos en diversas tentaciones, si es
necesario, \footnote{\textbf{1:6} 1Pe 5,10; 2Cor 4,17} \bibleverse{7}
...
y honra, cuando Jesucristo fuere manifestado: \footnote{\textbf{1:7}
  Prov 17,3; Mal 3,3} \bibleverse{8} Al cual, no habiendo visto, le
...
con gozo inefable y glorificado; \footnote{\textbf{1:8} Juan 20,29; 2Cor
  5,7} \bibleverse{9} Obteniendo el fin de vuestra fe, que es la salud
de vuestras almas.
...
\bibleverse{12} A los cuales fué revelado, que no para sí mismos, sino
...
presentada cuando Jesucristo os es manifestado: \footnote{\textbf{1:13}
  Luc 12,35-36} \bibleverse{14} Como hijos obedientes, no conformándoos
con los deseos que antes teníais estando en vuestra ignorancia;
\footnote{\textbf{1:14} Rom 12,2} \bibleverse{15} Sino como aquel que os
...
tiempo de vuestra peregrinación: \footnote{\textbf{1:17} Rom 2,11; Fil
  2,12} \bibleverse{18} Sabiendo que habéis sido rescatados de vuestra
...
corruptibles, como oro ó plata; \footnote{\textbf{1:18} 1Cor 6,20; 1Cor
  7,23; 1Pe 4,3} \bibleverse{19} Sino con la sangre preciosa de Cristo,
como de un cordero sin mancha y sin contaminación: \footnote{\textbf{1:19}
  Juan 1,29; Is 53,7; Heb 9,14} \bibleverse{20} Ya ordenado de antes de
la fundación del mundo, pero manifestado en los postrimeros tiempos por
amor de vosotros, \footnote{\textbf{1:20} Rom 16,25-26} \bibleverse{21}
...
palabra de Dios, que vive y permanece para siempre. \footnote{\textbf{1:23}
  Juan 1,13; Juan 3,5; Sant 1,18} \bibleverse{24} Porque Toda carne es
...
secóse la hierba, y la flor se cayó; \footnote{\textbf{1:24} Sant 1,10;
  Sant 1,1-11} \bibleverse{25} Mas la palabra del Señor permanece
...
\bibleverse{2} Desead, como niños recién nacidos, la leche espiritual,
sin engaño, para que por ella crezcáis en salud: \footnote{\textbf{2:2}
  Mat 18,3; Heb 5,12-13} \bibleverse{3} Si empero habéis gustado que el
Señor es benigno; \footnote{\textbf{2:3} Sal 34,9} \bibleverse{4} Al
...
\bibleverse{5} Vosotros también, como piedras vivas, sed edificados una
...
espirituales, agradables á Dios por Jesucristo. \footnote{\textbf{2:5}
  Efes 2,21-22; Heb 3,6; Rom 12,1} \bibleverse{6} Por lo cual también
...
ha llamado de las tinieblas á su luz admirable: \footnote{\textbf{2:9}
  Éxod 19,6; Apoc 1,6; Efes 5,8} \bibleverse{10} Vosotros, que en el
...
\footnote{\textbf{2:11} Sal 39,13} \bibleverse{12} Teniendo vuestra
...
Dios: ya sea al rey, como á superior; \footnote{\textbf{2:13} Rom
  13,1-7; Tit 3,1} \bibleverse{14} Ya á los gobernadores, como de él
enviados para venganza de los malhechores, y para loor de los que hacen
bien. \bibleverse{15} Porque esta es la voluntad de Dios; que haciendo
bien, hagáis callar la ignorancia de los hombres vanos: \bibleverse{16}
...
\footnote{\textbf{2:18} Efes 6,5; Tit 2,9} \bibleverse{19} Porque esto
...
boca: \footnote{\textbf{2:22} Is 53,9; Juan 8,46} \bibleverse{23} Quien
cuando le maldecían, no retornaba maldición; cuando padecía, no
amenazaba, sino remitía la causa al que juzga justamente:
\bibleverse{24} El cual mismo llevó nuestros pecados en su cuerpo sobre
...
justicia: por la herida del cual habéis sido sanados. \footnote{\textbf{2:24}
  Rom 6,8; Rom 6,11; Gal 3,13; 1Jn 3,5} \bibleverse{25} Porque vosotros
...
sin palabra por la conversación de sus mujeres, \footnote{\textbf{3:1}
  Efes 5,22; 1Cor 7,16} \bibleverse{2} Considerando vuestra casta
conversación, que es en temor. \bibleverse{3} El adorno de las cuales no
sea exterior con encrespamiento del cabello, y atavío de oro, ni en
compostura de ropas; \bibleverse{4} Sino el hombre del corazón que está
encubierto, en incorruptible ornato de espíritu agradable y pacífico, lo
cual es de grande estima delante de Dios. \bibleverse{5} Porque así
también se ataviaban en el tiempo antiguo aquellas santas mujeres que
esperaban en Dios, siendo sujetas á sus maridos: \bibleverse{6} Como
...
\bibleverse{10} Porque el que quiere amar la vida, y ver días buenos,
refrene su lengua de mal, y sus labios no hablen engaño; \footnote{\textbf{3:10}
  Sant 1,26} \bibleverse{11} Apártase del mal, y haga bien; busque la
...
\bibleverse{15} Sino santificad al Señor Dios en vuestros corazones, y
...
\bibleverse{16} Teniendo buena conciencia, para que en lo que murmuran
de vosotros como de malhechores, sean confundidos los que blasfeman
vuestra buena conversación en Cristo. \bibleverse{17} Porque mejor es
...
cual también fué y predicó á los espíritus encarcelados; \footnote{\textbf{3:19}
  1Pe 4,6} \bibleverse{20} Los cuales en otro tiempo fueron
...
personas fueron salvas por agua. \footnote{\textbf{3:20} Gén 7,7; Gén
  7,17; 2Pe 2,5} \bibleverse{21} A la figura de la cual el bautismo que
...
\bibleverse{22} El cual está á la diestra de Dios, habiendo subido al
...
\footnote{\textbf{4:3} Efes 2,2-3; Tit 3,3} \bibleverse{4} En lo cual
les parece cosa extraña que vosotros no corráis con ellos en el mismo
desenfrenamiento de disolución, ultrajándoos: \bibleverse{5} Los cuales
darán cuenta al que está aparejado para juzgar los vivos y los muertos.
\bibleverse{6} Porque por esto también ha sido predicado el evangelio á
...
templados, y velad en oración. \footnote{\textbf{4:7} 1Cor 10,11; 1Jn
  2,18} \bibleverse{8} Y sobre todo, tened entre vosotros ferviente
caridad; porque la caridad cubrirá multitud de pecados. \footnote{\textbf{4:8}
  Sant 5,20} \bibleverse{9} Hospedaos los unos á los otros sin
murmuraciones. \footnote{\textbf{4:9} Heb 13,2} \bibleverse{10} Cada uno
según el don que ha recibido, adminístrelo á los otros, como buenos
dispensadores de las diferentes gracias de Dios. \bibleverse{11} Si
...
\bibleverse{13} Antes bien gozaos en que sois participantes de las
...
\bibleverse{14} Si sois vituperados en el nombre de Cristo, sois
...
á Dios en esta parte. \footnote{\textbf{4:16} Fil 1,20} \bibleverse{17}
...
obedecen al evangelio de Dios? \footnote{\textbf{4:17} Jer 25,29; Ezeq
  9,6} \bibleverse{18} Y si el justo con dificultad se salva, ¿á dónde
aparecerá el infiel y el pecador? \footnote{\textbf{4:18} Prov 11,31}
\bibleverse{19} Y por eso los que son afligidos según la voluntad de
...
también participante de la gloria que ha de ser revelada: \footnote{\textbf{5:1}
  Rom 8,17; 2Jn 1,-1} \bibleverse{2} Apacentad la grey de Dios que está
...
\bibleverse{3} Y no como teniendo señorío sobre las heredades del Señor,
sino siendo dechados de la grey. \footnote{\textbf{5:3} Ezeq 34,2-4;
  2Cor 1,24; Tit 2,7} \bibleverse{4} Y cuando apareciere el Príncipe de
...
soberbios, y da gracia á los humildes. \footnote{\textbf{5:5} Prov 3,34;
  Mat 23,12; Efes 5,21; Sant 4,6} \bibleverse{6} Humillaos pues bajo la
poderosa mano de Dios, para que él os ensalce cuando fuere tiempo;
\footnote{\textbf{5:6} Job 22,29; Sant 4,10} \bibleverse{7} Echando toda
...
\footnote{\textbf{5:8} 2Cor 2,11; 1Tes 5,6; Luc 22,31} \bibleverse{9} Al
...
mundo. \bibleverse{10} Mas el Dios de toda gracia, que nos ha llamado á
...
\footnote{\textbf{5:10} 1Pe 1,6} \bibleverse{11} A él sea gloria é
