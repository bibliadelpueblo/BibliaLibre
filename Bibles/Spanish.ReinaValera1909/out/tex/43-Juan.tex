...
que es hecho, fué hecho. \footnote{\textbf{1:3} 1Cor 8,6; Col 1,16-17;
  Heb 1,2} \bibleverse{4} En él estaba la vida, y la vida era la luz de
los hombres. \footnote{\textbf{1:4} Juan 8,12} \bibleverse{5} Y la luz
...
\footnote{\textbf{1:6} Mat 3,1; Mar 1,4} \bibleverse{7} Este vino por
testimonio, para que diese testimonio de la luz, para que todos creyesen
por él. \footnote{\textbf{1:7} Hech 19,4} \bibleverse{8} No era él la
luz, sino para que diese testimonio de la luz. \bibleverse{9} Aquél era
...
gracia y de verdad. \footnote{\textbf{1:14} Is 7,14; Is 60,1; 2Pe
  1,16-17} \bibleverse{15} Juan dió testimonio de él, y clamó diciendo:
Este es del que yo decía: El que viene tras mí, es antes de mí: porque
es primero que yo. \bibleverse{16} Porque de su plenitud tomamos todos,
...
\footnote{\textbf{1:18} Juan 6,46; Mat 11,27}
...
en medio de vosotros ha estado á quien vosotros no conocéis. \footnote{\textbf{1:26}
  Luc 17,21} \bibleverse{27} Este es el que ha de venir tras mí, el cual
es antes de mí: del cual yo no soy digno de desatar la correa del
zapato. \bibleverse{28} Estas cosas acontecieron en Betábara, de la otra
...
habían oído de Juan, y le habían seguido. \footnote{\textbf{1:40} Mat
  4,18-20} \bibleverse{41} Este halló primero á su hermano Simón, y
díjole: Hemos hallado al Mesías (que declarado es, el Cristo).
\bibleverse{42} Y le trajo á Jesús. Y mirándole Jesús, dijo: Tú eres
...
Jerusalem. \footnote{\textbf{2:13} Mat 20,18; Mar 11,1; Luc 19,28; Juan
  5,1} \bibleverse{14} Y halló en el templo á los que vendían bueyes, y
ovejas, y palomas, y á los cambiadores sentados. \bibleverse{15} Y hecho
...
Nicodemo, príncipe de los Judíos. \footnote{\textbf{3:1} Juan 7,50; Juan
  19,39} \bibleverse{2} Este vino á Jesús de noche, y díjole: Rabbí,
...
espíritu es. \footnote{\textbf{3:6} Juan 1,13; Rom 8,5-9} \bibleverse{7}
No te maravilles de que te dije: Os es necesario nacer otra vez.
\bibleverse{8} El viento de donde quiere sopla, y oyes su sonido; mas ni
...
\bibleverse{18} El que en él cree, no es condenado; mas el que no cree,
ya es condenado, porque no creyó en el nombre del unigénito Hijo de
Dios. \footnote{\textbf{3:18} Juan 5,24} \bibleverse{19} Y esta es la
...
tinieblas que la luz; porque sus obras eran malas. \footnote{\textbf{3:19}
  Juan 1,5; Juan 1,9-11} \bibleverse{20} Porque todo aquel que hace lo
malo, aborrece la luz y no viene á la luz, porque sus obras no sean
redargüidas. \footnote{\textbf{3:20} Efes 5,13} \bibleverse{21} Mas el
...
de Judea; y estaba allí con ellos, y bautizaba. \footnote{\textbf{3:22}
  Juan 4,1-2} \bibleverse{23} Y bautizaba también Juan en Enón junto á
...
\footnote{\textbf{3:24} Mar 1,14} \bibleverse{25} Y hubo cuestión entre
...
\bibleverse{28} Vosotros mismos me sois testigos que dije: Yo no soy el
Cristo, sino que soy enviado delante de él. \footnote{\textbf{3:28} Juan
  1,20; Juan 1,23; Juan 1,27} \bibleverse{29} El que tiene la esposa, es
...
\footnote{\textbf{3:29} Mat 9,15} \bibleverse{30} A él conviene crecer,
mas á mí menguar.
...
medida. \footnote{\textbf{3:34} Juan 1,16} \bibleverse{35} El Padre ama
al Hijo, y todas las cosas dió en su mano. \footnote{\textbf{3:35} Juan
  5,20; Mat 11,27} \bibleverse{36} El que cree en el Hijo, tiene vida
...
oído que Jesús hacía y bautizaba más discípulos que Juan, \footnote{\textbf{4:1}
  Juan 3,22; Juan 3,26} \bibleverse{2} (Aunque Jesús no bautizaba, sino
sus discípulos), \bibleverse{3} Dejó á Judea, y fuése otra vez á
Galilea. \bibleverse{4} Y era menester que pasase por Samaria.
\bibleverse{5} Vino, pues, á una ciudad de Samaria que se llamaba
Sichâr, junto á la heredad que Jacob dió á José su hijo. \bibleverse{6}
...
\bibleverse{14} Mas el que bebiere del agua que yo le daré, para siempre
...
me envió, y que acabe su obra. \footnote{\textbf{4:34} Juan 6,38; Juan
  17,4} \bibleverse{35} ¿No decís vosotros: Aun hay cuatro meses hasta
...
regiones, porque ya están blancas para la siega. \footnote{\textbf{4:35}
  Mat 9,37} \bibleverse{36} Y el que siega, recibe salario, y allega
fruto para vida eterna; para que el que siembra también goce, y el que
siega. \bibleverse{37} Porque en esto es el dicho verdadero: Que uno es
el que siembra, y otro es el que siega. \bibleverse{38} Yo os he enviado
...
\footnote{\textbf{4:43} Mat 4,12} \bibleverse{44} Porque el mismo Jesús
dió testimonio de que el profeta en su tierra no tiene honra.
\footnote{\textbf{4:44} Mat 13,57} \bibleverse{45} Y como vino á
...
ido á la fiesta. \footnote{\textbf{4:45} Juan 2,23} \bibleverse{46} Vino
...
\footnote{\textbf{4:46} Juan 2,1; Juan 2,9} \bibleverse{47} Este, como
oyó que Jesús venía de Judea á Galilea, fué á él, y rogábale que
descendiese, y sanase á su hijo, porque se comenzaba á morir.
\bibleverse{48} Entonces Jesús le dijo: Si no viereis señales y milagros
no creeréis.
...
\bibleverse{2} Y hay en Jerusalem á la puerta del ganado un estanque,
que en hebraico es llamado Bethesda, el cual tiene cinco portales.
\footnote{\textbf{5:2} Neh 3,1} \bibleverse{3} En éstos yacía multitud
de enfermos, ciegos, cojos, secos, que estaban esperando el movimiento
del agua. \bibleverse{4} Porque un ángel descendía á cierto tiempo al
...
\bibleverse{20} Porque el Padre ama al Hijo, y le muestra todas las
...
\bibleverse{21} Porque como el Padre levanta los muertos, y les da vida,
así también el Hijo á los que quiere da vida. \bibleverse{22} Porque el
Padre á nadie juzga, mas todo el juicio dió al Hijo; \footnote{\textbf{5:22}
  Dan 7,12; Dan 7,14; Hech 10,42} \bibleverse{23} Para que todos honren
...
\bibleverse{25} De cierto, de cierto os digo: Vendrá hora, y ahora es,
...
vida en sí mismo: \footnote{\textbf{5:26} Juan 1,1-4} \bibleverse{27} Y
también le dió poder de hacer juicio, en cuanto es el Hijo del hombre.
\footnote{\textbf{5:27} Dan 7,13-14} \bibleverse{28} No os maravilléis
de esto; porque vendrá hora, cuando todos los que están en los sepulcros
oirán su voz; \bibleverse{29} Y los que hicieron bien, saldrán á
...
\bibleverse{30} No puedo yo de mí mismo hacer nada: como oigo, juzgo: y
...
enviasteis á Juan, y él dió testimonio á la verdad. \footnote{\textbf{5:33}
  Juan 1,19-34} \bibleverse{34} Empero yo no tomo el testimonio de
hombre; mas digo esto, para que vosotros seáis salvos. \bibleverse{35}
...
oído su voz, ni habéis visto su parecer. \footnote{\textbf{5:37} Mat
  3,17} \bibleverse{38} Ni tenéis su palabra permanente en vosotros;
...
\bibleverse{44} ¿Cómo podéis vosotros creer, pues tomáis la gloria los
...
hay quien os acusa, Moisés, en quien vosotros esperáis. \footnote{\textbf{5:45}
  Deut 31,26-27} \bibleverse{46} Porque si vosotros creyeseis á Moisés,
creeríais á mí; porque de mí escribió él. \footnote{\textbf{5:46} Gén
  3,15; Gén 49,10; Deut 18,15} \bibleverse{47} Y si á sus escritos no
...
verdaderamente es el profeta que había de venir al mundo. \footnote{\textbf{6:14}
  Deut 18,15} \bibleverse{15} Y entendiendo Jesús que habían de venir
...
\footnote{\textbf{6:35} Juan 4,14; Juan 7,37} \bibleverse{36} Mas os he
dicho, que aunque me habéis visto, no creéis. \bibleverse{37} Todo lo
que el Padre me da, vendrá á mí; y al que á mí viene, no le hecho fuera.
\bibleverse{38} Porque he descendido del cielo, no para hacer mi
voluntad, mas la voluntad del que me envió. \footnote{\textbf{6:38} Juan
  4,34} \bibleverse{39} Y esta es la voluntad del que me envió, del
...
\bibleverse{40} Y esta es la voluntad del que me ha enviado: Que todo
...
\bibleverse{47} De cierto, de cierto os digo: El que cree en mí, tiene
vida eterna. \footnote{\textbf{6:47} Juan 3,16} \bibleverse{48} Yo soy
el pan de vida. \footnote{\textbf{6:48} Juan 6,35} \bibleverse{49}
Vuestros padres comieron el maná en el desierto, y son muertos.
\footnote{\textbf{6:49} 1Cor 10,3-5} \bibleverse{50} Este es el pan que
desciende del cielo, para que el que de él comiere, no muera.
\bibleverse{51} Yo soy el pan vivo que he descendido del cielo: si
...
verdadera comida, y mi sangre es verdadera bebida. \bibleverse{56} El
que come mi carne y bebe mi sangre, en mí permanece, y yo en él.
\bibleverse{57} Como me envió el Padre viviente, y yo vivo por el Padre,
asimismo el que me come, él también vivirá por mí. \bibleverse{58} Este
...
\footnote{\textbf{6:62} Luc 24,50-51} \bibleverse{63} El espíritu es el
...
tabernáculos. \footnote{\textbf{7:2} Lev 23,34-36} \bibleverse{3} Y
...
tus discípulos vean las obras que haces. \footnote{\textbf{7:3} Juan
  2,12; Mat 12,46; Hech 1,14} \bibleverse{4} Que ninguno que procura ser
...
\footnote{\textbf{7:7} Juan 15,18} \bibleverse{8} Vosotros subid á esta
...
\footnote{\textbf{7:10} Juan 2,13} \bibleverse{11} Y buscábanle los
...
maravilláis. \footnote{\textbf{7:21} Juan 5,16} \bibleverse{22} Cierto,
...
padres); y en sábado circuncidáis al hombre. \footnote{\textbf{7:22} Gén
  17,10-12; Lev 12,3} \bibleverse{23} Si recibe el hombre la
...
\bibleverse{24} No juzguéis según lo que parece, mas juzgad justo
juicio.
...
mano, porque aun no había venido su hora. \footnote{\textbf{7:30} Juan
  8,20; Luc 22,53} \bibleverse{31} Y muchos del pueblo creyeron en él, y
decían: El Cristo, cuando viniere, ¿hará más señales que las que éste
hace? \bibleverse{32} Los Fariseos oyeron á la gente que murmuraba de él
...
\bibleverse{39} (Y esto dijo del Espíritu que habían de recibir los que
...
decían: Verdaderamente éste es el profeta. \footnote{\textbf{7:40} Juan
  6,14} \bibleverse{41} Otros decían: Este es el Cristo. Algunos empero
decían: ¿De Galilea ha de venir el Cristo? \footnote{\textbf{7:41} Juan
  1,46} \bibleverse{42} ¿No dice la Escritura, que de la simiente de
David, y de la aldea de Bethlehem, de donde era David, vendrá el Cristo?
\footnote{\textbf{7:42} Miq 5,1; Mat 2,5-6; Mat 22,42} \bibleverse{43}
Así que había disensión entre la gente acerca de él. \footnote{\textbf{7:43}
  Juan 9,16} \bibleverse{44} Y algunos de ellos querían prenderle; mas
...
primero. \footnote{\textbf{8:7} Rom 2,1} \bibleverse{8} Y volviéndose á
...
nadie. \footnote{\textbf{8:15} Juan 3,17} \bibleverse{16} Y si yo juzgo,
mi juicio es verdadero; porque no soy solo, sino yo y el que me envió,
el Padre. \bibleverse{17} Y en vuestra ley está escrito que el
testimonio de dos hombres es verdadero. \bibleverse{18} Yo soy el que
...
mas como el Padre me enseñó, esto hablo. \footnote{\textbf{8:28} Juan
  3,14; Juan 12,32} \bibleverse{29} Porque el que me envió, conmigo
...
reconocéis mi lenguaje? porque no podéis oir mi palabra. \footnote{\textbf{8:43}
  1Cor 2,14} \bibleverse{44} Vosotros de vuestro padre el diablo sois, y
...
vosotros no me creéis? \footnote{\textbf{8:46} 2Cor 5,21; 1Pe 2,22; 1Jn
  3,5; Heb 4,15} \bibleverse{47} El que es de Dios, las palabras de Dios
...
mas le conozco, y guardo su palabra. \footnote{\textbf{8:55} Juan
  7,28-29} \bibleverse{56} Abraham vuestro padre se gozó por ver mi día;
y lo vió, y se gozó.
...
que las obras de Dios se manifiesten en él. \footnote{\textbf{9:3} Juan
  11,4} \bibleverse{4} Conviéneme obrar las obras del que me envió,
entre tanto que el día dura: la noche viene, cuando nadie puede obrar.
\footnote{\textbf{9:4} Juan 5,17; Jer 13,16} \bibleverse{5} Entre tanto
que estuviere en el mundo, luz soy del mundo. \footnote{\textbf{9:5}
  Juan 12,35; Juan 8,12} \bibleverse{6} Esto dicho, escupió en tierra, é
hizo lodo con la saliva, y untó con el lodo sobre los ojos del ciego,
\footnote{\textbf{9:6} Mar 8,23} \bibleverse{7} Y díjole: Ve, lávate en
...
\bibleverse{23} Por eso dijeron sus padres: Edad tiene, preguntadle á
él.
...
\footnote{\textbf{10:12} Sal 23,-1; Is 40,11; Ezeq 34,11-23; Juan 15,13;
  Heb 13,20} \bibleverse{13} Así que, el asalariado, huye, porque es
...
voz; y habrá un rebaño, y un pastor. \footnote{\textbf{10:16} Juan
  11,52; Hech 10,34-35} \bibleverse{17} Por eso me ama el Padre, porque
yo pongo mi vida, para volverla á tomar. \bibleverse{18} Nadie me la
...
palabras. \footnote{\textbf{10:19} Juan 7,43; Juan 9,16} \bibleverse{20}
Y muchos de ellos decían: Demonio tiene, y está fuera de sí; ¿para qué
le oís? \footnote{\textbf{10:20} Juan 7,20; Mar 3,21} \bibleverse{21}
...
de Salomón. \footnote{\textbf{10:23} Hech 3,11} \bibleverse{24} Y
...
\bibleverse{28} Y yo les doy vida eterna: y no perecerán para siempre,
ni nadie las arrebatará de mi mano. \bibleverse{29} Mi Padre que me las
dió, mayor que todos es: y nadie las puede arrebatar de la mano de mi
Padre. \bibleverse{30} Yo y el Padre una cosa somos.
...
había estado bautizando Juan; y estúvose allí. \footnote{\textbf{10:40}
  Juan 1,28} \bibleverse{41} Y muchos venían á él, y decían: Juan, á la
verdad, ninguna señal hizo; mas todo lo que Juan dijo de éste, era
verdad. \bibleverse{42} Y muchos creyeron allí en él.
...
la aldea de María y de Marta su hermana. \footnote{\textbf{11:1} Luc
  10,38-39} \bibleverse{2} (Y María, cuyo hermano Lázaro estaba enfermo,
era la que ungió al Señor con ungüento, y limpió sus pies con sus
cabellos.) \footnote{\textbf{11:2} Juan 12,3} \bibleverse{3} Enviaron,
...
por ella. \footnote{\textbf{11:4} Juan 9,3} \bibleverse{5} Y amaba Jesús
á Marta, y á su hermana, y á Lázaro. \bibleverse{6} Como oyó pues que
estaba enfermo, quedóse aún dos días en aquel lugar donde estaba.
\bibleverse{7} Luego, después de esto, dijo á los discípulos: Vamos á
Judea otra vez.
...
\footnote{\textbf{11:9} Juan 9,4-5} \bibleverse{10} Mas el que anduviere
de noche, tropieza, porque no hay luz en él. \footnote{\textbf{11:10}
  Juan 12,35} \bibleverse{11} Dicho esto, díceles después: Lázaro
...
sepulcro. Era una cueva, la cual tenía una piedra encima. \footnote{\textbf{11:38}
  Mat 27,60} \bibleverse{39} Dice Jesús: Quitad la piedra. Marta, la
...
\bibleverse{43} Y habiendo dicho estas cosas, clamó á gran voz: Lázaro,
ven fuera.
...
pierda. \footnote{\textbf{11:50} Juan 18,14} \bibleverse{51} Mas esto no
...
profetizó que Jesús había de morir por la nación: \footnote{\textbf{11:51}
  Éxod 28,30; Núm 27,21} \bibleverse{52} Y no solamente por aquella
...
estaban derramados. \footnote{\textbf{11:52} Juan 7,35; Juan 10,16; 1Jn
  2,2} \bibleverse{53} Así que, desde aquel día consultaban juntos de
matarle. \bibleverse{54} Por tanto, Jesús ya no andaba manifiestamente
...
\bibleverse{2} E hiciéronle allí una cena: y Marta servía, y Lázaro era
uno de los que estaban sentados á la mesa juntamente con él.
\bibleverse{3} Entonces María tomó una libra de ungüento de nardo
...
\bibleverse{22} Vino Felipe, y díjolo á Andrés: Andrés entonces, y
...
vida eterna la guardará. \footnote{\textbf{12:25} Mat 10,39; Mat 16,25;
  Luc 17,33} \bibleverse{26} Si alguno me sirve, sígame: y donde yo
...
de esta hora. Mas por esto he venido en esta hora. \footnote{\textbf{12:27}
  Mat 26,38} \bibleverse{28} Padre, glorifica tu nombre. Entonces vino
...
este mundo será echado fuera. \footnote{\textbf{12:31} Juan 14,30; Juan
  16,11; Luc 10,18} \bibleverse{32} Y yo, si fuere levantado de la
tierra, á todos traeré á mí mismo. \footnote{\textbf{12:32} Juan 8,28}
\bibleverse{33} Y esto decía dando á entender de qué muerte había de
morir.
...
va. \footnote{\textbf{12:35} Juan 11,10} \bibleverse{36} Entre tanto que
...
él. \footnote{\textbf{12:41} Is 6,1} \bibleverse{42} Con todo eso, aun
...
no lo confesaban, por no ser echados de la sinagoga. \footnote{\textbf{12:42}
  Juan 9,22} \bibleverse{43} Porque amaban más la gloria de los hombres
...
me envió. \footnote{\textbf{12:45} Juan 14,9} \bibleverse{46} Yo la luz
he venido al mundo, para que todo aquel que cree en mí no permanezca en
tinieblas. \bibleverse{47} Y el que oyere mis palabras, y no las
creyere, yo no le juzgo; porque no he venido á juzgar al mundo, sino á
salvar al mundo. \bibleverse{48} El que me desecha, y no recibe mis
palabras, tiene quien le juzgue: la palabra que he hablado, ella le
juzgará en el día postrero. \bibleverse{49} Porque yo no he hablado de
mí mismo: mas el Padre que me envió, él me dió mandamiento de lo que he
de decir, y de lo que he de hablar. \bibleverse{50} Y sé que su
...
\footnote{\textbf{13:1} Juan 7,30; Juan 17,1} \bibleverse{2} Y la cena
...
en las manos, y que había salido de Dios, y á Dios iba, \footnote{\textbf{13:3}
  Juan 3,35; Juan 16,28} \bibleverse{4} Levántase de la cena, y quítase
su ropa, y tomando una toalla, ciñóse. \bibleverse{5} Luego puso agua en
un lebrillo, y comenzó á lavar los pies de los discípulos, y á
limpiarlos con la toalla con que estaba ceñido. \bibleverse{6} Entonces
...
\bibleverse{14} Pues si yo, el Señor y el Maestro, he lavado vuestros
pies, vosotros también debéis lavar los pies los unos á los otros.
\footnote{\textbf{13:14} Luc 22,27} \bibleverse{15} Porque ejemplo os he
dado, para que como yo os he hecho, vosotros también hagáis. \footnote{\textbf{13:15}
  Fil 2,5; 1Pe 2,21} \bibleverse{16} De cierto, de cierto os digo: El
siervo no es mayor que su señor, ni el apóstol es mayor que el que le
envió. \footnote{\textbf{13:16} Mat 10,24} \bibleverse{17} Si sabéis
estas cosas, bienaventurados seréis, si las hiciereis. \footnote{\textbf{13:17}
  Mat 7,24} \bibleverse{18} No hablo de todos vosotros: yo sé los que he
...
el Hijo del hombre, y Dios es glorificado en él. \footnote{\textbf{13:31}
  Juan 12,23; Juan 12,28} \bibleverse{32} Si Dios es glorificado en él,
Dios también le glorificará en sí mismo, y luego le glorificará.
\footnote{\textbf{13:32} Juan 17,1-5} \bibleverse{33} Hijitos, aun un
...
como os he amado, que también os améis los unos á los otros. \footnote{\textbf{13:34}
  Juan 15,12-13; Juan 15,17} \bibleverse{35} En esto conocerán todos que
...
¿cómo, pues, dices tú: Muéstranos el Padre? \footnote{\textbf{14:9} Juan
  12,45; Heb 1,3} \bibleverse{10} ¿No crees que yo soy en el Padre, y el
...
el Padre que está en mí, él hace las obras. \footnote{\textbf{14:10}
  Juan 12,49} \bibleverse{11} Creedme que yo soy en el Padre, y el Padre
...
yo voy al Padre. \footnote{\textbf{14:12} Mat 28,19} \bibleverse{13} Y
...
Padre sea glorificado en el Hijo. \footnote{\textbf{14:13} Juan 15,7;
  Juan 16,24; Mar 11,24; 1Jn 5,14; 1Jn 1,5-15} \bibleverse{14} Si algo
pidiereis en mi nombre, yo lo haré. \bibleverse{15} Si me amáis, guardad
mis mandamientos; \bibleverse{16} Y yo rogaré al Padre, y os dará otro
Consolador, para que esté con vosotros para siempre: \footnote{\textbf{14:16}
  Juan 15,26; Juan 16,7} \bibleverse{17} Al Espíritu de verdad, al cual
...
le conocéis; porque está con vosotros, y será en vosotros. \footnote{\textbf{14:17}
  Juan 16,13} \bibleverse{18} No os dejaré huérfanos: vendré á vosotros.
...
morada. \footnote{\textbf{14:23} Prov 8,17; Efes 3,17} \bibleverse{24}
...
mí. \footnote{\textbf{14:30} Juan 12,31; Efes 2,2} \bibleverse{31}
...
hablado. \footnote{\textbf{15:3} Juan 13,10; 1Pe 1,23} \bibleverse{4}
...
en mí. \bibleverse{5} Yo soy la vid, vosotros los pámpanos: el que está
en mí, y yo en él, éste lleva mucho fruto; porque sin mí nada podéis
hacer. \bibleverse{6} El que en mí no estuviere, será echado fuera como
mal pámpano, y se secará; y los cogen, y los echan en el fuego, y arden.
\bibleverse{7} Si estuviereis en mí, y mis palabras estuvieren en
...
\bibleverse{14} Vosotros sois mis amigos, si hiciereis las cosas que yo
os mando. \footnote{\textbf{15:14} Juan 8,31; Mat 12,50} \bibleverse{15}
...
antes que á vosotros. \footnote{\textbf{15:18} Juan 7,7} \bibleverse{19}
...
guardado mi palabra, también guardarán la vuestra. \footnote{\textbf{15:20}
  Juan 13,16; Mat 10,24-25} \bibleverse{21} Mas todo esto os harán por
causa de mi nombre, porque no conocen al que me ha enviado. \footnote{\textbf{15:21}
  Juan 16,3} \bibleverse{22} Si no hubiera venido, ni les hubiera
hablado, no tendrían pecado, mas ahora no tienen excusa de su pecado.
\footnote{\textbf{15:22} Juan 9,41} \bibleverse{23} El que me aborrece,
...
dará testimonio de mí. \footnote{\textbf{15:26} Juan 14,16; Juan 14,26;
  Luc 24,49} \bibleverse{27} Y vosotros daréis testimonio, porque estáis
...
cualquiera que os matare, pensará que hace servicio á Dios. \footnote{\textbf{16:2}
  Mat 10,17; Mat 10,22; Mat 24,9} \bibleverse{3} Y estas cosas os harán,
porque no conocen al Padre ni á mí. \footnote{\textbf{16:3} Juan 15,21}
\bibleverse{4} Mas os he dicho esto, para que cuando aquella hora
...
más; \footnote{\textbf{16:10} Hech 5,31; Rom 4,25} \bibleverse{11} Y de
...
podéis llevar. \footnote{\textbf{16:12} 1Cor 3,1} \bibleverse{13} Pero
...
hará saber las cosas que han de venir. \footnote{\textbf{16:13} Juan
  14,26; 1Jn 2,27} \bibleverse{14} El me glorificará: porque tomará de
lo mío, y os lo hará saber. \bibleverse{15} Todo lo que tiene el Padre,
...
gozo. \footnote{\textbf{16:20} Mar 16,10} \bibleverse{21} La mujer
...
dará. \footnote{\textbf{16:23} Juan 14,13-14} \bibleverse{24} Hasta
...
Dios. \footnote{\textbf{16:27} Juan 14,21} \bibleverse{28} Salí del
...
Dios verdadero, y á Jesucristo, al cual has enviado. \footnote{\textbf{17:3}
  1Jn 5,20} \bibleverse{4} Yo te he glorificado en la tierra: he acabado
la obra que me diste que hiciese. \bibleverse{5} Ahora pues, Padre,
...
\bibleverse{9} Yo ruego por ellos: no ruego por el mundo, sino por los
que me diste; porque tuyos son: \footnote{\textbf{17:9} Juan 6,37; Juan
  6,44} \bibleverse{10} Y todas mis cosas son tus cosas, y tus cosas son
mis cosas: y he sido glorificado en ellas. \footnote{\textbf{17:10} Juan
  16,15} \bibleverse{11} Y ya no estoy en el mundo; mas éstos están en
...
\bibleverse{12} Cuando estaba con ellos en el mundo, yo los guardaba en
...
\bibleverse{13} Mas ahora vengo á ti; y hablo esto en el mundo, para que
tengan mi gozo cumplido en sí mismos. \footnote{\textbf{17:13} Juan
  15,11} \bibleverse{14} Yo les he dado tu palabra; y el mundo los
aborreció, porque no son del mundo, como tampoco yo soy del mundo.
\footnote{\textbf{17:14} Juan 15,19} \bibleverse{15} No ruego que los
quites del mundo, sino que los guardes del mal. \footnote{\textbf{17:15}
  Mat 6,13; 2Tes 3,3} \bibleverse{16} No son del mundo, como tampoco yo
soy del mundo. \bibleverse{17} Santifícalos en tu verdad: tu palabra es
verdad. \bibleverse{18} Como tú me enviaste al mundo, también los he
enviado al mundo. \footnote{\textbf{17:18} Juan 20,21} \bibleverse{19} Y
...
que han de creer en mí por la palabra de ellos. \footnote{\textbf{17:20}
  Rom 10,17} \bibleverse{21} Para que todos sean una cosa; como tú, oh
...
para que el mundo crea que tú me enviaste. \footnote{\textbf{17:21} Gal
  3,28} \bibleverse{22} Y yo, la gloria que me diste les he dado; para
que sean una cosa, como también nosotros somos una cosa. \footnote{\textbf{17:22}
  Hech 4,32} \bibleverse{23} Yo en ellos, y tú en mí, para que sean
...
los has amado, como también á mí me has amado. \footnote{\textbf{17:23}
  1Cor 6,17} \bibleverse{24} Padre, aquellos que me has dado, quiero que
...
mundo. \footnote{\textbf{17:24} Juan 12,26} \bibleverse{25} Padre justo,
el mundo no te ha conocido, mas yo te he conocido; y éstos han conocido
que tú me enviaste; \bibleverse{26} Y yo les he manifestado tu nombre, y
...
juntan todos los Judíos, y nada he hablado en oculto. \footnote{\textbf{18:20}
  Juan 7,14; Juan 7,26} \bibleverse{21} ¿Qué me preguntas á mí? Pregunta
...
JESUS NAZARENO, REY DE LOS JUDIOS. \bibleverse{20} Y muchos de los
...
en latín. \bibleverse{21} Y decían á Pilato los pontífices de los
...
\footnote{\textbf{19:28} Sal 22,16} \bibleverse{29} Y estaba allí un
...
y rodeada á un hisopo, se la llegaron á la boca. \footnote{\textbf{19:29}
  Sal 69,22} \bibleverse{30} Y como Jesús tomó el vinagre, dijo:
...
piernas, y fuesen quitados. \footnote{\textbf{19:31} Lev 23,7; Deut
  21,23} \bibleverse{32} Y vinieron los soldados, y quebraron las
piernas al primero, y asimismo al otro que había sido crucificado con
él. \bibleverse{33} Mas cuando vinieron á Jesús, como le vieron ya
muerto, no le quebraron las piernas: \bibleverse{34} Empero uno de los
soldados le abrió el costado con una lanza, y luego salió sangre y agua.
\bibleverse{35} Y el que lo vió, da testimonio, y su testimonio es
verdadero: y él sabe que dice verdad, para que vosotros también creáis.
\bibleverse{36} Porque estas cosas fueron hechas para que se cumpliese
la Escritura: Hueso no quebrantaréis de él. \bibleverse{37} Y también
...
\bibleverse{39} Y vino también Nicodemo, el que antes había venido á
Jesús de noche, trayendo un compuesto de mirra y de áloes, como cien
libras. \footnote{\textbf{19:39} Juan 3,2} \bibleverse{40} Tomaron pues
el cuerpo de Jesús, y envolviéronlo en lienzos con especias, como es
costumbre de los Judíos sepultar. \bibleverse{41} Y en aquel lugar donde
había sido crucificado, había un huerto; y en el huerto un sepulcro
nuevo, en el cual aun no había sido puesto ninguno. \bibleverse{42}
...
él resucitase de los muertos. \footnote{\textbf{20:9} Luc 24,25-27; Hech
  2,24-32; 1Cor 15,4} \bibleverse{10} Y volvieron los discípulos á los
suyos.
...
costado. Y los discípulos se gozaron viendo al Señor. \footnote{\textbf{20:20}
  1Jn 1,1} \bibleverse{21} Entonces les dijo Jesús otra vez: Paz á
vosotros; como me envió el Padre, así también yo os envío. \footnote{\textbf{20:21}
  Juan 17,18} \bibleverse{22} Y como hubo dicho esto, sopló, y díjoles:
Tomad el Espíritu Santo: \bibleverse{23} A los que remitiereis los
...
estaba con ellos cuando Jesús vino. \footnote{\textbf{20:24} Juan 11,16;
  Juan 14,5; Juan 21,2} \bibleverse{25} Dijéronle pues los otros
...
de sus discípulos, que no están escritas en este libro. \footnote{\textbf{20:30}
  Juan 21,24-25} \bibleverse{31} Estas empero son escritas, para que
...
discípulos no entendieron que era Jesús. \footnote{\textbf{21:4} Juan
  20,14; Luc 24,16} \bibleverse{5} Y díjoles: Mozos, ¿tenéis algo de
...
del pez. \footnote{\textbf{21:13} Juan 6,11} \bibleverse{14} Esta era ya
...
\footnote{\textbf{21:20} Juan 13,23; Juan 13,25} \bibleverse{21} Así que
