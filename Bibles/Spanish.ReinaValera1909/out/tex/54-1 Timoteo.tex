...
nuestro Salvador, y del Señor Jesucristo, nuestra esperanza; \footnote{\textbf{1:1}
  Col 1,27} \bibleverse{2} A Timoteo, verdadero hijo en la fe: Gracia,
...
doctrina, \footnote{\textbf{1:3} Hech 20,1} \bibleverse{4} Ni presten
...
ahora. \footnote{\textbf{1:4} 1Tim 4,7} \bibleverse{5} Pues el fin del
...
conciencia, y de fe no fingida: \footnote{\textbf{1:5} Mat 22,37-40; Rom
  13,10; Gal 5,6} \bibleverse{6} De lo cual distrayéndose algunos, se
apartaron á vanas pláticas; \footnote{\textbf{1:6} 1Tim 6,4; 1Tim 6,20}
\bibleverse{7} Queriendo ser doctores de la ley, sin entender ni lo que
...
legítimamente; \footnote{\textbf{1:8} Rom 7,12} \bibleverse{9}
...
\footnote{\textbf{1:9} 1Cor 6,9-11} \bibleverse{10} Para los
...
doctrina; \bibleverse{11} Según el evangelio de la gloria del Dios
...
\footnote{\textbf{1:18} 1Tim 4,14; 1Tim 6,12; Jds 1,3} \bibleverse{19}
...
hombre; \footnote{\textbf{2:5} Heb 9,15} \bibleverse{6} El cual se dió á
sí mismo en precio del rescate por todos, para testimonio en sus
tiempos: \footnote{\textbf{2:6} Gal 1,4; Gal 2,20; Tit 2,14}
\bibleverse{7} De lo que yo soy puesto por predicador y apóstol, (digo
...
levantando manos limpias, sin ira ni contienda. \footnote{\textbf{2:8}
  Sant 1,6} \bibleverse{9} Asimismo también las mujeres, ataviándose en
...
\bibleverse{10} Sino de buenas obras, como conviene á mujeres que
profesan piedad. \footnote{\textbf{2:10} 1Tim 5,10} \bibleverse{11} La
mujer aprenda en silencio, con toda sujeción. \footnote{\textbf{2:11}
  Efes 5,22} \bibleverse{12} Porque no permito á la mujer enseñar, ni
tomar autoridad sobre el hombre, sino estar en silencio. \footnote{\textbf{2:12}
  1Cor 14,34; Gén 3,16} \bibleverse{13} Porque Adam fué formado el
primero, después Eva; \bibleverse{14} Y Adam no fué engañado, sino la
mujer, siendo seducida, vino á ser envuelta en transgresión: \footnote{\textbf{2:14}
  Gén 3,6} \bibleverse{15} Empero se salvará engendrando hijos, si
...
\bibleverse{2} Conviene, pues, que el obispo sea irreprensible, marido
de una mujer, solícito, templado, compuesto, hospedador, apto para
enseñar; \bibleverse{3} No amador del vino, no heridor, no codicioso de
torpes ganancias, sino moderado, no litigioso, ajeno de avaricia;
\bibleverse{4} Que gobierne bien su casa, que tenga sus hijos en
sujeción con toda honestidad; \bibleverse{5} (Porque el que no sabe
...
no dados á mucho vino, no amadores de torpes ganancias; \footnote{\textbf{3:8}
  Hech 6,3; Fil 1,1} \bibleverse{9} Que tengan el misterio de la fe con
limpia conciencia. \footnote{\textbf{3:9} 1Tim 1,19} \bibleverse{10} Y
...
\bibleverse{12} Los diáconos sean maridos de una mujer, que gobiernen
bien sus hijos y sus casas. \bibleverse{13} Porque los que bien
...
de error y á doctrinas de demonios; \footnote{\textbf{4:1} Mat 24,24;
  2Tes 2,3; 2Tim 3,1; 2Pe 3,3; 1Jn 2,18; Jds 1,18} \bibleverse{2} Que
con hipocresía hablarán mentira, teniendo cauterizada la conciencia.
\bibleverse{3} Que prohibirán casarse, y mandarán abstenerse de las
...
ellas los fieles, y los que han conocido la verdad. \footnote{\textbf{4:3}
  Gén 9,3; 1Cor 10,30-31; Col 2,23} \bibleverse{4} Porque todo lo que
...
\bibleverse{5} Porque por la palabra de Dios y por la oración es
santificado.
...
la cual has alcanzado. \footnote{\textbf{4:6} 2Tim 2,15} \bibleverse{7}
...
piedad. \footnote{\textbf{4:7} 1Tim 6,20; 2Tim 2,16; 2Tim 2,23; 2Tim
  4,4; Tit 1,14; Tit 3,9} \bibleverse{8} Porque el ejercicio corporal
...
promesa de esta vida presente, y de la venidera. \footnote{\textbf{4:8}
  1Tim 6,6; Heb 13,9} \bibleverse{9} Palabra fiel es esta, y digna de
ser recibida de todos. \bibleverse{10} Que por esto aun trabajamos y
...
presbiterio. \footnote{\textbf{4:14} 1Tim 1,18; 1Tim 5,22; Hech 6,6;
  Hech 8,17; 2Tim 1,6} \bibleverse{15} Medita estas cosas; ocúpate en
ellas; para que tu aprovechamiento sea manifiesto á todos.
\bibleverse{16} Ten cuidado de ti mismo y de la doctrina; persiste en
...
los más jóvenes, como á hermanos; \footnote{\textbf{5:1} Lev 19,32; Tit
  2,2} \bibleverse{2} A las ancianas, como á madres; á las jovencitas,
...
\bibleverse{16} Si algún fiel ó alguna fiel tiene viudas, manténgalas, y
...
\footnote{\textbf{5:17} Hech 14,23; Rom 12,8} \bibleverse{18} Porque la
...
\bibleverse{20} A los que pecaren, repréndelos delante de todos, para
...
piedad; \footnote{\textbf{6:3} Gal 1,6-9; 2Tim 1,13} \bibleverse{4} Es
...
\bibleverse{5} Porfías de hombres corruptos de entendimiento y privados
...
\bibleverse{8} Así que, teniendo sustento y con qué cubrirnos, seamos
contentos con esto. \footnote{\textbf{6:8} Prov 30,8} \bibleverse{9}
...
muerte. \footnote{\textbf{6:9} Prov 28,22; Mat 13,22} \bibleverse{10}
...
\footnote{\textbf{6:12} 1Tim 1,18; 1Tim 4,14; 1Cor 9,25-26; 2Tim 4,7;
  Heb 3,1} \bibleverse{13} Te mando delante de Dios, que da vida á todas
...
\bibleverse{14} Que guardes el mandamiento sin mácula ni reprensión,
hasta la aparición de nuestro Señor Jesucristo: \bibleverse{15} La cual
á su tiempo mostrará el Bienaventurado y solo Poderoso, Rey de reyes, y
Señor de señores; \bibleverse{16} Quien sólo tiene inmortalidad, que
...
\footnote{\textbf{6:17} Sal 62,11; Luc 12,15-21} \bibleverse{18} Que
hagan bien, que sean ricos en buenas obras, dadivosos, que con facilidad
comuniquen; \bibleverse{19} Atesorando para sí buen fundamento para lo
