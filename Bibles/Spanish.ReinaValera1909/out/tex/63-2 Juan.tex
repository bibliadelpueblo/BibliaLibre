...
conocido la verdad, \footnote{\textbf{1:1} 1Jn 1,-1} \bibleverse{2} Por
la verdad que está en nosotros, y será perpetuamente con nosotros:
\bibleverse{3} Sea con vosotros gracia, misericordia, y paz de Dios
...
\bibleverse{6} Y este es amor, que andemos según sus mandamientos. Este
...
galardón cumplido. \footnote{\textbf{1:8} Gal 4,11} \bibleverse{9}
...
Padre y al Hijo. \footnote{\textbf{1:9} 1Jn 2,23} \bibleverse{10} Si
...
\bibleverse{11} Porque el que le dice bienvenido, comunica con sus malas
obras.
