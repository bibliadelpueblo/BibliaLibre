...
de Galilea, y fué bautizado por Juan en el Jordán. \footnote{\textbf{1:9}
  Luc 2,51} \bibleverse{10} Y luego, subiendo del agua, vió abrirse los
cielos, y al Espíritu como paloma, que descendía sobre él.
\bibleverse{11} Y hubo una voz de los cielos que decía: Tú eres mi Hijo
...
se fué á un lugar desierto, y allí oraba. \footnote{\textbf{1:35} Mat
  14,23; Mat 26,36; Luc 5,16; Luc 11,1} \bibleverse{36} Y le siguió
...
\bibleverse{43} Entonces le apercibió, y despidióle luego, \footnote{\textbf{1:43}
  Mar 3,12; Mar 7,36} \bibleverse{44} Y le dice: Mira, no digas á nadie
...
hecho; no el hombre por causa del sábado. \footnote{\textbf{2:27} Deut
  5,14} \bibleverse{28} Así que el Hijo del hombre es Señor aun del
sábado.
...
de él, y daban voces, diciendo: Tú eres el Hijo de Dios. \footnote{\textbf{3:11}
  Luc 4,41} \bibleverse{12} Mas él les reñía mucho que no le
...
\bibleverse{18} Y á Andrés, y á Felipe, y á Bartolomé, y á Mateo, y á
Tomás, y á Jacobo hijo de Alfeo, y á Tadeo, y á Simón el Cananita,
\bibleverse{19} Y á Judas Iscariote, el que le entregó. Y vinieron á
casa.
...
candelero? \footnote{\textbf{4:21} Mat 5,15} \bibleverse{22} Porque no
...
\footnote{\textbf{4:24} Mat 7,2} \bibleverse{25} Porque al que tiene, le
...
noche y de día, y la simiente brota y crece como él no sabe. \footnote{\textbf{4:27}
  Sant 5,7} \bibleverse{28} Porque de suyo fructifica la tierra, primero
hierba, luego espiga, después grano lleno en la espiga; \bibleverse{29}
...
de Jacobo. \footnote{\textbf{5:37} Mat 17,1} \bibleverse{38} Y vino á
...
\bibleverse{42} Y luego la muchacha se levantó, y andaba; porque tenía
doce años. Y se espantaron de grande espanto. \bibleverse{43} Mas él les
...
\bibleverse{35} Y como ya fuese el día muy entrado, sus discípulos
llegaron á él, diciendo: El lugar es desierto, y el día ya muy entrado;
\footnote{\textbf{6:35} Mar 8,1-9} \bibleverse{36} Envíalos para que
...
á todos los dos peces. \footnote{\textbf{6:41} Mar 7,34} \bibleverse{42}
Y comieron todos, y se hartaron. \bibleverse{43} Y alzaron de los
pedazos doce cofines llenos, y de los peces. \bibleverse{44} Y los que
...
\bibleverse{5} Y le preguntaron los Fariseos y los escribas: ¿Por qué
...
\footnote{\textbf{7:31} Mar 5,20; Mat 15,29-31} \bibleverse{32} Y le
traen un sordo y tartamudo, y le ruegan que le ponga la mano encima.
\bibleverse{33} Y tomándole aparte de la gente, metió sus dedos en las
orejas de él, y escupiendo, tocó su lengua; \bibleverse{34} Y mirando al
cielo, gimió, y le dijo: Ephphatha: que es decir: Sé abierto.
\bibleverse{35} Y luego fueron abiertos sus oídos, y fué desatada la
ligadura de su lengua, y hablaba bien. \bibleverse{36} Y les mandó que
no lo dijesen á nadie; pero cuanto más les mandaba, tanto más y más lo
divulgaban. \bibleverse{37} Y en gran manera se maravillaban, diciendo:
...
no tienen qué comer: \footnote{\textbf{8:2} Mar 6,34-44} \bibleverse{3}
...
teniendo oídos no oís? ¿y no os acordáis? \footnote{\textbf{8:18} Mat
  13,13; Mat 13,16} \bibleverse{19} Cuando partí los cinco panes entre
...
le tocase. \footnote{\textbf{8:22} Mar 6,56} \bibleverse{23} Entonces,
...
\bibleverse{10} Y retuvieron la palabra en sí, altercando qué sería
...
de todos. \footnote{\textbf{9:35} Mar 10,44; Mat 20,27} \bibleverse{36}
Y tomando un niño, púsolo en medio de ellos; y tomándole en sus brazos,
les dice: \bibleverse{37} El que recibiere en mi nombre uno de los tales
...
haga milagro en mi nombre que luego pueda decir mal de mí. \footnote{\textbf{9:39}
  1Cor 12,3} \bibleverse{40} Porque el que no es contra nosotros, por
...
\footnote{\textbf{9:43} Mat 5,30} \bibleverse{44} Donde su gusano no
muere, y el fuego nunca se apaga. \bibleverse{45} Y si tu pie te fuere
...
apagado; \bibleverse{46} Donde el gusano de ellos no muere, y el fuego
nunca se apaga. \bibleverse{47} Y si tu ojo te fuere ocasión de caer,
sácalo: mejor te es entrar al reino de Dios con un ojo, que teniendo dos
ojos ser echado á la Gehenna; \bibleverse{48} Donde el gusano de ellos
no muere, y el fuego nunca se apaga. \bibleverse{49} Porque todos serán
salados con fuego, y todo sacrificio será salado con sal. \footnote{\textbf{9:49}
  Lev 2,13} \bibleverse{50} Buena es la sal; mas si la sal fuere
...
\footnote{\textbf{10:7} Gén 2,24} \bibleverse{8} Y los que eran dos,
...
no entrará en él. \footnote{\textbf{10:15} Mat 18,3} \bibleverse{16} Y
...
en el reino de Dios, los que confían en las riquezas! \footnote{\textbf{10:24}
  Sal 62,11; 1Tim 6,17} \bibleverse{25} Más fácil es pasar un camello
...
entre ellas son grandes, tienen sobre ellas potestad. \footnote{\textbf{10:42}
  Luc 22,25-27} \bibleverse{43} Mas no será así entre vosotros: antes
cualquiera que quisiere hacerse grande entre vosotros, será vuestro
servidor; \footnote{\textbf{10:43} Mar 9,35; 1Pe 5,3} \bibleverse{44} Y
...
\footnote{\textbf{11:1} Juan 2,13} \bibleverse{2} Y les dice: Id al
...
traedlo. \bibleverse{3} Y si alguien os dijere: ¿Por qué hacéis eso?
...
vendían palomas; \footnote{\textbf{11:15} Juan 2,14-16} \bibleverse{16}
Y no consentía que alguien llevase vaso por el templo. \bibleverse{17} Y
...
\footnote{\textbf{11:23} Mar 9,23; Mat 17,20} \bibleverse{24} Por tanto,
...
vendrá. \footnote{\textbf{11:24} Mat 7,7; Juan 14,13; 1Jn 5,14; 1Jn
  1,5-15} \bibleverse{25} Y cuando estuviereis orando, perdonad, si
...
os perdone también á vosotros vuestras ofensas. \footnote{\textbf{11:25}
  Mat 5,23} \bibleverse{26} Porque si vosotros no perdonareis, tampoco
...
\footnote{\textbf{11:32} Luc 7,29-30} \bibleverse{33} Y respondiendo,
...
\bibleverse{9} ¿Qué, pues, hará el señor de la viña? Vendrá, y destruirá
á estos labradores, y dará su viña á otros. \bibleverse{10} ¿Ni aun esta
Escritura habéis leído: La piedra que desecharon los que edificaban,
ésta es puesta por cabeza de esquina; \bibleverse{11} Por el Señor es
...
¿Cómo dicen los escribas que el Cristo es hijo de David? \footnote{\textbf{12:35}
  Is 11,1; Rom 1,3} \bibleverse{36} Porque el mismo David dijo por el
...
mucho. \footnote{\textbf{12:41} 2Re 12,10} \bibleverse{42} Y como vino
una viuda pobre, echó dos blancas, que son un maravedí. \bibleverse{43}
...
\bibleverse{44} Porque todos han echado de lo que les sobra; mas ésta,
...
predicado antes. \footnote{\textbf{13:10} Mar 16,15} \bibleverse{11} Y
...
de su casa; \bibleverse{16} Y el que estuviere en el campo, no vuelva
atrás á tomar su capa. \bibleverse{17} Mas ¡ay de las preñadas, y de las
que criaren en aquellos días! \bibleverse{18} Orad pues, que no
acontezca vuestra huída en invierno. \bibleverse{19} Porque aquellos
días serán de aflicción, cual nunca fué desde el principio de la
creación que crió Dios, hasta este tiempo, ni será. \bibleverse{20} Y si
...
serán conmovidas; \footnote{\textbf{13:25} Heb 12,26} \bibleverse{26} Y
...
sobre su cabeza. \footnote{\textbf{14:3} Juan 12,1-8} \bibleverse{4} Y
hubo algunos que se enojaron dentro de sí, y dijeron: ¿Para qué se ha
hecho este desperdicio de ungüento? \bibleverse{5} Porque podía esto ser
...
mis discípulos? \footnote{\textbf{14:14} Mar 11,3} \bibleverse{15} Y él
...
las ovejas. \footnote{\textbf{14:27} Juan 16,32} \bibleverse{28} Mas
...
angustiarse. \footnote{\textbf{14:33} Mat 17,1} \bibleverse{34} Y les
...
muerte. \footnote{\textbf{14:64} Juan 19,7} \bibleverse{65} Y algunos
...
\bibleverse{11} Mas los príncipes de los sacerdotes incitaron á la
multitud, que les soltase antes á Barrabás. \bibleverse{12} Y
...
\footnote{\textbf{15:24} Sal 22,19} \bibleverse{25} Y era la hora de las
tres cuando le crucificaron. \bibleverse{26} Y el título escrito de su
causa era: EL REY DE LOS JUDIOS. \bibleverse{27} Y crucificaron con él
dos ladrones, uno á su derecha, y el otro á su izquierda.
\bibleverse{28} Y se cumplió la Escritura, que dice: Y con los inicuos
fué contado.
...
edificas, \footnote{\textbf{15:29} Mar 14,58} \bibleverse{30} Sálvate á
...
\bibleverse{13} Y ellos fueron, y lo hicieron saber á los otros; y ni
...
\bibleverse{16} El que creyere y fuere bautizado, será salvo; mas el que
no creyere, será condenado. \footnote{\textbf{16:16} Hech 2,38; Hech
  16,31; Hech 16,33} \bibleverse{17} Y estas señales seguirán á los que
creyeren: En mi nombre echarán fuera demonios; hablarán nuevas lenguas;
\footnote{\textbf{16:17} Hech 16,18; Hech 10,46; Hech 19,6}
\bibleverse{18} Quitarán serpientes, y si bebieren cosa mortífera, no
