...
uno de todos vosotros abunda entre vosotros; \footnote{\textbf{1:3} 1Tes
  1,2-3} \bibleverse{4} Tanto, que nosotros mismos nos gloriamos de
...
vuestras persecuciones y tribulaciones que sufrís: \footnote{\textbf{1:4}
  2Cor 7,4} \bibleverse{5} Una demostración del justo juicio de Dios,
para que seáis tenidos por dignos del reino de Dios, por el cual
asimismo padecéis. \footnote{\textbf{1:5} Fil 1,28} \bibleverse{6}
Porque es justo para con Dios pagar con tribulación á los que os
atribulan. \footnote{\textbf{1:6} Rom 12,19; Apoc 18,6-7} \bibleverse{7}
...
\bibleverse{8} En llama de fuego, para dar el pago á los que no
conocieron á Dios, ni obedecen al evangelio de nuestro Señor Jesucristo;
\footnote{\textbf{1:8} Rom 2,8} \bibleverse{9} Los cuales serán
castigados de eterna perdición por la presencia del Señor, y por la
gloria de su potencia, \bibleverse{10} Cuando viniere para ser
...
nuestro Señor Jesucristo, y nuestro recogimiento á él, \footnote{\textbf{2:1}
  1Tes 4,13; 1Tes 4,17} \bibleverse{2} Que no os mováis fácilmente de
...
\footnote{\textbf{2:2} 2Pe 3,15-16} \bibleverse{3} No os engañe nadie en
...
manifieste el hombre de pecado, el hijo de perdición, \footnote{\textbf{2:3}
  1Tim 4,1; 1Jn 2,18} \bibleverse{4} Oponiéndose, y levantándose contra
...
templo de Dios como Dios, haciéndose parecer Dios. \footnote{\textbf{2:4}
  Mat 24,15; Dan 11,36} \bibleverse{5} ¿No os acordáis que cuando estaba
todavía con vosotros, os decía esto? \bibleverse{6} Y ahora vosotros
sabéis lo que impide, para que á su tiempo se manifieste. \bibleverse{7}
Porque ya está obrando el misterio de iniquidad: solamente espera hasta
que sea quitado de en medio el que ahora impide; \bibleverse{8} Y
...
\footnote{\textbf{2:8} Is 11,4; Apoc 19,15; Apoc 19,20} \bibleverse{9} A
...
grande potencia, y señales, y milagros mentirosos, \footnote{\textbf{2:9}
  Mat 24,24; Apoc 13,11-14} \bibleverse{10} Y con todo engaño de
iniquidad en los que perecen; por cuanto no recibieron el amor de la
verdad para ser salvos. \bibleverse{11} Por tanto, pues, les envía Dios
operación de error, para que crean á la mentira; \footnote{\textbf{2:11}
  2Tim 4,4} \bibleverse{12} Para que sean condenados todos los que no
...
confirmará y guardará del mal. \footnote{\textbf{3:3} 1Tes 5,24; Juan
  17,15} \bibleverse{4} Y tenemos confianza de vosotros en el Señor, que
hacéis y haréis lo que os hemos mandado. \footnote{\textbf{3:4} 2Cor
  7,16; Gal 5,10} \bibleverse{5} Y el Señor enderece vuestros corazones
...
\footnote{\textbf{3:6} 2Tes 2,15; Mat 18,17; Rom 16,17} \bibleverse{7}
...
anduvimos desordenadamente entre vosotros, \footnote{\textbf{3:7} 1Tes
  1,6} \bibleverse{8} Ni comimos el pan de ninguno de balde; antes,
obrando con trabajo y fatiga de noche y de día, por no ser gravosos á
ninguno de vosotros; \footnote{\textbf{3:8} 1Tes 2,9} \bibleverse{9} No
...
para que nos imitaseis. \footnote{\textbf{3:9} Hech 20,35; Fil 3,17; Mat
  10,10} \bibleverse{10} Porque aun estando con vosotros, os
denunciábamos esto: Que si alguno no quisiere trabajar, tampoco coma.
\footnote{\textbf{3:10} Gén 3,19; Éxod 20,9} \bibleverse{11} Porque
...
\footnote{\textbf{3:13} Gal 6,9} \bibleverse{14} Y si alguno no
obedeciere á nuestra palabra por carta, notad al tal, y no os juntéis
con él, para que se avergüence. \bibleverse{15} Mas no lo tengáis como á
