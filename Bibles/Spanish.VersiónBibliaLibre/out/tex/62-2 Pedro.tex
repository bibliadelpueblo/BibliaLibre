...
\bibleverse{1} Esta carta viene de parte de Simón Pedro, siervo y
...
verdaderamente justo y bueno. \bibleverse{2} Reciban todavía más gracia
...
\bibleverse{3} Por su poder divino hemos recibido todas las cosas
...
\bibleverse{4} Por medio de estas promesas podemos participar de la
naturaleza divina, deshacernos de la corrupción que producen los deseos
malos de este mundo. \bibleverse{5} Por esa misma razón, ¡hagan todo lo
que puedan! A su fe en Dios agréguenle bondad; a la bondad,
conocimiento; \footnote{\textbf{1:5} Gal 5,6; Gal 5,22} \bibleverse{6}
al conocimiento, dominio propio; al dominio propio, paciencia; a la
paciencia, reverencia; \bibleverse{7} a la reverencia, aprecio por los
hermanos creyentes; y a este aprecio, amor. \bibleverse{8} Cuanto más
desarrollen estas cualidades, tanto más productivos y útiles serán en su
conocimiento de nuestro Señor Jesucristo. \bibleverse{9} Porque quien no
...
Olvidan que han sido limpiados de sus pecados pasados. \footnote{\textbf{1:9}
  1Jn 2,9; 1Jn 1,2-11} \bibleverse{10} Así que, hermanos y hermanas,
...
\bibleverse{11} Recibirán una gran bienvenida al reino eterno de nuestro
...
\bibleverse{12} Por eso siempre les recuerdo estas cosas, aunque ya
ustedes las saben, y están firmes en la verdad que tienen.
\bibleverse{13} Pero aun así yo creo que es bueno animarlos y
recordarles estas cosas mientras viva. \bibleverse{14} Sé que se acerca
...
\bibleverse{15} Así que haré mi mejor esfuerzo para que aunque me vaya,
...
\bibleverse{16} Nosotros no seguimos mitos inventados cuando les
...
nosotros mismos vimos su majestad.\footnote{\textbf{1:16} Este texto
  también hace referencia a la Transfiguración.} \bibleverse{17} Él
...
verdaderamente me complace''.\footnote{\textbf{1:17} Citando Mateo 17:5
  o un pasaje paralelo.} \bibleverse{18} Nosotros mismos oímos esta voz
que habló desde el cielo cuando estábamos con él en el monte santo.

\bibleverse{19} También tenemos la palabra de confirmación de la
...
corazones. \bibleverse{20} Sobre todas las cosas, deben reconocer que
ninguna profecía de la Escritura está sujeta a una interpretación basada
en los caprichos de un individuo, \bibleverse{21} pues ninguna profecía
...
\bibleverse{1} Pero así como había falsos profetas entre el pueblo en
...
redimió, y trayendo rápida destrucción sobre sí mismos. \footnote{\textbf{2:1}
  Mat 24,11; 1Tim 4,1} \bibleverse{2} Muchos seguirán sus perversiones
inmorales, y por causa de ellos la gente condenará el camino de la
verdad. \bibleverse{3} Pues con avaricia los explotarán a ustedes con
...
\bibleverse{4} Porque Dios no perdonó ni siquiera a los ángeles cuando
...
para el juicio. \bibleverse{5} Dios tampoco perdonó al mundo antiguo,
...
diluvio sobre un mundo de personas malvadas. \footnote{\textbf{2:5} 1Pe
  3,20; 2Pe 3,6; Gén 8,18} \bibleverse{6} Dios condenó a las ciudades de
...
\footnote{\textbf{2:6} Gén 19,24-25} \bibleverse{7} Pero Dios rescató a
Lot, porque era un buen hombre, indignado por la abominable inmoralidad
de sus vecinos. \bibleverse{8} (Lot vivía entre ellos, pero hacía lo
bueno y lo recto. Ese día vio y escuchó lo que ellos hicieron, y la
maldad de ellos lo atormentaba). \bibleverse{9} Como pueden ver, el
...
castigo. \footnote{\textbf{2:9} 1Cor 10,13} \bibleverse{10} Esto también
...
difamar a los seres celestiales. \bibleverse{11} En cambio, los ángeles,
...
\bibleverse{12} Estas personas son como bestias sin razón, que nacen
para ser capturadas y destruidas. Condenan cosas que no conocen, y serán
destruidos como animales. \bibleverse{13} Recibirán su pago por el daño
...
con ustedes. \bibleverse{14} Siempre están en búsqueda de relaciones
...
escapar de una vida de error. \bibleverse{19} Les prometen libertad,
aunque ellos mismos son esclavos de la depravación. Pues somos esclavos
de todo lo que nos domina.

\bibleverse{20} Si las personas logran escapar de la influencia malvada
...
\bibleverse{21} Mejor sería que nunca hubieran conocido el camino recto
...
\bibleverse{22} Este proverbio aplica justamente a ellos: ``El perro ha
...
\bibleverse{1} Amigos míos, esta es mi segunda carta para ustedes. En
ambas he tratado de despertarlos y recordarles que deben tener un
pensamiento limpio y puro. \footnote{\textbf{3:1} 2Pe 1,13}
\bibleverse{2} No olviden las palabras que los profetas dijeron en el
pasado, y lo que el Señor y Salvador ordenó por medio de los apóstoles.
\bibleverse{3} Y sobre todo, sepan que en los últimos días habrá
...
malvados.\footnote{\textbf{3:3} Véase Judas 1:18.} \footnote{\textbf{3:3}
  1Tim 4,1; Jds 1,18} \bibleverse{4} ``¿Qué sucedió entonces con la
...
partir del agua, y estaba toda rodeada de ella. \footnote{\textbf{3:5}
  Mat 24,38; Gén 1,2; Gén 1,6; Gén 1,9; Sal 24,2} \bibleverse{6} Por el
agua, el mundo que existía en ese entonces fue destruido, inundado por
ella. \footnote{\textbf{3:6} 2Pe 2,5; Gén 7,21} \bibleverse{7} Pero por
...
\bibleverse{8} Sin embargo, amigos míos, no olviden esto: Que para el
Señor un día es como mil años, y mil años es como un día.\footnote{\textbf{3:8}
  Ver Salmos 90:4.} \footnote{\textbf{3:8} Sal 90,4} \bibleverse{9} El
...
\bibleverse{10} Sin embargo, el día del Señor vendrá, y será
...
\bibleverse{11} Y como todo quedará destruido de esta manera, ¿qué clase
de gente debemos ser? Debemos vivir de manera pura, consagrados a Dios,
\bibleverse{12} esperando con ilusión y deseo la venida del día del
Señor. Ese día los cielos arderán en llamas, y los elementos se
fundirán. \bibleverse{13} Pero en lo que a nosotros concierne, buscamos
...
\bibleverse{14} Así que, amigos míos, puesto que ustedes esperan estas
cosas, asegúrense de estar puros e irreprochables, y en paz con Dios.
\bibleverse{15} Recuerden que esta es la paciencia de nuestro Señor, que
...
sabiduría que Dios le dio. \bibleverse{16} Él habló sobre estas cosas,
...
\bibleverse{17} Mis amigos, puesto que ya saben esto, asegúrense de que
estos errores de los malvados no los descarríen, y no tropiecen de su
firme posición. \bibleverse{18} Deseo que crezcan en la gracia y en el
