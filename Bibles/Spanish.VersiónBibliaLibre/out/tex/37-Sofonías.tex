...
\bibleverse{1} Este es el mensaje que el Señor le dio a Sofonías. Él era
...
\bibleverse{2} Yo destruiré por complete todo de la faz de la tierra,
declara el Señor. \bibleverse{3} Yo destruiré a toda persona y animal,
...
tierra. \bibleverse{4} Golpearé\footnote{\textbf{1:4} Literalmente,
...
olvidados.\footnote{\textbf{1:4} Implícito.} \footnote{\textbf{1:4} 2Re
  23,5; Os 10,5} \bibleverse{5} Destruiré también a los que suben a las
...
Milcón.\footnote{\textbf{1:5} O ``Molec'', un dios pagano.} \footnote{\textbf{1:5}
  Jer 19,13; Jer 49,1} \bibleverse{6} Destruiré a os que una vez
adoraron al Señor y dejaron de hacerlo. Ellos no buscan al Señor ni
piden mi ayuda.

\bibleverse{7} ¡Callen ante el Señor Dios! Porque el día del Señor está
...
invitados.\footnote{\textbf{1:7} En este contexto, Israel es el
  ...
  Hab 2,20} \bibleverse{8} Entonces, en el día del sacrificio del Señor
...
los caminos paganos.\footnote{\textbf{1:8} Literalmente, ``los que se
  visten con ropas extranjeras''.} \bibleverse{9} También castigaré a
...
\bibleverse{10} Ese día, declara el Señor, un grito de lamento saldrá de
la Puerta del Pez, un lamento saldrá del Segundo Barrio, y un fuerte
estrépito de las montañas. \bibleverse{11} Los que viven en el Barrio
...
comercian la plata. \bibleverse{12} En ese tiempo, buscaré por toda
...
bien ni mal''.\footnote{\textbf{1:12} En otras palabras, rechazan al
  Señor porque no creen que él se preocupa por ellos.} \bibleverse{13}
...
\bibleverse{14} El gran día del Señor está cerca y se aproxima con
prontitud. Será un día amargo, e incluso los guerreros clamarán en voz
alta. \footnote{\textbf{1:14} Jl 1,15} \bibleverse{15} Será un día de
...
nubes negras; \footnote{\textbf{1:15} Jer 30,7} \bibleverse{16} un día
de sonido de trompetas y gritos de guerra contra ciudades fortificadas y
torres de vigilancia. \bibleverse{17} Traeré angustia sobre la
...
intestinos como el excremento. \bibleverse{18} Su plata y su oro no los
...
\bibleverse{1} Reúnanse, sí, reúnanse, nación sin valor, \footnote{\textbf{2:1}
  1Sam 30,14; Jer 47,-1} \bibleverse{2} antes de que se emita el
...
sobre ustedes. \bibleverse{3} Miren al Señor, todos ustedes, habitantes
...
\bibleverse{4} Gaza será abandonada, Ascalón será destruida; Asdod será
saqueada de noche, y Ecrón será arrancada de raíz. \bibleverse{5}
...
\bibleverse{6} La costa de su territorio se convertirá en pastizales,
con praderas para los pastores y será lugar de rediles de ovejas.
\bibleverse{7} Le pertenecerá al remanente de Judá. Allí apacentarán sus
...
\bibleverse{8} He oído las burlas de los moabitas y los escarnios
...
enviado amenazas contra su territorio. \footnote{\textbf{2:8} Jer 48,-1;
  Jer 49,1} \bibleverse{9} Por ello, juro por mi vida, declara el Dios
...
\bibleverse{10} Esto es lo que recibirán como pago por su orgullo,
porque se burlaron y amenazaron al pueblo del Señor Todopoderoso.
\bibleverse{11} El Señor los atemorizará, y hará morir de hambre a todos
...
\bibleverse{13} El Señor golpeará a los asirios del norte y los
destruirá. Desolará a Nínive, y será una tierra valdía y desierta.
\footnote{\textbf{2:13} Is 13,21; Is 34,11}

\bibleverse{14} El ganado se tumbará en medio de la ciudad. Será el
...
quedará expuesta. \bibleverse{15} Esto es lo que le sucederá a esta
...
\bibleverse{1} ¡Grande es el desastre que viene sobre ti, corrupta y
rebelde Jerusalén, que oprimes a la gente!\footnote{\textbf{3:1}
  ``Jerusalén'': implícito por contexto.} \bibleverse{2} Tú\footnote{\textbf{3:2}
...
\bibleverse{3} Tus líderes son codiciosos como leones rugientes. Tus
jueces son como lobos hambrientos que no dejan para el día siguiente.
\footnote{\textbf{3:3} Ezeq 22,27} \bibleverse{4} Tus profetas son
...
abiertamente la ley.\footnote{\textbf{3:4} O ``usan la ley en su propio
  beneficio''.} \footnote{\textbf{3:4} Miq 3,11} \bibleverse{5} Pero el
...
\bibleverse{6} Yo he destruido naciones. Sus castillos están
abandonados, sus calles vacías, y sus ciudades destruidas. No hay en
ellas sobrevivientes. No siquiera uno. \bibleverse{7} Me dije a mi
...
\bibleverse{8} Solo espera, declara el Señor. Viene el día en que me
...
\bibleverse{9} Porque entonces haré que las naciones hablen con pureza,
para que puedan orar y adorar juntas al Señor. \bibleverse{10} Desde
lejos los ríos de Etiopía, mi pueblo esparcido, mis adoradores, vendrán
a traerme sus ofrendas. \bibleverse{11} Ese día no serás avergonzado por
...
mi monte santo. \bibleverse{12} Dejaré entre tu pueblo a los mansos y
humildes, a los que confían en el nombre del Señor. \footnote{\textbf{3:12}
  Ezeq 6,8} \bibleverse{13} El pueblo de Israel que queda no actuará con
...
\bibleverse{14} ¡Canta, Jerusalén! ¡Grita Israel! ¡Alégrate y celebra
con todo tu corazón, Jerusalén! \bibleverse{15} Porque el Señor se ha
...
\bibleverse{16} Ese día, el mensaje al pueblo de Jerusalén será: ``¡No
temas, ni te desanimes!''\footnote{\textbf{3:16} ``No se desanimen'':
  Literalmente, ``no debiliten sus manos''.} \bibleverse{17} El Señor tu
...
tu existencia. \bibleverse{18} Yo reuniré a los que lloran por las
...
vergüenza.\footnote{\textbf{3:18} Esta es una interpretación del hebreo
  ...
  deseaban y esto era motivo de desgracia para ellos.} \bibleverse{19}
...
respetará. \bibleverse{20} En ese tiempo, los traeré a casa, y los
