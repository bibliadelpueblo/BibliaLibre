...
\bibleverse{1} Esta carta viene de Pablo, Silvano y Timoteo, para la
iglesia de los tesalonicenses que pertenecen a Dios, nuestro Padre, y al
Señor Jesucristo. \bibleverse{2} Tengan gracia y paz de parte de Dios el
...
\bibleverse{3} Seguimos agradeciendo a Dios por ustedes, hermanos y
...
tienen unos por otros aumenta cada vez más. \footnote{\textbf{1:3} 1Tes
  1,2-3} \bibleverse{4} Hablamos con orgullo de ustedes entre las
...
toda la persecución y las dificultades que han sufrido. \footnote{\textbf{1:4}
  2Cor 7,4} \bibleverse{5} Porque esta es la evidencia de que Dios es
justo en sus decisiones, que ustedes merecen el reino de Dios por el
cual sufren. \footnote{\textbf{1:5} Fil 1,28} \bibleverse{6} Puesto que
...
\bibleverse{7} Él los libertará de su sufrimiento---y a nosotros
...
con sus ángeles poderosos, \footnote{\textbf{1:7} Mat 16,27; Mat
  25,31-46; 1Tes 4,16} \bibleverse{8} y trayendo juicio sobre aquellos
que rechazan a Dios y se niegan a aceptar la buena nueva de nuestro
Señor Jesús. \footnote{\textbf{1:8} Rom 2,8} \bibleverse{9} Ellos
recibirán las consecuencias justas de la perdición eterna, separados de
la presencia del Señor y de su glorioso poder, \bibleverse{10} el día
...
\bibleverse{11} Por eso seguimos orando por ustedes, para que nuestro
...
acción que nace de la fe en él, \bibleverse{12} a fin de que el nombre
...
\bibleverse{1} En cuanto a la venida de nuestro Señor Jesucristo y la
manera como nos reuniremos con él, hermanos y hermanas, \footnote{\textbf{2:1}
  1Tes 4,13; 1Tes 4,17} \bibleverse{2} por favor, no se inquieten ni se
...
llegado. \footnote{\textbf{2:2} 2Pe 3,15-16} \bibleverse{3} No permitan
...
revelado. Aquél cuyo fin es la destrucción. \footnote{\textbf{2:3} 1Tim
  4,1; 1Jn 2,18} \bibleverse{4} Él es el enemigo de Dios, y con
...
Dios. \footnote{\textbf{2:4} Mat 24,15; Dan 11,36} \bibleverse{5} ¿No
recuerdan que les dije todo esto cuando todavía estaba con ustedes?
\bibleverse{6} Ahora bien, ustedes saben qué lo mantiene bajo control,
porque él será revelado como lo que es en su debido momento.\footnote{\textbf{2:6}
  ...
  significado.} \bibleverse{7} Pues los caminos secretos de esta
...
quite de en medio. \bibleverse{8} Entonces el hombre de anarquía será
...
aniquilándolo con el resplandor de su venida. \footnote{\textbf{2:8} Is
  11,4; Apoc 19,15; Apoc 19,20} \bibleverse{9} Él (el hombre de
...
\bibleverse{10} Usando todo tipo de trucos malvados engaña a aquellos
que van camino a la destrucción, porque se negaron a amar la verdad y
ser salvos. \bibleverse{11} Por esto Dios les envía un engaño que los
convencerá a fin de que crean en la mentira.\footnote{\textbf{2:11} La
  ...
  2Tim 4,4} \bibleverse{12} Como resultado, todos los que no creyeron en
...
\bibleverse{13} Pero nosotros no tenemos más que agradecer a Dios por
...
justifica al creer en la verdad. \bibleverse{14} A esto los llamó Dios
...
\bibleverse{15} Así que, hermanos y hermanas, permanezcan firmes, y
aférrense a lo que han aprendido, ya sea por lo que han oído, o por
medio de cartas nuestras. \footnote{\textbf{2:15} 2Tes 3,6}

\bibleverse{16} Quiera nuestro Señor Jesucristo mismo y Dios el Padre
(quien por medio de su gracia nos dio seguridad eterna y fiel
esperanza), \bibleverse{17} animarlos y fortalecerlos para que puedan
...
\bibleverse{1} Finalmente, hermanos y hermanas, les rogamos que oren por
nosotros, para que el mensaje del Señor pueda esparcirse y ser aceptado
en verdad, como lo aceptaron ustedes, \bibleverse{2} y que podamos
permanecer a salvo de los hombres inmorales y malvados, pues no todo el
mundo cree en Dios. \bibleverse{3} Pero el Señor es fiel y los
fortalecerá, y también los protegerá del maligno. \footnote{\textbf{3:3}
  1Tes 5,24; Juan 17,15} \bibleverse{4} Tenemos la gran seguridad en el
Señor de que ustedes están haciendo y seguirán haciendo lo que les
dijimos. \footnote{\textbf{3:4} 2Cor 7,16; Gal 5,10} \bibleverse{5}
...
\bibleverse{6} Ahora queremos decirles, hermanos, en el nombre de
...
aprendieron de nosotros. \footnote{\textbf{3:6} 2Tes 2,15; Mat 18,17;
  Rom 16,17} \bibleverse{7} Sin duda alguna, ustedes saben que deben
seguir nuestro ejemplo, porque mientras estuvimos con ustedes no fuimos
perezosos, \footnote{\textbf{3:7} 1Tes 1,6} \bibleverse{8} pues no
...
ustedes. \footnote{\textbf{3:8} 1Tes 2,9} \bibleverse{9} No porque no
...
de que todo aquél que no trabaje no coma. \footnote{\textbf{3:10} Gén
  3,19; Éxod 20,9} \bibleverse{11} Pero ahora hemos oído que hay muchos
perezosos entre ustedes que no trabajan en absoluto. \bibleverse{12}
...
\bibleverse{13} Hermanos y hermanas, no dejen de hacer el bien.
\footnote{\textbf{3:13} Gal 6,9} \bibleverse{14} Tomen nota de los que
...
\bibleverse{15} No los consideren como enemigos, sino háganles la
advertencia como quien habla con un hermano y hermana.

\bibleverse{16} Quiera el mismo Señor de paz darles paz en todas las
...
\bibleverse{17} Noten el saludo que les mando, con mi propia letra. Este
es mi firma en cada carta que escribo. \bibleverse{18} Que la gracia de
