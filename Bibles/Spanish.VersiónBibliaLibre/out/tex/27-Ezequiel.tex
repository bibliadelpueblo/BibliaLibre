...
\bibleverse{1} El quinto día del cuarto mes del trigésimo
...
\bibleverse{2} (En el quinto día del mes del quinto año del exilio del
rey Joaquín, \footnote{\textbf{1:2} 2Re 24,15} \bibleverse{3} un mensaje
...
\bibleverse{4} Miré hacia arriba y vi una tormenta de viento que llegaba
...
\bibleverse{5} y dentro de él había la forma de cuatro seres.\footnote{\textbf{1:5}
  Se les identifica como ``querubines'' en 10:2.} Este era su aspecto:
Tenían forma humana, \bibleverse{6} pero cada uno tenía cuatro caras y
cuatro alas. \bibleverse{7} Tenían las piernas rectas, y las plantas de
sus pies parecían pezuñas de terneros, y brillaban como el bronce
pulido. \bibleverse{8} Tenían manos humanas debajo de sus alas en cada
uno de sus cuatro lados. Los cuatro tenían caras y alas, \bibleverse{9}
y cada una de sus alas tocaba las del de al lado. Cuando se movían, no
giraban; todas se movían en una sola dirección.

\bibleverse{10} Este era el aspecto de sus rostros. Tenían un rostro
humano al frente, un rostro de león a la derecha, un rostro de toro a la
izquierda, y por último un rostro de águila. \bibleverse{11} Estas eran
...
cubrían su cuerpo. \bibleverse{12} Cada uno de ellos iba junto en
...
\bibleverse{13} Estos seres parecían carbones ardientes o antorchas
brillantes. El fuego ardiente se movía de un lado a otro entre los
seres, y del fuego salían relámpagos. \bibleverse{14} Los seres corrían
...
\bibleverse{15} Mientras observaba a estos seres, me di cuenta de que
había una rueda en el suelo junto a cada uno de los seres con sus cuatro
caras. \bibleverse{16} Las ruedas parecían estar hechas de
...
había lo que parecía otra rueda colocada en cruz. \bibleverse{17} Podían
moverse en cualquier dirección sin girar al hacerlo. \bibleverse{18} Las
llantas de las ruedas eran notablemente altas, y las cuatro llantas
estaban cubiertas de ojos.

\bibleverse{19} Cuando los seres se movían, también lo hacían las ruedas
que estaban a su lado, y cuando los seres volaban, las ruedas también lo
hacían. \bibleverse{20} Iban donde el Espíritu iba. Las ruedas se
elevaban junto a ellos, porque el Espíritu de los seres estaba en las
ruedas para dirigirlos. \footnote{\textbf{1:20} Ezeq 1,12}
\bibleverse{21} Cuando los seres se movían, las ruedas se movían; cuando
...
\bibleverse{22} Por encima de las cabezas de los seres se extendía algo
...
cristal de hielo. \bibleverse{23} Bajo esta extensión, las alas de los
seres se extendían unas hacia otras. Cada uno de ellos tenía también dos
alas que cubrían su cuerpo. \bibleverse{24} Cuando los seres se movían,
...
\bibleverse{25} Una voz habló desde más allá de la extensión sobre sus
cabezas, mientras ellos estaban quietos con las alas plegadas.
\bibleverse{26} Por encima de la extensión sobre sus cabezas vi lo que
...
\bibleverse{27} Desde lo que parecía ser su cintura hacia arriba,
...
rodeado de una luz muy brillante. \bibleverse{28} La luz brillante que
...
\bibleverse{1} ``Levántate, hijo del hombre,\footnote{\textbf{2:1}
...
dijo. \bibleverse{2} Mientras me hablaba, el Espíritu entró en mí y me
hizo levantarme. Le escuché mientras me hablaba.

\bibleverse{3} ``Hijo de hombre'', me dijo, ``te envío al pueblo de
...
\bibleverse{4} Son cabezas de cerdo; son niños de corazón duro. Te envío
a decirles que esto es lo que dice el Señor Dios. \bibleverse{5} ``Tanto
...
que ha llegado a ellos un profeta. \footnote{\textbf{2:5} Ezeq 3,11;
  Ezeq 3,27} \bibleverse{6} ``Hijo de hombre, no tengas miedo de ellos
...
rebelde. \bibleverse{7} Sólo diles lo que yo digo, te escuchen o no,
porque son rebeldes.
...
\bibleverse{8} ``En cuanto a ti, hijo de hombre, presta atención a lo
que te digo. No seas rebelde como esos rebeldes. Abre la boca y come lo
que te voy a dar''.

\bibleverse{9} Levanté la vista y vi una mano extendida hacia mí que
sostenía un pergamino. \bibleverse{10} Lo extendió frente a mí, y allí,
...
\bibleverse{1} ``Hijo de hombre'', me dijo, ``come lo que te han puesto
...
\bibleverse{3} ``Hijo de hombre'', me dijo, ``come y sáciate con este
...
\bibleverse{4} Luego me dijo: ``Hijo de hombre, ahora tienes que ir al
pueblo de Israel y darles mi mensaje. \bibleverse{5} No te voy a enviar
a los que tienen una lengua extraña, a gente que no conoces, sino al
pueblo de Israel. \bibleverse{6} Como digo, no te envío a aquellos cuya
...
habrían escuchado. \bibleverse{7} ``Pero el pueblo de Israel no querrá
...
de mente fuerte\footnote{\textbf{3:7} ``De mente fuerte'': literalmente,
  ``tienen la frente dura''.} y de corazón duro. \bibleverse{8} ``¡Mira!
...
ellos.\footnote{\textbf{3:8} El nombre de Ezequiel significa ``Dios
  fortalece''.} \bibleverse{9} Haré que tu mente sea como un
...
\bibleverse{10} ``Hijo de hombre'', añadió, ``presta mucha atención a
todo lo que te digo y reflexiona profundamente sobre ello.
\bibleverse{11} Ve a tu pueblo que está en el exilio. Diles que esto es
...
\bibleverse{12} El Espíritu me levantó, y oí un ruido muy fuerte detrás
de mí que parecía un terremoto. (¡Alabado sea la gloria del Señor donde
vive!) \bibleverse{13} Era el ruido que hacían las alas de los seres al
rozarse entre sí y el ruido que hacían las ruedas junto a ellos, un
ruido realmente fuerte que sonaba como un terremoto. \bibleverse{14}
...
pleno control de mí. \bibleverse{15} Llegué al lugar donde vivían los
...
\bibleverse{16} Cuando pasaron los siete días, me llegó un mensaje del
Señor que decía: \bibleverse{17} ``Hijo de hombre, te he elegido como
vigilante del pueblo de Israel. Cada vez que te dé un mensaje, deberás
avisarles de mi parte. \bibleverse{18} ``Por ejemplo, si le doy una
...
muerte. \bibleverse{19} Pero si les adviertes, y no dejan sus malos
caminos, morirán en sus pecados, pero tú te habrás salvado: no morirás.

\bibleverse{20} ``Además, si alguien que vive correctamente deja de
...
\bibleverse{21} Sin embargo, si adviertes a los que viven bien que no
...
\bibleverse{22} El poder del Señor se apoderó de mí allí, y me dijo:
``¡Levántate! Ve al valle, y allí te hablaré''.

\bibleverse{23} Así que me levanté y fui al valle, y allí vi la gloria
del Señor. Era como la gloria que había visto junto al río Quebar. Caí
de bruces en el suelo.

\bibleverse{24} Entonces el Espíritu entró en mí y me puso de pie. Me
dijo: ``Entra en tu casa y cierra la puerta. \footnote{\textbf{3:24}
  Ezeq 2,2} \bibleverse{25} Serás atado con cuerdas, hijo de hombre.
Serás atado para que no puedas salir entre la gente. \bibleverse{26}
Haré que tu lengua se pegue al paladar. No podrás hablar ni quejarte con
ellos, aunque sean un pueblo rebelde. \bibleverse{27} ``Sin embargo,
...
\bibleverse{1} ``Hijo de hombre, debes tomar un ladrillo, ponerlo frente
a ti y dibujar en él la ciudad de Jerusalén. \bibleverse{2} Muestra que
...
alrededor. \bibleverse{3} Pon una placa de hierro entre tú y la ciudad
...
\bibleverse{4} ``Luego acuéstate sobre tu lado izquierdo y carga con los
pecados de los israelitas. Llevarás sus pecados durante el número de
días que te acuestes sobre tu costado. \bibleverse{5} Te haré permanecer
allí durante 390 días, que representan el número de años de sus pecados.
Llevarás los pecados de los israelitas.

\bibleverse{6} ``Una vez que hayas terminado de hacer esto durante estos
...
allí durante 40 días, un día por cada año. \bibleverse{7} Mantén tu
rostro hacia el sitio de Jerusalén con el brazo desnudo, y profetiza
contra él. \bibleverse{8} ``Prepárate, porque ahora te voy a atar con
...
\bibleverse{9} ``Consigue trigo, cebada, frijoles, lentejas, mijo y
...
acostado. \bibleverse{10} Se te permite comer veinte siclos de
...
\bibleverse{11} ``Mide un sexto de hin\footnote{\textbf{4:11} ``Sexto de
  hin'': alrededor de una pinta y media.} de agua para beber, y la
beberás a horas regulares. \bibleverse{12} Comerán el pan como si fuera
un pan de cebada. Lo hornearán sobre un fuego que queme excrementos
humanos secos mientras todos los observan''. \bibleverse{13} Entonces el
Señor dijo: ``Esta es la forma en que los israelitas comerán su pan
impuro entre las naciones donde los exiliaré''.

\bibleverse{14} ``¡Por favor, no, Señor Dios!'' Respondí. ``Nunca me he
...
\bibleverse{15} ``Está bien'', dijo. ``Te dejaré usar estiércol de vaca
en lugar de excremento humano Puedes hornear tu pan sobre el fuego
usando eso''.

\bibleverse{16} Luego continuó: ``¡Hijo de hombre, mira! Voy a acabar
...
sucediendo, beberán agua medida en pequeñas cantidades. \bibleverse{17}
...
\bibleverse{1} ``Hijo de hombre, ve a afeitarte la cabeza y la barba con
una espada afilada como una navaja de barbero. Luego reparte el cabello
con una balanza. \bibleverse{2} Una vez terminados los días de asedio,
...
espada detrás de ellos para perseguirlos. \bibleverse{3} ``Toma unos
cuantos cabellos y mételos en el dobladillo de tu ropa. \bibleverse{4}
...
\bibleverse{5} ``Esto es lo que dice el Señor: Esto representa a
Jerusalén. La puse en medio de las naciones, rodeada de otros países.
\bibleverse{6} Pero ella se rebeló contra mis reglas, actuando con más
...
\bibleverse{7} ``En consecuencia, esto es lo que dice el Señor Dios: Has
...
\bibleverse{8} ``Así que esto es lo que dice el Señor Dios: ¡Cuidado,
porque soy yo quien te condena, Jerusalén! Voy a cumplir mi sentencia
contra ti mientras las otras naciones observan. \bibleverse{9} Por todas
las cosas repugnantes que has hecho, voy a hacer contigo lo que nunca he
hecho antes, y lo que nunca volveré a hacer. \bibleverse{10} En tu
...
\bibleverse{11} ``En vida, declara el Señor Dios, por haber ensuciado mi
...
ninguna piedad. \footnote{\textbf{5:11} Ezeq 8,6-18} \bibleverse{12}
...
\bibleverse{13} ``Cuando se acabe mi cólera y haya terminado de
...
\bibleverse{14} ``Voy a arruinarlos y a humillarlos frente a las
naciones que los rodean, a la vista de todos los transeúntes.
\bibleverse{15} Serás criticado y escarnecido, serás una advertencia y
...
\footnote{\textbf{5:15} Jer 24,9} \bibleverse{16} ``Cuando derrame sobre
...
\bibleverse{1} Me llegó un mensaje del Señor que decía: \bibleverse{2}
``Hijo de hombre, enfréntate a los montes de Israel y profetiza contra
ellos. \bibleverse{3} ``Diles: ¡Montes de Israel, escuchen el mensaje
...
sus lugares altos. \bibleverse{4} Sus altares paganos serán derribados,
...
\bibleverse{5} Pondré los cadáveres de ustedes, israelitas, frente a sus
ídolos y esparciré sus huesos alrededor de sus altares. \bibleverse{6}
...
hiciste será arruinado. \bibleverse{7} La gente será asesinada en todo
...
\bibleverse{8} ``Sin embargo, dejaré que algunos de ustedes sobrevivan y
los dispersaré entre las otras naciones. \bibleverse{9} ``Cuando hallan
...
\bibleverse{10} Entonces sabrán que yo soy el Señor, y que no estaba
...
\bibleverse{11} ``Esto es lo que dice el Señor Dios: Golpéense con las
...
enfermedad. \bibleverse{12} Los que vivan lejos morirán de enfermedad,
los que estén cerca serán asesinados por la espada, y los que queden
morirán de hambre. Así expresaré mi ira contra ellos. \bibleverse{13}
...
\footnote{\textbf{6:13} 1Re 14,23} \bibleverse{14} Voy a levantar mi
...
\bibleverse{3} ¡Ahora es el fin para ustedes! Voy a dirigir mi ira
contra ti. Te juzgaré por tus acciones y te pagaré por las cosas
ofensivas que has hecho. \bibleverse{4} No tendré piedad de ti, ni te
...
\bibleverse{5} ``Esto es lo que dice el Señor: ¡Cuidado! ¡Viene un
desastre tras otro! \bibleverse{6} ¡El fin está aquí! ¡El fin ha
llegado, y viene para ti! ¡Cuidado! ¡Este es el fin! \bibleverse{7}
...
\footnote{\textbf{7:7} Jl 1,15} \bibleverse{8} Dentro de muy poco te voy
a mostrar lo enojado que estoy contigo. Te juzgaré por lo que has hecho,
y te castigaré por todos tus repugnantes pecados. \bibleverse{9} No
...
\bibleverse{10} ``¿No lo ves? ¡El día está aquí! ¡Ha llegado! Las
consecuencias de sus acciones han cerrado el círculo: el bastón ha
florecido, el orgullo ha florecido. \bibleverse{11} Su camino de
...
honor. \bibleverse{12} ``¡Ha llegado el momento; el día está aquí!
...
castigo viene para todos. \bibleverse{13} Los vendedores nunca
...
sobrevivirán. \footnote{\textbf{7:13} Lev 27,24} \bibleverse{14} Aunque
...
\bibleverse{15} ``Fuera de la ciudad hay ataques armados; dentro hay
...
\bibleverse{16} Los que sobrevivan escaparán y se irán a vivir a las
montañas. Suspirarán como las palomas del valle, cada uno pensando en
sus propios pecados. \bibleverse{17} Todas las manos cojean y todas las
rodillas se debilitan. \bibleverse{18} Se vestirán con ropas de saco y
estarán totalmente aterrorizados. Todos se avergonzarán y se afeitarán
la cabeza en señal de duelo. \bibleverse{19} Tirarán su plata en las
...
problema que causó su pecado en primer lugar. \footnote{\textbf{7:19}
  Prov 11,4; Sof 1,18} \bibleverse{20} Estaban tan orgullosos de sus
...
ídolos en cosas inmundas para ellos. \bibleverse{21} Voy a entregar
estas cosas como botín a los extranjeros y como botín a los malvados de
la tierra, que las harán inmundas. \bibleverse{22} Miraré de reojo
...
\bibleverse{23} Prepara las cadenas,\footnote{\textbf{7:23} Cadenas para
...
violencia. \bibleverse{24} Así que voy a hacer que los más malvados de
todas las naciones se apoderen de sus casas. Acabaré con el orgullo de
los poderosos, y sus lugares santos quedarán impuros. \bibleverse{25}
``Absolutamente aterrorizados, los pueblos buscarán la paz, pero no la
encontrarán. \bibleverse{26} Desastre tras desastre caerá sobre ellos, y
...
ancianos. \bibleverse{27} El rey estará de luto, el príncipe estará
...
\bibleverse{1} El quinto día del sexto mes del sexto año, yo estaba
sentado en mi casa con los ancianos de Judá y el poder del Señor Dios se
apoderó de mí allí. \bibleverse{2} Miré a mi alrededor y vi un ser que
...
parecía metal brillante. \bibleverse{3} Extendió lo que parecía ser una
...
\bibleverse{4} Allí vi la gloria del Dios de Israel, igual que en la
...
\bibleverse{7} Me llevó a la entrada del patio del Templo. Al mirar a mi
alrededor, vi un agujero en la pared. \bibleverse{8} ``Hijo de hombre'',
me dijo, ``tira de la pared''. Así que aparté el muro y encontré una
puerta.

\bibleverse{9} Me dijo: ``Atraviesa la pared y mira las cosas malas y
repugnantes que están haciendo aquí''.

\bibleverse{10} Así que atravesé el muro y vi imágenes talladas que
...
\footnote{\textbf{8:10} Rom 1,23} \bibleverse{11} Setenta ancianos de la
...
\bibleverse{12} ``Hijo de hombre'', me dijo, ``¿puedes ver lo que los
...
además el Señor ha abandonado nuestro país!'\,'' \bibleverse{13} El
...
\bibleverse{14} Entonces me llevó a la entrada norte del Templo del
Señor. Vi a las mujeres sentadas allí, llorando por el dios Tamuz.
\bibleverse{15} ``Hijo de hombre'', me dijo, ``¿has visto esto? Pues vas
...
\bibleverse{16} Entonces me llevó al patio interior del Templo del Señor
...
\bibleverse{17} ``Hijo de hombre -me dijo-, ¿has visto esto? El pueblo
...
Mira cómo me insultan deliberadamente!\footnote{\textbf{8:17}
  Literalmente, ``se pusieron la rama en la nariz''.} \bibleverse{18}
...
\bibleverse{1} Entonces le oí gritar con voz potente: ``¡Comiencen el
ataque, ustedes los encargados de castigar a Jerusalén! Recojan sus
armas''. \bibleverse{2} Observé que seis hombres se acercaban por la
...
\bibleverse{3} La gloria del Dios de Israel se levantó de su lugar
...
\footnote{\textbf{9:3} Ezeq 1,4-28} \bibleverse{4} ``Recorre toda la
...
\bibleverse{5} Entonces le oí decir a los demás: ``Síganle por toda la
ciudad y comiencen a matar a la gente. No tengan piedad ni misericordia
de nadie. \bibleverse{6} Maten a los ancianos, a los jóvenes y a las
...
\bibleverse{7} Luego les dijo: ``Ensucien el Templo y llenen los patios
...
\bibleverse{8} Mientras ellos estaban ocupados matando gente, yo me
...
\bibleverse{9} ``Los pecados del pueblo de Israel y de Judá son
...
\footnote{\textbf{9:9} Ezeq 8,12} \bibleverse{10} Pero ciertamente no
seré amable con ellos ni tendré piedad. Me aseguraré de que sufran las
consecuencias de lo que han hecho''.

\bibleverse{11} Entonces, el hombre de lino con el equipo de escritura
...
\bibleverse{1} Miré hacia arriba y vi lo que parecía un trono hecho de
...
los querubines.\footnote{\textbf{10:1} Véase 1:26.} \footnote{\textbf{10:1}
  Ezeq 1,22; Ezeq 1,26} \bibleverse{2} Hablando desde allí, el Señor le
...
\bibleverse{3} Los querubines estaban de pie en el lado sur del Templo
cuando el hombre entró. Una nube llenaba el patio interior.
\bibleverse{4} Entonces la gloria del Señor se elevó por encima de los
...
\footnote{\textbf{10:4} Ezeq 1,4-28; Is 6,4} \bibleverse{5} El ruido que
hacían las alas de los querubines podía oírse incluso en el patio
exterior, y sonaba como la voz de Dios Todopoderoso.

\bibleverse{6} Cuando el Señor le ordenó al hombre vestido de lino: ``Ve
a buscar fuego de entre las ruedas, de entre los querubines'', el hombre
entró y se puso al lado de una de las ruedas. \bibleverse{7} Entonces
...
y se fue. \bibleverse{8} (Todos los querubines tenían lo que parecían
manos humanas bajo las alas).

\bibleverse{9} Vi cuatro ruedas junto a los querubines, una rueda al
lado de cada querubín. Las ruedas brillaban como el topacio.
\bibleverse{10} Las cuatro ruedas eran iguales y tenían una rueda dentro
de otra, colocada en cruz. \bibleverse{11} Los querubines podían ir en
cualquier dirección que miraran, moviéndose sin girar. \bibleverse{12}
Todo su cuerpo, incluyendo la espalda, las manos y las alas, estaba
cubierto de ojos, al igual que las cuatro ruedas. \bibleverse{13} Oí que
se referían a las ruedas como ``las ruedas de los carros''.\footnote{\textbf{10:13}
  ...
  Señor.} \bibleverse{14} Cada uno de ellos tenía cuatro caras: la
primera cara era de querubín, la segunda de hombre, la tercera de león y
la cuarta de águila.

\bibleverse{15} Entonces los querubines se elevaron en el aire. Eran los
seres que había visto junto al río Quebar. \bibleverse{16} Cuando los
...
\bibleverse{17} Cuando los querubines se detenían, las ruedas también lo
...
\bibleverse{18} Entonces la gloria del Señor salió de la entrada del
Templo y se detuvo sobre los querubines. \bibleverse{19} Mientras yo
...
\bibleverse{20} Estos eran los seres que yo había visto debajo del Dios
de Israel junto al río Quebar. Supe que eran querubines. \bibleverse{21}
Cada uno tenía cuatro rostros y cuatro alas, y tenían lo que parecían
manos humanas debajo de sus alas. \bibleverse{22} Sus rostros se
...
\bibleverse{1} Entonces el Espíritu me recogió y me llevó a la entrada
...
Pelatías, hijo de Benaía, líderes del pueblo. \bibleverse{2} El Señor me
...
\bibleverse{3} Están diciendo: `¿Es éste el momento de construir casas?
...
ella'.\footnote{\textbf{11:3} El significado de este verso resulta
  ...
  miedo, de ser como la carne que se hierve en una olla.} \bibleverse{4}
Así que profetiza contra ellos. Profetiza, hijo de hombre''.

\bibleverse{5} El Espíritu del Señor vino sobre mí y me dijo que dijera
Esto es lo que dice el Señor: ``¡Pueblo de Israel, eso es lo que estás
diciendo! ¡Yo sé lo que están pensando por dentro! \bibleverse{6}
Ustedes asesinan a más y más personas en esta ciudad. ¡Has llenado sus
calles de muertos!

\bibleverse{7} ``Esto es lo que dice el Señor Dios: Los que has matado
en esta ciudad son la carne, y la ciudad es la olla; pero yo te voy a
sacar de ella. \bibleverse{8} Ustedes tienen miedo de que los mate la
espada, así que traeré invasores con espadas para que los ataquen,
declara el Señor Dios. \bibleverse{9} Voy a sacarte de la ciudad y a
entregarte a los extranjeros, y voy a cumplir mi sentencia contra ti.
\bibleverse{10} Te matarán a espada y te castigaré hasta las fronteras
de Israel. Entonces sabrás que yo soy el Señor. \footnote{\textbf{11:10}
  2Re 25,20-21} \bibleverse{11} ``La ciudad no será como una olla para
ti, y tú tampoco serás la carne dentro de ella. Te castigaré hasta las
fronteras de Israel. \bibleverse{12} Entonces sabrás que yo soy el
...
\bibleverse{13} Mientras yo profetizaba, Pelatías hijo de Benaía murió.
...
\bibleverse{14} Me llegó un mensaje del Señor que decía: \bibleverse{15}
...
\bibleverse{16} ``Diles, pues, que esto es lo que dice el Señor Dios: A
...
\bibleverse{17} ``Diles que esto es lo que dice el Señor Dios: Voy a
...
\bibleverse{18} ``Cuando regresen, van a eliminar del país todos sus
ídolos ofensivos y sus prácticas repugnantes. \bibleverse{19} Les daré
...
\footnote{\textbf{11:19} Ezeq 36,26; Jer 24,7} \bibleverse{20} Así
...
\bibleverse{21} ``Pero a los que siguen eligiendo adorar ídolos
...
\bibleverse{22} Entonces los querubines abrieron sus alas y despegaron,
con las ruedas a su lado y con la gloria del Dios de Israel sobre ellos.
\footnote{\textbf{11:22} Ezeq 1,4-28} \bibleverse{23} La gloria del
Señor se elevó desde el interior de la ciudad y se dirigió al monte al
este de la ciudad. \bibleverse{24} En la visión que me dio el Espíritu
...
\bibleverse{25} les expliqué a los exiliados todo lo que el Señor me
había mostrado.
...
\bibleverse{3} ``Así que, hijo de hombre, ve y haz tus maletas como si
...
que esto significa, aunque sean gente rebelde. \bibleverse{4} Saquen sus
...
quien va al exilio. \bibleverse{5} ``Mientras ellos vigilan, derriba una
parte del muro de tu casa y saca tus pertenencias por el agujero.
\bibleverse{6} Cuando oscurezca, mientras ellos siguen vigilando, ponte
...
\bibleverse{7} Así que hice lo que se me indicó. Saqué mis maletas para
...
\bibleverse{8} Por la mañana me llegó un mensaje del Señor, que decía:
\bibleverse{9} ``Hijo de hombre, ¿no te han preguntado esos israelitas
rebeldes: `¿Qué estás haciendo?'

\bibleverse{10} Diles que esto es lo que dice el Señor Dios: `Esta señal
...
\bibleverse{11} ``Debes decirles: `Yo soy una señal para ustedes'. Tal
como se demostró aquí, así les sucederá a ellos: irán al exilio como
prisioneros. \footnote{\textbf{12:11} Ezeq 12,6}

\bibleverse{12} Cuando se haga de noche, su príncipe también se echará
...
cubrirá la cara para no ver el país que deja atrás. \footnote{\textbf{12:12}
  Jer 39,7} \bibleverse{13} Pero yo lo atraparé en mi red; lo atraparé
...
no lo verá, y allí morirá. \footnote{\textbf{12:13} Ezeq 17,20; Ezeq
  32,3-6} \bibleverse{14} ``Voy a dispersar a todos sus ayudantes y a
todas sus tropas en todas direcciones, y los perseguiré con la espada
desenvainada.

\bibleverse{15} Ellos sabrán que yo soy el Señor cuando los disperse
entre las diferentes naciones y países. \bibleverse{16} ``Pero dejaré
...
\bibleverse{17} Me llegó un mensaje del Señor que decía: \bibleverse{18}
``Hijo de hombre, tiembla al comer tu pan; tiembla de preocupación al
beber tu agua. \bibleverse{19} Entonces explica a la gente de este país
...
\bibleverse{20} Las ciudades serán destruidas y el campo se convertirá
...
\bibleverse{21} Otro mensaje del Señor me llegó diciendo:
\bibleverse{22} ``Hijo de hombre, ¿qué es ese proverbio que ustedes
tienen en la tierra de Israel: `El tiempo pasa y ninguna visión se hace
realidad?' \footnote{\textbf{12:22} 2Pe 3,4} \bibleverse{23} Pues diles
...
el momento en que toda visión se hará realidad. \footnote{\textbf{12:23}
  Hab 2,3} \bibleverse{24} No habrá más visiones falsas ni profecías
falsas entre los israelitas, \bibleverse{25} porque yo, el Señor, diré
...
\bibleverse{26} Un mensaje adicional del Señor me llegó, diciendo:
\bibleverse{27} ``Hijo de hombre, fíjate en lo que dice el pueblo de
...
\bibleverse{28} ``Pues diles que esto es lo que dice el Señor Dios: Todo
...
profecías: ¡Escuchen la palabra del Señor! \bibleverse{3} Esto es lo que
...
siguen sus propias ideas. No han visto nada. \footnote{\textbf{13:3} Jer
  23,21; Jer 23,31} \bibleverse{4} Israel, tus profetas son como zorros
que viven en las ruinas. \bibleverse{5} No fueron a reparar los huecos
de la muralla que protege al pueblo de Israel para que se mantenga
segura durante la batalla del Día del Señor. \bibleverse{6} ``Las
...
Aun así, ¡esperan que su mensaje se cumpla! \footnote{\textbf{13:6} Ezeq
  22,28; Jer 23,32} \bibleverse{7} ¿No es una visión falsa la que
...
\bibleverse{8} ``Así que esto es lo que dice el Señor: Ya que han dicho
mentiras y han afirmado ver visiones falsas, entonces tengan cuidado,
porque estoy contra ustedes, declara el Señor Dios. \bibleverse{9}
...
\bibleverse{10} ``Han engañado a mi pueblo diciendo: `Tendremos paz',
...
inestable de piedras sueltas que el pueblo ha construido. \footnote{\textbf{13:10}
  Jer 6,14} \bibleverse{11} Así que díganle a esa gente que está
...
tormenta de viento soplará con fuerza contra él. \bibleverse{12} ¿No
creen que cuando el muro se derrumbe la gente te preguntará: `¿Qué pasó
con la cal que pintaste?'

\bibleverse{13} ``Esto es lo que dice el Señor: En mi furia voy a enviar
una tormenta de viento, lluvia torrencial y piedras de granizo para
destruir el muro. \bibleverse{14} Demoleré el muro que encalaron,
...
Señor. \bibleverse{15} ``Una vez que la muralla y los que la encalaron
hayan experimentado mi ira, se los diré: El muro ya no existe, y los que
lo encubrieron ya no existen, \bibleverse{16} esos `profetas' de Israel
...
\bibleverse{17} ``Ahora, hijo de hombre, debes oponerte a esas mujeres
israelitas que inventan profecías en su propia mente. Profetiza contra
ellas \bibleverse{18} y diles que esto es lo que dice el Señor Dios:
...
\bibleverse{19} Me han deshonrado por unos puñados de cebada y unas
...
atrapado. \bibleverse{21} También arrancaré sus velos y rescataré a mi
pueblo de tu poder, para que ya no sea su víctima. Entonces sabrán que
yo soy el Señor. \bibleverse{22} ``Porque han desanimado a la gente
...
salvar sus vidas, \bibleverse{23} de ahora en adelante no podrán ver
...
\bibleverse{1} Llegaron algunos ancianos de Israel y se sentaron
conmigo. \footnote{\textbf{14:1} Ezeq 20,1} \bibleverse{2} Me llegó un
mensaje del Señor que decía: \bibleverse{3} ``Hijo de hombre, estos
...
adecuada a sus muchos ídolos. \bibleverse{5} Así podré hacer que el
...
\bibleverse{6} ``Así que dile al pueblo de Israel que esto es lo que
...
\bibleverse{7} Cuando el pueblo de Israel o los extranjeros que viven
con él adoren ídolos en su mente que los lleven a pecar y luego vengan a
consultar al profeta, yo mismo, el Señor, les responderé. \bibleverse{8}
...
\bibleverse{9} ``Pero si el profeta es engañado para dar un mensaje, fui
...
destruiré a ese profeta de mi pueblo Israel. \footnote{\textbf{14:9} 1Re
  22,20-23} \bibleverse{10} Ellos serán responsables del castigo que
reciban, así como los que crean en esos profetas recibirán el mismo
castigo. \bibleverse{11} Esto es para que el pueblo de Israel no me
...
\bibleverse{12} Me llegó de nuevo un mensaje del Señor que decía:
\bibleverse{13} ``Hijo de hombre, si un pueblo de un país peca contra mí
...
\bibleverse{14} Aunque Noé, Daniel y Job, estos tres hombres, estuvieran
presentes sus buenas vidas sólo se salvarían a sí mismos, declara el
Señor Dios. \footnote{\textbf{14:14} Jer 15,1}

\bibleverse{15} ``Yo podría enviar animales salvajes a arrasar el país,
...
nadie viajaría por miedo a esos animales. \footnote{\textbf{14:15} Ezeq
  14,21} \bibleverse{16} En mi vida, declara el Señor Dios, aunque estos
...
personas como los animales mueran! \bibleverse{22} ``Aun así, algunos de
...
desastre sobre Jerusalén, todo lo que le hice. \bibleverse{23} Si te das
...
árbol del bosque? \footnote{\textbf{15:2} Jer 2,21} \bibleverse{3}
...
\bibleverse{4} ``No, sólo hay que echarla al fuego para mantenerlo
encendido. Incluso así, el fuego quema los dos extremos, pero sólo
carboniza la parte del centro. ¿Se puede utilizar para algo?
\bibleverse{5} Ni siquiera antes de quemarla podrías convertirla en algo
...
\bibleverse{6} ``Así que esto es lo que dice el Señor Dios: De la misma
...
\bibleverse{7} Me volveré contra ellos. Aunque hayan escapado de este
fuego, otro fuego los va a quemar. Cuando me vuelva contra ellos,
entonces sabrán que yo soy el Señor. \bibleverse{8} ``Voy a convertir el
...
\bibleverse{1} Me llegó otro mensaje del Señor, que decía:
\bibleverse{2} ``Hijo de hombre, desafía a Jerusalén por sus prácticas
repugnantes. \bibleverse{3} Dile a Jerusalén que esto es lo que el Señor
...
\bibleverse{4} El día que naciste no te cortaron el cordón umbilical, ni
te lavaron para limpiarte, ni te frotaron con sal, ni te envolvieron en
paños. \bibleverse{5} Nadie te miró con amor para hacer algo así por ti;
...
\bibleverse{7} Te ayudé a crecer como una planta en el campo. Creciste
...
\bibleverse{8} ``Cuando volví a pasar por allí, te miré y vi que estabas
...
\bibleverse{9} Luego te lavé con agua, limpié tu sangre y te ungí con
aceite. \bibleverse{10} Te puse un vestido bellamente bordado y te di
sandalias de cuero fino. Te vestí de lino fino y te cubrí de seda.
\bibleverse{11} Te regalé joyas: te puse brazaletes en las muñecas y un
collar en el cuello. \bibleverse{12} Te puse un anillo en la nariz y
aretes en las orejas, y coloqué una hermosa corona en tu cabeza.
\bibleverse{13} ``Llevabas joyas de oro y plata, y tus ropas eran de
...
convertiste en una reina. \bibleverse{14} Fuiste famosa en todo el mundo
...
\bibleverse{15} ``Estabas tan orgullosa de tu belleza que me fuiste
...
\footnote{\textbf{16:15} Éxod 34,16} \bibleverse{16} Te hiciste
...
no deben suceder en el futuro! \bibleverse{17} ``También usaste las
hermosas joyas de oro y plata que te di para hacer ídolos masculinos y
te prostituiste con ellas. \bibleverse{18} Usaste tus ropas bordadas
para vestirlos, y colocaste ante ellos mi aceite de oliva y mi incienso.
\bibleverse{19} Presentaste la comida que te había dado como ofrenda
...
\bibleverse{20} ``Sacrificaste a tus hijos e hijas -- los hijos que
tuviste para mí -- ofreciéndolos como alimento para que los comieran los
ídolos. ¿No fue suficiente tu prostitución? \bibleverse{21} Sacrificaste
a mis hijos, los sacrificaste a los ídolos. \bibleverse{22} ``Mientras
...
\bibleverse{23} ``¡Viene el desastre! El desastre viene sobre ti,
declara el Señor Dios. Además de todas las cosas malas que hiciste,
\bibleverse{24} te construiste un santuario pagano, un altar de cultoa
...
las plazas de la ciudad. \bibleverse{25} Te convertiste en lugares altos
...
piernas para ellos, volviéndote cada vez más promiscua. \bibleverse{26}
...
promiscua. \bibleverse{27} ``Así que actué para reducir mis bendiciones
...
inmoralidad. \bibleverse{28} Como no estabas satisfecha, te prostituiste
con los asirios. Pero ni siquiera entonces quedaste satisfecha.
\bibleverse{29} Entonces llevaste tu conducta promiscua a Babilonia, el
país de los mercaderes, ¡pero ni siquiera entonces quedaste satisfecha!

\bibleverse{30} ``Realmente eres una mente enferma al hacer todo esto,
actuando como una prostituta sin vergüenza, declara el Señor Dios.
\bibleverse{31} En realidad, ni siquiera eras una prostituta normal
...
\bibleverse{32} ``¡Eres una esposa que ama el adulterio! ¡Te acuestas
con extraños y no con tu propio marido! \bibleverse{33} Normalmente
...
partes y tuvieran relaciones sexuales contigo. \bibleverse{34} Así que
...
\bibleverse{35} ``Así que, prostituta, ¡escucha el mensaje del Señor!
\bibleverse{36} Esto es lo que dice el Señor: Como estabas tan loca de
...
a esos ídolos, \bibleverse{37} voy a reunir a todos los amantes con los
...
\bibleverse{38} Te impondré el castigo de las mujeres que cometen
adulterio y de las que asesinan; serás castigada con ira apasionada.
\bibleverse{39} ``Luego te entregaré a tus amantes, y ellos demolerán
...
te dejarán completamente desnuda. \bibleverse{40} Vendrán con una turba
a atacarte. Te apedrearán y te cortarán en pedazos con sus espadas.
\bibleverse{41} Quemarán sus casas y los castigarán mientras muchas
mujeres lo observan. ``Detendré tu prostitución, y no volverás a pagar a
tus amantes. \bibleverse{42} Entonces dejaré de estar celoso y furioso
contigo. Me calmaré y no me enfadaré más.

\bibleverse{43} ``Como no te acordaste de cómo te cuidé\footnote{\textbf{16:43}
...
\bibleverse{44} ``Todos los que gustan de usar proverbios citarán éste
sobre ti: ```De tal palo, tal astilla'. \bibleverse{45} ``Tú eres la
...
padre era amorreo. \footnote{\textbf{16:45} Ezeq 16,3} \bibleverse{46}
...
\footnote{\textbf{16:46} Ezeq 23,4} \bibleverse{47} Tú no te limitaste a
seguir sus caminos y a hacer las mismas cosas repugnantes que ellas,
sino que muy pronto te volviste aún peor que ellas. \bibleverse{48}
``Vivo yo, declara el Señor Dios, que tu hermana Sodoma y sus hijas
nunca hicieron lo que tú y tus hijas han hecho.

\bibleverse{49} Los pecados de tu hermana Sodoma fueron estos: Ella y
sus hijas eran orgullosas, codiciosas y perezosas. No ayudaron a los
pobres ni a los necesitados. \bibleverse{50} Se volvieron arrogantes e
hicieron cosas repugnantes en mi presencia. Así que me deshice de ellas
cuando vi esto. \footnote{\textbf{16:50} Gén 18,20} \bibleverse{51}
...
\bibleverse{52} Ahora vas a tener que soportar tu vergüenza, ya que con
...
\bibleverse{53} ``Aun así, voy a hacer que Sodoma y sus hijas vuelvan
...
y sus hijas también. Te volveré a juntar con ellas. \bibleverse{54} Así
tendrás que soportar tu desgracia y avergonzarte de todas las cosas
malas que hiciste para que ellas se sintieran mejor. \bibleverse{55}
...
eran antes. \bibleverse{56} ¿No os burlabais de vuestra hermana Sodoma
cuando os sentíais orgullosas, \bibleverse{57} antes de que se
...
\bibleverse{58} Tendrás que experimentar las consecuencias de tu
...
\bibleverse{59} ``Esto es lo que dice el Señor: Voy a castigarte según
tus pecados, porque trataste con desprecio la promesa que hiciste al
romper el acuerdo. \bibleverse{60} Pero no olvidaré el acuerdo que hice
contigo cuando eras joven, y haré un acuerdo eterno contigo. \footnote{\textbf{16:60}
  Lev 26,45; Os 2,17; Ezeq 37,26; Jer 31,31; Jer 31,34} \bibleverse{61}
...
\footnote{\textbf{16:61} Ezeq 20,43} \bibleverse{62} ``Así es como
...
con el pueblo de Israel. \bibleverse{3} Diles que esto es lo que dice el
...
\bibleverse{4} Rompió su rama más alta y la llevó a un país de
comerciantes, y la plantó en una ciudad de comerciantes.

\bibleverse{5} Tomó un poco de la semilla de la tierra y la plantó en
buena tierra junto a un gran río, donde pudo crecer como un sauce.
\bibleverse{6} La semilla brotó y creció hasta convertirse en una vid
...
\bibleverse{7} ``Pero había otra gran águila que tenía grandes alas y
...
regara. \bibleverse{8} Pero había sido plantada en buena tierra, junto a
un gran río, para que creciera fuerte, diera fruto y se convirtiera en
una magnífica vid.

\bibleverse{9} ``Así que diles que esto es lo que dice el Señor Dios:
...
fuertes ni mucha gente para arrancarlo de raíz. \bibleverse{10} Incluso
...
\bibleverse{11} Me llegó un mensaje del Señor que decía: \bibleverse{12}
...
\bibleverse{13} Hizo un acuerdo con uno de los miembros de la familia
...
\bibleverse{14} para que el reino se mantuviera en sujeción y no fuera
lo suficientemente fuerte como para rebelarse; sólo sobreviviría
manteniendo su acuerdo con él. \bibleverse{15} ``Sin embargo, este rey
...
\bibleverse{16} ``Vivo yo, declara el Señor Dios, que va a morir en
Babilonia, en el país del rey que lo puso en el trono, cuyo juramento
despreció y cuyo acuerdo rompió. \bibleverse{17} El faraón, con su
...
asedio y acabe muriendo mucha gente. \bibleverse{18} No respetó su
...
\bibleverse{19} ``Así que esto es lo que dice el Señor Dios: Vivo yo, lo
...
y por romper mi acuerdo. \bibleverse{20} Lanzaré mi red sobre él y lo
...
condenaré a un castigo allí por su traición hacia mí. \footnote{\textbf{17:20}
  Ezeq 12,13} \bibleverse{21} Todos sus mejores soldados morirán en la
...
\bibleverse{22} ``Esto es lo que dice el Señor: Voy a arrancar una rama
de la copa alta del cedro y la plantaré en la cima de un monte alto.
\bibleverse{23} Lo plantaré en el monte alto de Israel para que le
...
\footnote{\textbf{17:23} Ezeq 20,40; Dan 4,9; Mat 13,32} \bibleverse{24}
...
\bibleverse{3} ``Mientras yo viva, declara el Señor Dios, no citarás más
este proverbio en Israel. \bibleverse{4} ¿No ves que todos me
...
\bibleverse{5} ``Toma el ejemplo de un hombre que es una buena persona,
que hace lo justo y lo correcto. \bibleverse{6} ``No va a los santuarios
...
con una mujer durante su período. \bibleverse{7} No explota a nadie.
...
Da de comer al hambriento y viste al desnudo. \footnote{\textbf{18:7}
  Sal 15,3; Deut 24,10-13} \bibleverse{8} No presta con intereses ni se
...
verdaderamente justo en sus decisiones entre las personas. \footnote{\textbf{18:8}
  Éxod 22,24} \bibleverse{9} Sigue mis reglas y cumple fielmente mis
...
\bibleverse{10} ``¿Qué pasa si ese hombre tiene un hijo que es un
delincuente violento, que mata y hace esas cosas malas que se acaban de
enumerar \bibleverse{11} aunque el padre no actúe así en absoluto. El
...
\bibleverse{12} Explota a los pobres y a los necesitados. Roba a otros,
y no devuelve lo que un deudor le ha dado como garantía. Adora a los
ídolos. Comete pecados repugnantes. \bibleverse{13} Presta con intereses
...
\bibleverse{14} ``Ahora bien, ¿qué pasa si este hombre tiene un hijo que
ve todos los pecados que su padre ha cometido? Los ve pero no hace lo
mismo. \bibleverse{15} No va a los santuarios paganos en las montañas
para comer una comida religiosa, ni adora a los ídolos de Israel. No
tiene relaciones sexuales con la mujer de otro. \bibleverse{16} No
explota a nadie. No exige una garantía para un préstamo. No roba a los
demás. Da de comer al hambriento y viste al desnudo. \bibleverse{17} Se
...
pecados de su padre, ciertamente vivirá. \bibleverse{18} Pero su padre
morirá por sus propios pecados, porque explotó a otros, robó a sus
parientes e hizo mal a su propio pueblo.

\bibleverse{19} Ustedes preguntan: `¿Por qué no ha de pagar el hijo por
...
castigado.\footnote{\textbf{18:19} ``No será castigado'': añadido para
  mayor claridad.} \bibleverse{20} ``Es la persona que peca la que
...
\bibleverse{21} ``Sin embargo, si alguien que es malvado deja de pecar y
guarda mis leyes, haciendo lo que es justo y correcto, ciertamente
vivirá-no morirá. \bibleverse{22} Ninguno de sus pecados se les echará
en cara. Porque ahora están haciendo lo que es justo, vivirán.
\bibleverse{23} ¿Acaso me gusta que los malvados mueran? declara el
Señor Dios. Claro que no; me encantaría que dejaran de pecar y vivieran.
\footnote{\textbf{18:23} Ezeq 18,32; Ezeq 33,11}

\bibleverse{24} ``Pero si alguien que vive de acuerdo con lo que es
...
\bibleverse{25} ``Aun así, ustedes dicen: `Lo que hace el Señor no está
...
bien? ¿No es lo que tú haces lo que no está bien? \footnote{\textbf{18:25}
  Ezeq 33,17-20} \bibleverse{26} ``Si alguien que vive de acuerdo con lo
que es correcto deja de hacer lo correcto y hace lo incorrecto, morirá.
Morirá a causa de las cosas malas que haya hecho. \bibleverse{27} ``Pero
si alguien malvado deja de hacer lo malo y hace lo que es justo y
correcto, salvará su vida. \bibleverse{28} Por haber reflexionado y
dejado de hacer lo malo, ciertamente vivirán; no morirán.
\bibleverse{29} ``Pero el pueblo de Israel dice: `El camino del Señor no
...
\bibleverse{30} ``En consecuencia, ¡voy a juzgarte, pueblo de Israel!
...
los hundan. \bibleverse{31} ¡Deshazte de todos tus pecados rebeldes!
Cambia tu forma de pensar y ten un espíritu nuevo. ¿Por qué quieres
morir, pueblo de Israel? \footnote{\textbf{18:31} Ezeq 36,26}
\bibleverse{32} ``No me gusta que nadie muera, declara el Señor Dios.
...
\bibleverse{1} Canta este canto fúnebre para los príncipes de Israel
\bibleverse{2} con estas palabras: ``¿Qué era tu madre? Era una leona
entre los leones. Se acostó en su lugar entre los leones jóvenes y crió
a sus cachorros. \bibleverse{3} Ella crió a uno de sus cachorros, y éste
creció hasta convertirse en un león joven. Una vez que aprendió a
despedazar su presa, empezó a comer gente. \bibleverse{4} Pero cuando
...
Utilizaron anzuelos para arrastrarlo a Egipto.\footnote{\textbf{19:4}
  ...
  2Re 23,30-34} \bibleverse{5} ``Cuando se dio cuenta de que la
esperanza que había estado esperando había desaparecido, convirtió a
otro de sus cachorros en un león joven. \bibleverse{6} Se paseó con los
demás leones y se hizo fuerte. Cuando aprendió a despedazar a sus
presas, empezó a comer gente. \bibleverse{7} Derribó sus
...
cuando lo oyó rugir. \bibleverse{8} Entonces la gente de los países de
alrededor lo atacó. Le echaron la red y lo atraparon en su trampa.
\bibleverse{9} Con ganchos lo metieron en una jaula y lo llevaron al rey
...
\bibleverse{10} ``Tu madre era como una vid plantada en tu viña a la
orilla del agua. Producía mucho fruto y tenía muchas ramas porque tenía
mucha agua. \footnote{\textbf{19:10} Ezeq 17,6} \bibleverse{11} Sus
...
que era. \bibleverse{12} Pero fue arrancado con ira y arrojado al suelo.
...
\bibleverse{13} Ahora la vid ha sido replantada en el desierto, en una
tierra seca y sin agua. \bibleverse{14} Un fuego salió de su tronco
...
\bibleverse{1} El día diez del quinto mes del séptimo año, algunos de
los ancianos de Israel vinieron a pedir consejo al Señor, y se sentaron
conmigo.

\bibleverse{2} Entonces me llegó un mensaje del Señor, que decía:
\bibleverse{3} ``Hijo de hombre, dile a estos ancianos de Israel que
...
\bibleverse{4} ``¿Vas a condenarlos, hijo de hombre? Recuérdales las
...
\bibleverse{5} y luego diles que esto es lo que dice el Señor Dios:
...
Levanté mi mano y les dije: `Yo soy el Señor, tu Dios'. \bibleverse{6}
...
mejor que cualquier otro país. \bibleverse{7} Les dije: `Todos ustedes
...
\bibleverse{8} ``Pero se rebelaron contra mí y no quisieron hacer lo que
...
advertí que los castigaría con mi ira allí en Egipto. \bibleverse{9}
...
\bibleverse{10} ``Así que los saqué de Egipto y los llevé al desierto.
\bibleverse{11} Allí les di mis leyes y les expliqué mis reglamentos
para que los que los cumplieran vivieran. \footnote{\textbf{20:11} Lev
  18,5} \bibleverse{12} También les di mis sábados para que fueran una
...
\bibleverse{13} ``Pero el pueblo de Israel se rebeló contra mí en el
...
\bibleverse{14} Pero aun así actué a favor de ellos para que no me
...
naciones que me habían visto sacar a Israel de Egipto. \footnote{\textbf{20:14}
  Ezeq 20,9} \bibleverse{15} ``Así que levanté mi mano y les juré en el
...
que fluye leche y miel -mejor que cualquier otro país- \footnote{\textbf{20:15}
  Núm 14,12} \bibleverse{16} porque rechazaron repetidamente mis
reglamentos, se negaron a observar mis leyes y violaron mis sábados, y
porque eligieron seguir adorando a los ídolos. \bibleverse{17} Aun así,
...
\bibleverse{18} ``En el desierto les dije a sus hijos: `No hagan lo que
sus padres les dijeron que hicieran. No sigan sus prácticas. No se
ensucien adorando sus ídolos. \bibleverse{19} Yo soy el Señor, tu Dios.
Hagan lo que yo les digo. Sigan mis normas y asegúrense de practicarlas.
\bibleverse{20} Santifiquen mis sábados para que sean una señal entre
ustedes y yo, para que reconozcan que yo soy el Señor su Dios'.
\footnote{\textbf{20:20} Ezeq 20,12}

\bibleverse{21} ``Pero sus hijos también se rebelaron contra mí. No
...
castigaría con mi ira allí en el desierto. \bibleverse{22} Pero me
...
Israel de Egipto. \bibleverse{23} ``Sin embargo, levanté mi mano y les
juré en el desierto que los iba a dispersar entre los distintos países
de las diferentes naciones. \bibleverse{24} Porque no guardaron mis
reglamentos, sino que rechazaron mis leyes y violaron mis sábados,
buscando siempre adorar a los ídolos de sus padres. \bibleverse{25}
``También dejé que siguieran los reglamentos que querían y que no eran
buenos; leyes que no les ayudaban a vivir. \bibleverse{26} Dejé que se
...
\bibleverse{27} ``Así que, hijo de hombre, dile al pueblo de Israel que
...
\bibleverse{28} Después de que los conduje a la tierra que les había
...
derramando sus libaciones. \bibleverse{29} Así que les pregunté: `¿Qué
...
\bibleverse{30} ``Por tanto, díganle al pueblo de Israel que esto es lo
...
mismas prácticas repugnantes? \bibleverse{31} Cuando presentan sus
...
\bibleverse{32} ``Cuando se dicen a sí mismos: `Seamos como las demás
naciones, como la gente de otros países que adora a los ídolos de madera
y de piedra', lo que están pensando nunca va a suceder. \bibleverse{33}
``Vivo yo, declara el Señor Dios, que los gobernaré con toda mi fuerza y
poder, y con mi ira. \bibleverse{34} Con toda mi fuerza y mi poder, y
con mi ira, te sacaré de entre las naciones y te reuniré de los países
donde estabas disperso. \bibleverse{35} Los traeré ante mí para
juzgarlos cara a cara en el desierto de las naciones. \footnote{\textbf{20:35}
  Os 2,16} \bibleverse{36} ``De la misma manera que juzgué a sus
...
así los juzgaré a ustedes, declara el Señor Dios. \footnote{\textbf{20:36}
  Núm 14,22-23} \bibleverse{37} Decidiré sobre ustedes cuando pasen bajo
...
cumplido nuestro acuerdo solemne. \bibleverse{38} Me ocuparé de los que
...
\bibleverse{39} ``Esto es lo que el Señor Dios les dice a ustedes,
...
ofrendas e ídolos paganos. \bibleverse{40} ``Porque allí, en mi monte
...
\bibleverse{41} ``Cuando los traiga de vuelta de entre las naciones y
...
las naciones la vean. \bibleverse{42} Entonces reconocerán que yo soy el
Señor cuando los haga regresar al país de Israel, la tierra que prometí
dar a sus antepasados. \bibleverse{43} ``Allí se acordarán de sus malos
caminos y de todo lo que hicieron para contaminarse, y se odiarán a sí
mismos por las conductas malas que tuvieron. \bibleverse{44} Entonces
...
\bibleverse{45} Otro mensaje del Señor vino a mí, diciendo:
\bibleverse{46} ``Hijo de hombre, mira hacia el sur y predica contra él.
Profetiza contra el bosque del Néguev. \bibleverse{47} Dile al bosque
...
todo, desde el norte hasta el sur. \bibleverse{48} Entonces todos
reconocerán que fui yo, el Señor, quien inició el fuego, y no se
apagará''.

\bibleverse{49} Pero entonces dije: ``¡Oh, no, Señor Dios! La gente ya
...
Profetiza contra el pueblo que vive en Israel \bibleverse{3} y diles que
...
malos. \bibleverse{4} Porque voy a destruir tanto a los buenos como a
los malos, atacaré a todos desde el norte hasta el sur. \bibleverse{5}
...
\bibleverse{6} ``Tú, hijo de hombre, debes gemir. Gime como si
estuvieras destrozado por dentro, mostrando una terrible tristeza
mientras te observan. \bibleverse{7} Cuando te pregunten: `¿Por qué
...
\bibleverse{8} Me llegó otro mensaje del Señor, diciendo: \bibleverse{9}
...
\bibleverse{10} ¡Está afilada para matar y pulida para brillar como un
...
hijo como un palo cualquiera'?)\footnote{\textbf{21:10} El hebreo de
  ...
  otras naciones.} \bibleverse{11} La espada está siendo pulida en este
momento, lista para ser usada. Está afilada y pulida, lista para ser
entregada al asesino. \bibleverse{12} ¡Llora y grita, hijo de hombre, y
...
muertos por la espada junto con mi pueblo. \bibleverse{13} Serán puestos
a prueba. ¿Qué pasa si el cetro que desprecia a los demás no continúa?
declara el Señor Dios. \bibleverse{14} ``Entonces, hijo de hombre,
...
viniendo hacia ellos desde todas las direcciones. \footnote{\textbf{21:14}
  Ezeq 32,20} \bibleverse{15} He puesto una espada en todas las puertas
de su ciudad para que pierdan el valor y caigan muchos. Está hecha para
brillar como un relámpago y se usa para matar. \bibleverse{16} Tala a
derecha e izquierda, en cualquier dirección que esté. \bibleverse{17} Yo
...
\bibleverse{18} Otro mensaje del Señor me llegó diciendo:
\bibleverse{19} ``Hijo de hombre, marca los dos caminos que podría tomar
...
diferentes. \bibleverse{20} Haz que una señal señale el camino para
atacar la ciudad amonita de Rabá, y otra para atacar Judá y la ciudad
fortificada de Jerusalén. \bibleverse{21} ``El rey de Babilonia está
...
\bibleverse{22} ``Tiene la señal de Jerusalén en su mano derecha. Aquí
...
asedio. \bibleverse{23} A los que han jurado ser leales a Nabucodonosor
...
\bibleverse{24} ``Así que esto es lo que dice el Señor Dios: Como has
...
\bibleverse{25} ``En cuanto a ti, impuro y malvado príncipe de Israel,
ha llegado el momento de completar tu castigo. \bibleverse{26} Esto es
...
poderosos. \bibleverse{27} ¡Voy a destruirlo todo, a convertirlo en una
...
\bibleverse{28} ``Profetiza, hijo de hombre, y anuncia que esto es lo
...
como un rayo, \bibleverse{29} aunque tus profetas te den falsas visiones
...
cumplir su castigo. \bibleverse{30} ¡Espada, vuelve al lugar de donde
viniste! Y a ti voy a juzgarte justo donde te criaste, en tu tierra
natal. \bibleverse{31} Me ocuparé de ti con mi cólera; soplaré mi fuego
de ira sobre ti; te entregaré a hombres crueles y expertos en
destrucción. \bibleverse{32} Serás quemada como leña. Tu sangre se
...
\bibleverse{3} y diles que esto es lo que dice el Señor Dios: Ustedes
...
hicieron inmundos. \bibleverse{4} Eres culpable de asesinato, y te has
...
de ti. \bibleverse{5} ¡La gente de cerca y de lejos se reirá de ti,
...
\bibleverse{6} ``Mira cómo todos tus líderes en Israel usan su poder
para asesinar. \bibleverse{7} Desprecias a tus padres. Explotas a los
extranjeros que viven contigo, y maltratas a los huérfanos y a las
viudas. \footnote{\textbf{22:7} Éxod 22,20-21} \bibleverse{8}
``Desprecias mis cosas sagradas y violas mis sábados. \bibleverse{9}
...
\bibleverse{10} ``Algunos de los que viven en la ciudad tienen
relaciones sexuales con las esposas de sus padres o con mujeres durante
su período. \bibleverse{11} Son el hogar de hombres malvados. Uno hace
...
que otro viola a su hermana, la hija de su propio padre. \footnote{\textbf{22:11}
  Lev 18,9; Lev 18,15; Lev 18,20} \bibleverse{12} ``Tu gente toma dinero
...
\bibleverse{13} ``¡Así que cuidado! Aplaudo en señal de condena tus
ganancias deshonestas y todos tus asesinatos. \bibleverse{14} ¿Van a ser
...
hablado, y voy a actuar. \bibleverse{15} Voy a dispersarlos entre las
naciones y los distintos países. Pondré fin a sus actos impuros.
\bibleverse{16} Porque cuando todos los demás vean cómo ustedes se han
...
plata. \footnote{\textbf{22:18} Is 1,22; Jer 6,28} \bibleverse{19} ``Así
que esto es lo que dice el Señor Dios: Porque todos ustedes han
terminado como impurezas, vean cómo los reúno en Jerusalén.
\bibleverse{20} De la misma manera que un refinador recoge la plata, el
...
los mantendré allí hasta que los funda. \bibleverse{21} ``Voy a
juntarlos a todos y los haré estallar con el fuego de mi ira, y serán
fundidos allí en la ciudad. \bibleverse{22} Como la plata se funde en un
...
\bibleverse{23} Me llegó otro mensaje del Señor, que decía:
\bibleverse{24} ``Hijo de hombre, dile a la ciudad de Jerusalén que, en
el momento del castigo, eres un país que no se ha limpiado, un lugar
donde no ha caído lluvia, \bibleverse{25} ``Sus dirigentes\footnote{\textbf{22:25}
...
la ciudad. \bibleverse{26} ``Sus sacerdotes pervierten mi ley y hacen
...
\bibleverse{27} ``Los funcionarios de su ciudad son como lobos que
desgarran a su presa, matan a la gente y destruyen vidas para
beneficiarse con el fraude. \bibleverse{28} ``Sus profetas encubren lo
...
dicho nada. \bibleverse{29} ``La gente de este país es chantajista y
...
\bibleverse{30} ``Traté de encontrar a uno de ellos que reparara el muro
...
\bibleverse{31} Así que les he hecho experimentar mi hostilidad,
...
madre. \bibleverse{3} Se prostituyeron en Egipto. De hecho, fueron
prostitutas desde que eran jóvenes. Se dejaban acariciar los pechos
vírgenes y apretar los pezones. \bibleverse{4} La mayor se llamaba
...
\bibleverse{5} ``Ahola se prostituyó mientras estaba casada conmigo.
Quería tener relaciones sexuales con sus amantes, los asirios.
\bibleverse{6} Eran soldados vestidos de azul, líderes y comandantes,
todos ellos jóvenes apuestos de la caballería. \bibleverse{7} Se entregó
...
tener sexo. \bibleverse{8} ``No dejó la prostitución que había iniciado
...
\bibleverse{9} Así que la entregué a sus amantes, los asirios con los
que quería tener sexo. \bibleverse{10} La desnudaron, se llevaron a sus
...
\bibleverse{11} ``Aholiba vio lo que le sucedió a su hermana, pero se
volvió aún peor que ella en su deseo de tener sexo y practicar la
prostitución. \footnote{\textbf{23:11} Ezeq 16,51} \bibleverse{12}
...
apuestos de la caballería. \bibleverse{13} Vi que ella también se había
...
uniformes de color rojo intenso. \bibleverse{15} Llevaban cinturones en
...
\bibleverse{16} Cuando ella vio las pinturas de ellos, quiso tener
relaciones sexuales con ellos y les envió mensajeros a Caldea.
\bibleverse{17} Los babilonios se acercaron a ella y a su lecho de amor,
y la mancillaron con su deseo sexual. Sin embargo, después de haber sido
deshonrada por ellos, los rechazó con disgusto. \bibleverse{18} ``Cuando
...
\bibleverse{19} Pero ella practicó aún más la prostitución, recordando
cómo había sido prostituta en Egipto cuando era joven. \bibleverse{20}
...
\bibleverse{21} ``Volvió a los actos indecentes de cuando era joven,
...
\bibleverse{23} los babilonios y todos los caldeos, los hombres de
...
importantes, todos montando a caballo. \bibleverse{24} ``Te atacarán
...
propias leyes. \bibleverse{25} Siento tanto lo que has hecho que me
...
fuego. \bibleverse{26} Les arrancarán sus ropas y les quitarán sus
hermosas joyas. \bibleverse{27} Voy a poner fin a su inmoralidad y a su
prostitución, que comenzaron en Egipto. No pensarás con nostalgia en
esos tiempos, y te olvidarás de Egipto.

\bibleverse{28} ``Porque esto es lo que dice el Señor Dios: Créanme
cuando les digo que los voy a entregar al pueblo que odian, al que
rechazaron con asco. \bibleverse{29} Ellos te tratarán con odio. Te
...
descubierto. Tu inmoralidad y prostitución \bibleverse{30} es la razón
por la que te ha sucedido todo esto, porque actuaste como una prostituta
con las naciones y te ensuciaste adorando a sus ídolos. \bibleverse{31}
...
\bibleverse{32} ``Esto es lo que dice el Señor Dios: Beberás de la copa
de tu hermana, una copa grande y profunda. Se reirán de ti y te
insultarán. Tendrás que soportar mucho de esto. \bibleverse{33} Te
embriagará y te llenará de dolor porque es una copa que trae horror y
destrucción, la copa de la que bebió tu hermana Samaria. \bibleverse{34}
La beberás toda, la harás pedazos en el suelo y te desgarrarás el pecho.
Esto es lo que he dicho, declara el Señor Dios.

\bibleverse{35} En resumen, esto es lo que dice el Señor Dios: Porque te
...
\bibleverse{36} Entonces el Señor me dijo ``Hijo de hombre, ¿vas a
condenar a Ahola y a Aholiba? ¡Denuncia las cosas repugnantes que han
hecho! \bibleverse{37} Porque han cometido adulterio y son culpables de
...
\footnote{\textbf{23:37} Jer 7,31} \bibleverse{38} ``Ellos también me
hicieron esto: El mismo día que ensuciaron mi santuario y violaron mis
sábados. \bibleverse{39} El mismo día en que mataron a sus hijos para
sus ídolos, fueron a mi santuario y lo ensuciaron. ¡Miren lo que
hicieron dentro de mi Templo!

\bibleverse{40} ``Ellos\footnote{\textbf{23:40} Refiriéndose a las dos
...
\bibleverse{41} Os sentabais en un costoso sofá, con mi incienso y mi
aceite en una mesa colocada delante.

\bibleverse{42} La sala estaba llena del ruido de la gente que estaba de
...
coronas en la cabeza. \bibleverse{43} ``Entonces dije acerca de la vieja
desgastada: `¡Ahora pueden tenerla como prostituta, porque eso es lo que
es!'. \bibleverse{44} ``Así que tuvieron sexo con ella como una
prostituta. Tuvieron relaciones sexuales con Ahola y Aholiba, esas
mujeres inmorales. \bibleverse{45} Pero los hombres que creen en lo
correcto los juzgarán y les impondrán el castigo por cometer adulterio y
asesinato, porque son adúlteros y asesinos.

\bibleverse{46} ``Esto es lo que dice el Señor Dios: ¡Que una turba las
ataque! Aterrorícenlos y rómpanlos. \bibleverse{47} La turba los
apedreará y los matará con sus espadas, matando a sus hijos e hijas y
quemando sus casas.

\bibleverse{48} Así acabaré con la inmoralidad en el país, y todas las
mujeres serán advertidas de no hacer lo que ustedes han hecho.
\bibleverse{49} Te castigarán por tu inmoralidad, y tendrás que
...
\bibleverse{1} El décimo día del décimo mes del noveno año, me llegó un
mensaje del Señor que decía: \footnote{\textbf{24:1} 2Re 25,1; Jer 52,4}
\bibleverse{2} ``Hijo de hombre, anota la fecha de hoy, porque éste es
el día en que el rey de Babilonia comenzó su asedio a Jerusalén.
\bibleverse{3} Luego repite la siguiente parábola a este pueblo rebelde.
Diles que esto es lo que dice el Señor Dios: ``Coge una olla y ponla al
fuego. Vierte un poco de agua. \bibleverse{4} Llénala con buenos trozos
de carne del muslo y de la paleta. Pon los mejores huesos.
\bibleverse{5} Elige el mejor animal del rebaño. Amontona el combustible
debajo de él. Hazlo hervir y cuece en él los huesos. \bibleverse{6}
...
elijas qué trozo. \bibleverse{7} Porque la sangre que ella derramó está
...
\bibleverse{8} En mi cólera y para castigar, he derramado su sangre
abiertamente sobre la roca desnuda, para que no se cubra. \bibleverse{9}
...
leña. \footnote{\textbf{24:9} Nah 3,1} \bibleverse{10} Pon mucha leña y
enciende el fuego. Asegúrate de que la carne esté bien cocida y añade
especias. Quema los huesos. \bibleverse{11} Luego pon la olla vacía
...
\bibleverse{12} Hasta ahora ha sido imposible limpiarla, ni siquiera el
fuego ha podido quemar toda su herrumbre.

\bibleverse{13} A causa de tu inmoralidad te habías ensuciado y yo traté
...
\bibleverse{14} Yo, el Señor, he hablado. Pronto llegará el momento en
...
\bibleverse{15} Me llegó un mensaje del Señor que decía: \bibleverse{16}
...
lágrima. \footnote{\textbf{24:16} Ezeq 24,18} \bibleverse{17} Llora en
...
\bibleverse{18} Hablé con la gente por la mañana, y mi mujer murió por
la noche. A la mañana siguiente hice lo que me habían dicho.

\bibleverse{19} La gente me preguntó: ``¿Qué haces? ¿No vas a
explicarnos qué significa esto?''

\bibleverse{20} Entonces les dije: ``Me llegó un mensaje del Señor, que
dice: \bibleverse{21} Dile al pueblo de Israel que esto es lo que dice
...
serán muertos por la espada. \bibleverse{22} ``Entonces harás lo mismo
que yo. No te velarás la cara ni comerás el pan que usan los dolientes.
\bibleverse{23} Mantendrán sus turbantes en la cabeza y sus sandalias en
los pies. No se lamenten ni lloren, sino que morirán por dentro a causa
de sus pecados, y gemirán unos con otros. \bibleverse{24} ``Así Ezequiel
...
\bibleverse{25} ``Tú, hijo de hombre, debes saber que cuando yo destruya
...
\bibleverse{26} cuando eso ocurra, alguien que haya logrado escapar
vendrá a darte la noticia. \footnote{\textbf{24:26} Ezeq 33,21}

\bibleverse{27} Ese día podrás hablar; ya no serás mudo. Así serás una
...
\bibleverse{3} Dile a los amonitas que escuchen el mensaje del Señor
...
exilio, \footnote{\textbf{25:3} Ezeq 36,2; Lam 2,16} \bibleverse{4} por
...
beberán tu leche. \bibleverse{5} Haré de Rabá un pasto para camellos, y
de Amón un corral para ovejas. Entonces sabrás que yo soy el Señor.
\bibleverse{6} ``Porque esto es lo que dice el Señor Dios: Como ustedes
aplaudieron y zapatearon en una celebración de odio por lo que le pasó a
Israel, \bibleverse{7} por eso los atacaré y los entregaré para que sean
...
\bibleverse{8} ``Esto es lo que dice el Señor: Porque la gente de Moab y
de Seír dijo: `Miren, la gente de Judá es igual a todos los demás',
\bibleverse{9} por eso abriré la frontera de Moab para que la ataquen,
incluyendo a Bet-Jesimot, Baal-Meón y Quiriatim, las ciudades famosas
del país. \bibleverse{10} Entregaré a Moab a los pueblos del Oriente
para que lo gobiernen, de modo que deje de existir como nación, al igual
que los amonitas. \bibleverse{11} Así es como voy a castigar a los
moabitas, y sabrán que yo soy el Señor.

\bibleverse{12} ``Esto es lo que dice el Señor: Debido a que Edom
cometió graves pecados al vengarse con saña del pueblo de Judá,
\footnote{\textbf{25:12} Jer 49,7-22; Abd 1,-1; Sal 137,7}
\bibleverse{13} por eso el Señor Dios dice: Voy a llegar a atacar a Edom
...
\bibleverse{14} Me vengaré de los edomitas por medio de mi pueblo
...
\bibleverse{15} ``Esto es lo que dice el Señor Dios: Porque los
filisteos en su odio se vengaron repetidamente de Judá, tratando de
destruir al pueblo, \bibleverse{16} por eso dice el Señor Dios:
...
\bibleverse{17} Mi venganza contra ellos será severa cuando los castigue
...
\bibleverse{1} El primer día del mes\footnote{\textbf{26:1} Al parecer,
  falta un número en el texto.} del undécimo año, vino a mí un mensaje
del Señor que decía: \bibleverse{2} ``Hijo de hombre, porque Tiro dijo
...
destruida, seré rico', \bibleverse{3} por eso el Señor Dios dice:
...
atacarte, como el mar que lanza sus olas contra la orilla. \footnote{\textbf{26:3}
  Is 23,-1} \bibleverse{4} Destruirán los muros de Tiro y derribarán sus
torres. Rasparé la tierra que hay sobre ella y la convertiré en una roca
desnuda. \bibleverse{5} En el mar será sólo un lugar para que los
pescadores extiendan sus redes. Yo he hablado, declara el Señor Dios.
Otras naciones vendrán a saquearla, \bibleverse{6} y los habitantes de
...
\bibleverse{7} ``Porque esto es lo que dice el Señor Dios: Mira cómo
...
\bibleverse{8} Matará a espada a la gente que vive en tus pueblos de
...
\bibleverse{9} Hará que sus arietes destrocen tus murallas y utilizará
sus herramientas para demoler tus torres. \bibleverse{10} Tendrá tantos
...
carros y de las carrozas. \bibleverse{11} Sus caballos correrán por las
calles de tu ciudad. Matará a toda tu gente con la espada. Tus enormes
pilares caerán al suelo. \bibleverse{12} Robarán tus riquezas y
...
\bibleverse{13} ``Así es como voy a poner fin a tu canto. Ya no se
escuchará la música de tus arpas. \bibleverse{14} Te convertiré en una
...
\bibleverse{15} ``Esto es lo que dice el Señor Dios a los habitantes de
...
dentro de tu ciudad? \bibleverse{16} ``Todos los gobernantes de las
...
te ha sucedido. \bibleverse{17} Entonces cantarán una canción fúnebre
...
\bibleverse{18} Ahora los pueblos de las costas tiemblan ante tu
...
\bibleverse{19} ``Porque esto es lo que dice el Señor Dios: Te
convertiré en una ruina como las demás ciudades deshabitadas. Haré que
el mar se levante para cubrirte con aguas profundas. \bibleverse{20} Te
...
en ti y no tendrás lugar en la tierra de los vivos. \bibleverse{21} Te
...
``Hijo de hombre, canta un canto fúnebre para Tiro. \footnote{\textbf{27:2}
  Is 23,-1} \bibleverse{3} Dile a Tiro, la ciudad que está a la puerta
...
soy!' \footnote{\textbf{27:3} Os 9,13} \bibleverse{4} Tus fronteras se
extienden a lo largo del mar. Tus constructores te armaron perfectamente
como un hermoso barco. \bibleverse{5} Te construyeron con madera de pino
del monte Hermón.\footnote{\textbf{27:5} ``Hermón'', literalmente,
  ``Senir'', otro nombre para esta montaña.} Usaron un cedro del Líbano
para hacer tu mástil. \footnote{\textbf{27:5} Deut 3,8-9} \bibleverse{6}
...
\bibleverse{7} Hicieron tu vela con el mejor lino de Egipto; ésta fue tu
bandera que todos reconocieron. Con telas teñidas de azul y púrpura de
las costas de Elisa hicieron tus toldos. \bibleverse{8} ``Los hombres de
Sidón y Arvad remaban en tu barco. Tenías tus propios marineros expertos
de Tiro. \bibleverse{9} Expertos artesanos de Gebal estaban a bordo para
...
\footnote{\textbf{27:9} 1Re 5,32} \bibleverse{10} Hombres de Persia,
Lidia y Put eran soldados en tu ejército. Vivían entre ustedes, colgando
sus escudos y cascos con ustedes, y se hacían famosos. \bibleverse{11}
...
\bibleverse{12} Tarsis comerciaba contigo porque tenías mucho de todo.
Pagaban tus mercancías con plata, hierro, estaño y plomo.

\bibleverse{13} Grecia,\footnote{\textbf{27:13} ``Grecia'':
  literalmente, ``Javan''.} Tubal y Mesec comerciaron contigo. Compraron
tus bienes, pagando con esclavos y objetos de bronce.

\bibleverse{14} La gente de Bet-togarmá intercambió caballos, caballos
de guerra y mulas por tus bienes.

\bibleverse{15} La gente de Dedánhacía negocios comerciales con ustedes.
...
\bibleverse{16} Los arameos comerciaban con ustedes porque tenían muchas
...
\bibleverse{17} Judá y el país de Israel comerciaron contigo, pagándote
...
\bibleverse{18} Como tenías muchos productos de toda clase, de hecho,
tenías abundancia de todo, Damasco comerciaba contigo usando vino de
Helbón, lana de Zahar.

\bibleverse{19} Vedan y Javan, de Izal, compraron tus productos
utilizando hierro forjado, casia y cálamo dulce.

\bibleverse{20} Dedán comerciaba contigo, dándote mantas para monturas.

\bibleverse{21} Arabia y todos los jefes de Cedar comerciaron contigo,
dándote a cambio corderos, carneros y cabras. \footnote{\textbf{27:21}
  Gén 25,13}

\bibleverse{22} Los mercaderes de Sabá y de Raama comerciaron contigo,
cambiando oro, las mejores especias y piedras preciosas por tus
productos.

\bibleverse{23} Harán, Cane y Edén comerciaban contigo, al igual que
Saba, Asur y Quilmad. \bibleverse{24} En tus plazas de mercado
...
cuerdas de hilos retorcidos. \bibleverse{25} ``Los barcos comerciales de
...
\bibleverse{26} Tus remeros te llevaron muy lejos en el agua, pero el
viento del este te destrozó allí en alta mar. \bibleverse{27} ¡Lo
...
profundidades del mar el día de tu naufragio. \bibleverse{28} La tierra
de alrededor tiembla cuando tus marineros gritan. \bibleverse{29} Todos
los remeros abandonan sus barcos. Los marineros y todos los oficiales de
los barcos se paran en la orilla. \bibleverse{30} Gritan por ti y rompen
a llorar. Lloran por ti echando polvo sobre sus cabezas y revolcándose
en las cenizas. \bibleverse{31} Se afeitan la cabeza por ti y se visten
de cilicio. Lloran por ti, gritando en agonía y en duelo sincero
\bibleverse{32} Mientras lloran y se lamentan por ti, cantan un canto
fúnebre por ti: `¿Quién podría compararse con Tiro, ahora destruida en
el mar? \bibleverse{33} Hiciste feliz a mucha gente cuando recibieron
tus bienes desde el otro lado del mar. Hiciste ricos a los reyes de la
tierra con todos tus bienes y productos valiosos. \bibleverse{34} Ahora
has naufragado en el mar, te has hundido en aguas profundas, y tu carga
y tu gente se han hundido contigo. \bibleverse{35} Todos los que viven
en las costas están consternados por lo que te ha sucedido. Sus reyes
están horrorizados; sus rostros se tuercen de miedo. \bibleverse{36} Los
...
hombre. No eres un dios, aunque te creas uno. \footnote{\textbf{28:2}
  Dan 5,20; Hech 12,23} \bibleverse{3} ¡Incluso te crees más sabio que
Daniel y no hay secreto que se te oculte! \footnote{\textbf{28:3} Ezeq
  14,14} \bibleverse{4} Sí, has utilizado tu sabiduría y tu astucia para
hacerte rico, recogiendo mucho oro y plata para tu tesoro.
\bibleverse{5} Te hiciste rico gracias a tus magníficas habilidades
comerciales, pero tu riqueza no hizo más que enorgullecerte.

\bibleverse{6} ``Así que esto es lo que dice el Señor Dios: Como te
crees un dios, \bibleverse{7} mira cómo traigo extranjeros para que te
...
orgullosa gloria. \bibleverse{8} Te arrastrarán a la tumba. Morirás
horriblemente en el mar. \footnote{\textbf{28:8} Ezeq 26,20}
\bibleverse{9} ¿Seguirás afirmando que eres un dios ante los que te
están matando? Sólo serás otra víctima humana, no un dios, a los ojos de
tus atacantes. \footnote{\textbf{28:9} Ezeq 28,2} \bibleverse{10} Te
...
\bibleverse{11} Otro mensaje del Señor me llegó, diciendo:
\bibleverse{12} ``Hijo de hombre, canta un canto fúnebre para el rey de
...
\bibleverse{13} Estabas en el Edén, el jardín de Dios. Llevabas toda
...
\bibleverse{14} Te di la posición de querubín guardián y te ungí. Vivías
en el monte santo de Dios y caminabas entre las piedras de fuego.
\bibleverse{15} Fuiste inocente en todo lo que hiciste desde el día en
que fuiste creado hasta que se descubrió que hacías el mal.
\bibleverse{16} Estabas tan ocupado con todos tus planes comerciales que
...
de fuego. \bibleverse{17} Te enorgulleciste a causa de tu belleza,
...
\bibleverse{18} Con todos tus pecados y tu comercio deshonesto has
...
allí miraban. \bibleverse{19} Todos los que te conocen entre las
...
\bibleverse{20} Me llegó un mensaje del Señor que decía: \bibleverse{21}
``Hijo de hombre, mira hacia Sidón y profetiza contra ella.
\bibleverse{22} Diles que esto es lo que dice el Señor: Cuidado, Sidón,
...
\bibleverse{23} Voy a enviar una enfermedad para que la azote, y haré
...
\bibleverse{24} El pueblo de Israel ya no tendrá que soportar a esta
...
\bibleverse{25} ``Esto es lo que dice el Señor Dios: Cuando haga volver
...
\bibleverse{26} Allí vivirán con seguridad, construyendo casas y
...
\bibleverse{1} El duodécimo día del décimo mes del décimo año, me llegó
un mensaje del Señor que decía: \bibleverse{2} ``Hijo de hombre, ponte
...
\footnote{\textbf{29:3} Ezeq 32,2} \bibleverse{4} Voy a poner anzuelos
...
escamas. \footnote{\textbf{29:4} Ezeq 38,4; 2Re 19,28} \bibleverse{5} Te
...
\bibleverse{6} Entonces todos en Egipto sabrán que yo soy el Señor.
...
\bibleverse{7} Cuando Israel se agarró a ti, te partiste, dañando su
...
\bibleverse{8} Así que esto es lo que dice el Señor Dios: Te atacaré con
una espada y mataré tanto a las personas como a los animales.
\bibleverse{9} Egipto se convertirá en un páramo vacío. Entonces sabrán
que yo soy el Señor. ``Porque dijiste: `El Nilo me pertenece; yo lo
hice',

\bibleverse{10} por eso te condeno a ti y a tu río. Arruinaré a Egipto,
...
Asuán, en el sur, y hasta la frontera con Cus.\footnote{\textbf{29:10}
  ...
  Nubia, y hoy en día como Sudán.} \bibleverse{11} Nadie, ni humano ni
animal, viajará por ese camino ni vivirá allí durante cuarenta años.
\bibleverse{12} ``Convertiré a Egipto en un páramo más que cualquier
...
\bibleverse{13} ``Sin embargo, esto es lo que dice el Señor Dios:
Después de cuarenta años reuniré a los egipcios de los diferentes países
donde fueron dispersados. \bibleverse{14} Sacaré a Egipto del cautiverio
y los llevaré de vuelta a la tierra de Patros, de donde vinieron
originalmente. Su reino será insignificante. \bibleverse{15} ``Egipto
...
sobre las naciones. \bibleverse{16} El pueblo de Israel no volverá a
...
\bibleverse{17} El primer día del primer mes del año veintisiete, me
llegó un mensaje del Señor que decía: \bibleverse{18} ``Hijo de hombre,
...
al atacarla. \bibleverse{19} ``Así que esto es lo que dice el Señor
...
su ejército. \bibleverse{20} Le voy a recompensar por todo su trabajo
dándole Egipto porque el trabajo que hicieron fue para mí, declara el
Señor Dios.

\bibleverse{21} ``En ese momento le devolveré el poder\footnote{\textbf{29:21}
...
\bibleverse{1} Me llegó otro mensaje del Señor, diciendo: \bibleverse{2}
``Hijo de hombre, profetiza y anuncia que esto es lo que dice el Señor
Dios: ¡Llora! ¡Este es un día terrible! \bibleverse{3} Pronto llegará el
...
\bibleverse{4} Una espada vendrá a atacar a Egipto, y habrá angustia en
...
\bibleverse{5} Cus, Put y Lud, y muchos otros pueblos, así como Arabia,
...
\bibleverse{6} Esto es lo que dice el Señor: Los aliados de Egipto
...
Dios. \bibleverse{7} Egipto se convertirá en un páramo más que cualquier
otro país, y sus ciudades quedarán en ruinas. \bibleverse{8} Entonces
reconocerán que yo soy el Señor cuando prenda fuego a Egipto y todos sus
aliados sean aplastados.

\bibleverse{9} ``En ese momento enviaré mensajeros en barcos para
...
\bibleverse{10} Esto es lo que dice el Señor Dios: Usaré a
Nabucodonosor, rey de Babilonia, para quitarle a Egipto sus riquezas.
\bibleverse{11} Él y su ejército de la nación más cruel del mundo serán
traídos para destruir el país. Usarán sus espadas para atacar a Egipto,
y llenarán la tierra de cadáveres. \bibleverse{12} Secaré los ríos y
...
\bibleverse{13} ``Esto es lo que dice el Señor Dios: Voy a destruir los
ídolos y a deshacerme de las imágenes en Menfis. Ya no habrá príncipe en
Egipto, y haré que todos en el país se aterroricen. \bibleverse{14}
Destruiré Patros, incendiaré Zoán y castigaré a Tebas. \bibleverse{15}
Derramaré mi ira sobre Pelusio, la ciudad fortaleza de Egipto, y
aniquilaré al ejército de Tebas. \bibleverse{16} Prenderé fuego a
Egipto, Pelusio sufrirá, Tebas será destrozada y Menfis tendrá problemas
todos los días. \bibleverse{17} Los jóvenes soldados de Heliópolis y
Bubastis\footnote{\textbf{30:17} ``Heliópolis y Bubastis'':
  literalmente, ``On y Pi-beseth''.} caerán a espada, y la gente de esas
ciudades será llevada cautiva. \bibleverse{18} Será un día oscuro en
...
\bibleverse{19} Así es como voy a castigar a Egipto, y reconocerán que
yo soy el Señor''.
...
\bibleverse{20} El séptimo día del primer mes del undécimo año, me llegó
un mensaje del Señor que decía: \bibleverse{21} ``Hijo de hombre, he
...
espada. \bibleverse{23} Dispersaré a los egipcios entre las diferentes
naciones y países. \bibleverse{24} ``Haré fuertes los brazos del rey de
...
\bibleverse{25} Haré fuertes los brazos del rey de Babilonia, pero los
...
rey de Babilonia y él la use para atacar a Egipto. \bibleverse{26}
...
\bibleverse{1} El primer día del tercer mes del undécimo año,\footnote{\textbf{31:1}
  Desde el comienzo del exilio del rey Joaquín.} me llegó un mensaje del
Señor, que decía: \bibleverse{2} ``Hijo de hombre, dile al Faraón, rey
de Egipto, y a todo su numeroso pueblo: ``¿Quién es tan grande como tú?
\bibleverse{3} Mira a Asiria. Era como un cedro en el Líbano, con sus
hermosas ramas dando sombra en el bosque. Era tan alta que su cima
alcanzaba las nubes. \bibleverse{4} Las fuentes de agua profundas lo
hacían crecer en altura y enviaban arroyos a su alrededor para regar
todos los demás árboles. \bibleverse{5} Llegó a ser muy alto, más que
cualquier otro árbol del bosque. Sus ramas crecían gruesas y largas
porque estaba muy bien regado. \bibleverse{6} En sus ramas anidaban toda
...
\bibleverse{7} Era hermoso y majestuoso con sus largas ramas, porque sus
raíces llegaban hasta las abundantes aguas. \bibleverse{8} Los cedros
...
era tan hermoso. \bibleverse{9} Yo lo hice hermoso con sus muchas ramas.
...
\bibleverse{10} ``Esto es lo que dice el Señor: Como llegó a ser tan
alto, llegando hasta las nubes, se enorgulleció a causa de su altura.
\footnote{\textbf{31:10} Ezeq 28,2-10} \bibleverse{11} Por eso lo
entregué al jefe de una nación extranjera que lo castigará por su
maldad. La he expulsado. \bibleverse{12} ``Extranjeros de la más cruel
...
de su sombra y lo abandonaron. \bibleverse{13} Los pájaros vinieron a
vivir en su tronco caído, y los animales salvajes se escondieron entre
sus ramas caídas. \bibleverse{14} ``Esto fue para que ningún otro árbol
...
y todos los árboles del bosque se marchitaron. \bibleverse{16} Hice
...
\bibleverse{17} También bajaron con él al Seol, a los que habían sido
muertos por la espada. Habían formado parte de su ejército viviendo a su
sombra entre las naciones.

\bibleverse{18} ``¿Quién es tan grande y glorioso como tú entre los
...
\bibleverse{1} El primer día del duodécimo mes del duodécimo año, me
llegó un mensaje del Señor que decía: \bibleverse{2} ``Hijo de hombre,
...
\bibleverse{3} Esto es lo que dice el Señor Dios: En presencia de muchas
naciones voy a tender mi red sobre ti, y te arrastrarán en mi red.
\footnote{\textbf{32:3} Ezeq 17,20} \bibleverse{4} Te dejaré caer sobre
...
salvajes te coman hasta quedar satisfechos. \bibleverse{5} Arrojaré tu
carne sobre las montañas y llenaré los valles con tus restos.
\bibleverse{6} Llenaré la tierra con tu sangre que fluye, derramándola
sobre las montañas, llenando los valles. \bibleverse{7} Cuando apague la
...
nube para cubrir el sol, y la luna dejará de brillar. \footnote{\textbf{32:7}
  Is 13,10} \bibleverse{8} Oscureceré todas las luces brillantes de los
cielos sobre ti, y haré que tu tierra se oscurezca, declara el Señor
Dios. \bibleverse{9} Cuando te destruya, haré que mucha gente se asuste,
incluso en países de los que no sabes nada. \bibleverse{10} Muchos se
...
\bibleverse{11} ``Porque esto es lo que dice el Señor Dios: ¡La espada
del rey de Babilonia te atacará! \bibleverse{12} Permitiré que tu
...
\bibleverse{13} Mataré a todo tu ganado que vive junto a los anchos
ríos. Nadie estará allí para agitar los ríos con sus pies; las pezuñas
del ganado no los enturbiarán. \bibleverse{14} Dejaré que sus aguas se
asienten y haré que sus ríos fluyan suavemente como el aceite, declara
el Señor Dios. \bibleverse{15} Cuando convierta a Egipto en un páramo,
vaciándolo por completo, cuando mate a todos los que viven allí,
entonces reconocerán que yo soy el Señor.

\bibleverse{16} Este es el canto fúnebre que cantarán las mujeres
...
\bibleverse{17} El decimoquinto día del duodécimo mes del duodécimo año,
me llegó un mensaje del Señor que decía: \bibleverse{18} ``Hijo de
...
\bibleverse{19} ¿Te crees más bella que nadie? ¡Bajen y ocupen su lugar
en la tumba con los paganos! \footnote{\textbf{32:19} Is 14,11-19}
\bibleverse{20} Yacerán entre los muertos por la espada. La espada está
lista para matar a todo el numeroso pueblo de Egipto. \footnote{\textbf{32:20}
  Ezeq 21,14} \bibleverse{21} Poderosos jefes hablarán desde el Seol
...
\bibleverse{22} ``Asiria está allí con toda su gente: está rodeada de
tumbas. Todos ellos murieron de forma violenta, asesinados por la
espada. \bibleverse{23} Sus tumbas están colocadas en lo más profundo
...
\bibleverse{24} ``Elam está allí con toda su gente alrededor de su
...
descienden a la tumba. \bibleverse{25} Se ha preparado un lugar de
...
\bibleverse{26} ``Mesec y Tubal están allí con toda su gente, rodeados
...
\footnote{\textbf{32:26} Ezeq 38,2} \bibleverse{27} Pero no están
...
\bibleverse{28} Sin embargo, tú también serás cortado y puesto a
descansar con los paganos, con los muertos por la espada.

\bibleverse{29} ``Allí está Edom con todos sus reyes y príncipes. En
...
\bibleverse{30} También están allí todos los jefes del norte y todo el
...
\bibleverse{31} ``El Faraón los verá y se alegrará de que él y toda su
numerosa gente no sean los únicos muertos por la espada, declara el
Señor Dios. \footnote{\textbf{32:31} Is 14,10}

\bibleverse{32} Porque yo aterrorizaré a los que están vivos para que el
...
su centinela. \bibleverse{3} Cuando viera que el ejército avanzaba para
atacar el país, tocaría la trompeta para avisar a todos. \bibleverse{4}
...
\bibleverse{5} Como oíste la trompeta pero no prestaste atención a la
...
\bibleverse{6} ``Pero si el vigilante vio venir el ataque y no tocó la
...
\bibleverse{7} ``Hijo de hombre, te he designado como vigilante del
pueblo de Israel. Escucha lo que te digo y adviérteles de mi parte.
\footnote{\textbf{33:7} Ezeq 3,17-19; Is 56,10; Heb 13,17}
\bibleverse{8} Si les digo a los malvados: `Son malvados, van a morir',
pero no les adviertes que cambien lo que hacen, entonces morirán en sus
pecados y te haré responsable de sus muertes. \bibleverse{9} Pero si les
...
\bibleverse{10} ``Hijo de hombre, dile al pueblo de Israel que esto es
...
\bibleverse{11} ``Diles: En mi vida, declara el Señor Dios, no me
...
\bibleverse{12} ``Por eso, hijo de hombre, dile a tu pueblo: Todas las
...
no vivirán si empiezan a pecar. \footnote{\textbf{33:12} Ezeq 3,20; Ezeq
  18,24} \bibleverse{13} ``Si le digo a una persona buena que vivirá y
...
\bibleverse{14} ``Pero si le digo a una persona mala: `Vas a morir' y
deja de pecar y hace lo que es bueno y correcto, \bibleverse{15} si
...
no morirá. \bibleverse{16} No se recordará ninguno de sus pecados; han
hecho lo que es bueno y correcto y por eso vivirán.

\bibleverse{17} ``Sin embargo, tu pueblo se queja: `Lo que hace el Señor
no está bien'. Pero es lo que ellos hacen lo que no está bien.
\footnote{\textbf{33:17} Ezeq 18,25-30} \bibleverse{18} Si una persona
buena deja de hacer el bien y peca, morirá por ello. \bibleverse{19} En
cambio, si una persona mala se aparta de sus pecados y hace lo que es
bueno y correcto, vivirá por ello. \bibleverse{20} ``Entonces, ¿cómo
...
\bibleverse{21} El quinto día del décimo mes del duodécimo año de
nuestro exilio, llegó un refugiado que había escapado de Jerusalén y me
dijo: ``¡La ciudad ha sido capturada!'' \bibleverse{22} La noche
...
\bibleverse{23} Me llegó un mensaje del Señor que decía: \bibleverse{24}
...
\footnote{\textbf{33:24} Is 51,2; Mal 2,15} \bibleverse{25} ``Así que
...
¿Creen realmente que el país debe pertenecerles? \bibleverse{26}
...
\bibleverse{27} ``Diles que esto es lo que dice el Señor Dios: Mientras
...
enfermedad. \bibleverse{28} Convertiré el país en un páramo, y se
...
\bibleverse{29} Entonces el pueblo reconocerá que yo soy el Señor,
...
\bibleverse{30} ``Hijo de hombre, tu pueblo habla de ti en las calles y
en las puertas de sus casas. Se animan unos a otros, diciendo: `¡Vamos!
Vamos a escuchar un mensaje del Señor'. \bibleverse{31} ``Así que mi
...
amor, sólo piensan en cómo engañar a los demás. \bibleverse{32} De
...
\bibleverse{33} Así que cuando suceda lo que dices (y sucederá),
...
rebaño? \bibleverse{3} Ustedes se comen la crema, usan la lana para
vestirse y sacrifican las ovejas cebadas, pero no alimentan al rebaño.
\bibleverse{4} ``No cuidas a los débiles, ni curas a los enfermos, ni
...
\footnote{\textbf{34:4} Zac 11,16; 1Pe 5,3} \bibleverse{5} Se
...
de todos los animales salvajes para alimentarse. \footnote{\textbf{34:5}
  Mat 9,36} \bibleverse{6} Mis ovejas se dispersaron, yendo a todas las
montañas y colinas altas. Se dispersaron por todas partes, y no había
nadie que fuera a buscarlas.

\bibleverse{7} ``Así que, pastores, escuchen lo que el Señor tiene que
decir: \bibleverse{8} Vivo yo, declara el Señor Dios, porque mis ovejas
...
\bibleverse{9} así que, pastores, escuchen lo que el Señor tiene que
decir. \bibleverse{10} ``Esto es lo que dice el Señor: Cuidado, porque
...
\bibleverse{11} ``Porque esto es lo que dice el Señor Dios: Mira que yo
mismo iré en busca de mis ovejas, buscando para encontrarlas.
\bibleverse{12} Así como un pastor va en busca de su oveja perdida
...
lúgubre. \bibleverse{13} Las sacaré de entre las demás naciones. Las
...
en todos los lugares donde haya gente en el país. \bibleverse{14} Les
...
lugares para pastar en las montañas de Israel. \footnote{\textbf{34:14}
  Sal 23,2} \bibleverse{15} ``Yo mismo cuidaré de mis ovejas y les daré
un lugar de descanso, declara el Señor Dios. \bibleverse{16} Iré en
...
\bibleverse{17} ``Rebaño mío, esto es lo que el Señor Dios les dice:
Estén vigilantes, porque yo juzgaré entre una oveja y otra, entre los
corderos y las cabras. \bibleverse{18} ¿Acaso no se conformaron con
...
ensuciar lo que queda con sus pies? \bibleverse{19} ¿Por qué mi rebaño
tiene que alimentarse de lo que sus pies han pisoteado, y beber el agua
que sus pies han enturbiado?

\bibleverse{20} ``Por eso el Señor Dios les dice: Vigilen, porque yo
mismo juzgaré entre las ovejas gordas y las flacas. \bibleverse{21} Así
...
\bibleverse{22} yo rescataré a mi rebaño, y ya no serán sus víctimas. Yo
...
\bibleverse{23} Pondré a un solo pastor a cargo de ellas, mi siervo
David, y él las cuidará. Él las cuidará y será su pastor. \footnote{\textbf{34:23}
  Ezeq 37,24; Juan 10,12-16; Jer 30,9; Os 3,5} \bibleverse{24} Yo, el
Señor, seré su Dios, y mi siervo David será su jefe. Yo, el Señor, he
hablado.

\bibleverse{25} ``Haré un acuerdo de paz con ellos y eliminaré los
animales salvajes del país, para que puedan vivir seguros en el desierto
y dormir seguros en el bosque. \bibleverse{26} Los bendeciré a ellos y a
todos los alrededores de mi colina. Enviaré la lluvia en el momento
oportuno. Serán lluvias de bendición. \bibleverse{27} Los árboles de los
...
hicieron esclavos. \bibleverse{28} ``Ya no serán víctimas de otras
naciones, y los animales salvajes no los comerán. Vivirán con seguridad,
y nadie los aterrorizará. \bibleverse{29} ``Haré que sus campos
...
país ni serán objeto de burla por parte de otros. \footnote{\textbf{34:29}
  Ezeq 36,30} \bibleverse{30} Entonces sabrán que yo estoy con ellos
como el Señor su Dios, y que el pueblo de Israel me pertenece, declara
el Señor Dios. \footnote{\textbf{34:30} Ezeq 11,20} \bibleverse{31}
...
\bibleverse{3} Anuncia que esto es lo que dice el Señor Dios: Ten
cuidado, porque te voy a condenar, monte Seir. Voy a atacarte y a
convertirte en un páramo. \bibleverse{4} Arruinaré tus ciudades;
...
\bibleverse{6} Así que mientras yo viva, declara el Señor Dios, dejaré
...
\footnote{\textbf{35:6} Apoc 16,5-6} \bibleverse{7} ``Convertiré el
monte Seir en un páramo en ruinas. Aniquilaré a cualquiera que se vaya o
que intente regresar. \bibleverse{8} Llenaré sus montañas de muertos.
Los muertos por la espada caerán en sus colinas, valles y todos sus
barrancos. \bibleverse{9} Te arruinaré para siempre. Tus ciudades no
volverán a ser habitadas. Entonces reconocerás que yo soy el Señor.

\bibleverse{10} ``Porque dijisteis: `Estas dos naciones y sus tierras
...
Señor estaba allí con ellos', \bibleverse{11} entonces en vida, declara
...
castigando por la forma en que los trataste. \bibleverse{12} ``También
...
tomarlas!' \bibleverse{13} Hiciste muchos alardes atacándome; tenías
mucho que decir contra mí. ¡Yo lo escuché por mí mismo! \bibleverse{14}
``Esto es lo que dice el Señor Dios: Te destruiré como celebran todos
los demás en el mundo. \bibleverse{15} Así como ustedes celebraron
...
\bibleverse{1} ``Y tú, hijo de hombre, profetiza a los montes de Israel
y di: Montañas de Israel, escuchad este mensaje del Señor. \footnote{\textbf{36:1}
  Ezeq 6,2} \bibleverse{2} Esto es lo que dice el Señor: El enemigo ha
dicho de ti: `¡Ah! Estos antiguos lugares altos nos pertenecen ahora',
\footnote{\textbf{36:2} Ezeq 25,3} \bibleverse{3} así que debes
...
sobre ti y te calumnió. \bibleverse{4} Así que ahora, montañas de
...
naciones que os rodean han saqueado y escarnecido. \bibleverse{5} Sí,
...
tierra y me trataban con total desprecio. \footnote{\textbf{36:5} Ezeq
  35,15} \bibleverse{6} ``Así que profetizad sobre el país de Israel y
...
naciones. \bibleverse{7} ``Esto es lo que dice el Señor Dios: Levanto mi
...
\bibleverse{8} Pero ustedes, montes de Israel, harán crecer árboles que
producirán frutos para mi pueblo Israel, pues pronto volverán a casa.
\bibleverse{9} ``Mira, yo estoy a tu favor y te ayudaré. Tu tierra será
arada y se sembrarán cosechas. \bibleverse{10} Tú apoyarás al pueblo de
Israel cuando regrese y crezca en número. La gente volverá a vivir en
las ciudades y reconstruirá las ruinas. \bibleverse{11} El número de tu
...
\bibleverse{12} ``Haré que mi pueblo Israel camine sobre tus montañas.
...
\bibleverse{13} ``Esto es lo que dice el Señor Dios: Porque la gente te
dice: `Te comes a la gente y le robas a tu nación sus hijos',
\bibleverse{14} a partir de ahora no te comerás a la gente ni le robarás
a tu nación sus hijos, declara el Señor Dios. \bibleverse{15} Voy a
...
\bibleverse{16} Me llegó otro mensaje del Señor, que decía:
\bibleverse{17} ``Hijo de hombre, cuando el pueblo de Israel vivía en su
...
ceremonial del período de una mujer. \footnote{\textbf{36:17} Lev 18,25;
  Lev 18,28} \bibleverse{18} Así que me enojé con ellos por los
asesinatos que cometieron en el país, y porque lo ensuciaron al adorar a
los ídolos. \bibleverse{19} Los dispersé entre las diferentes naciones y
países. Los juzgué según la forma en que se habían comportado y lo que
habían hecho. \bibleverse{20} Pero dondequiera que iban entre las
...
\bibleverse{21} Así que tuve que cuidar mi reputación de santidad que el
pueblo de Israel había arruinado entre las naciones a las que habían
ido. \footnote{\textbf{36:21} Ezeq 20,9}

\bibleverse{22} ``Díganle al pueblo de Israel que esto es lo que dice el
...
fueron. \footnote{\textbf{36:22} Sal 115,1; Jer 14,7} \bibleverse{23}
...
\bibleverse{24} ``Porque te haré volver de entre las naciones,
reuniéndote de todos los países diferentes, y te conduciré de nuevo a tu
propio país. \bibleverse{25} También derramaré sobre ti agua pura, y
quedarás limpio. Te lavaré de toda tu impureza y de todos tus ídolos.
\bibleverse{26} Te daré una mente nueva y pondré un espíritu nuevo
dentro de ti. Les quitaré su mente obstinada y les daré una mente
amorosa. \footnote{\textbf{36:26} Ezeq 11,19} \bibleverse{27} Pondré mi
...
hacer lo que les digo. \footnote{\textbf{36:27} Ezeq 37,24; Ezeq 39,29;
  Is 44,3} \bibleverse{28} ``Entonces vivirán en el país que les di a
sus antepasados. Ustedes serán mi pueblo, y yo seré su Dios. \footnote{\textbf{36:28}
  Ezeq 11,20} \bibleverse{29} Te salvaré de todo lo que te hace impuro.
Me aseguraré de que tengas mucho grano. No te enviaré ninguna hambruna.
\bibleverse{30} También me aseguraré de que tengas buenas cosechas en
tus huertos y campos, para que no te burlen más las otras naciones a
causa del hambre.

\bibleverse{31} ``Entonces se acordarán de sus malos caminos y de las
...
\bibleverse{32} Deben saber cuenta que no hago esto por ustedes, declara
...
\bibleverse{33} ``Esto es lo que dice el Señor Dios: El día en que los
limpie de todos sus pecados, haré que vuelvan a vivir en sus ciudades y
me aseguraré de que las ruinas sean reconstruidas. \bibleverse{34} La
tierra que estaba desierta volverá a ser cultivada en lugar de parecer
abandonada a los ojos de todos los que pasen. \bibleverse{35} Entonces
...
\bibleverse{36} ``Entonces las naciones que queden a tu alrededor
...
\bibleverse{37} ``Esto es lo que dice el Señor: Volveré a responder a
...
\bibleverse{38} Al igual que todos los rebaños que son llevados a
...
\bibleverse{1} El Señor me recogió y me llevó con su Espíritu. Me puso
en medio de un valle que estaba lleno de huesos. \bibleverse{2} Me
condujo alrededor de ellos, y en todas las direcciones vi muchísimos
huesos en el fondo del valle. Estaban muy secos. \bibleverse{3} Entonces
me preguntó: ``Hijo de hombre, ¿pueden estos huesos volver a la vida?''
. ``Señor Dios, sólo tú sabes la respuesta'', le contesté.

\bibleverse{4} Me dijo: ``Profetiza a estos huesos y diles: ¡Huesos
secos, escuchad este mensaje del Señor! \bibleverse{5} Esto es lo que el
Señor Dios dice a estos huesos: Soplaré aire en ustedes y volverán a la
vida. \footnote{\textbf{37:5} Sal 104,30} \bibleverse{6} Les daré
...
\bibleverse{7} Así que profeticé tal como se me había ordenado. Cuando
empecé a profetizar, de repente oí un ruido seco. Los huesos se unieron,
hueso pegado a hueso. \footnote{\textbf{37:7} Ezeq 37,10} \bibleverse{8}
Mientras miraba, vi que les crecían tendones y carne, y que la piel los
cubría; pero los cuerpos no respiraban.

\bibleverse{9} Entonces me dijo: ``¡Anuncia al aliento! Profetiza, hijo
...
\bibleverse{10} Así que profeticé tal como me había ordenado, y el
...
\bibleverse{11} Me dijo: ``Hijo de hombre, estos huesos representan a
...
aniquilados'. \bibleverse{12} ``Así que profetiza y diles que esto es lo
que dice el Señor Dios: Pueblo mío, voy a abrir tus tumbas y te sacaré
de ellas, y te llevaré de vuelta al país de Israel. \bibleverse{13}
Entonces sabrán que yo soy el Señor, cuando abra sus tumbas y los saque
de ellas, pueblo mío. \bibleverse{14} Pondré mi Espíritu en ustedes y
...
\bibleverse{15} Otro mensaje del Señor me llegó, diciendo:
\bibleverse{16} ``Hijo de hombre, toma un pedazo de madera y escribe en
...
a ellos'. \bibleverse{17} Luego une los dos trozos de madera en uno
...
\bibleverse{18} ``Cuando tu pueblo venga y te pregunte: `¿Vas a explicar
de qué se trata todo esto?' \bibleverse{19} Diles que esto es lo que
...
y serán como uno solo en mi mano. \bibleverse{20} ``Cuando tengas en tus
manos los trozos de madera en los que has escrito, y mientras todos te
miran, \bibleverse{21} diles que esto es lo que dice el Señor Dios: Voy
...
\footnote{\textbf{37:21} Ezeq 36,24} \bibleverse{22} Haré de ellos una
...
\bibleverse{23} ``Ya no se contaminarán con sus ídolos o imágenes
...
\bibleverse{27} Mi tabernáculo estará con ellos. Yo seré su Dios, y
ellos serán mi pueblo. \bibleverse{28} Las naciones reconocerán que yo
...
Tubal. Profetiza contra él \footnote{\textbf{38:2} Ezeq 39,1; Apoc 20,8;
  Ezeq 32,26} \bibleverse{3} y declara que esto es lo que dice el Señor
Dios: Cuidado, te estoy condenando, Gog, jefe de Mesec y Tubal.
\bibleverse{4} Te enviaré en otra dirección, pondré garfios en tus
...
pequeños y rodelas, todos blandiendo sus espadas. \bibleverse{5} Se
unirán a ellos soldados de Persia, Cus y Put, todos equipados con
escudos y cascos, \bibleverse{6} junto con Gomer y todos sus ejércitos,
...
\bibleverse{7} ``¡Prepárate! Asegúrate de que tú y todo tu ejército
contigo estén preparados. Tú eres el que está a cargo de ellos.
\bibleverse{8} Mucho tiempo después serás llamado a la batalla. En los
...
\bibleverse{9} Tú y todo tu ejército, y los ejércitos de muchas naciones
...
\bibleverse{10} ``Esto es lo que dice el Señor Dios: En ese día
empezarás a pensar en cosas en tu mente, y se te ocurrirá un plan
malvado. \bibleverse{11} Te dirás a ti mismo: `Voy a atacar un país de
...
\bibleverse{12} Podré saquearlos, les robaré sus posesiones. Atacaré los
...
tiene ganado y posesiones, que vive en el centro\footnote{\textbf{38:12}
  ...
  16:16.} del país'. \footnote{\textbf{38:12} Ezeq 5,5} \bibleverse{13}
...
\bibleverse{14} ``Así que profetiza, hijo de hombre, y dile a Gog que
esto es lo que dice el Señor Dios: El día que ataques, ¿no te darás
cuenta de que mi pueblo Israel está desprevenido? \bibleverse{15}
...
\bibleverse{16} Atacarás a mi pueblo Israel como una nube que cubre la
...
\bibleverse{17} ``Esto es lo que dice el Señor Dios: ¿No eres tú aquel
...
atacaría? \bibleverse{18} Ahora bien, en ese día, el día en que Gog
venga a atacar el país de Israel, me enojaré mucho, declara el Señor
Dios. \bibleverse{19} ``En mi apasionado y furioso enojo anuncio que en
ese momento se producirá un violento terremoto en el país de Israel.
\bibleverse{20} Todo lo que vive en la tierra temblará ante mi
...
derribados. \bibleverse{21} ``Llamaré a atacar a Gog desde todas mis
montañas, declara el Señor Dios. Cada uno atacará a su hermano con la
espada. \bibleverse{22} Lo castigaré con enfermedades y derramamiento de
...
su ejército, y sobre los ejércitos de sus numerosos aliados. \footnote{\textbf{38:22}
  Apoc 20,9} \bibleverse{23} Demostraré mi verdadero poder y santidad,
...
\bibleverse{1} ``Hijo de hombre, profetiza contra Gog y anuncia que esto
es lo que dice el Señor Dios: Cuidado, porque te voy a condenar Gog,
príncipe principal de Mesec y Tubal. \bibleverse{2} Te enviaré en otra
dirección, te arrastraré, te traeré de los lugares lejanos del norte y
te enviaré a atacar las montañas de Israel. \bibleverse{3} Entonces te
quitaré el arco de tu mano izquierda y te haré soltar las flechas de tu
mano derecha. \bibleverse{4} ``Serás muerto en los montes de Israel, tú
...
alimento a toda clase de aves y animales carnívoros. \footnote{\textbf{39:4}
  Ezeq 39,17} \bibleverse{5} Caerán y morirán a la intemperie, porque yo
he hablado, declara el Señor Dios. \bibleverse{6} ``Prenderé fuego a
Magog, así como a las tierras costeras donde la gente cree que es seguro
vivir, y entonces reconocerán que yo soy el Señor.

\bibleverse{7} Así daré a conocer mi reputación de santidad entre mi
pueblo Israel y no permitiré que se arruine más. Entonces las naciones
reconocerán que yo soy el Señor, el Santo de Israel. \bibleverse{8} ¡Sí,
...
\bibleverse{9} ``Entonces los habitantes de las ciudades de Israel
...
armas para hacer fuego durante siete años. \bibleverse{10} No
...
\bibleverse{11} ``En ese momento le daré a Gog un lugar para ser
...
\bibleverse{12} El pueblo de Israel tardará siete meses en enterrarlos
para que el país quede limpio. \bibleverse{13} Todo el mundo en el país
participará en enterrarlos, y esto les dará buena reputación cuando
revele mi gloria, declara el Señor Dios.

\bibleverse{14} ``Se elegirán hombres para que recorran repetidamente el
...
\bibleverse{15} Cuando registren el país, si encuentran un hueso humano
...
\bibleverse{16} Incluso la ciudad allí se llamará Hamona.\footnote{\textbf{39:16}
...
\bibleverse{17} ``Hijo de hombre, esto es lo que dice el Señor Dios:
...
tendrán carne para comer y sangre para beber. \bibleverse{18} Comerán la
...
cebados que vienen de Basán. \bibleverse{19} Comerán grasa hasta quedar
totalmente llenos y beberán sangre hasta embriagarse en el sacrificio
que voy a preparar. \bibleverse{20} Comerás en mi mesa hasta saciarte,
...
\bibleverse{21} ``Revelaré mi gloria a las demás naciones, y todas ellas
verán el castigo que les impongo. \bibleverse{22} Desde ese momento el
pueblo de Israel sabrá que yo soy el Señor, su Dios. \bibleverse{23} Las
...
\bibleverse{24} Traté con ellos a causa de su impureza y de sus pecados,
...
\bibleverse{25} ``Esto es lo que dice el Señor Dios: Ahora haré regresar
...
\bibleverse{26} Se olvidarán de sus acciones vergonzosas y de todas las
formas en que me fueron infieles, una vez que vivan seguros en su país,
sin que nadie los amenace. \bibleverse{27} Cuando los traiga a casa
desde las naciones, reuniéndolos desde los países de sus enemigos,
revelaré mi santidad entre tantas naciones que miran. \bibleverse{28}
Entonces sabrán que yo soy el Señor, su Dios, cuando los lleve de nuevo
a su país, sin dejar a ninguno de ellos atrás. \bibleverse{29} Ya no los
...
\bibleverse{1} Al principio del año, el día diez del mes del vigésimo
...
me llevó allí a la ciudad. \bibleverse{2} Dios me llevó al país de
Israel en visión y me posó en una montaña muy alta. En el lado sur de la
montaña había edificios que parecían ser una ciudad. \bibleverse{3}
...
pie en la entrada. \bibleverse{4} ``Hijo de hombre'', me dijo, ``mira
...
\bibleverse{5} Pude ver un muro que rodeaba el Templo. La vara de medir
...
\bibleverse{6} Luego subió los escalones de la puerta que daba al este.
Midió que el umbral de la puerta tenía seis codos de profundidad.
\bibleverse{7} Más allá, había nichos que medían seis por seis codos,
con cinco codos entre los nichos. El umbral de la entrada interior que
daba al pórtico medía seis codos.

\bibleverse{8} Luego midió el pórtico de entrada. \bibleverse{9} Tenía
...
\bibleverse{10} A cada lado de la entrada de la puerta oriental había
tres nichos que medían lo mismo. Los postes de cada lado también medían
lo mismo. \bibleverse{11} El ancho de la puerta de entrada medía diez
codos. Su longitud era de trece codos. \bibleverse{12} Un muro de un
codo de alto estaba delante de la alcoba, y las alcobas medían seis
codos por seis codos. \bibleverse{13} Luego midió la puerta de entrada
desde el techo de una alcoba hasta el techo de la de enfrente. Había
veinticinco codos desde una puerta hasta la opuesta. \bibleverse{14}
Luego midió la distancia entre los postes en sesenta codos. La puerta
daba la vuelta al patio. \bibleverse{15} Había cincuenta codos desde la
entrada de la puerta hasta el extremo del pórtico interior.
\bibleverse{16} Las alcobas y sus pilares tenían ventanas estrechas en
...
\bibleverse{17} Me llevó al patio exterior. Vi que se habían construido
habitaciones y un pavimento alrededor del patio. Había treinta
habitaciones que daban al pavimento. \bibleverse{18} El pavimento se
denominaba pavimento inferior y se extendía a lo largo de los lados de
las puertas y tenía la misma longitud que éstas. \bibleverse{19} Midió
...
\bibleverse{20} También midió la longitud y la anchura de la puerta del
patio exterior que daba al norte. \bibleverse{21} Sus tres nichos a
...
\bibleverse{22} Las ventanas, el pórtico y los adornos de las palmeras
...
\bibleverse{23} Había una entrada al patio interior que daba a la puerta
norte, al igual que la puerta este. Midió la distancia desde la entrada
hasta la puerta como cien codos.

\bibleverse{24} Me llevó al lado sur, y vi una puerta que daba al sur.
Midió sus postes y su pórtico, y medían lo mismo que los anteriores.
\bibleverse{25} Tanto la puerta como el pórtico tenían ventanas a su
alrededor que eran como las otras ventanas. Tenía cincuenta codos de
largo y veinticinco de ancho. \bibleverse{26} Tenía siete escalones que
subían a ella, y su pórtico estaba orientado hacia ellos. Tenía un poste
a cada lado con dibujos de palmeras. \bibleverse{27} El patio interior
...
\bibleverse{28} Me llevó al patio interior por la puerta sur, y midió la
puerta sur. Medía lo mismo que las anteriores. \bibleverse{29} Sus
...
cincuenta codos de largo y veinticinco de ancho. \bibleverse{30} (Los
otros pórticos circundantes medían veinticinco codos de largo y cinco de
profundidad). \bibleverse{31} El pórtico daba al patio exterior y sus
pilares estaban decorados con dibujos de palmeras. Tenía ocho escalones
para llegar a él.

\bibleverse{32} Me llevó al patio interior, en el lado este. Midió la
puerta y medía lo mismo que las anteriores. \bibleverse{33} Los nichos,
...
veinticinco de ancho. \bibleverse{34} El pórtico daba al patio exterior
y sus postes estaban decorados con dibujos de palmeras. Tenía ocho
escalones para llegar a ella.

\bibleverse{35} Me llevó a la puerta norte y la midió. Medía lo mismo
que las anteriores, \bibleverse{36} incluyendo sus alcobas, postes y
pórtico. La puerta y su pórtico tenían ventanas alrededor. Tenía
cincuenta codos de largo y veinticinco de ancho. \bibleverse{37} El
...
\bibleverse{38} Junto al pórtico de las puertas interiores había una
sala con una puerta. Allí se lavaba el holocausto. \bibleverse{39}
...
pecado y las ofrendas por la culpa. \bibleverse{40} Afuera, en el camino
hacia la entrada de la puerta norte, había dos mesas a un lado del
pórtico de la puerta y dos mesas al otro lado. \bibleverse{41} Así que
...
sacrificios. \bibleverse{42} También había cuatro mesas de piedra
...
\bibleverse{43} En las paredes del interior de la sala se colocaban
...
\bibleverse{44} Fuera de la puerta interior, pero dentro del patio
...
\bibleverse{45} El hombre me dijo: ``La sala que da al sur es para los
sacerdotes encargados del Templo, \bibleverse{46} y la sala que da al
...
\bibleverse{47} Midió el patio cuadrado: cien codos de largo y cien de
...
\bibleverse{48} Me llevó al pórtico del Templo y midió los pilares del
...
\bibleverse{49} El pórtico medía veinte codos de ancho y doce de
...
\bibleverse{1} Me llevó al Templo y midió los postes como seis codos de
ancho a ambos lados. \bibleverse{2} La entrada tenía diez codos de
...
\bibleverse{3} Entró en el santuario interior y midió los postes de la
...
\bibleverse{4} Midió la sala que había junto al santuario interior, de
...
\bibleverse{5} Midió la pared del Templo con un grosor de seis codos, y
cada sala lateral alrededor del Templo tenía cuatro codos de ancho.
\bibleverse{6} Había tres niveles de salas laterales superpuestos, cada
...
la pared del Templo mismo. \bibleverse{7} Las salas laterales alrededor
...
\bibleverse{8} Vi que el Templo estaba sobre una plataforma elevada que
...
\bibleverse{9} El grosor de la pared exterior de las salas laterales era
de cinco codos, y había un espacio abierto entre las salas laterales del
Templo \bibleverse{10} y las cámaras exteriores que medían veinte codos
de ancho alrededor del Templo. \footnote{\textbf{41:10} Ezeq 42,1-3}
\bibleverse{11} Las puertas de las salas laterales se abrían a este
espacio, con una entrada al norte y otra al sur. El espacio abierto
medía cinco codos de ancho a cada lado.

\bibleverse{12} Otro edificio daba al patio del Templo por el lado
...
\bibleverse{13} El Templo medía cien codos de largo. El patio del Templo
y el edificio, incluyendo sus muros, también medían cien codos.
\bibleverse{14} El patio del Templo, en el lado este, (incluyendo la
...
\bibleverse{15} Midió la longitud del edificio que daba al patio del
...
santuario interior y los pórticos que daban al patio, \bibleverse{16}
...
hasta las ventanas. \bibleverse{17} En la parte exterior de todas las
paredes de la entrada del santuario interior, espaciadas a intervalos
regulares alrededor del santuario interior y exterior, \bibleverse{18}
había diseños tallados de querubines y palmeras. Cada querubín tenía dos
caras: \bibleverse{19} la cara de un hombre miraba en dirección a una
...
Templo. \bibleverse{20} En la pared del Templo, desde el suelo hasta el
espacio que había sobre la puerta, había dibujos de querubines y
palmeras.

\bibleverse{21} El marco de la puerta del Templo era rectangular, al
igual que el marco de la puerta del santuario. \bibleverse{22} Allí
...
``Esta es la mesa que está delante del Señor''. \bibleverse{23} Tanto el
Templo como el santuario tenían puertas dobles con bisagras.
\bibleverse{24} Cada puerta tenía dos paneles que se abrían. Había dos
paneles para una puerta, y dos paneles para la otra puerta.
\bibleverse{25} En las puertas del Templo había tallas de querubines y
palmeras como las de las paredes, y había un techo de madera que cubría
la parte exterior del pórtico en la parte delantera. \bibleverse{26} En
...
\bibleverse{1} El hombre me sacó por la puerta norte al patio exterior,
a las habitaciones que se encuentran en el lado más alejado del patio
del Templo, junto al muro exterior norte. \bibleverse{2} El edificio que
daba a la puerta norte tenía cien codos de largo y cincuenta de ancho.
\footnote{\textbf{42:2} Ezeq 41,13} \bibleverse{3} Tenía tres pisos de
...
\footnote{\textbf{42:3} Ezeq 41,10; Ezeq 40,17} \bibleverse{4} Delante
de las salas había un pasillo interior de diez codos de ancho y cien de
largo. Sus puertas daban al norte. \bibleverse{5} Las habitaciones
superiores eran más pequeñas debido al espacio que ocupaban las salas
abiertas en los niveles inferior y medio del edificio. \bibleverse{6}
...
\bibleverse{7} Delante de las habitaciones había un muro exterior de
cincuenta codos de largo, paralelo al patio exterior. \bibleverse{8} Las
...
\bibleverse{9} Debajo de estas habitaciones había una entrada en el lado
...
\bibleverse{10} A lo largo del muro del sur\footnote{\textbf{42:10}
  ``Sur'': Tomado de la Septuaginta.} lado del patio exterior había
habitaciones junto al patio y frente al edificio. \bibleverse{11} Frente
...
puertas, planta y salidas. \bibleverse{12} Del mismo modo, había una
...
\bibleverse{13} El hombre me dijo: ``Las habitaciones del norte y del
...
las ofrendas por la culpa. \bibleverse{14} Una vez que los sacerdotes
...
\bibleverse{15} Cuando el hombre terminó de medir dentro del área del
Templo, me sacó por la puerta oriental y midió también los alrededores.
\bibleverse{16} Con la vara de medir midió el lado oriental. Tenía
quinientos codos de largo. \bibleverse{17} Midió el lado norte. Tenía
quinientos codos de largo. \bibleverse{18} Midió el lado sur. Tenía
quinientos codos de largo. \bibleverse{19} Luego dio la vuelta y midió
el lado oeste. Tenía quinientos codos de largo. \bibleverse{20} Así
...
\bibleverse{1} El hombre me llevó de vuelta a la puerta oriental.
\bibleverse{2} Allí vi la gloria del Dios de Israel que venía del este.
Su voz sonaba como una cascada atronadora, y la tierra resplandecía con
su gloria. \bibleverse{3} La visión que vi era igual a la que había
...
\bibleverse{4} La gloria del Señor entró en el Templo por la puerta
oriental. \footnote{\textbf{43:4} Ezeq 11,22-23; Ezeq 10,19}
\bibleverse{5} Entonces el Espíritu me levantó y me llevó al patio
interior, y la gloria del Señor llenó el Templo. \footnote{\textbf{43:5}
  Éxod 40,34; 1Re 8,10-11}

\bibleverse{6} Oí que alguien me hablaba desde el interior del Templo
mientras el hombre estaba de pie a mi lado. \bibleverse{7} Me dijo:
...
paganos. \bibleverse{8} Cuando construyeron sus casas junto a la mía -su
...
\footnote{\textbf{43:8} Ezeq 8,7-18} \bibleverse{9} Ahora, si se
deshacen de su prostitución y de sus honores paganos a sus reyes
muertos, viviré con ellos para siempre.

\bibleverse{10} ``Hijo de hombre, habla al pueblo de Israel sobre el
Templo y se avergonzarán de sus pecados. Haz que consideren
cuidadosamente su plan, \bibleverse{11} y si se avergüenzan de todo lo
...
\bibleverse{12} ``Esta es la ley del Templo: toda el área alrededor del
...
\bibleverse{13} ``Estas son las medidas del altar en codos (un codo y el
...
La parte posterior del altar \footnote{\textbf{43:13} Ezeq 40,47; Éxod
  27,1-8} \bibleverse{14} , medida desde el canalón en el suelo hasta la
...
la cornisa de un codo de ancho. \bibleverse{15} ``El hogar del altar
tendrá una altura de cuatro codos, con cuatro cuernos que apunten hacia
arriba desde él. \bibleverse{16} El hogar del altar será cuadrado, y sus
cuatro lados medirán doce codos cada uno. \bibleverse{17} La repisa será
...
\bibleverse{18} Luego me dijo: ``Hijo de hombre, esto es lo que dice el
...
\bibleverse{19} Darás un novillo como ofrenda por el pecado a los
sacerdotes levitas de la familia de Sadoc, que vienen a servir ante mí,
declara el Señor Dios. \bibleverse{20} Toma un poco de su sangre y ponla
...
\bibleverse{21} Luego retira el toro para la ofrenda por el pecado y
quémalo en el lugar designado del área del Templo, fuera del santuario.

\bibleverse{22} ``El segundo día traerás un macho cabrío sin defectos
como ofrenda por el pecado, y el altar quedará purificado como se
purificó con el toro. \bibleverse{23} Cuando hayas terminado de
purificarte, presentarás un novillo y un carnero, ambos sin defectos.
\bibleverse{24} Los ofrecerás al Señor. Los sacerdotes rociarán sal
sobre ellos y los sacrificarán al Señor como holocausto.

\bibleverse{25} ``Durante siete días, ofrecerás un macho cabrío cada día
como ofrenda por el pecado. También deberás entregar un novillo y un
carnero, ambos sin defectos. \bibleverse{26} Durante siete días, los
sacerdotes deberán arreglar el altar y purificarlo. Así lo dedicarán.
\footnote{\textbf{43:26} Éxod 28,41}

\bibleverse{27} Una vez transcurridos estos días, a partir del octavo
...
\bibleverse{1} El hombre me llevó de nuevo a la puerta exterior del
santuario que daba al este, pero estaba cerrada. \bibleverse{2} El Señor
...
Así que permanecerá cerrada. \bibleverse{3} El príncipe mismo puede
...
\bibleverse{4} El hombre me llevó al frente del Templo por la puerta
norte. Al mirar, vi la gloria del Señor llenando su Templo, y caí con el
rostro en tierra. \footnote{\textbf{44:4} Ezeq 43,5}

\bibleverse{5} El Señor me dijo: ``¡Hijo de hombre, concéntrate! ¡Mantén
...
\bibleverse{6} ``Dile a esos rebeldes, al pueblo de Israel, que esto es
lo que dice el Señor Dios: ¡Ya estoy harto de todos tus repugnantes
pecados, pueblo de Israel! \bibleverse{7} Además de todas sus prácticas
...
comida, la grasa y la sangre. Rompiste mi acuerdo. \bibleverse{8}
Además, no has cuidado de mi santuario como se te exigía, sino que has
empleado a otros para que cuiden de mi santuario por ti. \bibleverse{9}
...
\bibleverse{10} ``Los levitas que me abandonaron cuando Israel dejó de
adorarme y se fue a seguir a sus ídolos, sufrirán las consecuencias de
sus pecados. \bibleverse{11} Sin embargo, servirán en mi santuario,
...
servirlos. \bibleverse{12} ``Pero como sirvieron al pueblo frente a sus
...
pecado, declara el Señor Dios. \bibleverse{13} No podrán acercarse a mí
...
repugnantes pecados que cometieron. \bibleverse{14} Sin embargo, los
...
\bibleverse{15} ``Los sacerdotes levitas, descendientes de Sadoc y que
...
para ofrecerme grasa y sangre, declara el Señor Dios. \bibleverse{16}
Sólo ellos pueden entrar en mi santuario y acercarse a mi mesa para
ministrar ante mí. Ellos harán lo que yo diga.

\bibleverse{17} ``Cuando entren por las entradas del patio interior, se
...
en las entradas del patio interior o dentro del Templo. \footnote{\textbf{44:17}
  Lev 16,4} \bibleverse{18} Llevarán turbantes de lino en la cabeza y
ropa interior de lino. No deben llevar nada que les haga sudar.
\bibleverse{19} ``Cuando vayan al atrio exterior, donde está el pueblo,
...
\bibleverse{20} ``No se les permite afeitarse la cabeza ni dejarse
crecer el cabello; deben tener un corte de pelo adecuado. \footnote{\textbf{44:20}
  Lev 19,27; Lev 21,5} \bibleverse{21} Ningún sacerdote debe beber vino
antes de entrar en el patio interior. \footnote{\textbf{44:21} Lev 10,9}
\bibleverse{22} No deben casarse con una mujer viuda o divorciada; sólo
...
\bibleverse{23} Deben enseñar a mi pueblo la diferencia entre lo que es
...
\bibleverse{24} ``Serán jueces en las causas judiciales y basarán sus
...
\bibleverse{25} ``Un sacerdote no debe hacerse impuro acercándose a un
...
hacerlo. \footnote{\textbf{44:25} Lev 21,1-4} \bibleverse{26} Después,
una vez purificado, deberá esperar siete días. \bibleverse{27} Entonces,
...
\bibleverse{28} ``En cuanto a su parte de la tierra, yo me encargaré de
ellos. No les darás ninguna propiedad en Israel, porque yo los
mantendré. \bibleverse{29} ``Deben comer las ofrendas de grano, las
ofrendas por el pecado y las ofrendas por la culpa. Todo lo que traiga
el pueblo de Israel y se dedique al Señor será de ellos. \bibleverse{30}
...
tu casa sea bendecida. \bibleverse{31} Los sacerdotes no podrán comer
...
\bibleverse{1} Cuando asignes la propiedad de la tierra por sorteo,
...
Toda esta zona es sagrada. \bibleverse{2} Dentro de ella está la sección
para el santuario que mide 500 codos cuadrados, con un área abierta
alrededor de 50 codos de ancho. \bibleverse{3} A partir de esta zona
santa, mide una sección de 25. 000 codos por 10. 000 codos. Aquí estará
el santuario, el Lugar Santísimo. \bibleverse{4} Esta zona es una
...
santuario. \bibleverse{5} La otra sección que mide 25. 000 codos por 10.
...
\bibleverse{6} Asigna a la ciudad un área de 5. 000 codos de ancho y 25.
000 de largo junto a la sección del santuario. Es para todo el pueblo de
Israel.

\bibleverse{7} Al príncipe se le asignará el territorio a ambos lados
...
asignación a las tribus. \bibleverse{8} Este territorio será de su
...
\bibleverse{9} Esto es lo que dice el Señor Dios: ¡Ya hancausado
...
\footnote{\textbf{45:9} Ezeq 46,18} \bibleverse{10} Deben usar métodos
...
sólidos, y un baño para medir los líquidos. \footnote{\textbf{45:10} Lev
  19,36; Deut 25,15} \bibleverse{11} El efa y el baño tendrán la misma
...
la medida fundamental. \bibleverse{12} Veinte gueras hacen un siclo.
...
\bibleverse{13} Estos son los impuestos\footnote{\textbf{45:13} Los
  impuestos deben ser pagados al príncipe para los gastos de
  funcionamiento del Templo.} de cada homer de trigo o cebada.
\bibleverse{14} En el caso del aceite de oliva, la décima parte de un
...
\bibleverse{15} Además, de cada rebaño de doscientas ovejas de los
...
enderezar al pueblo, declara el Señor Dios. \bibleverse{16} Todos los
habitantes del país deben hacer estas contribuciones al príncipe de
Israel. \bibleverse{17} La función del príncipe es proporcionar los
...
\bibleverse{18} Esto es lo que dice el Señor Dios: El primer día del
primer mes debes sacrificar un novillo que no tenga defectos para
purificar el santuario. \bibleverse{19} El sacerdote tomará parte de la
...
del patio interior. \bibleverse{20} También lo harás el séptimo día del
...
\bibleverse{21} El decimocuarto día del primer mes celebrarás la Pascua.
...
\bibleverse{22} Ese día el príncipe ofrecerá un toro como ofrenda por el
pecado para él y para todos los habitantes del país. \bibleverse{23}
...
\bibleverse{24} También entregará un efa de grano y un hin de aceite de
oliva como ofrenda para acompañar a cada toro y a cada carnero.
\footnote{\textbf{45:24} Ezeq 46,5; Núm 15,4; Núm 15,6; Núm 15,9}

\bibleverse{25} Durante los siete días de la fiesta\footnote{\textbf{45:25}
...
\bibleverse{1} Esto es lo que dice el Señor Dios: ``La puerta oriental
...
\bibleverse{2} El príncipe debe entrar por el pórtico de la puerta desde
...
hasta la noche. \bibleverse{3} El pueblo de Israel también se inclinará
ante el Señor a la entrada de la puerta los sábados y las lunas nuevas.
\bibleverse{4} ``El holocausto que el príncipe debe ofrecer al Señor el
día de sábado será de seis corderos y un carnero, todos sin defectos.
\footnote{\textbf{46:4} Núm 28,9} \bibleverse{5} La ofrenda de grano que
...
oliva por cada efa de grano. \bibleverse{6} El día de la Luna Nueva se
ofrecerá un novillo, seis corderos y un carnero. Todos ellos deberán
estar libres de defectos. \bibleverse{7} También deberá ofrecer una
...
efa de grano. \bibleverse{8} Cuando el príncipe entre, lo hará por el
pórtico de la puerta, y saldrá por el mismo camino.

\bibleverse{9} ``Cuando el pueblo de Israel se reúna ante el Señor en
...
la que entró. Todos deben salir por la puerta opuesta. \bibleverse{10}
...
\bibleverse{11} En las fiestas religiosas y en las reuniones periódicas,
...
\bibleverse{12} ``Cuando el príncipe decida hacer una ofrenda voluntaria
...
\bibleverse{13} ``Cada mañana se sacrificará un cordero de un año, sin
defectos, como holocausto diario al Señor. \bibleverse{14} Todas las
...
\bibleverse{15} Asegúrate de que el cordero, la ofrenda de grano y el
...
\bibleverse{16} ``Esto es lo que dice el Señor: Si el príncipe regala
una propiedad a alguno de sus hijos para que la posea, ésta pertenecerá
a sus descendientes. Ellos podrán heredar la propiedad. \bibleverse{17}
...
hijos, son de ellos. \footnote{\textbf{46:17} Lev 25,10} \bibleverse{18}
...
\bibleverse{19} El hombre me llevó por la entrada junto a la puerta a
las habitaciones sagradas orientadas al norte que pertenecían a los
sacerdotes. Me mostró un lugar en el extremo occidental \bibleverse{20}
...
\bibleverse{21} Me llevó al patio exterior y me condujo a cada una de
sus cuatro esquinas. Vi un patio separado en cada esquina.
\bibleverse{22} Había patios amurallados separados en las cuatro
esquinas del patio exterior. Cada uno de ellos medía cuarenta codos por
treinta codos; todos eran del mismo tamaño. \bibleverse{23} Cada uno de
los cuatro patios tenía una cornisa de piedra con hornos construidos en
la base de las paredes de cada lado. \bibleverse{24} Me dijo: ``Estas
...
\bibleverse{1} El hombre me llevó de vuelta a la entrada del Templo. Vi
...
debajo del lado sur del Templo y corría al sur del altar. \footnote{\textbf{47:1}
  Jl 4,18; Zac 14,8; Apoc 22,1} \bibleverse{2} Luego me sacó por la
...
\bibleverse{3} El hombre caminó hacia el este sosteniendo un cordel de
medición, midió mil codos y me condujo a través del agua que me llegaba
a los tobillos. \bibleverse{4} Midió otros mil codos y me hizo pasar por
el agua que me llegaba a las rodillas. Midió otros mil codos y me hizo
pasar por el agua que me llegaba a la cintura. \bibleverse{5} Midió
...
\bibleverse{6} ``Hijo de hombre, ¿has observado todo esto?'' , me
preguntó. Luego me llevó de vuelta a la orilla del río.

\bibleverse{7} Cuando llegué allí, vi un gran número de árboles a ambos
lados del río. \bibleverse{8} Me dijo: ``Esta agua desemboca en la
...
llega al Mar Muerto, convierte el agua salada en dulce. \footnote{\textbf{47:8}
  Gén 14,3} \bibleverse{9} Habrá muchos animales y peces dondequiera que
fluya el río. Como el río vuelve dulce el agua salada dondequiera que
fluya, todo podrá vivir allí. \bibleverse{10} ``Los pescadores estarán
...
en el Mar Mediterráneo. \bibleverse{11} Sin embargo, las marismas y las
zonas pantanosas no se volverán frescas; seguirán siendo saladas.
\bibleverse{12} ``A ambos lados del río crecerán todo tipo de árboles
...
doce tribus de Israel. (José recibirá dos asignaciones). \footnote{\textbf{47:13}
  Gén 48,5; Jos 17,17} \bibleverse{14} Debes asignarles la tierra por
...
\bibleverse{20} ``El Mar Mediterráneo es el límite occidental hasta un
...
\bibleverse{21} ``Ustedes deben asignar esta tierra para que la posean
según las tribus de Israel. \bibleverse{22} Ustedes van a asignar la
...
de la misma manera que a ustedes. \bibleverse{23} A los extranjeros se
...
\bibleverse{1} Esta es una lista de los territorios según los nombres de
...
\bibleverse{2} El territorio de Aser limita con el de Dan de este a
oeste.

\bibleverse{3} El territorio de Neftalí limita con el de Aser de este a
oeste.

\bibleverse{4} El territorio de Manasés limita con el de Neftalí de este
a oeste.

\bibleverse{5} El territorio de Efraín limita con el de Manasés de este
a oeste.

\bibleverse{6} El territorio de Rubén limita con el de este a oeste.

\bibleverse{7} El territorio de Judá limita con el de Rubén de este a
oeste.

\hypertarget{la-santa-ordenanza}{%
\subsection{La santa ordenanza}\label{la-santa-ordenanza}}

\bibleverse{8} Junto a la asignación de Judá, de este a oeste, está la
...
\bibleverse{9} El territorio especial que hagas será para el Señor y
tendrá 25. 000 codos por 10. 000 codos. \bibleverse{10} Este será el
...
este. El santuario estará en medio de él. \bibleverse{11} Es para los
...
no me abandonaron cuando los israelitas me abandonaron. \footnote{\textbf{48:11}
  Ezeq 44,15} \bibleverse{12} Será una parte especial de la tierra
provista para ellos, una asignación santísima junto a la de los levitas.

\bibleverse{13} Los levitas tendrán un área de 25. 000 codos por 10. 000
...
será de 25. 000 codos, y su anchura de 10. 000\footnote{\textbf{48:13}
  La Septuagintadice 20. 000.} codos. \bibleverse{14} No se les permite
vender a cambio ni transferir nada de ella, porque es la mejor parte de
la tierra y es sagrada para el Señor.

\bibleverse{15} El resto, de 5. 000 codos por 25. 000 codos, es para uso
ordinario de la ciudad para casas y pastos. La ciudad estará en medio de
ella, \bibleverse{16} y estas serán sus medidas 4. 500 codos por todos
los lados, al norte, al sur, al este y al oeste. \bibleverse{17} Los
pastos de la ciudad la rodearán por 250 codos por todos los lados, al
norte, al sur, al este y al oeste. \bibleverse{18} Lo que queda de la
...
\bibleverse{19} Los trabajadores que cultiven la tierra serán de todas
las tribus israelitas. \bibleverse{20} Todoel territorio será un
...
\bibleverse{21} La tierra que quede a ambos lados del territorio sagrado
...
\footnote{\textbf{48:21} Ezeq 45,7} \bibleverse{22} El área de los
...
\bibleverse{23} Estas son las asignaciones para el resto de las tribus:
La asignación de Benjamín se extiende desde el límite oriental del país
hasta el occidental.

\bibleverse{24} El territorio de Simeón limita con el de Benjamín de
este a oeste.

\bibleverse{25} El territorio de Isacar limita con el de Simeón de este
a oeste.

\bibleverse{26} El territorio de Zabulón limita con el de Isacar de este
a oeste.

\bibleverse{27} El territorio de Gad limita con el de Zabulón de este a
oeste.

\bibleverse{28} El límite sur del territorio de Gad será desde Tamar
hasta las aguas de Meribat-Cadés, y luego a lo largo del Wadi de Egipto
hasta el Mar Mediterráneo.

\bibleverse{29} Esta es la tierra que debes asignar a las tribus de
...
\bibleverse{30} Estas serán las salidas de la ciudad, comenzando por el
lado norte, que tiene una longitud de 4. 500 codos. \bibleverse{31} Las
...
\bibleverse{32} Habrá tres puertas en el lado este, (también de 4. 500
codos de largo): las puertas de José, Benjamín y Dan.

\bibleverse{33} Habrá tres puertas en el lado sur, (también de 4. 500
codos de largo): las puertas de Simeón, Isacar y Zabulón.

\bibleverse{34} En el lado oeste habrá tres puertas (también de 4. 500
codos): la puerta de Gad, la puerta de Aser y la puerta de Neftalí.

\bibleverse{35} La distancia alrededor del exterior de la ciudad será de
