...
\bibleverse{1} Esta carta viene de parte de Judas, siervo de Jesucristo,
...
el Padre, y que son guardados a salvo por Jesucristo: \footnote{\textbf{1:1}
  Mat 13,55} \bibleverse{2} ¡Que la misericordia, la paz y el amor de
...
\bibleverse{3} Amigos, desde antes ya anhelaba la oportunidad de
...
santo de Dios. \bibleverse{4} Pues algunos se han infiltrado entre
...
\bibleverse{5} Aunque esto ya lo saben, quiero recordarles que aunque el
...
\bibleverse{6} Incluso a los ángeles que estaban inconformes con las
...
\bibleverse{7} Del mismo modo, Sodoma y Gomorra, y las naciones cercanas
...
\bibleverse{8} Del mismo modo, estos soñadores\footnote{\textbf{1:8} Se
...
\bibleverse{9} Incluso el arcángel Miguel, cuando discutía con el diablo
sobre el cuerpo de Moisés, no se animó a condenarlo con insultos
difamatorios, sino que dijo: ``Que el Señor te reprenda''.
\bibleverse{10} Pero estas personas ridiculizan lo que no comprenden; y
lo que entienden, eso siguen, por instinto, como animales que no tienen
razón. Esto es lo que los destruye. \bibleverse{11} ¡Cuán grande
...
rebelión de Coré, se han destruido a sí mismos. \footnote{\textbf{1:11}
  Gén 4,-1; Núm 16,-1; Núm 31,16} \bibleverse{12} Estas personas
...
ni frutos, muertos doce veces y extraídos desde las raíces. \footnote{\textbf{1:12}
  1Cor 11,21} \bibleverse{13} Son olas violentas del océano, que arrojan
...
\bibleverse{14} Enoc, quien vivió siete generaciones después de Adán,
profetizó sobre estas personas: ``¡Miren! El Señor viene con miles y
miles de sus santos \footnote{\textbf{1:14} Gén 5,21} \bibleverse{15}
...
\bibleverse{16} Tales personas son gruñonas, que siempre están
...
\bibleverse{17} Pero ustedes, mis queridos amigos, recuerden, por favor,
lo que les dijeron los apóstoles de nuestro Señor Jesucristo.
\bibleverse{18} Porque ellos les explicaron que en los últimos tiempos
vendrían mofadores, que seguirían sus propios deseos malvados.
\footnote{\textbf{1:18} 1Tim 4,1; 2Pe 3,3} \bibleverse{19} Ellos causan
divisiones, son personas mundanas que no tienen el Espíritu. \footnote{\textbf{1:19}
  1Cor 2,14}

\bibleverse{20} Pero ustedes, amigos míos, deben edificarse a sí mismos
por la fe en Dios. Oren en el Espíritu Santo, \footnote{\textbf{1:20}
  Col 2,7; 1Tes 5,11} \bibleverse{21} manténganse a salvo en el amor de
Dios, y esperen la misericordia de nuestro Señor Jesucristo, que otorga
vida eterna. \bibleverse{22} Muestren bondad con los que dudan.
\bibleverse{23} Salven a todos los que puedan, arrebatándolos del fuego.
...
\bibleverse{24} Ahora, a Aquél que puede guardarlos sin caer, y que
puede llevarlos a su gloriosa presencia sin falta, y con gran gozo,
\bibleverse{25} al único Dios, nuestro Salvador, por medio de Jesucristo
