...
\bibleverse{1} Tras la muerte de Moisés, el siervo del Señor, el Señor
habló con Josué, el hijo de Nun, que había sido asistente de Moisés. Y
le dijo: \bibleverse{2} ``Mi siervo Moisés ha muerto. Así que ve y cruza
el Jordán, tú y todo el pueblo, y entren en el país que yo le entrego a
los israelitas. \bibleverse{3} Como se lo prometí a Moisés, dondequiera
que pongas un pie, será tierra que yo te daré,\footnote{\textbf{1:3}
  Refiriéndose no a Josué, sino a todo el pueblo.} \bibleverse{4} desde
...
izquierda, para que tengas éxito en todo lo que hagas. \footnote{\textbf{1:7}
  Deut 5,29; 1Re 2,3} \bibleverse{8} Sigue recordándole al pueblo la
...
en lo que hagas. \footnote{\textbf{1:8} Sal 1,2-3} \bibleverse{9} No te
...
\bibleverse{10} Entonces Josué le dio una orden a los líderes del
pueblo: \bibleverse{11} ``Vayan por todo el campamento y díganle al
...
\bibleverse{12} Pero a las tribus de Rubén y Gad, y a la mitad de la
tribu de Manasés, Josué les dijo: \bibleverse{13} ``Recuerden lo que
...
está dando descanso, y les dará esta tierra'. \footnote{\textbf{1:13}
  Núm 32,20} \bibleverse{14} Sus esposas, hijos, y su ganado se quedarán
...
\bibleverse{15} hasta que el Señor les de descanso, como los ha dejado
...
\bibleverse{16} Entonces ellos le dijeron a Josué: ``Haremos todo lo que
nos has dicho, e iremos a donde nos envíes. \bibleverse{17} Te
obedeceremos como obedecimos a Moisés en todo. Que el Señor Dios esté
contigo como estuvo con Moisés. \bibleverse{18} Cualquiera que se rebele
...
\bibleverse{1} Entonces Josué, hijo de Nun, envió en secreto a dos
...
\bibleverse{2} Pero al rey de Jericó le informaron: ``Mira, unos
israelitas han venido aquí esta noche para espiar el territorio''.

\bibleverse{3} Así que el rey de Jericó envió órdenes a Rahab,
...
\bibleverse{4} La mujer se había llevado a los dos hombres y los había
escondido. Y le dijo a los mensajeros del rey:\footnote{\textbf{2:4}
  ``Mensajeros del rey'': implícito.} ``Sí, es verdad, los hombres
vinieron a visitarme, pero no sabía de dónde eran. \bibleverse{5} Se
...
quizás los alcancen''. \bibleverse{6} (Ella los había llevado hasta el
tejado y los había escondido debajo de unos fardos de lino que tenía
allí). \bibleverse{7} Los mensajeros del rey fueron tras los hombres por
...
\bibleverse{8} Antes de que los espías se durmieran, Rahabsubió al
tejado para hablar con ellos. \bibleverse{9} Les dijo: ``Sé que el Señor
...
\bibleverse{10} Hemos oído cómo el Señor secó las aguas del Mar Rojo
...
destruyeron por completo. \footnote{\textbf{2:10} Éxod 14,21; Núm 21,24;
  Núm 21,35} \bibleverse{11} Al oír esto, nuestro ánimo decayó. A nadie
...
su Dios es Dios arriba en el cielo y abajo en la tierra. \footnote{\textbf{2:11}
  Jos 5,1; Éxod 15,14-15; Deut 4,39} \bibleverse{12} Así que ahora
...
de que puedo confiar en ustedes, \footnote{\textbf{2:12} Jos 6,23; Jos
  6,25} \bibleverse{13} y que apartarán a mi padre y a mi madre, así
como a mis hermanos y hermanas, y a todos los que forman parte de sus
familias, y que los salvarán de la muerte''.

\bibleverse{14} ``¡Nuestras vidas por las vidas de ellos!'' le
...
muralla de la ciudad. \bibleverse{16} ``Corran hacia las colinas'', les
...
\bibleverse{17} Los hombres le habían dicho: ``Seremos liberados de la
promesa que nos hiciste jurar, \bibleverse{18} a menos que cuando
...
hermanos, y a toda la familia. \bibleverse{19} Si alguien sale de tu
...
asumimos toda la responsabilidad de su muerte. \bibleverse{20} Pero si
le dices a alguien sobre esto entonces seremos liberados de la promesa
que nos hiciste jurar''.

\bibleverse{21} ``Estoy de acuerdo, que sea como ustedes lo han dicho'',
...
\bibleverse{22} Ellos subieron a las colinas y se quedaron allí tres
días. Los hombres que los perseguían buscaron por todo elcamino pero no
pudieron encontrarlos, así que volvieron a casa. \bibleverse{23}
...
pasado. \bibleverse{24} ``El Señor ha puesto esta tierra en nuestras
...
\bibleverse{1} A la mañana siguiente, Josué y los israelitas salieron de
Sitín y llegaron a la orilla del Jordán. Allí pasaron la noche antes de
cruzar. \footnote{\textbf{3:1} Núm 25,1} \bibleverse{2} Tres días
después, los líderes del pueblo pasaron por el campamento \bibleverse{3}
...
estén y seguirla. \bibleverse{4} Así sabrán qué camino tomar, ya que no
han estado aquí antes. Mantengan una distancia de 3. 000 pies entre
ustedes y el Arca. ¡No se acerquen!''

\bibleverse{5} Entonces Josué le dijo al pueblo: ``Asegúrense de estar
...
\bibleverse{6} Josuéles habló a los sacerdotes:\footnote{\textbf{3:6} Se
...
\bibleverse{7} El Señor le dijo a Josué: ``Lo que hago hoy te confirmará
...
cuenta de que así como estuve con Moisés, estaré contigo. \footnote{\textbf{3:7}
  Jos 4,14; Jos 1,5; Jos 1,17} \bibleverse{8} Dile a los sacerdotes que
llevan el Arca del Pacto: `Cuando lleguen a cruce del Jordán, den unos
pasos hacia el agua y luego deténganse allí'\,''.

\bibleverse{9} Entonces Josué les dijo a los israelitas: ``Vengan aquí y
escuchen lo que el Señor su Dios les quiere decir. \bibleverse{10} Así
...
y a los jebuseos. \bibleverse{11} Sólo recuerden: el Arca del Pacto del
Señor de toda la tierra cruzará el Jordánantes que ustedes.
\bibleverse{12} Elijan doce hombres de las tribus de Israel, uno por
tribu.\footnote{\textbf{3:12} Este verso parece fuera de lugar y se
  repite en 4:2.} \bibleverse{13} En el momento en que los sacerdotes
...
\bibleverse{14} Así que el pueblo recogió el campamento y se dispuso a
cruzar el Jordán, y los sacerdotes que llevaban el Arca iban adelante.
\bibleverse{15} Como era la temporada de la cosecha, el Jordán estaba
...
fluir. \bibleverse{16} El agua se amontonó mucho más arriba, en la
...
\bibleverse{17} Los sacerdotes que llevaban el Arca se mantuvieron
...
\bibleverse{1} Cuando toda la nación terminó de cruzar el Jordán, el
Señor le dijo a Josué: \bibleverse{2} ``Escoge doce hombres del pueblo,
uno por tribu, \bibleverse{3} y diles: `Recojan doce piedras del medio
del Jordán, donde están los sacerdotes. Luego llévenlas y déjenlas en el
lugar donde acamparán esta noche'\,''.

\bibleverse{4} Entonces Josué mandó llamar a los doce hombres que había
elegido, uno de cada tribu, \bibleverse{5} y les dijo: ``Vuelvan y
...
sus hombros, uno por cada una de las tribus de Israel. \bibleverse{6}
Este será un monumento entre ustedes, para que un día, cuando sus hijos
pregunten: `¿Qué significan estas piedras?' \bibleverse{7} ustedes
...
\bibleverse{9} Josué también colocó doce piedras en medio del Jordán
justo donde los sacerdotes que llevaban el Arca del Pacto se habían
quedado en pie, y siguen allí hasta el día de hoy. \bibleverse{10} Los
...
lo que Moisés le había dicho a Josué.\footnote{\textbf{4:10} Esta
  ...
  para su relato.} Y el pueblo cruzó rápidamente. \bibleverse{11}
...
\bibleverse{12} Los hombres armados de las tribus de Rubén y Gad, y la
...
Israel, como Moisés lo había estipulado. \footnote{\textbf{4:12} Núm
  32,21; Núm 32,29} \bibleverse{13} Fueronunos 40. 000 hombres, armados
...
\bibleverse{14} Ese día el Señor confirmó a Josué como gran líder a la
vista de todos los israelitas, y ellos se maravillaron de él como lo
habían hecho con Moisés.

\bibleverse{15} El Señor le había dicho a Josué: \bibleverse{16} ``Dile
...
\bibleverse{17} Así que Josué les dijo a los sacerdotes, ``Salgan del
Jordán''. \bibleverse{18} Los sacerdotes salieron del Jordán llevando el
...
orillas como antes. \bibleverse{19} El pueblo salió del Jordán y acampó
...
\bibleverse{20} Josué colocó en Gilgal las doce piedras que habían sido
tomadas del Jordán. \bibleverse{21} Y entonces les dijo a los
israelitas: ``El día que sus hijos les pregunten a sus padres: `¿Qué
significan estas piedras?' \bibleverse{22} ustedes podrán explicarles:
`Aquí es donde los israelitas cruzaron el Jordán en tierra seca'.
\bibleverse{23} Porque el Señor su Dios hizo que el río Jordán se secara
...
\bibleverse{24} Y lo hizo para que todos en la tierra supieran cuán
...
\bibleverse{1} Cuando todos los reyes amorreos al Oeste del Jordán y
...
enfrentarse a los israelitas. \bibleverse{2} En ese momento, el Señor le
...
generación\footnote{\textbf{5:2} ``Circuncida a la nueva generación'':
  ...
  Éxod 4,25} \bibleverse{3} Josué mandó a hacer cuchillos de piedra y
todos los israelitas varones fueron circuncidados en el lugar que más
adelante se conoció como ``la colina de los prepucios''. \bibleverse{4}
...
en el viaje, en medio del desierto, después del Éxodo. \bibleverse{5}
Todos habían sido circuncidados cuando salieron de Egipto, pero los
nacidos en el viaje desde entonces no lo habían hecho. \bibleverse{6}
...
que fluye leche y miel. \bibleverse{7} El Señor los reemplazó con sus
hijos, y estos fueron los que Josué circuncidó. No estaban circuncidados
porque no habían sido circuncidados en el camino. \bibleverse{8} Una vez
que todos fueron circuncidados, se quedaron en el campo hasta que se
recuperaron.

\bibleverse{9} Entonces el Señor le dijo a Josué: ``Hoy he quitado de
...
\bibleverse{10} Los israelitas acamparon en Gilgal y celebraron allí la
Pascua en la tarde del día 14 del primer mes. \footnote{\textbf{5:10}
  Éxod 12,6; Lev 23,5} \bibleverse{11} A partir del día siguiente,
comenzaron a comer los productos de la tierra: pan sin levadura y grano
asado. \bibleverse{12} El mismo día en que comenzaron a comer el
...
\bibleverse{13} Un día, cuando Josué estaba cerca de Jericó, levantó la
...
\bibleverse{14} Josué cayó al suelo con el rostro en alto. Y entonces
dijo: ``¿Qué órdenes tiene mi señor para su siervo?'' \footnote{\textbf{5:14}
  Éxod 14,19}

\bibleverse{15} El comandante del ejército del Señor le dijo a Josué:
...
\bibleverse{1} Las puertas de Jericó se cerraron y se prohibieron por
culpa de los israelitas. No se le permitía a nadie entrar o salir.
\bibleverse{2} Pero el Señor le dijo a Josué: ``Te entrego la ciudad de
Jericó, junto con su rey y su ejército de guerreros. \bibleverse{3}
Marcha alrededor de la ciudad con tus hombres armados una vez al día
durante seis días. \bibleverse{4} Siete sacerdotes irán delante del
...
carnero. \bibleverse{5} Cuando escuchen un largo golpe en los cuernos de
...
\bibleverse{6} Así que Josué, hijo de Nun, mandó a llamar a los
...
\bibleverse{7} Luego le dijo al pueblo: ``¡Muévanse! ¡Marchen alrededor
de la ciudad con los hombres armados delante del Arca del Señor!''

\bibleverse{8} Cuando Josué terminó de hablarle al pueblo, los siete
...
\bibleverse{9} Algunos de los hombres armados marchaban delante de los
sacerdotes haciendo sonar los cuernos, mientras que otros seguían el
Arca, haciendo sonar los cuernos continuamente.

\bibleverse{10} Sin embargo, Josué les ordenó: ``No griten, ni hablen.
No digan nada hasta que yo les de la orden de gritar, ¡solo entonces
griten!'' \bibleverse{11} Así que el Arca del Señor fue llevada por todo
alrededor de la ciudad, y dieron una vuelta. Luego regresaron al
campamento y pasaron la noche allí. \bibleverse{12} Josué se levantó
temprano en la mañana, y los sacerdotes recogieron el Arca del Señor.
\bibleverse{13} Los siete sacerdotes con los siete cuernos de carnero
...
continuamente los cuernos. \bibleverse{14} Así que el segundo día
...
\bibleverse{15} El séptimo día, se levantaron al amanecer y marcharon
alrededor de la ciudad de la manera habitual, salvo que este día le
dieron siete vueltas a la ciudad. \bibleverse{16} La séptima vez, cuando
los sacerdotes soplaron los cuernos, Josué le dijo al pueblo: ``¡Griten,
porque hoy el Señor nos ha dado la ciudad! \bibleverse{17} La ciudad y
...
\bibleverse{18} Pero no se acerquen a ninguna de las cosas que se han
...
\footnote{\textbf{6:18} Lev 27,28; Deut 13,18} \bibleverse{19} Así que
...
\bibleverse{20} Tan pronto como oyeron el sonido de las bocinas, el
...
\bibleverse{22} Josué lehabía dicho a los dos hombres que habían ido a
explorar la tierra: ``Vayan a la casa de la prostituta Rahab y sáquenla
junto con toda su familia, tal como se lo prometieron'' \bibleverse{23}
...
llevaron a un lugar cerca del campamento israelita. \footnote{\textbf{6:23}
  Núm 31,19} \bibleverse{24} Los israelitas quemaron la ciudad y todo lo
...
\bibleverse{25} Josué salvó a Rahab, la prostituta, y a su familia
...
\bibleverse{26} En ese momento Josué declaró una maldición, diciendo:
...
\bibleverse{27} Y el Señor estaba con Josué, y su fama se extendió por
toda la tierra.
...
\bibleverse{1} Sin embargo, los israelitas no habían sido fieles
...
Judá. \bibleverse{2} Josué envió hombres desde el campamento
...
\bibleverse{3} Cuando regresaron, le dijeron a Josué: ``No necesitamos a
...
unos pocos''. \bibleverse{4} Así que alrededor de tres mil hombres
fueron a luchar, pero fueron golpeados por los hombres de Hai y tuvieron
que irse huyendo. \bibleverse{5} Los hombres de Hai mataron a unos
...
para luchar. \bibleverse{6} Entonces Josué rasgó sus ropas\footnote{\textbf{7:6}
...
ancianos se echaron polvo en la cabeza. \bibleverse{7} Josué gritó:
...
\bibleverse{8} Perdona, Señor, pero ¿qué puedo decir ahora que Israel ha
dado la espalda y ha huido de sus enemigos? \bibleverse{9} Los cananeos
...
\bibleverse{10} Pero el Señor le respondió a Josué: ``¡Levántate! ¿Qué
crees que haces acostado sobre tu rostro de esa manera? \bibleverse{11}
...
objetos robados junto con sus propias pertenencias. \bibleverse{12} Por
...
\bibleverse{13} Levántate y asegúrate de que el pueblo esté puro. Diles:
...
cosas sean eliminadas por completo. \bibleverse{14} Por la mañana, te
...
por hombre. \bibleverse{15} El que sea sorprendido en posesión de lo que
...
\bibleverse{16} Josué se levantó temprano a la mañana siguiente y llamó
a Israel al frente, tribu por tribu. \footnote{\textbf{7:16} 1Sam
  10,20-21; 1Sam 14,41-42} \bibleverse{17} La tribu de Judá fue elegida.
...
Zabdi.\footnote{\textbf{7:17} ``La familia de Zabdi'' (algunos
  ...
  problemático.} \footnote{\textbf{7:17} Núm 26,20} \bibleverse{18} La
familia de Zabdi se presentó, y Acán, hijo de Carmi, hijo de Zabdi, hijo
de Zera, de la tribu de Judá, fue elegido. \bibleverse{19} Entonces
Josué le dijo a Acán: ``Hijo mío, honra a Jehová, el Dios de Israel, y
confiesa. Dime lo que has hecho. No me lo ocultes''.

\bibleverse{20} ``¡Es verdad!'' respondió Acán. ``He pecado contra el
Señor, el Dios de Israel. Yo lo he hecho. \bibleverse{21} A Entre el
...
\bibleverse{22} Josué envió hombres que corrieron a revisar la tienda.
Encontraron lo que estaba escondido, con la plata enterrada aún más
profundamente. \bibleverse{23} Los hombres sacaron las cosas de la
tienda y se las llevaron a Josué y a todos los israelitas. Allí las
extendieron ante el Señor. \bibleverse{24} Entonces Josué, con todos los
...
\bibleverse{25} Entonces Josué dijo a Acán: ``¿Por qué nos has traído
...
quemaron sus cuerpos. \bibleverse{26} Colocaron sobre él un gran montón
...
\bibleverse{1} El Señor le dijo a Josué: ``¡No tengas miedo ni te
...
\bibleverse{2} Harás con Hai y su rey lo mismo que hiciste con Jericó y
su rey. Sin embargo, esta vez podrán quedarse con el botín y el ganado.
Preparen una emboscada detrás de la ciudad''.

\bibleverse{3} Así que Josué y todo el pueblo se prepararon para atacar
a Hai. Escogió a treinta mil de sus mejores combatientes y los envió de
noche. \bibleverse{4} Les ordenó: ``Pongan una emboscada detrás de la
ciudad, no muy lejos. Todos deben estar preparados. \bibleverse{5}
...
nosotros huiremos de ellos. \bibleverse{6} Nos perseguirán mientras los
alejamos de la ciudad, porque se dirán unos a otros: `Están huyendo de
nosotros igual que antes'. \footnote{\textbf{8:6} Jos 7,5}
\bibleverse{7} Mientras nosotros huimos de ellos, ustedes se levantarán
de sus posiciones de emboscada y tomarán la ciudad, pues el Señor Dios
se las entregará. \bibleverse{8} Una vez que hayan capturado la ciudad,
préndanle fuego, como lo ha ordenado el Señor. Sigan sus órdenes''.

\bibleverse{9} Josué los envió, y fueron a tender una emboscada entre
Betel y el lado occidental de Hai. Pero esa noche Josué se quedó con el
pueblo en el campamento. \bibleverse{10} A la mañana siguiente, Josué se
levantó temprano, reunió al pueblo y subió a atacar a Hai, acompañado
por los ancianos de Israel. \bibleverse{11} Todos los combatientes que
estaban con él se acercaron al frente de la ciudad y acamparon allí, en
el lado norte, con un valle entre ellos y Hai. \bibleverse{12} Tomó unos
cinco mil hombres y los puso en emboscada entre Betel y Hai, al oeste de
la ciudad. \bibleverse{13} Así que el ejército tomó sus posiciones: el
...
\bibleverse{14} En cuanto el rey de Hai se percató de la situación,
...
\bibleverse{15} Josué y los israelitas se dejaron llevar y huyeron en
dirección al desierto. \bibleverse{16} Todos los hombres de la ciudad
fueron llamados a salir a perseguirlos, y mientras perseguían a Josué,
se alejaron de la ciudad. \bibleverse{17} No quedó un solo hombre en Hai
...
\bibleverse{18} Entonces el Señor le dijo a Josué: ``Levanta la lanza
...
\bibleverse{19} En cuanto vieron esta señal, los hombres que estaban
emboscados se levantaron y entraron corriendo en la ciudad. La
capturaron y rápidamente le prendieron fuego. \bibleverse{20} Cuando los
...
sus perseguidores. \bibleverse{21} Cuando Josué y los israelitas vieron
...
\bibleverse{22} Los hombres de la emboscada también salieron de la
...
hombre sobrevivió o pudo escapar. \bibleverse{23} Sólo el rey de Hai fue
...
\bibleverse{24} Cuando los israelitas terminaron de matar a los hombres
...
a la ciudad y mató a todos los que vivían allí. \bibleverse{25} Los
muertos de aquel día, contando hombres y mujeres, fueron doce mil,
quienes eran todos los habitantes de Hai. \bibleverse{26} Porque Josué
...
\bibleverse{27} Los israelitas sólo se llevaron el ganado y el botín de
la ciudad, como el Señor le lo había ordenado a Josué. \bibleverse{28}
...
\bibleverse{29} Mató al rey de Hai y colgó su cuerpo en un árbol hasta
...
\bibleverse{30} Luego Josué construyó un altar en el monte Ebal para el
Señor, el Dios de Israel. \footnote{\textbf{8:30} Deut 27,2-8}
\bibleverse{31} Hizo lo que Moisés, el siervo del Señor, le había dicho
...
sacrificios de comunión al Señor. \bibleverse{32} Allí, en presencia de
los israelitas, Josué inscribió en las piedras una copia de la Ley de
Moisés. \bibleverse{33} Todos los israelitas, los ancianos, los
...
\bibleverse{34} Entonces Josué leyó en voz alta toda la Ley: todas las
bendiciones y maldiciones registradas en el libro de la Ley.
\bibleverse{35} Josué leyó cada palabra de las instrucciones de Moisés a
...
\bibleverse{1} Todos los reyes al oeste del Jordán se enteraron de lo
...
\bibleverse{2} Así que se reunieron para luchar juntos como un ejército
...
\bibleverse{3} Pero cuando el pueblo de Gabaón se enteró de lo que Josué
le había hecho a Jericó y a Hai, \bibleverse{4} decidieron un plan
...
remendados. \bibleverse{5} Se pusieron sandalias gastadas que habían
sido remendadas y llevaban ropas viejas. Todo su pan estaba seco y
enmohecido.\footnote{\textbf{9:5} O ``se desmoronó''.} \bibleverse{6} Se
...
\bibleverse{7} Pero los israelitas dijeron a los heveos: ``Tal vez
ustedes vivan cerca. Si es así, no podemos hacer un tratado con
ustedes''. \footnote{\textbf{9:7} Jos 11,19; Éxod 23,32}

\bibleverse{8} ``Somos sus siervos'', respondieron. ``Pero ¿quiénes son
ustedes? ¿De dónde vienen?'' preguntó Josué.

\bibleverse{9} ``Nosotros tus siervos hemos venido de una tierra
lejana'', respondieron. ``Porque hemos oído hablar de la reputación del
Señor, su Dios, y de todo lo que hizo en Egipto, \bibleverse{10} y de lo
...
Hesbón, y a Og, rey de Basán, que gobernaba en Astarot.\footnote{\textbf{9:10}
  ...
  venido de un país lejano.} \bibleverse{11} Así que nuestros
...
\bibleverse{12} `Miren este pan. Estaba caliente cuando lo sacamos de
nuestras casas el día que salimos para venir aquí. Pero ahora está seco
y mohoso, como pueden ver. \bibleverse{13} Estos odres eran nuevos
...
\bibleverse{14} Los israelitas probaron algunos de los alimentos. Sin
embargo, no consultaron al Señor. \footnote{\textbf{9:14} Núm 27,21}
\bibleverse{15} Entonces Josué hizo un tratado con ellos, prometiendo
...
\bibleverse{16} Tres días después de haber hecho el tratado, los
israelitas se enteraron de que los gabaonitas vivían cerca, ¡justo en
medio de ellos! \bibleverse{17} Entonces los israelitas partieron para
ir a las ciudades gabaonitas, y llegaron allí al tercer día. Las
ciudades eran Gabaón, Cafira, Berot y Quiriat Yearín. \bibleverse{18}
...
\bibleverse{19} Pero los líderes respondieron al pueblo: ``Les hemos
jurado por el Señor, el Dios de Israel, así que ahora no podemos
ponerles la mano encima. \bibleverse{20} Así que esto es lo que vamos a
...
romper el juramento que les hicimos''. \footnote{\textbf{9:20} 2Sam
  21,1-2} \bibleverse{21} Los líderes concluyeron: ``Déjenlos vivir''.
...
\bibleverse{22} Entonces Josué convocó a los gabaonitas y les preguntó:
``¿Por qué nos han engañado? ¡Nos dijeron que vivíamos lejos de ustedes,
pero resulta que ustedes viven al lado de nosotros! \bibleverse{23}
...
\bibleverse{24} Entonces ellos le respondieron a Josué: ``A nosotros,
...
\bibleverse{25} Ahora estamos en tus manos. Haz con nosotros lo que
consideres justo y correcto''.

\bibleverse{26} Josué hizo lo que había dicho. Los salvó de los
israelitas, para que no los mataran. \bibleverse{27} Aquel día Josué los
...
\bibleverse{1} Adonisedec, rey de Jerusalén, se enteró de que Josué
...
\footnote{\textbf{10:1} Jos 8,-1; Jos 9,1-9} \bibleverse{2} El pueblo de
...
que Hai, y sus hombres eran fuertes luchadores. \bibleverse{3} Así que
...
diciendo: \bibleverse{4} ``Vengan y ayúdenme a atacar a Gabaón porque
han hecho la paz con Josué y los israelitas''. \bibleverse{5} Así que
...
Gabaón y comenzaron su ataque. \bibleverse{6} Los gabaonitas enviaron un
...
\bibleverse{7} Así que Josué, con todos sus hombres de combate y sus
mejores combatientes, partió de Gilgal. \bibleverse{8} El Señor le dijo
a Josué: ``No tengas miedo de ellos, porque los vencerás. Ni uno solo
podrá enfrentarse a ti''.

\bibleverse{9} Al marchar toda la noche desde Gilgal, Josué llegó sin
avisar. \bibleverse{10} El Señor hizo entrar en pánico a los ejércitos
...
\bibleverse{11} Mientras huían de los israelitas por la ladera de Bet
...
\bibleverse{12} El día en que el Señor entregó a los amorreos a los
...
\bibleverse{13} El sol dejó de moverse y la luna se quedó quieta, hasta
...
del cielo y no se puso durante un día entero. \footnote{\textbf{10:13}
  Hab 3,11; 2Sam 1,18} \bibleverse{14} Nunca antes ni después hubo un
...
\bibleverse{15} Entonces Josué y todo el ejército regresaron al
...
\bibleverse{16} Los cinco reyes habían huido y se habían escondido en
una cueva en Maceda. \bibleverse{17} Cuando Josué se enteró de que los
cinco reyes se habían escondido en una cueva en Maceda,

\bibleverse{18} dio esta orden: ``Haz rodar algunas piedras grandes para
bloquear la entrada de la cueva y haz que algunos hombres la vigilen.
\bibleverse{19} Pero no te quedes allí. Persigue al enemigo y atácalo
...
\bibleverse{20} Así, Josué y los israelitas los derrotaron totalmente,
abatiéndolos y matándolos. Sólo unos pocos sobrevivieron y escaparon a
sus ciudades. \bibleverse{21} El ejército regresó con Josué al
...
israelitas.\footnote{\textbf{10:21} En otras palabras, los pueblos
  ...
  atacarlos.} \bibleverse{22} Entonces Josué dijo: ``Abran la entrada de
la cueva y saquen de ella a los cinco reyes''.

\bibleverse{23} Así lo hicieron, sacando a los cinco reyes de la cueva:
los reyes de Jerusalén, Hebrón, Jarmut, Laquis y Eglón. \bibleverse{24}
...
\bibleverse{25} Josué les dijo: ``¡Nuncantengan miedo ni se desanimen!
¡Sean fuertes y valientes! Porque el Señor va a hacer lo mismo con todos
los enemigos que ustedes van a combatir''

\bibleverse{26} Entonces Josué mató a los reyes y colgó sus cuerpos en
cinco árboles y los dejó allí colgados hasta el atardecer.\footnote{\textbf{10:26}
  Véase Deuteronomio 21:22-23.} \bibleverse{27} Al ponerse el sol, Josué
...
\bibleverse{28} Ese día Josué capturó a la ciudad de Maceda, matando a
...
\bibleverse{29} Entonces Josué y el ejército israelita salieron de
Maceda y fueron a atacar Libna, \bibleverse{30} y el Señor le entregó la
...
\bibleverse{31} Entonces Josué y el ejército israelita pasaron de Libna
a Laquis, rodearon la ciudad y la atacaron. \bibleverse{32} El Señor
...
en Libna. \bibleverse{33} Entonces Horam, rey de Gezer, vino con su
ejército a ayudar a Laquis, pero Josué y sus hombres los mataron, sin
dejar sobrevivientes.

\bibleverse{34} Josué y el ejército israelita avanzaron desde Laquis
hasta Eglón, rodeando la ciudad y atacándola. \bibleverse{35} Ese mismo
...
\bibleverse{36} Josué y el ejército israelita dejaron Eglón y fueron a
atacar Hebrón. \bibleverse{37} Capturaron la ciudad, así como los
...
\bibleverse{38} Entonces Josué y el ejército israelita se volvieron y
fueron a atacar Debir. \bibleverse{39} La capturó, así como a su rey y a
...
de Debir como había matado al rey de Libna. \bibleverse{40} Así, Josué
...
\footnote{\textbf{10:40} Núm 21,2; Deut 20,16-18} \bibleverse{41} Josué
...
\footnote{\textbf{10:41} Jos 11,16} \bibleverse{42} Todos los reyes y
...
Señor, el Dios de Israel, luchaba por los israelitas. \footnote{\textbf{10:42}
  Jos 10,14} \bibleverse{43} Josué y el ejército israelita regresaron
...
\bibleverse{1} Cuando Jabín, rey de Hazor, se enteró de lo sucedido,
envió un mensaje\footnote{\textbf{11:1} Una llamada a las armas.} a
Jobab, rey de Madón, a los reyes de Simrón y Ajsaf, \bibleverse{2} y a
...
\bibleverse{3} a los reyes de los cananeos, tanto al este como al oeste,
...
tierra de Mizpa. \bibleverse{4} Todos sus ejércitos se reunieron, una
vasta horda tan numerosa como la arena de la orilla del mar, junto con
muchísimos caballos y carros. \bibleverse{5} Todos estos reyes unieron
...
\bibleverse{7} Josué y el ejército israelita fueron y los atacaron sin
previo aviso en las aguas de Merón. \bibleverse{8} El Señor los entregó
...
\bibleverse{9} Después Josué hizo lo que el Señor le había ordenado:
...
\bibleverse{10} Entonces Josué se volvió contra Hazor. La capturó y mató
...
reinos.\footnote{\textbf{11:10} El rey de Hazor había sido el líder de
  la coalición contra Israel-véase 10:1.} \bibleverse{11} Josué hizo
...
\bibleverse{12} Josué capturó todas estas ciudades y mató a sus reyes.
Las apartó y las destruyó por completo, como lo había ordenado Moisés,
el siervo del Señor. \bibleverse{13} Sin embargo, Israel no quemó
ninguna de las ciudades construidas sobre montículos, excepto Hazor, que
Josué sí quemó. \bibleverse{14} Los israelitas sí tomaron para sí todo
...
\bibleverse{15} Como el Señor había instruido a Moisés, así Moisés había
...
\bibleverse{16} Así, Josué conquistó toda la tierra: la región
...
\bibleverse{17} Esto abarcaba la tierra desde el monte Halac que lleva a
...
\bibleverse{18} Josuélibró una larga guerra con todos estos reyes.
\bibleverse{19} Ni un solo pueblo hizo la paz con los israelitas,
excepto los heveos, los habitantes de Gabaón. Todos los demás fueron
conquistados en batalla. \bibleverse{20} Porque el Señor los hizo
...
\bibleverse{21} Durante este tiempo Josué también aniquiló a los
...
apartó y destruyó completamente sus ciudades, \footnote{\textbf{11:21}
  Núm 13,22; Deut 1,28} \bibleverse{22} y no quedaron descendientes de
...
\footnote{\textbf{11:22} 1Sam 17,4} \bibleverse{23} Así que Josué tomó
...
\bibleverse{1} Estos son los reyes que los israelitas derrotaron cuando
...
tierra del lado oriental del Jordán. \bibleverse{2} Sehón, rey de los
...
\footnote{\textbf{12:2} Núm 21,24} \bibleverse{3} Su territorio también
...
sur hasta las laderas de Pisga. \bibleverse{4} El rey Og de Basán, uno
de los últimos de los refaítas, que vivía en Astarot y Edrei,
\bibleverse{5} gobernaba en el norte, desde el monte Hermón hasta
...
frontera de Sehón, rey de Hesbón. \bibleverse{6} Moisés, el siervo del
...
\bibleverse{7} Estos son los reyes de la tierra que Josué y los
...
\bibleverse{8} La tierra incluía la región montañosa, las estribaciones,
...
\bibleverse{9} El rey de Jericó. El rey de Hai, cerca de Betel.
...
\bibleverse{11} El rey de Jarmut. El rey de Laquis. \footnote{\textbf{12:11}
  Jos 10,3} \bibleverse{12} El rey de Eglón. El rey de Gezer.
\footnote{\textbf{12:12} Jos 10,3; Jos 10,26; Jos 10,33} \bibleverse{13}
El rey de Debir. El rey de Geder. \footnote{\textbf{12:13} Jos 10,39;
  Jue 1,11} \bibleverse{14} El rey de Horma. El rey de Arad. \footnote{\textbf{12:14}
  Jue 1,17; Núm 21,1} \bibleverse{15} El rey de Libna. El rey de Adulam.
\footnote{\textbf{12:15} Jos 10,29-30} \bibleverse{16} El rey de Maceda.
El rey de Betel. \footnote{\textbf{12:16} Jos 10,28} \bibleverse{17} El
rey de Tappúajh. El rey de Hefer. \bibleverse{18} El rey de Afec. El rey
de Lasharon. \footnote{\textbf{12:18} Jos 15,53; 1Sam 4,1}
\bibleverse{19} El rey de Madón. El rey de Hazor. \footnote{\textbf{12:19}
  Jos 11,1; Jos 11,10} \bibleverse{20} El rey de Simrón-merón. El rey de
Acsaf. \footnote{\textbf{12:20} Jos 11,1}

\bibleverse{21} El rey de Taanac. El rey de Meguido. \bibleverse{22} El
rey de Cedes. El rey de Jocneam en el Carmelo. \bibleverse{23} El rey de
Doren Nafat-dor. El rey de Goim en Gilgal.\footnote{\textbf{12:23} La
  Septuaginta dice ``Galilea''.} \bibleverse{24} El rey de Tirsa. El
...
\bibleverse{1} Habían pasado muchos años y Josué había envejecido. El
Señor le habló diciendo: ``Ya eres un anciano, pero aún te queda mucha
tierra por conquistar.

\bibleverse{2} ``Esta es la tierra que queda: el territorio de todos los
filisteos y de todos los gesureos, \bibleverse{3} desde el río Sihor, en
...
avvitas \bibleverse{4} en el sur, toda la tierra de los cananeos, y
Meará que pertenece a los sidonios, hasta Afec en la frontera con los
amorreos, \bibleverse{5} así como la tierra de los giblitas y la zona
del Líbano desde la ciudad de Baal-gad hasta las laderas del monte
Hermón hasta Lebo-hamat, \bibleverse{6} Y todos los que viven en la
...
israelitas. Sólo asigna la tierra a Israel para que la posea,\footnote{\textbf{13:6}
  ...
  Jos 11,8} \bibleverse{7} Así que reparte esta tierra entre las nueve
...
\bibleverse{8} La otra mitad de la tribu de Manasés, y las tribus de
...
Señor. \bibleverse{9} Se extendía desde Aroer, al borde del valle de
Arnón, desde la ciudad situada en medio del valle, y toda la meseta de
Medeba, hasta Dibón; \bibleverse{10} y todas las ciudades que
pertenecían a Sehón, rey de los amorreos, que gobernaba en Hesbón, hasta
la frontera con los amonitas. \bibleverse{11} Además, incluía Galaad, la
tierra de los guesuritas y de los maacatitas, todo el monte Hermón y
todo Basán hasta Salecá, \bibleverse{12} así como toda la tierra del
...
\bibleverse{13} Pero los israelitas no habían expulsado a los
gueshuritas ni a los maacateos, que aún viven entre ellos hasta el día
de hoy. \bibleverse{14} Moisés no asignó ninguna tierra a los levitas.
...
\bibleverse{15} Esta fue la tierra que Moisés asignó a la tribu de
Rubén, por familias: \footnote{\textbf{13:15} Núm 32,-1} \bibleverse{16}
...
\bibleverse{17} Hesbón y todas las ciudades en la meseta -Dibón, Bamot
Baal, Bet Baal Meón, \bibleverse{18} Jahaza, Cedemot, Mefaat,
\bibleverse{19} Quiriatáim, Sibma, Zeret-Sahar, en una colina del valle,
\bibleverse{20} Bet Peor, las laderas de Pisga, Bet Jesimot,
\bibleverse{21} todas las ciudades de la meseta y todo el reino de
...
\bibleverse{22} Al mismo tiempo, los israelitas mataron a Balaam, hijo
de Beor, el adivino, junto con los demás que fueron sacrificados.
\footnote{\textbf{13:22} Núm 22,5; Núm 31,8}

\bibleverse{23} El Jordán era el límite de la tribu de Rubén. Esta era
la tierra, las ciudades y las aldeas, asignadas a la tribu de Rubén, por
familias.

\bibleverse{24} Esta fue la tierra que Moisés asignó a la tribu de Gad,
por familias: \bibleverse{25} Su territorio era Jazer, todas las
...
\bibleverse{26} que se extendía desde Hesbón hasta Ramat-mizpa y
Betonim, y desde Mahanaim hasta la región de Debir. \bibleverse{27} I En
...
hacia el este. \bibleverse{28} Esta era la tierra, las ciudades y las
aldeas, asignadas a la tribu de Gad, por familias.

\bibleverse{29} Esta fue la tierra que Moisés asignó a la media tribu de
Manasés, es decir, a la mitad de la tribu de los descendientes de
Manasés, por familias: \bibleverse{30} Su territorio se extendía desde
Manahaim por todo Basán, todo el reino de Og y todas las ciudades de
Jair en Basán: sesenta en total. \bibleverse{31} También incluía Galaad,
...
\bibleverse{32} Estas fueron las asignaciones que hizo Moisés cuando
estuvo en las llanuras de Moab, al otro lado del Jordán, al este de
Jericó. \bibleverse{33} Sin embargo, Moisés no asignó ninguna tierra a
...
\bibleverse{1} Esta fue la tierra que se asignó a los israelitas para
...
hijo de Nun, y los jefes de las tribus. \footnote{\textbf{14:1} Núm
  34,17} \bibleverse{2} La decisión sobre el reparto de la tierra entre
las nueve tribus y media se hizo echando suertes, como el Señor había
instruido a Moisés. \footnote{\textbf{14:2} Núm 26,55} \bibleverse{3}
...
ellas. \footnote{\textbf{14:3} Jos 13,14-33} \bibleverse{4} Los
...
\footnote{\textbf{14:4} Jos 21,-1} \bibleverse{5} Así que los israelitas
...
\bibleverse{6} Los líderes de la tribu de Judá se acercaron a Josué en
...
de mí y de ti. \bibleverse{7} Yo tenía cuarenta años cuando Moisés, el
...
regresé, dije la verdad en mi informe. \footnote{\textbf{14:7} Núm 13,6;
  Núm 13,30} \bibleverse{8} Pero los que iban conmigo hicieron que
nuestro pueblo tuviera miedo. Sin embargo, he seguido fielmente al
Señor, mi Dios. \bibleverse{9} En ese momento Moisés me hizo una promesa
...
\bibleverse{10} Mira: el Señor me ha mantenido con vida estos últimos
...
ochenta y cinco años, \bibleverse{11} pero sigo siendo tan fuerte como
cuando Moisés me envió. Soy tan fuerte y estoy listo para la batalla o
para lo que pueda venir como lo era entonces. \bibleverse{12} Así que
...
\bibleverse{13} Así que Josué bendijo a Caleb y le concedió la propiedad
de Hebrón. \footnote{\textbf{14:13} Jos 15,13-19; Jos 21,11-12}
\bibleverse{14} Así que Hebrón perteneció a Caleb, hijo de Jefone el
cenecista, desde aquel día hasta hoy, porque había seguido fielmente al
Señor, el Dios de Israel. \bibleverse{15} (Hebrón se llamaba antes
...
\bibleverse{1} Esta fue la tierra asignada a la tribu de Judá, por
...
\bibleverse{2} Su frontera comenzaba\footnote{\textbf{15:2} Muchas de
...
que mira hacia el sur --- \bibleverse{3} Hai luego iba hacia el sur del
...
allí subía hasta Adar y luego giraba hacia Carca, \bibleverse{4} pasando
por Azmon y saliendo al Wadi de Egipto, terminando en el mar.\footnote{\textbf{15:4}
  El mediterráneo.} Esta era su frontera sur. \bibleverse{5} La frontera
...
termina el Jordán, \bibleverse{6} hasta el límite de Bet-Joglá, y luego
al norte de Bet-arabá hasta la Piedra de Bohán (hijo de Rubén).
\footnote{\textbf{15:6} Jos 18,17} \bibleverse{7} Desde allí iba hasta
...
hasta las aguas de En-semes y hasta En-rogel. \footnote{\textbf{15:7}
  2Sam 17,17} \bibleverse{8} El límite pasaba entonces por el valle de
...
Hinón hasta el extremo norte del valle de Refayín. \footnote{\textbf{15:8}
  2Cró 28,3} \bibleverse{9} Desde allí, el límite iba desde la cima de
...
monte Efrón. Luego se doblaba hacia Balá (Quiriath-Yearín). \footnote{\textbf{15:9}
  Jos 15,60} \bibleverse{10} Luego el límite daba la vuelta al oeste de
...
\bibleverse{11} El límite seguía hasta la ladera norte de Ecrón y se
doblaba hacia Siquerón, pasando por el monte Balá, hasta Jabneel y
terminaba en el mar. \bibleverse{12} El límite occidental era la costa
...
\bibleverse{13} El Señor le había ordenado a Josué que asignara algunas
...
\footnote{\textbf{15:13} Jos 14,6-15; Jue 1,10-15} \bibleverse{14} Caleb
...
de Anac.\footnote{\textbf{15:14} Véase Números 13:22. Dado que estos
  ...
  de nombres para los grupos familiares más grandes.} \bibleverse{15}
Desde allí fue a atacar a los habitantes de Debir (antes conocida como
Quiriat-sefer). \bibleverse{16} Caleb anunció: ``Al que ataque a
Quiriat-sefer y lo capture, le daré a mi hija Acsa para que se case con
él''. \bibleverse{17} Otniel, hijo de Quenaz, hermano de Caleb, capturó
la ciudad, por lo que Caleb le dio a su hija Acsa para que se casara.
\bibleverse{18} Cuando ella se acercó,\footnote{\textbf{15:18} Algunos
...
\bibleverse{19} Ella respondió: ``Por favor, dame una bendición. Ya que
...
\bibleverse{20} Esta fue la tierra asignada a la tribu de Judá, por
familias. \bibleverse{21} Las ciudades para la tribu de Judá en el
extremo sur, en la frontera con Edom: Cabzeel, Edar, Jagur,
\bibleverse{22} Quiná, Dimoná, Adadá, \bibleverse{23} Cedes, Jazor,
Itnán, \bibleverse{24} Zif, Telén, Bealot, \bibleverse{25} Jazor-jadatá,
Queriot-Jezrón (o Jazor), \bibleverse{26} Amán, Semá, Moladá,
\bibleverse{27} Jazar-Gadá, Hesmón, Bet-pelet, \bibleverse{28}
Jazar-súal, Beerseba, Biziotiá, \bibleverse{29} Balá, Iyín, Esen,
\bibleverse{30} Eltolad, Quesil, Jormá, \bibleverse{31} Siclag, Madmana,
Sansaná, \bibleverse{32} Lebaot, Sijín, Ayín, y Rimón, es decir,
veintinueve ciudades con sus aldeas. \bibleverse{33} Las ciudades de las
estribaciones occidentales: Estaol, Zora, Asena, \bibleverse{34} Zanoa,
Enganín, Tapúaj, Enam, \bibleverse{35} Jarmut, Adulán, Soco, Azeca,
\bibleverse{36} Sajarayin, Aditatin, Guederá, y Guederotayin, es decir,
diez ciudades con sus aldeas. \bibleverse{37} También: Zenán, Jadasá,
Migdal-gad, \bibleverse{38} Dileán, Mizpa, Joctel, \bibleverse{39}
Laquis, Bocat, Eglón, \bibleverse{40} Cabón, Lajmás, Quitlís,
\bibleverse{41} Guederot, Bet-dagón, Noamá, y Maceda, es deicr, diez
ciudades con sus aldeas. \bibleverse{42} Además: Libná, Éter, Asán,
\bibleverse{43} Jifta, Asena, Nezib, \bibleverse{44} Queilá, Aczib y
Maresá. Es decir, nueve ciudades con sus aldeas. \footnote{\textbf{15:44}
  Jos 19,29} \bibleverse{45} Ecrón, con sus ciudades y aldeas,
\footnote{\textbf{15:45} 1Sam 5,10} \bibleverse{46} desde Ecrón hasta el
mar las ciudades cercanas a Asdod y sus aldeas, \bibleverse{47} Asdod y
...
Wadi de Egipto, y a lo largo de la costa del mar. \footnote{\textbf{15:47}
  1Sam 5,1; Jue 1,18; Núm 34,6} \bibleverse{48} En la región de las
colinas: Samir, Jatir, Soco, \bibleverse{49} Daná, Quiriat Saná (o
Debir), \bibleverse{50} Anab, Estemoa, Anín, \bibleverse{51} Gosén,
Holón y Guiló. Es decir, once ciudades con sus aldeas. \bibleverse{52}
También: Arab, Dumá, Esán, \bibleverse{53} Yanún, Bet-tapúaj, Afecá,
\bibleverse{54} Humtá, Quiriat-arba (o Hebrón), y Sior. Es decir, nueve
ciudades con sus aldeas. \bibleverse{55} Además: Maón, Carmelo, Zif,
Yutá, \bibleverse{56} Jezrel, Jocdeán, Zanoa, \bibleverse{57} Caín,
Guibeá y Timná. Es deicr, diez ciudades con sus aldeas. \bibleverse{58}
También: Jaljul, Betsur, Guedor, \bibleverse{59} Marat, Beth Anot y
Eltecón. Es decir, seis ciudades con sus aldeas. \bibleverse{60} Además:
Quiriat Baal (o Quiriat-Yearín) y Rabá. Es decir, dos ciudades con sus
aldeas. \bibleverse{61} En el desierto: Bet-arabá, Midín, Secacá,
\bibleverse{62} Nibsán, la Ciudad de la Sal, y Engadi. Es decir, seis
ciudades con sus aldea.

\bibleverse{63} Sin embargo, la tribu de Judá no pudo expulsar a los
...
\bibleverse{1} La frontera para el reparto a los descendientes de José
...
Betel. \bibleverse{2} Desde Betel (o Luz) continuaba hasta el límite de
Atarot el arquita. \bibleverse{3} Luego descendía hacia el oeste hasta
el límite de los jafletitas y el límite de la parte baja de Bet-horón,
hasta Gezer, y luego hasta el mar. \bibleverse{4} Esta fue la asignación
...
\bibleverse{5} Este fue el territorio asignado a la tribu de Efraín, por
familias. El límite de su asignación iba desde Atarot-addar, en el este,
hasta la parte alta de Bet-horón \bibleverse{6} y luego hasta el mar.
Desde Micmetat, en el norte, el límite giraba hacia el este, pasando por
Tanat-Siló, al este de Janoa. \bibleverse{7} Desde Janoa bajaba hasta
Atarot y Nará, luego tocaba Jericó y terminaba en el Jordán.
\bibleverse{8} Desde Tapúaj, el límite corría hacia el oeste hasta el
arroyo de Caná y luego salía al mar. Esta era la tierra asignada a la
tribu de Efraín, por familias. \bibleverse{9} También se le asignaron a
la tribu de Efraín algunas ciudades con sus aldeas que estaban en la
tierra asignada a la tribu de Manasés. \bibleverse{10} Sin embargo, no
...
\bibleverse{1} Esta fue la asignación a la tribu de Manasés, el hijo
...
Galaad y Basán ya le habían sido asignados. \footnote{\textbf{17:1} Núm
  26,29; Jos 13,31} \bibleverse{2} La asignación fue para el resto de la
...
\bibleverse{3} Pero Zelofehad, hijo de Héfer, hijo de Galaad, hijo de
...
eran Majlá, Noa, Joglá, Milca y Tirsá. \footnote{\textbf{17:3} Núm
  26,33; Núm 27,1} \bibleverse{4} Se acercaron al sacerdote Eleazar, a
...
como el Señor había ordenado. \bibleverse{5} En consecuencia, Manasés
recibió diez cuotas de tierra junto a la tierra de Galaad y Basán, al
otro lado del Jordán, \bibleverse{6} porque las hijas de la tribu de
...
\bibleverse{7} Elterritorio de la tribu de Manasés iba desde Aser hasta
Micmetat, cerca de Siquem, y luego hacia el sur hasta el manantial de
Tappúaj. \bibleverse{8} La tierra alrededor de Tapúajle fue asignada a
Manasés, pero la ciudad de Tappúaj, que estaba en la frontera de la
tierra de Manasés, fue asignada a Efraín. \bibleverse{9} Desde allí la
...
\bibleverse{10} Al sur, la tierra pertenecía a Efraín, y al norte, a
Manasés. El mar era el límite. Al norte limitaba con Aser, y al oriente
con Isacar. \bibleverse{11} Las siguientes ciudades con sus aldeas le
...
Meguido.\footnote{\textbf{17:11} El hebreo al final del verso es difícil
  ...
  1Sam 28,7} \bibleverse{12} Pero los descendientes de Manasés no
...
\bibleverse{13} Sin embargo, más tarde, cuando los israelitas se
...
\bibleverse{14} Entonces los descendientes de José se acercaron a Josué
...
\bibleverse{15} Josué les dijo: ``Si son tantos, si la región montañosa
...
\bibleverse{16} Los descendientes de Josué respondieron: ``La región
...
\bibleverse{17} Josué ledijo a las tribus de Efraín y Manasés, los
descendientes de José: ``Como son tantos y tan fuertes, se les dará más
que una parte. \bibleverse{18} Seles asignará además la región
...
\bibleverse{1} La tierra había sido sometida\footnote{\textbf{18:1}
...
Reunión.\footnote{\textbf{18:1} El Tabernáculo.} \bibleverse{2} Sin
...
asignaciones de tierras.\footnote{\textbf{18:2} De lo que sigue se
  ...
  falta de deseo de ir a tomar posesión de ella.} \bibleverse{3}
...
sus antepasados? \bibleverse{4} Elijan a tres hombres de cada tribu y
los enviaré a explorar la tierra. Luego podrán escribir una descripción
sobre la distribución de la tierra y traérmela. \bibleverse{5} Deben
...
en el sur y la de José\footnote{\textbf{18:5} Refiriéndose a Efraín y
  Manasés.} en el norte. \bibleverse{6} Una vez que hayas escrito la
...
\bibleverse{7} ``Pero los levitas no reciben una parte, pues su función
...
\bibleverse{8} Cuando los hombres se pusieron en camino para explorar la
...
\bibleverse{9} Así que los hombres fueron y exploraron la tierra y
...
campamento de Silo \bibleverse{10} w donde Josué les echó suertes en
...
\bibleverse{11} La primera suerte echada fue para la tribu de Benjamín,
por familias. La tierra asignada estaba entre la de la tribu de Judá y
la de la tribu de José. \bibleverse{12} Su límite comenzaba en el
Jordán, iba al norte de la ladera de Jericó, al oeste a través de la
región montañosa, y salía al desierto de Bet-aven. \bibleverse{13} Luego
...
\footnote{\textbf{18:13} Gén 12,8; Gén 28,19} \bibleverse{14} Aquí el
...
ciudad de la tribu de Judá. Este era el límite occidental. \footnote{\textbf{18:14}
  Jos 15,6-9} \bibleverse{15} El límite sur comenzaba en el límite de
...
\bibleverse{16} y luego bajaba hasta el pie de la montaña que da al
...
\bibleverse{17} Desde allí se dirigía hacia el norte, hacia En-semes y
hacia Gelilot, frente a las alturas de Adumín, y luego bajó hasta la
Piedra de Bohán (hijo de Rubén). \bibleverse{18} Luego recorría la
cordillera frente al valle del Jordán, hacia el norte, y después bajaban
al mismo valle del Jordán. \bibleverse{19} Desde allí corría a lo largo
...
\bibleverse{20} El límite oriental era el Jordán. Estos eran los límites
alrededor de la tierra de la tribu de Benjamín, por familias.
\bibleverse{21} Estas eran las ciudades de la tribu de Benjamín, por
familias: Jericó, Bet-hogá, Emec-casis, \bibleverse{22} Bet-arabá,
Zemaryin, Betel, \bibleverse{23} Avīn, Pará, Ofra, \bibleverse{24}
Quefar-amoní, Ofni y Gueba. En total, doce ciudades con sus
correspondientes aldeas. \bibleverse{25} Además: Gabaón, Ramá, Beerot,
\bibleverse{26} Mizpa, Kefira, Moza, \bibleverse{27} Rekem, Irpeel,
Taralá, \bibleverse{28} Zela, Haelef, Jebús (o Jerusalén), Guibeá y
...
\bibleverse{1} Lasuerte para la segunda asignación cayó sobre la tribu
de Simeón, por familias. El territorio estaba dentro de la tierra
asignada a la tribu de Judá. \bibleverse{2} Su asignación incluía
Beerseba, Seba,\footnote{\textbf{19:2} ``Saba'': Probablemente se trata
  ...
  6.} Moladá, \bibleverse{3} Jazar-súal, Balá, Esen, \bibleverse{4}
Eltolad, Betul, Jormá, \bibleverse{5} Siclag, Bet-marcabot, Jazar-Susá,
\bibleverse{6} Bet-lebaot, y Sarujén. Es decir, trece ciudades con sus
aldeas. \bibleverse{7} También: Ayin, Rimón, Éter y Asán, es decir,
cuatro ciudades con sus aldeas, \bibleverse{8} así como todas las aldeas
...
\bibleverse{9} La asignación de la tribu de Simeón fue parte de la que
...
\bibleverse{10} Lasuerte para la tercera asignación cayó sobre la tribu
de Zabulón, por familias. El límite de su asignación comenzaba en Sarid,
\bibleverse{11} y luego iba hacia el oeste pasando por Maralá, tocaba
Dabesé y luego el arroyo cerca de Jocneán. \bibleverse{12} Siguiendo el
...
\bibleverse{13} Desde allí corría hacia el este hasta Gath-hepher,
Eth-kazin, y hasta Rimmon, y giraba hacia Neah. \bibleverse{14} Allí el
límite giraba hacia el norte, hacia Hannatón, y terminaba en el valle de
Iphtah-el. \bibleverse{15} T Las ciudades eran: Kattath, Nahalal,
Shimron, Idalah, y Bethlehem\footnote{\textbf{19:15} No el Belén cercano
  a Jerusalén.} -- doce ciudades con sus aldeas. \bibleverse{16} Este
...
\bibleverse{17} La suerte para la cuarta asignación cayó sobre la tribu
de Isacar, por familias. \bibleverse{18} Su territorio incluía estas
ciudades: Jezreel, Quesulot, Sunén, \footnote{\textbf{19:18} 2Re 4,8}
\bibleverse{19} Jafarayín, Sijón, Anajarat, \bibleverse{20} Rabit,
Cisón, Abez, \bibleverse{21} Rémet, Enganín, Enadá y Bet Pasés.
\bibleverse{22} El límite también llegaba a las ciudades de Tabor,
Sajazimá y Beth-Semes, y terminaba en el río Jordán. En total eran
dieciséis ciudades con sus aldeas. \bibleverse{23} Este fue el reparto
...
\bibleverse{24} La suerte para la quinta asignación cayó sobre la tribu
de Aser, por familias. \bibleverse{25} Su asignación incluía las
ciudades de Jelkat, Jalí, Betén, Acsaf, \bibleverse{26} Alamélec, Amad y
Miseal. Su límite llegaba hasta el Carmelo y Sijor-libnat en el oeste.
\bibleverse{27} Luego giraba hacia el este, hacia Bet-dagón, llegando a
...
seguía hasta \bibleverse{28} Ebrón,\footnote{\textbf{19:28} ``Ebrón'':
  Algunos creen que este lugar debe ser ``Abdón''} Rejob, Hamón, y Caná,
y tocaba Gran Sidón. \bibleverse{29} El límite giraba entonces hacia
...
\bibleverse{30} Uma, Afec y Rejob -- veintidósciudades con sus aldeas.
\bibleverse{31} Este fue el reparto -la tierra, las ciudades y las
...
\bibleverse{32} Lasuerte para la sexta asignación cayó sobre la tribu de
Neftalí, por familias. \bibleverse{33} Su límite comenzaba en Jélef,
junto a la encina de Sananín, y seguía hasta Adaminéqueb, Jabnel, y
continuaba hasta Lacún, terminando en el Jordán. \bibleverse{34} Luego
...
oeste y al Jordán por el este. \bibleverse{35} Las ciudades fortificadas
eran: Sidín, Ser, Jamat, Racat, Quinéret, \bibleverse{36} Adamá, Ramá,
Jazor, \bibleverse{37} Cedes, Edrey, Enjazor, \bibleverse{38} Irón,
Migdal El, Jorén, Bet Anat, y Bet Semes. En total eran diecinueve
ciudades con sus aldeas. \footnote{\textbf{19:38} Jue 1,33}
\bibleverse{39} Este fue el territorio -- latierra, las ciudades y las
...
\bibleverse{40} La suerte para la séptima asignación cayó sobre la tribu
de Dan, por familias. \bibleverse{41} Su asignación incluía las ciudades
de Zora, Estaol, Ir-semes, \bibleverse{42} Sagalbīn, Ayalón, Jetlá,
\bibleverse{43} Elón, Timná, Ecrón, \bibleverse{44} Eltequé, Guibetón,
Balat, \bibleverse{45} Jehúd, Bené Berac, Gat-rimón, \bibleverse{46}
Mejarcón, Racón, junto con el territorio frente a Jope \footnote{\textbf{19:46}
  Jon 1,3} \bibleverse{47} Sin embargo, la tribu de Dan no pudo
...
Dan, en honor a su antepasado. \footnote{\textbf{19:47} Jue 18,27; Jue
  18,29} \bibleverse{48} Este fue el territorio -- latierra, las
...
\bibleverse{49} Cuando terminaron de asignar la tierra y establecer sus
fronteras, los israelitas le dieron a Josué, hijo de Nun, una asignación
entre ellos. \bibleverse{50} Siguiendo la orden del Señor, le dieron la
...
reconstruyó la ciudad y se estableció allí. \footnote{\textbf{19:50} Jos
  24,30} \bibleverse{51} Estas fueron las asignaciones distribuidas por
...
\bibleverse{1} Entonces el Señor le dijo a Josué: \bibleverse{2} ``Dile
a los israelitas: `Asigna ciudades santuario, como te lo ordené por
medio de Moisés. \footnote{\textbf{20:2} Núm 35,6-29} \bibleverse{3}
...
vengarse.\footnote{\textbf{20:3} ``Venganza'': literalmente ``vengador
  de la sangre''.} \bibleverse{4} Cuando llegue a una de estas ciudades,
...
alojarse. \bibleverse{5} Si el que busca venganza viene a buscar al
hombre, no deben entregarle al que cometió el homicidio, porque mató a
alguien sin intención y sin odio deliberado. \bibleverse{6} Permanecerá
...
\bibleverse{7} Así que asignaron las siguientes ciudades santuario Cedes
...
de Judá. \bibleverse{8} Al otro lado del Jordán, al este de Jericó,
...
\bibleverse{9} Estasfueron las ciudades asignadas para todos los
...
\bibleverse{1} Los jefes de la tribu de Leví se acercaron al sacerdote
Eleazar, a Josué hijo de Nun y a los jefes de las tribus israelitas.
\bibleverse{2} Les hablaron en Silo, en Canaán, diciendo: ``El Señor dio
...
\bibleverse{3} Así que, siguiendo las instrucciones del Señor, los
israelitas dieron ciudades y pastos a los levitas de sus propias
asignaciones. \bibleverse{4} Se echó la suerte a las familias de los
...
ciudades de las tribus de Judá, Simeón y Benjamín.\footnote{\textbf{21:4}
  Ciudadespreviamenteasignadas.} \bibleverse{5} A las familias restantes
de los descendientes de Cota se les asignaron diez ciudades de las
tribus de Efraín, Dan y la media tribu de Manasés. \bibleverse{6} A las
...
vivían en Basán. \bibleverse{7} A las familias de los descendientes de
Merari se les asignaron doce ciudades de las tribus de Rubén, Gad y
Zabulón. \bibleverse{8} Así los israelitas dieron a los levitas por
sorteo estas ciudades y pastos, tal como el Señor lo había ordenado por
medio de Moisés. \bibleverse{9} Dieron de la tribu de Judá y de la tribu
de Simeón las siguientes ciudades, específicamente nombradas,
\bibleverse{10} a las familias de los coatitas, descendientes de Aarón,
de la tribu de Leví, ya que la primera suerte les correspondió a ellos:
\bibleverse{11} Quiriat-arba (o Hebrón), en la región montañosa de Judá,
junto con los pastos que la rodean. (Arba era el antepasado de Anac).
\footnote{\textbf{21:11} Jos 20,7} \bibleverse{12} Pero los campos más
...
\bibleverse{13} Dieron a los descendientes del sacerdote Aarón las
siguientes ciudades y sus pastos Hebrón (una ciudad santuario para los
que accidentalmente cometieran un asesinato), Libna, \bibleverse{14}
Jatir, Estemoa, \bibleverse{15} Holón, Debir, \bibleverse{16} Ain, Yutá
y Bet Semes: nueve ciudades de estas dos tribus. \footnote{\textbf{21:16}
  1Sam 6,12; 1Sam 6,15} \bibleverse{17} De la tribu de Benjamín, las
siguientes cuatro ciudades y sus pastos Gabaón, Geba, \bibleverse{18}
Anatot y Almón. \bibleverse{19} En total, trece ciudades y sus pastos
fueron entregados a los sacerdotes, los descendientes de Aarón.

\bibleverse{20} En cuanto a las demás familias de los hijos de Clota de
la tribu de Leví, se les dio por sorteo cuatro ciudades con sus pastos
de la tribu de Efraín: \bibleverse{21} Siquem en la región montañosa de
Efraín (una ciudad santuario para los que cometieran un asesinato
accidental), Gezer, \footnote{\textbf{21:21} Jos 20,7} \bibleverse{22}
Quibsayín y Bet-Jorón. \bibleverse{23} De la tribu de Dan, las
siguientes cuatro ciudades y sus pastos Eltequé, Guibetón,
\bibleverse{24} Ayalón y Gath-Rimón. \bibleverse{25} De la media tribu
de Manasés, las siguientes dos ciudades con sus pastos Tanac y
Gat-rimón. \bibleverse{26} Así que en total se dieron diez ciudades y
sus pastos a las familias restantes de los descendientes de Koat.

\bibleverse{27} Las familias de los descendientes de Gersón de la tribu
...
accidentalmente cometieron un asesinato), y Besterá. \bibleverse{28} De
la tribu de Isacar las siguientes cuatro ciudades y sus pastos: Cisón,
Daberat, \bibleverse{29} Jarmut y Enganín. \bibleverse{30} De la tribu
de Aser, las siguientes cuatro ciudades con sus pastos Miseal, Abdón,
\bibleverse{31} Jelcat y Rejob. \bibleverse{32} De la tribu de Neftalí,
...
Jamot-Dor y Cartán. \footnote{\textbf{21:32} Jos 20,7} \bibleverse{33}
En total, trece ciudades y sus pastos fueron asignados a las familias de
Gersón.

\bibleverse{34} Las familias de los descendientes de Merari, los que
quedaron de la tribu de Leví, recibieron las siguientes cuatro ciudades
y sus pastos de la tribu de Zabulón: Jocneán, Caráa, \bibleverse{35}
Dimná y Nalal. \bibleverse{36} De la tribu de Rubén, las siguientes
cuatro ciudades con sus pastos Béser, Yahaza, \bibleverse{37} Cedemot y
Mefat. \bibleverse{38} De la tribu de Gad, las siguientes cuatro
...
cometieron un asesinato accidental), Mahanaim, \footnote{\textbf{21:38}
  Jos 20,8} \bibleverse{39} Hesbón y Jazer. \bibleverse{40} Así que en
total se asignaron doce ciudades a las familias de Merari, las que
quedaban de la tribu de Leví.

\bibleverse{41} Los levitas recibieron un total de cuarenta y ocho
ciudades y pastos dentro de la tierra de los israelitas. \bibleverse{42}
...
\bibleverse{43} Así, el Señor dio a los israelitas toda la tierra que
había prometido a sus antepasados. Ellos se apoderaron de ella y se
establecieronallí. \bibleverse{44} El Señor les dio la paz\footnote{\textbf{21:44}
...
para que los derrotaran. \bibleverse{45} No faltó ni una sola de las
...
\bibleverse{1} Entonces Josué convocó a las tribus de Rubén, Gad y la
media tribu de Manasés. \bibleverse{2} Les dijo: ``Ustedes han hecho
todo lo que Moisés, el siervo del Señor, les dijo que hicieran, y han
seguido todos los mandatos que les di. \bibleverse{3} En todo este
...
\bibleverse{4} Ahora que el Señor su Dios le ha dado la paz a sus
...
\bibleverse{5} Pero asegúrense de cumplir los mandamientos y la ley, tal
...
\bibleverse{6} Josué los bendijo, los despidió y se fueron a casa.
\bibleverse{7} Moisés había dado a la media tribu de Manasés la tierra
...
\bibleverse{8} Les dijo: ``Llévense a casa todas las riquezas que se han
...
\bibleverse{9} Así que las tribus de Rubén y Gad y la media tribu de
...
orden del Señor a través de Moisés. \bibleverse{10} Cuando se acercaron
...
Jordán. \bibleverse{11} Se les dijo a los israelitas: ``Miren, las
...
pertenece a los israelitas''. \bibleverse{12} Los israelitas se
reunieron en Silo para ir a la guerra contra ellos. \bibleverse{13}
...
Galaad. \bibleverse{14} Con él iban diez jefes, uno de cada una de las
diez tribus de Israel, y cada uno el jefe de su familia. \bibleverse{15}
Cuando llegaron, les dijeron a las tribus de Rubén y Gad, y a la media
tribu de Manasés: \bibleverse{16} ``Esto es lo que dice todo el pueblo
...
\bibleverse{17} ¿No fue suficiente nuestro pecado en Peors?\footnote{\textbf{22:17}
...
\bibleverse{18} Entonces, ¿por qué se alejan ahora del Señor? Si hoy se
rebelan contra el Señor, mañana se enfadará con todos nosotros.
\bibleverse{19} ``Pero si creen que su tierra está
...
distinto del altar del Señor, nuestro Dios. \bibleverse{20} Cuando Acán,
...
\bibleverse{21} Entonces las tribus de Rubén y Gad, y la media tribu de
Manasés, respondieron a los dirigentes israelitas: \footnote{\textbf{22:21}
  Núm 1,16; Núm 10,4} \bibleverse{22} ``El Señor es Dios de
...
desleales, ¡mátennos ahora mismo! \bibleverse{23} Si nuestra acción de
...
\bibleverse{24} ``Lo hicimos porque nos preocupaba que en el futuro tus
descendientes dijeran a los nuestros: `¿Qué tienes que ver con el Señor,
el Dios de Israel? \bibleverse{25} El Señor puso una frontera -- elrío
...
\bibleverse{26} ``Así que dijimos: `Construyamos un altar, no para
holocaustos ni para sacrificios, \bibleverse{27} sino como testimonio
...
\bibleverse{28} ``Si lo hicieran en el futuro, nuestros descendientes
...
\bibleverse{29} ``Jamás se nos ocurriría rebelarnos contra el Señor o
...
\bibleverse{30} Cuando Finés y los jefes israelitas oyeron esto de las
tribus de Rubén y Gad y de la media tribu de Manasés, se
alegraron.\footnote{\textbf{22:30} ``Se alegraron'': literalmente, ``fue
  bueno a sus ojos''.} \bibleverse{31} Finés respondió a las tribus de
...
Señor''.\footnote{\textbf{22:31} Si los israelitas hubieran ido
  ...
  habría traído sobre ellos el juicio divino.} \bibleverse{32} Entonces
...
\bibleverse{33} Los israelitas se alegraron del informe y Dios los
bendijo. Ya no hablaron de ir a la guerra para destruir la tierra donde
vivían las tribus de Rubén y Gad. \bibleverse{34} Las tribus de Rubén y
...
\bibleverse{1} Mucho tiempo después, una vez que el Señor había dado la
paz a los israelitas del conflicto con los enemigos que los rodeaban,
Josué, ya siendo muy anciano, \bibleverse{2} convocó a todos los
...
\bibleverse{3} Ustedes han visto todo lo que el Señor, su Dios, ha hecho
por ustedes ante todas las naciones. El Señor, su Dios, ha luchado por
ustedes. \bibleverse{4} ``Les he asignado la tierra de las naciones
restantes para que la posean, así como las naciones ya conquistadas,
desde el Jordán hasta el Mar Mediterráneo. \bibleverse{5} El Señor, tu
...
\bibleverse{6} ``Asegúrate de observar todo lo que está escrito en el
libro de la Ley de Moisés. No te desvíes de ella, ni a la izquierda ni a
la derecha. \footnote{\textbf{23:6} Deut 5,29} \bibleverse{7} No te
...
los adores, ni te inclines ante ellos. \footnote{\textbf{23:7} Éxod
  23,13; Éxod 23,24} \bibleverse{8} Mantente cerca del Señor, tu Dios,
como has hecho hasta ahora.

\bibleverse{9} El Señor ha expulsado ante ti a naciones fuertes y
poderosas. Nadie ha podido enfrentarse a ti hasta el día de hoy.
\footnote{\textbf{23:9} Lev 26,7-8; Deut 28,7} \bibleverse{10} Uno solo
de ustedes puede ahuyentar a mil enemigos, porque el Señor, su Dios,
lucha por ustedes, como se los ha prometido. \bibleverse{11}
Procurenamar al Señor, su Dios.

\bibleverse{12} Porque si se apartan de él y siguen los caminos de las
naciones que quedan, si se unen en matrimonio, mezclándose unos con
otros, \bibleverse{13} pueden estar absolutamente seguros de que el
...
\bibleverse{14} ``Ahora estoy a punto de morir, el destino de todo ser
...
fallado. \footnote{\textbf{23:14} 1Re 2,2; Jos 21,45} \bibleverse{15}
...
\bibleverse{16} Si rompes el acuerdo que el Señor tu Dios hizo contigo y
...
\bibleverse{1} Josué convocó a todas las tribus de Israel en Siquem.
...
Dios. \bibleverse{2} Josué dijo a todo el pueblo: ``El Señor, el Dios de
...
adoraban a otros dioses. \bibleverse{3} Yo traje a tu padre Abraham
desde el otro lado del Éufrates y lo conduje por toda la tierra de
Canaán y le di muchos descendientes. Le di a Isaac. \bibleverse{4} A
...
\bibleverse{5} ``Envié a Moisés y a Aarón, e hice caer plagas sobre el
pueblo de Egipto, y te saqué a ti.\footnote{\textbf{24:5} El relato
  ...
  Éxod 3,10} \bibleverse{6} Sí, saqué a tus antepasados, pero cuando
llegaste al Mar Rojo los egipcios perseguían a tus antepasados con
carros y jinetes. \footnote{\textbf{24:6} Éxod 12,33} \bibleverse{7} Tus
...
\bibleverse{8} ``Después te llevé a la tierra de los amorreos que vivían
...
\bibleverse{9} ``Cuando Balac, hijo de Zipor, el rey de Moab, quiso
luchar contra Israel, mandó a llamar a Balaam, hijo de Beor, para que
viniera a maldecirte. \footnote{\textbf{24:9} Núm 22,-1} \bibleverse{10}
...
\bibleverse{11} ``Cruzaste el Jordán y llegaste a Jericó, donde los
...
jebuseos. \footnote{\textbf{24:11} Jos 3,14; Jos 6,1} \bibleverse{12}
...
espadas y arcos! \footnote{\textbf{24:12} Éxod 23,28} \bibleverse{13}
...
\bibleverse{14} ``Así que respeten al Señor y adórenlo, sincera y
...
allá del Éufrates y en Egipto, y adoren al Señor. \footnote{\textbf{24:14}
  Jos 24,2; Éxod 32,-1} \bibleverse{15} Pero si no quieren adorar al
...
\bibleverse{16} El pueblo respondió: ``¡Nunca abandonaremos al Señor ni
adoraremos a otros dioses! \bibleverse{17} Porque el Señor, nuestro
...
naciones. \bibleverse{18} El Señor expulsó ante nosotros a los amorreos
y a todas las demás naciones que habitaban la tierra. Así que adoraremos
al Señor, porque es nuestro Dios''.

\bibleverse{19} Josué le dijo al pueblo: ``Recuerden que el Señor es un
Dios santo y celoso. No podrán adorarle, ni perdonará su rebeldía nisus
pecados \footnote{\textbf{24:19} Deut 5,26; Éxod 20,5} \bibleverse{20}
...
\bibleverse{21} ``¡No digas eso!''\footnote{\textbf{24:21} ``¡No digas
  eso!'': literalmente, ``¡No!''} respondió el pueblo. ``¡Adoraremos al
Señor!'' \bibleverse{22} Entonces Josué advirtió al pueblo: ``Hoy se han
...
\bibleverse{23} ``Entonces desháganse de esos dioses extranjeros que
tienen y prometan ser leales sólo al Señor, el Dios de Israel'', les
dijo Josué.

\bibleverse{24} El pueblo respondió a Josué: ``Adoraremos al Señor,
nuestro Dios, y le obedeceremos''.

\bibleverse{25} Así que Josué hizo un acuerdo solemne entre el pueblo y
el Señor ese día en Siquem, obligándolos a seguir todas las leyes e
instrucciones del Señor. \footnote{\textbf{24:25} 2Re 23,3}
\bibleverse{26} Josué lo anotó en el Libro de la Ley de Dios, y colocó
una gran piedra bajo la encina, cerca del santuario del Señor.
\footnote{\textbf{24:26} Gén 35,4; Jue 9,6} \bibleverse{27} Josué dijo
...
\footnote{\textbf{24:27} Jos 22,27; Gén 31,48} \bibleverse{28} Entonces
...
\bibleverse{29} Más tarde, después de todo esto, Josué, hijo de Nun,
siervo del Señor, murió a la edad de ciento diez años. \bibleverse{30}
...
\bibleverse{31} Los israelitas siguieron adorando al Señor durante toda
...
Israel. \bibleverse{32} Los huesos de José, que los israelitas habían
...
de José. \bibleverse{33} Eleazar, hijo de Aarón, murió y lo enterraron
