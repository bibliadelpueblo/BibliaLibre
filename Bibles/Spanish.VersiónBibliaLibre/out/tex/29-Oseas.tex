...
\bibleverse{1} El Señor envió un mensaje a Oseas, hijo de Berí, en el
...
\bibleverse{2} El Señor comenzó hablando a través de Oseas diciéndole:
...
\bibleverse{3} Así que Oseas fue y se casó con Gómer, la hija de
Diblaim. Ella quedó embarazada y le dio un hijo a Oseas.

\bibleverse{4} Entonces el Señor le dijo a Oseas: ``Ponle por nombre
...
\footnote{\textbf{1:4} 2Re 10,30} \bibleverse{5} Ese día yo quebrantaré
al ejército de Israel en el valle de Jezreel''.

\bibleverse{6} Gómer volvió a quedar embarazada y esta vez tuvo una
...
\bibleverse{7} Pero tendré piedad de los de la casa de Judá y los
salvaré. Pero no será con arco ni espada, ni tampoco con guerreros de a
caballo''.

\bibleverse{8} Después que ya Gómer dejó de amamantar a Lo-ruhamah,
volvió a quedar embarazada y tuvo un hijo.

\bibleverse{9} Entonces el Señor le dijo a Oseas: ``Ponle por nombre
...
\bibleverse{10} Sin embargo,\footnote{\textbf{1:10} ``Sin embargo'' es
...
\bibleverse{11} El pueblo de Israel y el pueblo de Judá se reunirán y
...
\bibleverse{1} ``Ese día llamarás a tus hermanos Ammi, y a tus hermanas
...
\bibleverse{2} Condenen a su madre, condénenla porque no es mi esposa y
...
que se quite el maquillaje y las vestiduras provocativas.\footnote{\textbf{2:2}
  ...
  Ezeq 23,1-23} \bibleverse{3} ``De lo contrario la dejaré desnuda, tal
...
árido, y la dejaré morir de sed. \footnote{\textbf{2:10} Jer 13,22; Jer
  13,26} \bibleverse{4} No tendré piedad de sus hijos porque son hijos
de prostitución. \bibleverse{5} Pues su madre era un prostituta que los
...
me dan de beber'. \bibleverse{6} ``Por eso voy a obstaculizar su camino
con arbustos de espinas, y construiré un muro de piedra para detenerla y
que no encuentre forma de continuar. \bibleverse{7} Cuando vaya en busca
...
ahora'. \bibleverse{8} ``A ella se le olvidó que yo fui quien le dio
...
\bibleverse{9} Así que recuperaré mi grano maduro y mi nuevo vino que di
en tiempo de cosecha. Recuperaré mi lana y el lino que le di para cubrir
su desnudez. \bibleverse{10} La dejaré desnuda ante la mirada de sus
amantes, y ninguno podrá rescatarla de mi. \bibleverse{11} Pondré fin a
...
reposo, y todos sus festivales.\footnote{\textbf{2:11} Aunque las
  ...
  que en una observancia sincera.} \bibleverse{12} Destruiré sus viñedos
...
frutos que queden. \bibleverse{13} Yo la castigaré por todas las veces
...
\bibleverse{14} ``Miren lo que voy a hacer: Haré que vuelva a mi, la
llevaré al desierto, y allí hablaré a su corazón. \bibleverse{15} Le
...
joven, como cuando salió de Egipto. \footnote{\textbf{2:15} Jos 7,24-26;
  Éxod 15,1} \bibleverse{16} Ese día, dice el Señor, tú me volverás a
llamar `mi esposo' y no `mi Baal'.\footnote{\textbf{2:16} ``Mi Baal''
  ...
  un esposo, y no simplemente como su Señor.} \bibleverse{17} Haré que
deje de invocar a los baales, y sus nombres no serán mencionados nunca
más. \bibleverse{18} ``En ese momento haré un acuerdo solemne\footnote{\textbf{2:18}
...
acostarte en paz. \bibleverse{19} Serás mi esposa para siempre. Te haré
mi esposa en bondad y justicia. \footnote{\textbf{2:19} Apoc 19,7}
\bibleverse{20} Seré fiel a ti, mi esposa, y tú me reconocerás como el
Señor. \footnote{\textbf{2:20} Sal 146,6; Jer 31,34} \bibleverse{21} Ese
...
\bibleverse{22} La tierra responderá al grano, y al nuevo vino, y al
aceite de oliva y ellos responderán `Jezreel' (Dios muestra).

\bibleverse{23} Yo la `sembraré' para mi mismo en la tierra. Amaré a
...
\bibleverse{1} El Señor me dijo: ``Ve una vez más y ama a una
...
\bibleverse{2} Así que la compré de nuevo por quince siclos de plata y
un homer y medio de cebada.\footnote{\textbf{3:2} Aproximadamente el
  ...
  de otra persona.} \bibleverse{3} Y le dije: ``Debes quedarte conmigo
por muchos días, y abandonarás la prostitución. No tendrás intimidad con
ningún hombre, y entonces seré tuyo''.

\bibleverse{4} Porque el pueblo de Israel durará muchos días sin rey ni
...
idólatras.\footnote{\textbf{3:4} La frase ``sin altar de piedras, sin
  ...
  como su líder.} \footnote{\textbf{3:4} 2Cró 15,3} \bibleverse{5}
...
\bibleverse{1} ¡Escucha la palabra del Señor, pueblo de Israel, porque
...
\bibleverse{2} Por el contrario, solo hay maldiciones, mentiras,
asesinatos, robos y adulterio. Cometen actos violentos y hay gran
derramamiento de sangre. \bibleverse{3} Por causa de esto, la tierra se
...
\bibleverse{4} Pero nadie debe culpar a otro. Mi disputa es con ustedes,
los sacerdotes, pues ustedes son los responsables.\footnote{\textbf{4:4}
  ...
  a otros.} \footnote{\textbf{4:4} Deut 17,12} \bibleverse{5} Por ello
...
la noche, y yo destruiré a la madre de todos ustedes.\footnote{\textbf{4:5}
  Madre: Es decir, la nación de Israel.} \bibleverse{6} ``Mi pueblo está
...
enseñanzas, yo me olvidaré de sus hijos. \bibleverse{7} Cuantos más
...
\bibleverse{8} Ellos se alimentaban del pecado\footnote{\textbf{4:8} O
...
mi pueblo, y estaban hambrientos de su inmoralidad. \footnote{\textbf{4:8}
  Lev 6,19} \bibleverse{9} Por lo tanto, al pueblo le ocurrirá lo mismo
que a los sacerdotes: Los castigaré por lo que han hecho, y les pagaré
por sus acciones. \bibleverse{10} Comerán, pero no se sentirán saciados;
...
\bibleverse{11} Ellosdestruyen sus mentes con el vino viejo y el vino
nuevo. \bibleverse{12} ``Mi pueblo pide consejo a sus ídolos de madera y
...
abandonado a su Dios. \bibleverse{13} Ofrecen sacrificios en lo alto de
...
prostituido y tus nueras se han vuelto adúlteras. \footnote{\textbf{4:13}
  Ezeq 6,13} \bibleverse{14} No castigaré a tus hijas por prostituirse,
...
\bibleverse{15} ``Aunque tú, Israel, te has vuelto una prostituta,
...
Bet-Aven,\footnote{\textbf{4:15} Un lugar llamado Guilgal era donde los
  ...
  nada''.} ni jure diciendo: `el Señor vive'. \bibleverse{16} Si Israel
se comporta como una vaca rebelde, ¿cómo podría el Señor cuidar de
Israel como un cordero en una gran pradera? \bibleverse{17}
...
ídolos, así que déjenlo en paz! \bibleverse{18} Cuando los líderes dejan
de beber, se van y buscan prostitutas para acostarse con ellas. Se
complacen más en sus actos inmorales que en el honor. \bibleverse{19}
...
\bibleverse{1} ``¡Escuchen esto, sacerdotes! ¡Presta atención, casa de
Israel! ¡Escuchen, miembros de la failia real! \bibleverse{2} El juicio
...
hecho. \bibleverse{3} Yo conozco muy bien a Efraín, e Israel no puede
esconderse de mi, porque ahora Efraín es una prostituta e Israel se ha
contaminado. \footnote{\textbf{5:3} Os 1,2} \bibleverse{4} Sus acciones
...
\bibleverse{5} El orgullo del pueblo de Israel habla contra ellos en su
propia cara. Israel y Efraín tropezarán por su culpabilidad; y Judá
tropezará junto con ellos también. \bibleverse{6} Ellos buscarán al
...
\bibleverse{7} Ellos han sido infieles al Señor y han tenido hijos que
...
\bibleverse{8} ``¡Hagan sonar la trompeta en Guibeá! ¡Toquen la tompreta
...
frente!\footnote{\textbf{5:8} Los tres lugares mencionados están en la
  ...
  sureña de Benjamín.} \bibleverse{9} Efraín quedará desolado en el día
del castigo. Yo revelaré la verdad entre las tribus de Israel.
\bibleverse{10} Los gobernantes de Judá se han convertido en ladrones
...
\bibleverse{11} El pueblo de Efraín está aplastado y hecho pedazos a
...
humanas.\footnote{\textbf{5:11} Este versículo se ha vinculado con la
  ...
  idolatría''.} \footnote{\textbf{5:11} Is 29,13} \bibleverse{12} Yo soy
como un gusano en Efraín, y como un carcoma para el pueblo de Judá.
\bibleverse{13} ``Cuando Efraín vio cuán enfermo estaba, y Judá notó sus
propias heridas, Efraín se volvió al gran rey de Asiria para pedir su
ayuda; pero él no los pudo sanar ni curar sus heridas. \bibleverse{14}
...
\bibleverse{15} Entonces me iré y volveré de donde vine, hasta que
...
\bibleverse{1} ``¡Vamos! Volvamos al Señor. Él nos ha hecho pedazos,
pero ahora nos sanará; nos ha derribado, pero pondrá vendas en nuestras
heridas. \footnote{\textbf{6:1} Os 5,14} \bibleverse{2} En dos días nos
sanará, y después de tres días nos levantará para que podamos vivir en
su presencia. \footnote{\textbf{6:2} Deut 32,39} \bibleverse{3}
...
como la lluvia de la primavera que riega la tierra''. \bibleverse{4}
...
el rocío de la mañana. \bibleverse{5} Por eso los he reducido a través
de los profetas y los destruí con mis palabras. Mi juicio resplandece
como la luz. \footnote{\textbf{6:5} Jer 23,29} \bibleverse{6} Quiero que
...
\bibleverse{7} Pero ustedes, como Adán, quebrantaron nuestro
acuerdo,\footnote{\textbf{6:7} Literalmente, ``pacto''.} y me fueron
infieles. \footnote{\textbf{6:7} Gén 3,6} \bibleverse{8} Gilead es una
ciudad de gente malvada, donde se pueden rastrear las huellas de sangre.
\bibleverse{9} Los sacerdotes son como una cuadrilla de bandidos,
...
\bibleverse{10} He visto algo aborrecible en la casa de Israel: Efraín
...
\bibleverse{11} Y en lo que tiene que ver contigo, Judá, ha llegado tu
...
la gente en las calles. \bibleverse{2} Pero no se dan cuenta de que yo
me acuerdo de toda su maldad. Sus pecados los rodean y siempre están
delante de mi. \bibleverse{3} Alegran a su rey con su maldad, y a los
príncipes con mentiras. \bibleverse{4} Todos son adúlteros, y arden de
...
\bibleverse{8} Efraín se mezcla con otras naciones. ¡Es tan inútil como
el pan cocido a medias!\footnote{\textbf{7:8} Literalmente, ``un pan
  plano que solo se ha cocido de un lado''.} \bibleverse{9} Los
extranjeros le quitan toda su fuerza y él ni siquiera se da cuenta. Su
cabello se vuelve gris y no lo nota. \bibleverse{10} El orgullo de
Israel testifica contra él, pero a pesar de todo esto Efraín no vuelve
al Señor su Dios ni lo busca. \bibleverse{11} Efraín es como una paloma,
ingenua y sin razón, que clama a Egipto y luego va a Asiria. \footnote{\textbf{7:11}
  Os 5,13; Os 12,2} \bibleverse{12} Cuando se vaya, lanzaré mi red sobre
ellos y los atraparé como aves silvestres. Cuando los oiga volar en
bandada, los castigaré. \bibleverse{13} ¡Grande es el desastre que viene
...
calumnian. \bibleverse{14} No claman a mi con sinceridad en sus
...
\bibleverse{15} Yo mismo los entrené y los hice fuertes; y ahora
conspiran contra mi. \bibleverse{16} Se vuelven, pero no al Altísimo.
...
\bibleverse{1} ¡Pon trompeta en tus labios! Un águila\footnote{\textbf{8:1}
...
ley. \footnote{\textbf{8:1} Is 58,1} \bibleverse{2} Israel invoca a mi:
``¡Nuestro Dios, te conocemos!'' \bibleverse{3} Pero Israel ha rechazado
lo que es bueno. Un enemigo los perseguirá. \bibleverse{4} Nombraron
...
\bibleverse{5} ¡Samaria, yo aborrezco el ídolo con figura de becerro que
has hecho! ¡Mi ira arde contra ellos! ¿Hasta cuándo serán incapaces de
ser buenos? \footnote{\textbf{8:5} 1Re 12,28} \bibleverse{6} Este ídolo
...
\bibleverse{7} Los que siembran viento, cosecharán tempestad. Los tallos
...
\bibleverse{8} Israel ha sido devorado. Entre las naciones son como cosa
despreciable. \footnote{\textbf{8:8} Jer 22,28} \bibleverse{9} Han
acudido a Asiria como un asno errante y solitario. Efarín ha contratado
amantes. \footnote{\textbf{8:9} Os 5,13; Os 7,11} \bibleverse{10} Aunque
...
Etonces se retorcerán bajo el agobio del gran rey.\footnote{\textbf{8:10}
  ...
  invasores extranjeros, en especial a los asirios.} \bibleverse{11}
¡Aún cuando Efarín construyó altares para presentar ofrendas por el
pecado, se volvieron altares de pecado! \bibleverse{12} Yo les escribe
...
extranjeros.\footnote{\textbf{8:12} En otras palabras, consideraban que
  la ley no se aplicaba a ellos.} \bibleverse{13} Vienen a presentarme
...
\bibleverse{14} Israel se ha olvidado de su Hacedor y ha construido
...
\bibleverse{1} ¡No te alegres, Israel! ¡No celebres como las demás
...
\footnote{\textbf{9:1} Os 1,2} \bibleverse{2} Tus eras y lagares no te
alimentarán. La tierra no podrá producir el nuevo vino. \bibleverse{3}
No permanecerás en la tierra del Señor; en cambio Efraín volverá a
Egipto y comerá alimentos inmundos en Asiria. \bibleverse{4} Tú no
...
del Señor. \bibleverse{5} ¿Qué herán en los días de fiestas religiosas,
y de otras festividades del Señor?\footnote{\textbf{9:5} Esto puede
  ...
  que eran celebrados en el reino del sur.} \bibleverse{6} Miren, se han
...
tiendas. \footnote{\textbf{9:6} Os 10,8} \bibleverse{7} ¡Ha llegado la
...
\bibleverse{8} El Centinela de Efraín está con mi Dios. El profeta es
...
\bibleverse{9} porque se han corrompido hasta el límite, como en los
...
\bibleverse{10} Como encontrar uvas en el desierto, así fue como
...
\bibleverse{11} ¡Escucha Efraín! Así como el ave que escapa y vuela
lejos, así será tu gloria: no habrá nacimientos, embarazos ni
concepciones. \bibleverse{12} Incluso si lograsen concebir hijos, yo me
encargaré de que no sobrevivan. ¡Grande es el desastre que vendrá sobre
ti cuando yo me aleje! \bibleverse{13} ¡Escucha Efraín! Así como vi a
...
\bibleverse{14} Dales, Señor\ldots{} ¿Qué podrás darles? Dales vientres
que aborten y senos secos.\footnote{\textbf{9:14} Debido a que la
  ...
  afirmaban.} \bibleverse{15} Toda su maldad comenzó en Guilgal, y desde
entonces comencé a aborrecerlos. Los expulsaré de mi casa por su maldad.
No los amaré más, porque todos sus líderes son rebeldes. \bibleverse{16}
...
masacre. \bibleverse{17} Mi Dios te rechazará porque no lo has
...
\bibleverse{1} Israel es como una viña frondosa\footnote{\textbf{10:1}
...
\bibleverse{2} El pueblo tiene corazones engañosos, y ahora deben asumir
la responsabilidad de su culpa. El Señor romperá sus altares y destruirá
sus pilares sagrados. \bibleverse{3} Entonces dirán: ``No tenemos rey,
porque no tememos al Señor, ¿y acaso qué hará un rey por nosotros?''
\bibleverse{4} Hablan con palabras vacías, juran y hacen falsas promesas
...
``justicia'' florece como hierba venenosa en el campo. \bibleverse{5}
...
le dará a Asiria como tributo por el gran rey. \footnote{\textbf{10:5}
  Os 10,15; Os 4,15} \bibleverse{6} Efraín sufrirá desgracia, e Israel
será avergonzado por sus propias decisiones.\footnote{\textbf{10:6}
  ...
  paganas.} \footnote{\textbf{10:6} Os 5,13} \bibleverse{7} Samaria y su
rey serán arrastrados como una pequeña rama en la superficie del agua.
\bibleverse{8} Los altares de Aven,\footnote{\textbf{10:8} Donde estaban
...
\bibleverse{9} Desde los días de Guibeá, oh Israel, has estado pecando y
no has cambiado. ¿Acaso el pueblo de Guibeá cree que la guerra no los
alcanzará? \footnote{\textbf{10:9} Os 9,9} \bibleverse{10} Cuando yo lo
elija, castigaré a los malvados. Las naciones se reunirán contra ellos
cuando sean castigados por su doble crimen. \bibleverse{11} Efraín es
...
\bibleverse{12} Siembren ustedes mismos lo bueno y cosecharán amor
...
que venga y haga llover bondad sobre ustedes. \footnote{\textbf{10:12}
  Jer 4,3; Is 55,6} \bibleverse{13} Pero por el contrario han sembrado
...
\bibleverse{15} Esto mismo te pasará a ti, Betel, por tu gran maldad. Al
...
\bibleverse{1} Yo amé a Israel desde que era un niño. Es mi hijo a quien
saqué de Egipto. \footnote{\textbf{11:1} Éxod 4,22; Mat 2,15}
\bibleverse{2} Así como los llamaban, iban:\footnote{\textbf{11:2} A
...
ofrecieron incienso a los ídolos. \bibleverse{3} Yo mismo enseñé a
...
sanador.\footnote{\textbf{11:3} En el contexto del Éxodo. Ver Éxodo
  15:26.} \bibleverse{4} Los conduje con cuerdas de bondad, con lazos de
...
alimentarlos.\footnote{\textbf{11:4} La imagen da un giro que indica el
  ...
  soportar.} \bibleverse{5} Sin embargo, como mi pueblo se niega a
regresar a mi, tampoco volverán a la tierra de Egipto\footnote{\textbf{11:5}
  ...
  esta vez a Asiria.} sino que Asiria será su rey. \bibleverse{6} Habrá
guerra\footnote{\textbf{11:6} Literalmente, ``la espada''.} en sus
ciudades que porndrá fin a su jactancia y destruirá sus planes.
\bibleverse{7} Mi pueblo insiste en su apostasía. Lo llaman ``dios en lo
...
los levnatará. \bibleverse{8} ¿Cómo podría abandonarte, Efraín? ¿Cómo
...
\bibleverse{9} No cederé al ardor de mi ira, no destruiré a Efraín de
...
entre ustedes. No entraré en sus ciudades.\footnote{\textbf{11:9}
  ...
  3,31-36} \bibleverse{10} El pueblo me segirá a mi, al Señor. El Señor
rugirá como león y entonces sus hijos vendrán temblando desde el oeste.
\footnote{\textbf{11:10} Is 31,4-5; Jer 25,30; Os 3,1}

\bibleverse{11} Como una bandada de aves, vendrán desde Egipto. Como
palomas vendrán de Asiria, y yo los traeré de nuevo a casa, dice el
Señor. \bibleverse{12} Efraín me rodea con sus mentiras e Israel con
...
\bibleverse{1} Efraín trata de guiar al viento, yendo tras el viento del
...
Egipto.\footnote{\textbf{12:1} En otras palabras, al hacer un tratado
  ...
  Os 7,11} \bibleverse{2} El Señor tiene además una acusación en contra
de Judá, y castigará a Jacob por las acciones del pueblo. Les pagará
conforme a lo que han hecho. \bibleverse{3} Incluso desde el vientre
...
Dios. \bibleverse{4} Peleó con un ángel y ganó. Lloró y le rogó por una
bendición. Jacob encontró a Dios en Betel, y allí habló con él,
\bibleverse{5} el Señor Dios Todopoderoso, ¡el Señor es su gran nombre!
\footnote{\textbf{12:5} Gén 35,15} \bibleverse{6} Ustedes deben volver a
su Dios. Actúen con amor y hagan lo recto, y siempre esperen en Dios.
\bibleverse{7} El mercader que sostiene en sus manos una balanza
alterada ama la estafa. \bibleverse{8} Efraín dice: ``Soy rico! ¡Me he
enriquecido! He recibido mucho fruto de mi trabajo y nadie puede
demostrar que soy culpable de ningún mal''. \bibleverse{9} Pero yo soy
...
de nuevo en tiendas como lo haces en tiempos de fiesta.\footnote{\textbf{12:9}
  ...
  para recordar su viaje por el desierto} \bibleverse{10} Yo hablé a
través de los profetas. Yo mismo di muchas visiones y parábolas a través
de los profetas. \footnote{\textbf{12:10} Os 13,4} \bibleverse{11} Si
...
son como pilas de rocas en los surcos del campo.\footnote{\textbf{12:11}
  ...
  conocer al Dios verdadero.} \bibleverse{12} Jacob huyó a la tierra de
...
esposa cuidando ovejas. \bibleverse{13} A través de un
...
profeta también.\footnote{\textbf{12:13} Se usa la misma para hablar de
  ...
  Moisés.} \bibleverse{14} Efraín ha hecho enojar al Señor, y el Señor
...
\bibleverse{1} Cuando habló Efraín, se asustaron porque eran la tribu
líder en Israel. Pero cuando fueron culpables de adoración a Baal,
murieron. \bibleverse{2} Ahora pecan constantemente, y se forjan ídolos
...
pueblo. ``Besen al ídolo con forma de becerro''. \bibleverse{3} Por
...
chimenea. \footnote{\textbf{13:3} Os 6,4; Sal 1,4} \bibleverse{4} Pero
...
\bibleverse{5} Te cuidé en el desierto. Allí la tierra fue como pasto
para ellos\footnote{\textbf{13:5} ``Fue como pasto para ellos'' o ``Yo
  los alimenté''.} \footnote{\textbf{13:5} Os 9,10} \bibleverse{6} y se
...
olvidaron de mi.\footnote{\textbf{13:6} Véase la advertencia de que esto
  ...
  32,15} \bibleverse{7} Así que yo seré para ellos como un león, como un
leopardo acecharé junto al camino. \footnote{\textbf{13:7} Os 5,14}
\bibleverse{8} Seré como la madre oso a quien le han robado sus crías, y
desgarraré sus entrañas. Yo los devoraré como un león, como una bestia
salvaje los destrozaré. \bibleverse{9} Se han destruido ustedes mismos,
oh Israel, porque tu única esperanza está en mi. \bibleverse{10} ¿Dónde
...
líderes que me exigían un rey y un príncipe? \footnote{\textbf{13:10}
  1Sam 8,5} \bibleverse{11} En mi ira te di un rey, y en mi furia te lo
...
\bibleverse{12} La culpa de Efraín ha sido anotada, y su pecado será
erradicado.\footnote{\textbf{13:12} ``Erradicado:'': Literalmente,
  ...
  sentido de que simplemente quede oculto y continúe).} \bibleverse{13}
...
tiempo.\footnote{\textbf{13:13} Esto podría referirse a los problemas de
  ...
  morir.} \bibleverse{14} Yo los redimiré del poder del Seol. Los
...
\bibleverse{15} Aunque prospere entre los juncos,\footnote{\textbf{13:15}
...
\bibleverse{16} Samaria tendrá que acarrear las consecuencias de su
...
\bibleverse{1} Vuelve, Israel, al Señor tu Dios, porque tus pecados te
han hecho caer. \footnote{\textbf{14:1} Os 12,7; Zac 1,4} \bibleverse{2}
...
\bibleverse{3} Asiria no puede salvarnos, y no escaparemos con nuestros
...
en ti''. \bibleverse{4} Yo sanaré su falta de fe. Los amaré
...
\bibleverse{5} Yo seré como el rocío para Israel, y ellos florecerán
como los lirios, y sus raíces crecerán fuertes como los cedros del
Líbano. \bibleverse{6} Sus retoños se extenderán, y su esplendor será
como el árbol de olivo, su fragancia será como los cedros del Líbano.
\bibleverse{7} Los que habitan bajo su sombra regresarán, y florecerán
como el grano; florecerán como el vino, y serán recordados como el vino
del Líbano. \bibleverse{8} Efraín, ¿hasta cuándo tendré que advertirte
...
y de mí nace tu fruto. \bibleverse{9} ¿Quién es sabio para entender todo
