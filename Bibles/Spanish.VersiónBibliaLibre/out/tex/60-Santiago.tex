...
\bibleverse{1} Esta carta viene de parte de Santiago, siervo de Dios y
...
\bibleverse{2} Amigos míos, elijan estar felices aun cuando se
atraviesen todo tipo de problemas en su camino, \bibleverse{3} porque
ustedes saben que la paciencia surge al enfrentar desafíos en cuanto a
su fe en Dios. \bibleverse{4} Que su paciencia se fortalezca tanto como
...
\bibleverse{5} Si alguno de ustedes necesita sabiduría, pídala a Dios,
que da a todos generosamente y sin retenciones. \footnote{\textbf{1:5}
  Prov 2,3-6; Sant 3,15} \bibleverse{6} Pero cuando pidan, recuerden
...
del mar que son llevadas de un lado al otro por el viento. \footnote{\textbf{1:6}
  Mar 11,24; 1Tim 2,8} \bibleverse{7} Y ninguna persona que sea así debe
pensar que podrá recibir algo del Señor, \bibleverse{8} porque sus
...
\bibleverse{9} Los creyentes que han nacido en la pobreza deben
enorgullecerse en la posición de grandeza que se les ha dado,
\footnote{\textbf{1:9} Sant 2,5} \bibleverse{10} mientras que los ricos
...
\bibleverse{12} Feliz es quien soporta con paciencia la tentación,
...
\bibleverse{13} Cuando alguien es tentado, no debe decir: ``Estoy siendo
tentado por Dios''. Porque Dios no es tentado por el mal, ni él tienta a
nadie. \bibleverse{14} Las tentaciones vienen de nuestros propios malos
deseos que nos descarrían y nos atrapan. \footnote{\textbf{1:14} Rom
  7,7-8} \bibleverse{15} Tales deseos nos llevan al pecado, y el pecado,
al haberse desarrollado en plenitud, causa la muerte. \footnote{\textbf{1:15}
  Rom 7,10} \bibleverse{16} Mis queridos amigos, no se dejen engañar.
\bibleverse{17} Todo lo que es bueno, todo don perfecto, viene de
...
de ellas, él no cambia, él no varía ni arroja sombras.\footnote{\textbf{1:17}
  ...
  1,5} \bibleverse{18} Él eligió darnos una nueva vida por medio de la
...
\bibleverse{19} Recuerden esto, mis queridos amigos: todos deberían ser
prontos para escuchar, pero lentos para hablar y lentos para enojarse,
\footnote{\textbf{1:19} Prov 29,20; Ecl 5,1-2; Ecl 7,9} \bibleverse{20}
...
\bibleverse{21} Así que despojémonos de todo lo que es sucio y maligno.
...
\bibleverse{22} Hagan, más bien, lo que dice la palabra. No escuchen
solamente ni se engañen ustedes mismos. \footnote{\textbf{1:22} Mat
  7,26; Rom 2,13} \bibleverse{23} Si solo oyen la palabra y no la ponen
en práctica, es como si miraran sus rostros en un espejo.
\bibleverse{24} Ahí se ven a sí mismos, pero luego se van, y de
inmediato olvidan cómo se veían. \bibleverse{25} Pero si miran la ley
...
\bibleverse{26} Si piensan que son piadosos, pero no controlan lo que
dicen, se están engañando a ustedes mismos y su religión no tiene
sentido. \footnote{\textbf{1:26} 1Pe 3,10}

\bibleverse{27} Ante los ojos de nuestro Dios y Padre, la religión pura
...
\bibleverse{1} Mis amigos, como creyentes con fe en nuestro glorioso
Señor Jesucristo, ustedes no deben mostrar favoritismo. \bibleverse{2}
Imaginen que a su sinagoga llega un hombre usando anillos de oro y ropas
finas, y luego entra un hombre pobre vestido de harapos. \bibleverse{3}
...
\bibleverse{4} ¿acaso no han discriminado y juzgado con razones
equivocadas? \bibleverse{5} Escuchen, mis queridos amigos: ¿Acaso Dios
...
\bibleverse{6} Pero ustedes han tratado al pobre de manera vergonzosa.
¿No son los ricos quienes los oprimen y los arrastran a las cortes?
\bibleverse{7} ¿Acaso no son ellos quienes insultan el honorable
...
\bibleverse{8} Si ustedes realmente observan la ley real de la
Escritura: ``Amarás a tu prójimo como a ti mismo'', entonces hacen
bien.\footnote{\textbf{2:8} Citando Levítico 19:18.} \bibleverse{9} Pero
...
\bibleverse{10} Quien observa todo lo que está en la ley pero incumple
una sola parte, es culpable de incumplirla toda. \footnote{\textbf{2:10}
  Mat 5,19} \bibleverse{11} Dios les dijo que no cometan adulterio, y
...
matan, de igual modo son quebrantadores de la ley.\footnote{\textbf{2:11}
  Citando Éxodo 20:13-14 o Deuteronomio 5:17-18.} \bibleverse{12} Deben
hablar y actuar como personas que serán juzgadas por la ley de la
libertad. \bibleverse{13} Todo aquél que no muestra misericordia, será
...
\bibleverse{14} Amigos míos, ¿qué de bueno hay en decir que tenemos fe
en Dios si no hacemos lo correcto? ¿Puede salvarnos tal ``fe''?
\footnote{\textbf{2:14} Mat 7,21} \bibleverse{15} Si un hermano o
hermana no tiene ropas, o comida para el día, \bibleverse{16} y tú vas y
...
\bibleverse{17} Porque la fe basada en la confianza en Dios por sí misma
está muerta y no sirve para nada si no haces lo recto. \bibleverse{18}
...
\bibleverse{19} ¿Tú crees que Dios es un solo Dios? Eso es bueno, pero
los demonios también creen en Dios, ¡y se aterran de él! \bibleverse{20}
...
\bibleverse{21} ¿No fue nuestro Padre Abrahán justificado\footnote{\textbf{2:21}
  O ``probado justo''.} por lo que hizo al ofrecer a su hijo Isaac en un
altar? \footnote{\textbf{2:21} Gén 22,-1; Heb 11,17}

\bibleverse{22} Sepan que su fe en Dios iba de la mano con lo que hizo,
y por medio de lo que hizo su fe en Dios fue completa. \bibleverse{23}
...
Dios, y esto fue considerado como él haciendo el bien,\footnote{\textbf{2:23}
  ...
  Ver Isaías 41:8.} \bibleverse{24} Vemos entonces que somos
justificados por lo que hacemos y no solo por nuestra fe en Dios.
\bibleverse{25} Del mismo modo, ¿no fue justificada Rahab, la
prostituta, por lo que hizo cuando cuidó de los mensajeros y los envió
luego por un camino distinto? \bibleverse{26} Así como el cuerpo está
...
\bibleverse{1} Mis amigos, no muchos de ustedes deberían ser maestros,
porque ustedes saben que quien enseña tiene una responsabilidad mayor
ante el juicio. \bibleverse{2} Todos cometemos errores de muchas
...
\bibleverse{3} Nosotros ponemos frenos en nuestra boca como los caballos
para que nos obedezcan, y así poder dirigirlos hacia donde queremos.
\bibleverse{4} Miremos también los barcos: aunque son muy grandes y son
impulsados por vientos fuertes, son conducidos por un pequeño timón
hacia la dirección que el piloto quiere ir. \bibleverse{5} Del mismo
...
\bibleverse{6} Y la lengua es una llama. Es una espada del mal en medio
...
\bibleverse{7} La gente puede dominar todo tipo de animales, ya sean
aves, reptiles, y criaturas del mar, \bibleverse{8} pero nadie puede
dominar la lengua. Porque es maligna, difícil de controlar, llena de
veneno mortal. \bibleverse{9} La misma lengua que usamos para bendecir a
nuestro Señor y Padre, la usamos para maldecir a otras personas que
están hechas a imagen de Dios. \bibleverse{10} ¡Emanan bendiciones y
maldiciones de la misma boca! Amigos, ¡esto no debe ser así! \footnote{\textbf{3:10}
  Efes 4,29} \bibleverse{11} ¿Acaso puede brotar de la misma fuente agua
dulce y amarga a la vez? \bibleverse{12} Amigos míos, así como una
...
\bibleverse{13} ¿Quién entre ustedes tiene sabiduría y entendimiento?
Pues permita que su buen vivir demuestre lo que hace, actuando
rectamente, con sabia bondad y consideración. \bibleverse{14} Pero si
tienes celos amargos y ambición egoísta en tu corazón, no te jactes de
ello ni quieras mentirle a la verdad. \bibleverse{15} Esta clase de
``sabiduría'' no viene de arriba, sino que es terrenal, carente de
espiritualidad, y demoníaca. \bibleverse{16} Dondequiera haya celos y
ambición egoísta, también habrá confusión y todo tipo de prácticas
malas. \bibleverse{17} Sin embargo, la sabiduría que viene de arriba es
...
no hipócrita. \bibleverse{18} Los que siembran paz recogerán la paz de
...
\bibleverse{1} ¿De dónde surgen las contiendas y discusiones que hay
entre ustedes? ¿Acaso no son por las pasiones sensuales que luchan
dentro de ustedes? \bibleverse{2} Están ardiendo de deseo, pero no
...
que reciban en placeres egoístas. \bibleverse{4} ¡Adúlteros! ¿No se dan
...
\footnote{\textbf{4:4} Luc 6,26; Rom 8,7; 1Jn 2,15} \bibleverse{5}
...
\footnote{\textbf{4:5} Éxod 20,3; Éxod 20,5} \bibleverse{6} Pero Dios
...
de los arrogantes, pero da gracia a los humildes''.\footnote{\textbf{4:6}
  ...
  1Pe 5,5} \bibleverse{7} Colóquense, pues, bajo la dirección de Dios.
Confronten al enemigo, y él huirá de ustedes. \footnote{\textbf{4:7} 1Pe
  5,8-9} \bibleverse{8} Acérquense a Dios y él se acercará a ustedes.
...
\bibleverse{9} Muestren algo de remordimiento, lloren y laméntense.
Cambien su risa por lamento, y su alegría por tristeza. \bibleverse{10}
Sean humildes ante el Señor y él los exaltará.

\bibleverse{11} Amigos, no hablen mal unos de otros. Todo el que critica
...
están cumpliendo, porque están actuando como jueces. \bibleverse{12} Hay
...
\bibleverse{13} Atiendan, ustedes los que dicen: ``Hoy o mañana iremos a
tal y tal ciudad, pasaremos un año allí haciendo negocios y obtendremos
ganancia''. \footnote{\textbf{4:13} Prov 27,1} \bibleverse{14} ¡Ustedes
...
que aparece por un poco tiempo y luego se va. \footnote{\textbf{4:14}
  Luc 12,20} \bibleverse{15} Lo que deberían decir es: ``Si Dios quiere,
viviremos de esta manera, y haremos planes para hacer aquello''.
\footnote{\textbf{4:15} Hech 18,21; 1Cor 4,19} \bibleverse{16} Pero
ahora están solo llenos de ideas vanas. Y toda esta jactancia es
maligna. \bibleverse{17} Porque es pecado si sabes hacer lo bueno y no
...
\bibleverse{1} ¡Ustedes, ricos! Deberían llorar y lamentar todos los
problemas que les vienen encima. \footnote{\textbf{5:1} Luc 6,24-25}
\bibleverse{2} Toda su riqueza está podrida, y sus ropas han sido
devoradas por polillas. \footnote{\textbf{5:2} Mat 6,19} \bibleverse{3}
...
riquezas en los últimos días. \bibleverse{4} Miren, los salarios de sus
...
\bibleverse{5} Han disfrutado una vida de lujos aquí en la tierra,
...
sacrificio. \footnote{\textbf{5:5} Luc 16,19; Luc 16,25; Jer 12,3; Jer
  25,34} \bibleverse{6} Han condenado y han asesinado al inocente que ni
...
\bibleverse{7} Amigos, sean pacientes y esperen el regreso del Señor.
...
la tierra mientras crece con la lluvia temprana y tardía. \footnote{\textbf{5:7}
  Luc 21,19; Heb 10,36} \bibleverse{8} Ustedes también necesitan ser
pacientes. Manténganse fuertes porque el regreso del Señor está cerca.

\bibleverse{9} Amigos míos, no se quejen unos de otros, para que no sean
juzgados. ¡Miren, el juez está justo a las puertas! \bibleverse{10}
...
\bibleverse{11} Observen que siempre decimos que son benditos los que
...
\bibleverse{12} Por encima de todo, amigos, no juren. No juren por el
...
\bibleverse{13} ¿Está sufriendo alguno entre ustedes? Ore. ¿Hay alguien
alegre entre ustedes también? Cante canciones de alabanza. \footnote{\textbf{5:13}
  Sal 50,15; Col 3,16} \bibleverse{14} ¿Está alguno enfermo? Llamen a
los ancianos de iglesia para que oren y le unjan con aceite en el nombre
del Señor. \footnote{\textbf{5:14} Mar 6,13} \bibleverse{15} Porque tal
...
Y si ha cometido pecados, le serán perdonados. \footnote{\textbf{5:15}
  Mar 16,18} \bibleverse{16} Admitan unos delante de otros los errores
...
oración sincera de los justos es eficaz. \footnote{\textbf{5:16} Hech
  12,5} \bibleverse{17} Elías era un hombre que tenía la misma
...
\footnote{\textbf{5:17} 1Re 17,1; Luc 4,25} \bibleverse{18} Luego oró
una vez más, y el cielo envió la lluvia sobre la tierra, y la tierra dio
su cosecha. \footnote{\textbf{5:18} 1Re 18,41-45}

\bibleverse{19} Amigos míos, si alguno de ustedes se descarría de la
verdad y alguien le trae de vuelta, \bibleverse{20} háganle saber que
