...
\bibleverse{1} Esta es la visión que Isaías, hijo de Amoz, vio sobre
...
\bibleverse{2} ¡Cielos, escuchen! ¡Tierra, presta atención! Porque el
...
y los cuidé, pero ellos se han rebelado contra mí. \bibleverse{3} El
...
\bibleverse{4} ¡Qué nación tan pecadora, un pueblo que lleva una carga
...
extraños. Han retrocedido. \bibleverse{5} ¿Quieren ser castigados? ¿Van
...
\bibleverse{6} Están heridos de pies a cabeza, magullados y adoloridos,
con heridas abiertas que no han sido limpiadas ni vendadas, ni tratadas
con aceite de oliva. \footnote{\textbf{1:6} Deut 28,25} \bibleverse{7}
...
terreno valdío. \bibleverse{8} La hija de Sión ha quedado como una choza
en una viña, como una cabaña en un campo de pepinos, como una ciudad
sitiada. \bibleverse{9} Si el Señor Todopoderoso no nos hubiera dejado
...
\bibleverse{10} ¡Escuchen la palabra del Señor, gobernantes de Sodoma!
Presten atención a las instrucciones de nuestro Dios, pueblos de
Gomorra. \footnote{\textbf{1:10} Jer 23,14; Lam 4,6} \bibleverse{11} ¿De
...
\bibleverse{12} Cuando vienen a presentarse ante mí en el culto, ¿quién
les ha pedido que se paseen con orgullo por mis atrios? \bibleverse{13}
...
asambleas solemnes. \bibleverse{14} ¡Detesto con todo mi ser sus fiestas
anuales y de luna nueva! Se han convertido en una carga para mí: ¡ya no
los soporto! \bibleverse{15} Cuando alzan sus manos hacia mí para orar,
...
atención, porque sus manos están llenas de sangre.\footnote{\textbf{1:15}
  ...
  incluso de asesinato.} \bibleverse{16} Lávense y límpiense.
¡Desháganse de sus pecados pues no quiero verlos! ¡Dejen de hacer el
mal! \footnote{\textbf{1:16} Jl 2,12-13; Miq 6,6-8} \bibleverse{17}
...
\bibleverse{18} Vengan y discutamos esto, dice el Señor. Aunque sus
...
\footnote{\textbf{1:18} Is 43,25; Is 44,22; Sal 51,9} \bibleverse{19} Si
...
mismos comerán lo mejor del fruto de la tierra.\footnote{\textbf{1:19}
  ...
  cosechas, etc.} \footnote{\textbf{1:19} Lev 25,18-19} \bibleverse{20}
...
\bibleverse{21} ¡La ciudad que solía ser fiel se ha convertido ahora en
...
lo correcto, pero ahora sólo viven en ella asesinos. \footnote{\textbf{1:21}
  Mat 23,37} \bibleverse{22} Su plata se ha convertido en un desperdicio
sin valor; su vino se ha aguado. \bibleverse{23} Sus dirigentes son
...
\bibleverse{24} Esto es lo que dice el Señor, el Señor Todopoderoso, el
Poderoso de Israel: ¡Basta! ¡Me alegraré en castigar a mis enemigos,
pagando a los que me odian! \bibleverse{25} Me volveré contra ti. Te
refinaré en un horno y eliminaré así todas las impurezas.
\bibleverse{26} Te daré buenos líderes como los que tenías antes, sabios
...
ser llamada la Ciudad de la Integridad, la Ciudad Fiel. \footnote{\textbf{1:26}
  Zac 8,3} \bibleverse{27} Sión será rescatada por la justicia y por
causa de los que se arrepienten y hacen el bien. \footnote{\textbf{1:27}
  Is 46,13} \bibleverse{28} Pero los rebeldes y los pecadores serán
destruidos, y los que abandonen al Señor morirán. \bibleverse{29}
...
\bibleverse{30} Como resultado, se convertirán en un roble cuyas hojas
se han marchitado, un jardín seco que no tiene agua. \bibleverse{31} Su
...
\bibleverse{2} En los últimos días, la montaña donde se levanta el
...
para visitarla. \bibleverse{3} La gente vendrá y dirá: ``Subamos al
...
se extenderán desde Sión, y su palabra desde Jerusalén''. \footnote{\textbf{2:3}
  Juan 4,22} \bibleverse{4} El Señor decidirá los casos de las naciones;
...
ya no lucharán entre sí; ya no aprenderán métodos de guerra. \footnote{\textbf{2:4}
  Is 9,4} \bibleverse{5} Vengan, israelitas,\footnote{\textbf{2:5}
...
\bibleverse{6} Porque tú, Señor, has renunciado a tu pueblo, los
...
extranjeros.\footnote{\textbf{2:6} ``se hacen amigos de los
  ...
  hijos de los extranjeros''.} \bibleverse{7} Su país está lleno de
...
caballos; y tienen una cantidad interminable de carros. \footnote{\textbf{2:7}
  Deut 17,16; Miq 5,9} \bibleverse{8} Su país está lleno de ídolos; se
inclinan y adoran lo que han hecho ellos mismos, producido por sus
propias manos. \bibleverse{9} Este pueblo será abatido y humillado:
¡Señor, no los perdones! \bibleverse{10} Huyan a las cuevas de las
rocas, escóndanse bajo tierra de la presencia aterradora del Señor, de
la gloria de su majestad. \bibleverse{11} Los que miran con arrogancia
...
\bibleverse{12} El Señor ha reservado un día en el que se ocupará de los
orgullosos y arrogantes. Acabará con toda la altivez, y los derribará.
\bibleverse{13} Derribará los cedros del Líbano, altos y elevados, y
todos los grandes robles de Basán, \bibleverse{14} Derribará los altos
montes y las altas colinas. \bibleverse{15} Derribará toda torre alta y
todo muro defensivo. \bibleverse{16} Aniquilará a todos los barcos
comerciales de Tarsis, así como las embarcaciones comerciales.
\bibleverse{17} Los arrogantes serán abatidos, y los orgullosos serán
...
\bibleverse{20} Ese día la gente tomará los ídolos de plata y oro que
construyeron para adorar y los arrojarán a las ratas\footnote{\textbf{2:20}
  ...
  animal de madriguera.} y a los murciélagos. \bibleverse{21} Correrán a
...
majestad, cuando llegue a sacudir la tierra. \footnote{\textbf{2:21}
  2Tes 1,9} \bibleverse{22} No se molesten en confiar en los seres
...
\bibleverse{1} ¡Presten atención! El Señor, el Señor Todopoderoso, le
...
\footnote{\textbf{3:1} Lev 26,26; Ezeq 4,16} \bibleverse{2} sus fuertes
combatientes y soldados, sus líderes y profetas, sus adivinos y
ancianos, \bibleverse{3} los capitanes del ejército, sus funcionarios
del Estado, consejeros, artesanos, maestros de magia y expertos en
ocultismo. \bibleverse{4} Les daré como líderes a jóvenes que los
gobernarán de manera infantil. \bibleverse{5} La gente se maltratará
...
tienen cargos importantes. \bibleverse{6} Un hombre agarrará a uno de
...
ruinas''. \bibleverse{7} Pero inmediatamente su hermano le gritará:
...
\bibleverse{8} Porque Jerusalén y Judá han caído por causa de lo que
dijeron e hicieron en contra del Señor, rebelándose delante de él.
\bibleverse{9} La mirada de sus rostros demuestra lo que han hecho,
...
\bibleverse{10} Dile a los que viven bien que estarán bien, porque
...
hecho.\footnote{\textbf{3:10} ``estarán contentos de recibir la
  ...
  sus obras''.} \footnote{\textbf{3:10} Is 32,17} \bibleverse{11} Pero a
los malvados les llega la tragedia, porque se hará con ellos lo mismo
que hicieron. \bibleverse{12} Los líderes que actúan de manera infantil
...
\bibleverse{13} El Señor se levanta para juzgar su caso. El Señor se
levanta para juzgar al pueblo. \bibleverse{14} El Señor viene a
...
todo lo que le han robado a los pobres. \bibleverse{15} ¿Por qué han
...
\bibleverse{16} El Señor dice: Las mujeres de Sión son tan presumidas,
...
con sus tobilleras que tintinean. \footnote{\textbf{3:16} Prov 31,30;
  1Tim 2,9} \bibleverse{17} Por eso el Señor les llenará la cabeza de
costras y dejará al descubierto sus partes íntimas.

\bibleverse{18} En ese momento el Señor les quitará los adornos finos:
sus tobilleras, sus diademas, sus collares de media luna,
\bibleverse{19} sus pendientes colgantes, brazaletes, velos,
\bibleverse{20} tocados, fajas, porta perfumes, amuletos,
\bibleverse{21} anillos, narigueras, \bibleverse{22} vestidos de fiesta,
batas, mantos, bolsos, \bibleverse{23} espejos de mano, ropa interior de
lino fino, vendas para la cabeza y chales. \bibleverse{24} Lo que
...
\bibleverse{25} Sus hombres serán asesinados con espada; sus soldados
morirán en la batalla. \bibleverse{26} Las puertas de Sión llorarán y se
...
\bibleverse{1} En ese tiempo, siete mujeres se agarrarán a un solo
...
\bibleverse{2} Pero en ese momento, ``el retoño del Señor''\footnote{\textbf{4:2}
...
que queden en Israel. \footnote{\textbf{4:2} Is 11,1} \bibleverse{3}
...
estén registrados entre los vivos de Jerusalén -- \footnote{\textbf{4:3}
  Luc 10,20} \bibleverse{4} una vez que el Señor haya lavado los
...
\footnote{\textbf{4:4} Zac 13,1; Mat 3,11} \bibleverse{5} Entonces el
...
\bibleverse{6} Será un lugar para estar a la sombra del calor diurno, y
...
\bibleverse{1} Permítanme cantar una canción para mi amor, sobre su
viñedo. Mi amor tenía una viña en una colina fértil. \footnote{\textbf{5:1}
  Is 27,2; Sal 80,9-16; Mar 12,1-9} \bibleverse{2} La cavó, limpió el
...
\bibleverse{3} ``Ahora, ustedes que viven en Jerusalén y en Judá, por
favor, juzguen entre mi viña y yo. \bibleverse{4} ¿Qué más podía hacer
por mi viña de lo que ya he hecho? Cuando buscaba uvas dulces, ¿por qué
sólo produjo uvas agrias? \bibleverse{5} ``Así que déjenme decirles lo
que voy a hacer con mi viña. Quitaré su seto y será destruida. Derribaré
su muro, y será pisoteada. \bibleverse{6} La convertiré en un lugar
...
ella''. \bibleverse{7} Israel es la viña del Señor Todopoderoso, y el
...
\bibleverse{8} La tragedia se acerca a ti, que compras casa sobre casa y
...
\bibleverse{9} Oí al Señor Todopoderoso declarar: Puedes estar seguro de
que muchas casas están destinadas a convertirse en ruinas, y hermosas
mansiones destinadas a quedar deshabitadas. \bibleverse{10} Diez acres
...
\bibleverse{11} La tragedia llega a ustedes que se levantan temprano por
la mañana con ganas de beber, y que se quedan hasta tarde bebiendo vino
hasta emborracharse. \bibleverse{12} En sus fiestas ustedes tienen liras
y arpas, panderetas y flautas, y vino, pero nunca consideran lo que hace
el Señor, y no reconocen su ayuda. \bibleverse{13} Como resultado, mi
...
\bibleverse{14} El apetito de la tumba aumenta, su boca se abre de par
en par, y la nobleza de Jerusalén y las masas bajarán a ella, junto con
las turbas alborotadas y borrachas. \bibleverse{15} Todos serán
abatidos, todos serán humillados; los orgullosos bajarán sus ojos en
señal de humillación. \footnote{\textbf{5:15} Is 2,11} \bibleverse{16}
Pero el Señor Todopoderoso será reivindicado porque hace lo que es
justo; el Dios santo se mostrará santo por su bondad. \bibleverse{17}
...
\bibleverse{18} Viene la tragedia para ustedes, que arrastran sus
pecados detrás de la iniquidad con cuerdas hechas de mentiras, y tiran
con cuerdas de la maldad. \bibleverse{19} Ustedes son de los que dicen:
...
\bibleverse{20} La tragedia está llegando a ustedes que dicen que el mal
...
\bibleverse{21} La tragedia viene a ustedes que son sabios en sus
propios ojos y se creen muy inteligentes. \footnote{\textbf{5:21} Prov
  3,7; Rom 12,17}

\bibleverse{22} La tragedia viene para ustedes, que son campeones en el
consumo de vino, y expertos en mezclar bebidas alcohólicas;
\bibleverse{23} ustedes que liberan al culpable por un soborno, y sin
embargo niegan la justicia al inocente. \bibleverse{24} Así como el
...
\bibleverse{25} Por eso el Señor arde de ira\footnote{\textbf{5:25} Hay
...
su mano sigue levantada. \bibleverse{26} Enviará una señal a las
naciones lejanas y silbará a los que viven en los confines de la tierra.
Mira qué rápido responden, qué rápido vienen. \bibleverse{27} Ninguno de
ellos se cansa ni tropieza; ninguno descansa ni duerme. Ningún cinturón
se afloja, y ninguna correa de sandalia se rompe. \bibleverse{28} Sus
...
carros giran como un torbellino. \bibleverse{29} Rugen como leones, como
jóvenes leones. Gruñen y se abalanzan sobre su presa. La arrastran para
que no pueda ser rescatada. \bibleverse{30} En ese momento rugirán sobre
...
\bibleverse{1} El año en que murió el rey Uzías, vi al Señor sentado con
majestad en un trono alto, y la cola de su manto llenaba el Templo.
\footnote{\textbf{6:1} Juan 12,41} \bibleverse{2} Había
...
\bibleverse{3} Se gritaban unos a otros: Santo, santo, santo es el Señor
Todopoderoso; su gloria llena toda la tierra.

\bibleverse{4} El sonido de sus gritos hizo temblar las columnas y los
postes de las puertas, y el Templo se llenaba de humo. \footnote{\textbf{6:4}
  Ezeq 10,4; Apoc 15,8} \bibleverse{5} Yo grité: ``¡Estoy condenado! Voy
...
\bibleverse{6} Entonces uno de los serafines voló hacia mí. Llevaba en
la mano un carbón encendido que había cogido con unas pinzas del altar.
\bibleverse{7} Me tocó la boca con él y me dijo: ``¡Mira! Esto ha tocado
...
\bibleverse{8} Entonces oí al Señor preguntar: ``¿A quién enviaré?
¿Quién irá y hablará\footnote{\textbf{6:8} ``Y hablará'': Añadido para
  mayor claridad.} por nosotros?'' Así que dije: ``¡Estoy aquí! Por
favor, envíame''.

\bibleverse{9} Él respondió: ``Ve y dile a este pueblo: `Siguen
escuchando, pero nunca entienden. Sigue viendo, pero nunca comprenden'.
\bibleverse{10} Haz que las mentes de este pueblo sean insensibles; haz
...
\bibleverse{11} Entonces le pregunté: ``¿Cuánto tiempo durará esto,
...
\bibleverse{12} hasta que el Señor envíe a la gente lejos y el país
quede totalmente desierto. \bibleverse{13} Aunque una décima parte de la
...
\bibleverse{1} Fue durante el reinado de Acaz hijo de Jotam, hijo de
...
pero no pudieron conquistar la ciudad. \footnote{\textbf{7:1} 2Re 15,37;
  2Re 16,5} \bibleverse{2} Cuando la familia real de Judá fue
...
\bibleverse{3} Entonces el Señor dijo a Isaías: ``Toma a tu hijo
...
\bibleverse{4} Dile que se calme y se calle. No tengas miedo ni te
asustes por un par de trozos de leña que arden, por la ira ardiente de
Rezín y Aram, y del hijo de Remalías. \bibleverse{5} Aram ha conspirado
para destruirte junto con Efraín y el hijo de Remalías diciendo:
\bibleverse{6} ¡Vamos a atacar a Judá! La aterrorizaremos y la
conquistaremos para nosotros, y haremos rey al hijo de Tabel''.
\bibleverse{7} Pero esto es lo que dice el Señor Dios: ``¡Este plan no
se concretará, simplemente no sucederá! \bibleverse{8} Porque el jefe de
...
\bibleverse{9} El jefe de Israel es Samaria, y el jefe de Samaria es el
...
\bibleverse{10} Más tarde, el Señor envió otro mensaje a Acaz:
\bibleverse{11} ``Pide al Señor, tu Dios, una señal, ya sea tan profunda
como donde está enterrada la gente o tan alta como el cielo''.

\bibleverse{12} ``No, no voy a pedirla'', respondió Acaz. ``Me niego a
poner al Señor a prueba''.

\bibleverse{13} Entonces Isaías dijo: ``¡Escuchen, familia real de Judá!
¿No les basta con desgastar a la gente? ¿Tienen que desgastar también a
mi Dios? \bibleverse{14} Por eso el Señor mismo les dará una señal.
...
embarazada y dará a luz un hijo, al que llamará Emanuel.\footnote{\textbf{7:14}
  Emmanuel quiere decir ``Dios con nosotros''.} \bibleverse{15} Comerá
leche y miel hasta que sepa rechazar el mal y elegir el bien.
\footnote{\textbf{7:15} Is 7,21-22} \bibleverse{16} Porque antes de que
...
\bibleverse{17} El Señor hará que tú, tu pueblo y la familia real
...
\bibleverse{18} En ese momento el Señor silbará para llamar a las moscas
...
\bibleverse{19} Todas vendrán y descenderán sobre los valles escarpados
y las grietas de las rocas, sobre todos los arbustos espinosos y las
charcas.

\bibleverse{20} En ese momento el Señor usará una navaja alquilada desde
más allá del río Éufrates, el rey de Asiria, para afeitarlos de pies a
cabeza, incluyendo sus barbas.

\bibleverse{21} En ese tiempo, el que logre mantener con vida a una vaca
joven y a dos ovejas \bibleverse{22} comerá cuajada, porque producen
mucha leche; pues todo el que sobreviva en la tierra comerá cuajada y
miel.

\bibleverse{23} En aquel tiempo, en todos los lugares donde antes había
mil vides que valían mil siclos, sólo habrá zarzas y espinas.
\bibleverse{24} La gente irá a cazar allí con arcos y flechas porque la
tierra estará cubierta de zarzas y espinas. \bibleverse{25} De hecho, a
...
\bibleverse{1} Entonces el Señor me dijo: ``Toma una tabla grande y
escribe en ella con una pluma ordinaria: `Maher Salal Jas
Baz'\footnote{\textbf{8:1} Queriendo decir: ``Rápido el saqueo, rápido
  el despojo''.} \bibleverse{2} Necesitaré al sacerdote Urías y a
Zacarías, hijo de Jeberequías, para que sean mis testigos de
confianza''.

\bibleverse{3} Entonces me acosté con mi mujer\footnote{\textbf{8:3}
...
Jas Baz. \bibleverse{4} Porque antes de que el niño sepa decir `papá' o
...
\bibleverse{5} Entonces el Señor me habló de nuevo, diciendo:
\bibleverse{6} ``Porque este pueblo ha rechazado las aguas de Siloé que
...
\bibleverse{7} el Señor va a traer las poderosas aguas del río Éufrates
contra ellos: el rey de Asiria con todo su glorioso ejército. Inundará
todos sus cauces y desbordará todas sus orillas. \bibleverse{8} Se
...
\bibleverse{9} ``¡Naciones, presten atención,\footnote{\textbf{8:9}
...
aplastadas. \footnote{\textbf{8:9} Sal 2,-1} \bibleverse{10} Pueden
...
\bibleverse{11} Pues esto es lo que me dijo el Señor, sujetándome con
mano fuerte, instruyéndome para que no siguiera el camino de este
pueblo. Me dijo: \bibleverse{12} No llames conspiración a todo lo que
esta gente llama conspiración. No temas lo que ellos temen. No te dejes
intimidar. \bibleverse{13} El Señor Todopoderoso es a quien deben
considerar como santo. A él es a quien debes temer, a él es a quien
debes respetar. \bibleverse{14} Él será un santuario para ustedes. Pero
...
\bibleverse{15} Mucha gente tropezará con él. Caerán y quedarán
...
\bibleverse{16} Guarda este testimonio, sella estas instrucciones: son
para mis discípulos. \bibleverse{17} Esperaré en el Señor, el que oculta
su rostro a los descendientes de Jacob. Pondré mi esperanza en él.
\bibleverse{18} Aquí estoy junto a los hijos que el Señor me ha dado.
...
\bibleverse{19} Cuando alguien les aconseje: ``Vayan y pregunten a los
...
favor de los vivos? \footnote{\textbf{8:19} 2Re 1,3} \bibleverse{20}
...
\bibleverse{21} Vagarán por el país, deprimidos y hambrientos. Cuando
estén hambrientos se pondrán furiosos, y mirando hacia arriba maldecirán
a su rey y a su Dios. \bibleverse{22} Entonces mirarán hacia la tierra y
...
\bibleverse{1} Aun así, no habrá más oscuridad para los que sufrieron.
...
\bibleverse{2} El pueblo que camina en la oscuridad verá una luz
brillante; una luz brillará sobre los que viven en una tierra de total
oscuridad. \bibleverse{3} Hará que la nación crezca enormemente y la
...
\bibleverse{4} Porque romperás el yugo que los agobia, la barra sobre
sus hombros y la vara de los opresores que los golpean, como hiciste
cuando derrotaste al ejército madianita. \bibleverse{5} Porque toda bota
...
\bibleverse{6} Porque nos nacerá un niño, se nos dará un hijo. Él
...
\bibleverse{7} Su gobierno y la paz que trae no conocen límites y nunca
...
\bibleverse{8} El Señor ha enviado un mensaje dirigido a Jacob, y sus
consecuencias caerán sobre Israel. \bibleverse{9} Todo el pueblo se dará
cuenta pronto: Efraín y los pueblos que viven en Samaria. Con orgullo y
arrogancia dicen: \bibleverse{10} ``Los edificios de ladrillo se han
...
\bibleverse{11} Pero el Señor ha fortalecido a los enemigos de
...
contra Israel\footnote{\textbf{9:11} ``Israel'': Añadido para mayor
  claridad.} y los ha alentado. \bibleverse{12} Los arameos del este y
...
\bibleverse{13} Pero el pueblo no volvió al que lo castigó; no vino a
adorar al Señor Todopoderoso. \footnote{\textbf{9:13} Is 10,33}
\bibleverse{14} Así que en un solo día el Señor le cortará a Israel la
cabeza y la cola, las palma y los juncos. \bibleverse{15} Los ancianos y
la gente honrada son la cabeza, y los profetas que enseñan la mentira
son la cola. \bibleverse{16} Los líderes del pueblo los han engañado;
los que se guiaban por ellos están confundidos. \bibleverse{17} Por eso
...
\bibleverse{18} Porque la maldad arde como un fuego, quemando zarzas y
espinas, incendiando el bosque y enviando una columna de humo que se
eleva. \bibleverse{19} La ira del Señor Todopoderoso quema la tierra. El
pueblo es como combustible para el fuego, y nadie trata de ayudar a
nadie. \bibleverse{20} La gente destruye\footnote{\textbf{9:20}
...
\bibleverse{21} Manasés destruye a Efraín, y Efraín destruye a Manasés.
...
\bibleverse{1} La tragedia se cierne sobre los que aprueban malos
decretos y redactan leyes para perjudicar a la gente. \bibleverse{2}
...
\bibleverse{3} ¿Qué van a hacer el día en que sean castigados, cuando el
desastre caiga sobre ustedes desde lejos? ¿A quién vas a correr para que
te ayude? ¿Dónde vas a dejar toda tu riqueza?

\bibleverse{4} ¡Lo único que podrán hacer es postrarse como prisioneros,
...
\bibleverse{5} ¡La tragedia se acerca a los asirios, aunque la vara que
usan representa mi cólera y el bastón que sostienen en sus manos
representa mi furia! \footnote{\textbf{10:5} Is 7,20} \bibleverse{6}
...
en la calle. \bibleverse{7} Pero esto no es lo que piensa el rey de
Asiria. Este no es el plan que tiene en mente. Lo que él quiere hacer es
destruir y eliminar muchas naciones. \bibleverse{8} Él dice: ``¡Todos
mis comandantes son reyes! \bibleverse{9} Conquistamos Calno como lo
hicimos con Carquemis; así también Hamat como Arpad; Samaria como
Damasco. \bibleverse{10} Yo fui quien conquistó estos reinos junto con
...
eran mejores que las de Jerusalén y Samaria. \footnote{\textbf{10:10} Is
  36,18-20} \bibleverse{11} ¿Por qué no voy a hacer con Jerusalén y sus
...
\bibleverse{12} Una vez que el Señor haya terminado todo su trabajo
contra el Monte Sion y Jerusalén, él\footnote{\textbf{10:12} ``Él'':
  Literalmente, ``Yo''.} castigará al rey de Asiria por su terrible
arrogancia y por la mirada engreída de sus ojos. \bibleverse{13} Porque
...
gobernantes de sus tronos. \bibleverse{14} Como si robara un nido de
...
\bibleverse{15} ¿Acaso un hacha dice que es más importante que la
...
de madera. \footnote{\textbf{10:15} Is 10,5} \bibleverse{16} Así que el
...
se pondrá debajo de todo lo que él está tan orgulloso. \bibleverse{17}
La luz de Israel se convertirá en un fuego, y su Santo se convertirá en
una llama. Quemará sus espinas y zarzas en un solo día. \bibleverse{18}
Destruirá totalmente sus espléndidos bosques y huertos. Asiria se
consumirá, tambaleándose como un enfermo. \bibleverse{19} Los árboles
...
\bibleverse{20} En ese momento, los que queden en Israel y los
...
Israel. \bibleverse{21} Un remanente volverá, un remanente de Jacob
volverá al Dios Fuerte. \bibleverse{22} Israel, aunque tu pueblo sea tan
...
\footnote{\textbf{10:22} Rom 9,27} \bibleverse{23} El Señor Dios
...
\bibleverse{24} Así que esto es lo que dice el Señor, el Señor
...
hicieron los egipcios. \bibleverse{25} Muy pronto dejaré de estar
enojado con ustedes. Entonces volveré mi ira contra ellos y los
destruiré. \bibleverse{26} El Señor Todopoderoso los azotará con un
...
\footnote{\textbf{10:26} Jue 7,25; Éxod 14,26} \bibleverse{27} En ese
...
\bibleverse{28} Los asirios llegaron a Ajat, pasaron por Migrón y
almacenaron sus provisiones en Micmas. \bibleverse{29} Cruzaron el paso
diciendo: Pasaremos la noche en Geba. El pueblo de Ramá tiembla de
miedo; los habitantes de Guibeá de Saúl huyen. \bibleverse{30} ¡Griten
una advertencia, pueblo de Galim! ¡Presten atención, los que viven en
Lais! ¡Pobre pueblo de Anatot! \bibleverse{31} Los habitantes de
Madmena, todos huyen. Los habitantes de Gebim buscan un lugar seguro.
\bibleverse{32} Hoy los invasores se detienen en Nob, agitando sus puños
en el monte de la Hija de Sión, en la colina de Jerusalén.

\bibleverse{33} Mira cómo el Señor Todopoderoso va a cortar las ramas
...
orgullosos serán derribados.\footnote{\textbf{10:33} La profecía pasa
  ...
  árboles''.} \bibleverse{34} Cortará el espeso bosque con un hacha, y
...
\bibleverse{1} Del tronco de Isaí saldrá un brote, y de sus raíces una
rama que dará fruto. \bibleverse{2} Descansará sobre él el Espíritu del
...
\footnote{\textbf{11:2} Is 42,1; Mat 12,18} \bibleverse{3} Su felicidad
consistirá en reverenciar al Señor. No juzgará por lo que ve, ni tomará
decisiones basadas en lo que oye. \bibleverse{4} En cambio, juzgará a
...
\bibleverse{5} Llevará la bondad como una faja y la confianza como un
cinturón.

\bibleverse{6} Los lobos vivirán con los corderos; los leopardos se
...
ganado joven estarán juntos, y un niño pequeño los guiará. \footnote{\textbf{11:6}
  Is 65,25} \bibleverse{7} Las vacas y los osos pastarán juntos; los
leones jóvenes comerán paja como el ganado. \bibleverse{8} Los bebés
...
\bibleverse{9} Nada causará daño ni perjuicio en ninguna parte de mi
...
\bibleverse{10} En ese momento la raíz de Isaí se erigirá como un
...
\bibleverse{11} En ese momento el Señor actuará por segunda
...
\bibleverse{12} Levantará un estandarte para las naciones y reunirá al
pueblo exiliado de Israel; reunirá al pueblo disperso de Judá desde los
confines de la tierra. \bibleverse{13} Los celos de Efraín desaparecerán
y los enemigos de Judá serán destruidos; Efraín no tendrá celos de Judá
y Judá no tratará a Efraín como enemigo. \bibleverse{14} Juntos volarán
...
convertirán en sus súbditos. \bibleverse{15} El Señor dividirá el Golfo
...
corrientes que la gente podrá cruzar fácilmente a pie. \bibleverse{16}
...
\bibleverse{1} En ese momento dirás: ``¡Te alabaré, Señor! Aunque
estabas enojado conmigo, tu ira ha pasado, y ahora me consuelas.
\bibleverse{2} ¡Mira! ¡Dios es mi salvación! ¡Confiaré en él y no tendré
miedo! Porque el Señor es mi fuerza y mi canción, y me ha salvado''.
\bibleverse{3} Con gran alegría tomarás agua del pozo de la salvación.
\footnote{\textbf{12:3} Zac 13,1; Sal 46,5} \bibleverse{4} En ese
...
\bibleverse{5} Canten al Señor por todas las cosas gloriosas que ha
hecho; que todo el mundo lo sepa. \bibleverse{6} Griten con fuerza y
...
\bibleverse{1} Este es el mensaje que recibió Isaías, hijo de Amoz,
...
\bibleverse{2} Levanten un estandarte en la cima de una colina desnuda;
...
príncipes.\footnote{\textbf{13:2} ``Palacios de los príncipes'':
  ...
  13,17} \bibleverse{3} He ordenado a los que he elegido que ataquen; he
llamado a mis guerreros para que ejecuten mi furioso juicio y celebren
mi triunfo. \bibleverse{4} ¡Un ruido viene de las montañas, que suena
...
para la guerra. \bibleverse{5} Vienen de tierras lejanas, de más allá de
los horizontes lejanos -- el Señor y las armas de su furia -- vienen a
destruir todo el país.

\bibleverse{6} Aúllen de miedo, porque se acerca el día del Señor, el
tiempo en que el Todopoderoso destruye. \footnote{\textbf{13:6} Jl 1,15}
\bibleverse{7} A todos se les caerán las manos, y todos perderán la
cabeza por el pánico. \bibleverse{8} Estarán aterrorizados; el dolor y
...
\bibleverse{9} ¡Presten atención! Viene el día del Señor, cruel, con
furia y con una ira feroz, para devastar la tierra y aniquilar a sus
pecadores. \bibleverse{10} Las estrellas de las constelaciones del cielo
no brillarán. Cuando el sol se levante, quedará oscuro. La luna no dará
luz. \bibleverse{11} Castigaré al mundo por su maldad, y a los impíos
...
arrogantes, y humillaré a los tiranos y su orgullo. \bibleverse{12} Haré
que la gente sea más escasa que el oro puro, más rara que el oro de
Ofir. \footnote{\textbf{13:12} 1Re 9,28} \bibleverse{13} Haré temblar
...
\bibleverse{14} Como una gacela cazada, o como ovejas sin pastor, los
babilonios\footnote{\textbf{13:14} ``Los babilonios'': Añadido para
  mayor claridad.} volverán a su propio pueblo, huirán a su tierra.
\bibleverse{15} Cualquiera que sea capturado, será apuñalado hasta la
muerte; cualquiera que sea capturado será muerto a espada.
\bibleverse{16} Sus hijos pequeños serán despedazados mientras miran,
...
\bibleverse{17} Haré que los medos los ataquen, gente a la que no le
importa la plata ni el oro. \bibleverse{18} Sus arcos masacrarán a sus
jóvenes; no tendrán piedad de los bebés; no tendrán piedad de los niños.
\footnote{\textbf{13:18} Is 13,16} \bibleverse{19} Babilonia, la ciudad
...
babilónico, será demolida por Dios como Sodoma y Gomorra. \footnote{\textbf{13:19}
  Gén 19,24-25} \bibleverse{20} Nadie volverá a vivir en Babilonia.
Estará desierta; ningún nómada del desierto instalará allí una tienda,
ningún pastor llevará allí un rebaño a descansar. \bibleverse{21} Sólo
...
cabras salvajes saltarán alrededor. \bibleverse{22} Las hienas aullarán
...
\bibleverse{1} Pero el Señor será misericordioso con los descendientes
...
\bibleverse{2} Las naciones irán con ellos y los acompañarán a su propia
...
\bibleverse{3} En ese momento el Señor les aliviará el dolor y la
...
\bibleverse{4} Se burlarán del rey de Babilonia, diciendo: ``¡Cómo se ha
acabado tu dominio opresor y se ha detenido tu insolencia!
\bibleverse{5} El Señor ha roto la vara de los impíos, el cetro de los
gobernantes. \bibleverse{6} Tú seguías golpeando furiosamente a los
pueblos extranjeros sin parar, y gobernabas agresivamente a las naciones
con una persecución desenfrenada. \bibleverse{7} ¡Ahora toda la tierra
descansa en paz, y todos comienzan a celebrar! \bibleverse{8} Los
...
\bibleverse{9} ``Los que están en la tumba de abajo están ansiosos por
...
las naciones se levantan de sus tronos.\footnote{\textbf{14:9} Estos
  versos son poéticos y no deben tomarse literalmente.} \bibleverse{10}
Todos hablarán y te dirán: `Así que tú también eres tan débil como
nosotros; te has vuelto igual que nosotros. \bibleverse{11} Tu orgullo
...
\bibleverse{12} ``Estrella de la mañana,\footnote{\textbf{14:12}
...
\bibleverse{13} Te dijiste a ti mismo: `Subiré al cielo. Levantaré mi
...
\bibleverse{14} Subiré a las alturas sobre las nubes; me haré semejante
al Altísimo'. \footnote{\textbf{14:14} Ezeq 28,14} \bibleverse{15} Pero
tú serás arrastrado al sepulcro, a las profundidades de la fosa.
\bibleverse{16} Los que te vean te mirarán fijamente, examinándote de
cerca, preguntando: `¿Es éste el hombre que hizo temblar la tierra, que
hizo temblar los reinos? \bibleverse{17} ¿Es éste el que convirtió el
mundo en un desierto, destruyó ciudades y nunca dejó que sus prisioneros
volvieran a casa?'

\bibleverse{18} ``Todos los demás reyes de las naciones yacen
espléndidos en sus grandes mausoleos. \bibleverse{19} Pero tú eres
...
han arrojado a un pozo lleno de piedras. \bibleverse{20} No serás
...
\bibleverse{21} Prepárate para ejecutar a sus hijos por culpa de los
...
\bibleverse{22} ``Vendré y los atacaré, declara el Señor Todopoderoso.
Destruiré todo: su reputación, los que quedan, sus hijos y sus
descendientes, dice el Señor. \bibleverse{23} Convertiré a Babilonia en
...
\bibleverse{24} El Señor Todopoderoso ha hecho un juramento: Será como
lo he planeado. Sucederá como lo he decidido. \bibleverse{25} Aplastaré
...
sobre los hombros de mi pueblo. \bibleverse{26} Este es el plan que he
hecho con respecto a toda la tierra; mi mano se extiende para controlar
a todas las naciones. \bibleverse{27} El Señor Todopoderoso ha hecho su
...
\bibleverse{28} El siguiente mensaje llegó el año en que murió el rey
Acaz.

\bibleverse{29} Todos ustedes, filisteos, no celebren que se haya roto
...
víbora, su fruto será una serpiente voladora. \footnote{\textbf{14:29}
  Jer 47,-1} \bibleverse{30} Los pobres tendrán comida y los necesitados
...
\bibleverse{31} ¡Lloren, puertas! ¡Llora, ciudad! ¡Fúndanse en la
hazaña, todos los filisteos! Porque una nube de humo se acerca desde el
norte: un ejército que no tiene soldados.

\bibleverse{32} ¿Cuál será la respuesta dada a los mensajeros de esa
...
\bibleverse{1} Un mensaje sobre Moab. La ciudad de Ar en Moab es
devastada, ¡destruida en una sola noche! La ciudad de Quir, en Moab, ha
sido devastada y destruida en una sola noche.

\bibleverse{2} Los habitantes de Dibón suben a su Templo para llorar en
...
\bibleverse{3} Llevan cilicio en sus calles. En las azoteas y en las
plazas todos lloran, se postran llorando. \footnote{\textbf{15:3} Is
  22,1} \bibleverse{4} El pueblo de Hesbón y Eleale grita de tristeza,
sus voces se escuchan hasta Jahaza. Por eso hasta los soldados más
valientes de Moab gritan, porque están aterrorizados. \bibleverse{5}
...
\bibleverse{6} Todas las aguas de Nimrim se han secado. La hierba se ha
marchitado, toda la vegetación ha desaparecido, no queda nada verde.
\bibleverse{7} Todo lo que habían ganado, todas sus posesiones, tienen
que llevarlas al otro lado del río Sauce. \bibleverse{8} Su grito de
dolor resuena en todo el país de Moab; sus lamentos y su luto se
extienden desde Eglaim hasta Beer-elim. \bibleverse{9} El río
...
\bibleverse{1} Envíen corderos como tributo al gobernante de la
...
a lo largo del desierto, hasta la montaña de la hija de Sion.\footnote{\textbf{16:1}
  ``La hija de Sión'' es Jerusalén.} \bibleverse{2} Las mujeres moabitas
...
\bibleverse{3} Piénsalo y toma una decisión. Haz que tu sombra sea tan
...
no los traiciones mientras huyen.\footnote{\textbf{16:3} Algunos creen
  ...
  de los refugiados de Judá.} \bibleverse{4} Deja que mis refugiados se
...
se vayan los invasores agresivos. \bibleverse{5} Entonces se instaurará
...
\bibleverse{6} Sabemos todo sobre el orgullo de los moabitas, lo
terriblemente vanidosos y engreídos que son, completamente arrogantes.
Pero su jactancia es falsa. \bibleverse{7} Todos los moabitas se
...
Kir-hareset, todos ellos destruidos. \bibleverse{8} Los campos de Hesbón
...
al este hacia el desierto, y al oeste hasta el mar. \bibleverse{9} Por
...
\bibleverse{10} La alegría y el gozo han desaparecido. Nadie celebra en
los campos de cosecha ni en los viñedos; nadie grita de alegría. Nadie
pisa las uvas en los lagares. Han dejado de alegrarse. \bibleverse{11}
Con el corazón roto, lloro por Moab como una música triste en un arpa;
en el fondo lloro por Kir-hareset. \bibleverse{12} Los moabitas van y se
desgastan adorando en sus lugares altos. Van a sus santuarios a rezar,
pero no les sirve de nada.

\bibleverse{13} Este es el mensaje que el Señor ya ha dado sobre Moab.
\bibleverse{14} Pero ahora el Señor vuelve a hablar y dice: Dentro de
...
\bibleverse{1} Un mensaje sobre Damasco. Mira, Damasco dejará de existir
como ciudad. En cambio, se convertirá en un montón de ruinas.
\footnote{\textbf{17:1} Jer 49,23; Am 1,3}

\bibleverse{2} Los pueblos de Aroer quedarán abandonados. Los rebaños
vivirán en las calles y descansarán allí, porque no habrá nadie que los
ahuyente. \bibleverse{3} La ciudad fortificada desaparecerá de
...
\bibleverse{4} En aquel tiempo la gloria de Jacob se desvanecerá;
perderá su fuerza.\footnote{\textbf{17:4} ``Perderá su fuerza'':
  Literalmente, ``la grasa de su carne se volverá magra''.}
\bibleverse{5} Se verá tan vacío como los campos después de que los
...
\bibleverse{6} Pero quedarán algunas, como un olivo que ha sido
...
Israel. \bibleverse{7} En ese momento la gente le prestará atención a su
Creador y mirará al Santo de Israel. \bibleverse{8} No creerán en los
altares que construyeron ni en los ídolos que hicieron; no mirarán a los
postes de Asera ni a los altares de incienso. \bibleverse{9} En ese
...
invadieron.\footnote{\textbf{17:9} Se hace referencia a la época en que
  ...
  israelitas.} El país quedará completamente desolado. \bibleverse{10}
...
vides exóticas, \bibleverse{11} aunque las hagan crecer el día que las
...
\bibleverse{12} ¡Viene el desastre para las muchas naciones que gruñen,
...
rugen, rugiendo como las aguas estruendosas!\footnote{\textbf{17:12}
  ...
  Asiria.} \bibleverse{13} Las naciones rugen como el estruendo de las
...
la tormenta. \bibleverse{14} ¡El terror repentino llega al atardecer!
...
\bibleverse{1} La tragedia está llegando a la tierra de las alas
giratorias que se encuentra a lo largo de los ríos de Etiopía,
\bibleverse{2} Ellos envían mensajeros río abajo\footnote{\textbf{18:2}
...
ríos.\footnote{\textbf{18:2} El hebreo de este verso no es claro y ha
  sido interpretado de diversas maneras.} \bibleverse{3} Todos los
...
\bibleverse{4} Porque esto es lo que me ha dicho el Señor: Observaré en
...
\bibleverse{5} Porque antes de la vendimia, después de que la flor se
haya ido y se convierta en una uva sin madurar, él poda la vid con un
cuchillo para quitarle los sarmientos y las ramas. \bibleverse{6} Todos
...
los animales salvajes en invierno. \bibleverse{7} En aquel tiempo se
...
\bibleverse{1} Un mensaje sobre Egipto. Mira, el Señor está cabalgando
...
\bibleverse{2} Animaré a los egipcios a atacar a otros egipcios.
Lucharán entre sí, vecino contra vecino, pueblo contra pueblo y reino
contra reino. \bibleverse{3} Destruiré la confianza de los egipcios.
...
\bibleverse{4} Entregaré a los egipcios a un duro dictador. Un rey cruel
los gobernará, declara el Señor.

\bibleverse{5} Las aguas del Nilo\footnote{\textbf{19:5} Literalmente,
  ``las aguas del mar''.} fallará, y su cauce se secará al sol.
\bibleverse{6} Los canales comenzarán a apestar; las ramas del Nilo en
Egipto se secarán hasta quedar en un hilillo y se secarán; las cañas y
los juncos se marchitarán. \bibleverse{7} La vegetación de las riberas
...
\bibleverse{8} Los pescadores se lamentarán: todos los que usan anzuelos
para pescar en el Nilo llorarán y se lamentarán, junto con los que
pescan echando las redes al agua. \bibleverse{9} Los trabajadores que
preparan el lino para el lino y los tejedores de telas
blancas\footnote{\textbf{19:9} Probablemente, refiriéndose al algodón.}
estarán desesperados. \bibleverse{10} Los trabajadores de la industria
...
\bibleverse{11} Los líderes de Zoán son estúpidos. Los sabios consejeros
...
soy un hombre sabio, descendiente de antiguos reyes''? \bibleverse{12}
...
\bibleverse{13} Los dirigentes de Zoán se han vuelto estúpidos; los
...
pueblo. \bibleverse{14} El Señor ha mezclado un espíritu de confusión
para que beban, haciendo que los egipcios se tambaleen en todo lo que
hacen, como un borracho que resbala en su propio vómito. \bibleverse{15}
...
\bibleverse{16} En ese momento los egipcios se volverán como mujeres.
Temblarán de miedo cuando el Señor Todopoderoso levante su brazo contra
ellos. \bibleverse{17} La tierra de Judá será una fuente de terror para
...
\bibleverse{18} En ese momento habrá cinco ciudades en Egipto que hablen
...
\bibleverse{19} En ese momento habrá un altar al Señor en medio de
Egipto, y un monumento de piedra al Señor en su frontera.
\bibleverse{20} Esto será una señal y un testimonio de la presencia del
...
luchará por ellos y los rescatará. \bibleverse{21} El Señor se dará a
...
\bibleverse{22} El Señor infligirá una plaga a Egipto. Lo hará, pero los
...
\bibleverse{23} En ese momento habrá una carretera de Egipto a Asiria.
Los asirios irán a Egipto, y los egipcios irán a Asiria. Los egipcios y
los asirios adorarán juntos.

\bibleverse{24} En ese momento Israel será la tercera parte de esta
alianza, uniéndose a Egipto y Asiria, una bendición para toda la tierra.
\bibleverse{25} El Señor Todopoderoso los bendecirá diciendo: ``Benditos
...
\bibleverse{1} En el año en que Sargón,\footnote{\textbf{20:1} Esta es
...
atacar la ciudad de Asdod y la conquistó, \footnote{\textbf{20:1} 2Re
  18,17} \bibleverse{2} en ese momento el Señor habló por medio de
...
\bibleverse{3} Entonces el Señor dijo: ``De la misma manera que mi
siervo Isaías ha andado desnudo y descalzo durante tres años como señal
y advertencia contra Egipto y Etiopía, \bibleverse{4} así el rey de
...
para vergüenza de Egipto. \bibleverse{5} Ellos\footnote{\textbf{20:5}
...
en Egipto. \bibleverse{6} En ese momento la gente que vive en las
...
\bibleverse{1} Un mensaje sobre el desierto junto al mar.\footnote{\textbf{21:1}
...
\bibleverse{2} una visión horripilante que me ha sido explicada. El
...
\bibleverse{3} Por ello, mi cuerpo está lleno de agonía. Me abruma el
dolor, como el de una mujer que da a luz. Me confunde lo que oigo; me
angustia lo que veo. \bibleverse{4} Mi mente vacila; tiemblo de pánico.
...
\bibleverse{5} Ponen la mesa, extienden las alfombras, comen y
beben\ldots{} ``¡Levántense, oficiales! Preparen sus escudos para la
batalla!'' \bibleverse{6} Esto es lo que me dijo el Señor: ``¡Ve! Haz
que un vigía vigile, y asegúrate de que informe de lo que ve.
\bibleverse{7} Cuando vea que se acercan carros tirados por parejas de
caballos, jinetes en asnos y en camellos, que vigile con mucho cuidado,
prestando mucha atención''. \bibleverse{8} Entonces el vigía\footnote{\textbf{21:8}
...
\bibleverse{9} ¡Ahora mira! Viene un hombre en un carro con un par de
...
\bibleverse{10} Mi pobre pueblo oprimido y tan maltratado, les he
...
\bibleverse{11} Un mensaje sobre Edom.\footnote{\textbf{21:11} La
...
\bibleverse{12} El vigilante responde: ``La mañana está llegando, pero
pronto volverá la noche. Si quieres volver a preguntar, vuelve y
pregunta''.

\bibleverse{13} Un mensaje sobre Arabia. Caravanas de Dedán, pasen la
noche en los arbustos.

\bibleverse{14} Pueblo de Tema, lleven agua a los sedientos, salid al
encuentro de los refugiados con comida. \bibleverse{15} Huyen de una
batalla feroz, de espadas, de espadas desenvainadas, de arcos y flechas.
\bibleverse{16} Esto es lo que me dijo el Señor: ``Dentro de un año,
igual que un trabajador contratado cuenta exactamente los años, toda la
gloria de Cedar desaparecerá. \bibleverse{17} Sólo quedarán unos pocos
...
\bibleverse{1} Un mensaje sobre el Valle de la Visión (Jerusalén). ¿Qué
está sucediendo? ¿Por qué todo el mundo se ha subido a los tejados?
\footnote{\textbf{22:1} Is 15,3}

\bibleverse{2} Hay gritos y conmoción en toda la ciudad con gente
...
batalla.\footnote{\textbf{22:2} Una crítica al pueblo de Jerusalén que
  no luchaba contra los invasores.} \bibleverse{3} Todos tus líderes
...
camino. \bibleverse{4} Por eso dije: ``¡Váyanse! Déjenme llorar en paz.
...
\bibleverse{5} Porque el Señor tiene un día de derrota, de pánico y
confusión en el Valle de la Visión, un día de derribo de muros y de
gritos de auxilio a las montañas. \bibleverse{6} Los elamitas recogen
...
batalla.\footnote{\textbf{22:6} ``Listos para la batalla'': Añadido para
  mayor claridad.} \bibleverse{7} Tus valles más fértiles están ahora
llenos de carruajes enemigos y su caballería está a tus puertas.
\bibleverse{8} Las defensas de Judá han sido despojadas y por eso en ese
...
\bibleverse{9} Examinaste las fracturas de los muros de la Ciudad de
David y descubriste que había muchas. Hiciste que se acumulara agua en
el estanque inferior. \footnote{\textbf{22:9} Is 7,3} \bibleverse{10}
...
\footnote{\textbf{22:10} Jer 33,4} \bibleverse{11} Construiste un
...
\bibleverse{12} En ese momento el Señor, el Señor Todopoderoso, los
invitaba a llorar y lamentarse; a que se afeitaran la cabeza y se
vistieran de cilicio. \bibleverse{13} Pero lugar de eso siguen con sus
...
\bibleverse{14} El Señor Todopoderoso me lo ha dejado claro: ``No
...
\bibleverse{15} Esto es lo que el Señor, el Señor Todopoderoso, me dijo
que hiciera. ``Ve donde Sebna, el administrador del palacio, y dale este
mensaje: \bibleverse{16} '¿Qué haces aquí? ¿Quién te crees que eres para
hacerte un sepulcro en lo alto de una colina, para hacerte un lugar de
descanso? \bibleverse{17} ¡Cuidado, gran hombre! El Señor está a punto
de agarrarte y arrojarte violentamente a un lado. \bibleverse{18} Te va
...
familia real de tu señor. \bibleverse{19} Yo\footnote{\textbf{22:19}
...
\bibleverse{20} ``Después llamaré a mi siervo, Eliaquim, hijo de
Hilcías. \footnote{\textbf{22:20} Is 36,3}

\bibleverse{21} Le pondré tu manto y le colocaré tu faja, y le daré tu
autoridad. Él será un padre para el pueblo que vive en Jerusalén y en
Judá. \bibleverse{22} Le daré la llave de la casa de David.\footnote{\textbf{22:22}
...
él cierra, nadie lo puede abrir. \bibleverse{23} Lo clavaré como un
clavo bien clavado en una pared. Él traerá el honor a su familia.
\bibleverse{24} ``Sobre él recaerá la pesada carga de la familia de su
padre: todos los descendientes y los parientes políticos, todos los
pequeños recipientes, cuencos y toda clase de jarras. \bibleverse{25}
...
\bibleverse{1} Un mensaje sobre Tiro. ¡Aúllen, gente de los barcos de
...
\bibleverse{2} Permanezcan en silencio, habitantes de las costas,
mercaderes de Sidón y marineros. \bibleverse{3} El grano
...
las naciones. \bibleverse{4} ¡Siente la vergüenza, Sidón! Porque la
...
\bibleverse{5} Cuando las noticias sobre Tiro lleguen a Egipto, se
angustiarán. \bibleverse{6} ¡Naveguen y crucen hacia Tarsis! ¡Lloren,
habitantes de las costas! \bibleverse{7} ¿Es ésta realmente su ciudad
triunfante, cuyos comienzos se remontan a un pasado lejano, que ha
enviado gente a colonizar lugares lejanos?

\bibleverse{8} ¿Quién ha planeado este ataque a Tiro? ¡Tiro, que creó
reinos, cuyos mercaderes eran príncipes, cuyos comerciantes eran
honrados en todo el mundo! \bibleverse{9} El Señor Todopoderoso lo
planeó, para humillar su orgullo en toda su gloria, y para derribar a
todos los que reciben honores mundanos. \bibleverse{10} Cultiva tu
...
puerto.\footnote{\textbf{23:10} El hebreo de este verso no está claro.
  ...
  Tiro.} \footnote{\textbf{23:10} Job 12,21; Job 12,18} \bibleverse{11}
...
sus fortalezas. \bibleverse{12} Dijo: ``No festejes más, virgen
maltratada hija de Sidón. Ve y navega hasta Chipre; pero ni siquiera
allí encontrarás descanso''.

\bibleverse{13} ¡Mira el país de los babilonios, este pueblo que ya no
...
y arruinaron el país. \bibleverse{14} ¡Giman a gritos, gente en los
...
\bibleverse{15} En ese momento la ciudad de Tiro será olvidada durante
...
prostituta: \bibleverse{16} ¡Toma una lira y recorre la ciudad,
prostituta olvidada! Toca y canta para que la gente se acuerde de ti.
\bibleverse{17} Después de setenta años, el Señor restaurará Tiro. Pero
entonces volverá a ofrecer sus servicios como una prostituta,
vendiéndose a todos los reinos del mundo. \bibleverse{18} Sin embargo,
...
\bibleverse{1} ¡Estén atentos! El Señor va a destruir la tierra, para
dejarla totalmente devastada. Va a destrozar la superficie de la tierra
y a dispersar a sus habitantes. \bibleverse{2} Sucederá lo mismo con
...
o deudores. \bibleverse{3} La tierra será completamente asolada y
...
\bibleverse{4} La tierra se seca y se marchita; el mundo se seca y se
marchita, los altos y poderosos\footnote{\textbf{24:4} ``Los altos y
  poderosos'': o, ``los cielos''.} se marchitan junto con la tierra.
\bibleverse{5} La tierra está contaminada por su gente; han despreciado
las leyes de Dios, han violado sus reglamentos y han quebrantado el
acuerdo eterno con él. \bibleverse{6} Por eso una maldición está
destruyendo la tierra. El pueblo sufre por su culpa. Los habitantes de
la tierra se consumen y sólo unos pocos sobreviven. \bibleverse{7} El
vino nuevo se seca y la vid se marchita. Todo el pueblo que celebra
gime. \footnote{\textbf{24:7} Jl 1,12} \bibleverse{8} El alegre sonido
...
la deliciosa música de arpa se ha acabado, \footnote{\textbf{24:8} Jer
  7,34; Jer 16,9} \bibleverse{9} la gente ya no canta mientras bebe
vino, y la cerveza sabe amarga. \bibleverse{10} La caótica ciudad se
desmorona; todas las casas están cerradas con barrotes para impedir el
paso a los demás. \bibleverse{11} Las multitudes en la calle gritan,
exigiendo tener vino. La alegría se convierte en oscuridad. No queda
felicidad en la tierra. \bibleverse{12} La ciudad está en un horrible
...
\bibleverse{13} Así va a ser en toda la tierra entre las naciones: sólo
...
\bibleverse{14} Estos supervivientes gritan y cantan de alegría. Desde
el oeste alaban la majestad del Señor. \bibleverse{15} Desde el oriente
glorifican al Señor; desde las orillas del mar alaban el nombre del
Señor, el Dios de Israel. \bibleverse{16} Desde los confines de la
...
\bibleverse{17} Terrores, trampas y lazos los esperan, pueblos de la
tierra. \bibleverse{18} Los que huyan aterrorizados caerán en una fosa,
...
tierra tiemblan. \bibleverse{19} La tierra tiembla por completo, se
desgarra y se sacude violentamente. \footnote{\textbf{24:19} 2Pe 3,10}
\bibleverse{20} La tierra se tambalea de un lado a otro como un
...
\bibleverse{21} En ese momento el Señor castigará a todos los altos
seres celestiales y a los reyes de la tierra. \footnote{\textbf{24:21}
  Apoc 19,18-21}

\bibleverse{22} Serán reunidos, prisioneros en una fosa. Serán
encarcelados, y finalmente serán castigados. \bibleverse{23} La luna
...
\bibleverse{1} Señor, tú eres mi Dios. Te honraré y alabaré quien eres,
porque has hecho cosas maravillosas que planificaste hace tiempo. Eres
fiel y digno de confianza. \bibleverse{2} Has convertido la
...
reconstruida. \bibleverse{3} Por eso las naciones poderosas te honrarán;
ciudades de naciones brutales te temerán. \bibleverse{4} Pero tú has
...
contra un muro, \footnote{\textbf{25:4} Is 4,6} \bibleverse{5} como el
...
\bibleverse{6} En esta montaña\footnote{\textbf{25:6} Refiriéndose al
...
carne. \bibleverse{7} En este monte destruirá el velo que cubre a todas
las naciones, la sábana que está sobre todos. \bibleverse{8} Destruirá
...
\bibleverse{9} En ese momento su pueblo dirá: ``¡Mira! Este es nuestro
...
trae''. \footnote{\textbf{25:9} Sal 48,15} \bibleverse{10} La mano
...
\bibleverse{11} Extenderán sus manos para tratar de salvarse, como los
nadadores que usan sus manos para nadar, pero su orgullo será humillado
por más que se agiten. \bibleverse{12} Moab,\footnote{\textbf{25:12}
...
\bibleverse{1} En ese momento, este será el canto que se entone en la
...
\bibleverse{2} Abre las puertas para que entre la nación que sigue la
justicia, la nación que permanece fiel. \footnote{\textbf{26:2} Sal
  118,19} \bibleverse{3} Mantendrás en completa paz a los que mantienen
su mente centrada en ti, porque confían en ti. \bibleverse{4} Confía en
el Señor para siempre, porque el Señor Dios es la Roca eterna.
\footnote{\textbf{26:4} Deut 32,4} \bibleverse{5} Él derriba a los
poderosos que viven con altivez; derriba la ciudad orgullosa con sus
altos muros, haciéndola caer al suelo, hasta el polvo. \bibleverse{6}
...
\bibleverse{7} Tú, Dios, haces lo que es justo, y enderezas el camino de
los que viven rectamente; allanas su senda. \bibleverse{8} Sí, seguimos
tus instrucciones, Señor, ponemos nuestra esperanza en ti. Lo que más
deseamos es acordarnos de ti y de tu maravilloso nombre. \bibleverse{9}
...
justo. \bibleverse{10} Aunque se muestre la gracia a los malvados, no
...
grandeza del Señor. \bibleverse{11} Señor, tú tienes la mano levantada,
...
\bibleverse{12} Señor, tú nos das la paz y la prosperidad; todo lo que
...
\bibleverse{13} Señor, Dios nuestro, ha habido otros señores además de
ti que nos han gobernado, pero tú eres el único al que adoramos.
\bibleverse{14} Están muertos, no volverán a vivir;\footnote{\textbf{26:14}
...
ellos. \bibleverse{15} Tú has hecho crecer a la nación, Señor, tú has
hecho crecer a la nación. Has ampliado nuestras fronteras de la tierra,
y te hemos honrado. \bibleverse{16} Señor, cuando sufrimos acudimos a
ti, derramando nuestras oraciones como susurros mientras nos
disciplinabas. \footnote{\textbf{26:16} Is 28,19; Os 5,15}
\bibleverse{17} Al igual que una mujer embarazada que da a luz se
revuelve y grita de dolor, así éramos nosotros en tu presencia, Señor.
\footnote{\textbf{26:17} Juan 16,21; Apoc 12,2} \bibleverse{18} Sin
...
del mundo no han cobrado vida.\footnote{\textbf{26:18} ``No han cobrado
  ...
  ``nacer''.} \footnote{\textbf{26:18} Miq 4,10} \bibleverse{19} Pero
...
\bibleverse{20} Pueblo mío, entrad en vuestras casas y cerrad las
puertas detrás de ustedes. Escóndanse allí por un tiempo hasta que pase
la furia. \footnote{\textbf{26:20} Sal 57,2}

\bibleverse{21} ¡Cuidado! El Señor viene desde donde vive para castigar
...
\bibleverse{1} En ese momento el Señor tomará su espada afilada, grande
...
\bibleverse{2} En ese momento, canta sobre una hermosa viña. \footnote{\textbf{27:2}
  Is 5,1} \bibleverse{3} Yo, el Señor, la cuido, regándola a menudo. La
cuido de noche y de día para que nadie la dañe. \bibleverse{4} Ya no me
...
\bibleverse{5} De lo contrario, deberían acudir a mí en busca de
...
\bibleverse{6} En el futuro los descendientes de Jacob serán como un
árbol que echa raíces. Israel florecerá y echará brotes, y llenará de
frutos el mundo entero. \bibleverse{7} ¿Ha golpeado el Señor a Israel
como golpeó a los que lo atacaron? ¿Los ha matado como mató a sus
asesinos?\footnote{\textbf{27:7} La respuesta implícita es ``No''.}
\bibleverse{8} Se ocupó de ellos enviándolos al exilio, desterrándolos.
Los expulsó con su poderosa fuerza, como cuando sopla el viento del
este. \footnote{\textbf{27:8} Jer 30,11; Jer 18,17} \bibleverse{9} A
...
no quedarán en pie postes de Asera ni altares de incienso. \footnote{\textbf{27:9}
  Is 31,7; Lev 26,30} \bibleverse{10} La ciudad fortificada será
...
\bibleverse{11} Sus ramas secas serán arrancadas y utilizadas por las
...
\bibleverse{12} En ese momento el Señor trillará el grano cosechado
desde el río Éufrates hasta el Wadi de Egipto, y ustedes, israelitas,
serán recogidos uno por uno.

\bibleverse{13} En ese momento sonará una fuerte trompeta, y los que
...
\bibleverse{1} La tragedia llega a la ciudad de Samaria,\footnote{\textbf{28:1}
...
\bibleverse{2} ¡Cuidado, porque el Señor tiene a uno que es fuerte y
poderoso! Lo va a derribar como una tormenta de granizo y un tornado,
como una lluvia torrencial y una inundación abrumadora. \bibleverse{3}
Esa gloria suprema de los borrachos de Efraín será pisoteada.
\bibleverse{4} Esa flor marchita de maravillosa belleza, asentada sobre
...
\bibleverse{5} En ese momento, el Señor Todopoderoso será una corona
hermosa y gloriosa que enorgullecerá a los que queden de su pueblo.
\bibleverse{6} Será una inspiración para que los jueces hagan lo
...
\bibleverse{7} Pero este pueblo también bebe tanto vino y cerveza que se
...
tomar decisiones. \bibleverse{8} Todas sus mesas están llenas de vómito:
la suciedad está por todas partes.

\bibleverse{9} ``¿A quién trata de enseñar el conocimiento?'', se
...
retirados del pecho? \bibleverse{10} Nos dice este bla y aquel bla, bla
...
\bibleverse{11} Bien: ahora el Señor hablará a este pueblo en lenguas
extranjeras que les suenen extrañas!\footnote{\textbf{28:11} Como la
  ...
  13.} \bibleverse{12} Les había dicho: ``Pueden descansar aquí. Dejen
...
descansar con seguridad''. Pero se negaron a escuchar. \footnote{\textbf{28:12}
  Mat 11,28-29} \bibleverse{13} Por lo tanto, el mensaje del Señor para
...
\bibleverse{14} Así que presten atención al mensaje del Señor, ustedes,
gobernantes despreciables que dirigen a este pueblo en Jerusalén.
\bibleverse{15} Ustedes afirman: ``Hemos hecho un acuerdo con la muerte;
...
nuestros propios engaños''. \bibleverse{16} En consecuencia, escuchen lo
...
quedará suelto.\footnote{\textbf{28:16} ``No quedará suelto'': la
  ...
  118,22; Rom 9,33; Rom 10,11; 1Pe 2,6} \bibleverse{17} Haré que la
...
mentiras, y el agua inundará el lugar donde te escondes. \bibleverse{18}
...
\bibleverse{19} Se precipitará una y otra vez, arrastrándote mañana tras
mañana, día y noche, precipitándose una y otra vez. Una vez que
entiendas este mensaje estarás totalmente aterrorizado. \bibleverse{20}
La cama es demasiado corta para que puedas estirarte; la manta es
demasiado estrecha para que no puedas cubrirte. \bibleverse{21} El Señor
...
actuar como debe, su insólita acción. \footnote{\textbf{28:21} 2Sam
  5,20; 1Cró 14,16} \bibleverse{22} Así que no te burles, o tu prisión
...
\bibleverse{23} ¡Escuchen lo que les digo! ¡Escuchen y presten atención!
¡Escuchen mis palabras! \bibleverse{24} ¿Acaso el agricultor se pasa
todo el tiempo arando? ¿O pasa todo el tiempo preparando la tierra?
\bibleverse{25} ¿Acaso, una vez que tiene todo listo, no siembra
semillas como el eneldo y el comino, no planta trigo y cebada en
hileras, con el grano de la escanda como cerco? \bibleverse{26} Su Dios
le da instrucciones y le enseña lo que debe hacer. \bibleverse{27} ¡No
...
\bibleverse{28} El grano que se utiliza para el pan se daña fácilmente,
por lo que no se trilla siempre. Cuando se pasan las ruedas de los
carros con los caballos, no se aplasta. \bibleverse{29} Esto también
...
\bibleverse{1} La tragedia llega a ti Ariel, Ariel la ciudad donde vivió
David. Año tras año tienes tus fiestas. \footnote{\textbf{29:1} Is
  29,7-8} \bibleverse{2} Pero yo voy a causarle problemas a Ariel; la
ciudad llorará y se lamentará, será como el crisol del altar\footnote{\textbf{29:2}
  ...
  ``león de Dios''.} para mí. \bibleverse{3} Te rodearé, te asediaré con
torres y construiré rampas para atacarte. \bibleverse{4} Serás
...
\bibleverse{5} Pero entonces todos tus enemigos serán como polvo fino;
todos tus crueles opresores, como paja que se lleva el viento. Entonces,
de repente, en un abrir y cerrar de ojos, \bibleverse{6} el Señor
...
\footnote{\textbf{29:6} Is 30,30} \bibleverse{7} Las naciones que
asedien a Ariel, que ataquen sus fortificaciones y que atormenten al
pueblo, ¡desaparecerán como si fuera un sueño! \bibleverse{8} Será como
...
\bibleverse{9} ¡Sorpréndanse y asómbrense! ¡Háganse los ciegos para que
no puedan ver! Embriáguese, pero no de vino. Tambaléense, pero no por la
cerveza. \bibleverse{10} Porque el Señor los ha adormecido mucho, y ha
cerrado los ojos y cubierto las cabezas de los que hablan por Dios y ven
visiones. \bibleverse{11} Toda esta visión es como las palabras de un
...
sellado''. \bibleverse{12} Si se lo das a alguien que no sabe leer y le
...
\bibleverse{13} El Señor dice: ``Este pueblo viene a alabarme con sus
...
\bibleverse{14} Así que una vez más sorprenderé a este pueblo con un
...
\bibleverse{15} La tragedia llega a la gente que se toma tantas
...
¿verdad?'' \footnote{\textbf{29:15} Sal 10,11} \bibleverse{16} ¡Qué
...
\bibleverse{17} No pasará mucho tiempo y los bosques del Líbano se
convertirán en un campo productivo, y el campo productivo parecerá un
bosque. \footnote{\textbf{29:17} Is 32,15} \bibleverse{18} En aquel
...
\footnote{\textbf{29:18} Is 35,5} \bibleverse{19} Los humildes serán aún
más felices en el Señor, y los pobres encontrarán su alegría en el Santo
de Israel. \bibleverse{20} Los crueles ya no existirán, los
despreciadores desaparecerán, y los que buscan hacer el mal serán
destruidos: \bibleverse{21} los que dicen cosas para engañar a otros y
...
ya no palidecerán de miedo. \bibleverse{23} Cuando vean a todos sus
...
reverencia por el Dios de Israel. \bibleverse{24} Los que se han
...
\bibleverse{1} La tragedia llega a mis hijos rebeldes, declara el Señor.
Hacen planes que no vienen de mí; hacen alianzas contra mi voluntad,
añadiendo pecado al pecado. \bibleverse{2} Van a Egipto sin preguntarme,
buscando la protección del Faraón, esperando encontrar seguridad
escondida detrás de Egipto. \bibleverse{3} Pero la protección del Faraón
será una vergüenza para ustedes; esconderse detrás de Egipto sólo les
traerá humillación. \bibleverse{4} Aunque tenga funcionarios en Zoán y
sus mensajeros lleguen a Hanes, \bibleverse{5} los egipcios ofenderán a
...
\bibleverse{7} El apoyo de Egipto es un soplo de viento vacío. Por eso
...
\bibleverse{8} Ahora ve y escribe todo esto en una tablilla y en un
pergamino para que perdure por los siglos de los siglos. \bibleverse{9}
Porque son un pueblo rebelde, hijos de mentira, que se niegan a escuchar
las instrucciones del Señor. \bibleverse{10} Les dicen a los que ven
...
profecías falsas. \bibleverse{11} ¡Dejen de decirnos lo correcto; vayan
en otra dirección! No queremos oír más sobre el Santo de Israel''.
\bibleverse{12} Así responde el Santo de Israel: Puesto que han
rechazado este mensaje, y puesto que confían en la opresión y creen en
la deshonestidad, \bibleverse{13} su castigo caerá repentinamente sobre
ustedes, como un alto muro que sobresale y se derrumba en un instante.
\bibleverse{14} Serás destrozado como una vasija de barro, roto en
...
\bibleverse{15} Esto es lo que el Señor Dios, el Santo de Israel, dijo:
...
\bibleverse{16} Respondieron: ``¡No! ¡Escaparemos a caballo!
¡Escaparemos en caballos rápidos!'' ¡Pero los rápidos serán quienes los
persigan! \bibleverse{17} Uno solo de ellos perseguirá a mil de ustedes.
...
\bibleverse{18} Así que el Señor espera, queriendo ser bondadoso con
...
\bibleverse{19} Pueblo de Sión, tú que vives en Jerusalén, ya no tendrás
que llorar. Cuando clames por ayuda, él será bondadoso contigo. Les
responderá en cuanto los escuche. \bibleverse{20} Aunque el Señor les dé
...
\bibleverse{21} Cuando caminen a la derecha o a la izquierda, oirán
detrás de ustedes una voz que les dirá: Este es el camino a seguir.
\footnote{\textbf{30:21} Deut 5,29; Deut 28,14} \bibleverse{22}
...
\bibleverse{23} Él enviará la lluvia cuando siembres, y la tierra
producirá grandes cosechas. En ese momento tu ganado se alimentará en
ricos pastos. \bibleverse{24} Los bueyes y los asnos que ayuden a
cultivar la tierra comerán buenas verduras y granos, esparcidos con
tenedor y pala. \bibleverse{25} En ese tiempo, cuando tus enemigos sean
asesinados y las fortalezas caigan, correrán arroyos de agua por todas
las montañas y colinas. \bibleverse{26} La luna brillará tanto como el
...
\bibleverse{27} ¡Mira cómo llega el Señor desde lejos, ardiendo de ira y
acompañado de espesas nubes de humo! Lo que dice muestra su ira: es como
un fuego que lo quema todo. \bibleverse{28} Su aliento se precipita como
...
pueblos para conducirlos. \bibleverse{29} Pero ustedes tendrán una
...
Señor, a la Roca de Israel. \bibleverse{30} El Señor gritará para que
...
granizo. \bibleverse{31} A la orden del Señor, los asirios serán
destrozados, derribados por su cetro. \bibleverse{32} Cada vez que el
...
\bibleverse{33} El lugar de incineración\footnote{\textbf{30:33}
...
\bibleverse{1} La tragedia se avecina para los que acuden a Egipto en
...
\bibleverse{2} ¡Pero él también es sabio! Traerá el desastre y no
...
ayuda. \footnote{\textbf{31:2} Am 3,6; Núm 23,19} \bibleverse{3} Los
...
\bibleverse{4} Esto es lo que me dijo el Señor: Es como un león joven
...
\bibleverse{5} Como las aves que revolotean por encima, así el Señor
...
y la rescatará. \bibleverse{6} Regresen, israelitas, al que tan
descaradamente se rebelaron. \bibleverse{7} Porque en ese momento cada
...
\bibleverse{8} Los asirios serán muertos por la espada de uno que no es
...
\footnote{\textbf{31:8} Is 37,36} \bibleverse{9} Su ``roca''\footnote{\textbf{31:9}
...
\bibleverse{1} ¡Cuidado! Viene un rey que hace lo correcto cuando
gobierna, y los que gobiernan bajo él actuarán con justicia. \footnote{\textbf{32:1}
  Jer 23,5} \bibleverse{2} Cada uno de ellos será como un refugio contra
...
por el sol.\footnote{\textbf{32:2} ``Calcinado por el sol'':
  ...
  caluroso que causa fatiga.} \bibleverse{3} Entonces todo el que tenga
ojos podrá ver de verdad, y todo el que tenga oídos podrá oír de verdad.
\bibleverse{4} Los impulsivos serán sensatos y reflexionarán; los
tartamudos hablarán con claridad. \footnote{\textbf{32:4} Is 35,6}
\bibleverse{5} Ya no se llamará a los tontos respetables ni a los
sinvergüenzas muy apreciados. \bibleverse{6} Porque los necios sólo
...
niegan el agua al sediento. \bibleverse{7} Los tramposos emplean métodos
perversos; idean planes para arruinar a los pobres con mentiras, incluso
cuando la razón está del lado de los pobres. \bibleverse{8} Pero las
...
\bibleverse{9} ¡Levántense, mujeres que andan relajadas, y presten
atención a lo que digo! Ustedes, señoras sin preocupaciones,
¡escúchenme! \footnote{\textbf{32:9} Is 3,16-999} \bibleverse{10} Dentro
de poco, ustedes, que se creen tan seguras, temblarán de miedo. La
vendimia va a fracasar y no habrá cosecha. \bibleverse{11} ¡Tiemblen,
...
alrededor de la cintura. \bibleverse{12} Golpeen sus pechos con tristeza
por la pérdida de sus hermosos campos, de sus viñas fértiles,
\bibleverse{13} por la pérdida de la tierra de mi pueblo. Lloren porque
ahora está cubierta de espinas y zarzas, lloren por la pérdida de todos
los hogares felices y las ciudades alegres. \bibleverse{14} El palacio
...
y el buen campo crezca como un bosque. \bibleverse{16} Entonces los que
vivan en el desierto practicarán la justicia, y los que vivan entre los
campos harán lo recto. \bibleverse{17} Vivir correctamente traerá paz y
seguridad duraderas. \bibleverse{18} Mi pueblo vivirá en paz, seguro y
protegido en sus hogares. \bibleverse{19} Aunque el granizo puede
destruir un bosque y una ciudad puede ser demolida, \bibleverse{20}
...
\bibleverse{1} La tragedia se acerca a ti, destructor que no has
...
engañado. \bibleverse{2} Señor, por favor, sé benévolo con nosotros;
ponemos nuestra confianza en ti. Sé la fuerza en la que confiamos cada
mañana; sé nuestra salvación en tiempos de angustia. \bibleverse{3}
Cuando ruges, los pueblos huyen; cuando te preparas para la acción, las
naciones se dispersan. \footnote{\textbf{33:3} Sal 68,2} \bibleverse{4}
...
enjambre. \bibleverse{5} El Señor es alabado porque vive en lo más alto
del cielo; ha llenado Sión de justicia y derecho. \bibleverse{6} Él será
...
\bibleverse{7} Pero ¡mira! Hasta tus soldados más valientes lloran a
gritos en la calle; los mensajeros que enviaste a pedir la paz lloran
amargamente. \bibleverse{8} Tus carreteras están desiertas; ya nadie
...
\bibleverse{9} Israel\footnote{\textbf{33:9} ``Israel'': Literalmente,
...
\bibleverse{10} ``¡Pero ahora voy a intervenir!'' dice el Señor.
``¡Estoy dispuesto a actuar! ¡Me mostraré por encima de todos los demás!
\bibleverse{11} Todo lo que das a luz es sólo hierba seca, todo lo que
das a luz es sólo rastrojo. Tu aliento es un fuego que te quemará.
\bibleverse{12} Ustedes serán reducidos a cenizas como espinas que se
cortan y se arrojan al fuego. \bibleverse{13} Los que están lejos,
...
\bibleverse{14} Los pecadores que viven en Sión tiemblan de miedo; los
...
eterno?'' \bibleverse{15} Los que viven correctamente y dicen la verdad,
...
los que cierran los ojos antes que mirar el mal. \footnote{\textbf{33:15}
  Sal 15,2-5; Sal 24,3-4} \bibleverse{16} Vivirán en las alturas;
estarán protegidos por las fortalezas de las montañas; siempre tendrán
comida y siempre tendrán agua.

\bibleverse{17} Verán al rey con su maravillosa apariencia, y
contemplarán una tierra que se extiende a lo lejos. \bibleverse{18} En
...
torres?\footnote{\textbf{33:18} Este versículo se ha ampliado para dar
  ...
  sobre Jerusalén han desaparecido todos.} \bibleverse{19} Ya no verás a
...
\bibleverse{20} Por el contrario, verás a Sión como una ciudad festiva.
...
levantan, cuyas cuerdas nunca se rompen. \bibleverse{21} Aquí mismo,
...
pasar. \bibleverse{22} Porque el Señor es nuestro juez, el Señor es
nuestro legislador, el Señor es nuestro rey. Él es quien nos salvará.
\bibleverse{23} El aparejo de tu barco cuelga suelto, de modo que el
...
los cojos tendrán su parte. \bibleverse{24} Nadie en Israel dirá:
...
\bibleverse{1} ¡Acérquense, naciones, y escuchen! ¡Pueblos, presten
atención! ¡Escuchen estas palabras todos los que viven en la tierra, y
todo lo que viene de ella! \bibleverse{2} La ira del Señor está contra
todas las naciones y su furia está contra todos sus ejércitos. Los
destruirá por completo; los hará masacrar. \bibleverse{3} Los que sean
...
\bibleverse{4} El sol, la luna y las estrellas del cielo se
...
\bibleverse{5} Cuando mi espada haya terminado lo que tiene que
...
\bibleverse{6} La espada del Señor está recubierta de sangre y cubierta
...
tierra de Edom. \bibleverse{7} El buey salvaje caerá con ellos, los
novillos junto con los maduros. Su tierra se empapará de sangre, y su
suelo se empapará de grasa. \bibleverse{8} Porque el Señor tiene un día
de castigo, un año de retribución, por los problemas causados a Sión.
\bibleverse{9} ¡Los arroyos de Edom se convertirán en alquitrán, su
suelo en azufre, y su tierra se convertirá en alquitrán ardiente!
\bibleverse{10} El fuego arderá de día y de noche, y no se apagará
nunca; su humo se elevará para siempre. De una generación a otra
permanecerá desolada; la gente no volverá a ir allí. \bibleverse{11} El
...
\bibleverse{12} Sus nobles no tendrán nada que llamar reino;\footnote{\textbf{34:12}
  El hebreo de esta frase no está claro.} todos sus príncipes
desaparecerán. \bibleverse{13} Sobre sus palacios crecerán espinas; la
...
\bibleverse{14} Será un lugar de encuentro para los animales del
...
descansar. \bibleverse{15} Allí el búho construirá su nido, pondrá y
...
su pareja. \bibleverse{16} Mira en el rollo del Señor y lee lo que dice:
No faltará ni una sola de ellas con su pareja, porque el Señor ha
ordenado que así sea, y su Espíritu las ha reunido. \bibleverse{17} Él
...
\bibleverse{1} El desierto y la tierra seca celebrarán; el desierto
florecerá como el azafrán. \bibleverse{2} ¡Florezcan profusamente,
...
Dios. \bibleverse{3} ¡Haz que las manos débiles se fortalezcan, y haz
que las rodillas temblorosas se mantengan firmes! \footnote{\textbf{35:3}
  Heb 12,12} \bibleverse{4} Diles a los que tienen miedo: ¡Sean fuertes!
...
vendrá con la retribución divina para salvaros. \footnote{\textbf{35:4}
  Sal 94,1} \bibleverse{5} Cuando eso ocurra, los ciegos verán y los
sordos oirán. \footnote{\textbf{35:5} Is 29,18; Mat 11,5} \bibleverse{6}
...
\bibleverse{7} La tierra seca será como un estanque, la tierra árida
...
hierba, cañas y juncos. \bibleverse{8} Allí habrá una carretera, un
...
\bibleverse{9} En el camino no se encontrarán leones ni otros animales
peligrosos: sólo los redimidos caminarán por él. \bibleverse{10} Los que
...
\bibleverse{1} En el año catorce del reinado de Ezequías, Senaquerib,
...
Judá.\footnote{\textbf{36:1} Gran parte de los tres capítulos siguientes
  son paralelos a 2 Reyes 18 a 2 Reyes 20.} \bibleverse{2} El rey de
...
superior, en el camino hacia el Campo de la Lavandera. \bibleverse{3}
...
\bibleverse{4} El general del ejército asirio les dijo: ``Dile a
...
\bibleverse{5} Ustedes dicen que tienen una estrategia y que están
listos para la guerra, pero esas son palabras vacías. ¿En quién confías,
ahora que te has rebelado contra mí? \bibleverse{6} ¡Mira! Estás
...
todo aquel que confía en él. \bibleverse{7} Si me dicen: `Confiamos en
...
de Jerusalén?' \bibleverse{8} ¿Por qué no aceptas el desafío de mi amo,
el rey de Asiria? Él dice: ¡Te daré dos mil caballos, si puedes
encontrar suficientes jinetes para ellos! \bibleverse{9} ¿Cómo podrías
...
\bibleverse{10} Más aún: ¿habría venido a atacar este lugar sin el
...
\bibleverse{11} Eliaquim, Sebna y Joa le dijeron al general del
...
\bibleverse{12} Pero el general del ejército respondió: ``¿Acaso mi amo
...
comer sus propios excrementos y beber su propia orina''. \bibleverse{13}
Entonces el general del ejército gritó en hebreo: ``¡Escuchen esto del
gran rey, el rey de Asiria! \footnote{\textbf{36:13} Is 36,4}
\bibleverse{14} Esto es lo que dice el rey: ¡No te dejes engañar por
Ezequías! ¡Él no puede salvarlos! \bibleverse{15} No crean a Ezequías
...
Asiria'. \bibleverse{16} No escuchen a Ezequías. Esto es lo que dice el
...
pozo. \bibleverse{17} Yo vendré y los llevaré a una tierra que es como
la suya, una tierra de grano y de vino nuevo, una tierra de pan y de
viñedos. \bibleverse{18} Pero no se dejen engañar por Ezequías cuando
...
nación ha salvado su tierra del poder del rey de Asiria? \footnote{\textbf{36:18}
  Is 10,10; Is 37,12} \bibleverse{19} ¿Dónde estaban los dioses de Hamat
y Arfad? ¿Dónde estaban los dioses de Sefarvaim? ¿Pudieron ellos salvar
a Samaria de mí? \bibleverse{20} ¿Cuál de todos los dioses de estos
países ha salvado su tierra de mí? ¿Cómo podría entonces el Señor salvar
a Jerusalén de mí?''

\bibleverse{21} Pero el pueblo permaneció en silencio y no dijo nada,
pues Ezequías había dado la orden: ``No le respondan''.

\bibleverse{22} Entonces Eliaquim, hijo de Hilcías, el administrador del
...
vistió de cilicio y entró en el Templo del Señor. \bibleverse{2} Envió a
...
hijo de Amoz. \bibleverse{3} Ellos le dijeron: ``Esto es lo que dice
...
darlos a luz. \bibleverse{4} Tal vez el Señor, tu Dios, al oír el
...
\bibleverse{5} Después de que los funcionarios de Ezequías entregaron su
mensaje a Isaías,

\bibleverse{6} éste les respondió: ``Díganle a su amo: Esto es lo que
...
\bibleverse{7} Mira, voy a asustarlo: oirá un rumor y tendrá que volver
...
diciendo: \bibleverse{10} ``Dile a Ezequías, rey de Judá: `No dejes que
tu Dios, en el que confías, te engañe diciendo que Jerusalén no caerá en
manos del rey de Asiria. \bibleverse{11} ¡Mira! Has oído lo que los
...
¿Realmente creen que se salvarán? \bibleverse{12} ¿Acaso los salvaron
...
\footnote{\textbf{37:12} Is 36,18} \bibleverse{13} ¿Dónde está hoy el
...
\bibleverse{15} Ezequías oró al Señor, diciendo: \bibleverse{16} ``Señor
...
cielo y de la tierra. \bibleverse{17} Escucha con tus oídos, Señor, y
oye; abre tus ojos, Señor, y mira. Escucha el mensaje que Senaquerib ha
enviado para insultar al Dios vivo. \bibleverse{18} ``Sí, es cierto,
Señor, que los reyes asirios han destruido estas naciones y sus tierras.
\bibleverse{19} Han arrojado sus dioses al fuego porque no son realmente
dioses; son sólo obra de manos humanas, hechos de madera y piedra para
poder destruirlos. \bibleverse{20} Ahora, Señor, Dios nuestro, sálvanos
...
\bibleverse{21} Entonces Isaías, hijo de Amoz, envió un mensaje a
Ezequías, diciendo: ``Esto es lo que dice el Señor, el Dios de Israel:
Como me has orado acerca de Senaquerib, rey de Asiria, \bibleverse{22}
...
\bibleverse{23} ¿A quién has insultado y ridiculizado? ¿Contra quién has
levantado la voz? ¿A quién miraste con ojos tan orgullosos? ¡Fue contra
el Santo de Israel! \bibleverse{24} Por medio de tus siervos te has
...
\bibleverse{25} He cavado pozos y bebido agua en tierras extranjeras.
Con las plantas de mis pies he secado todos los ríos de Egipto'''.

\bibleverse{26} El Señor responde:\footnote{\textbf{37:26} ``El Señor
...
\bibleverse{27} Su pueblo, impotente, está aterrorizado y humillado. Son
...
\bibleverse{28} ``Pero yo te conozco muy bien: dónde vives, cuándo
entras, cuándo sales, y tu furia contra mí. \bibleverse{29} A causa de
...
\bibleverse{30} ``Ezequías, esta será una señal para demostrar que esto
...
cosecharás, plantarás viñas y comerás su fruto. \bibleverse{31} El
remanente que quede de Judá revivirá, echando raíces abajo y dando
frutos arriba. \footnote{\textbf{37:31} Is 27,6} \bibleverse{32} Porque
...
\bibleverse{33} Esto es lo que dice el Señor sobre el rey de Asiria: No
...
\bibleverse{34} Volverá por donde vino y no entrará en esta ciudad, dice
el Señor. \bibleverse{35} Yo defenderé esta ciudad y la salvaré, por mí
...
\bibleverse{36} Entonces el ángel del Señor fue al campamento asirio y
mató a 185. 000 de ellos. Cuando los supervivientes se despertaron por
la mañana, estaban rodeados de cadáveres. \bibleverse{37} Senaquerib,
rey de Asiria, se rindió y se fue. Regresó a su casa en Nínive y se
quedó allí. \bibleverse{38} Mientras adoraba en el templo de su dios
...
\bibleverse{4} Entonces el Señor envió un mensaje a Isaías, diciendo:
\bibleverse{5} Ve y dile a Ezequías: Esto es lo que dice el Señor, el
Dios de tu antepasado David: He escuchado tu oración, he visto tus
lágrimas. Añadiré quince años a tu vida. \bibleverse{6} Te salvaré a ti
y a esta ciudad del rey de Asiria. Defenderé esta ciudad. \bibleverse{7}
Esta es la señal del Señor para ti, de que el Señor hará lo que
prometió: \bibleverse{8} Mira, haré que la sombra hecha por el sol
...
\bibleverse{9} Esto es lo que escribió Ezequías, rey de Judá, después de
recuperarse de su enfermedad: \bibleverse{10} Me dije a mí mismo:
``¿Tendré que ir a la muerte\footnote{\textbf{38:10} ``Muerte''
  Literalmente, ``Puertas del Seol''.} ahora que mi vida está bien? ¿Por
qué no puedo contar con el resto de mis años?''. \bibleverse{11} Dije:
...
\footnote{\textbf{38:11} Sal 27,13} \bibleverse{12} Como la tienda de un
...
\bibleverse{13} Me acuesto pacientemente hasta la mañana, pero siento
como si un león rompiera cada hueso de mi cuerpo. Día y noche me llevas
a mi fin. \footnote{\textbf{38:13} Job 10,16} \bibleverse{14} Grito como
...
\bibleverse{15} ``Pero, ¿qué puedo decir? Él me dijo lo que iba a pasar,
...
experiencia que he vivido. \bibleverse{16} Señor, vivimos de lo que tú
dices y haces, y yo encuentro vida en todo esto. Me has devuelto la
salud y me has permitido vivir. \bibleverse{17} Definitivamente fue por
...
\bibleverse{18} Los que están en la tumba no pueden alabarte, los
muertos no pueden alabarte. Los que bajan a la fosa ya no pueden esperar
en tu fidelidad. \footnote{\textbf{38:18} Sal 6,6} \bibleverse{19} Sólo
los vivos pueden alabarte como lo hago yo hoy. Los padres explican a sus
hijos cómo se puede confiar en ti. \bibleverse{20} ¡El Señor me ha
salvado! Cantaremos mis canciones con instrumentos de cuerda todos los
días de nuestra vida en el Templo del Señor''.

\bibleverse{21} Isaías había dicho: ``Prepara un apósito de higos y
úntalo sobre las llagas de la piel para que se recupere''.
\bibleverse{22} Ezequías había preguntado: ``¿Cuál es la señal que
...
\bibleverse{1} Al mismo tiempo, Merodac-baladán, hijo de Baladán, rey de
Babilonia, envió cartas y un regalo a Ezequías, porque había oído que
Ezequías estaba enfermo y se había recuperado. \bibleverse{2} Ezequías
...
\bibleverse{3} Entonces el profeta Isaías fue a ver al rey Ezequías y le
preguntó: ``¿De dónde vinieron esos hombres y qué te dijeron?''
``Vinieron a verme desde muy lejos, desde Babilonia'', respondió
Ezequías.

\bibleverse{4} ``¿Qué vieron en tu palacio?'' preguntó Isaías. ``Vieron
todo en mi palacio'', respondió Ezequías. ``No hubo nada en todos mis
almacenes que no les mostrara''.

\bibleverse{5} Isaías le dijo a Ezequías: ``Escucha lo que dice el
Señor: \bibleverse{6} Puedes estar seguro de que se acerca el momento en
...
Señor. \bibleverse{7} Algunos de tus hijos, tus propios descendientes,
...
\bibleverse{8} Ezequías dijo a Isaías: ``El mensaje del Señor que me has
...
\bibleverse{1} ``¡Consuela, sí consuela a mi pueblo!'' dice tu Dios.
\bibleverse{2} ``Háblale con amor al pueblo de Jerusalén, diciéndole que
...
\bibleverse{3} Se oye una voz que dice: ``Preparen el camino al Señor en
el desierto, hagan una calzada recta para nuestro Dios a través del
desierto. \footnote{\textbf{40:3} Luc 3,4-6; Juan 1,23} \bibleverse{4}
Rellenen todos los valles; allanen todos los montes y colinas; allanen
el terreno irregular; allanen los lugares escabrosos. \bibleverse{5} La
...
\bibleverse{6} Se oye una voz que dice: ``Grítalo''. Pregunté: ``¿Qué
...
confianza es como las flores del campo. \footnote{\textbf{40:6} 1Pe
  1,23-25; Sant 1,10; Sant 1,1-11; Sal 90,5-6} \bibleverse{7} La hierba
se marchita y la flor se desvanece cuando el Señor sopla sobre ellos.
Sí, las personas son como la hierba. \bibleverse{8} Sin embargo, aunque
...
\bibleverse{9} Sión, portadora de buenas noticias, sube a un monte alto.
...
está tu Dios!''. \bibleverse{10} ¡Mira! ¡El Señor Dios viene con poder!
Gobernará con mano firme. Mira! Trae consigo su recompensa, viene a dar
su regalo. \footnote{\textbf{40:10} Is 62,11} \bibleverse{11} Cuida de
...
\bibleverse{12} ¿Quién ha medido las aguas que tiene en la palma de su
...
montes con una balanza y las colinas con una balanza? \bibleverse{13}
...
\bibleverse{14} ¿A quién acudió el Señor en busca de consejo para
ayudarle a entender? ¿Quién le enseñó el bien y el mal? ¿Quién le dio
conocimiento y le mostró el camino de la sabiduría? \bibleverse{15} Es
...
\bibleverse{16} Toda la madera del Líbano para un fuego y todos sus
...
menos que nada, como si no existieran. \bibleverse{18} ¿Quién crees que
es como Dios? ¿A qué imagen crees que se parece? \bibleverse{19} ¿Acaso
es un ídolo de metal que un artesano funde en un molde, y luego un
orfebre lo recubre de oro y le hace cadenas de plata? \bibleverse{20}
...
ídolo que no se caiga. \bibleverse{21} ¿No lo sabes? ¿No te has
...
desde que se creó el mundo?\footnote{\textbf{40:21} ``Se creó el
  mundo'': Literalmente, ``Los fundamentos del mundo''.} \bibleverse{22}
...
cortina, los extiende como una tienda para vivir. \footnote{\textbf{40:22}
  Sal 104,2} \bibleverse{23} Derriba a los líderes; hace que los
gobernantes del mundo sean como nada. \bibleverse{24} Apenas si están
...
\bibleverse{25} ``¿Con quién me vas a comparar? ¿Quién es igual a mí?'',
pregunta el Santo. \bibleverse{26} Mira los cielos. ¿Quién ha creado
...
\bibleverse{27} ¿Por qué hablas así, Jacob, y por qué dices, Israel:
``¡El Señor no ve lo que me pasa, y se desentiende de mis derechos!''
\bibleverse{28} ¿No lo sabes? ¿No has oído? El Señor es el Dios eterno,
...
\bibleverse{30} Incluso los jóvenes se debilitan y se cansan; caen
cuando están agotados. \bibleverse{31} Pero los que confían en el Señor
...
\bibleverse{1} Escúchenme en silencio, pueblos que viven en tierras más
...
vengan y hablen, y que nos unamos para el juicio.\footnote{\textbf{41:1}
  ...
  ídolos.} \bibleverse{2} Quien ha animado a este del este que es
...
él por el viento. \footnote{\textbf{41:2} Is 41,25; Is 44,28; Is 45,1;
  Is 45,13; Is 46,11; Is 48,14-15} \bibleverse{3} Los persigue y avanza
sin daño alguno, sin seguir las rutas habituales. \bibleverse{4} ¿Quién
...
soy yo. \bibleverse{5} Las islas observan con temor, las tierras lejanas
tiemblan. Se reúnen y consultan. \bibleverse{6} Todos se ayudan
mutuamente, animándose a ser fuertes. \bibleverse{7} El artesano anima
...
\bibleverse{8} Pero a ti, Israel, siervo mío, Jacob, los que he elegido,
descendientes de mi amigo Abraham, \footnote{\textbf{41:8} Is 43,10; Is
  42,19; Is 44,1; Is 44,21; Is 45,4; Is 42,1; Sant 2,23} \bibleverse{9}
...
abandonado. \bibleverse{10} ¡No tengan miedo, porque yo estoy con
...
favor de lo que es justo. \bibleverse{11} Mira: todo el que se enoje
contigo será avergonzado y deshonrado. Los que luchan contra ti
terminarán como nada y morirán. \bibleverse{12} Aunque busques a tus
enemigos, no los encontrarás. Los que te atacan se convertirán en nada.
\bibleverse{13} Porque yo, el Señor, te cogeré de la mano y te diré:
...
\bibleverse{14} No tengas miedo, Jacob, pequeño gusano, pueblo de
Israel, porque yo te ayudaré'', declaró el Señor, tu Salvador, el Santo
de Israel. \footnote{\textbf{41:14} Is 43,3} \bibleverse{15} ¡Mira! Te
...
convirtiéndolas en paja. \bibleverse{16} Los arrojarás al aire, el
viento se los llevará y una tormenta los dispersará. Entonces te
alegrarás en el Señor, y te jactarás del Santo de Israel.

\bibleverse{17} Los pobres y los necesitados buscan agua, pero no la
encuentran; sus lenguas están secas de sed. Yo, el Señor, les
responderé; yo, el Dios de Israel, no los abandonaré. \bibleverse{18}
...
\bibleverse{19} Plantaré cedros, acacias, mirtos y olivos en el
desierto. Pondré árboles de hoja perenne en el desierto, abetos y bojes
juntos. \bibleverse{20} Así todos podrán ver y saber, podrán pensar en
...
\bibleverse{21} ``Ahora presenta tu caso'',\footnote{\textbf{41:21}
...
sus pruebas'', dice el Rey de Jacob. \bibleverse{22} ``Dejen
...
resultado final. O que nos hablen del futuro. \footnote{\textbf{41:22}
  Is 43,8-9; Is 44,7} \bibleverse{23} Predicen lo que va a pasar para
que sepamos con certeza que son dioses. Al menos hagan algo, bueno o
malo, que nos impresione cuando lo veamos. \bibleverse{24} ¡Pero
mírense! ¡No son nada y nada pueden hacer! ¡Cualquiera que los elija a
ustedes es repugnante!

\bibleverse{25} ``Yo he animado al que viene del norte. Él es del
...
pisa la arcilla.\footnote{\textbf{41:25} Tanto el mortero como la
  arcilla se mezclaban con los pies.} \bibleverse{26} ``¿Quién lo
...
una palabra!\footnote{\textbf{41:26} Refiriéndose a la incapacidad de
  los ídolos para predecir el futuro.} \bibleverse{27} Yo fui el primero
en anunciar a Sión: `¡Mira, aquí están!' Yo fui el que llevó a Jerusalén
la buena noticia. \bibleverse{28} Miro a estos ídolos y veo que no hay
...
algo, ni siquiera saben responder. \bibleverse{29} ¡Míralos! Son todos
...
\bibleverse{1} ¡Mira! Aquí está mi siervo, el que yo sostengo; mi
...
mostrará a las naciones lo que es correcto. \footnote{\textbf{42:1} Is
  49,1-6; Is 52,13; Is 41,8; Mat 12,18-21; Mat 3,17} \bibleverse{2} No
gritará ni vociferará; no levantará la voz en la calle. \bibleverse{3}
...
fielmente de que todos sean tratados con justicia. \footnote{\textbf{42:3}
  Sal 34,19} \bibleverse{4} No se dará por vencido ni se desanimará
...
\bibleverse{5} Esto es lo que dice Dios, el Señor, el que creó los
...
\bibleverse{6} ``Yo, el Señor, te he llamado para que demuestres lo que
es correcto, y te llevaré de la mano. Te cuidaré y te daré como señal de
mi acuerdo con los pueblos y como luz para las naciones. \bibleverse{7}
...
de la cárcel a los que están en la oscuridad. \footnote{\textbf{42:7} Is
  35,5} \bibleverse{8} ``¡Yo soy el Señor, ese es mi nombre! No doy mi
honor a nadie más; no doy mi alabanza a los ídolos. \footnote{\textbf{42:8}
  Éxod 3,15; Is 48,11} \bibleverse{9} Fíjense que lo que predije se ha
...
\bibleverse{10} ¡Canten una nueva canción al Señor! Canten alabanzas
...
\bibleverse{11} Que grite la gente del desierto y de sus ciudades; que
...
\bibleverse{12} Que glorifiquen al Señor y lo alaben en las islas.
\bibleverse{13} Como un poderoso guerrero marchará el Señor, como un
soldado aguerrido sale con valor. Da su grito de guerra, gritando
mientras lucha y derrota a sus enemigos. \bibleverse{14} ``Durante mucho
tiempo no dije nada, me callé y me contuve. Pero ahora, como una mujer
que da a luz, gemiré y jadearé. \bibleverse{15} Secaré las montañas y
las colinas, y haré que se marchite todo su verdor. Convertiré los ríos
en islas y secaré los estanques. \bibleverse{16} Llevaré a los ciegos
...
Esto es lo que voy a hacer por ellos; no los defraudaré. \bibleverse{17}
...
\bibleverse{18} ``¡Escuchen, sordos! ¡Miren y vean, ciegos! \footnote{\textbf{42:18}
  Is 43,8} \bibleverse{19} ¿Quién es ciego como mi siervo? ¿Quién es
...
\bibleverse{20} Has mirado muchas cosas pero no has visto realmente; has
oído pero nunca has escuchado realmente''. \footnote{\textbf{42:20} Is
  53,1}

\bibleverse{21} Como el Señor hace lo que es justo, quiso mostrar lo
importantes y maravillosas que eran sus instrucciones. \bibleverse{22}
...
``¡Devuélvanlos!'' \bibleverse{23} ¿Quién de ustedes va a escuchar esto,
o a prestar atención después? \bibleverse{24} ¿Quién dejó que Jacob
...
\bibleverse{25} Así que derramó sobre ellos su furia y la violencia de
...
\bibleverse{1} Pero ahora esto es lo que el Señor dice a Jacob, el que
te creó; a Israel, el que te formó: ``¡No tengas miedo! Yo te he
salvado. Te he llamado por tu nombre; eres mío. \bibleverse{2} Cuando
...
\bibleverse{3} Porque yo soy el Señor, tu Dios, el Santo de Israel, tu
Salvador. Entregué Egipto para pagar tu libertad; cambié Etiopía y Seba
por ti. \footnote{\textbf{43:3} Prov 11,8} \bibleverse{4} Porque ustedes
son tan valiosos para mí, porque los honro y porque los amo, doy pueblos
a cambio de ustedes, naciones a cambio de sus vidas. \bibleverse{5}
...
a sus hijos desde el este y el oeste, y los reuniré. \footnote{\textbf{43:5}
  Is 11,11-16} \bibleverse{6} Le diré al norte: `¡Entréguenlos!' y al
sur: `¡No los detengan!' Hagan volver a mis hijos de lejos y a mis hijas
de tierras lejanas. \bibleverse{7} Que vuelvan todos los que llevan mi
...
\bibleverse{8} ``Que vuelvan los que tienen ojos y están ciegos, los que
tienen oídos y están sordos. \footnote{\textbf{43:8} Is 42,18}
\bibleverse{9} ¡Que se reúnan todas las naciones! ¡Que se reúnan todos
...
Entonces que escuchen y digan: `Es verdad!'\footnote{\textbf{43:9} Esto
  ...
  Is 41,22-26} \bibleverse{10} ``Sin embargo, ustedes son mis testigos,
...
dios me precedió, y ninguno vendrá después de mí. \footnote{\textbf{43:10}
  Is 41,8} \bibleverse{11} Yo, sí, yo soy el Señor, y no hay salvador
fuera de mí. \footnote{\textbf{43:11} Is 44,6; Deut 32,39}
\bibleverse{12} Yo predije lo que iba a suceder, luego los salvé, luego
...
\footnote{\textbf{43:12} Is 43,10} \bibleverse{13} Yo soy Dios desde el
...
\bibleverse{14} ``Esto es lo que dice el Señor, tu Redentor, el Santo de
...
están tan orgullosos.\footnote{\textbf{43:14} El hebreo de la última
  parte de este verso es impreciso.} \bibleverse{15} Yo soy el Señor, tu
...
\bibleverse{16} Esto es lo que dice el Señor, el que hace un camino a
través del mar, un sendero a través de las aguas impetuosas;
\bibleverse{17} el que sacó un gran ejército con sus caballos y carros y
los puso en el suelo, para no volver a levantarse, apagados como una
mecha encendida. \bibleverse{18} ``Pero no te fijes en el pasado; no te
concentres en lo que pasó entonces. \bibleverse{19} ¡Mira lo nuevo que
...
abriendo un camino en el desierto, ríos en el desierto. \footnote{\textbf{43:19}
  Is 41,18} \bibleverse{20} Los animales salvajes me estarán
...
elegido, pueda beber. \bibleverse{21} Hice a este pueblo para mí, para
...
\bibleverse{22} ``Pero no me has pedido ayuda, Jacob. Te has cansado de
mí, Israel. \bibleverse{23} No me has traído ovejas para los
...
\footnote{\textbf{43:23} Is 1,11-15} \bibleverse{24} No has usado tu
...
\bibleverse{25} Yo, sí, soy el Dios que borra tus pecados por ser quien
soy, y que ya no se acuerda de tus pecados. \bibleverse{26} ¡Recuérdame
...
caso para demostrar que tienes razón! \footnote{\textbf{43:26} Is 58,2;
  Jer 2,35} \bibleverse{27} Tu primer padre pecó, y tus líderes se
rebelaron contra mí. \footnote{\textbf{43:27} Dan 9,6; Dan 9,8}

\bibleverse{28} Por eso traté con desprecio a los sacerdotes del
...
\bibleverse{1} Pero ahora escucha, Jacob, mi siervo, Israel, el que he
elegido. \footnote{\textbf{44:1} Is 41,8} \bibleverse{2} Esto es lo que
...
ayudará: No temas, Jacob, siervo mío, Jesurún,\footnote{\textbf{44:2}
  ...
  Deut 32,15; Deut 33,5} \bibleverse{3} Porque voy a derramar agua sobre
...
\footnote{\textbf{44:3} Is 32,15; Jl 3,1} \bibleverse{4} Crecerán entre
la hierba, como los sauces junto a los arroyos. \bibleverse{5} Uno de
...
\bibleverse{6} Esto es lo que dice el Señor, el Rey y Redentor de
Israel, el Señor Todopoderoso: Yo soy el primero y soy el último, y no
hay otro Dios fuera de mí. \bibleverse{7} ¿Quién es como yo? Que lo
...
que va a suceder. \footnote{\textbf{44:7} Is 41,22} \bibleverse{8} ¡No
...
\bibleverse{9} Todos los que hacen ídolos son estúpidos; esas cosas que
...
\bibleverse{10} ¿Quién hace un dios, quién moldea un ídolo que no le
sirve para nada? \bibleverse{11} Todo el que hace ídolos debería
...
\bibleverse{12} El herrero hace una herramienta de hierro para tallar
...
\footnote{\textbf{44:12} Is 40,18-20} \bibleverse{13} El carpintero mide
...
persona, alguien hermoso, para ponerlo en un santuario. \bibleverse{14}
Corta cedros, o toma un ciprés o un roble. Los deja crecer con fuerza en
el bosque. Planta un abeto y la lluvia lo hace crecer. \bibleverse{15}
...
el que se inclina. \bibleverse{16} Entonces quema parte de la leña para
asar su carne para comer, y para calentarse, y dice: ``¡Ah! ¡Mira ese
fuego que me mantiene caliente!'' \bibleverse{17} Luego utiliza el resto
...
dios!'' \bibleverse{18} ¡Qué ignorantes son, qué tontos! Sus ojos han
sido tapados para que no puedan ver, sus mentes cerradas para que no
tengan entendimiento. \bibleverse{19} No pueden reflexionar, no tienen
...
adoración ante un bloque de madera''. \bibleverse{20} Se alimenta de
...
\bibleverse{21} Acuérdate de todo esto, Jacob e Israel, porque tú eres
mi siervo. Yo te hice, Israel, tú eres mi siervo. No te olvidaré.
\footnote{\textbf{44:21} Is 41,8; Is 44,2} \bibleverse{22} He borrado
...
\bibleverse{23} Canten en fiesta, cielos, porque el Señor ha hecho esto;
...
\bibleverse{24} Esto es lo que dice el Señor, tu Redentor, que te formó
...
los cielos, y yo mismo formé la tierra.\footnote{\textbf{44:24} Isaías
  ...
  ``desplegada''.} \bibleverse{25} Yo soy el que demuestra que las
...
hago que sus conocimientos sean ridículos.\footnote{\textbf{44:25}
  ``Ridículo'': o ``sin sentido''.} \bibleverse{26} Pero yo confirmo los
...
serán reconstruidas, sus ruinas serán reparadas'. \bibleverse{27} Cuando
ordene a las aguas profundas: `¡Sécate!' ¡me aseguraré de que los ríos
se sequen! \footnote{\textbf{44:27} Éxod 14,21; Jos 3,9-17}
\bibleverse{28} Cuando le diga a Ciro: `Tú eres mi pastor', él cumplirá
...
\bibleverse{1} Esto es lo que dice el Señor a Ciro, el que ha ungido, a
...
cerrarán. \footnote{\textbf{45:1} Is 44,28; Is 41,2} \bibleverse{2} Iré
...
puertas de bronce y cortaré las barras de hierro. \bibleverse{3} Te daré
...
llama por tu nombre. \bibleverse{4} Te llamo por tu nombre y te he dado
un título de honor, por el bien de Jacob, mi siervo, y de Israel, el que
elegí, aunque no me conozcas. \bibleverse{5} Yo soy el Señor, no hay
Dios fuera de mí. Aparte de mí no hay Dios. Te haré fuerte, aunque no me
conozcas, \footnote{\textbf{45:5} Is 44,6} \bibleverse{6} para que
todos, desde el este hasta el oeste, sepan que no hay Dios aparte de mí,
que yo soy el Señor y no hay ninguno aparte de mí. \bibleverse{7} Yo
...
\bibleverse{8} Que la lluvia caiga del cielo, que la bondad caiga de las
...
\bibleverse{9} Qué problemas tiene la gente cuando se pelea con su
...
no tienes manos!''?. \footnote{\textbf{45:9} Is 29,16; Jer 18,6; Rom
  9,20-21} \bibleverse{10} ¡Qué malo sería que le dijeras a tu padre:
``¿Por qué me has tenido?'' o a tu madre: ``¿Por qué he nacido?''
\bibleverse{11} Esto es lo que dice el Señor, el Santo de Israel, tu
Creador: Puedes preguntarme sobre las cosas que vendrán. Pero, ¿vas a
sermonearme sobre mis hijos y lo que hago? \bibleverse{12} Yo soy el que
...
estrellas llegaran a existir.\footnote{\textbf{45:12} ``Llegaran a
  existir'': Añadido para mayor claridad.} \bibleverse{13} Porque hago
...
\bibleverse{14} Esto es lo que dice el Señor: ``Los egipcios productivos
...
contigo, y no hay otro Dios fuera de él'\,''. \footnote{\textbf{45:14}
  Is 45,5} \bibleverse{15} Pero tú eres un Dios que se esconde, Dios de
Israel, Salvador. \footnote{\textbf{45:15} Rom 11,33} \bibleverse{16}
Todos los que fabrican ídolos se avergüenzan y se humillan, todos son
deshonrados. \footnote{\textbf{45:16} Is 44,9; Is 44,11} \bibleverse{17}
...
\bibleverse{18} Porque esto es lo que dice el Señor, el Dios que creó
...
soy el Señor, y no hay Dios fuera de mí. \bibleverse{19} No he hablado
...
digo lo que es justo. \bibleverse{20} Reúnanse y vengan, acérquense,
...
\footnote{\textbf{45:20} Is 43,9} \bibleverse{21} Discutan esto juntos,
...
correcto y que salve. No hay otro Dios sino yo. \footnote{\textbf{45:21}
  Is 45,5} \bibleverse{22} Vengan a mí todos los que están en la tierra
y sálvense, porque yo soy Dios y no hay Dios fuera de mí.
\bibleverse{23} He jurado por mí mismo, he dicho lo que es justo y no me
retractaré jamás. Todos se inclinarán ante mí; todos me reconocerán.
\footnote{\textbf{45:23} Rom 14,11; Fil 2,10-11} \bibleverse{24} Dirán
...
\footnote{\textbf{45:24} Jer 23,6} \bibleverse{25} Pero en el Señor
...
\bibleverse{1} Bel se inclina, Nebo se agacha;\footnote{\textbf{46:1}
...
animales cansados. \bibleverse{2} Se agachan y se inclinan juntos; no
...
\bibleverse{3} Escúchenme, descendientes de Jacob, todos los que quedan
del pueblo de Israel. Yo los he cuidado desde que nacisteis, llevándoos
desde el nacimiento. \bibleverse{4} Incluso cuando sean ancianos,
...
salvaré. \bibleverse{5} ¿A quién me compararás? ¿A quién considerarás mi
igual? ¿Con quién me compararás, como si fuéramos iguales? \footnote{\textbf{46:5}
  Is 44,9-20} \bibleverse{6} Hay quienes sacan el oro de sus bolsas con
...
\bibleverse{7} Levantan el ídolo sobre sus hombros, lo transportan y lo
...
\bibleverse{8} ¡Recuerden esto y actúen como hombres! Piensen en ello,
rebeldes. \bibleverse{9} Recuerden lo que he hecho por ustedes desde el
principio, porque yo soy Dios, y no hay Dios fuera de mí. Yo soy Dios, y
no hay ninguno como yo. \bibleverse{10} Yo soy el que puede predecir lo
...
todo lo que deseo. \footnote{\textbf{46:10} Is 42,9} \bibleverse{11}
...
\bibleverse{12} ¡Escúchenme, ustedes, gente obstinada, que están tan
lejos de hacer lo que es correcto! \bibleverse{13} Muy pronto voy a
...
\bibleverse{2} Ve a trabajar moliendo harina con piedras de molino.
Quítate el velo. Quítate la falda, desnuda las piernas, vadea los ríos.
\bibleverse{3} Se te verá desnuda; lo que debería ser privado quedará
vergonzosamente expuesto. Me vengaré, no perdonaré a nadie.
\bibleverse{4} Nuestro Redentor -su nombre es el Señor Todopoderoso- es
el Santo de Israel.
...
\bibleverse{5} Siéntate tranquila y vete a las tinieblas, hija de
Babilonia. Nunca más serás llamada reina de todos los reinos.
\bibleverse{6} Me enojé con mi pueblo y abandoné a los que me
...
ancianos. \footnote{\textbf{47:6} Is 10,5-7; Zac 1,15} \bibleverse{7}
...
\bibleverse{8} Ahora escucha esto, mujer sensual,\footnote{\textbf{47:8}
...
viuda ni experimentaré la pérdida de mis hijos''. \bibleverse{9} ¡Pero
...
mágicos. \bibleverse{10} Pusiste tu confianza en tus malas acciones,
...
hay nadie más que yo''. \bibleverse{11} El mal\footnote{\textbf{47:11}
...
\bibleverse{12} Así que sigue con tus hechizos mágicos y toda tu
...
\bibleverse{13} ¡Todos los consejos que has recibido te han agotado!
...
se te viene encima! \bibleverse{14} ¡Pero míralos! Son como rastrojos
...
calentarse! \bibleverse{15} Toda esa gente con la que has trabajado,
...
\bibleverse{1} Escuchen esto, descendientes de Jacob, llamados por el
...
verdadera ni sinceramente. \bibleverse{2} Ustedes dicen que son de la
...
\bibleverse{3} Hace tiempo que predije lo que iba a suceder: lo dije y
se lo hice saber a la gente. Luego, de repente, decidí actuar, y todo se
hizo realidad. \bibleverse{4} Yo sé lo tercos que son ustedes, con
cuellos inflexibles como el hierro y frentes duras como el bronce.
\footnote{\textbf{48:4} Jer 5,3} \bibleverse{5} Hace tiempo que les
...
metal ordenaron que sucediera esto''. \bibleverse{6} Has oído todo lo
...
\bibleverse{7} Son cosas nuevas, no son algo del pasado. Antes de hoy no
habrán oído nada sobre ellos, así que no pueden decir: ``Ah, sí, ya lo
sabía''. \bibleverse{8} ¡No, nunca han oído eso, y nunca lo han sabido!
¡Nadie les ha hablado de eso antes! Sé lo tercos que son ustedes: ¡Su
nombre es rebeldes de nacimiento! \bibleverse{9} Pero debido a mi
naturaleza\footnote{\textbf{48:9} ``Naturaleza'': Literalmente,
  ``nombre''.} yo retraso mi castigo; y a causa de mi reputación, no voy
a destruirlos. \bibleverse{10} Miren cómo los he refinado, pero no como
la plata: los elegí en el horno de la dificultad. \bibleverse{11} La
...
\bibleverse{12} Escúchame, Jacón, e Israel, al que llamé. Sólo yo soy
Dios. Yo soy el primero y soy el último. \footnote{\textbf{48:12} Is
  41,4} \bibleverse{13} Yo puse los cimientos de la tierra con mis
propias manos; yo personalmente extendí los cielos. Cuando llamo a las
estrellas, todas toman su posición. \bibleverse{14} Reúnanse todos y
...
\bibleverse{15} Yo mismo he hablado. Lo he llamado a hacer esto, y
tendrá éxito en lo que haga.

\bibleverse{16} Acércate a mí y escucha esto. Desde el principio no he
...
\bibleverse{17} Esto es lo que dice el Señor, tu Redentor, el Santo de
...
\bibleverse{18} ¡Si hubieras escuchado atentamente lo que te he dicho!
...
\bibleverse{19} Tus hijos, tus descendientes, habrían sido como todos
...
\bibleverse{20} ¡Abandona Babilonia! ¡Huye de Babilonia con gritos de
alegría! Hacedlo saber a todos, diciendo a toda la tierra: ``¡El Señor
ha redimido a su siervo Jacob!'' \bibleverse{21} No tenían sed cuando
...
ellos. Abrió la roca y el agua salió a borbotones. \footnote{\textbf{48:21}
  Éxod 17,6} \bibleverse{22} Los impíos no tienen paz, dice el
...
\bibleverse{1} Escúchenme, habitantes de las islas!\footnote{\textbf{49:1}
...
aún estaba en el vientre de mi madre. \bibleverse{2} Las palabras que me
...
\bibleverse{3} Me dijo: ``Tú eres mi siervo, Israel, y por medio de ti
revelaré mi gloria''. \footnote{\textbf{49:3} Is 49,5; Is 42,1; Is 41,8}
\bibleverse{4} Pero yo respondí: ``¡He trabajado para nada! Me he
...
\bibleverse{5} Ahora va a hablar mi Señor, el que me formó en el vientre
...
Señor, y mi Dios me ha dado fuerzas. \bibleverse{6} Él dice: ``No es
...
\bibleverse{7} Esto es lo que dice el Señor, el Redentor y Santo de
...
\bibleverse{8} Esto es lo que dice el Señor: Te responderé en el momento
...
reasignar las partes que han sido abandonadas. \footnote{\textbf{49:8}
  Sal 69,14; 2Cor 6,2; Is 42,6} \bibleverse{9} Di a los prisioneros:
...
las colinas que antes eran estériles. \bibleverse{10} No tendrán hambre
ni sed, y no se calentarán bajo el sol, porque el que los ama los
conducirá a manantiales y los guiará hacia el agua. \bibleverse{11}
Convertiré todos mis montes en un camino; ¡mis carreteras serán
realmente altas! \bibleverse{12} ¡Mira a esta gente que viene de lejos!
...
\bibleverse{13} ¡Cielos, griten de alegría! Tierra, ¡celebración!
...
\bibleverse{14} Pero Sión dijo: ``El Señor me ha abandonado; el Señor se
ha olvidado de mí''. \bibleverse{15} ¿De verdad? ¿Puede una madre
...
\bibleverse{16} ¡Mira los nombres que he escrito en las palmas de mis
...
\bibleverse{17} Pronto tus hijos volverán corriendo. Tus destructores,
los que devastaron tu tierra, se habrán ido. \bibleverse{18} Mira a tu
...
poniéndoselos con orgullo como a una novia. \bibleverse{19} Tus ciudades
...
desaparecido hace tiempo. \bibleverse{20} Los niños nacidos durante tu
...
mí! ¡Hagan espacio para que yo tenga un lugar donde vivir! \footnote{\textbf{49:20}
  Is 54,1} \bibleverse{21} Entonces te dirás a ti mismo: ``¿Quién dio a
...
\bibleverse{22} Esto es lo que dice el Señor Dios: Mira cómo doy la
...
a tus hijas sobre sus hombros. \bibleverse{23} Los reyes serán sus
...
\bibleverse{24} ¿Se puede arrebatar el botín a un guerrero? ¿Se puede
rescatar a los prisioneros de un dictador?\footnote{\textbf{49:24}
  ``Dictador'': Lectura de los Rollos del Mar Muerto.} \bibleverse{25}
...
\bibleverse{26} Haré que tus opresores coman su propia carne y beban su
...
\bibleverse{1} Esto es lo que dice el Señor: ¿Dónde está el certificado
...
fue despedida por tu maldad. \footnote{\textbf{50:1} Deut 24,1; Is 54,6;
  Is 52,3} \bibleverse{2} Cuando vine, ¿por qué no había nadie? Cuando
...
porque han muerto de sed al no haber agua. \footnote{\textbf{50:2} Is
  59,1; Núm 11,23; Éxod 14,21} \bibleverse{3} Puedo hacer que los cielos
...
\bibleverse{4} El Señor Dios me ha dado la capacidad de enseñar a otros,
...
despierta cada mañana; me ayuda a escuchar como discípulo. \footnote{\textbf{50:4}
  Mat 7,28-29; Mat 11,28} \bibleverse{5} El Señor Dios me ha instruido,
y no he sido rebelde ni me he apartado. \footnote{\textbf{50:5} Sal 40,7}
\bibleverse{6} Ofrecí mi espalda para que me golpearan y mis mejillas
...
\bibleverse{7} El Señor Dios me ayuda, por lo que no he sido deshonrado.
Por eso estoy tan decidido, poniendo mi rostro duro como una piedra,
sabiendo que no seré humillado. \bibleverse{8} El que me reivindica está
...
\bibleverse{9} El Señor Dios me defiende. ¿Quién va a declararme
...
\bibleverse{10} ¿Quién de ustedes respeta al Señor y obedece lo que dice
su siervo? ¿Quién de ustedes camina en las tinieblas y no tiene luz? Que
confíen en el Señor y pongan su confianza en Dios. \bibleverse{11}
...
\bibleverse{1} Escúchenme, los que siguen la justicia y adoran al Señor.
Piensen en la roca de la que fueron cortados, y en la cantera de la que
fueron cincelados. \footnote{\textbf{51:1} Is 48,1} \bibleverse{2} Miren
...
\footnote{\textbf{51:2} Ezeq 33,24} \bibleverse{3} El Señor cuidará de
...
\bibleverse{4} Presta atención a mí, pueblo mío; escúchame, nación mía:
Enviaré mi ley, y mi justicia será una luz para las naciones.
\bibleverse{5} Pronto llegará mi gobierno de justicia. Viene mi
salvación. Mi poder traerá el juicio a las naciones. Las tierras lejanas
me esperan a mí y a mi poder. \bibleverse{6} Mira a los cielos y mira a
...
\bibleverse{7} Escúchame, tú que sabes lo que es correcto y que
...
\footnote{\textbf{51:7} Mat 5,11} \bibleverse{8} Las polillas se los
...
\bibleverse{9} ¡Por favor, despierta, despierta! ¡Usa tu fuerza,
...
en pedazos, ¿quién mató a ese monstruo marino? \footnote{\textbf{51:9}
  Éxod 14,14; Éxod 15,7} \bibleverse{10} ¿No fuiste tú quien secó el
...
\bibleverse{11} Los que el Señor ha liberado volverán cantando al entrar
...
\bibleverse{12} Soy yo, sí, el que te consuela. ¿Por qué has de temer a
los mortales que mueren como la hierba? \footnote{\textbf{51:12} Sal
  56,5; Is 40,6} \bibleverse{13} ¡Te has olvidado del Señor, tu Hacedor,
...
su ira? \bibleverse{14} Los prisioneros que están postrados pronto serán
liberados. No van a morir; no seguirán pasando hambre. \bibleverse{15}
Porque yo soy el Señor, tu Dios, que agita el mar para que rujan sus
olas. El Señor Todopoderoso es su nombre. \bibleverse{16} Yo te he dicho
...
\bibleverse{17} ¡Despierta, despierta! ¡Levántate, Jerusalén! Has bebido
...
fondo de la copa, la bebida que hace tambalear a la gente. \footnote{\textbf{51:17}
  Sal 60,5; Sal 75,9; Jer 25,15-18} \bibleverse{18} De todos tus hijos
que tuviste, no queda ninguno que te guíe. De todos los hijos que
criaste, no hay ninguno que te lleve de la mano. \bibleverse{19} Dos
...
te va a consolar? \footnote{\textbf{51:19} Is 47,9} \bibleverse{20} Tus
...
\bibleverse{21} Así que escuchen esto, pobres, sentados allí en estado
de embriaguez, pero no por haber bebido vino. \bibleverse{22} Esto es lo
...
\bibleverse{23} En cambio, daré esa copa a quienes los atormentaban, a
...
\bibleverse{1} ¡Despierta, despierta, Sión! ¡Sé fuerte! Ponte tus
mejores galas, Jerusalén, la ciudad santa. Los extranjeros paganos no
volverán a entrar en ti. \bibleverse{2} Sacúdete del polvo y levántate.
Siéntate en tu trono, Jerusalén. Lanza las cadenas de tu cuello, hija
cautiva de Sión. \bibleverse{3} Esto es lo que dice el Señor: Fuiste
vendida por nada, y serás comprada de nuevo sin dinero. \footnote{\textbf{52:3}
  Is 50,1} \bibleverse{4} Esto es lo que dice el Señor: En primer lugar,
mi pueblo fue a vivir a Egipto, luego Asiria lo conquistó sin razón.
\bibleverse{5} ¿Qué tengo que hacer ahora? pregunta el Señor. Mi pueblo
...
Señor. \bibleverse{6} Así que voy a hacer que mi pueblo me conozca; en
...
\bibleverse{7} ¡Qué espectáculo tan maravilloso en las montañas es el
...
anunciando la salvación, diciendo a Sión: ``Tu Dios reina!'' \footnote{\textbf{52:7}
  Nah 2,1; Rom 10,15; Zac 9,9} \bibleverse{8} Los vigilantes de la
...
Señor vuelve a Jerusalén. \footnote{\textbf{52:8} Is 56,10; Is 62,6;
  Ezeq 3,17} \bibleverse{9} Que las ruinas de Jerusalén canten todas de
alegría porque el Señor ha venido a cuidar a su pueblo; ha liberado a
Jerusalén. \bibleverse{10} El Señor ha demostrado su santo poder a todas
las naciones; el mundo entero verá la salvación de nuestro Dios.
\footnote{\textbf{52:10} Is 53,1} \bibleverse{11} ¡Salgan, salgan,
...
\bibleverse{12} Pero no salgan con prisa, no se apresuren como si
...
\bibleverse{13} Mira: mi siervo actuará con sabiduría; será muy alabado,
será elevado en su posición y visto como alguien a quien la gente
admira. \footnote{\textbf{52:13} Is 42,1} \bibleverse{14} Pero muchos se
...
cualquier ser humano. \bibleverse{15} Sorprenderá a muchas naciones, y
...
\bibleverse{1} ¿Ha creído alguien en nuestras noticias? ¿A quién ha
mostrado el Señor su poder?\footnote{\textbf{53:1} Por la forma en que
  ...
  10,16; Is 52,10} \bibleverse{2} Como un brote joven creció ante él,
...
para que nos fijáramos en él; nada en su aspecto nos atraía. \footnote{\textbf{53:2}
  Is 11,1} \bibleverse{3} La gente lo despreciaba y lo rechazaba. Era un
...
despreciamos y no le respetamos. \footnote{\textbf{53:3} Sal 22,7-8; Mar
  9,12} \bibleverse{4} Sin embargo, era él quien cargaba con nuestras
...
estaba siendo golpeado, vencido y humillado por Dios. \footnote{\textbf{53:4}
  Mat 8,17} \bibleverse{5} Pero fue herido por nuestros actos rebeldes,
...
la paz,\footnote{\textbf{53:5} ``Paz'': a menudo en el sentido de
  ...
  2,24} \bibleverse{6} Todos nosotros nos hemos extraviado, como ovejas.
...
que toda nuestra culpa cayera sobre él.\footnote{\textbf{53:6} La
  ...
  5,21} \bibleverse{7} Fue perseguido y maltratado, pero no dijo nada.
...
\footnote{\textbf{53:7} Juan 1,29; Hech 8,32} \bibleverse{8} Por la
...
\bibleverse{9} Lo enterraron como si fuera un malvado, dándole una tumba
entre los ricos, aunque no había hecho nada malo ni había dicho ninguna
mentira. \footnote{\textbf{53:9} 1Pe 2,22; 1Jn 3,5} \bibleverse{10} Sin
...
\bibleverse{11} Después de su sufrimiento, verá los resultados y quedará
...
y cargará con sus pecados. \footnote{\textbf{53:11} Rom 10,4; 2Cor 5,21;
  Juan 1,29} \bibleverse{12} Por eso le concederé un lugar entre los
...
\bibleverse{1} ¡Canta de alegría, mujer sin hijos, tú que has tenido un
...
\bibleverse{2} Haz más grande la tienda donde vives; estira la tela para
agrandar tu casa. No trates de ahorrar espacio: alarga las cuerdas de tu
tienda y haz más fuertes las estacas. \bibleverse{3} Te vas a extender a
...
\bibleverse{4} No tengas miedo, porque no serás humillado; no te
alteres, porque no serás deshonrado. Te olvidarás de la vergüenza de tu
juventud, y ya no recordarás la vergüenza de tu viudez. \bibleverse{5}
...
\footnote{\textbf{54:5} Os 2,21} \bibleverse{6} El Señor te ha llamado
...
Dios. \footnote{\textbf{54:6} Is 50,1} \bibleverse{7} Te abandoné por
poco tiempo, pero te haré volver, mostrándote una gran bondad.
\footnote{\textbf{54:7} Sal 30,6} \bibleverse{8} En un momento de
...
\footnote{\textbf{54:8} Is 60,10} \bibleverse{9} Para mí, esto es igual
...
no me enfadaré contigo ni te regañaré. \footnote{\textbf{54:9} Gén
  9,11-17} \bibleverse{10} Aunque los montes dejen de existir y las
...
\bibleverse{11} ¡Mi pobre ciudad dañada por la tormenta que no puede ser
...
Utilizaré zafiros para poner tus cimientos. \bibleverse{12} Haré tus
...
Todos tus muros serán de piedras preciosas, \footnote{\textbf{54:12}
  Apoc 21,18-21} \bibleverse{13} y todos tus hijos serán alumnos del
Señor, y vivirán en completa paz. \footnote{\textbf{54:13} Juan 6,45}
\bibleverse{14} Tu sociedad funcionará a partir de principios de bondad
y de derecho; no habrá nadie que te oprima. No tendrás miedo; no tendrás
que enfrentar ningún tipo de terror. \bibleverse{15} Si algún invasor
viene a atacarte, yo no lo envié; tú derrotarás a cualquiera que te
ataque. \footnote{\textbf{54:15} Rom 8,31}

\bibleverse{16} Mira: he creado al herrero que sopla las brasas en una
llama caliente y forja un arma adecuada; y he creado al destructor que
trae la destrucción. \bibleverse{17} Ninguna de las armas forjadas
...
\bibleverse{1} Vengan todos los que tienen sed, vengan a beber el agua.
Los que no tienen dinero, vengan, pueden comprar y comer. Vengan y
compren vino y leche; no necesitan dinero; no cuesta nada.
\bibleverse{2} ¿Por qué gastas dinero en lo que no es comida, y por qué
trabajas por algo que no te satisface? Escúchame bien: come lo que es
bueno, y disfrutarás de la mejor comida. \bibleverse{3} Ven aquí y
...
mostré a David. \footnote{\textbf{55:3} Jer 31,31-34; Sal 89,3-5; Hech
  13,34} \bibleverse{4} Mira cómo lo hice testigo de los pueblos, líder
y comandante para ellos. \bibleverse{5} Llamará a naciones que ni
...
\bibleverse{6} Busca al Señor mientras puedas encontrarlo; llámalo
mientras esté cerca. \bibleverse{7} Los malvados deben cambiar sus
...
él es generoso con su perdón. \footnote{\textbf{55:7} Ezeq 33,11; Sal
  130,4} \bibleverse{8} Porque sus pensamientos no son mis pensamientos,
y sus caminos no son mis caminos, declara el Señor. \bibleverse{9} Así
como los cielos son más altos que la tierra, mis caminos son más altos
que los suyos, y mis pensamientos más altos. \bibleverse{10} Es como la
...
\bibleverse{11} De la misma manera, las palabras que digo no vuelven a
mí sin cumplirse, sino que logran lo que yo quiero: alcanzan con éxito
mi propósito. \footnote{\textbf{55:11} Mat 13,8} \bibleverse{12} Vivirás
...
\bibleverse{13} Los cipreses crecerán en lugar de los arbustos de
...
\bibleverse{1} Esto es lo que dice el Señor: Sigue la ley y haz lo que
es correcto, porque pronto llegará mi salvación y se revelará mi bondad.
\bibleverse{2} Bienaventurados todos los que hacen esto: los que la
cumplen, los que observan el sábado sin violarlo y los que no hacen nada
malo. \footnote{\textbf{56:2} Is 58,13} \bibleverse{3} No permitas que
...
hijos''. \footnote{\textbf{56:3} Is 14,1; Deut 23,2} \bibleverse{4}
...
\bibleverse{5} les daré, en mi casa y dentro de mis muros, un lugar para
recordarlos y una reputación mejor que la de los hijos e hijas. Les daré
una reputación eterna que nunca se desvanecerá. \bibleverse{6} En cuanto
...
sin violarlo y que cumplen mi acuerdo, \bibleverse{7} traeré a estos
...
casa de oración para todas las naciones. \footnote{\textbf{56:7} Mar
  11,17} \bibleverse{8} Esto es lo que dice el Señor Dios, que hizo
...
\bibleverse{9} ¡Vengan, animales salvajes, animales salvajes del campo y
de los bosques, vengan a comer a mi pueblo! \bibleverse{10} Porque todos
...
amando el sueño. \bibleverse{11} Son perros codiciosos que nunca están
...
por su cuenta, cada uno mirando por sí mismo. \footnote{\textbf{56:11}
  Jer 6,13} \bibleverse{12} ``Vamos'', dicen, ``¡traigo vino y nos
...
\bibleverse{1} Las personas buenas mueren, y a nadie le importa; los
fieles fallecen, y nadie piensa que estaban siendo protegidos del mal.
\footnote{\textbf{57:1} 2Re 22,20} \bibleverse{2} Los que siguen el bien
...
\bibleverse{3} Pero en cuanto a ustedes, hijos de adivinos, producto del
adulterio y la prostitución, ¡vengan aquí! \footnote{\textbf{57:3} Mat
  12,39} \bibleverse{4} ¿De quién se burlan ustedes cuando ponen caras
de desprecio y sacan la lengua? ¿No son ustedes los hijos del pecado y
de la mentira? \bibleverse{5} Ustedes son los que celebran orgías
paganas bajo las encinas, bajo todo árbol verde. Sacrifican a sus hijos
en los valles y entre las cumbres rocosas. \bibleverse{6} Han elegido
...
\bibleverse{7} Han cometido adulterio\footnote{\textbf{57:7} ``Cometido
...
\bibleverse{8} Han colocado sus símbolos paganos detrás de sus puertas y
...
\bibleverse{9} Fueron a ofrecer a Moloc\footnote{\textbf{57:9} Un dios
...
lejanos; incluso bajaste al mundo de los muertos.\footnote{\textbf{57:9}
  ``El mundo de los muertos'': Literalmente, ``Seol''.} \bibleverse{10}
...
``¡No tiene remedio!''. Encontraron nuevas fuerzas\footnote{\textbf{57:10}
  ...
  8.} y así no te debilitaste. \bibleverse{11} ¿De quién te asustaste?
...
\bibleverse{12} Voy a contarle a todo el mundo lo bueno que eres y las
cosas que haces, pero no te van a ayudar. \bibleverse{13} Cuando clames
...
\bibleverse{14} El\footnote{\textbf{57:14} Refiriéndose al Señor.} dirá:
Construye una carretera, quita todo lo que estorba a mi pueblo.
\bibleverse{15} Esto es lo que dice el que está por encima de todo, el
...
restaurando sus espíritus y animándolos. \footnote{\textbf{57:15} Sal
  113,5-9; Is 66,1-2; Sal 51,19} \bibleverse{16} No pelearé contigo para
...
el ánimo, el mismo pueblo al que di vida. \footnote{\textbf{57:16} Sal
  103,9} \bibleverse{17} Sí, me enfadé con esta gente pecadora y
...
querían. \bibleverse{18} Yo sé lo que hacen, pero los sanaré. Los guiaré
y consolaré a los que lloran, \bibleverse{19} para que puedan decir
...
\bibleverse{20} Pero los malvados son como el mar que se agita, que
nunca se queda quieto, agitando el lodo y el fango con sus olas.
\footnote{\textbf{57:20} Jds 1,13} \bibleverse{21} No hay paz para los
...
\bibleverse{1} ¡Ruge desde la garganta! ¡No te contengas! ¡Grita como
...
\bibleverse{2} ¡Cada día se acercan a mí, encantados de conocer mis
...
Dios. \footnote{\textbf{58:2} Is 43,26} \bibleverse{3} ``¿No has visto
...
quiere, y se trata mal a los trabajadores. \bibleverse{4} ¿No ven que
...
escuchadas en las alturas. \bibleverse{5} ¿Es éste el tipo de ayuno que
...
\bibleverse{6} No, este es el ayuno que yo quiero: libera a los que han
...
de abuso. \bibleverse{7} Comparte tu comida con los hambrientos, acoge
...
\footnote{\textbf{58:7} Mat 25,35} \bibleverse{8} Entonces tu
...
\footnote{\textbf{58:8} Is 58,10; Sal 37,6} \bibleverse{9} Entonces,
...
dejan de señalar con el dedo y de calumniar a los demás, \footnote{\textbf{58:9}
  Is 30,19} \bibleverse{10} si se dedican a ayudar a los hambrientos y a
dar a los pobres lo que necesitan, entonces su luz brillará en las
tinieblas, y su noche será como el sol del mediodía. \bibleverse{11} El
...
como un manantial que nunca se seca. \bibleverse{12} Algunos de ustedes
...
\bibleverse{13} Si se aseguran de no quebrantar\footnote{\textbf{58:13}
...
\bibleverse{14} entonces descubrirán que el Señor es quien
...
\bibleverse{1} ¿No lo ves? El brazo del Señor no es demasiado débil para
salvarte, y su oído no es demasiado sordo para escucharte. \footnote{\textbf{59:1}
  Is 50,2} \bibleverse{2} Es tu culpa la que ha creado una barrera entre
tú y tu Dios; tus pecados han ocultado su rostro de ti para que no pueda
escucharte. \bibleverse{3} Tus manos están cubiertas de sangre y tus
dedos manchados de culpa, tus labios hablan mentiras y tu boca susurra
cosas malas. \bibleverse{4} Nadie quiere justicia, nadie alega su caso
con honestidad. Se apoyan en falsos testimonios y dicen mentiras.
Conciben planes malvados, y dan a luz problemas. \bibleverse{5} Incuban
huevos de víbora y tejen una tela de araña. Si te comes sus huevos,
morirás; si aplastas sus huevos, sólo nacerán serpientes. \bibleverse{6}
...
violencia. \bibleverse{7} Corren para hacer el mal; se apresuran a
...
pecaminosos; sólo causan estragos y destrucción. \footnote{\textbf{59:7}
  Rom 3,15-17} \bibleverse{8} No saben vivir en paz; no son rectos ni
...
\bibleverse{9} Por eso no tenemos justicia, y no hacemos lo que es
justo. Buscamos la luz, pero sólo encontramos la oscuridad; buscamos la
luz brillante, pero caminamos en la oscuridad profunda. \bibleverse{10}
...
\bibleverse{11} Todos nosotros gruñimos como osos y arrullamos como
palomas mientras esperamos que se haga justicia, pero nunca sucede;
esperamos la salvación, pero nunca la recibimos. \bibleverse{12} Tú
...
todos nuestros pecados. \bibleverse{13} Te hemos desobedecido y negado,
...
\bibleverse{14} Se rechaza la justicia, y nunca se hace lo correcto. La
...
\bibleverse{15} No hay verdad en ninguna parte, y quien abandona el mal
es robado. El Señor vio lo que sucedía, y se molestó porque no había
justicia. \bibleverse{16} Miró a su alrededor, y se horrorizó al ver que
...
\bibleverse{17} Se puso la integridad como coraza y el casco de la
salvación en la cabeza. Se vistió con ropas de venganza y se envolvió
con determinación como un manto. \bibleverse{18} Pagará a todos por lo
que han hecho: furia a sus enemigos, venganza a los que se le oponen,
revancha a las tierras lejanas. \bibleverse{19} Los de occidente se
...
Señor. \bibleverse{20} El Redentor vendrá a Sión, a los descendientes de
Jacob que se conviertan de sus pecados, declara el Señor. \footnote{\textbf{59:20}
  Is 1,27; Rom 11,26}

\bibleverse{21} Este es mi acuerdo con ellos, dice el Señor. Mi
...
\bibleverse{1} Levántate y brilla, porque ha llegado tu luz; la gloria
del Señor se ha levantado sobre ti. \bibleverse{2} Aunque las tinieblas
...
ti. \bibleverse{3} Las naciones acudirán a tu luz, y los reyes acudirán
...
\bibleverse{4} Mira a tu alrededor, y verás que todos se reúnen y vienen
a ti: tus hijos regresan de lejos, tus hijas jóvenes son llevadas en la
cadera. \footnote{\textbf{60:4} Is 49,18; Is 66,12} \bibleverse{5}
...
\bibleverse{6} Largas caravanas de camellos cubrirán la tierra, camellos
...
e incienso, gritando alabanzas al Señor. \footnote{\textbf{60:6} Sal
  72,10; Mat 2,1-11} \bibleverse{7} Todos los rebaños de Cedar serán
...
Templo donde me honran. \bibleverse{8} ¿Qué son estos que vuelan como
una nube, que vuelan como palomas que regresan a su nido? \bibleverse{9}
...
\bibleverse{10} Los extranjeros reconstruirán tus murallas, y sus reyes
trabajarán para ti. Aunque te golpeé cuando estaba enojado contigo,
ahora seré bondadoso y misericordioso contigo. \bibleverse{11} Tus
...
ti, con sus reyes conducidos en procesión. \footnote{\textbf{60:11} Apoc
  21,25-26} \bibleverse{12} Cualquier nación o reino que no te sirva
será completamente destruido. \bibleverse{13} La gloria del Líbano
vendrá a ti: cedros, acacias y mirtos, para embellecer mi Templo y
honrar el lugar que elegí para vivir. \bibleverse{14} Los hijos de los
...
\bibleverse{15} Antes estabas abandonada y despreciada, en un lugar al
...
\bibleverse{16} Las naciones te proveerán de lo necesario, los reyes te
...
\bibleverse{17} Te traeré oro en lugar de bronce, plata en lugar de
...
a la Paz como tu vigilante, y a la Bondad como tu líder. \footnote{\textbf{60:17}
  Is 52,7} \bibleverse{18} No habrá más violencia en tu tierra, ni
...
\bibleverse{19} No necesitarás la luz del sol durante el día, ni la luz
...
\bibleverse{20} Tu sol no se pondrá nunca, y tu luna no se apagará
jamás, porque el Señor será tu luz eterna, y tu tiempo de luto
terminará. \bibleverse{21} Todo tu pueblo será bueno, y será dueño de la
tierra para siempre. Ellos son el brote que he plantado con mis manos, y
revelarán mi gloria. \bibleverse{22} La más pequeña de tus familias
...
\bibleverse{1} El Espíritu del Señor Dios está sobre mí, porque el Señor
...
cautivos, a poner en libertad a los prisioneros, \footnote{\textbf{61:1}
  Mat 11,5; Luc 4,18-19} \bibleverse{2} a anunciar el año de gracia del
Señor y el día del castigo de nuestro Dios,\footnote{\textbf{61:2}
  ...
  Lev 25,10; Is 63,4} \bibleverse{3} El Señor dará a todos los que
...
\bibleverse{4} Reconstruirán las viejas ruinas; restaurarán los lugares
...
generación. \bibleverse{5} Los extranjeros pastorearán sus rebaños,
cuidarán sus campos y atenderán sus viñas. \footnote{\textbf{61:5} Is
  60,10-16} \bibleverse{6} Serán llamados sacerdotes del Señor,
...
riquezas de las naciones y estarán orgullosos de tenerlas. \footnote{\textbf{61:6}
  Is 66,21} \bibleverse{7} En lugar de la vergüenza, recibirán una doble
bendición; en lugar de los insultos, se alegrarán de que les den el
doble de tierras, y su alegría durará para siempre. \bibleverse{8} Yo,
...
\footnote{\textbf{61:8} Is 54,10; Is 55,3} \bibleverse{9} Sus
...
\bibleverse{10} ¡Yo celebraré felizmente en el Señor! Todo mi ser
...
novia que lleva sus joyas. \bibleverse{11} Como la tierra echa brotes y
...
\bibleverse{1} No puedo callar por mi amor a Sión, no puedo callar por
mi amor a Jerusalén, hasta que su integridad brille como un rayo de luz,
hasta que su salvación arda como una antorcha. \bibleverse{2} Las
...
\bibleverse{3} Serás una corona de belleza en la mano del Señor; un
tocado real en la mano de tu Dios. \bibleverse{4} Ya no te llamarán
...
al Señor, y tu tierra estará casada.\footnote{\textbf{62:4} Los nombres
  ...
  Jerusalén.} \bibleverse{5} Porque como un joven se casa con una joven,
...
\bibleverse{6} He puesto centinelas en tus muros, Jerusalén; no callarán
...
nunca a descansar. \footnote{\textbf{62:6} Is 52,8} \bibleverse{7}
Tampoco le den descanso al Señor, hasta que termine su obra, hasta que
haga de Jerusalén el lugar más loable de la tierra. \bibleverse{8} El
...
extranjeros se beban el vino nuevo que tanto has trabajado. \footnote{\textbf{62:8}
  Is 65,21-22} \bibleverse{9} En cambio, los que cosechan el grano lo
...
\bibleverse{10} ¡Salgan! ¡Salgan por las puertas! ¡Despejen el camino
...
ver!\footnote{\textbf{62:10} Las imágenes de este verso se toman para
  representar al pueblo que abandona Babilonia.} \bibleverse{11}
...
¡viene a dar su regalo! \footnote{\textbf{62:11} Zac 9,9; Is 40,10; Apoc
  22,12} \bibleverse{12} Ellos serán llamados el Pueblo Santo, los
...
\bibleverse{1} ¿Quién es éste que viene de Edom, de la ciudad de
...
\footnote{\textbf{63:1} Is 42,1; Is 42,3} \bibleverse{2} ¿Por qué tu
ropa es roja, como si hubieras pisado uvas en un lagar? \footnote{\textbf{63:2}
  Apoc 19,13} \bibleverse{3} He pisado el lagar yo solo; de las naciones
...
\bibleverse{4} Porque decidí que éste era el día de mi venganza; ha
llegado el año de mi redención. \footnote{\textbf{63:4} Is 13,9; Is
  34,8; Is 61,2} \bibleverse{5} Miré a mi alrededor, pero nadie vino a
...
\footnote{\textbf{63:5} Is 59,16} \bibleverse{6} En mi furia pisoteé a
...
\bibleverse{7} Quiero contarle a todo el mundo el amor confiable del
...
bondad y su infinito amor digno de confianza. \bibleverse{8} Dijo: ¿No
...
\bibleverse{9} Sufrió con ellos en todo su sufrimiento, y el ángel de su
...
\bibleverse{10} Pero ellos se rebelaron contra él y causaron dolor a su
Espíritu Santo, por lo que para ellos se convirtió en un enemigo y luchó
contra ellos. \bibleverse{11} Entonces ellos\footnote{\textbf{63:11}
...
medio de su pueblo? \footnote{\textbf{63:11} Éxod 14,30} \bibleverse{12}
...
reputación tan maravillosa y duradera? \bibleverse{13} ¿Dónde está el
que los condujo a través de las profundidades del mar? Eran como un
caballo corriendo por el desierto, no tropezaban. \bibleverse{14} Como
...
\bibleverse{15} ¡Señor, míranos desde el cielo! ¡Vigila desde tu alto
hogar, en tu santidad y gloria! ¿Dónde está tu entusiasmo y tu poder?
¡No me muestras tus sentimientos de simpatía y bondad! \bibleverse{16}
...
nuestro Redentor desde hace mucho tiempo. \bibleverse{17} Señor, ¿por
...
te pertenecen. \bibleverse{18} Tu Templo nos perteneció por un tiempo,
pero luego nuestros enemigos lo invadieron y lo destruyeron. \footnote{\textbf{63:18}
  Sal 79,1}

\bibleverse{19} Fuimos tuyos desde tiempos remotos, pero hemos acabado
...
\bibleverse{1} Si tan sólo desgarraras los cielos y bajaras. Las
...
\bibleverse{2} De la misma manera que el fuego quema la madera y hace
hervir el agua, ¡haz que tu reputación sea conocida por tus enemigos,
para que las naciones tiemblen en tu presencia! \bibleverse{3} En el
pasado hiciste cosas que no esperábamos. Bajaste y las montañas
temblaron en tu presencia. \bibleverse{4} Desde el principio, nadie ha
...
\bibleverse{5} Te unes a los que se alegran y a los que hacen lo
...
así?\footnote{\textbf{64:5} El hebreo del final de este verso no está
  claro.} \bibleverse{6} Todos nos hemos vuelto impuros, y todas las
...
\bibleverse{7} No hay nadie que te invoque ni que quiera realmente
...
\bibleverse{8} Pero tú, Señor, eres nuestro Padre. Nosotros somos el
barro, tú eres el alfarero. Nos has hecho con tus propias manos.
\bibleverse{9} Por favor, limita tu ira, Señor, y no recuerdes nuestros
pecados para siempre. Míranos, y mira que todos somos tu pueblo.
\bibleverse{10} Tus ciudades santas se han convertido en un desierto;
Sión se ha convertido en un desierto; sí, incluso Jerusalén es una ruina
abandonada. \bibleverse{11} Nuestro hermoso y santo Templo, donde
nuestros antepasados te alababan, ha sido incendiado, y todo lo que
atesorábamos ha sido destruido. \bibleverse{12} En vista de todo esto,
...
\bibleverse{1} Me dejé consultar por gente que ni siquiera me hacía
...
\footnote{\textbf{65:1} Rom 10,20} \bibleverse{2} Extendí mis manos todo
...
\bibleverse{3} Este pueblo siempre me hace enojar, porque presenta
sacrificios a los ídolos en sus jardines sagrados y ofrece incienso en
altares paganos hechos de ladrillo. \bibleverse{4} Pasan la noche entre
las tumbas y en las cuevas, comiendo cerdo y cocinando otras carnes
impuras. \footnote{\textbf{65:4} Is 66,17; Lev 11,7} \bibleverse{5}
...
mis narices, un hedor que arde todo el día! \bibleverse{6} ¡Mira, todo
está escrito delante de mí! No me voy a callar. Voy a pagarles arrojando
su castigo en su regazo. \bibleverse{7} Voy a pagarles por sus propios
...
\bibleverse{8} Esto es lo que dice el Señor: Es como cuando queda un
...
los destruiré a todos. \bibleverse{9} Me aseguraré de que Jacob tenga
...
\bibleverse{10} Sarón se convertirá en un pasto para los rebaños, y el
Valle de Acor en un lugar de descanso para los rebaños, para mi pueblo
que me sigue. \footnote{\textbf{65:10} Jos 7,26} \bibleverse{11} Pero
...
\bibleverse{12} Me aseguraré de que tu destino sea ser asesinado por la
...
\bibleverse{13} Así que esto es lo que dice el Señor: Mis siervos
...
\footnote{\textbf{65:13} Is 55,1} \bibleverse{14} ¡Escuchen! Mis siervos
...
\bibleverse{15} Tu nombre sólo será usado como una maldición por mis
elegidos, porque el Señor Dios te matará y dará a sus siervos otro
nombre. \bibleverse{16} Quien pida una bendición o haga un juramento en
...
\bibleverse{17} ¡Mira! Voy a crear cielos nuevos y una tierra nueva. No
...
verdadera alegría. \footnote{\textbf{65:18} Is 35,10} \bibleverse{19} Me
...
del llanto y los gritos de auxilio no volverán a oírse allí. \footnote{\textbf{65:19}
  Is 25,8} \bibleverse{20} Ningún bebé morirá a los pocos días, y ningún
...
\bibleverse{21} Construirán casas y vivirán en ellas; comerán el fruto
de las viñas que ellos mismos plantaron. \footnote{\textbf{65:21} Is
  62,8} \bibleverse{22} Ya no construirán casas para que otros vivan en
...
disfrutar de todo lo que han trabajado. \footnote{\textbf{65:22} Deut
  28,30} \bibleverse{23} No trabajarán para nada, y no tendrán hijos
destinados al desastre. Porque son personas que viven bajo la bendición
del Señor, y sus hijos también lo serán. \bibleverse{24} Yo responderé
incluso antes de que me pregunten. Mientras aún están hablando, les
responderé. \bibleverse{25} El lobo y el cordero comerán juntos. El león
...
\bibleverse{1} Esto es lo que dice el Señor: El cielo es mi trono, y la
...
a construir para mí? ¿Dónde me acostaré para descansar? \footnote{\textbf{66:1}
  1Re 8,27; Hech 7,49; Hech 17,24} \bibleverse{2} Yo lo hice todo; así
...
son humildes y arrepentidos, y tiemblan cuando hablo. \footnote{\textbf{66:2}
  Is 57,15} \bibleverse{3} Cuando alguien sacrifica un toro, es como un
...
actuar así y amar esas cosas repugnantes, \footnote{\textbf{66:3} Lev
  17,4} \bibleverse{4} también elegiré castigarlos severamente y
...
\bibleverse{5} Escuchen lo que el Señor tiene que decir, los que
...
\bibleverse{6} ¡Oigan todos los gritos de la ciudad! ¡Oigan todo el
ruido del Templo! Es el sonido del Señor devolviendo a sus enemigos lo
que merecen. \bibleverse{7} Ella\footnote{\textbf{66:7} Refiriéndose a
  Jerusalén como una mujer.} dio a luz antes de ponerse de parto, dio a
luz a un niño antes de que llegaran los dolores. \bibleverse{8} ¿Quién
...
\bibleverse{9} ¿Acaso llevaría yo a un bebé al punto de nacer y luego no
lo daría a luz? pregunta el Señor. ¿Yo, que he dado a luz, impediría que
naciera? \footnote{\textbf{66:9} Is 37,3}

\bibleverse{10} Celebren con Jerusalén y alégrense por ella, todos los
que la aman; celebren con ella y canten de alegría, todos los que se
lamentan por ella. \footnote{\textbf{66:10} Sal 122,6} \bibleverse{11}
...
\bibleverse{12} Esto es lo que dice el Señor: ¡Mira! Voy a darle paz y
...
\bibleverse{13} Como una madre que consuela a su hijo, yo te consolaré a
ti. Serás consolado en Jerusalén. \bibleverse{14} Cuando veas que esto
...
\bibleverse{15} ¡Mira! El Señor viene rodeado de fuego, con sus carros
girando como el viento, para expresar su ira con furia, para dar su
reprimenda en llamas de fuego. \bibleverse{16} El Señor ejecutará el
juicio sobre todos con fuego y con su espada. Habrá muchos muertos por
el Señor.

\bibleverse{17} Los que se dedican y se hacen puros para\footnote{\textbf{66:17}
...
\bibleverse{18} Yo sé\footnote{\textbf{66:18} ``Sé'': Tomado de la
...
\bibleverse{19} Les daré una señal, y enviaré a las naciones a algunos
...
entre las naciones. \bibleverse{20} Traerán a todo tu pueblo de todas
...
\bibleverse{21} Elegiré a algunos de ellos como sacerdotes y levitas,
dice el Señor. \footnote{\textbf{66:21} Is 61,6}

\bibleverse{22} Así como los cielos nuevos y la tierra nueva que yo haré
durarán para siempre, también tu descendencia y tu nombre durarán para
siempre, dice el Señor. \bibleverse{23} Todos vendrán a adorarme, de una
Luna Nueva a otra, y de un sábado a otro, dice el Señor. \bibleverse{24}
