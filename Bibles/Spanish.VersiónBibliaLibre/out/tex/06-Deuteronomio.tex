...
\bibleverse{1} Este es el registro de lo que Moisés le dijo a todos los
...
Laban, Hazerot y Di-zahab por el otro. \bibleverse{2} (Se necesitan once
días para ir de Horebv a Cades-barnea por el camino que pasa por el
Monte Seir). \bibleverse{3} El primer día del undécimo mes del
...
Señor le había ordenado que les dijera. \bibleverse{4} Esto sucedió
...
gobernaba en Astarot. \bibleverse{5} Hablando en el lado este del Jordán
...
\bibleverse{6} El Señor nuestro Dios nos dijo en Horeb: ``Han
permanecido aquí al lado de esta montaña por mucho tiempo. \footnote{\textbf{1:6}
  Núm 10,11-12} \bibleverse{7} Continúensu viaje y vayan a las colinas
...
\bibleverse{8} ``Miren que yo les doy esta tierra. Vayan y tomen
...
\bibleverse{9} Fue entonces cuando le dije: ``No puedo hacerme
responsable de todo el pueblo yo solo. \bibleverse{10} El Señor nuestro
...
\bibleverse{11} Que el Señor, el Dios de sus antepasados, los
multiplique mil veces y los bendiga como lo ha prometido.
\bibleverse{12} Pero, ¿cómo puedo asumir todos sus problemas, cargas y
discusiones yo solo? \bibleverse{13} Deben elegir entre ustedes hombres
sabios, experimentados y con buen juicio de cada una de sus tribus, y yo
los pondré a cargo como sus líderes''.

\bibleverse{14} Ustedes me respondieron diciendo: ``Tu propuesta es
buena''. \bibleverse{15} Así que he convocado a los líderes de sus
...
\bibleverse{16} Al mismo tiempo le di instrucciones estrictas a sus
...
o un extranjero que viva entre ustedes. \bibleverse{17} No muestren
...
demasiado duro para ustedes, y yo lo escucharé''. \footnote{\textbf{1:17}
  Deut 16,19; Éxod 21,6} \bibleverse{18} Esta fue también la época en
...
\bibleverse{19} Siguiendo las órdenes del Señor nuestro Dios, dejamos
...
Cuando llegamos a Cades-barnea, \bibleverse{20} es expliqué: ``Han
llegado a la colina de los amorreos, que el Señor nuestro Dios nos da.
\bibleverse{21} ¡Miren que el Señor su Dios les ha dado la tierra! Vayan
...
\bibleverse{22} Entonces todos ustedes vinieron a mí y me sugirieron:
...
\bibleverse{23} Me pareció un buen plan, así que elegí a doce de sus
hombres, uno de cada tribu. \bibleverse{24} Partieron y subieron a las
colinas hasta el Valle de Escol, para explorar la tierra.
\bibleverse{25} Trajeron de vuelta algunos de los frutos del país,
llevándolos hasta nosotros, y nos dieron el informe: ``El Señor nuestro
Dios nos está dando buena tierra''.

\bibleverse{26} Pero ustedes no quisieron ir. Se rebelaron contra las
instrucciones del Señor su Dios. \footnote{\textbf{1:26} Núm 14,-1}
\bibleverse{27} Se quejaron en sus tiendas y dijeron: ``Parece que el
Señor nos odia, y nos sacó de Egipto para entregarnos a los amorreos
para ser aniquilados. \bibleverse{28} ¿Adónde vamos? Nuestros hermanos
...
\bibleverse{29} Así que yo les dije: ``¡No se asusten, ni tengan miedo
de ellos! \bibleverse{30} El Señor nuestro Dios que guía su camino
...
\bibleverse{31} Lo mismo hizo en el desierto, y ustedes vieron cómo el
...
\bibleverse{32} A pesar de todo esto, no confiaron en el Señor su Dios,
\bibleverse{33} que los guió en el viaje, estando presente en el fuego
...
\bibleverse{34} Cuando el Señor oyó lo que ustedes decían, se enfadó e
hizo un juramento: \bibleverse{35} ``Ni uno solo de esta mala generación
verá la buena tierra que prometí a sus antepasados, \bibleverse{36}
...
\bibleverse{37} El Señor también se enojó conmigo por culpa de ustedes.
Y me dijo: ``Ni siquiera tú entrarás en el país. \bibleverse{38} Sin
...
porque él ayudará a Israel a ocupar la tierra. \footnote{\textbf{1:38}
  Núm 34,17} \bibleverse{39} Sus hijos pequeños que afirmaban que se
...
ocuparán. \bibleverse{40} Pero ahora den la vuelta y vuelvan al desierto
por el camino que lleva al Mar Rojo''.

\bibleverse{41} Pero ustedes respondieron y dijeron: ``¡Hemos pecado
...
\bibleverse{42} Pero el Señor me instruyó: ``Ordénales que no vayan a
pelear porque no estaré con ustedes para evitar que sean derrotados por
sus enemigos''.

\bibleverse{43} Yo les advertí esto, pero ustedes se negaron a escuchar.
Desafiaron las instrucciones del Señor y con arrogancia se fueron a
luchar en las montañas. \bibleverse{44} Entonces los amorreos que vivían
allí en las colinas vinieron y los atacaron. Los persiguieron como un
enjambre de abejas, matándolos desde Seir hasta Horma. \bibleverse{45}
Luego ustedes volvieron al campamento y lloraron ante el Señor, pero él
se negó a escucharlos. \bibleverse{46} Y tuvieron que permancer en Cades
...
\bibleverse{1} Luego dimos la Vuelta y regresamos por el desierto de
...
\bibleverse{2} Finalmente el Señor me dijo: \bibleverse{3} ``Han estado
vagando en esta región montañosa por suficiente tiempo. Vuelvan al
norte, \bibleverse{4} y dale estas órdenes al pueblo: Pasarán por el
...
\footnote{\textbf{2:4} Núm 20,14} \bibleverse{5} No luchen contra ellos,
...
pertenece. \footnote{\textbf{2:5} Gén 36,8; Gén 36,43} \bibleverse{6}
Págales con dinero por la comida que comes y el agua que bebes''.

\bibleverse{7} Recuerden que el Señor su Dios los ha bendecido en todo
...
\bibleverse{8} Así que pasamos por la tierra de nuestros parientes, los
...
\bibleverse{9} Entonces el Señor me dijo: ``No causes problemas a los
...
\bibleverse{10} (Un pueblo fuerte y numeroso llamado los Emim vivió una
vez allí. Ellos eran tan altos como los anaceos,\footnote{\textbf{2:10}
  Ver 1:28.} \footnote{\textbf{2:10} Deut 1,28} \bibleverse{11} y al
igual que los anaceos, también fueron considerados como
Refaim,\footnote{\textbf{2:11} ``Refaím'': Una raza de gigantes.} pero
los moabitas los llamaron Emim. \bibleverse{12} Anteriormente los horeos
...
\bibleverse{13} Entonces el Señor nos dijo:\footnote{\textbf{2:13}
...
\bibleverse{14} El tiempo que tardamos en viajar desde Cades-barnea
...
\footnote{\textbf{2:14} Deut 1,34} \bibleverse{15} De hecho, el Señor
trabajó contra ellos para sacarlos del campamento, hasta que todos
murieron. \bibleverse{16} Una vez muertos los guerreros del pueblo,
\bibleverse{17} el Señor me dijo: \bibleverse{18} ``Hoy cruzarás la
frontera de Moab por la ciudad de Ar. \bibleverse{19} Sin embargo,
...
\bibleverse{20} (Esta tierra era considerada anteriormente como el país
de los Refaim que solían vivir allí. Sin embargo, los amonitas los
llamaban Zamzumitas. \bibleverse{21} Eran un pueblo fuerte y numeroso,
...
allí, \bibleverse{22} tal como lo hizo con los descendientes de Esaú que
...
siguen allí hasta hoy. \bibleverse{23} Los Avvim, que vivían en aldeas
...
\bibleverse{24} Entonces el Señor nos dijo,\footnote{\textbf{2:24}
...
a tomarla, y peleen con él en batalla. \bibleverse{25} A partir de este
...
\bibleverse{26} Entonces Moisés les dijo a los israelitas:\footnote{\textbf{2:26}
...
para Sehón, rey de Hesbón, diciéndole, \footnote{\textbf{2:26} Núm
  21,21-26} \bibleverse{27} `Déjanos pasar por tu tierra. Nos quedaremos
en el camino principal y no nos desviaremos ni a la derecha ni a la
izquierda. \bibleverse{28} Véndenos comida para comer y agua para beber
por dinero. Déjanos pasar a pie, \bibleverse{29} como nos permitieron
...
nos da'\,''. \bibleverse{30} Pero Sehón, rey de Hesbón, se negó a
...
\bibleverse{31} Entonces el Señor me dijo: ``Mira, he empezado a
entregarte a Sehón y su tierra. Ahora puedes empezar a conquistar y
tomar su tierra''. \bibleverse{32} Sehón y todo su ejército salieron a
luchar contra nosotros en Yahaza. \bibleverse{33} El Señor nuestro Dios
nos lo entregó y lo matamos a él, a sus hijos y a todo su ejército.
\bibleverse{34} También capturamos a toda su gente, ylos separamos para
...
dejamos ningún sobreviviente. \bibleverse{35} Todo lo que tomamos para
nosotros fue el ganado y el saqueo de los pueblos que habíamos
capturado. \bibleverse{36} Ningún pueblo tenía muros demasiado altos que
...
\bibleverse{37} Pero no fueron a ningún sitio cerca del país de los
...
\bibleverse{1} Salimos y subimos por la carretera hacia Basán. Entonces
Og, el rey de Basán, y todo su ejército salieron a luchar contra
nosotros en Edrei. \bibleverse{2} Pero el Señor me dijo: ``No le tengas
...
\bibleverse{3} El Señor nuestro Dios nos entregó a Og, rey de Basán, y a
todo su ejército. Los matamos y no dejamos sobrevivientes.
\bibleverse{4} También capturamos todos sus pueblos. No hubo un solo
pueblo entre los sesenta que no pudiéramos capturar. Incluso toda la
región de Argob, el reino de Og en Basán. \bibleverse{5} Todas estas
...
\bibleverse{6} Las separamos para su destrucción, como hicimos con
Sehón, rey de Hesbón, matando a todos los hombres, mujeres y niños de
cada ciudad. \bibleverse{7} Pero tomamos para nosotros todo el ganado y
...
\bibleverse{8} Así que en resumen, en ese momento tomamos de los dos
reyes amorreos la tierra al Este del Jordán, desde el valle de Arnón
hasta el Monte Hermón. \bibleverse{9} (El Monte Hermón es llamado Sirión
por los sidonios y Senir por los amorreos). \bibleverse{10} El área
...
\bibleverse{11} (Sólo Og, rey de Basán, quedó de la raza de los Refaim.
Tenía una cama de hierro de nueve codos de largo y cuatro de ancho.
Todavía está en la ciudad amonita de Rabá). \bibleverse{12} Fue entonces
...
\footnote{\textbf{3:12} Núm 32,33-42} \bibleverse{13} Asigné a la media
...
la tierra de los Refaim). \bibleverse{14} Jair, descendiente de Manasés,
...
nombre hasta el día de hoy. \bibleverse{15} Asigné el resto
de\footnote{\textbf{3:15} ``El resto de'': añadido para mayor claridad.}
Galaad to the descendants of Maquir, \bibleverse{16} mientras que yo
...
Jaboc en la frontera amonita. \bibleverse{17} El río Jordán en la Arabá
...
\bibleverse{18} Fue entonces cuando te\footnote{\textbf{3:18}
...
\bibleverse{19} Sin embargo, tus mujeres, tus hijos y tus ganados (sé
que tienes mucho ganado) pueden quedarse en las ciudades que les he
dado, \bibleverse{20} hasta que el Señor le dé la victoria a sus
...
\bibleverse{21} Esta fue la vez que le ordené a Josué: ``Has visto con
tus propios ojos todo lo que el Señor tu Dios hizo a estos dos reyes. El
Señor hará lo mismo con todos los reinos a los que vas. \bibleverse{22}
...
\bibleverse{23} Este fue también el momento en que supliqué al Señor,
diciendo, \bibleverse{24} ``Señor Dios, apenas has empezado a mostrar tu
...
haces? \bibleverse{25} Por favor, déjame cruzar el Jordán y ver la buena
tierra de allí, las hermosas colinas y las montañas del Líbano!''

\bibleverse{26} Pero el Señor se enfadó conmigo por culpa de ustedes y
se negó a escucharme. ``Ya basta'', me dijo. ``No me hables más de esto.
\bibleverse{27} Sube a la cima del monte y mira al Oeste, al norte, al
sur y al Este. Contempla la tierra con tus propios ojos, porque no vas a
cruzar este Jordán. \bibleverse{28} En vez de eso, pon a Josué a cargo
...
\bibleverse{29} Así que nos quedamos allí en el valle cerca de
Beth-peor.
...
\bibleverse{1} Pueblo de Israel, presten atención a las normas y
...
dando. \bibleverse{2} No añadan ni quiten nada de lo que les digo, para
que puedan guardar los mandamientos del Señor su Dios, que les ordenó
seguir. \bibleverse{3} Han visto por ustedes mismos lo que el Señor hizo
en Baal-peor, donde el Señor su Dios mató a todos los que adoraban al
dios de Baal- Peor. \footnote{\textbf{4:3} Núm 25,3-9} \bibleverse{4}
Aquellos entre ustedes que permanecieron fieles al Señor todavía están
vivos hoy, cada uno de ustedes. \bibleverse{5} Escuchen, yo les he
...
\bibleverse{6} Asegúrense de observarlas, porque esto demostrará su
...
\bibleverse{7} ¿Qué nación es tan grande como nosotros, teniendo un dios
tan cerca de ellos como el Señor nuestro Dios es para nosotros cada vez
que lo invocamos? \bibleverse{8} ¿Qué nación es tan grande como
...
\bibleverse{9} Sólo asegúrate de ser muy cuidadosos, y realmente cuidar
...
cuenta mientras vivan. Enséñenselas a sus hijos y nietos. \footnote{\textbf{4:9}
  Sal 103,2} \bibleverse{10} Aquel día en que estuvieron en la presencia
...
\bibleverse{11} Se reunieron y se pararon al pie de la montaña. La
montaña estaba ardiendo, lanzando llamas al cielo y produciendo gruesas
y oscuras nubes. \bibleverse{12} El Señor les habló desde el fuego.
Escucharon las palabras, pero no vieron la forma en que nadie hablaba,
sólo había una voz. \bibleverse{13} Les explicó su pacto, los Diez
Mandamientos, que les ordenó seguir. Los escribió en dos tablas de
piedra. \footnote{\textbf{4:13} Éxod 31,18} \bibleverse{14} Este fue el
...
vez que hayan cruzado el Jordán. \bibleverse{15} No vieron ninguna
figura cuando el Señor les habló desde el fuego en Horeb, así que tengan
mucho cuidado \bibleverse{16} de no estropear su relación con el Señor
haciendo un ídolo de cualquier forma, ya sea en forma de hombre o mujer,
\bibleverse{17} o de cualquier animal terrestre o pájaro que vuele,
\bibleverse{18} o de cualquier animal que se arrastre por el suelo o
cualquier pez en las profundidades del mar. \bibleverse{19} Cuando miren
...
permitido. \footnote{\textbf{4:19} Deut 17,3} \bibleverse{20} Recuerden
...
que fueranun pueblo libre, tal como lo son hoy. \footnote{\textbf{4:20}
  Éxod 19,5-6} \bibleverse{21} Pero el Señor se enojó conmigo por culpa
...
\footnote{\textbf{4:21} Deut 3,26} \bibleverse{22} Así que no cruzaré el
Jordán, porque tengo que morir aquí en esta tierra. Pero ustedes
cruzarán y ocuparán esa buena tierra. \bibleverse{23} Sin embargo,
...
prohibido. \bibleverse{24} Porque el Señor su Dios es un fuego que lo
...
\bibleverse{25} Después de haber vivido en el campamento durante mucho
...
su Dios, verá esto como un mal que lo hará enojar. \bibleverse{26} Si
...
\bibleverse{27} Entoncesel Señor los dispersará entre las demás
naciones, y no muchos de ustedes sobrevivirán en los países donde el
Señor los ha exiliado. \bibleverse{28} Allí adorarán a dioses de madera
y piedra hechos por seres humanos. Estos ídolos no pueden ver ni oír, ni
comer ni oler. \bibleverse{29} Sin embargo, si mientras están allí
...
todo corazón, con un compromiso completo. \footnote{\textbf{4:29} Sal
  27,8; Jer 29,13-14} \bibleverse{30} Cuando estén en problemas, después
...
Señor su Dios y obedecerán lo que él diga. \footnote{\textbf{4:30} Lev
  26,40} \bibleverse{31} El Señor su Dios es un Dios misericordioso. No
...
\bibleverse{32} ¡Mediten en ello! Examinen toda la historia desde el
...
\bibleverse{33} ¿Ha escuchado alguna vez un pueblo la voz de Dios
hablando desde el fuego, y han sobrevivido como ustedes lo han hecho?
\footnote{\textbf{4:33} Éxod 20,1; Éxod 20,19} \bibleverse{34} ¿Ha
...
por ustedes en Egipto, ante tus propios ojos? \footnote{\textbf{4:34}
  Deut 7,19} \bibleverse{35} Se les mostró todo esto para que tuvieran
la certeza de que el Señor es Dios y no hay nadie como él. \footnote{\textbf{4:35}
  Deut 32,39} \bibleverse{36} Él les hizo escuchar su voz desde el cielo
para que le obedecieran. En la tierra se reveló a través del fuego
ardiente, y le oyeron hablar desde el fuego. \bibleverse{37} Porque amó
a sus antepasados, los eligió a ustedes, su descendencia. Él mismo los
sacó de Egipto con su gran poder, \bibleverse{38} expulsando delante de
ustedes a naciones más grandes y fuertes que ustedes, para conducirlos a
su tierra y dárselas como posesión, tal como sucede hoy. \bibleverse{39}
Así que hoy tengan la certeza de esto y no lo olviden nunca: el Señor es
el único Dios arriba en el cielo y abajo en la tierra. \bibleverse{40}
...
\bibleverse{41} Entonces Moisés asignó tres pueblos santuarios al este
del Jordán \footnote{\textbf{4:41} Núm 35,6-29; Deut 19,2-13}
\bibleverse{42} a los que una persona podía acudir corriendo después de
matar accidentalmente a alguien sin odio deliberado. Para salvar su vida
podían correr a uno de estos pueblos: \bibleverse{43} Bezer en la
...
\bibleverse{44} Esta es la ley que Moisés puso ante los israelitas.
\bibleverse{45} Estas son las leyes, reglas y normas que Moisés les dio
después de que salieran de Egipto. \bibleverse{46} Esto fue cuando
...
Egipto. \bibleverse{47} Se apoderaron de su país y del país de Og, rey
de Basán. (Eran los dos reyes de los amorreos que anteriormente
gobernaban en el lado este del Jordán). \bibleverse{48} El territorio
...
Monte Sirion,\footnote{\textbf{4:48} ``Sirión'', aquí es ``Sión'', pero
  vea 3:9.} también conocido como el Monte Hermón, \bibleverse{49} e
...
\bibleverse{1} Entonces Moisés convocó a todos los israelitas y les
...
seguirlas cuidadosamente. \bibleverse{2} Recuerden que el Señor nuestro
Dios hizo un acuerdo con nosotros en Horeb. \footnote{\textbf{5:2} Deut
  28,69; Éxod 19,5} \bibleverse{3} No hizo este acuerdo con nuestros
padres, sino con nosotros, todos los que aún viven hoy. \footnote{\textbf{5:3}
  Deut 29,14} \bibleverse{4} El Señor habló con ustedes de persona a
persona desde el fuego de la montaña. \footnote{\textbf{5:4} Deut 5,21;
  Éxod 19,19} \bibleverse{5} Este fue el momento en el que me interpuse
...
\bibleverse{6} ``Yo soy el Señor tu Dios, que te sacó de Egipto, de la
prisión de la esclavitud. \footnote{\textbf{5:6} Éxod 20,-1}

\bibleverse{7} ``No debes tener otros dioses aparte de mí. \footnote{\textbf{5:7}
  Deut 11,16; Deut 11,28}

\bibleverse{8} ``No debes hacerte ningún tipo de ídolo, ya sea en forma
de algo que esté arriba en los cielos, o abajo en la tierra, o debajo en
las aguas. \footnote{\textbf{5:8} Deut 27,15} \bibleverse{9} No debes
...
me odian sobre sus hijos, nietos y bisnietos; \bibleverse{10} pero
muestro un amor fiel a las miles de generaciones que me aman y guardan
mis mandamientos.

\bibleverse{11} ``No debes usar el nombre del Señor tu Dios de manera
incorrecta, porque el Señor no perdonará a nadie que use su nombre de
forma incorrecta.

\bibleverse{12} ``Recuerda el sábado para santificarlo, como el Señor,
tu Dios, te ha ordenado. \bibleverse{13} Tienes seis días para trabajar
y ganarte el sustento, \bibleverse{14} pero el séptimo día es el sábado
...
\bibleverse{15} Recuerda que una vez fueron esclavos en Egipto, y que el
...
\bibleverse{16} Honra a tu padre y a tu madre, como te ha ordenado el
...
\bibleverse{19} ``No debes robar. \footnote{\textbf{5:19} Éxod 31,18}

\bibleverse{20} ``No debes dar pruebas falsas contra otros.

\bibleverse{21} ``No debes desear tener la esposa de otro. No debes
...
\bibleverse{22} En voz alta el Señor les dio estos mandamientos a todos
...
piedra y me las dio. \bibleverse{23} Cuando escucharon la voz que venía
de las tinieblas mientras la montaña estaba en llamas, todos sus jefes y
ancianos de las tribus vinieron a mí, \bibleverse{24} y me dijeron:
...
ellos. \bibleverse{25} Pero aún podríamos morir, ¿no es así? Este enorme
fuego nos va a quemar, y moriremos si el Señor nuestro Dios continúa
hablándonos. \bibleverse{26} ¿Alguien más ha oído hablar al Dios vivo
desde el fuego y ha sobrevivido, como nosotros? \footnote{\textbf{5:26}
  Deut 29,3; Núm 11,29} \bibleverse{27} e y escucha todo lo que el Señor
nuestro Dios dice. Entonces podrás repetirnos todo lo que el Señor
nuestro Dios ha dicho. Prometemos escuchar y obedecer''.

\bibleverse{28} El Señor escuchó lo que ustedes me dijeron, y me dijo:
``He escuchado lo que este pueblo te dijo. Todo lo que han dicho es
bueno. \bibleverse{29} Sólo deseo que me respeten y guarden siempre mis
mandamientos para que ellos y sus hijos estén bien para siempre.

\bibleverse{30} Ve y diles: `Tienen que volver a sus tiendas'.
\bibleverse{31} Pero deben quedarse aquí conmigo para que les dé todos
los mandamientos y reglas que deben enseñarles a seguir en el país que
les estoy dando para que lo tomen y lo posean''.

\bibleverse{32} Así que asegúrate de hacer lo que el Señor tu Dios te ha
ordenado hacer, no te desvíes en ninguna dirección. \bibleverse{33}
...
\bibleverse{1} Estos son los mandamientos y ordenanzas que el Señor su
Dios me ha pedidoque les enseñe a seguir en el país que van a entrar y
ocupar. \bibleverse{2} Esto es para que tú y tus hijos y nietos muestren
...
\bibleverse{3} Escucha, pueblo de Israel, y está atento a observarlas,
...
\bibleverse{4} Escucha, pueblo de Israel, el Señor nuestro Dios, el
...
\bibleverse{6} Las órdenes que les doy hoy deben permanecer en sus
mentes. \footnote{\textbf{6:6} Deut 11,18-20} \bibleverse{7} Deberán
...
casa y al viajar, cuando se acuesten y cuando se levanten. \footnote{\textbf{6:7}
  Gén 18,19} \bibleverse{8} Amárrenlas en sus manos como recordatorio y
pónganlas también en sus frentes. \footnote{\textbf{6:8} Éxod 13,9}
\bibleverse{9} Escríbanlas en los postes de sus casas y en sus puertas.
...
\bibleverse{10} El Señor tu Dios te llevará al país que prometió darte a
ti y a tus antepasados, Abraham, Isaac y Jacob. Es un país con grandes y
prósperas ciudades que no construiste, \bibleverse{11} con casas llenas
...
lleno \bibleverse{12} asegúrate de no olvidartedel Señor que te sacó de
Egipto, de la prisión de la esclavitud. \bibleverse{13} Respeta al Señor
tu Dios, adórale sólo a él, y haz sólo promesas en su nombre.
\footnote{\textbf{6:13} Deut 10,20; Mat 4,10} \bibleverse{14} No adores
a ningún otro dios, ni a los dioses de los pueblos que te rodean,
\bibleverse{15} porque el Señor tu Dios, que vive entre ustedes, es un
...
\bibleverse{16} No pongas a prueba al Señor tu Dios como lo hiciste en
Massa.\footnote{\textbf{6:16} Ver Éxodo 17:7.} \footnote{\textbf{6:16}
  Mat 4,7; Éxod 17,2; Éxod 17,7} \bibleverse{17} Debes tener cuidado de
guardar los mandamientos del Señor tu Dios y las leyes y reglas que te
ha dado. \bibleverse{18} Haz lo que es bueno y correcto ante los ojos
...
\bibleverse{19} Él expulsará a todos tus enemigos delante de ti, tal
como dijo.
...
\bibleverse{20} En el futuro, cuando tus hijos vengan y te pregunten:
``¿Qué sentido tienen los decretos y preceptos que el Señor nuestro Dios
te ordenó seguir?'' \footnote{\textbf{6:20} Éxod 13,14} \bibleverse{21}
...
\bibleverse{22} Ante nuestros ojos el Señor hizo señales y milagros
increíbles y aterradores sobre Egipto, sobre el Faraón y sobre todo su
pueblo. \bibleverse{23} Pero nos sacó de allí para traernos aquí,
dándonos este país que les había prometido a nuestros antepasados.
\bibleverse{24} El Señor nos ordenó que guardáramos todas estas leyes y
que respetáramos al Señor nuestro Dios, para que siempre estuviéramos
seguros y salvos, como lo estamos hoy. \bibleverse{25} Y si observamos
...
\bibleverse{1} El Señor tu Dios te va a conducir a la tierra que estás
...
y fuertes que tú. \footnote{\textbf{7:1} Deut 31,3} \bibleverse{2}
...
\bibleverse{3} No te cases con ellos. No dejes que tus hijas se casen
con sus hijos o que sus hijas se casen con tus hijos, \footnote{\textbf{7:3}
  Éxod 23,32; Éxod 34,15-16} \bibleverse{4} porque alejarán a tus hijos
de mi, para que vayan a adorar a otros dioses. Entonces el Señor se
enfadará contigo y vendrá rápidamente a matarte. \bibleverse{5} Por el
...
ídolos. \bibleverse{6} Porque tú eres el Señor, el pueblo santo de tu
...
valorado por encima de todos los demás pueblos de la tierra. \footnote{\textbf{7:6}
  Éxod 19,5-6} \bibleverse{7} No fue por ser numerosos que el Señor los
amó más que a cualquier otra nación; de hecho, los eligió a pesar de ser
tan pocos. \footnote{\textbf{7:7} Efes 2,8} \bibleverse{8} Pero como el
...
del Faraón, rey de Egipto. \bibleverse{9} Por eso puedes estar seguro de
...
\bibleverse{10} Pero no duda en pagar a los que le odian,
destruyéndolos. \bibleverse{11} Así que guarden los mandamientos,
...
\bibleverse{12} Si escuchas estas preceptos y te preocupas por
...
que les prometió a tus antepasados. \footnote{\textbf{7:12} Éxod
  23,22-31} \bibleverse{13} Él te amará y te bendecirá y te dará muchos
...
tus antepasados. \bibleverse{14} Serás más bendecido que cualquier otra
nación; ninguno de ustedesse quedará sin hijos, y ninguno de sus ganados
dejará de tener crías. \bibleverse{15} El Señor te guardará de toda
...
\bibleverse{16} Destruirás todas las naciones que el Señor tu Dios te
entregue. No las mires con simpatía. No adores a sus dioses, porque eso
terminará siendo una trampa para ti. \bibleverse{17} Podrán pensar:
``Estas naciones son más fuertes que nosotros. ¿Cómo podemos
expulsarlas?'' \footnote{\textbf{7:17} Núm 13,31; Núm 14,1-4}
\bibleverse{18} Pero no les tengan miedo. Asegúrense de recordar lo que
el Señor su Dios hizo con el Faraón y con todo Egipto: \bibleverse{19}
...
las naciones que actualmente temes. \bibleverse{20} Además de esto, el
...
\bibleverse{21} No tengas miedo de estas naciones, porque el Señor tu
Dios, que está contigo, es un Dios poderoso y asombroso. \bibleverse{22}
...
\bibleverse{23} Pero el Señor tu Dios te los entregará y los arrojará en
un terrible pánico, hasta que sean aniquilados. \bibleverse{24} Él te
...
completamente. \bibleverse{25} Debes quemar los ídolos de su dios. No
...
tenga que ver con los ídolos. \bibleverse{26} No traigas ningún ídolo
...
\bibleverse{1} Ten cuidado de seguir todos los mandamientos que te doy
hoy, para que vivas y tengas muchos descendientes, y vayas y te apoderes
del país que el Señor prometió dar a tus antepasados. \bibleverse{2}
...
no. \footnote{\textbf{8:2} Deut 13,4; Jue 2,22} \bibleverse{3} Te
...
palabra que sale de la boca del Señor. \footnote{\textbf{8:3} Éxod
  16,13-15; Mat 4,4} \bibleverse{4} Durante estos cuarenta años tu ropa
no se desgastó y tus pies no se hincharon. \bibleverse{5} Así que debes
...
\bibleverse{6} Por eso debes guardar los mandamientos del Señor tu Dios,
...
\bibleverse{7} Porque el Señor tu Dios te lleva a un buen país. Es una
tierra de arroyos, estanques y manantiales que fluyen por los valles y
bajan por las colinas; \bibleverse{8} Es una tierra que produce trigo,
cebada, vides, higueras, granadas, aceite de oliva y miel.
\bibleverse{9} Es una tierra en la que no se agotan los alimentos, en la
...
\bibleverse{10} Cuando comas y te sacies, dale las gracias al Señor tu
...
\bibleverse{11} Asegúrate de no olvidar al Señor tu Dios desobedeciendo
sus mandamientos y reglas que te doy hoy. \bibleverse{12} Porque cuando
comas y te sacies, cuando construyas casas hermosas para vivir,
\bibleverse{13} y cuando tus rebaños y manadas crezcan, y tu plata y oro
se acumulen, y todas tus posesiones aumenten, \bibleverse{14} entonces
te enorgullecerás y te olvidarás del Señor tu Dios que te sacó de
Egipto, de la prisión, de la casa de la esclavitud. \bibleverse{15} Él
...
una roca de pedernal. \bibleverse{16} Te alimentó en el desierto con
...
\bibleverse{17} Puede que llegues a pensar: ``Me hice rico con todo mi
trabajo''. \bibleverse{18} Pero recuerda que es el Señor su Dios quien
...
\bibleverse{19} Si alguna vez te olvidasdel Señor tu Dios, y vas tras
otros dioses, adorándolos e inclinándote ante ellos, les aseguro ahora
mismo que morirán definitivamente. \bibleverse{20} De la misma manera
...
\bibleverse{1} ¡Escuchen, pueblo de Israel! Dentro de poco van a cruzar
...
llegan hasta el cielo. \bibleverse{2} Los habitantes del paísson fuertes
...
\footnote{\textbf{9:2} Núm 13,32-33} \bibleverse{3} Pero recuerden que
...
\bibleverse{4} Cuando el Señor su Dios los haya expulsado delante de
...
\footnote{\textbf{9:4} Deut 8,17; Gén 15,16} \bibleverse{5} No es porque
...
hizo a tus padres Abraham, Isaac y Jacob. \bibleverse{6} Mejor es que
...
\bibleverse{7} ¡Recuerda cómo provocaste al Señor tu Dios en el
...
\bibleverse{8} En Horeb provocaron al Señor, haciéndolo enojar tanto que
estuvo a punto de destruirlos. \footnote{\textbf{9:8} Éxod 32,-1}
\bibleverse{9} Fue entonces cuando subí a la montaña para recibir las
...
no comí ni bebí nada. \bibleverse{10} El Señor me dio las dos tablas de
...
\bibleverse{11} Después de cuarenta días y cuarenta noches, el Señor me
dio las dos tablas de piedra, las tablas del pacto. \bibleverse{12} El
...
\bibleverse{13} El Señor también me dijo: ``He estado observando a este
pueblo, y son realmente obstinados y duros de corazón. \bibleverse{14}
...
\bibleverse{15} Volví a bajar la montaña mientras aún estaba en llamas,
llevando las dos tablas del pacto. \bibleverse{16} Entonces vi cuánto
...
\bibleverse{17} Tiré las dos tablas al suelo, rompiéndolas en pedazos
mientras ustedes miraban. \bibleverse{18} Luego me acosté en el suelo
...
enfadar. \bibleverse{19} Estaba aterrorizado por lo enojado y furioso
...
\bibleverse{20} El Señor estaba tan enojado con Aarón que estaba listo
para destruirlo, pero en ese momento yo también oré por Aarón.
\bibleverse{21} Tomé esa cosa abominable, el becerro que habían hecho, y
...
\bibleverse{22} Pero siguieron provocando al Señor en Tabera, en Masá y
en Quibrot-hatavá. \bibleverse{23} Cuando el Señor los hizo salir de
...
\bibleverse{24} Se han rebelado contra el Señor desde el día en que los
conocí.
...
\bibleverse{25} Así que me acosté en tierra ante el Señor durante
cuarenta días y cuarenta noches, porque el Señor había amenazado con
destruirlos. \bibleverse{26} Le rogué al Señor diciendo: ``Por favor,
Señor, Dios, no destruyas a tu pueblo que te pertenece, a los que
rescataste y sacaste de Egipto con tu gran poder. \bibleverse{27} Por
favor, recuerda a tus siervos Abraham, Isaac y Jacob. Por favor, ignora
la terquedad de este pueblo y su malvado pecado. \bibleverse{28} Si no
...
\bibleverse{29} ¡Pero ellos son tu pueblo, Señor! ¡Te pertenecen! ¡Los
sacaste de Egipto con tu asombroso poder y fuerza!''

\hypertarget{section-9}{%
\section{10}\label{section-9}}

\bibleverse{1} Después de eso el Señor me dijo: ``Corta dos tablas de
piedra como las primeras, haz un Arca de madera, y ven a mí en la
montaña. \bibleverse{2} Escribiré las mismas palabras en las tablas que
estaban en las primeras, que tú rompiste. Luego las pondré en el Arca''.
\footnote{\textbf{10:2} Éxod 32,19} \bibleverse{3} Hice un Arca de
madera de acacia, corté dos tablas de piedra como las primeras, y subí a
la montaña con ellas. \bibleverse{4} El Señor escribió lo que tenía
...
El Señor me las dio, \bibleverse{5} y yo bajé la montaña y las puse en
el Arca que había hecho siguiendo las instrucciones del Señor. Han
estado allí desde entonces.

\bibleverse{6} Los israelitas fueron de los pozos del pueblo de Yacán a
...
\bibleverse{7} De allí se trasladaron a Gudgoda, y de Gudgoda a Jotbata,
una tierra que tenía muchos arroyos. \bibleverse{8} En este tiempo el
...
\bibleverse{9} Es por eso que la tribu de Leví no tiene derecho a la
...
\bibleverse{10} Permanecí en la montaña cuarenta días y cuarenta noches
...
\bibleverse{11} Entonces el Señor me dijo: ``Prepárate y continúa tu
...
\bibleverse{12} Pueblo de Israel, ¿qué quiere el Señor su Dios de
...
\bibleverse{13} quiere que guarden los mandamientos y preceptos del
Señor que yo les doy hoy para su propio bien. \bibleverse{14} Miren!
Todo pertenece al Señor su Dios: los cielos, los cielos más altos, la
tierra y todo lo que está en ellos. \bibleverse{15} Pero el Señor sintió
...
hasta hoy. \bibleverse{16} Dedíquense a Dios.\footnote{\textbf{10:16}
  ``Dedíquense a Dios'' literalmente, ``circunciden el prepucio de sus
  corazones''.} No sean más tercos ni duros de corazón. \bibleverse{17}
...
acepta sobornos. \bibleverse{18} Se asegura de que los huérfanos y las
viudas reciban justicia, y ama a los extranjeros, proveyéndolos de
comida y ropa. \bibleverse{19} También ustedes deben amar al extranjero
porque ustedes mismos fueron una vez extranjeros en Egipto. \footnote{\textbf{10:19}
  Éxod 22,20-23}

\bibleverse{20} Deben respetar al Señor su Dios y adorarle. Aférrense a
él y hagansus promesas en su nombre. \bibleverse{21} Es a él a quien
...
\bibleverse{22} Cuando sus antepasados fueron a Egipto sólo había
...
\bibleverse{1} Amen al Señor su Dios y obedezcan su palabra, sus normas,
preceptos y mandamientos. \bibleverse{2} Dense cuenta de que son ustedes
...
\bibleverse{3} sí como sus milagros. Vieron lo que hizo con el Faraón,
rey de Egipto, y con todo su país. \bibleverse{4} Vieron lo que le hizo
...
cambiado! \footnote{\textbf{11:4} Éxod 14,25; Éxod 14,27} \bibleverse{5}
Vieron lo que hizo por ustedes en el desierto hasta que llegaron aquí.
\bibleverse{6} Vieron lo que hizo, allí mismo entre ustedes, a Dotán y a
...
\bibleverse{7} Ustedes vieron con sus propios ojos todas las cosas
asombrosas que el Señor ha hecho.

\bibleverse{8} Así que debes cumplir todos los mandamientos que te doy
hoy. De esta manera tendrás la fuerza para entrar y apoderarte del país
que estás cruzando el Jordán para tenerlo como tuyo, \bibleverse{9}
...
\bibleverse{10} El país al que entrarán no es como el país de Egipto del
que vienen. Allí tenían que sembrar tu semilla y trabajar duro, regando
la tierra, como si estuvieran cuidando de un huerto. \bibleverse{11}
Pero en este país que habitarán al cruzar el Jordán es una tierra de
montañas y valles que recibe mucha lluvia. \bibleverse{12} Es una tierra
que el Señor su Dios cuida él mismo. El Señor su Dios siempre la está
cuidando, todo el año. \bibleverse{13} Así que si te dedicas a guardar
...
\bibleverse{14} entonces enviaré lluvia para tu tierra en el momento
adecuado, lluvia en otoño y primavera, para que puedan cosechar el
grano, el vino nuevo y el aceite de oliva. \bibleverse{15} También
proveeré los campos de pasto para tu ganado. Tendrás más que suficiente
para comer. \bibleverse{16} Pero asegúrate de que no dejarte engañar e
ir a adorar e inclinarte ante otros dioses, \bibleverse{17} o el Señor
...
\bibleverse{18} Concentren sus mentes en las palabras que les estoy
diciendo. Amárrenlas en sus manos como recordatorio y pónganlas también
en sus frentes. \footnote{\textbf{11:18} Deut 6,6-9} \bibleverse{19}
Enséñenlas a sus hijos y hablen de ellas cuando estén en casa y al
viajar, cuando se acuesten y cuando se levanten. \bibleverse{20}
Escríbanlas en los postes de sus casas y en sus puertas, \bibleverse{21}
para que mientras dure la tierra, ustedes y sus hijos tengan una larga
vida en el país que el Señor prometió a sus antepasados. \bibleverse{22}
...
aferran a él, \bibleverse{23} entonces el Señor expulsará a todas estas
naciones que están delante de ustedes, y se apoderan del país de las
naciones que son más grandes y más fuertes que ustedes. \bibleverse{24}
...
hasta el mar Mediterráneo. \bibleverse{25} Nadie podrá resistirte; el
Señor tu Dios hará que todos los que viven allí te teman absolutamente,
dondequiera que vayas, tal como te prometió. \bibleverse{26} ¡Miren! Hoy
pongo ante ustedes una bendición y una maldición. \footnote{\textbf{11:26}
  Deut 30,1; Deut 30,15} \bibleverse{27} Recibirán una bendición si
obedecen los mandamientos del Señor su Dios que les doy hoy. \footnote{\textbf{11:27}
  Deut 28,2; Deut 28,15} \bibleverse{28} Pero recibirán una maldición si
...
\bibleverse{29} Cuando el Señor su Dios los lleve al país donde
...
\bibleverse{30} (Estas montañas están al oeste del Jordán, en el país de
los cananeos que viven en el Arabá cerca de Gilgal, junto a los robles
de Moreh). \footnote{\textbf{11:30} Gén 12,6}

\bibleverse{31} Pronto cruzarán el Jordán para entrar y ocupar el país
que el Señor su Dios les da. Cuando lo tomen y se establezcan allí,
\bibleverse{32} asegúrense de seguir todas las reglas y preceptos que
hoy les estoy dando.
...
\bibleverse{1} Estas son las normas y preceptos que debes asegurarte de
seguir todo el tiempo que vivas en la tierra que el Señor, el Dios de
tus antepasados, te ha dado para que la poseas. \bibleverse{2} Debes
...
las colinas y bajo todo árbol verde. \footnote{\textbf{12:2} Deut 7,5;
  Deut 7,25} \bibleverse{3} Derriba sus altares, derriba sus pilares
idólatras, quema sus postes de Asera, y destruye los ídolos de sus
dioses. Eliminaen todas partes cualquier rastro de ellos. \bibleverse{4}
No debes adorar al Señor tu Dios de la manera en que ellos lo hacían.
\bibleverse{5} Sino que debes ir al lugar que el Señor tu Dios elija
entre el territorio de todas tus tribus para establecer un lugar donde
viva contigo. Allí es donde debes ir. \bibleverse{6} Llevarás allí tus
...
los primogénitos de tus rebaños y manadas. \bibleverse{7} Allí es donde,
...
Dios los ha bendecido. \bibleverse{8} No deben hacer lo que estamos
haciendo aquí hoy. En este momento cada uno hace lo que cree correcto,
\bibleverse{9} porque no han llegado a la tierra que les pertenecerá y
que el Señor su Dios les está dando, y donde estarán en paz.
\bibleverse{10} Después de que crucen el Jordán y se establezcan en el
...
\bibleverse{11} entonces el Señor su Dios elegirá un lugar donde vivir
...
\bibleverse{12} Celebrarán allí en presencia del Señor su Dios, ustedes,
...
tierras. \footnote{\textbf{12:12} Núm 18,20; Núm 18,24} \bibleverse{13}
Asegúrense de no presentar sus holocaustos donde quieran.
\bibleverse{14} Sino que los ofrecerás solamente en el lugar que el
Señor elija, en el territorio de una de tus tribus. Allí es donde deben
hacer todo lo que les ordeno.

\bibleverse{15} Por supuesto que puedes sacrificar y comer carne donde
...
\bibleverse{16} pero no deben comer el derramamiento de sangre que hay
en el suelo. \footnote{\textbf{12:16} Lev 3,17} \bibleverse{17} En sus
...
voluntarias o susofrendas especiales. \bibleverse{18} Sino que deben
...
todo lo que hagan, \bibleverse{19} y asegúrense de no olvidarse de los
...
\bibleverse{20} Cuando el Señor su Dios les de más tierra, como
prometió, y desees un poco de carne, y digas: ``Quiero comer carne'',
podrás hacerlo cuando quieras. \bibleverse{21} Si el lugar donde el
...
\bibleverse{22} De hecho, puedes comerlo como si te comieras una gacela
o un ciervo, tanto si estás ceremonialmente limpio como si no, puedes
comerlo. \bibleverse{23} Sólo asegúrate de no comer la sangre, porque la
sangre es la vida, y no debes comer la vida con la carne. \footnote{\textbf{12:23}
  Deut 12,16} \bibleverse{24} No debes comer la sangre; derrámala en el
suelo. \bibleverse{25} No la comas, para que en todo te vaya bien a ti y
a tus hijos, porque harás lo que es correcto ante los ojos del Señor.
\bibleverse{26} Toma tus santos sacrificios y las ofrendas para cumplir
tus votos y ve al lugar que el Señor elija. \bibleverse{27} Presenta tus
...
\bibleverse{28} Cumplan todo lo que yo les mando, para que les vaya bien
...
\bibleverse{29} Cuando el Señor tu Dios destruya las naciones que están
delante de ti cuando entres en el país para poseerlas, y las expulses y
te establezcas en su tierra, \bibleverse{30} asegúrate de no caer en la
...
\bibleverse{31} No debes adorar al Señor tu Dios así, porque cuando
...
\bibleverse{32} on toda dedicación obedezcan todo lo que les ordeno. No
...
\bibleverse{1} Tal vez un profeta o alguien que tiene sueños sobre el
futuro llega y te da una predicción sobre alguna señal o milagro,
\bibleverse{2} y la señal o maravilla ocurre. Si después de eso te
dicen: ``Sigamos a otros dioses que no conoces, y adorémoslos'',
\bibleverse{3} entonces no debes escuchar lo que ese profeta o soñador
dice porque el Señor tu Dios está tratando de probar si realmente lo
amas con toda tu mente y con todo tu ser. \bibleverse{4} Debes seguir al
...
\bibleverse{5} Esta clase de profeta o soñador debe ser ejecutado,
...
\bibleverse{6} Aunque tu propio hermano, o tu hijo o hija, o la esposa
...
\bibleverse{7} los dioses de tus vecinos de la nación pagana, ya sea que
amen de cerca o de lejos en cualquier dirección, \bibleverse{8} no te
rindas a ellos ni los escuches. No les muestres misericordia. No los
perdones ni los protejas. \bibleverse{9} ¡Es absolutamente necesario
matarlos! Empieza a matarlos y luego haz que todos los demás te ayuden.
\bibleverse{10} Apedrea a la persona hasta la muerte por tratar de
alejarte del Señor tu Dios, que te sacó de Egipto, de la prisión de la
esclavitud. \footnote{\textbf{13:10} Deut 17,7} \bibleverse{11} Entonces
...
\bibleverse{12} Puede suceder que una vez que vivas en las ciudades que
el Señor tu Dios te da, oigas \bibleverse{13} que gente malvada se ha
...
\bibleverse{14} Si esto ocurre, hay que hacer una investigación
...
realmente entre ustedes, \bibleverse{15} entonces tienen que matar con
espada al pueblo que vive en esa ciudad. Sepáralos para la destrucción,
tanto a la gente como a su ganado. \bibleverse{16} Deberás amontonar
...
\bibleverse{17} No tomen para ustedes nada de lo que ha sido apartado
...
descendientes como se lo prometió a sus antepasados, \bibleverse{18}
...
\bibleverse{1} Ustedes son los hijos del Señor su Dios. No se mutilen ni
...
\bibleverse{2} porque ustedes son un pueblo santo que pertenece al Señor
su Dios. El Señor loseligiócomo su pueblo especial entre todas las
naciones de la tierra.

\bibleverse{3} No deberán comer nada repulsivo. \bibleverse{4} Estos son
...
\bibleverse{5} ciervos, gacelas, cabras salvajes, antílopes y ovejas de
montaña. \bibleverse{6} Puedes comer cualquier animal que tenga la
pezuña dividida y que también mastique el bolo alimenticio.
\bibleverse{7} Pero no puedes comer de aquellos que, o bien mastican el
...
tienen la pezuña dividida. Debes tratarlos como inmundos. \bibleverse{8}
...
debes comer su carne ni tocar su cuerpo muerto. \bibleverse{9} Cuando se
trata de criaturas que viven en el agua, se permite comer cualquier cosa
que tenga aletas y escamas. \bibleverse{10} Pero no debes comer nada que
no tenga aletas y escamas. Debes tratarlos como inmundos.
\bibleverse{11} Está permitido comer cualquier ave limpia.
\bibleverse{12} Pero no debes comer lo siguiente: águila, buitre
leonado, quebrantahuesos, \bibleverse{13} ratonero, milanos, cualquier
clase de halcón, \bibleverse{14} cualquier miembro de la familia de los
cuervos, \bibleverse{15} cárabo, búho chico, gaviotas, cualquier clase
de halcón, \bibleverse{16} búho pequeño, búho real, lechuza,
\bibleverse{17} búho del desierto, buitre egipcio, búho pescador,
\bibleverse{18} cigüeñas, cualquier clase de garza, abubilla o
murciélago. \bibleverse{19} Todos los insectos que vuelan son inmundos
para ustedes; no deben comerlos. \bibleverse{20} Pero podrán comer
cualquier animal limpio que tenga alas.

\bibleverse{21} No deben comer ningún animal que muera. Puedes dárselo a
...
\bibleverse{22} Asegúrense de pagar un diezmo de cada cosecha que se
produzca cada año en sus campos. \footnote{\textbf{14:22} Lev 27,30}
\bibleverse{23} Debes comer una décima parte de tu grano, vino nuevo y
...
\bibleverse{24} Sin embargo, si está demasiado lejos para llevar todo el
diezmo con el que el Señor tu Dios te ha bendecido, porque el lugar
donde el Señor tu Dios eligió está demasiado lejos, \bibleverse{25}
entonces puedes cambiarlo por dinero, llevar el dinero contigo e ir al
lugar que el Señor tu Dios elegirá. \bibleverse{26} Luego puedes gastar
...
\bibleverse{27} No te olvides de cuidar a los levitas de tu pueblo,
porque no tienen ninguna participación en la asignación de tierras.
\bibleverse{28} Al final de cada tercer año, recoge una décima parte de
todos tus productos de ese año y guárdalos en tu pueblo. \footnote{\textbf{14:28}
  Deut 26,12-15}

\bibleverse{29} De esta manera los levitas (que no tienen ninguna
...
\bibleverse{1} Debes cancelar las deudas al final de cada siete años.
\bibleverse{2} Esta es la forma en que funcionará: Si le diste un
...
sido anunciado. \bibleverse{3} Se te permite cobrarle a un extranjero,
pero debes cancelar lo que te debe tu compañero israelita.
\bibleverse{4} Sin embargo, no debes tener gente pobre entre ti, porque
el Señor te bendecirá de verdad en el país que el Señor tu Dios te da
para que lo poseas. \bibleverse{5} Sólo tienes que asegurarte de que
obedeces al Señor tu Dios, y que te preocupas por seguir todos estos
mandamientos que te doy hoy. \bibleverse{6} El Señor tu Dios te va a
...
\bibleverse{7} Si hay israelitas que son pobres en cualquiera de tus
...
\bibleverse{8} Al contrario. Deben ser generosos con ellos y prestarles
lo que necesiten. \footnote{\textbf{15:8} Luc 6,34-35} \bibleverse{9} No
...
hallado culpable de pecado. \bibleverse{10} Dales una y otra vez, y
hazlo sin enojo. Cuando das generosamente, el Señor tu Dios te bendecirá
en todo tu trabajo y en todo lo que emprendas. \bibleverse{11} Siempre
...
\bibleverse{12} Si un hebreo, uno de tu propio pueblo, sea hombre o
...
tienes que liberarlo en el séptimo año. \footnote{\textbf{15:12} Éxod
  21,2} \bibleverse{13} Y cuando los liberes, no los despidas sin nada.
\bibleverse{14} Dales muchos regalos: animales de tus rebaños, grano de
tu era y vino de tu lagar. Dales tan generosamente como el Señor tu Dios
te ha bendecido. \bibleverse{15} No olviden que una vez fueron esclavos
en Egipto, y el Señor su Dios los liberó. Por eso hoy les doy esta
orden. \bibleverse{16} Sin embargo, si tu esclavo varón te dice: ``No
quiero dejarte'', porque te ama a ti y a tu familia y es mejor que se
quede contigo, \bibleverse{17} entonces usa una herramienta de
metal\footnote{\textbf{15:17} ``Herramienta de metal'', literalmente,
  ``un punzón''.} para perforar su oreja contra la puerta, y será tu
esclavo de por vida. Haz lo mismo con tu esclava. \bibleverse{18} No
...
\bibleverse{19} Debes separarte para darle al Señor tu Dios todos los
...
\footnote{\textbf{15:19} Éxod 13,2} \bibleverse{20} Cada año tú y tu
...
del Señor tu Dios en el lugar que el Señor elija. \footnote{\textbf{15:20}
  Deut 14,23} \bibleverse{21} Sin embargo, si un animal tiene algún
...
\bibleverse{22} Cómanlo en casa. Todos ustedes, tanto si están
...
\bibleverse{23} pero no comeránla sangre derramada en el
...
\bibleverse{1} Debes observar el mes de Abib y celebrar la
...
Abib que el Señor tu Dios te sacó de Egipto por la noche. \footnote{\textbf{16:1}
  Éxod 12,-1} \bibleverse{2} El sacrificio de la Pascua de tu rebaño o
manada debe ser ofrecido al Señor tu Dios en el lugar que el Señor
elija. \bibleverse{3} No comas pan ordinario con él. Durante siete días
...
día en que dejasteis Egipto para el resto de sus vidas. \bibleverse{4}
...
hasta la mañana. \bibleverse{5} No sacrifiquen el animal de la Pascua en
ninguno de los pueblos que el Señor su Dios les da. \bibleverse{6} El
...
dejaste Egipto. \bibleverse{7} Cocínalo y cómelo en el lugar que el
Señor tu Dios elija. Luego por la mañana regresa a tus tiendas.
\bibleverse{8} Coman pan sin levadura durante seis días, y el séptimo
día tendrán una reunión sagrada para honrar al Señor su Dios. No harás
ese día ningún trabajo.

\bibleverse{9} Cuenta siete semanas a partir de la fecha en que
comiences la cosecha de granos. \bibleverse{10} Luego celebra el
...
\bibleverse{11} Celebrarás en presencia del Señor en el lugar que él
...
extranjeros, huérfanos y viudas que hay entre ustedes. \footnote{\textbf{16:11}
  Deut 16,16; Éxod 20,24} \bibleverse{12} No olviden que una vez fueron
esclavos en Egipto, y tengan cuidado de seguir estos preceptos.
\footnote{\textbf{16:12} Deut 5,15}

\bibleverse{13} Celebren la Fiesta de los Refugios durante siete días,
una vez que hayan terminado de trillar el grano y de prensar las uvas.
\bibleverse{14} Disfruten de la fiesta ustedes, sus hijos e hijas, sus
...
los extranjeros, huérfanos y viudas que hay entre ustedes. \footnote{\textbf{16:14}
  Deut 16,11; Deut 26,11} \bibleverse{15} Celebren esta fiesta durante
...
sean realmente felices. \bibleverse{16} Todos tus hombres deben
...
ofrenda. \bibleverse{17} Cada uno de ustedes debe traer cualquier regalo
...
\bibleverse{18} Elijan jueces y oficiales para cada una de sus tribus en
cada pueblo que el Señor su Dios les dé. Deben juzgar a la gente con
justicia. \bibleverse{19} No perviertan la justicia ni muestren
...
y tuerce las palabras de los verdaderos. \footnote{\textbf{16:19} Deut
  1,17} \bibleverse{20} Hagan siempre lo que es justo y recto, para que
...
\bibleverse{21} No pongas nunca un palo de madera de Asera junto al
altar que construyas para el Señor tu Dios, \bibleverse{22} y no te
...
\bibleverse{1} No sacrifiques al Señor tu Dios ganado o una oveja que
...
\bibleverse{2} Puede que exista un informe de que uno de ustedes, ya sea
...
del Señor. \footnote{\textbf{17:2} Deut 13,7-12} \bibleverse{3} Esta
...
-- lo cual yo les he ordenado que no hagan. \footnote{\textbf{17:3} Deut
  4,19} \bibleverse{4} Si escuchas tal informe, necesitas hacer una
investigación completa. Si se descubre que el informe es cierto, y que
se ha cometido un pecado tan terrible en Israel, \bibleverse{5} deben
hacer que el hombre o la mujer que ha cometido este terrible acto sea
sacado del pueblo y apedreado hasta la muerte. \bibleverse{6} Esa
...
\bibleverse{7} Los testigos deben actuar primero en la ejecución de la
...
\bibleverse{8} Si hay un caso ante el tribunal de su ciudad que sea
...
el Señor su Dios elija. \bibleverse{9} Acudan a los sacerdotes, a los
levitas y al juez encargado. Preséntenles el caso y ellos te darán su
decisión. \bibleverse{10} Deben acatar la decisión que les den allí, en
el lugar que el Señor elija. Asegúrense de hacer todo lo queles digan,
\bibleverse{11} de acuerdo con las instrucciones legales que les den y
con el veredicto que dicten. No te desvíes de tal decisión. \footnote{\textbf{17:11}
  Deut 17,20} \bibleverse{12} Todo aquel que trate con desprecio al
sacerdote (que ministra ante el Señor su Dios) o al juez, debe ser
ejecutado. Debes eliminar este mal de Israel. \bibleverse{13} Entonces
...
\bibleverse{14} Una vez que hayas entrado en la tierra que el Señor tu
...
naciones que nos rodean'', \bibleverse{15} puedes tener un rey pero sólo
uno elegido por el Señor tu Dios. Debe ser un israelita. No debes tener
un rey que sea extranjero, alguien que no sea israelita. \bibleverse{16}
...
debes volver allí nunca más''. \footnote{\textbf{17:16} 1Re 10,25; 1Re
  10,28} \bibleverse{17} No debe tener muchas esposas, para que no lo
alejen de seguir al Señor. No debe tener grandes cantidades de plata y
oro. \footnote{\textbf{17:17} 1Re 11,4}

\bibleverse{18} Una vez que sea rey y se siente en su trono real, debe
hacer una copia para sí mismo de estas instrucciones, escribiéndolas en
un pergamino en presencia de los sacerdotes levitas. \bibleverse{19}
...
palabra de estas instrucciones y normas. \bibleverse{20} Entonces no
...
\bibleverse{1} Los sacerdotes levitas, de hecho toda la tribu de Leví,
...
que es lo que tienen derecho a recibir. \footnote{\textbf{18:1} Deut
  10,9; Núm 18,8-20; 1Cor 9,13} \bibleverse{2} Aunque no son dueños de
tierras entre las otras tribus, el Señor cuida de ellos, como lo
prometió. \bibleverse{3} La parte de los sacerdotes del sacrificio de un
...
\bibleverse{4} Darán las primicias de su grano, vino nuevo y aceite de
oliva, así como la primera lana esquilada de su rebaño. \bibleverse{5}
...
ciudad israelita y va al lugar que el Señor elija, \bibleverse{7}
...
\bibleverse{8} Todos ellos recibirán las mismas asignaciones de comida,
...
\bibleverse{9} Una vez que entres en el país que el Señor tu Dios te da,
no copies los modos ofensivos de las naciones allí. \bibleverse{10} No
...
hechicería, \footnote{\textbf{18:10} Lev 18,21; Lev 19,26; Lev 19,31;
  Lev 20,27} \bibleverse{11} que practique brujería, que visite a un
...
\bibleverse{12} Es por estas cosas ofensivas que el Señor tu Dios está
expulsando a las naciones antes que tú. \bibleverse{13} Debes ser
inocente de tales cosas en la presencia del Señor tu Dios. \footnote{\textbf{18:13}
  Gén 6,9; Sal 15,2} \bibleverse{14} Aunque estas naciones, cuya tierra
ocuparán ustedes, escuchen a los magos y adivinos, el Señor su Dios les
prohíbe a ustedes hacer lo mismo. \bibleverse{15} El Señor tu Dios les
enviará un profeta como yo, y será de entre el mismo pueblo. Deben
escucharlo. \bibleverse{16} Recuerden lo que le dijeron al Señor su Dios
...
\bibleverse{17} Entonces el Señor me dijo: ``Tienen razón en lo que
dicen. \footnote{\textbf{18:17} Deut 5,25} \bibleverse{18} Voy a
enviarles un profeta de su pueblo. Le daré mis mensajes y les dirá todo
lo que le ordene. \bibleverse{19} Me haré cargo de todo aquel que no
escuche mi mensaje que el profeta habla en mi nombre. \bibleverse{20}
...
\bibleverse{21} Se preguntarán: ``¿Cómo podemos estar seguros de que un
mensaje no ha venido del Señor?'' \bibleverse{22} Cuando un profeta
...
\bibleverse{1} Después de que el Señor tu Dios haya destruido las
naciones cuya tierra te da, y después de que las hayas expulsado y te
hayas establecido en sus ciudades y casas, \bibleverse{2} entonces debes
elegir tres pueblos santuarios en el país que el Señor tu Dios te da
como posesión. \bibleverse{3} Debes construir caminos a estas ciudades.
...
\bibleverse{4} Esto es lo que sucederá cuando una persona mate
accidentalmente a alguien sin quererlo y corra a uno de estos pueblos
santuarios para salvar su vida. \bibleverse{5} Por ejemplo, si un hombre
...
\bibleverse{6} De lo contrario, el vengador\footnote{\textbf{19:6} Ver
...
hizo sin intención de causar daño alguno. \bibleverse{7} Esta es la
razón por la que doy esta orden de elegir tres ciudades santuario.
\bibleverse{8} Si el Señor tu Dios expande tu territorio, como prometió
a tus antepasados, y te da toda la tierra que te prometió,
\bibleverse{9} y si te preocupas por cumplir todos estos mandamientos
...
\bibleverse{10} De esta manera, la sangre de los inocentes no será
...
perder sus vidas. \bibleverse{11} Por otra parte, si un hombre odia a
alguien, se esconde a la espera, y lo ataca y lo mata, y luego el
asesino corre a una de las ciudades santuario, \bibleverse{12} los
ancianos de su ciudad natal deben mandarlo a buscar, traerlo de vuelta y
entregarlo al vengador para que lo mate. \bibleverse{13} No le muestren
...
\bibleverse{14} No muevas los linderos de tu vecino. Fue colocado allí
...
\bibleverse{15} La evidencia dada por un solo testigo no es suficiente
...
evidencia dada por dos o tres testigos. \footnote{\textbf{19:15} Deut
  17,6; Juan 8,17; 2Cor 13,1} \bibleverse{16} Si alguien acusa
falsamente a otra persona de un delito, \bibleverse{17} ambos implicados
...
\bibleverse{18} Los jueces llevarán a cabo una investigación completa, y
si el acusador resulta ser un mentiroso que ha hecho falsas acusaciones,
\bibleverse{19} entonces debe castigar al acusador de la misma manera en
que ellos quisieron castigar a su víctima. Deben eliminar este mal de
entre ustedes. \bibleverse{20} Entonces el resto del pueblo oirá y
...
semejante. \bibleverse{21} No muestren ninguna misericordia. La regla es
...
\bibleverse{1} Cuando vayas a la guerra con tus enemigos y veas caballos
...
\bibleverse{2} Antes de ir a la batalla, el sacerdote vendrá y hablará
con el ejército. \bibleverse{3} Les dirá: ``¡Escuchen, hombres de
...
\bibleverse{4} Porque el Señor su Dios va con ustedes y luchará por
ustedes contra sus enemigos, y les dará la victoria''.

\bibleverse{5} Los oficiales también hablarán al ejército y les dirán:
...
\bibleverse{6} ¿Hay algún hombre aquí que haya plantado un viñedo y aún
...
\footnote{\textbf{20:6} Deut 28,30; Lev 19,24-25} \bibleverse{7} ¿Hay
...
batalla y otro hombre se casaría con ella''. \footnote{\textbf{20:7}
  Deut 24,5} \bibleverse{8} Los oficiales también deben decir al
...
como a él mismo''. \footnote{\textbf{20:8} Jue 7,3} \bibleverse{9}
...
\bibleverse{10} Cuando se llega a un pueblo, listo para atacarlo,
primero se debe hacer una oferta de paz a las personas que viven allí.
\footnote{\textbf{20:10} Núm 21,21-22} \bibleverse{11} Si aceptan tu
oferta de paz y te abren las puertas, todos los habitantes se
convertirán en tus trabajadores esclavos. \bibleverse{12} Sin embargo,
si se niegan a hacer la paz con ustedes y deciden luchar contra ustedes,
entonces asedien la ciudad. \bibleverse{13} Una vez que el Señor tu Dios
te lo haya entregado, mata a todo varón con la espada. \bibleverse{14}
...
de tus enemigos que el Señor tu Dios te dé. \bibleverse{15} De esta
manera te ocuparás de todos los pueblos que estén lejos de ti y no
pertenezcan a las naciones vecinas. \bibleverse{16} Sin embargo, cuando
...
da para que la ocupes, no dejes nada vivo que respire. \footnote{\textbf{20:16}
  Jos 10,40} \bibleverse{17} Sepáralas para su completa destrucción:
hititas, amorreos, cananeos, ferezeos, heveos y jebuseos, como te ha
ordenado el Señor tu Dios. \footnote{\textbf{20:17} Deut 7,1-2}

\bibleverse{18} Esto es para evitar que te enseñen todas las cosas
ofensivas que hacen al adorar a sus dioses, y al hacerlo te hagan pecar
contra el Señor tu Dios. \bibleverse{19} Ahora bien, cuando sities una
...
también deberías atacar? \bibleverse{20} Sin embargo, puedes destruir
...
\bibleverse{1} Es posible que encuentres a un hombre asesinado, tirado
en un campo en el país que el Señor tu Dios te da, y nadie sabe quién lo
mató. \bibleverse{2} Sus ancianos y jueces deben venir y medir la
distancia del cuerpo a los pueblos de alrededor. \bibleverse{3} Entonces
...
trabajo. \bibleverse{4} Llevarán la vaca a un valle que tenga un arroyo
que lo atraviese y cuya tierra nunca haya sido arada o sembrada. Rómpele
el cuello a la vaca allí, junto al arroyo. \bibleverse{5} Los sacerdotes
...
las disputas legales y los casos de asalto. \footnote{\textbf{21:5} Deut
  17,8-9} \bibleverse{6} Entonces todos los ancianos del pueblo más
cercano al cuerpo deben lavarse las manos en el arroyo sobre la vaca
muerta, diciendo, \footnote{\textbf{21:6} Mat 27,24} \bibleverse{7} ``No
tuvimos nada que ver con este asesinato, y no vimos quién lo hizo.
\bibleverse{8} Señor, por favor perdona a tu pueblo Israel, a quien
rescataste, y no lo hagas culpable de derramar sangre inocente. De esta
manera la culpa por derramar sangre será perdonada''. \bibleverse{9} Así
...
\bibleverse{10} Cuando vayan a la guerra con sus enemigos y el Señor su
Dios los entregue en derrota y los capturen, \bibleverse{11} s posible
que vean que uno de ellos es una mujer hermosa que les gusta y con la
que se quieren casar. \bibleverse{12} Llévenla a casa y hagan que se
afeite la cabeza, que se corte las uñas, \bibleverse{13} y que se
...
\bibleverse{14} Sin embargo, si no eres feliz con ella, debes dejarla ir
...
\bibleverse{15} Si un hombre tiene dos esposas, una que ama y otra que
no, y ambas tienen hijos a su cargo, pero el hijo primogénito es de la
esposa que no ama, \bibleverse{16} cuando llegue el momento de que el
...
esposa que no ama. \bibleverse{17} Sino que debe reconocer al
...
\bibleverse{18} Si alguien tiene un hijo obstinado y rebelde que no
obedece a sus padres y no les obedece ni siquiera cuando está castigado,
\bibleverse{19} sus padres deben llevarlo a los ancianos del pueblo, al
tribunal de su ciudad natal, \bibleverse{20} y decirles: ``Nuestro hijo
es obstinado y rebelde, no nos obedece. ¡Es un borracho inútil!''
\bibleverse{21} Entonces todos los hombres de su pueblo lo apedrearán
...
\bibleverse{22} Si alguien comete un crimen castigado con la muerte, y
la persona es ejecutada colgando de un árbol, \bibleverse{23} no dejes
...
\bibleverse{1} Si ves a la vaca o a la oveja de alguien deambulando por
ahí, no lo ignores. Asegúrate de llevársela a su dueño. \footnote{\textbf{22:1}
  Éxod 23,4} \bibleverse{2} Si su dueño no vive cerca de ti, o si no
sabes quién es, llévate el animal a casa y guárdalo hasta que el dueño
venga a buscarlo, entonces puedes devolverlo. \bibleverse{3} Haz lo
mismo con cualquier otra cosa que encuentres que alguien haya perdido:
un burro, una capa, cualquier cosa. No lo ignores. \bibleverse{4} Si ves
...
\bibleverse{5} Una mujer no debe usar ropa de hombre, y un hombre no
debe usar ropa de mujer. Cualquiera que haga esto ofende al Señor tu
Dios.

\bibleverse{6} Si encuentras un nido de pájaros con pollos o huevos, ya
...
crías. \bibleverse{7} Puedes llevarte a las crías, pero asegúrate de
dejar ir a la madre, para que te vaya bien y tengas una buena y larga
vida. \footnote{\textbf{22:7} Lev 22,28}

\bibleverse{8} Cuando construyas una casa nueva, asegúrate de instalar
una barandilla alrededor del techo, para que no te culpen si alguien
muere al caer de él.

\bibleverse{9} No plantestu viñedo con otro tipo de cultivo. De lo
...
fruto de tu viñedo, deben ser dedicados al Señor.\footnote{\textbf{22:9}
  ``Al Señor'': añadido para mayor claridad.} \bibleverse{10} No se debe
unir un buey y un burro cuando se ara. \bibleverse{11} No uses ropa
hecha de lana y lino tejidas juntas. \footnote{\textbf{22:11} Lev 19,19}

\bibleverse{12} Pon borlas en el dobladillo de la capa que usas para
...
\bibleverse{13} Si un hombre se casa con una mujer y se acuesta con
ella, pero termina odiándola, \bibleverse{14} y la acusa de ser inmoral,
dándole un mal nombre, diciendo: ``Me casé con esta mujer y me acosté
con ella, pero descubrí que no era virgen''. \bibleverse{15} Los padres
de la mujer llevarán la prueba de su virginidad a los ancianos a la
puerta del pueblo, \bibleverse{16} y el padre les explicará: ``Di mi
hija en matrimonio a este hombre, pero él ha acabado odiándola.
\bibleverse{17} Ahora la ha acusado de ser inmoral, diciendo: `Descubrí
...
\bibleverse{18} Entonces los ancianos de esa ciudad tomarán al hombre y
lo castigarán.\footnote{\textbf{22:18} Probablemente por medio de azotes
  en público.} \bibleverse{19} También le multarán con cien siclos de
...
\bibleverse{20} Pero si la acusación es cierta y no hay pruebas de la
virginidad de la mujer, \bibleverse{21} ésta será llevada a la puerta de
...
\bibleverse{22} Si se encuentra a un hombre durmiendo con la mujer de
otro, tanto el hombre como la mujer deben morir. Debes eliminar el mal
de Israel. \footnote{\textbf{22:22} Lev 20,10}

\bibleverse{23} Si un hombre encuentra a una muchacha, una virgen
comprometida con otro hombre, y se acuesta con ella allí en el pueblo,
\bibleverse{24} entonces debes llevarlos a ambos a la puerta del pueblo
...
\bibleverse{25} Sin embargo, si el hombre encuentra por casualidad a una
mujer que está comprometida en el campo, y la ataca y la viola, sólo el
hombre tiene que morir. \bibleverse{26} No le haga nada a la mujer,
...
la asesina). \bibleverse{27} Cuando el hombre violó a la mujer que
estaba comprometida en el campo, ella gritó, pero no había nadie para
rescatarla. \bibleverse{28} Si un hombre encuentra por casualidad a una
virgen no comprometida, y la agarra y la viola, y alguien los ve,
\bibleverse{29} el hombre debe pagar al padre de la mujer cincuenta
siclos de plata, y debe casarse con ella porque la ha avergonzado. No se
le permite divorciarse de ella mientras viva. \bibleverse{30} El hombre
...
\bibleverse{1} Ningún hombre cuyos genitales hayan sido dañados o
cortados puede entrar en el santuario del Señor. \footnote{\textbf{23:1}
  Lev 18,8} \bibleverse{2} A nadie de raza mixta\footnote{\textbf{23:2}
...
décima generación. \bibleverse{3} Ningún amonita o moabita o cualquiera
de sus descendientes puede entrar en el santuario del Señor, hasta la
décima generación. \bibleverse{4} Porque no vinieron a recibiros con
comida y agua en su viaje desde Egipto, y contrataron a Balaam, hijo de
Beor, de Petor en Mesopotamia, para maldeciros. \bibleverse{5} Pero el
...
Dios te ama. \bibleverse{6} No organices un tratado de paz con ellos ni
les ayudes mientras vivas. \bibleverse{7} No desprecies a los edomitas,
porque son tus parientes. Tampoco desprecies a un egipcio, porque
viviste como extranjero en su país. \bibleverse{8} A la tercera
...
\bibleverse{9} Cuando estén en un campamento del ejército durante una
guerra con sus enemigos, asegúrense de evitar todo lo malo.
\bibleverse{10} Cualquier hombre que se vuelva impuro por una liberación
de semen debe abandonar el campamento y permanecer fuera.
\bibleverse{11} Al final del día debe lavarse con agua, y al atardecer
puede volver al campamento. \bibleverse{12} Elija un lugar fuera del
campamento para ser usado como baño. \bibleverse{13} Debe tener una pala
como parte de su equipo para que pueda cavar un agujero, y luego cuando
termine puede cubrir sus excrementos. \bibleverse{14} El Señor tu Dios
...
\bibleverse{15} No envíes a un esclavo de vuelta a su amo si ha venido a
ti en busca de protección. \footnote{\textbf{23:15} Lev 26,12}
\bibleverse{16} Deja que el esclavo viva en tu país donde quiera, en el
pueblo que quiera. No lo maltrates.

\bibleverse{17} Ninguna mujer ni hombre israelita debe ser una
prostituta de culto. \bibleverse{18} No traigas a la casa del Señor tu
...
\bibleverse{19} No le cobres a un compañero israelita intereses por
dinero, comida o cualquier otro tipo de préstamo. \footnote{\textbf{23:19}
  Lev 18,22; Apoc 22,15} \bibleverse{20} Puedes cobrarle intereses a un
...
\bibleverse{21} Si haces una promesa al Señor tu Dios, no tardes en
cumplirla, porque él definitivamente te exigirá que la cumplas y serás
culpable de pecado si no lo haces. \bibleverse{22} Si no haces tales
promesas entonces no serás culpable de pecado. \bibleverse{23} Pero
asegúrate de cumplir lo que le has dicho al Señor tu Dios, porque fuiste
tú quien eligió libremente hacer tal promesa. \bibleverse{24} Cuando
camines por la viña de tu vecino, puedes comer tantas uvas como quieras,
pero no debes recoger ninguna para llevarla contigo. \bibleverse{25}
...
\bibleverse{1} Si un hombre se casa con una mujer, pero no está contento
...
\bibleverse{2} Supongamos que después de salir de su casa, se casa con
otro hombre, \bibleverse{3} y supongamos que el segundo hombre también
termina odiándola, le escribe un certificado de divorcio, se lo da, y la
envía fuera de su casa, o puede que él muera. \bibleverse{4} El primer
...
\bibleverse{5} Si un hombre acaba de casarse, no debe ser enviado a la
...
\bibleverse{6} No aceptes un par de piedras de molino, o incluso sólo
...
\bibleverse{7} Cualquiera que sea sorprendido secuestrando a un
...
\bibleverse{8} Cuando se trata de enfermedades infecciosas de la piel,
...
dado. \footnote{\textbf{24:8} Lev 13,-1; Lev 14,2} \bibleverse{9}
Recuerda lo que el Señor tu Dios le hizo a Miriam en el viaje al salir
de Egipto. \footnote{\textbf{24:9} Núm 12,10-15}

\bibleverse{10} Si le prestas algo a alguien, no entres en su casa para
tomar algún tipo de seguridad. \bibleverse{11} Permanece afuera mientras
ellos entran y te traen la seguridad. \bibleverse{12} Si es un hombre
...
\bibleverse{13} Asegúrate de devolverlo antes de la puesta de sol, para
...
\bibleverse{14} No maltrates a un sirviente asalariado, pobre y
necesitado, sea israelita o extranjero que viva en uno de tus pueblos.
\footnote{\textbf{24:14} Lev 19,13} \bibleverse{15} Paga su salario
...
\bibleverse{16} Los padres no deben ser ejecutados por sus hijos, y los
...
\bibleverse{17} No trates injustamente a los extranjeros o a los
huérfanos; no tomes el manto de viuda como garantía de pago. \footnote{\textbf{24:17}
  Éxod 22,20-21} \bibleverse{18} Recuerden que una vez fueron esclavos
en Egipto, y el Señor su Dios los rescató de ese lugar. Por eso te
ordeno que hagas esto. \footnote{\textbf{24:18} Deut 16,12}

\bibleverse{19} Si cuando estás cosechando en tu campo te olvidas de una
...
que hagas. \footnote{\textbf{24:19} Lev 19,9-10} \bibleverse{20} Cuando
...
\bibleverse{21} Cuando coseches las uvas en tu viñedo, no vuelvas a
repasar las vides. Lo que queda es para los extranjeros, los huérfanos y
las viudas. \bibleverse{22} Recuerden que una vez fueron esclavos en
...
\bibleverse{1} Si hay algún argumento jurídico entre dos personas, deben
acudir a los tribunales para que se juzgue el caso, a fin de justificar
al que tiene razón y condenar al que está equivocado. \bibleverse{2} Si
...
\bibleverse{3} No deben recibir más de cuarenta azotes. Más que eso
sería humillarlos públicamente. \footnote{\textbf{25:3} 2Cor 11,24}

\bibleverse{4} No se debe amordazar a un buey cuando está pisando el
...
\bibleverse{5} Cuando dos hermanos viven cerca uno del otro y uno de
...
\footnote{\textbf{25:5} Rut 4,5; Mat 22,24} \bibleverse{6} El primer
hijo que tenga se llamará como el hermano muerto, para que su nombre no
sea olvidado en Israel.

\bibleverse{7} Sin embargo, si el hombre se niega a casarse con la viuda
...
mí''. \bibleverse{8} Los ancianos del pueblo deben llamarlo y hablar con
él. Si continúa negándose y dice: ``No quiero casarme con ella'',
\bibleverse{9} la viuda de su hermano debe confrontarlo en presencia de
...
nombre de la familia de su hermano''. \bibleverse{10} A partir de
...
\bibleverse{11} Si dos hombres están peleando, y una de sus esposas
interviene para salvar a su marido de ser golpeado, y ella se agarra a
los genitales del atacante, \bibleverse{12} eben cortarle la mano. No le
muestres ninguna piedad.

\bibleverse{13} No tengas dos pesos de medida diferentes en tu bolsa,
uno que sea pesado y otro que sea ligero. \bibleverse{14} No tengas dos
recipientes de medida diferentes en tu casa, uno que sea grande y otro
que sea pequeño. \bibleverse{15} Asegúrate de usar siempre pesos y
medidas exactas y verdaderas. De esa manera tendrás una larga vida en el
país que el Señor tu Dios te ha dado. \bibleverse{16} Cualquiera que no
...
\bibleverse{17} Recuerda lo que te hicieron los amalecitas al salir de
Egipto. \footnote{\textbf{25:17} Éxod 17,8-16}

\bibleverse{18} Salieron a enfrentarse a ti cuando estabas cansado y
cansado de tu viaje, y atacaron a todos aquellos que se estaban quedando
atrás. No tuvieron ningún respeto por Dios. \bibleverse{19} Una vez que
...
\bibleverse{1} Una vez que hayas entrado en el país que el Señor tu Dios
te da, y lo tomes y te establezcas allí, \bibleverse{2} toma algunas de
...
Señor tu Dios elija, \footnote{\textbf{26:2} Éxod 23,19; Éxod 34,26; Lev
  2,14} \bibleverse{3} y dile al sacerdote a cargo en ese momento, ``Hoy
declaro al Señor tu Dios que ahora vivo en el país que el Señor prometió
a nuestros antepasados que nos daría''. \bibleverse{4} El sacerdote te
quitará la cesta y la pondrá delante del altar del Señor tu Dios.
\bibleverse{5} Entonces esto es lo que debes declarar públicamente ante
...
se convirtieron en una nación grande y poderosa. \bibleverse{6} Pero los
egipcios nos trataron muy mal, nos oprimieron y nos obligaron a hacer
trabajos forzados. \bibleverse{7} Clamamos al Señor, el Dios de nuestros
antepasados, y el Señor nos respondió al ver cuánto estábamos sufriendo,
obligados a trabajar tan duro con tanta crueldad. \bibleverse{8} El
Señor nos sacó de Egipto con su gran poder y su increíble fuerza y con
acciones, señales y milagros aterradores. \bibleverse{9} Nos trajo aquí
y nos dio este país, una tierra que fluye leche y miel. \bibleverse{10}
...
ante él. \bibleverse{11} Entonces tú, los levitas y los extranjeros que
...
\bibleverse{12} Cuando terminen de almacenar la décima parte de su
...
suficiente comida en sus ciudades. \footnote{\textbf{26:12} Deut
  14,27-29} \bibleverse{13} Entonces harás esta declaración en presencia
...
he roto ni olvidado tus mandamientos. \bibleverse{14} No he comido nada
...
\bibleverse{15} Por favor, mira desde tu casa en el cielo y bendice a tu
...
\bibleverse{16} Hoy el Señor, tu Dios, te ordena que cumplas estas
preceptos y normas. Asegúrate de seguirlos con toda tu mente y con todo
tu ser. \bibleverse{17} Hoy has declarado públicamente que el Señor es
tu Dios y que seguirás sus caminos, guardarás las reglas y mandamientos
y normas, y obedecerás lo que él diga. \bibleverse{18} Hoy el Señor ha
...
\bibleverse{19} Ha anunciado que les dará mayor alabanza, reputación y
...
\bibleverse{1} Moisés y los ancianos israelitas de Israel le dieron
...
\bibleverse{2} El día que cruces el Jordán hacia el país que el Señor tu
Dios te da, coloca unas grandes piedras y píntalas con cal.
\bibleverse{3} Entonces escribe todas estas leyes en ellas una vez que
...
antepasados, te lo prometió. \bibleverse{4} Una vez que hayas cruzado el
Jordán, debes colocar estas piedras en el Monte Ebal, habiéndolas
pintado con cal, como te he ordenado hacer hoy. \bibleverse{5} Construye
...
\bibleverse{6} Construye el altar del Señor tu Dios con piedras sin
cortar y sacrifícalo con holocaustos para el Señor tu Dios.
\bibleverse{7} Ahí es también donde debes sacrificar y comer tus
...
\bibleverse{8} Escribe todas estas leyes claramente en las piedras.
...
\bibleverse{9} Moisés y los sacerdotes levitas les dieron estas órdenes
a todos los israelitas: ``¡Cállense, pueblo de Israel, y escuchen! Hoy
se han convertido en el pueblo del Señor su Dios. \bibleverse{10} Así
que obedezcan lo que el Señor su Dios les dice, y sigan los mandamientos
y preceptos que les doy hoy''.

\bibleverse{11} Ese día Moisés dio estas órdenes al pueblo:
\bibleverse{12} Después de haber cruzado el Jordán, las siguientes
...
\bibleverse{13} Las siguientes tribus se pararán en el Monte Ebal para
la maldición: Rubén, Gad, Aser, Zabulón, Dan y Neftalí. \bibleverse{14}
...
\bibleverse{15} ``Maldito sea el que fabrique una imagen tallada o un
ídolo de metal y le adore en secreto. ¡No es sino un objeto hecho por
hombres, y es ofensivo para el Señor!'' Todos dicen: ``¡Amén!''

\bibleverse{16} ``¡Maldito sea el que deshonre a su padre o a su
madre''. Todos dicen: ``¡Amén!'' \footnote{\textbf{27:16} Éxod 21,17}

\bibleverse{17} ``¡Maldito sea el que mueva los linderos de su vecino!''
Todos dicen: ``¡Amén!'' \footnote{\textbf{27:17} Deut 19,14}

\bibleverse{18} ``¡Maldito sea el que permita a un ciego deambular por
el camino!'' Todos dicen: ``¡Amén!'' \footnote{\textbf{27:18} Lev 19,14}

\bibleverse{19} ``¡Maldito sea el que no trate bien a los extranjeros, a
los huérfanos y a las viudas!'' Todos dicen: ``¡Amén!'' \footnote{\textbf{27:19}
  Éxod 22,20-21}

\bibleverse{20} ``¡Maldito sea el que se acueste con la mujer de su
padre, porque habrá deshonrado a su padre!'' Todos dicen: ``¡Amén!''
\footnote{\textbf{27:20} Lev 18,8}

\bibleverse{21} ``¡Maldito sea el que se acueste con cualquier animal!''
Todos dicen: ``¡Amén!'' \footnote{\textbf{27:21} Éxod 22,18}

\bibleverse{22} ``¡Maldito sea el hombre que se acueste con su hermana,
la hija de su padre o la hija de su madre!'' Todos dicen: ``¡Amén!''
\footnote{\textbf{27:22} Lev 18,9; Lev 18,11}

\bibleverse{23} ``¡Maldito sea el hombre que se acueste con su suegra!''
Todos dicen: ``¡Amén!'' \footnote{\textbf{27:23} Lev 18,17}

\bibleverse{24} ``¡Maldito sea el que ataque en secreto a su prójimo!''
Todos dicen: ``¡Amén!'' \footnote{\textbf{27:24} Núm 35,20}

\bibleverse{25} ``¡Maldito sea el que acepte un soborno para matar a un
inocente!'' Todos dicen: ``¡Amén!'' \footnote{\textbf{27:25} Deut 16,19;
  Éxod 23,8}

\bibleverse{26} ``¡Maldito sea el que no obedezca cuidadosamente todas
...
\bibleverse{1} Si realmente obedeces lo que el Señor tu Dios te dice, y
...
\footnote{\textbf{28:1} Deut 26,19} \bibleverse{2} Tendrás todas las
siguientes bendiciones y aún más, si haces lo que el Señor tu Dios dice.
\bibleverse{3} Serás bendecido cuando estés en la ciudad; serás
bendecido cuando estés en el campo. \bibleverse{4} Serás bendecido con
...
corderos. \bibleverse{5} Serás bendecido con mucho pan.\footnote{\textbf{28:5}
  Literalmente, ``tu cesta y tu bol de amasar serán bendecidos''. De
  manera similar, lo opuesto en el versículo 17.} \bibleverse{6} Serás
bendecido dondequiera que vayas y en todo lo que hagas. \footnote{\textbf{28:6}
  Sal 121,8} \bibleverse{7} El Señor derrotará a los enemigos que vengan
a atacarte. Vendrán a ti desde una dirección, pero se dispersarán por
siete caminos diferentes. \bibleverse{8} El Señor bendecirá tu
...
el país que te está dando. \bibleverse{9} El Señor te hará su pueblo
...
\bibleverse{10} Entonces todos en la tierra verán que el Señor te ha
elegido para ser suyo,\footnote{\textbf{28:10} Literalmente, ``llamado
  por el nombre del Señor''.} y tendrán miedo de ti. \bibleverse{11} El
...
que el Señor prometió a tus antepasados que te daría. \bibleverse{12} El
...
de ellas. \bibleverse{13} El Señor te pondrá en el primer lugar, no en
...
\bibleverse{14} No te desvíes hoy de ninguna de mis instrucciones. No
...
\bibleverse{15} Pero si no obedeces al Señor tu Dios siguiendo
...
\footnote{\textbf{28:15} Dan 9,11} \bibleverse{16} Serás maldito cuando
estés en la ciudad; serás maldito cuando estés en el campo.
\bibleverse{17} Serás malditoal no tener pan. \bibleverse{18} Serás
malditosin poder tener hijos, ni buenas cosechas, ni tus vacas tendrán
terneros ni tus ovejas tendrán corderos. \bibleverse{19} Serásmaldito
dondequiera que vayas y en todo lo que hagas. \bibleverse{20} El Señor
...
hecho al abandonarlo.\footnote{\textbf{28:20} ``Abandonarlo'': Hebreo
  ``abandonarme''.} \bibleverse{21} El Señor te dará enfermedades
infecciosas hasta que te haya borrado del país en el que estás entrando.
\bibleverse{22} Entonces el Señor te golpeará con una enfermedad que te
...
plaga y el moho. Estos te atacarán hasta que mueras. \footnote{\textbf{28:22}
  1Re 17,7} \bibleverse{23} El cielo sobre ti será como el bronce, y la
tierra debajo de ti será como el hierro. \footnote{\textbf{28:23} Deut
  11,17} \bibleverse{24} El Señor cambiará la lluvia de tu tierra en
polvo y arena; caerá del cielo sobre ti hasta que seas destruido.
\bibleverse{25} El Señor hará que tus enemigos te derroten. Los atacarás
...
\bibleverse{26} Tu cadáver será alimento para las aves de rapiña y los
animales salvajes, y no habrá nadie que los espante. \bibleverse{27} El
...
costras y sarpullidos que no se pueden curar. \footnote{\textbf{28:27}
  Éxod 9,9} \bibleverse{28} El Señor te volverá loco y te hará quedar
ciego y confundido, \bibleverse{29} de modo que incluso al mediodía
estarás a tientas como un ciego en la oscuridad. No tendrás éxito en lo
que hagas. Serás perseguido y te robarán todo el tiempo, y nadie vendrá
a salvarte. \bibleverse{30} Te comprometerás a casarte con una mujer,
...
cosecha. \bibleverse{31} Tu buey será sacrificado delante de ti, pero no
...
\bibleverse{32} Tus hijos e hijas serán llevados como esclavos a otras
naciones mientras tú miras, y te desgastarás llorando por ellos, pero no
habrá nada que puedas hacer al respecto. \bibleverse{33} Una nación
...
\footnote{\textbf{28:33} Jue 6,3} \bibleverse{34} Lo que
veasteenloquecerá. \bibleverse{35} El Señor te causará forúnculos
dolorosos que no se pueden curar en tus rodillas y muslos, de hecho, de
la cabeza a los pies. \bibleverse{36} El Señor te desterrará a ti y a tu
...
hechos de madera y piedra. \bibleverse{37} Lucirás comoun espanto para
todas las naciones donde has sido exiliado por el Señor. Se reirán de ti
y te ridiculizarán. \footnote{\textbf{28:37} 1Re 9,7} \bibleverse{38}
...
\bibleverse{39} Sembrarás y cuidarás los viñedos, pero no cosecharás las
uvas ni beberás el vino, porque serán comidos por los gusanos.
\bibleverse{40} Tendrás olivos por todo el país pero no tendrás aceite
de oliva para usar,\footnote{\textbf{28:40} ``Usar'': literalmente,
  ``ungir'', el proceso de aplicar aceite de oliva en la piel.} porque
las aceitunas se caerán pronto de los árboles. \bibleverse{41} Tendrás
hijos e hijas, pero no los tendrás por mucho tiempo, porque serán
llevados en cautiverio como esclavos. \bibleverse{42} Nubes de langostas
destruirán todos tus árboles y cultivos. \bibleverse{43} Los extranjeros
que vivan con ustedes se elevarán cada vez más por encima de ustedes,
mientras que ustedes se hundirán cada vez más. \bibleverse{44} Ellos te
...
\bibleverse{45} Todas estas maldiciones caerán sobre ti. Te perseguirán
y atacarán hasta que mueras porque no has obedecido al Señor tu Dios y
no has guardado los mandamientos y preceptos que te dio. \bibleverse{46}
...
\bibleverse{47} Por no haber servido al Señor tu Dios con alegría y con
una actitud alegre, \bibleverse{48} servirás a tus enemigos que el Señor
envía a atacarte con hambre, sed, desnudez y pobreza. Él atará un yugo
de hierro en tu cuello hasta destruirte. \bibleverse{49} El Señor traerá
...
entenderás. \bibleverse{50} Son una nación despiadada que no respeta a
los viejos y no tiene piedad de los jóvenes. \footnote{\textbf{28:50}
  Dan 8,23; Lam 5,12} \bibleverse{51} Se comerán tus corderos y terneros
...
corderos de tus rebaños, así que morirás de hambre. \bibleverse{52}
...
tu país que el Señor tu Dios te ha dado. \bibleverse{53} Terminarás
...
enemigo. \bibleverse{54} El hombre más bondadoso y sensible de entre
ustedes se negará a compartir su comida con su hermano, con la mujer que
ama y con los hijos que le quedan. \bibleverse{55} Se negará a compartir
...
su enemigo les ha causado en todos sus pueblos. \bibleverse{56} La mujer
...
hija. \bibleverse{57} Incluso se comerá en secreto al bebés que dé a luz
y la placenta, ya que no tiene nada más por el asedio y el sufrimiento
que su enemigo les ha causado en todos sus pueblos, \bibleverse{58} Si
...
\bibleverse{59} él traerá sobre ti y tus descendientes desastres
increíbles, enfermedades intensas y duraderas, y enfermedades terribles
e incurables. \bibleverse{60} Él hará caer sobre ti las enfermedades que
te aterrorizaban en Egipto, y se quedarán contigo. \footnote{\textbf{28:60}
  Deut 28,27} \bibleverse{61} El Señor también lescausará todas las
enfermedades y dolencias, incluso las que no están registradas en este
Libro de la Ley, hasta que seas destruido. \bibleverse{62} Ustedes, que
...
dijo. \bibleverse{63} De la misma manera que quiso hacerlos prósperos y
...
\bibleverse{64} El Señor los esparcirá entre las naciones de toda la
...
\bibleverse{65} No encontrarán ningún lugar para descansar entre esas
naciones, ningún lugar propio. El Señor los pondrá ansiosos, con la
vista fallida y la mente llena de desesperación. \bibleverse{66} Verán
su vida pendiendo de un hilo mientras dudan. Tendrán miedo de día y de
noche, aterrorizados de no sobrevivir. \bibleverse{67} Por la mañana
...
\bibleverse{68} El Señor los enviará de vuelta a Egipto en barcos, a un
...
\bibleverse{1} Los siguientes son los términos del acuerdo que el Señor
...
adición al acuerdo que había hecho con ellos en Horeb.\footnote{\textbf{29:1}
  ...
  Éxod 19,4} \bibleverse{2} Moisés convocó a todos los israelitas y les
...
\bibleverse{3} Vieron con sus propios ojos las pruebas asombrosas, y las
grandes señales y milagros. \footnote{\textbf{29:3} Deut 5,26; Is 6,9-10}
\bibleverse{4} Pero hasta ahora el Señor no les ha dado mentes que
entiendan, ni ojos que vean, ni oídos que oigan, diciendo: \footnote{\textbf{29:4}
  Deut 8,2; Deut 8,4} \bibleverse{5} Durante cuarenta años los conduje
por el desierto, pero sus vestidos y sandalias no se desgastaron.
\bibleverse{6} No tenían pan para comer, ni vino o alcohol para beber,
para que se dieran cuenta de que yo soy el Señor tu Dios. \footnote{\textbf{29:6}
  Núm 21,21-35} \bibleverse{7} Cuando llegamos aquí, Sehón, rey de
Hesbón, y Og, rey de Basán, salieron a luchar contra nosotros en la
batalla, pero los vencimos. \footnote{\textbf{29:7} Núm 32,-1}
\bibleverse{8} Tomamos su tierra y se la dimos a las tribus de Rubén,
Gad y a la media tribu de Manasés para que la posean. \bibleverse{9} Así
...
\bibleverse{10} Todos ustedes están hoy aquí ante el Señor su Dios: los
jefes de las tribus, los oficiales y todos los hombres de Israel,
\bibleverse{11} us hijos y esposas y los extranjeros en sus campamentos
que cortan la leña y acarrean el agua. \bibleverse{12} Están aquí para
que puedanentrar a hacer parte del pacto del Señor su Dios, que hoy hace
con ustedes, y para aceptar su solemne promesa; \bibleverse{13} para que
...
\footnote{\textbf{29:13} Deut 5,3} \bibleverse{14} No es sólo con
ustedes que el Señor está haciendo este acuerdo y promesa solemne,
\bibleverse{15} o es solo con los que están aquí con nosotros hoy en la
...
\bibleverse{16} Ustedes saben muy bien cómo era cuando vivíamos en la
tierra de Egipto y nuestras experiencias al pasar por las naciones en el
camino hacia aquí. \bibleverse{17} Vieron sus repugnantes prácticas
religiosas y sus ídolos de madera y piedra, y plata y oro.
\bibleverse{18} Hoy deben asegurarse de que no haya ningún hombre o
...
eso entre ustedes que produzca tal veneno y amargura. \bibleverse{19}
...
\bibleverse{20} El Señor nunca querría perdonarlos. De hecho, su
...
\bibleverse{21} y los castigará como un ejemplo de ellos para todas las
tribus israelitas, de acuerdo con todas las maldiciones del acuerdo
escrito en este Libro de la Ley.

\bibleverse{22} Las generaciones posteriores, sus descendientes y los
extranjeros de lejos, verán cómo el Señor ha traído el desastre al país
y lo ha devastado. \bibleverse{23} Todo el país será un páramo ardiente
...
\bibleverse{1} Un día después de que experimenten todo esto, las
...
exiliado. \bibleverse{2} Cuando eso suceda, y cuando tú y tus hijos
...
entonces el Señor tu Dios será misericordioso contigo. \footnote{\textbf{30:2}
  Lev 26,40} \bibleverse{3} Él te traerá de vuelta a casa, reuniéndote
de todas las naciones donde te dispersó. \footnote{\textbf{30:3} Jer
  29,14; Am 9,14; Jer 32,37} \bibleverse{4} Aunque te exiliases hasta
los confines de la tierra, te recogerá de allí y te traerá de vuelta.
\bibleverse{5} El Señor tu Dios te traerá de vuelta al país que
...
\bibleverse{6} El Señor tu Dios te hará a ti y a tus descendientes suyos
...
tu mente y con todo tu ser, para que vivas. \footnote{\textbf{30:6} Deut
  10,16; Jer 4,4; Ezeq 11,19; Rom 2,29; Col 2,11} \bibleverse{7}
Entonces el Señor tu Dios hará caer todas estas maldiciones sobre tus
enemigos, sobre aquellos que te odian y persiguen. \bibleverse{8} Una
vez más harás lo que el Señor te diga y seguirás todos sus mandamientos
que te doy hoy. \bibleverse{9} El Señor tu Dios te hará triunfar en todo
...
hizo con tus antepasados, \bibleverse{10} si obedeces al Señor tu Dios
...
\bibleverse{11} La instrucción que les doy hoy no es demasiado difícil
de seguir para ustedes. No es que esté tan lejos que te sea imposible
alcanzarla. \bibleverse{12} No está en el cielo como para preguntarte:
``¿Quién va a subir al cielo a conseguirla para nosotros y hacernos
saber lo que dice para que podamos obedecerla?'' \bibleverse{13} No está
...
saber lo que dice para que podamos obedecerla?'' \bibleverse{14} Sino
...
\bibleverse{15} ¡Escuchen! Hoy he puesto una elección ante ustedes: la
vida y lo que es bueno, o la muerte y lo que es malo. \footnote{\textbf{30:15}
  Deut 11,26; Deut 28,2; Deut 2,15} \bibleverse{16} Yo les exhorto para
...
entrando y que les pertenecerá. \bibleverse{17} Si no haces caso de esto
y te niegas a escuchar, si te sientes atraído a inclinarte ante otros
dioses y adorarlos, \bibleverse{18} entonces les advierto ahora mismo
que definitivamente morirán. No vivirán mucho tiempo en el país que van
a poseer después de cruzar el Jordán. \bibleverse{19} Soy invoco al
...
\bibleverse{20} para que amen al Señor su Dios, le obedezcan y se
...
\bibleverse{1} Cuando Moisés terminó\footnote{\textbf{31:1} Tomado de
  los Rollos del Mar Muerto y de la Septuaginta.} de darles estas
instrucciones a todos los israelitas, \bibleverse{2} les dijo, ahora
tengo ciento veinte años. No puedo moverme como antes, y el Señor me ha
dicho, ``No deben cruzar el Jordán''. \bibleverse{3} El Señor tu Dios en
...
como dijo el Señor. \footnote{\textbf{31:3} Deut 3,28} \bibleverse{4} El
...
amorreos, y su tierra cuando los destruyó. \footnote{\textbf{31:4} Núm
  21,21-35} \bibleverse{5} El Señor se los entregará, y harán con ellos
exactamente como se los he dicho. \footnote{\textbf{31:5} Deut 7,2}
\bibleverse{6} ¡Sean fuertes! Sean valientes! No tengan miedo ni terror,
porque el Señor su Dios irá con ustedes. No los dejará ni los abandonará
nunca.

\bibleverse{7} Moisés llamó a Josué y le dijo delante de todos los
...
como propio. \bibleverse{8} El Señor mismo va delante de ti. Él estará
...
\bibleverse{9} Moisés escribió esta ley y la dio a los sacerdotes, los
hijos de Leví, que llevaban el Arca del pacto del Señor, y a todos los
ancianos israelitas. \bibleverse{10} Moses les dio estas órdenes: ``Cada
siete años, el año en que se cancelan las deudas durante la Fiesta de
los Tabernáculos, \footnote{\textbf{31:10} Deut 15,1} \bibleverse{11} y
...
\bibleverse{12} ``Haz que el pueblo se reúna -- hombres, mujeres, niños
...
instrucciones de esta ley. \bibleverse{13} Entonces sus hijos que no
...
\bibleverse{14} Entonces el Señor le dijo a Moisés: ``Escucha, pronto
...
\bibleverse{15} El Señor se apareció allí en la tienda en una columna de
nube. La nube estaba a la entrada de la tienda. \bibleverse{16} El Señor
...
ellos. \bibleverse{17} Entonces los abandonaré y me alejaré de ellos,
...
porque nuestro Dios nos ha abandonado!' \bibleverse{18} ``Entonces
...
\bibleverse{19} ``Así que escribe esta canción y enséñasela a los
israelitas. Ayúdalos a aprender a cantarla, así tendré pruebas contra
ellos. \footnote{\textbf{31:19} Deut 32,-1} \bibleverse{20} Una vez que
...
acuerdo. \footnote{\textbf{31:20} Deut 32,15} \bibleverse{21} Una vez
...
\bibleverse{22} Entonces Moisés escribió esta canción y se la enseñó a
los israelitas.

\bibleverse{23} Entonces el Señor designó a Josué hijo de Nun como
...
\bibleverse{24} Cuando Moisés terminó de escribir esta Ley en un libro
de principio a fin, \bibleverse{25} ordenó a los levitas que llevaban el
Arca del Acuerdo del Señor: \bibleverse{26} ``Pongan este libro de la
Ley junto al Arca del Pacto del Señor su Dios, para que se guarde allí
como testimonio contra ustedes. \bibleverse{27} Sé lo obstinado y
...
\bibleverse{28} ``Convoca a todos los ancianos de tus tribus y a todos
...
ellos. \bibleverse{29} Sé que después de mi muerte se volverán
...
\bibleverse{30} Entonces Moisés recitó todas las palabras de esta
...
\bibleverse{1} Cielo, escucha mientras hablo; Tierra, escucha lo que
digo. \footnote{\textbf{32:1} Deut 31,28; Is 1,2} \bibleverse{2} Que mi
...
como lluvias primaverales sobre las plantas en crecimiento. \footnote{\textbf{32:2}
  Is 55,10-11} \bibleverse{3} Alabaré el carácter del Señor. ¡Que todo
el mundo sepa de su grandeza! \bibleverse{4} Él es la Roca. Todo lo que
hace es perfecto, porque todos sus caminos son correctos. Él es el Dios
confiable que nunca es injusto; es justo y honesto. \bibleverse{5} Sus
...
\footnote{\textbf{32:5} Is 1,2-4} \bibleverse{6} ¿Es esta la manera de
...
\bibleverse{8} El Altísimo les dio a las naciones sus tierras cuando
...
\bibleverse{9} Pero el pueblo del Señor es suyo, Israel es su elegido.
\bibleverse{10} Los encontró en una tierra desértica, en un páramo
...
persona que más amaba.\footnote{\textbf{32:10} ``La persona que más
  ...
  17,8; Zac 2,12} \bibleverse{11} Como un águila que vigila\footnote{\textbf{32:11}
...
alas, te recogió y te llevó consigo.\footnote{\textbf{32:11} ``Te llevó
  ...
  Sal 36,8; Éxod 19,4} \bibleverse{12} El Señor fue el único que te
guió; ningún dios extranjero estaba con él. \bibleverse{13} El Señor te
...
\footnote{\textbf{32:13} Sal 81,17} \bibleverse{14} Con yogur del rebaño
...
uvas. \bibleverse{15} Pero Israel,\footnote{\textbf{32:15} Literalmente,
  ``Jesurún'', que significa: ``el bueno''.} te engordaste y te
rebelaste: con grasa, sobrepeso y llenura de comida. Abandonaste al Dios
que te hizo y despreciaste la Roca de tu salvación. \bibleverse{16}
Celebraste al Señor adorando a dioses extranjeros; lo enojaste con
prácticas tan repugnantes. \bibleverse{17} Ofreciste sacrificios a los
demonios en lugar de a Dios, a dioses que no conocías, a nuevos dioses
que tus antepasados no adoraban. \bibleverse{18} Abandonaste a la Roca
que te engendró; olvidaste al Dios que te dio a luz. \bibleverse{19} El
Señor los rechazó cuando vio esto; sus hijos e hijas lo enojaron.
\bibleverse{20} Dijo: Me apartaré de ellos. ¡Entonces veré qué les pasa!
Son un pueblo perverso, hijos infieles. \bibleverse{21} Me han dado
...
\footnote{\textbf{32:21} Jer 2,11; Rom 10,19} \bibleverse{22} Mi ira se
...
que produce, incluso prendiendo fuego a los cimientos de las montañas.
\bibleverse{23} Amontonaré desastres sobre ellos; usaré mis flechas para
dispararles. \bibleverse{24} Se consumirán por el hambre, destruidos por
...
deslizan por el suelo. \bibleverse{25} Afuera en las calles la espada
mata a sus hijos, dentro de sus casas, mueren de miedo; jóvenes y
mujeres jóvenes, niños y ancianos. \bibleverse{26} Les habría dicho que
iba a cortarlos en pedazos y borrar incluso su memoria; \bibleverse{27}
...
propia cuenta, el Señor no tuvo nada que ver''. \bibleverse{28} Israel
es una nación que no piensa con claridad; ninguno de ellos entiende
nada. \footnote{\textbf{32:28} Is 27,11; Jer 4,22} \bibleverse{29} Cómo
me gustaría que fueran sabios, para que pudieran entenderlo; así
reconocerían cuál puede ser su fin! \bibleverse{30} ¿Cómo podría un
...
\bibleverse{31} La roca en la que confían no es como nuestra Roca, como
incluso nuestros enemigos admiten.\footnote{\textbf{32:31} Tomado de la
  Septuaginta.} \bibleverse{32} Pero su vid proviene de la vid de
Sodoma, de los campos de Gomorra. Sus uvas son venenosas; son racimos
amargos. \footnote{\textbf{32:32} Is 1,10} \bibleverse{33} Su vino es el
veneno de las serpientes, el veneno de las serpientes mortales.
\bibleverse{34} He guardado todo esto; está sellado en mis bóvedas.
\bibleverse{35} Me aseguro de que se haga justicia, lo pagaré. Se acerca
...
\bibleverse{36} El Señor va a reivindicar a su pueblo; será
...
que todos se han ido, ya sean esclavos o libres. \footnote{\textbf{32:36}
  1Re 14,10} \bibleverse{37} Preguntará: ¿Qué pasó con tus dioses, la
roca a la que acudiste para protegerte? \bibleverse{38} ¿Quién comió la
...
vengan a ayudarte! ¡Haz que vengan a protegerte! \footnote{\textbf{32:38}
  Jue 10,14} \bibleverse{39} ¡Escuchen! ¡Yo soy el único Dios! ¡No hay
...
\bibleverse{40} Levanto mi mano al cielo y declaro solemnemente sobre mi
vida eterna, \footnote{\textbf{32:40} Éxod 6,8; Ezeq 33,11}
\bibleverse{41} Cuando afile mi brillante espada y la recoja para
ejecutar el juicio, pagaré a mis enemigos y castigaré a los que me odian
como se merecen. \bibleverse{42} Mis flechas se emborracharán de sangre,
como mi espada come carne; la sangre de los muertos y capturados, las
cabezas de los líderes del enemigo. \bibleverse{43} ¡Celebren con él!
...
\bibleverse{44} Entonces Moisés vino con Josué hijo de Nun y recitó
todas las palabras de esta canción para que el pueblo la escuchara.
\bibleverse{45} Después de que Moisés terminó de recitar toda la canción
a todos los israelitas, \bibleverse{46} les dijo: ``Piensen en todas
...
hijos a seguir cuidadosamente todo lo que está en esta ley. \footnote{\textbf{32:46}
  Deut 6,7} \bibleverse{47} No traten estas palabras como triviales
...
\bibleverse{48} Ese mismo día el Señor le dijo a Moisés: \bibleverse{49}
...
\bibleverse{50} ``Allí, en el monte que has subido, morirás y te unirás
...
en el monte Hor y se unió a su pueblo. \footnote{\textbf{32:50} Núm
  20,23-29} \bibleverse{51} ``Porque allí, en las aguas de Meribá-Cades,
...
presencia. \footnote{\textbf{32:51} Núm 20,12-13} \bibleverse{52} Aunque
...
\bibleverse{1} La siguiente es la bendición que Moisés, el hombre de
Dios, les dio a los israelitas antes de morir. \footnote{\textbf{33:1}
  Gén 49,-1} \bibleverse{2} Dijo: El Señor vino del monte Sinaí y nos
...
\bibleverse{3} Cuánto amas al pueblo; tienes a todos los santos en tu
mano. Se sientan a tus pies para escuchar tus palabras: \bibleverse{4}
la ley que Moisés nos entregó y que pertenece a todos los israelitas.
\bibleverse{5} El Señor se convirtió en el Rey en Israel\footnote{\textbf{33:5}
...
\bibleverse{6} A Rubén le dijo: ``Que viva y no muera, pero que sólo
tenga unos pocos hombres''.

\bibleverse{7} A Judá le dijo: ``Señor, por favor escucha el clamor de
Judá y reúnelo con su pueblo. Aunque él luche por sí mismo, ayúdalo
contra sus enemigos''.

\bibleverse{8} A Leví le dijo: ``Tu Tumim le fue dado a Leví y tu Urim a
los consagrados a Dios, los que probaste en Masá y con los cuales
discutiste en las aguas de Meribá. \bibleverse{9} Leví dijo que no
...
\bibleverse{10} Ellos le enseñarán tu reglamento a Jacob y tu ley a
Israel. Pondrán incienso ante ti y sacrificarán holocaustos enteros en
tu altar. \bibleverse{11} Señor, por favor bendice lo que tienen y
acepta su servicio para ti. Destruye a los que los atacan; asegúrate de
que sus enemigos no se levanten nunca más''.

\bibleverse{12} A Benjamín le dijo: ``Que el que ama el Señor se
mantenga seguro y a salvo en el Señor. El Señor siempre lo protege,
dejándolo descansar sobre sus hombros''.

\bibleverse{13} A José le dijo: ``Que el Señor bendiga su tierra con los
mejores regalos del cielo, con el rocío y el agua de las profundidades
de abajo; \bibleverse{14} con las mejores cosechas maduradas por el sol
y los mejores productos de las estaciones; \bibleverse{15} con las
mejores contribuciones de las antiguas montañas y los mejores materiales
de las colinas eternas; \bibleverse{16} con los mejores regalos de la
...
\bibleverse{17} Es tan majestuoso como un toro primogénito; sus cuernos
...
\bibleverse{18} A Zabulón le dijo: ``Que celebre Zabulón en sus viajes e
Isacar en sus tiendas. \bibleverse{19} Convocarán a los
...
\bibleverse{20} A Gad le dijo: ``¡Bienaventurado el que extienda el
territorio de Gad! Gad es como un león al acecho, listo para arrancar un
brazo o una cabeza. \bibleverse{21} Eligió la mejor tierra para sí
...
\bibleverse{22} A Dan le dijo: ``Dan es un joven león que salta de
Basán''.

\bibleverse{23} A Neftalí le dijo: ``Neftalí es realmente favorecido,
lleno de la bendición del Señor. Se apoderará de la tierra al oeste y al
sur''.

\bibleverse{24} A Aser le dijo: ``Que Aser sea bendecido más que todos
los demás hijos; que sea favorecido por encima de sus hermanos y que
bañe sus pies en aceite de oliva. \bibleverse{25} Que los cerrojos de tu
...
\bibleverse{26} No hay nadie como el Dios de Israel, que cabalga por los
cielos para venir a ayudarte; que cabalga por las nubes en majestad.
\bibleverse{27} El Dios eterno es tu hogar, y te sostiene con sus brazos
eternos. Expulsa al enemigo delante de ti y da la orden:
``¡Destrúyelo!'' \bibleverse{28} Como resultado, Israel vive en paz;
Jacob no tiene problemas en un país de grano y vino nuevo, donde los
cielos gotean de rocío. \footnote{\textbf{33:28} Núm 23,9}
\bibleverse{29} ¡Cuán bendito eres, Israel! ¿Hay alguien como tú, un
...
\bibleverse{1} Moisés dejó las llanuras de Moab y se dirigió al Monte
...
El Señor le mostró todo el país, desde Galaad hasta Dan. \footnote{\textbf{34:1}
  Deut 3,27} \bibleverse{2} Esto incluía todos los territorios de
Neftalí, Efraín y Manasés, Judá hasta el mar Mediterráneo,
\bibleverse{3} el Néguev y el valle del Jordán desde Jericó (la ciudad
de las palmeras) hasta Zoar. \bibleverse{4} El Señor le dijo: ``Este es
...
\bibleverse{5} Moisés, el siervo del Señor, murió allí en el país de
Moab, tal como el Señor había dicho. \footnote{\textbf{34:5} Deut 32,50}
\bibleverse{6} Lo enterró en un valle allí en Moab que está frente a
Bet-peor, pero nadie sabe hasta hoy dónde está la tumba de Moisés.
\footnote{\textbf{34:6} Jds 1,9} \bibleverse{7} Moisés tenía 120 años
cuando murió, pero aún veía claramente y era fuerte. \bibleverse{8} Los
...
días, hasta que el tiempo de duelo terminó. \footnote{\textbf{34:8} Núm
  20,29} \bibleverse{9} Josué, hijo de Nun, se llenó de espíritu de
...
\bibleverse{10} Desde entonces nunca ha habido un profeta en Israel como
Moisés que fuera amigo íntimo del Señor.\footnote{\textbf{34:10} ``Que
  ...
  conoció cara a cara''.} \bibleverse{11} El Señor lo envió a llevar a
cabo todas las señales y milagros en Egipto para convencer al Faraón y a
sus oficiales, y a toda la gente del país. \bibleverse{12} Moisés hizo
