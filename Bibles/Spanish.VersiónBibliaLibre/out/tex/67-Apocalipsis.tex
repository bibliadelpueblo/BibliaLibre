...
\bibleverse{1} Esta es la revelación de Jesucristo, la cual Dios entregó
para mostrar a sus siervos lo que sucederá pronto. Él envió a su ángel
para revelarla a su siervo Juan, \bibleverse{2} quien confirmó todo lo
...
\bibleverse{3} Bendito es todo aquél que lee\footnote{\textbf{1:3}
...
\bibleverse{4} Esta carta viene de parte de Juan y es enviada a las
...
\footnote{\textbf{1:4} Éxod 3,14-15; Apoc 3,1; Apoc 5,6} \bibleverse{5}
...
libertó de nuestros pecados por medio de su sangre, \footnote{\textbf{1:5}
  Apoc 3,14; Juan 18,37; 1Tim 6,13; Col 1,18} \bibleverse{6} quien nos
...
\bibleverse{7} Miren que viene rodeado de nubes, y todos lo verán,
...
\bibleverse{8} ``Yo soy el Principio y el Fin'',\footnote{\textbf{1:8}
...
\bibleverse{9} Yo soy Juan, hermano de ustedes, partícipe en el
...
Dios y la verdad tal como fue revelada por Jesús. \bibleverse{10} Fui
lleno del Espíritu en el día del Señor, y escuché una voz fuerte detrás
de mí, que sonaba como una trompeta. \bibleverse{11} Y me dijo:
``Escribe en un libro lo que ves y envíalo a las siete iglesias: Éfeso,
Esmirna, Pérgamo, Tiatira, Sardis, Filadelfia, y Laodicea''.

\bibleverse{12} Me di vuelta para ver quién me hablaba. Y cuando di la
vuelta vi siete candelabros de oro, \bibleverse{13} y en medio de los
...
pecho. \bibleverse{14} Su cabello lucía como lana blanca, y sus ojos
como fuego ardiente. \footnote{\textbf{1:14} Dan 7,9; Apoc 2,18; Apoc
  19,12} \bibleverse{15} Sus pies lucían como metal que ha sido refinado
en una caldera. Y su voz como el estruendo de las aguas de una cascada.
\bibleverse{16} Sostenía siete estrellas en su mano derecha y de su boca
salía una espada de doble filo. Su rostro brillaba como el sol en su
esplendor. \bibleverse{17} Cuando lo vi, caí a sus pies como muerto.
Pero él me tocó con su mano derecha y dijo: ``No tengas miedo, yo soy el
primero y el último.

\bibleverse{18} Soy el que vive. Estuve muerto, pero mírame, ahora estoy
vivo por siempre y para siempre, y tengo las llaves de la muerte y del
sepulcro.\footnote{\textbf{1:18} Literalmente, el ``Hades''.}
\bibleverse{19} ``Así que escribe lo que has visto, lo que está
sucediendo en el presente y lo que sucederá en el futuro.
\bibleverse{20} Este es el significado de las siete estrellas que viste
...
\bibleverse{1} ``Escribe esto al ángel de la iglesia de Éfeso: Esto es
...
\bibleverse{2} Conozco tus logros, tu trabajo arduo y tu perseverancia.
...
\footnote{\textbf{2:2} 1Jn 4,1} \bibleverse{3} Conozco tu paciencia, y
lo que soportaste por mi causa, y sé que nunca te rendiste.
\bibleverse{4} ``Pero tengo algo contra ti: has descuidado tu primer
amor. \footnote{\textbf{2:4} 1Tim 5,12} \bibleverse{5} Así que recuerda
...
que te arrepientas. \bibleverse{6} Sin embargo, tienes esto a tu favor:
...
también lo hago. \bibleverse{7} Si tienen oídos, oigan lo que el
...
\bibleverse{8} ``Escribe esto al ángel de la iglesia de Esmirna: Esto es
lo que dice el primero y el último, el que estaba muerto y volvió a la
vida: \footnote{\textbf{2:8} Apoc 1,11; Apoc 1,18}

\bibleverse{9} Conozco las dificultades que afrontas, y cuán pobre eres
...
y no lo son, sino que pertenecen a la sinagoga de Satanás. \footnote{\textbf{2:9}
  Sant 2,5; Apoc 3,9} \bibleverse{10} No tengas miedo respecto a las
...
\bibleverse{11} Si tienes oídos, oye lo que el Espíritu dice a las
...
\bibleverse{12} ``Escribe esto al ángel de la iglesia de Pérgamo: Esto
dice el que sostiene la espada de doble filo: \footnote{\textbf{2:12}
  Heb 4,12}

\bibleverse{13} Yo sé que vives donde Satanás tiene su trono, y que has
...
donde vive Satanás. \bibleverse{14} ``Pero tengo unas cuantas cosas
...
\bibleverse{15} Del mismo modo, tienes a algunos que guardan las
enseñanzas de los Nicolaítas. \bibleverse{16} Así que arrepiéntete, o
vendré pronto a ti y pelearé contra ellos usando la espada de mi boca.
\bibleverse{17} Si tienes oídos, escucha lo que el Espíritu dice a las
...
\bibleverse{18} ``Escribe esto al ángel de la iglesia de Tiatira: Esto
...
\bibleverse{19} Yo conozco tus logros, tu amor y fidelidad, tu servicio
y perseverancia, y que ahora estás trabajando más que cuando comenzaste
a creer. \bibleverse{20} ``Pero tengo algo contra ti: estás dejando que
...
comer alimentos sacrificados a ídolos. \bibleverse{21} Yo le di tiempo
de arrepentirse de sus pecados sexuales, pero ella no está dispuesta a
hacerlo. \bibleverse{22} Por lo tanto yo la arrojo en una cama junto a
sus compañeros de adulterio, y sufrirán en gran manera a menos que se
arrepientan de lo que han hecho con ella. \bibleverse{23} Yo enviaré a
...
. Yo recompensaré a cada uno conforme a sus obras. \footnote{\textbf{2:23}
  Sal 7,10; Jer 17,10} \bibleverse{24} ``Para el resto de ustedes que
...
les colocaré ninguna otra carga. Sino que les digo: \bibleverse{25}
`Mantengan lo que tienen hasta que yo venga'. \bibleverse{26} A los que
sean victoriosos y obedezcan lo que yo ordeno hasta el fin, les daré
autoridad sobre las naciones. \bibleverse{27} Él gobernará las naciones
...
\bibleverse{28} yo les daré la estrella de la mañana.\footnote{\textbf{2:28}
  ...
  a Cristo.} \bibleverse{29} Si tienen oídos, escuchen lo que el
...
\bibleverse{1} ``Escribe esto al ángel de la iglesia de Sardis: Esto es
...
\bibleverse{2} Despierta, y trata de revivir lo que queda y está a punto
...
\bibleverse{3} ``Así que acuérdense de cómo recibieron este mensaje, y
...
hora vendré. \footnote{\textbf{3:3} 1Tes 5,2} \bibleverse{4} ``Pero hay
...
\footnote{\textbf{3:4} Jds 1,23} \bibleverse{5} Los que sean victoriosos
...
\bibleverse{6} Si tienen oídos, escuchen lo que el Espíritu dice a las
iglesias.
...
\bibleverse{7} ``Escribe esto al ángel de la iglesia de Filadelfia: Esto
...
\bibleverse{8} Yo conozco tus logros. Mira, he abierto para ti una
puerta que nadie puede cerrar. Sé que tienes apenas poca fuerza, pero
hiciste lo que yo te pedí, y no me negaste. \bibleverse{9} Desde la
...
reconozcan que yo te amo. \bibleverse{10} Y como has perseverado como te
...
cuando todos los habitantes de la tierra serán juzgados. \footnote{\textbf{3:10}
  Apoc 14,12; Mat 6,13} \bibleverse{11} ``¡Vengo pronto! Retén lo que
tienes para que nadie quite tu corona. \footnote{\textbf{3:11} Apoc 2,10}
\bibleverse{12} A los victoriosos los convertiré en pilares para el
...
\bibleverse{13} Si tienen oídos, escuchen lo que el Espíritu dice a las
iglesias.
...
\bibleverse{14} ``Escribe esto al ángel de la iglesia de Laodicea: Esto
es lo que dice el Amén, el testigo fiel, el máximo gobernante de la
creación de Dios:

\bibleverse{15} Yo conozco tus logros, que no eres ni frío ni caliente.
¡Ojalá fueras frío o caliente! \bibleverse{16} Pero como eres tibio, y
no eres frío ni caliente, te escupiré de mi boca. \bibleverse{17} Tú te
...
no sabes que eres un miserable, pobre, ciego y desnudo. \footnote{\textbf{3:17}
  1Cor 3,18; 1Cor 4,8} \bibleverse{18} Yo te aconsejo, pues, que de mí
...
puedas ver. \footnote{\textbf{3:18} Is 55,1} \bibleverse{19} ``Yo
corrijo y disciplino a los que amo. Así que sé sincero y arrepiéntete.
\footnote{\textbf{3:19} Prov 3,12; Heb 12,6; 1Cor 11,32} \bibleverse{20}
...
puerta, entraré y comeré con él, y él conmigo. \footnote{\textbf{3:20}
  Juan 14,23} \bibleverse{21} A los que sean victoriosos los haré
...
\bibleverse{22} Si tienes oídos, escucha lo que el Espíritu dice a las
iglesias''.
...
\bibleverse{1} Después de esto vi una puerta que se había abierto
...
\bibleverse{2} E inmediatamente fui lleno del Espíritu y vi un trono en
el cielo, y había alguien sentado sobre él. \footnote{\textbf{4:2} Is
  6,1; Sal 47,9} \bibleverse{3} El que estaba sentado allí brillaba como
...
\bibleverse{4} Alrededor del trono había otros veinticuatro tronos, y
veinticuatro ancianos sentados sobre ellos, vestidos de blanco y usando
coronas de oro en sus cabezas. \bibleverse{5} Desde el trono salían
...
antorchas, que son los siete Espíritus de Dios. \footnote{\textbf{4:5}
  Éxod 19,16; Apoc 1,4} \bibleverse{6} Y frente al trono se extendía un
...
delante y por detrás. \footnote{\textbf{4:6} Ezeq 1,5; Ezeq 1,10; Ezeq
  1,22; Ezeq 10,14} \bibleverse{7} La primera criatura parecía un león,
la segunda parecía un novillo, la tercera tenía rostro humano, y la
cuarta parecía como un águila que volaba. \bibleverse{8} Cada una de las
...
\bibleverse{9} Y cada vez que las criaturas vivientes glorifican, honran
y agradecen al que está sentado en el trono, y que vive por siempre y
para siempre, \bibleverse{10} los veinticuatro ancianos se inclinan ante
...
\bibleverse{11} ``Nuestro Señor y Dios, tú eres digno de gloria, honra y
...
\bibleverse{1} Vi al que estaba sentado en el trono, sosteniendo un
...
escrito por ambos lados y tenía puestos siete sellos. \bibleverse{2}
Entonces vi a un ángel poderoso, gritando a gran voz: ``¿Quién es digno
de abrir el rollo y romper sus sellos?'' \bibleverse{3} Y nadie en el
cielo, ni en la tierra, ni debajo de la tierra\footnote{\textbf{5:3}
  ...
  5:13.} era capaz de abrir el rollo y leerlo. \bibleverse{4} Lloré
mucho porque no podían hallar a nadie que fuera digno de abrir el libro
y leerlo. \bibleverse{5} Entonces uno de los ancianos me habló y me
...
\bibleverse{6} Entonces vi a un Cordero que parecía como si lo hubieran
...
la tierra. \footnote{\textbf{5:6} Is 53,7; Juan 1,29} \bibleverse{7} Él
fue y tomó el rollo de la mano derecha del que estaba sentado en el
trono. \bibleverse{8} Cuando tomó el rollo, las cuatro criaturas
...
que son las oraciones de los creyentes. \bibleverse{9} Ellos cantaban un
...
\bibleverse{10} Los convertiste en un reino y en sacerdotes para nuestro
...
\bibleverse{11} Y mientras veía, escuché las voces de millones de
ángeles alrededor del trono, junto con las criaturas vivientes y los
ancianos, \footnote{\textbf{5:11} Heb 12,22} \bibleverse{12} diciendo
...
\bibleverse{13} Entonces oí a cada criatura en el cielo, en la tierra y
...
\bibleverse{14} Y las cuatro criaturas vivientes dijeron: ``¡Amén!'' y
...
\bibleverse{1} Y miré cuando el Cordero rompió el primero de los siete
...
estruendosa: ``¡Ven!''\footnote{\textbf{6:1} La orden dada aquí también
  podría ser ``¡Ve!''} \bibleverse{2} Entonces miré y vi un caballo
...
\bibleverse{3} Cuando abrió el segundo sello, escuché a la segunda
criatura decir: ``¡Ven!'' \bibleverse{4} Y salió otro caballo, que era
...
\bibleverse{5} Y cuando abrió el tercer sello, escuché a la tercera
criatura viviente decir: ``¡Ven!'' Entonces miré y vi un caballo negro.
El que lo cabalgaba sostenía una balanza en su mano. \bibleverse{6} Y
...
\bibleverse{7} Cuando abrió el cuarto sello, escuché a la cuarta
criatura viviente decir: ``¡Ven!'' \bibleverse{8} Entonces miré y vi un
...
\bibleverse{9} Cuando abrió el quito sello, vi debajo del altar a
...
\bibleverse{10} Y clamaban, diciendo: ``¿Hasta cuándo, Señor, que eres
santo y verdadero, harás juicio y traerás justicia sobre aquellos en la
tierra que derramaron nuestra sangre?'' \bibleverse{11} Y a cada uno de
...
\bibleverse{12} Cuando abrió el sexto sello, hubo un gran terremoto. El
sol se puso negro como tela de silicio y toda la luna se volvió roja
como la sangre. \bibleverse{13} Las estrellas del cielo caían sobre la
tierra como higos verdes que caen del árbol cuando es sacudido por el
viento. \footnote{\textbf{6:13} Is 34,4} \bibleverse{14} El cielo
desapareció como cuando un pergamino se enrolla, y todas las montañas e
islas fueron removidas de su sitio. \bibleverse{15} Y los reyes de la
...
las montañas. \bibleverse{16} Y gritaban a las montañas y a las rocas:
...
\footnote{\textbf{6:16} Luc 23,30} \bibleverse{17} Porque el día
...
\bibleverse{1} Entonces vi cuatro ángeles que estaban en pie en las
...
ellos golpeara la tierra, el mar, o algún árbol. \footnote{\textbf{7:1}
  Dan 7,2} \bibleverse{2} Y miré a otro ángel levantarse desde el Este,
...
mar: \bibleverse{3} ``¡No le hagan daño a la tierra, ni al mar, ni a los
árboles, hasta que hayamos puesto un sello en las frentes de los
verdaderos seguidores de Dios!'' \bibleverse{4} Y se me dijo el número
...
\footnote{\textbf{7:4} Apoc 14,1; Apoc 14,3} \bibleverse{5} doce mil de
la tribu de Judá, doce mil de la tribu de Rubén, doce mil de la tribu de
Gad, \bibleverse{6} doce mil de la tribu de Aser, doce mil de la tribu
de Neftalí, doce mil de la tribu de Manasés, \bibleverse{7} doce mil de
la tribu de Simeón, doce mil de la tribu de Leví, doce mil de la tribu
de Isacar, \bibleverse{8} doce mil de la tribu de Zabulón, doce mil de
...
\bibleverse{9} Después de esto mire y vi una gran multitud que nadie
...
ramas de palmeras en sus manos. \bibleverse{10} Y gritaron fuertemente:
``La Salvación viene de nuestro Dios que está sentado en el trono, y del
Cordero''.

\bibleverse{11} Y todos los ángeles que rodeaban el trono, y los
ancianos, así como las cuatro criaturas vivientes, cayeron postrados con
sus rostros a tierra ante el trono, adorando a Dios. \bibleverse{12}
...
\bibleverse{13} Entonces uno de los ancianos me habló, preguntándome:
``¿Quiénes son los que están vestidos con túnicas blancas, y de dónde
han venido?''

\bibleverse{14} Y yo respondí: ``Mi Señor, tú sabes la respuesta''.
...
\bibleverse{15} Por eso ellos pueden estar en pie frente al trono de
...
trono los protegerá con su presencia.\footnote{\textbf{7:15} ``Proteger
  ...
  misma palabra para la venida de Jesús, en Juan 1:14.} \bibleverse{16}
...
sufrirán de calor abrasador,\footnote{\textbf{7:16} Citando Isaías
  49:10.} \footnote{\textbf{7:16} Is 49,10} \bibleverse{17} porque el
...
\bibleverse{2} Y vi a los siete ángeles que están delante de Dios. A
ellos se les dieron siete trompetas. \footnote{\textbf{8:2} Mat 24,31}

\bibleverse{3} Entonces vino otro ángel y se puso en pie en\footnote{\textbf{8:3}
...
al trono. \bibleverse{4} Y de la mano del ángel, el humo del incienso
subía junto a las oraciones de los santos ante Dios. \footnote{\textbf{8:4}
  Sal 141,2} \bibleverse{5} Entonces el ángel tomó el incensario y lo
...
\bibleverse{6} Entonces los siete ángeles que sostenían las siete
...
\bibleverse{7} Y el primer ángel hizo sonar su trompeta. Y llovía fuego
...
\bibleverse{8} Y el segundo ángel hizo sonar su trompeta. Y sucedió que
...
Y una tercera parte del mar se convirtió en sangre, \footnote{\textbf{8:8}
  Éxod 7,20-21} \bibleverse{9} y una tercera parte de las criaturas que
vivían en el mar murieron, y una tercera parte de las embarcaciones
quedaron destruidas.

\bibleverse{10} Entonces el tercer ángel hizo sonar su trompeta. Y una
...
sobre una tercera parte de los ríos y fuentes de agua. \footnote{\textbf{8:10}
  Is 14,12} \bibleverse{11} Y el nombre de la estrella es Ajenjo, y una
...
\bibleverse{12} El cuarto ángel hizo sonar su trompeta, y fueron heridas
...
\bibleverse{13} Entonces vi y escuché a un águila\footnote{\textbf{8:13}
...
\bibleverse{1} Entonces el quinto ángel hizo sonar su trompeta. Y vi una
...
Abismo.\footnote{\textbf{9:1} A veces se traduce como ``pozo sin
  fondo''.} \bibleverse{2} Y abrió la puerta del Abismo, y salía humo de
...
oscurecieron por el humo que salía del Abismo. \footnote{\textbf{9:2} Jl
  2,2; Jl 2,10} \bibleverse{3} Salieron langostas del humo hasta la
tierra, y se les dio poder como de escorpiones. \bibleverse{4} Se les
...
frentes. \bibleverse{5} Y no tenían permiso de matar, pero podían
torturar a estas personas durante cinco meses. Y la tortura era como el
aguijón de un escorpión. \bibleverse{6} Durante ese tiempo, la gente
andará buscando la muerte, pero no la hallarán; querrán morir, pero la
muerte huirá de ellos. \footnote{\textbf{9:6} Apoc 6,16}

\bibleverse{7} Las langostas parecían caballos de guerra. Usaban algo
que parecía como coronas de oro sobre sus cabezas, y sus rostros eran
como de humanos. \bibleverse{8} Tenían cabello largo como mujeres y
dientes como de leones. \bibleverse{9} Sus pectorales parecían haber
...
\bibleverse{10} Y tenían colas como de escorpiones, con aguijones.
Tenían el poder de herir a la gente por seis meses con sus colas.
\bibleverse{11} Y quien los lideraba como su rey era el ángel del Abismo
...
\bibleverse{12} El primer Desastre ha terminado, pero aún faltan dos
más.
...
\bibleverse{13} Entonces el sexto ángel hizo sonar su trompeta. Y
escuché una voz que venía desde los cuernos del altar de oro que está
frente a Dios \bibleverse{14} y hablaba con el sexto ángel que tenía la
...
\bibleverse{16} Se me dijo el número de los soldados del ejército a
caballo: era 200 millones. \bibleverse{17} Y en mi visión vi a los
...
y de sus bocas salía fuego, humo y azufre. \bibleverse{18} Y por estas
tres plagas murió una tercera parte de la humanidad, por el fuego, humo
y azufre que salían de sus bocas. \bibleverse{19} El poder de los
...
\bibleverse{20} Pero el resto de la humanidad que no murió por estas
...
\bibleverse{21} Tampoco se arrepintieron de sus asesinatos, su brujería,
...
\bibleverse{1} Entonces vi a otro ángel descendiendo del cielo, con una
nube que lo envolvía y un arcoíris sobre su cabeza. Su rostro lucía como
el sol, y sus pies como columnas de fuego. \bibleverse{2} Y sostenía un
pequeño rollo que ya había sido abierto. Colocó su pie derecho sobre el
mar, y su pie izquierdo en la tierra. \bibleverse{3} Y dio un grito, que
se oía como el rugir de un león. Cuando gritó, contestaron los siete
truenos. \bibleverse{4} Cuando los siete truenos hablaron, estuve a
...
\bibleverse{5} El ángel que vi en pie sobre el mar y la tierra elevó su
mano derecha hacia el cielo. \bibleverse{6} E hizo un voto sagrado en
...
\bibleverse{7} Pero al mismo tiempo, cuando habla el séptimo ángel,
...
\bibleverse{8} Entonces oí nuevamente la voz del cielo que me decía:
``Ve y toma el rollo que está abierto en la mano del ángel que está en
pie sobre la tierra y el mar''.

\bibleverse{9} Entonces fui donde el ángel, y le pedí que me diera el
...
\bibleverse{10} Así que tomé el pequeño rollo del ángel y me lo comí. Y
en mi boca fue dulce como la miel, pero fue amargo en mi estómago.
\bibleverse{11} Y se me dijo: ``Debes profetizar nuevamente sobre muchos
...
\bibleverse{1} Y se me dio una vara de medir y me dijeron: ``Levántate y
...
\bibleverse{2} No midas el patio que está fuera del Templo, déjalo,
...
\bibleverse{3} ``Le daré poder a mis dos testigos, y profetizarán
durante 1. 260 días, vestidos de silicio''. \footnote{\textbf{11:3} Apoc
  12,6}

\bibleverse{4} Ellos son los dos árboles de olivo y los dos candelabros
que están frente al Señor de la tierra.\footnote{\textbf{11:4} Una
  referencia a Zacarías 4:14.} \footnote{\textbf{11:4} Zac 4,3; Zac
  4,11-14} \bibleverse{5} Si alguno intenta hacerles daño, saldrá fuego
de sus bocas y quemarán a sus enemigos. Así morirá cualquiera que
intente herirlos. \bibleverse{6} Y estos dos testigos tienen el poder de
...
\bibleverse{7} Cuando terminen su testimonio, la bestia que sale del
abismo los atacará, los desafiará y los matará. \footnote{\textbf{11:7}
  Apoc 13,1; Apoc 13,7} \bibleverse{8} Sus cuerpos muertos yacerán a las
...
\bibleverse{9} Durante tres días y medio, los pueblos, tribus, lenguas y
naciones mirarán sus cuerpos muertos, y no permitirán que sepulten sus
cuerpos. \bibleverse{10} Los habitantes de la tierra están contentos por
su muerte, y celebran, enviándose regalos unos a otros, porque estos dos
profetas eran tormento para ellos.

\bibleverse{11} Pero tres días y medio después, el aliento de vida de
...
estaban horrorizados.\footnote{\textbf{11:11} El tiempo verbal de este
  ...
  traducción ha mantenido este cambio.} \bibleverse{12} Los dos testigos
...
\bibleverse{13} Y al mismo tiempo hubo un gran terremoto, y una décima
...
\bibleverse{14} El segundo Desastre ha terminado; ahora se aproxima el
tercer Desastre.
...
\bibleverse{15} Entonces el segundo ángel hizo sonar su trompeta, y
...
rostros a tierra y adoraron a Dios. \footnote{\textbf{11:16} Apoc 4,4;
  Apoc 4,10} \bibleverse{17} Y decían: ``Te agradecemos, Oh, Señor, el
Todopoderoso, el que era y es, porque has retomado tu gran poder y has
afirmado tu gobierno''. \bibleverse{18} Las naciones se enfurecieron,
...
\bibleverse{19} Entonces se abrió el Templo de Dios en el cielo, y el
...
\bibleverse{1} Luego, apareció una señal asombrosa en el cielo: una
mujer vestida del sol, con la luna bajo sus pies, y una corona de doce
estrellas en su cabeza. \bibleverse{2} Ella estaba embarazada, y gritaba
por sus dolores de parto, y gemía mientras daba a luz.

\bibleverse{3} Y apareció otra señal en el cielo: un enorme dragón rojo
con siete cabezas y diez cuernos, y siete coronas\footnote{\textbf{12:3}
  ...
  distinta a la que se usa en 12:1.} sobre sus cabezas. \bibleverse{4}
...
estaba dando a luz, para comerse a su hijo al nacer. \bibleverse{5} Y
...
fue arrebatado y llevado hasta Dios y su trono. \footnote{\textbf{12:5}
  Sal 2,9} \bibleverse{6} Entonces la mujer huyó corriendo al desierto,
...
\bibleverse{7} Y se desató una guerra en el cielo. Miguel y sus ángeles
pelearon con el dragón. Y el dragón y sus ángeles pelearon también,
\bibleverse{8} pero no era suficientemente fuerte, y no pudieron
permanecer más en el cielo. \bibleverse{9} Y el gran dragón, la
...
\bibleverse{10} Entonces escuché una voz fuerte en el cielo, que decía:
...
\bibleverse{11} Ellos lo vencieron mediante la sangre del Cordero y por
...
estuvieron dispuestos a morir si era necesario. \footnote{\textbf{12:11}
  Apoc 6,9; Apoc 7,14} \bibleverse{12} ``¡Así que celebren, cielos, y
...
\bibleverse{13} Y cuando el dragón se dio cuenta de que había sido
arrojado a la tierra, persiguió a la mujer que había dado a luz al niño
varón. \bibleverse{14} Y a la mujer se le dieron alas de una gran águila
...
serpiente. \bibleverse{15} Y la serpiente botaba agua como un río de su
boca, tratando de ahogar a la mujer con la corriente. \bibleverse{16}
Entonces la tierra vino a ayudar a la mujer abriendo su boca y
tragándose el río de agua que salía de la boca del dragón.
\bibleverse{17} Y el dragón se enfureció contra la mujer, y se fue a
...
\bibleverse{1} Y el dragón se paró en la orilla del mar. Entonces vi a
...
cabezas. \footnote{\textbf{13:1} Dan 7,3-7} \bibleverse{2} La bestia que
...
autoridad a la bestia. \bibleverse{3} Una de sus cabezas parecía haber
sufrido una herida de muerte, pero tal herida se había sanado. Y todo el
mundo estaba asombrado ante esta bestia, \bibleverse{4} y adoraron al
...
\bibleverse{5} Se le dio la habilidad\footnote{\textbf{13:5}
  Literalmente, ``se les dio una boca''.} de jactarse y decir
blasfemias, y también se le dio la autoridad de hacer esto por
veinticuatro meses. \bibleverse{6} Tan pronto como abrió su boca, habló
...
\bibleverse{7} Entonces a la bestia se le dio poder de atacar a los
...
pueblos, tribus, lenguas y naciones. \footnote{\textbf{13:7} Apoc 11,7;
  Dan 7,21} \bibleverse{8} Y todos los habitantes de la tierra le
...
principio del mundo. \bibleverse{9} Si alguno tiene oídos, ¡oiga!
\bibleverse{10} Todo el que tenga que ir a cautiverio, irá a cautiverio;
...
\bibleverse{11} Entonces vi otra bestia, que subía de la tierra. Tenía
dos cuernos como un cordero, pero hablaba como un dragón.
\bibleverse{12} E impuso la misma autoridad que la bestia, en su nombre,
e hizo que la tierra y los que viven en ella adoraran a la primera
bestia, cuya herida mortal había sanado. \bibleverse{13} Y realizaba
...
\bibleverse{14} Engañó a los habitantes de la tierra con milagros que
...
que volvió a la vida. \bibleverse{15} Y se le permitió infundir aliento
de vida en la imagen de la bestia para que pudiera hablar, y daba
órdenes de mandar a matar a todo aquél que no le adorara.
\bibleverse{16} E hizo que todos, fueran débiles o poderosos, ricos o
pobres, esclavos o libres, recibieran una marca en su mano derecha o en
sus frentes. \bibleverse{17} Y a nadie se le permitía comprar o vender,
excepto a aquellos que tuvieran la marca, que era el nombre de la bestia
o el número de su nombre. \bibleverse{18} Aquí se requiere sabiduría. Y
...
\bibleverse{1} Luego miré, y vi al Cordero en pie sobre el Monte de
...
\bibleverse{2} Y escuché una voz que procedía del cielo y que sonaba
como torrentes de agua y fuertes truenos, y se oían tocar muchas arpas.
\footnote{\textbf{14:2} Apoc 1,15} \bibleverse{3} Y cantaban un cántico
...
habían sido redimidos de la tierra. \bibleverse{4} Ellos no se habían
...
humanidad como primicias para Dios y el Cordero. \bibleverse{5} Ellos no
...
\bibleverse{6} Entonces vi a otro ángel que volaba por en medio del
cielo. Tenía el evangelio eterno para que se anunciara a los habitantes
de la tierra, a cada nación, tribu, lengua y pueblo. \bibleverse{7} Y
...
\bibleverse{8} Y le siguió un segundo ángel, gritando: ``¡Babilonia, la
...
\bibleverse{9} Y un tercer ángel le siguió, diciendo a gran voz: ``Si
alguno adora a la bestia y a su imagen, y recibe marca sobre su frente o
su mano, \footnote{\textbf{14:9} Apoc 13,12-17} \bibleverse{10} beberá
...
Cordero. \footnote{\textbf{14:10} Sal 75,9} \bibleverse{11} Y el humo de
...
\bibleverse{12} Esto quiere decir que los creyentes deben perseverar con
...
\bibleverse{13} Entonces oí una voz que procedía del cielo, que me
...
\bibleverse{14} Entonces miré y vi una nube blanca. Y sobre la nube
...
de oro y sostenía en su mano una hoz afilada. \footnote{\textbf{14:14}
  Mar 13,26} \bibleverse{15} Y otro ángel salió del Templo y gritaba a
...
madura''. \footnote{\textbf{14:15} Mat 13,39; Jl 4,13} \bibleverse{16} Y
el que estaba sentado sobre la nube pasó la hoz sobre la tierra, y
recogió la cosecha de la tierra.

\bibleverse{17} Y otro ángel salió del Templo en el cielo. También tenía
una hoz afilada. \bibleverse{18} A él le siguió un ángel que venía desde
...
la tierra, porque sus uvas están maduras''. \bibleverse{19} Y el ángel
...
el enorme lagar del juicio de Dios.\footnote{\textbf{14:19}
  ...
  importante la nota del versículo 6:16.} \bibleverse{20} Y fueron
...
\bibleverse{1} Entonces vi en el cielo otra señal asombrosa y de gran
...
\bibleverse{2} Vi lo que parecía como un mar de vidrio mezclado con
...
les había dado \footnote{\textbf{15:2} Apoc 4,6} \bibleverse{3} y
...
\bibleverse{4} ¿Quién no te rendiría reverencia, oh, Señor? ¿Quién es el
...
\bibleverse{5} Después de esto, miré, y el Templo de la ``Tienda del
...
\bibleverse{6} Y del Templo salieron siete ángeles que sostenían las
siete plagas, usando ropas blancas, de lino, y con cintos de oro en sus
pechos.

\bibleverse{7} Y una de las cuatro criaturas vivientes le dio a los
siete ángeles siete copas de oro, llenas del juicio de Dios, quien vive
por siempre y para siempre. \bibleverse{8} Entonces el Templo se llenó
...
\bibleverse{1} Entonces escuché una gran voz que venía desde el Templo,
y que decía a los siete ángeles: ``Vayan y derramen las siete copas del
juicio de Dios sobre la tierra''.

\bibleverse{2} Entonces el primer ángel fue y derramó su copa sobre la
...
\bibleverse{3} Luego el segundo ángel derramó su copa sobre el mar, y se
convirtió como la sangre de un cadáver, y todo lo que había en el mar
murió.

\bibleverse{4} Después el tercer ángel derramó su copa sobre los ríos y
fuentes de agua, y el agua se convirtió en sangre. \footnote{\textbf{16:4}
  Éxod 7,17-21} \bibleverse{5} Y escuché al ángel que tenía el poder
sobre las aguas, y declaró: ``Tú eres realmente justo, tú, que eres y
fuiste, el Santo, como lo demuestra este juicio. \bibleverse{6} Estas
personas derramaron la sangre de los creyentes. ¡Y ahora les das a beber
sangre, como lo merecen!''

\bibleverse{7} Entonces oí una voz que provenía desde el altar,
diciendo: ``Sí, oh, Señor, el Todopoderoso. ¡Tus juicios son justos y
verdaderos!''

\bibleverse{8} Y el cuarto ángel derramó su copa sobre el sol, y se le
dio el poder de quemar a la gente con fuego. \bibleverse{9} Y se
...
\bibleverse{10} Luego el quinto ángel derramó su copa sobre el trono de
la bestia, y vinieron tinieblas sobre su reino. La gente mordía sus
lenguas por el dolor que sentían, \bibleverse{11} y maldecían al Dios
del cielo por causa de su dolor y sus llagas, pero no se arrepentían ni
dejaban de hacer lo que estaban haciendo.

\bibleverse{12} Luego el sexto ángel derramó su copa sobre el poderoso
...
\bibleverse{13} Entonces vi tres espíritus malos que parecían como ranas
que salían de las bocas del dragón, la bestia, y el falso profeta.
\footnote{\textbf{16:13} Apoc 12,3; Éxod 8,3} \bibleverse{14} Estos son
...
\bibleverse{15} (¡Estén atentos! Vendré como un ladrón.\footnote{\textbf{16:15}
...
\footnote{\textbf{16:15} 1Tes 5,2} \bibleverse{16} Los espíritus malos
reunieron a los reyes para la batalla en un lugar que en hebreo se llama
Armagedón.

\bibleverse{17} Entonces el séptimo ángel derramó su copa en el aire, y
del Templo salió una gran voz, que venía desde el trono, y gritaba:
``¡Está hecho!'' \bibleverse{18} Entonces hubo relámpagos y truenos, y
un gran terremoto sacudió la tierra. Y fue el peor terremoto que hubiera
existido desde que hubo habitantes en la tierra. \bibleverse{19} La gran
...
\bibleverse{20} Todas las islas se desvanecieron, y todas las montañas
desaparecieron. \footnote{\textbf{16:20} Apoc 6,14} \bibleverse{21} Cayó
...
\bibleverse{1} Y uno de los siete ángeles con las siete copas vino y me
...
\bibleverse{2} Los reyes de la tierra han cometido adulterio con ella, y
los habitantes de la tierra se han embriagado con el vino de su
inmoralidad''. \bibleverse{3} Entonces me llevó en el Espíritu a un
...
nombres blasfemos. \bibleverse{4} La mujer estaba vestida de púrpura y
...
\bibleverse{5} Y en su frente estaba escrito un nombre de
...
Prostitutas y de las obscenidades del mundo. \bibleverse{6} Y vi que la
...
\bibleverse{7} Y el ángel me preguntó: ``¿Por qué estás asombrado? Te
explicaré el misterio de la mujer y la bestia sobre la cual estaba
montada, y que tenía siete cabezas y diez cuernos. \bibleverse{8} La
...
\bibleverse{9} ``Aquí se necesita una mente con entendimiento. Las siete
cabezas son siete colinas, donde está sentada la mujer;\footnote{\textbf{17:9}
  ...
  también versículo 1.} \bibleverse{10} esos son siete reyes. Cinco ya
han caído, uno reina ahora, y el último está por venir, y su reino será
corto. \bibleverse{11} La bestia que era, y no es, es un octavo rey y
pertenece a los siete. Él también será destruido por completo.
\bibleverse{12} ``Los diez cuernos que viste son diez reyes que no han
...
reinar junto con la bestia durante una hora. \footnote{\textbf{17:12}
  Apoc 13,1} \bibleverse{13} Y han acordado un solo propósito: ceder su
poder y autoridad a la bestia. \bibleverse{14} Y harán guerra contra el
...
\bibleverse{15} Y el ángel siguió explicándome: ``Las aguas que viste
...
\bibleverse{16} Los diez cuernos que viste y la bestia odiarán a la
...
\bibleverse{17} ``Porque Dios puso en sus mentes que hicieran lo que él
quería, que tuvieran un mismo acuerdo: ceder su reino a la bestia, para
que se cumplan las palabras de Dios. \bibleverse{18} La mujer que viste
...
\bibleverse{1} Después de esto vi a otro ángel descendiendo desde el
...
\bibleverse{2} Y gritó con voz poderosa: ``¡Babilonia la grande ha
...
espantosa. \footnote{\textbf{18:2} Apoc 14,8; Is 34,11; Is 34,13; Jer
  50,39} \bibleverse{3} Pues todas las naciones han bebido\footnote{\textbf{18:3}
...
\bibleverse{4} Luego escuché otra voz que venía desde el cielo, y
...
pecaminosos, y para que no participen de sus plagas. \footnote{\textbf{18:4}
  Is 48,20; Jer 50,8; Jer 51,6; Jer 51,45; 2Cor 6,17} \bibleverse{5} Sus
pecados se han acumulado hasta llegar al cielo, y Dios no olvida su
maldad. \footnote{\textbf{18:5} Gén 18,20-21; Jer 51,9} \bibleverse{6}
...
\bibleverse{7} Devuélvanle la misma medida de su jactancia y su lujuria
...
\bibleverse{8} Ahora por esto sus plagas caerán sobre ella en un solo
...
\bibleverse{9} Los reyes de la tierra que habían cometido adulterio con
ella y consintieron sus lujos, llorarán y se lamentarán por ella cuando
vean el humo del fuego que la destruye. \bibleverse{10} Permaneciendo a
...
una hora se ejecutó tu sentencia de muerte!'' \bibleverse{11} Los
comerciantes de la tierra lloran y se lamentan por ella, porque ya nadie
compra sus bienes, \footnote{\textbf{18:11} Ezeq 27,36} \bibleverse{12}
...
\bibleverse{13} así como cargamentos de canela, especias, incienso,
...
ganado y ovejas, caballos y carros, y esclavos y prisioneros.\footnote{\textbf{18:13}
  Literalmente, ``cuerpos y almas de hombres''.} \bibleverse{14} Has
...
lujosas y relucientes, y no las recuperarás nunca más. \bibleverse{15}
...
misma agonía. Llorarán y se lamentarán, diciendo: \bibleverse{16}
...
\footnote{\textbf{18:16} Apoc 17,4} \bibleverse{17} ¡En solo una hora
...
distancia. \footnote{\textbf{18:17} Ezeq 27,27-36} \bibleverse{18} Y
mientras veían el humo del fuego que la destruye, gritaban: ``¿Qué
ciudad podría compararse con esta gran ciudad?'' \bibleverse{19} Y se
...
\bibleverse{20} Cielos, creyentes, apóstoles y profetas, celebren lo que
...
\bibleverse{21} Y un poderoso ángel tomó una piedra del tamaño de una
...
\footnote{\textbf{18:21} Jer 51,63-64} \bibleverse{22} ``Y nunca más
...
\footnote{\textbf{18:22} Is 24,8; Ezeq 26,13} \bibleverse{23} Nunca más
...
\bibleverse{1} Después de esto escuché lo que sonaba como el ruido de
una gran multitud en el cielo, que gritaba: ``¡Aleluya! Salvación,
gloria y poder describen a nuestro Dios, \bibleverse{2} porque sus
...
\bibleverse{3} Y otra vez gritaron: ``¡Aleluya! El humo de su
destrucción asciende por siempre y para siempre''. \footnote{\textbf{19:3}
  Is 34,10} \bibleverse{4} Entonces los veinticuatro ancianos y las
...
\bibleverse{11} Y vi que el cielo se abrió. Y había allí un caballo
...
su juicio, y es recto al hacer la guerra. \footnote{\textbf{19:11} Apoc
  3,14; Mat 24,30; Is 11,4-5} \bibleverse{12} Sus ojos eran como fuego
...
\bibleverse{13} Usaba una túnica cubierta de sangre, y su nombre es La
Palabra de Dios. \footnote{\textbf{19:13} Is 63,1-2; Juan 1,1}
\bibleverse{14} Los ejércitos del cielo le seguían, sobre caballos
blancos y vestidos con lino fino, blanco y limpio. \footnote{\textbf{19:14}
  Apoc 17,14} \bibleverse{15} De su boca salió una espada afilada para
...
lagar del juicio\footnote{\textbf{19:15} Literalmente ``de la furia de
  ...
  Sal 2,9; Apoc 14,19-20} \bibleverse{16} Y sobre su túnica y en su
muslo estaba escrito el nombre Rey de reyes y Señor de señores.
\footnote{\textbf{19:16} Apoc 1,5; 1Tim 6,15}

\bibleverse{17} Y vi a un ángel que estaba en pie en el sol, gritando a
...
para la gran fiesta de Dios. \footnote{\textbf{19:17} Ezeq 39,4; Ezeq
  39,17-20} \bibleverse{18} Aquí pueden comer la carne de los muertos:
...
pequeños''. \bibleverse{19} Y vi a la bestia y a los reyes de la tierra
...
\bibleverse{20} Y capturaron a la bestia, junto al falso profeta que
...
\bibleverse{21} A los demás los mataron con la espada del que estaba
...
\bibleverse{1} Y vi a un ángel que descendía del cielo, sosteniendo en
su mano la llave del Abismo y una cadena enorme. \footnote{\textbf{20:1}
  Apoc 9,1} \bibleverse{2} Agarró al dragón, la serpiente Antigua, que
es el Diablo y Satanás, y lo ató con cadenas durante mil años.
\footnote{\textbf{20:2} Apoc 12,9} \bibleverse{3} El ángel lo lanzó al
...
\bibleverse{4} Entonces vi gente sentada en tronos, y se les había dado
...
ellos vivieron y reinaron con Cristo durante mil años. \footnote{\textbf{20:4}
  Apoc 3,21; Mat 19,28; 1Cor 6,2} \bibleverse{5} Esta es la primera
...
\bibleverse{6} ¡Benditos y santos son los que tienen parte en la primera
...
\bibleverse{7} Cuando terminen los mil años, Satanás será liberado de su
prisión, \bibleverse{8} y saldrá a engañar a las naciones, simbolizadas
...
número es incontable como la arena del mar. \footnote{\textbf{20:8} Ezeq
  38,2} \bibleverse{9} Y marchaban sobre la tierra con un frente amplio
y rodearon el campo donde estaban los creyentes, la ciudad amada. Pero
cayó fuego del cielo y los quemó. \bibleverse{10} Entonces el diablo,
...
\hypertarget{la-segunda-resurrecciuxf3n-y-el-juicio-final}{%
\subsection{La segunda resurrección y el juicio
final}\label{la-segunda-resurrecciuxf3n-y-el-juicio-final}}

\bibleverse{11} Entonces vi un gran trono blanco con Uno sentado en él.
El cielo y la tierra desaparecieron, y no existían más.\footnote{\textbf{20:11}
  ...
  Mat 25,31-46; 2Pe 3,7; 2Pe 3,10; 2Pe 3,12} \bibleverse{12} Vi a los
...
habían hecho. \footnote{\textbf{20:12} Juan 5,28-29} \bibleverse{13} El
...
\bibleverse{14} Entonces la muerte y el Hades fueron arrojados al lago
de fuego. El lago de fuego es la segunda muerte. \footnote{\textbf{20:14}
  1Cor 15,26; 1Cor 15,55}

\bibleverse{15} Aquellos que no tengan su nombre escrito en el libro de
la vida, fueron lanzados al lago de fuego.

\hypertarget{section-20}{%
\section{21}\label{section-20}}

\bibleverse{1} Entonces vi un nuevo cielo y una nueva tierra.\footnote{\textbf{21:1}
...
\bibleverse{2} Y vi la santa ciudad, Nueva Jerusalén, descendiendo desde
...
serán su pueblo. Dios mismo estará con ellos como su Dios.\footnote{\textbf{21:3}
  ...
  antiguos.} \footnote{\textbf{21:3} Ezeq 37,26-27} \bibleverse{4} El
...
\bibleverse{5} El que está sentado en el trono dijo: ``¡Todas las cosas
las estoy haciendo nuevas!'' Y me dijo: ``Escribe esto, porque estas
palabras son fieles y verdaderas''. \bibleverse{6} Entonces me dijo:
...
vida. \bibleverse{7} Los que sean victoriosos heredarán todas estas
cosas, y yo seré su Dios, y ellos serán mis hijos. \bibleverse{8} Pero
...
\bibleverse{9} Uno de los siete ángeles que tenía las siete copas con
...
la novia, a la esposa del Cordero''. \footnote{\textbf{21:9} Apoc 15,1;
  Apoc 15,6-7; Apoc 19,7} \bibleverse{10} Y me llevó en el Espíritu a la
cima de una montaña muy alta. Ahí me mostró la ciudad santa, Jerusalén,
descendiendo del cielo de Dios, \bibleverse{11} brillando con la gloria
de la presencia de Dios. La luz resplandecía como una piedra preciosa,
un jaspe, transparente y brillante. \bibleverse{12} Y el muro de la
...
Israel. \bibleverse{13} Y había tres puertas en el Este, tres puertas en
el Norte, tres puertas en el Sur, y tres puertas en el Oeste.
\bibleverse{14} El muro de la ciudad tenía doce fundamentos, y sobre
ellos estaban inscritos los nombres de los doce apóstoles del Cordero.

\bibleverse{15} El ángel que me habló tenía una vara de medir para medir
la ciudad, sus puertas, y su muro. \footnote{\textbf{21:15} Ezeq 40,3}
\bibleverse{16} La ciudad era cuadrada. La longitud era la misma que la
anchura. Midió la ciudad con una vara, y era de 12:000
estadios.\footnote{\textbf{21:16} Aproximadamente 1. 500 millas.} La
longitud, la anchura y la altura, eran iguales. \bibleverse{17} Entonces
...
\bibleverse{18} El muro estaba hecho de jaspe. Y la ciudad estaba hecha
de oro puro, que parecía de vidrio. \bibleverse{19} Los fundamentos del
...
el cuarto de esmeralda, \bibleverse{20} el quinto de sardónice, el sexto
...
de amatista. \bibleverse{21} Las doce puertas estaban hechas de perlas,
cada una hecha de una sola perla. La calle principal estaba hecha de oro
puro, transparente como el vidrio.

\bibleverse{22} Y no vi Templo allí, porque el Señor Dios Todo poderoso,
y el Cordero, son su Templo. \bibleverse{23} La ciudad no necesita del
...
\bibleverse{24} Las naciones caminarán por su luz y los reyes de la
tierra traerán su gloria a la ciudad. \bibleverse{25} Las puertas de la
ciudad no serán cerradas durante el día (allí no habrá noche).
\bibleverse{26} Y la honra y la gloria de las naciones serán traídas a
la ciudad. \bibleverse{27} Nada impuro entrará allí, ni ninguno que
...
\bibleverse{1} Y el ángel me mostró el río de agua de vida, limpio como
el cristal, que brotaba desde el trono de Dios y del Cordero,
\footnote{\textbf{22:1} Ezeq 47,1; Ezeq 47,12; Zac 14,8; Gén 2,9}
\bibleverse{2} justo en medio de la calle principal de la ciudad. A
...
la sanidad de los pueblos de todas las naciones. \bibleverse{3} Y allí
no habrá más maldición.\footnote{\textbf{22:3} O ``alguna cosa
  maldita''.} El trono de Dios y del Cordero estará en la ciudad, y sus
siervos lo adorarán. \bibleverse{4} Ellos verán su rostro, y su nombre
estará escrito sobre sus frentes. \footnote{\textbf{22:4} Apoc 3,12}
\bibleverse{5} Y no habrá más noche, y no habrá necesidad de luz de una
...
\bibleverse{6} Entonces el ángel me dijo: ``Estas palabras son fieles y
...
\bibleverse{7} ``¡Yo vengo pronto!\footnote{\textbf{22:7} Se entiende
...
\bibleverse{8} Yo soy Juan, quien escuchó y vio todas estas cosas.
Cuando las vi y las escuché, caí a los pies del ángel que me había
mostrado estas cosas, para adorarlo. \bibleverse{9} Entonces me dijo:
...
\bibleverse{10} Entonces me dijo: ``No selles las palabras de profecía
de este libro y ni las guardes en secreto, porque el tiempo está cerca.
\footnote{\textbf{22:10} Apoc 1,3; Apoc 10,4} \bibleverse{11} Deja que
...
\bibleverse{12} ``Yo vengo pronto, y traigo mi recompensa para dar a
todos conforme a lo que hayan hecho. \footnote{\textbf{22:12} Is 40,10}
\bibleverse{13} Yo soy el Alfa y la Omega, el primero y el último, el
principio y el fin. \footnote{\textbf{22:13} Apoc 1,11; Heb 13,8}
\bibleverse{14} Benditos los que lavan sus túnicas\footnote{\textbf{22:14}
...
vida, y para poder entrar a la ciudad por las puertas. \footnote{\textbf{22:14}
  Apoc 7,14} \bibleverse{15} ``Los que están fuera de la ciudad son
...
\bibleverse{16} ``Yo, Jesús, he enviado a mi ángel para darte este
...
\bibleverse{17} El Espíritu y la novia dicen: ``Ven''. Quien escucha
...
\bibleverse{18} Declaro solemnemente a todos los que escuchan las
...
\bibleverse{19} Si alguno quita las palabras proféticas de este libro,
Dios le quitará su parte en el árbol de la vida y de la ciudad santa que
se describe en este libro. \bibleverse{20} Aquél que confirma todo esto
dice: ``Sí, yo vengo pronto''. Amén, ven, Señor Jesús. \footnote{\textbf{22:20}
  1Cor 16,22}

\bibleverse{21} Que la gracia del Señor Jesús esté con los creyentes.
Amén.
