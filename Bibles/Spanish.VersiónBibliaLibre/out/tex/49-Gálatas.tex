...
\bibleverse{1} Esta carta viene de Pablo, un apóstol no designado por
...
a Jesús de entre los muertos. \bibleverse{2} Todos los hermanos y
hermanas que están aquí conmigo se han unido para enviar esta carta a
las iglesias de Galacia. \bibleverse{3} Que la gracia y la paz de Dios
el Padre y de nuestro Señor Jesucristo esté con ustedes. \bibleverse{4}
...
\bibleverse{5} A él sea la gloria por siempre y para siempre. Amén.
...
\bibleverse{6} Estoy sorprendido de cuán rápidamente están abandonando
al Dios que los llamó por la gracia de Cristo. Se están convirtiendo a
otro tipo de buena noticia \bibleverse{7} ¡una que no es ninguna buena
noticia en absoluto! Hay algunos por ahí confundiéndolos, queriendo
pervertir la buena noticia de Cristo. \bibleverse{8} Pero si alguno,
...
\bibleverse{9} Les vuelvo a decir lo que ya les he dicho antes: ¡si
...
\bibleverse{10} ¿De quién creen que quiero aprobación? ¿De la gente o de
...
\bibleverse{11} Permítanme aclarar esto, amigos míos, respecto a la
buena noticia que estoy declarando: Que no vino de ningún ser humano.
\bibleverse{12} No la recibí de nadie, y nadie me la enseñó. Fue Cristo
...
\bibleverse{13} Ustedes oyeron sobre mi conducta como seguidor de la
religión judía, y cómo perseguí con fanatismo a la iglesia de Dios,
tratando de destruirla de manera salvaje. \bibleverse{14} Incluso superé
a mis contemporáneos en la práctica de la religión judía porque era un
seguidor celoso de las tradiciones de mis ancestros. \bibleverse{15}
...
nacimiento) me llamó por su gracia, y se complació \footnote{\textbf{1:15}
  Rom 1,1; Jer 1,5} \bibleverse{16} en revelarme a su Hijo, a fin de que
pudiera anunciar la buena noticia a las naciones,\footnote{\textbf{1:16}
  ...
  Mat 16,17; Gal 2,7} \bibleverse{17} No fui a Jerusalén para hablarle a
...
\bibleverse{18} Después de tres años fui a Jerusalén a visitar a Pedro.
Me quedé allí dos semanas con él. \footnote{\textbf{1:18} Juan 1,42;
  Hech 9,26-27} \bibleverse{19} Tampoco vi a otros apóstoles, excepto a
Santiago, el hermano del Señor. \footnote{\textbf{1:19} Mat 13,55}
\bibleverse{20} (¡Permítanme asegurarles ante Dios que no miento sobre
las cosas que les estoy escribiendo!) \bibleverse{21} Luego fui a Siria
y a Cilicia. \footnote{\textbf{1:21} Hech 9,30}

\bibleverse{22} Aún así, los que estaban en las iglesias de Judea no me
habían visto personalmente. \bibleverse{23} Ellos solo escuchaban a la
gente decir: ``¡El hombre que solía perseguirnos ahora está esparciendo
la fe que una vez intentó destruir!'' \bibleverse{24} Y alababan a Dios
por causa de mí.
...
Entonces llevé conmigo a Tito. \bibleverse{2} Fui por causa de lo que
...
en vano. \bibleverse{3} Pero sucedió que estando allá nadie insistió en
que Tito, quien iba conmigo, fuera circuncidado, aunque él era griego.
\footnote{\textbf{2:3} Hech 16,3; 1Cor 9,21} \bibleverse{4} (Ese asunto
...
en esclavos. \bibleverse{5} Pero nunca cedimos a ellos, ni siquiera por
...
\bibleverse{6} Pero aquellos considerados como importantes, no añadieron
...
juzga a las personas del mismo modo que yo lo hago). \footnote{\textbf{2:6}
  2Cor 11,5; 2Cor 11,23} \bibleverse{7} Por el contrario, cuando se
...
judíos, \footnote{\textbf{2:7} Efes 3,1-2} \bibleverse{8} (pues el mismo
...
apóstol a los extranjeros), \bibleverse{9} y cuando reconocieron también
...
\bibleverse{10} Nosotros trabajaríamos por los extranjeros, mientras
...
\bibleverse{11} Sin embargo, cuando Pedro fue a Antioquía, tuve que
confrontarlo directamente, porque evidentemente estaba equivocado en lo
que hacía. \bibleverse{12} Antes de que algunos de los amigos de
...
ser circuncidados. \footnote{\textbf{2:12} Hech 11,2-3} \bibleverse{13}
...
\bibleverse{14} Cuando comprendí que no tenían una posición firme en
...
\bibleverse{15} Podemos ser judíos por nacimiento, y no `pecadores' como
los extranjeros, \bibleverse{16} pero sabemos que nadie es justificado
...
requisitos de la ley''. \bibleverse{17} Porque si, al intentar ser
...
que no! \bibleverse{18} Pues si tuviera que reconstruir lo que he
...
ley.\footnote{\textbf{2:18} En otras palabras, si vuelvo al antiguo
  ...
  pecador.} \bibleverse{19} Porque a través de la ley morí a la ley para
poder vivir para Dios. \footnote{\textbf{2:19} Rom 7,6} \bibleverse{20}
...
\bibleverse{21} ¿Cómo podría rechazar la gracia de Dios? ¡Pues si
...
\bibleverse{1} ¡Oh, gálatas, cuán insensatos!\footnote{\textbf{3:1} La
...
les fue mostrada claramente para que pudieran ver! \bibleverse{2}
Díganme, entonces, ¿recibieron el Espíritu por guardar la ley o por
creer en lo que habían oído? \bibleverse{3} ¡En realidad han perdido la
...
\bibleverse{4} ¿Sufrieron tanto para nada? (Realmente no fue para nada,
¿o sí?) \bibleverse{5} Permítanme preguntarles esto: ¿Acaso
...
\bibleverse{6} Es como Abraham, que ``confío en Dios, y fue considerado
como hombre justo''.\footnote{\textbf{3:6} Citando Génesis 15:6.}
\footnote{\textbf{3:6} Rom 4,3} \bibleverse{7} De modo que ustedes deben
reconocer que los que creen en Dios son los hijos de Abraham.
\bibleverse{8} En la Escritura estaba predicho que Dios justificaría a
...
todas las naciones''. \bibleverse{9} En consecuencia, los que creen en
Dios son bendecidos junto a Abraham, que confió en Dios.

\bibleverse{10} Todos los que dependen del cumplimiento de la
...
\bibleverse{11} Está claro que nadie es justificado delante de Dios por
el intento de guardar la ley, porque ``los justos vivirán por su fe en
Dios''.\footnote{\textbf{3:11} Citando Habacuc 2:4.} \bibleverse{12} Y
...
\bibleverse{13} Pero Cristo nos ha rescatado de la maldición de la ley
...
\bibleverse{14} De modo que a través de Cristo Jesús la bendición de
...
\bibleverse{15} Hermanos y hermanas, aquí tenemos un ejemplo de la vida
diaria. Si se alista un contrato y este es acordado, firmado y sellado,
nadie puede ignorarlo o añadirle más cosas. \bibleverse{16} Pues las
promesas les fueron dadas a Abraham y a su hijo.\footnote{\textbf{3:16}
  Literalmente, ``semilla''.} No dice ``hijos'', en plural, sino en
singular: ``y a tu hijo'', queriendo decir, Cristo. \bibleverse{17}
...
la promesa. \bibleverse{18} Si la herencia se deriva de la obediencia a
...
\bibleverse{19} ¿Qué sentido tiene la ley, entonces? Fue dada para
...
de un mediador. \footnote{\textbf{3:19} Rom 5,20; Hech 7,38; Hech 7,53;
  Éxod 5,5; Heb 2,2} \bibleverse{20} Pero no se necesita de un mediador
...
\bibleverse{21} ¿De modo que la ley obra en contra de las promesas de
...
de ella. \bibleverse{22} Pero la Escritura nos dice que todos somos
...
\bibleverse{23} Antes de que confiáramos en Jesús permanecíamos bajo
custodia de la ley hasta que se reveló este camino de la fe. \footnote{\textbf{3:23}
  Gal 4,3} \bibleverse{24} La ley fue nuestro guardián hasta que vino
...
\bibleverse{25} Pero ahora que ha llegado este camino de fe en Jesús, ya
no necesitamos de tal guardián. \footnote{\textbf{3:25} Rom 10,4}
\bibleverse{26} Porque ustedes son hijos de Dios por medio de su fe en
Jesucristo. \footnote{\textbf{3:26} Juan 1,12; Rom 8,17} \bibleverse{27}
Todos los que de ustedes fueron bautizados en Cristo se han vestido de
Cristo. \footnote{\textbf{3:27} Rom 6,3; Rom 13,14} \bibleverse{28} Ya
...
\bibleverse{29} ¡Si son de Cristo, son hijos de Abraham, y herederos de
la promesa!
...
\bibleverse{1} Permítanme explicarles lo que estoy diciendo. Un heredero
que es menor de edad no es distinto a un esclavo, aunque el heredero sea
el propietario de todo. \bibleverse{2} Pues un heredero está sujeto a
los guardias y administradores hasta que llegue el tiempo establecido
por su padre. \bibleverse{3} Lo mismo sucede con nosotros. Cuando éramos
...
\footnote{\textbf{4:3} Gal 4,8-10; Gal 5,1; Col 2,20} \bibleverse{4}
...
nacido bajo el gobierno de la ley, \footnote{\textbf{4:4} Mar 1,15; Efes
  1,10} \bibleverse{5} para poder rescatar a los que fueron cautivos
bajo el dominio de la ley, a fin de que pudiéramos recibir la heredad de
hijos adoptivos. \bibleverse{6} Para demostrar que ustedes son sus
...
haciéndonos clamar: ``Abba'', que quiere decir ``Padre''. \footnote{\textbf{4:6}
  Rom 8,15} \bibleverse{7} Puesto que ya no eres un esclavo, sino un
...
\bibleverse{8} Cuando ustedes no conocían a Dios, estaban esclavizados
por los supuestos ``dioses'' de este mundo. \bibleverse{9} Pero ahora
...
valor? ¿Quieren ser esclavos de esas reglas nuevamente? \bibleverse{10}
Ustedes observan días especiales y meses, temporadas y años.\footnote{\textbf{4:10}
  ...
  Rom 14,5; Col 2,16; Col 2,20-21} \bibleverse{11} Y me preocupa que
todo lo que hice por ustedes haya sido tiempo perdido. \footnote{\textbf{4:11}
  2Jn 1,-1}

\bibleverse{12} Les ruego, mis amigos: sean como yo, porque yo me volví
como ustedes\footnote{\textbf{4:12} En otras palabras, un ``gentil
  liberado''.} . Ustedes nunca me trataron mal. \bibleverse{13}
...
enfermo durante mi primera visita.\footnote{\textbf{4:13} Parece ser que
  ...
  Hech 16,6; 1Cor 2,3} \bibleverse{14} Y aunque mi enfermedad fue muy
...
\bibleverse{15} ¿Entonces qué ha pasado con su gratitud? ¡Déjenme
decirles que en ese tiempo, si ustedes hubieran podido sacarse los ojos
para dármelos a mí, de seguro lo habrían hecho! \bibleverse{16} ¿Qué es
lo que ha ocurrido, entonces? ¿Me he convertido en enemigo de ustedes
por decir la verdad? \bibleverse{17} Estas personas anhelan tener el
...
apoyarlos. \bibleverse{18} Por supuesto, es bueno hacer el bien. ¡Pero
...
\bibleverse{19} Mis queridos amigos, quiero trabajar a su lado hasta que
el carácter de Cristo se haya duplicado en ustedes. \footnote{\textbf{4:19}
  1Cor 4,15} \bibleverse{20} Desearía poder acompañarlos ahora mismo y
...
\bibleverse{21} Respóndanme esto, ustedes que quieren vivir bajo la ley:
¿No escuchan lo que la ley está diciendo? \bibleverse{22} Como dice la
...
\bibleverse{23} Sin embargo, el hijo de la sierva nació por planes
...
\bibleverse{24} Esto nos muestra una analogía: estas dos mujeres
...
\bibleverse{25} Agar simboliza al Monte Sinaí en Arabia, y corresponde a
la Jerusalén actual, porque ella está en esclavitud con sus hijos.
\bibleverse{26} Pero la Jerusalén celestial es libre. Ella es nuestra
madre. \footnote{\textbf{4:26} Heb 12,22; Apoc 21,2} \bibleverse{27}
...
\bibleverse{28} Ahora, amigos míos, nosotros somos hijos de la promesa
tal como Isaac. \bibleverse{29} Sin embargo, así como el que nació por
planes humanos persiguió al que nació por el Espíritu, del mismo modo
ocurre hoy. \bibleverse{30} Pero ¿qué dice la Escritura? ``Despidan a la
...
\bibleverse{31} Por lo tanto, mis amigos, no somos hijos de la sierva,
sino de la mujer libre.

\hypertarget{section-4}{%
\section{5}\label{section-4}}

\bibleverse{1} Cristo nos libertó para que pudiéramos tener verdadera
...
\bibleverse{2} Permítanme decirles francamente: si dependen del camino
de la circuncisión, Cristo no les será de beneficio en absoluto.
\bibleverse{3} Permítanme repetir: todo hombre que es circuncidado tiene
que cumplir toda la ley. \bibleverse{4} Los que entre ustedes creen que
pueden ser justificados por la ley, están separados de Cristo y han
abandonado la gracia. \bibleverse{5} Porque por medio del Espíritu
creemos y aguardamos la esperanza de ser justificados. \bibleverse{6}
...
\bibleverse{7} ¡Lo estaban haciendo muy bien! ¿Quién se interpuso en el
camino y les impidió convencerse de la verdad? \bibleverse{8} Esta
``persuasión'' sin duda no proviene de Aquél que los llama.
\bibleverse{9} Ustedes solo necesitan un poco de levadura para que
crezca toda la masa. \footnote{\textbf{5:9} 1Cor 5,6} \bibleverse{10}
...
\bibleverse{11} En cuanto a mí, hermanos y hermanas, si aún estamos en
...
\footnote{\textbf{5:11} Gal 6,12; 1Cor 1,23; 1Cor 15,30} \bibleverse{12}
...
\bibleverse{13} ¡Ustedes, mis hermanos y hermanas, fueron llamados para
...
amor. \bibleverse{14} Pues toda la ley se resume en este mandamiento:
``Amarás a tu prójimo como a ti mismo''.\footnote{\textbf{5:14} Citando
  Levítico 19:18.} \bibleverse{15} Pero si se atacan y se destruyen unos
...
\bibleverse{16} Mi consejo es que caminen por el Espíritu. No satisfagan
los deseos de su naturaleza pecaminosa. \bibleverse{17} Porque los
...
\bibleverse{18} Pero si el Espíritu los guía, no están bajo la ley.
\bibleverse{19} Es claro lo que la naturaleza pecaminosa trae como
resultado: inmoralidad sexual, indecencia, sensualidad, \footnote{\textbf{5:19}
  1Cor 6,9-10} \bibleverse{20} idolatría, hechicería, odio, rivalidad,
celos, rabia, ambición egoísta, disensión, herejía, \bibleverse{21}
...
\bibleverse{22} Pero el fruto del Espíritu es amor, gozo, paz,
paciencia, benignidad, bondad, fe, \footnote{\textbf{5:22} Efes 5,9}
\bibleverse{23} mansedumbre y dominio propio. ¡No hay ley que se oponga
a estas cosas! \footnote{\textbf{5:23} 1Tim 1,9} \bibleverse{24} Los que
...
\bibleverse{25} Si vivimos en el Espíritu debemos caminar también en el
...
\bibleverse{1} Mis amigos, si alguno se extravía por causa del pecado,
...
de mansedumbre. Y cuídense de no ser tentados también. \footnote{\textbf{6:1}
  Mat 18,15; Sant 5,19} \bibleverse{2} Sobrelleven unos las cargas de
los otros, pues de esta manera cumplen la ley de Cristo. \footnote{\textbf{6:2}
  2Cor 11,29} \bibleverse{3} Los que creen que son importantes---cuando
realmente no son nada---se engañan a sí mismos. \bibleverse{4} Examinen
cuidadosamente sus acciones. Así podrán estar satisfechos de ustedes
mismos, sin compararse con nadie más. \bibleverse{5} Debemos ser
responsables de nosotros mismos. \footnote{\textbf{6:5} Rom 14,12}

\bibleverse{6} Aquellos que reciben enseñanza de la Palabra deben tratar
bien a sus maestros, compartiendo con ellos todas las cosas buenas.
\footnote{\textbf{6:6} 1Cor 9,14}

\bibleverse{7} No se dejen engañar, Dios no puede ser tratado con
desacato: todo lo que siembren, eso cosecharán. \bibleverse{8} Si
...
\bibleverse{9} No nos cansemos nunca de hacer el bien, pues segaremos en
el momento apropiado, si somos perseverantes. \footnote{\textbf{6:9}
  2Tes 3,13} \bibleverse{10} Así que mientras tengamos
...
\bibleverse{11} ¡Miren cuán grandes son las letras, ahora que les
escribo con mi propia mano! \bibleverse{12} Esas personas que solo
quieren dar una buena impresión los están obligando a circuncidarse para
no ser perseguidos ellos por la cruz de Cristo. \bibleverse{13} Incluso
...
\bibleverse{14} Ojalá yo nunca me jacte de nada, excepto en la cruz de
...
\bibleverse{15} La circuncisión o la incircuncisión no importan. ¡Lo que
importa es que fuimos creados nuevamente! \footnote{\textbf{6:15} Gal
  5,6; 1Cor 7,19; 2Cor 5,17} \bibleverse{16} ¡Paz y misericordia a todos
los que siguen este principio, y al Israel de Dios! \footnote{\textbf{6:16}
  Sal 125,5; Fil 3,16}

\bibleverse{17} Por favor, no me agobien más, porque llevo en mi cuerpo
...
\bibleverse{18} Mis hermanos y hermanas, que la gracia de nuestro Señor
