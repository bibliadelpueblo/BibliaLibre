...
\bibleverse{4} Und des HErrn Wort geschah zu mir und sprach:
\bibleverse{5} Ich kannte dich, ehe denn ich dich im Mutterleibe
...
\bibleverse{6} Ich aber sprach: Ach Herr HErr, ich tauge nicht, zu
predigen; denn ich bin zu jung. \footnote{\textbf{1:6} 2Mo 3,11; Jes
  6,5-8}

\bibleverse{7} Der HErr sprach aber zu mir: Sage nicht: „Ich bin zu
jung``; sondern du sollst gehen, wohin ich dich sende, und predigen, was
ich dich heiße. \bibleverse{8} Fürchte dich nicht vor ihnen; denn ich
bin bei dir und will dich erretten, spricht der HErr.

\bibleverse{9} Und der HErr reckte seine Hand aus und rührte meinen Mund
an und sprach zu mir: Siehe, ich lege meine Worte in deinen Mund.
\footnote{\textbf{1:9} 5Mo 18,18} \bibleverse{10} Siehe, ich setze dich
...
\bibleverse{11} Und es geschah des HErrn Wort zu mir und sprach:
Jeremia, was siehst du? Ich sprach: Ich sehe einen erwachenden Zweig.

\bibleverse{12} Und der HErr sprach zu mir: Du hast recht gesehen; denn
ich will wachen über mein Wort, dass ich's tue. \footnote{\textbf{1:12}
  Jer 31,28}

\bibleverse{13} Und es geschah des HErrn Wort zum andernmal zu mir und
sprach: Was siehst du? Ich sprach: Ich sehe einen heißsiedenden Topf von
Mitternacht her.

\bibleverse{14} Und der HErr sprach zu mir: Von Mitternacht wird das
Unglück ausbrechen über alle, die im Lande wohnen. \bibleverse{15} Denn
...
alle Städte Judas. \bibleverse{16} Und ich will das Recht lassen über
...
\bibleverse{1} Und des HErrn Wort geschah zu mir und sprach:
\bibleverse{2} Gehe hin und predige öffentlich zu Jerusalem und sprich:
...
Lande, da man nichts sät, \bibleverse{3} da Israel des HErrn eigen war
und seine erste Frucht. Wer sie fressen wollte, musste Schuld haben, und
Unglück musste über ihn kommen, spricht der HErr.

\bibleverse{4} Höret des HErrn Wort, ihr vom Hause Jakob und alle
Geschlechter vom Hause Israel. \bibleverse{5} So spricht der HErr: Was
...
\footnote{\textbf{2:5} Mi 6,3-6} \bibleverse{6} und dachten nie einmal:
...
dem Lande, da niemand wandelte noch ein Mensch wohnte? \bibleverse{7}
...
mir mein Erbe zum Gräuel. \bibleverse{8} Die Priester gedachten nicht:
...
Baal und hingen an den unnützen Götzen. \bibleverse{9} Darum muss ich
...
\bibleverse{10} Gehet hin in die Inseln Chittim und schauet, und sendet
nach Kedar und merket mit Fleiß und schauet, ob's daselbst so zugeht!
\bibleverse{11} ob die Heiden ihre Götter ändern, wiewohl sie doch nicht
Götter sind! Und mein Volk hat doch seine Herrlichkeit verändert um
einen unnützen Götzen. \bibleverse{12} Sollte sich doch der Himmel davor
entsetzen, erschrecken und sehr erbeben, spricht der HErr.
\bibleverse{13} Denn mein Volk tut eine zwiefache Sünde: mich, die
...
\footnote{\textbf{2:13} Jer 17,13; Ps 36,10}
...
\bibleverse{20} Denn du hast immerdar dein Joch zerbrochen und deine
...
Götzen nach. \bibleverse{21} Ich aber hatte dich gepflanzt zu einem
...
geraten zu einem bitteren, wilden Weinstock? \footnote{\textbf{2:21} Jes
  5,1-4} \bibleverse{22} Und wenn du dich gleich mit Lauge wüschest und
nähmest viel Seife dazu, so gleißt doch deine Untugend desto mehr vor
mir, spricht der Herr HErr. \bibleverse{23} Wie darfst du denn sagen:
...
\bibleverse{24} Du läufst umher wie eine Kamelstute in der Brunst, und
...
weit laufen; am Feiertage sieht man es wohl. \bibleverse{25} Schone doch
...
dir nicht nachlaufen? \bibleverse{32} Vergisst doch eine Jungfrau ihres
...
\bibleverse{34} Überdas findet man Blut der armen und unschuldigen
Seelen bei dir an allen Orten, und das ist nicht heimlich, sondern
offenbar an diesen Orten. \bibleverse{35} Doch sprichst du: Ich bin
...
\bibleverse{1} Und er spricht: Wenn sich ein Mann von seinem Weibe
...
\bibleverse{6} Und der HErr sprach zu mir zur Zeit des Königs Josia:
...
\bibleverse{7} Und ich sprach, da sie solches alles getan hatte: Bekehre
dich zu mir. Aber sie bekehrte sich nicht. Und obwohl ihre Schwester
Juda, die Verstockte, gesehen hat, \bibleverse{8} wie ich der
...
\bibleverse{11} Und der HErr sprach zu mir: Die abtrünnige Israel ist
fromm gegen die verstockte Juda. \bibleverse{12} Gehe hin und rufe diese
...
ewiglich zürnen. \bibleverse{13} Allein erkenne deine Missetat, dass du
...
\bibleverse{14} Bekehret euch, ihr abtrünnigen Kinder, spricht der HErr;
...
\footnote{\textbf{3:14} Hos 2,21; Jes 6,13} \bibleverse{15} und will
euch Hirten geben nach meinem Herzen, die euch weiden sollen mit Lehre
und Weisheit. \footnote{\textbf{3:15} Jer 23,4} \bibleverse{16} Und es
...
Gedanken ihres bösen Herzens. \footnote{\textbf{3:17} Jes 2,2-4; Jes
  65,2} \bibleverse{18} Zu der Zeit wird das Haus Juda gehen zum Hause
...
ihres Gottes, vergessen haben. \bibleverse{22} So kehret nun wieder, ihr
...
\bibleverse{24} Und die Schande hat gefressen unserer Väter Arbeit von
unserer Jugend auf samt ihren Schafen, Rindern, Söhnen und Töchtern.
\bibleverse{25} Denn worauf wir uns verließen, das ist uns jetzt eitel
...
\bibleverse{1} Willst du dich, Israel, bekehren, spricht der HErr, so
bekehre dich zu mir. Und wenn du deine Gräuel wegtust von meinem
Angesicht, so sollst du nicht vertrieben werden. \bibleverse{2} Alsdann
...
\bibleverse{3} Denn so spricht der HErr zu denen in Juda und zu
...
\bibleverse{5} Verkündiget in Juda und schreiet laut zu Jerusalem und
...
\bibleverse{6} Werft zu Zion ein Panier auf; fliehet und säumet nicht!
...
\bibleverse{9} Zu der Zeit, spricht der HErr, wird dem König und den
Fürsten das Herz entfallen; die Priester werden bestürzt und die
Propheten erschrocken sein.

\bibleverse{10} Ich aber sprach: Ach Herr HErr! du hast's diesem Volk
...
\bibleverse{14} So wasche nun, Jerusalem, dein Herz von der Bosheit, auf
dass dir geholfen werde. Wie lange wollen bei dir bleiben deine leidigen
Gedanken?

\bibleverse{15} Denn es kommt ein Geschrei von Dan her und eine böse
Botschaft vom Gebirge Ephraim. \bibleverse{16} Saget an den Heiden,
verkündiget in Jerusalem, dass Hüter kommen aus fernen Landen und werden
schreien wider die Städte Judas. \bibleverse{17} Sie werden sich um sie
her lagern wie die Hüter auf dem Felde; denn sie haben mich erzürnt,
spricht der HErr. \footnote{\textbf{4:17} Jer 1,15; Jer 6,3}
\bibleverse{18} Das hast du zum Lohn für dein Wesen und dein Tun. Dann
...
Zorn. \bibleverse{27} Denn so spricht der HErr: Das ganze Land soll wüst
werden, und ich will's doch nicht gar aus machen. \footnote{\textbf{4:27}
  Jer 5,10; Jer 5,18} \bibleverse{28} Darum wird das Land betrübt und
...
\bibleverse{1} Gehet durch die Gassen zu Jerusalem und schauet und
...
\bibleverse{2} Und wenn sie schon sprechen: „Bei dem lebendigen
Gott!{}``, so schwören sie doch falsch.

\bibleverse{3} HErr, deine Augen sehen nach dem Glauben. Du schlägst
...
weiß nichts um des HErrn Weg und um ihres Gottes Recht. \bibleverse{5}
...
\bibleverse{6} Darum wird sie auch der Löwe, der aus dem Walde kommt,
...
\bibleverse{12} Sie verleugnen den HErrn und sprechen: „Das ist er
...
\bibleverse{14} Darum spricht der HErr, der Gott Zebaoth: Weil ihr
...
\bibleverse{18} Doch will ich's, spricht der HErr, zur selben Zeit mit
euch nicht gar aus machen. \bibleverse{19} Und ob sie würden sagen:
...
\bibleverse{1} Fliehet, ihr Kinder Benjamin, aus Jerusalem und blaset
...
ein großer Jammer. \bibleverse{2} Die Tochter Zion ist wie eine schöne
und lustige Aue. \bibleverse{3} Aber es werden Hirten über sie kommen
...
\bibleverse{6} Denn also spricht der HErr Zebaoth: Fället Bäume und
...
\bibleverse{9} So spricht der HErr Zebaoth: Was übriggeblieben ist von
...
es nicht. \bibleverse{11} Darum bin ich von des HErrn Drohen so voll,
...
\bibleverse{16} So spricht der HErr: Tretet auf die Wege und schauet und
...
\bibleverse{17} Ich habe Wächter über dich gesetzt: Merket auf die
...
\bibleverse{21} Darum spricht der HErr also: Siehe, ich will diesem Volk
...
\bibleverse{22} So spricht der HErr: Siehe, es wird ein Volk kommen von
Mitternacht, und ein großes Volk wird sich erregen vom Ende der Erde,
\footnote{\textbf{6:22} Jer 5,15; 5Mo 28,49} \bibleverse{23} die Bogen
...
\bibleverse{1} Dies ist das Wort, welches geschah zu Jeremia vom HErrn,
und sprach: \bibleverse{2} Tritt ins Tor im Hause des HErrn und predige
...
\bibleverse{3} So spricht der HErr Zebaoth, der Gott Israels: Bessert
...
Tempel! \bibleverse{5} sondern bessert euer Leben und Wesen, dass ihr
recht tut einer gegen den anderen \bibleverse{6} und den Fremdlingen,
...
Schaden: \footnote{\textbf{7:6} 2Mo 22,20-21} \bibleverse{7} so will ich
immer und ewiglich bei euch wohnen an diesem Ort, in dem Lande, das ich
euren Vätern gegeben habe. \bibleverse{8} Aber nun verlasset ihr euch
auf Lügen, die nichts nütze sind. \bibleverse{9} Daneben seid ihr Diebe,
Mörder, Ehebrecher und Meineidige und räuchert dem Baal und folgt
fremden Göttern nach, die ihr nicht kennt. \bibleverse{10} Darnach kommt
...
Gräuel tun. \bibleverse{11} Haltet ihr denn dieses Haus, das nach meinem
...
hören, ich rufe euch, und ihr wollt nicht antworten: \footnote{\textbf{7:13}
  Spr 1,24; Jes 65,12} \bibleverse{14} so will ich dem Hause, das nach
...
\footnote{\textbf{7:14} Jer 26,6} \bibleverse{15} und will euch von
meinem Angesicht wegwerfen, wie ich weggeworfen habe alle eure Brüder,
den ganzen Samen Ephraims.

\footnote{\textbf{7:15} 2Kö 17,18; 2Kö 17,20; 2Kö 17,23}
...
\bibleverse{20} Darum spricht der Herr HErr: Siehe, mein Zorn und mein
...
\bibleverse{21} So spricht der HErr Zebaoth, der Gott Israels: Tut eure
Brandopfer und anderen Opfer zuhauf und esset Fleisch. \bibleverse{22}
...
\footnote{\textbf{7:22} Mi 6,6-8; 1Sam 15,22} \bibleverse{23} sondern
...
die ich euch gebiete, auf dass es euch wohl gehe. \footnote{\textbf{7:23}
  2Mo 19,5} \bibleverse{24} Aber sie wollen nicht hören noch ihre Ohren
...
Herzens Gedünken und gingen hinter sich und nicht vor sich. \footnote{\textbf{7:24}
  Jer 11,8; Jes 65,2} \bibleverse{25} Ja, von dem Tage an, da ich eure
Väter aus Ägyptenland geführt habe, bis auf diesen Tag habe ich stets zu
euch gesandt alle meine Knechte, die Propheten. \bibleverse{26} Aber sie
...
\bibleverse{29} Schneide deine Haare ab und wirf sie von dir und
...
genannt ist, dass sie es verunreinigen, \bibleverse{31} und bauen die
...
\footnote{\textbf{7:32} Jer 19,6} \bibleverse{33} Und die Leichname
...
\bibleverse{1} Zu derselben Zeit, spricht der HErr, wird man die Gebeine
...
Gräbern werfen; \bibleverse{2} und wird sie hinstreuen unter Sonne, Mond
...
\bibleverse{3} Und alle Übrigen von diesem bösen Volk, an welchem Ort
...
\bibleverse{4} Darum sprich zu ihnen: So spricht der HErr: Wo ist
jemand, so er fällt, der nicht gerne wieder aufstünde? Wo ist jemand,
wenn er irregeht, der nicht gerne wieder zurechtkäme? \bibleverse{5}
...
abwenden lassen. \bibleverse{6} Ich sehe und höre, dass sie nichts
...
im Streit. \bibleverse{7} Ein Storch unter dem Himmel weiß seine Zeit,
...
\bibleverse{8} Wie mögt ihr doch sagen: „Wir wissen, was recht ist, und
haben die heilige Schrift vor uns``? Ist's doch eitel Lüge, was die
Schriftgelehrten setzen. \bibleverse{9} Darum müssen solche Lehrer zu
...
\bibleverse{10} Darum will ich ihre Weiber den Fremden geben und ihre
...
\footnote{\textbf{8:10} Jer 6,13-15; Jes 56,11} \bibleverse{11} und
...
nicht schämen. Darum müssen sie fallen auf einen Haufen; und wenn ich
sie heimsuchen werde, sollen sie stürzen, spricht der HErr.
\bibleverse{13} Ich will sie also ablesen, spricht der HErr, dass keine
...
\bibleverse{14} Wo werden wir dann wohnen? Ja, sammelt euch dann und
...
\bibleverse{15} Wir hofften, es sollte Friede werden, so kommt nichts
Gutes; wir hofften, wir sollten heil werden, aber siehe, so ist mehr
Schaden da. \footnote{\textbf{8:15} Jer 14,19} \bibleverse{16} Man hört
...
\bibleverse{17} Denn siehe, ich will Schlangen und Basilisken unter euch
...
\bibleverse{18} Was mag mich in meinem Jammer erquicken? Mein Herz in
mir ist krank. \footnote{\textbf{8:18} Jer 4,19} \bibleverse{19} Siehe,
...
fremde, unnütze Gottesdienste? \bibleverse{20} „Die Ernte ist vergangen,
der Sommer ist dahin, und uns ist keine Hilfe gekommen.``

\bibleverse{21} Mich jammert herzlich, dass mein Volk so verderbt ist;
ich gräme mich und gehabe mich übel. \bibleverse{22} Ist denn keine
Salbe in Gilead, oder ist kein Arzt da? Warum ist denn die Tochter
meines Volks nicht geheilt? \bibleverse{23} Ach, dass ich Wasser genug
...
der HErr. \bibleverse{3} Ein jeglicher hüte sich vor seinem Freunde und
traue auch seinem Bruder nicht; denn ein Bruder unterdrückt den anderen,
und ein Freund verrät den anderen. \bibleverse{4} Ein Freund täuscht den
...
können. \bibleverse{5} Es ist allenthalben eitel Trügerei unter ihnen,
und vor Trügerei wollen sie mich nicht kennen, spricht der HErr.
\bibleverse{6} Darum spricht der HErr Zebaoth also: Siehe, ich will sie
...
\bibleverse{11} Wer nun weise wäre und ließe es sich zu Herzen gehen und
...
\bibleverse{12} Und der HErr sprach: Darum dass sie mein Gesetz
...
\bibleverse{14} darum spricht der HErr Zebaoth, der Gott Israels, also:
Siehe, ich will dieses Volk mit Wermut speisen und mit Galle tränken;
\footnote{\textbf{9:14} Jer 23,15} \bibleverse{15} ich will sie unter
...
\footnote{\textbf{9:15} 3Mo 26,33} \bibleverse{16} So spricht der HErr
...
eure Töchter weinen, und eine lehre die andere klagen: \bibleverse{20}
...
Straße. \bibleverse{21} So spricht der HErr: Sage: Der Menschen
Leichname sollen liegen wie der Mist auf dem Felde und wie Garben hinter
dem Schnitter, die niemand sammelt.

\bibleverse{22} So spricht der HErr: Ein Weiser rühme sich nicht seiner
...
der HErr. \footnote{\textbf{9:23} 1Kor 1,31; 2Kor 10,17} \bibleverse{24}
...
\bibleverse{1} Höret, was der HErr zu euch vom Hause Israel redet.
\bibleverse{2} So spricht der HErr: Ihr sollt nicht der Heiden Weise
lernen und sollt euch nicht fürchten vor den Zeichen des Himmels, wie
die Heiden sich fürchten. \bibleverse{3} Denn der Heiden Satzungen sind
...
\bibleverse{4} und schmückt sie mit Silber und Gold und heftet sie mit
Nägeln und Hämmern, dass sie nicht umfallen. \bibleverse{5} Es sind ja
...
\bibleverse{6} Aber dir, HErr, ist niemand gleich; du bist groß, und
dein Name ist groß, und kannst es mit der Tat beweisen. \bibleverse{7}
...
Königreichen deinesgleichen nicht. \bibleverse{8} Sie sind allzumal
Narren und Toren; denn ein Holz muss ja ein nichtiger Gottesdienst sein.
\bibleverse{9} Silbernes Blech bringt man aus Tharsis, Gold aus Uphas,
durch den Meister und Goldschmied zugerichtet; blauen und roten Purpur
zieht man ihm an, und ist alles der Weisen Werk. \bibleverse{10} Aber
...
\bibleverse{17} Tue deinen Kram weg aus dem Lande, die du wohnest in der
Feste. \bibleverse{18} Denn so spricht der HErr: Siehe, ich will die
Einwohner des Landes auf diesmal wegschleudern und will sie ängsten,
dass sie es fühlen sollen.

\bibleverse{19} Ach mein Jammer und mein Herzeleid! Ich denke aber: Es
ist meine Plage; ich muss sie leiden. \footnote{\textbf{10:19} Ps 77,11}
\bibleverse{20} Meine Hütte ist zerstört, und alle meine Seile sind
...
\bibleverse{21} Denn die Hirten sind zu Narren geworden und fragen nach
dem HErrn nicht; darum können sie auch nichts Rechtes lehren, und ihre
ganze Herde ist zerstreut.

\bibleverse{22} Siehe, es kommt ein Geschrei daher und ein großes Beben
...
\bibleverse{23} Ich weiß, HErr, dass des Menschen Tun steht nicht in
seiner Gewalt, und steht in niemands Macht, wie er wandle oder seinen
Gang richte. \bibleverse{24} Züchtige mich, HErr, -- doch mit Maßen und
nicht in deinem Grimm, auf dass du mich nicht aufreibest. \footnote{\textbf{10:24}
  Jer 46,28; Ps 6,2; Hab 1,12} \bibleverse{25} Schütte aber deinen Zorn
...
\bibleverse{1} Dies ist das Wort, das zu Jeremia geschah vom HErrn, und
sprach: \bibleverse{2} Höret die Worte dieses Bundes, dass ihr sie denen
in Juda und den Bürgern zu Jerusalem saget. \bibleverse{3} Und sprich zu
...
\bibleverse{4} den ich euren Vätern gebot des Tages, da ich sie aus
...
und ich will euer Gott sein, \bibleverse{5} auf dass ich den Eid halten
...
\bibleverse{6} Und der HErr sprach zu mir: Predige alle diese Worte in
den Städten Judas und auf den Gassen zu Jerusalem und sprich: Höret die
Worte dieses Bundes und tut darnach! \bibleverse{7} Denn ich habe euren
...
Stimme! \bibleverse{8} Aber sie gehorchten nicht, neigten auch ihre
...
\bibleverse{9} Und der HErr sprach zu mir: Ich weiß wohl, wie sie in
Juda und zu Jerusalem sich rotten. \bibleverse{10} Sie kehren sich eben
...
Bund gebrochen, den ich mit ihren Vätern gemacht habe. \bibleverse{11}
...
schreien, will ich sie nicht hören. \bibleverse{12} So lass denn die
...
\bibleverse{13} Denn so manche Stadt, so manche Götter hast du, Juda;
...
\bibleverse{15} Was haben meine Freunde in meinem Hause zu schaffen? Sie
...
\bibleverse{16} Der HErr nannte dich einen grünen, schönen, fruchtbaren
Ölbaum; aber nun hat er mit einem großen Mordgeschrei ein Feuer um ihn
lassen anzünden, dass seine Äste verderben müssen. \bibleverse{17} Denn
...
\bibleverse{18} Der HErr hat mir's offenbart, dass ich's weiß, und
zeigte mir ihr Vornehmen, \bibleverse{19} nämlich, dass sie mich wie ein
...
ausrotten, dass seines Namens nimmermehr gedacht werde. \footnote{\textbf{11:19}
  Jes 53,7} \bibleverse{20} Aber du, HErr Zebaoth, du gerechter Richter,
...
\bibleverse{21} Darum spricht der HErr also wider die Männer zu
...
sterben! \footnote{\textbf{11:21} Jer 1,1} \bibleverse{22} darum spricht
...
\bibleverse{23} denn ich will über die Männer zu Anathoth Unglück kommen
...
\bibleverse{1} HErr, wenn ich gleich mit dir rechten wollte, so behältst
...
\bibleverse{2} Du pflanzest sie, dass sie wurzeln und wachsen und Frucht
bringen. Nahe bist du in ihrem Munde, aber ferne von ihrem Herzen;
\bibleverse{3} mich aber, HErr, kennst du und siehst mich und prüfst
mein Herz vor dir. Reiße sie weg wie Schafe, dass sie geschlachtet
werden; sondere sie aus, dass sie gewürgt werden. \bibleverse{4} Wie
...
\bibleverse{14} So spricht der HErr wider alle meine bösen Nachbarn, die
...
reißen. \bibleverse{15} Und wenn ich sie nun ausgerissen habe, will ich
mich wiederum über sie erbarmen und will einen jeglichen zu seinem
Erbteil und in sein Land wiederbringen. \bibleverse{16} Und soll
...
werden. \footnote{\textbf{12:16} Jer 4,2; 5Mo 6,13} \bibleverse{17} Wo
...
\bibleverse{1} So spricht der HErr zu mir: Gehe hin und kaufe dir einen
leinenen Gürtel und gürte damit deine Lenden und mache ihn nicht nass.

\bibleverse{2} Und ich kaufte einen Gürtel nach dem Befehl des HErrn und
gürtete ihn um meine Lenden.

\bibleverse{3} Da geschah des HErrn Wort zum andernmal zu mir und
sprach: \bibleverse{4} Nimm den Gürtel, den du gekauft und um deine
...
\bibleverse{6} Nach langer Zeit aber sprach der HErr zu mir: Mache dich
...
\bibleverse{8} Da geschah des HErrn Wort zu mir und sprach:
\bibleverse{9} So spricht der HErr: Eben also will ich auch verderben
die große Hoffart Judas und Jerusalems. \bibleverse{10} Das böse Volk,
...
\bibleverse{11} Denn gleichwie ein Mann den Gürtel um seine Lenden
...
\bibleverse{12} So sage ihnen nun dieses Wort: So spricht der HErr, der
...
füllen soll? \bibleverse{13} So sprich zu ihnen: So spricht der HErr:
...
zu Jerusalem füllen, dass sie trunken werden sollen; \footnote{\textbf{13:13}
  Jer 25,15-18; Jes 51,17} \bibleverse{14} und will einen mit dem
...
HErr hat's geredet. \bibleverse{16} Gebet dem HErrn, eurem Gott, die
...
und dunkel machen wird. \bibleverse{17} Wollt ihr aber solches nicht
...
\bibleverse{18} Sage dem König und der Königin: Setzt euch herunter;
denn die Krone der Herrlichkeit ist euch von eurem Haupt gefallen.
\footnote{\textbf{13:18} Kla 5,16} \bibleverse{19} Die Städte gegen
...
\bibleverse{20} Hebet eure Augen auf und sehet, wie sie von Mitternacht
daherkommen. Wo ist nun die Herde, so dir befohlen war, deine herrliche
Herde? \bibleverse{21} Was willst du sagen, wenn er dich so heimsuchen
...
Weib in Kindsnöten. \bibleverse{22} Und wenn du in deinem Herzen sagen
...
geschehen. \bibleverse{23} Kann auch ein Mohr seine Haut wandeln oder
ein Parder seine Flecken? So könnt ihr auch Gutes tun, die ihr des Bösen
gewohnt seid. \footnote{\textbf{13:23} Ps 55,20} \bibleverse{24} Darum
will ich sie zerstreuen wie Stoppeln, die vor dem Winde aus der Wüste
verweht werden. \bibleverse{25} Das soll dein Lohn sein und dein Teil,
den ich dir zugemessen habe, spricht der HErr. Darum dass du mein
vergessen hast und verlässest dich auf Lügen, \bibleverse{26} so will
ich auch deine Säume hoch aufdecken, dass man deine Schande sehen muss.
\bibleverse{27} Denn ich habe gesehen deine Ehebrecherei, dein Geilheit,
...
\bibleverse{1} Dies ist das Wort, das der HErr zu Jeremia sagte von der
teuren Zeit: \bibleverse{2} Juda liegt jämmerlich, ihre Tore stehen
elend; es stehet kläglich auf dem Lande, und ist zu Jerusalem ein groß
Geschrei. \bibleverse{3} Die Großen schicken die Kleinen nach Wasser;
...
ihre Häupter. \bibleverse{4} Darum dass die Erde lechzet, weil es nicht
regnet auf die Erde, gehen die Ackerleute traurig und verhüllen ihre
Häupter. \footnote{\textbf{14:4} Joe 1,11} \bibleverse{5} Denn auch die
Hinden, die auf dem Felde werfen, verlassen die Jungen, weil kein Gras
wächst. \bibleverse{6} Das Wild steht auf den Hügeln und schnappt nach
...
\bibleverse{7} Ach HErr, unsere Missetaten haben's ja verdient; aber
hilf doch um deines Namens willen! denn unser Ungehorsam ist groß, damit
wir wider dich gesündigt haben. \bibleverse{8} Du bist der Trost Israels
und sein Nothelfer; warum stellst du dich, als wärest du ein Gast im
Lande und ein Fremder, der nur über Nacht darin bleibt? \bibleverse{9}
...
\bibleverse{10} So spricht der HErr von diesem Volk: Sie laufen gern hin
...
Volk um Gnade bitten. \bibleverse{12} Denn ob sie gleich fasten, so will
...
\bibleverse{13} Da sprach ich: Ach Herr HErr, siehe, die Propheten sagen
...
\bibleverse{14} Und der HErr sprach zu mir: Die Propheten weissagen
...
\bibleverse{15} Darum so spricht der HErr von den Propheten, die in
...
\bibleverse{19} Hast du denn Juda verworfen, oder hat deine Seele einen
...
Gutes. Wir hofften, wir sollten heil werden; aber siehe, so ist mehr
Schaden da. \bibleverse{20} HErr, wir erkennen unser gottlos Wesen und
unserer Väter Missetat; denn wir haben wider dich gesündigt.
\bibleverse{21} Aber um deines Namens willen lass uns nicht geschändet
...
\bibleverse{1} Und der HErr sprach zu mir: Und wenngleich Mose und
...
treibe sie weg von mir und lass sie hinfahren! \footnote{\textbf{15:1}
  Ps 99,6; Hes 14,14} \bibleverse{2} Und wenn sie zu dir sagen: Wo
...
Erden, dass sie gefressen und vertilgt werden sollen. \footnote{\textbf{15:3}
  Hes 14,21} \bibleverse{4} Und ich will sie in allen Königreichen auf
...
wünschen? \bibleverse{6} Du hast mich verlassen, spricht der HErr, und
...
\bibleverse{7} Ich will sie mit der Wurfschaufel zum Lande hinausworfeln
...
\bibleverse{8} Es sollen mir mehr Witwen unter ihnen werden, denn Sand
...
unversehens überfallen lassen, \bibleverse{9} dass die, die sieben
...
\bibleverse{10} Ach, meine Mutter, dass du mich geboren hast, wider den
...
\bibleverse{11} Der HErr sprach: Wohlan, ich will euer etliche
...
meinem Zorn über euch angegangen. \bibleverse{15} Ach HErr, du weißt es;
...
du weißt, dass ich um deinetwillen geschmäht werde. \bibleverse{16} Dein
...
Zebaoth. \bibleverse{17} Ich habe mich nicht zu den Spöttern gesellt
noch mich mit ihnen gefreut, sondern bin allein geblieben vor deiner
Hand; denn du hattest mich gefüllt mit deinem Grimm. \bibleverse{18}
...
\bibleverse{19} Darum spricht der HErr also: Wo du dich zu mir hältst,
...
zu dir fallen. \bibleverse{20} Denn ich habe dich wider dieses Volk zur
...
dich errette, spricht der HErr, \bibleverse{21} und will dich erretten
...
\bibleverse{1} Und des HErrn Wort geschah zu mir und sprach:
\bibleverse{2} Du sollst kein Weib nehmen und weder Söhne noch Töchter
zeugen an diesem Ort. \bibleverse{3} Denn so spricht der HErr von den
...
Lande: \bibleverse{4} Sie sollen an Krankheiten sterben und weder
...
\bibleverse{5} Denn so spricht der HErr: Du sollst nicht zum Trauerhaus
...
spricht der HErr, samt meiner Gnade und Barmherzigkeit, \bibleverse{6}
...
noch kahl scheren. \bibleverse{7} Und man wird auch nicht unter sie Brot
...
\bibleverse{10} Und wenn du solches alles diesem Volk gesagt hast und
...
unseren Gott, gesündigt haben? \bibleverse{11} sollst du ihnen sagen:
...
\bibleverse{13} Darum will ich euch aus diesem Lande stoßen in ein Land,
...
\bibleverse{14} Darum siehe, es kommt die Zeit, spricht der HErr, dass
...
\bibleverse{15} sondern: So wahr der HErr lebt, der die Kinder Israel
...
\bibleverse{19} HErr, du bist meine Stärke und Kraft und meine Zuflucht
...
nützen können. \bibleverse{20} Wie kann ein Mensch Götter machen, die
doch nicht Götter sind? \bibleverse{21} Darum siehe, nun will ich sie
...
\bibleverse{1} Die Sünde Judas ist geschrieben mit eisernen Griffeln und
spitzigen Demanten geschrieben und auf die Tafel ihres Herzens gegraben
und auf die Hörner an ihren Altären, \bibleverse{2} dass ihre Kinder
gedenken sollen derselben Altäre und Ascherabilder bei den grünen
Bäumen, auf den hohen Bergen. \bibleverse{3} Aber ich will deine Höhen,
...
begangen. \bibleverse{4} Und du sollst aus deinem Erbe verstoßen werden,
...
\bibleverse{5} So spricht der HErr: Verflucht ist der Mann, der sich auf
...
\bibleverse{6} Der wird sein wie die Heide in der Wüste und wird nicht
...
Wüste, in einem unfruchtbaren Lande, da niemand wohnt. \footnote{\textbf{17:6}
  Jer 48,6} \bibleverse{7} Gesegnet aber ist der Mann, der sich auf den
HErrn verlässt und des Zuversicht der HErr ist. \footnote{\textbf{17:7}
  Ps 146,5} \bibleverse{8} Der ist wie ein Baum, am Wasser gepflanzt und
...
\bibleverse{9} Es ist das Herz ein trotzig und verzagt Ding; wer kann es
ergründen? \bibleverse{10} Ich, der HErr, kann das Herz ergründen und
...
\bibleverse{12} Aber die Stätte unseres Heiligtums, der Thron göttlicher
Ehre, ist allezeit fest geblieben. \bibleverse{13} Denn, HErr, du bist
...
\bibleverse{14} Heile du mich, HErr, so werde ich heil; hilf du mir, so
ist mir geholfen; denn du bist mein Ruhm. \bibleverse{15} Siehe, sie
sprechen zu mir: Wo ist denn des HErrn Wort? Lass es doch kommen!
\bibleverse{16} Aber ich bin nicht von dir geflohen, dass ich nicht dein
Hirte wäre; so habe ich den bösen Tag nicht begehrt, das weißt du; was
ich gepredigt habe, das ist recht vor dir. \bibleverse{17} Sei du mir
nur nicht schrecklich, meine Zuversicht in der Not! \bibleverse{18} Lass
...
\bibleverse{19} So spricht der HErr zu mir: Gehe hin und tritt unter das
Tor des Volks, dadurch die Könige Judas aus und ein gehen, und unter
alle Tore zu Jerusalem \bibleverse{20} und sprich zu ihnen: Höret des
HErrn Wort, ihr Könige Judas und ganz Juda und alle Einwohner zu
Jerusalem, so zu diesem Tor eingehen. \bibleverse{21} So spricht der
HErr: Hütet euch und tragt keine Last am Sabbattage durch die Tore
hinein zu Jerusalem \bibleverse{22} und führet keine Last am Sabbattage
...
wie ich euren Vätern geboten habe. \footnote{\textbf{17:22} Jes 56,2;
  Jes 58,13} \bibleverse{23} Aber sie hören nicht und neigen ihre Ohren
nicht, sondern bleiben halsstarrig, dass sie mich ja nicht hören noch
sich ziehen lassen. \footnote{\textbf{17:23} Jer 11,8} \bibleverse{24}
...
ihr keine Arbeit an demselben Tage tut: \bibleverse{25} so sollen auch
...
soll diese Stadt ewiglich bewohnt werden; \bibleverse{26} und sollen
...
Hause des HErrn. \bibleverse{27} Werdet ihr mich aber nicht hören, dass
...
\bibleverse{1} Dies ist das Wort, das geschah vom HErrn zu Jeremia, und
sprach: \bibleverse{2} Mache dich auf und gehe hinab in des Töpfers
...
\bibleverse{5} Da geschah des HErrn Wort zu mir und sprach:
...
\footnote{\textbf{18:6} Jes 45,9; Röm 9,21} \bibleverse{7} Plötzlich
...
bösen Wesen und bessert euer Wesen und Tun. \bibleverse{12} Aber sie
...
\bibleverse{13} Darum spricht der HErr: Fragt doch unter den Heiden. Wer
hat je desgleichen gehört? Dass die Jungfrau Israel so gar gräuliche
Dinge tut! \bibleverse{14} Bleibt doch der Schnee länger auf den Steinen
im Felde, wenn's vom Libanon herab schneit, und das Regenwasser
verschießt nicht so bald, wie mein Volk vergisst. \bibleverse{15} Sie
räuchern den Göttern und richten Ärgernis an auf ihren Wegen für und für
und gehen auf ungebahnten Straßen, \bibleverse{16} auf dass ihr Land zur
Wüste werde, ihnen zur ewigen Schande, dass, wer vorübergeht, sich
verwundere und den Kopf schüttle. \bibleverse{17} Denn ich will sie wie
...
nichts geben auf alle seine Rede! \bibleverse{19} HErr, habe Acht auf
mich und höre die Stimme meiner Widersacher! \bibleverse{20} Ist's
...
ich ihr Bestes redete und deinen Grimm von ihnen wendete. \footnote{\textbf{18:20}
  Ps 35,7} \bibleverse{21} So strafe nun ihre Kinder mit Hunger und lass
...
durchs Schwert erwürgt werde; \bibleverse{22} dass ein Geschrei aus
...
meinen Füßen Stricke gelegt. \bibleverse{23} Und weil du, HErr, weißt
...
\bibleverse{1} So spricht der HErr: Gehe hin und kaufe dir einen irdenen
Krug vom Töpfer, samt etlichen von den Ältesten des Volks und von den
Ältesten der Priester, \bibleverse{2} und gehe hinaus ins Tal
...
\bibleverse{3} und sprich: Höret des HErrn Wort, ihr Könige Judas und
...
wer es hören wird, dem die Ohren klingen sollen, \footnote{\textbf{19:3}
  1Sam 3,11; 2Kö 21,12} \bibleverse{4} darum dass sie mich verlassen und
...
\bibleverse{5} und haben dem Baal Höhen gebaut, ihre Kinder zu
...
davon geredet habe, was auch in mein Herz nie gekommen ist. \footnote{\textbf{19:5}
  Jer 7,31-32} \bibleverse{6} Darum siehe, es wird die Zeit kommen,
...
kein Raum sein wird, zu begraben. \footnote{\textbf{19:11} Jes 30,14;
  Jer 7,32} \bibleverse{12} So will ich mit dieser Stätte, spricht der
HErr, und ihren Einwohnern umgehen, dass diese Stadt werden soll gleich
wie das Thopheth. \bibleverse{13} Dazu sollen die Häuser zu Jerusalem
...
HErrn und sprach zu allem Volk: \bibleverse{15} So spricht der HErr
...
\bibleverse{1} Da aber Pashur, ein Sohn Immers, der Priester, der zum
Obersten im Hause des HErrn gesetzt war, Jeremia hörte solche Worte
weissagen, \bibleverse{2} schlug er den Propheten Jeremia und legte ihn
in den Stock unter dem Obertor Benjamin, welches am Hause des HErrn ist.
\bibleverse{3} Und da es Morgen ward, zog Pashur Jeremia aus dem Stock.
Da sprach Jeremia zu ihm: Der HErr heißt dich nicht Pashur, sondern
Schrecken um und um. \bibleverse{4} Denn so spricht der HErr: Siehe, ich
...
\bibleverse{5} Auch will ich alle Güter dieser Stadt samt allem, was sie
...
bringen. \footnote{\textbf{20:5} Jes 39,6} \bibleverse{6} Und du,
...
\bibleverse{7} HErr, du hast mich überredet, und ich habe mich überreden
...
täglich. \footnote{\textbf{20:8} Jes 49,4} \bibleverse{9} Da dachte ich:
...
schier vergangen. \bibleverse{10} Denn ich höre, wie mich viele schelten
...
\bibleverse{11} Aber der HErr ist bei mir wie ein starker Held; darum
...
Schande sein, deren man nicht vergessen wird. \footnote{\textbf{20:11}
  Jer 1,8; Jer 1,19; Jer 15,20} \bibleverse{12} Und nun, HErr Zebaoth,
...
\footnote{\textbf{20:12} Jer 11,20} \bibleverse{13} Singet dem HErrn,
...
\bibleverse{14} Verflucht sei der Tag, darin ich geboren bin; der Tag
müsse ungesegnet sein, darin mich meine Mutter geboren hat! \footnote{\textbf{20:14}
  Jer 15,10; Hi 3,1-10; Hi 10,18} \bibleverse{15} Verflucht sei der, der
meinem Vater gute Botschaft brachte und sprach: „Du hast einen jungen
Sohn``, dass er ihn fröhlich machen wollte! \bibleverse{16} Der Mann
...
Heulen! \bibleverse{17} Dass du mich doch nicht getötet hast im
Mutterleibe, dass meine Mutter mein Grab gewesen und ihr Leib ewig
schwanger geblieben wäre! \bibleverse{18} Warum bin ich doch aus
...
\bibleverse{1} Dies ist das Wort, das vom HErrn geschah zu Jeremia, da
...
den Sohn Maasejas, den Priester, und ließ ihm sagen: \footnote{\textbf{21:1}
  Jer 29,25} \bibleverse{2} Frage doch den HErrn für uns. Denn
...
\bibleverse{5} Und ich will wider euch streiten mit ausgereckter Hand,
mit starkem Arm, mit Zorn, Grimm und großer Ungnade. \bibleverse{6} Und
will die Bürger dieser Stadt schlagen, die Menschen und das Vieh, dass
sie sterben sollen durch eine große Pestilenz. \bibleverse{7} Und
...
\bibleverse{8} Und sage diesem Volk: So spricht der HErr: Siehe, ich
lege euch vor den Weg zum Leben und den Weg zum Tode. \bibleverse{9} Wer
...
Ausbeute behalten. \footnote{\textbf{21:9} Jer 38,2} \bibleverse{10}
...
\bibleverse{11} Und höret des HErrn Wort, ihr vom Hause des Königs in
Juda! \bibleverse{12} Du Haus David, so spricht der HErr: Haltet des
...
\bibleverse{13} Siehe, spricht der HErr, ich will an dich, die du
wohnest im Grunde, auf dem Felsen der Ebene und sprichst: Wer will uns
überfallen oder in unsere Feste kommen? \bibleverse{14} Ich will euch
...
\bibleverse{1} So spricht der HErr: Gehe hinab in das Haus des Königs in
Juda und rede daselbst dieses Wort \bibleverse{2} und sprich: Höre des
...
\bibleverse{3} So spricht der HErr: Haltet Recht und Gerechtigkeit, und
...
nicht unschuldig Blut an dieser Stätte. \footnote{\textbf{22:3} Jer
  21,12} \bibleverse{4} Werdet ihr solches tun, so sollen durch die Tore
...
und zu Rosse, samt ihren Knechten und ihrem Volk. \footnote{\textbf{22:4}
  Jer 17,25} \bibleverse{5} Werdet ihr aber solchem nicht gehorchen, so
...
\bibleverse{6} Denn so spricht der HErr von dem Hause des Königs in
Juda: Ein Gilead bist du mir, ein Haupt im Libanon. Was gilt's? ich will
dich zur Wüste und die Städte ohne Einwohner machen. \bibleverse{7} Denn
...
gehandelt? \bibleverse{9} Und man wird antworten: Darum dass sie den
...
\bibleverse{10} Weinet nicht über die Toten und grämet euch nicht darum;
weinet aber über den, der dahinzieht; denn er wird nimmer wiederkommen,
dass er sein Vaterland sehen möchte. \bibleverse{11} Denn so spricht der
...
\bibleverse{12} sondern muss sterben an dem Ort, dahin er gefangen
...
gibt ihm seinen Lohn nicht \bibleverse{14} und denkt: „Wohlan, ich will
mir ein großes Haus bauen und weite Gemächer!{}`` und lässt sich Fenster
drein hauen und es mit Zedern täfeln und rot malen! \bibleverse{15}
...
Gerechtigkeit, und es ging ihm wohl? \bibleverse{16} Er half dem Elenden
und Armen zum Recht, und es ging ihm wohl. Ist's nicht also, dass
solches heißt, mich recht erkennen? spricht der HErr. \bibleverse{17}
...
\bibleverse{18} Darum spricht der HErr von Jojakim, dem Sohn Josias, dem
König Judas: Man wird ihn nicht beklagen: „Ach Bruder! ach
Schwester!{}``, man wird ihn nicht beklagen: „Ach Herr! ach Edler!{}``
\footnote{\textbf{22:18} Jer 34,5} \bibleverse{19} Er soll wie ein Esel
...
\bibleverse{20} Gehe hinauf auf den Libanon und schreie und lass dich
hören zu Basan und schreie von Abarim; denn alle deine Liebhaber sind
zunichte gemacht. \bibleverse{21} Ich habe dir's vorhergesagt, da es
...
\bibleverse{22} Alle deine Hirten wird der Wind weiden, und deine
...
werden um aller deiner Bosheit willen. \footnote{\textbf{22:22} Jer
  25,9; Jer 25,18} \bibleverse{23} Die du jetzt auf dem Libanon wohnest
...
\bibleverse{24} So wahr ich lebe, spricht der HErr, wenn Chonja, der
...
\bibleverse{25} und in die Hände geben derer, die nach deinem Leben
stehen und vor welchen du dich fürchtest, in die Hände Nebukadnezars,
des Königs zu Babel, und der Chaldäer. \bibleverse{26} Und ich will dich
und deine Mutter, die dich geboren hat, in ein anderes Land treiben, das
nicht euer Vaterland ist, und sollt daselbst sterben. \bibleverse{27}
Und in das Land, da sie von Herzen gern wieder hin wären, sollen sie
nicht wiederkommen. \bibleverse{28} Wie ein elender, verachteter,
...
geworfen! \bibleverse{29} O Land, Land, Land, höre des HErrn Wort!
\bibleverse{30} So spricht der HErr: Schreibet an diesen Mann als einen,
...
\bibleverse{1} Weh euch Hirten, die ihr die Herde meiner Weide umbringet
und zerstreuet! spricht der HErr. \footnote{\textbf{23:1} Hes 13,2-16;
  Hes 34,1-34; Sach 11,5} \bibleverse{2} Darum spricht der HErr, der
...
\bibleverse{3} Und ich will die Übrigen meiner Herde sammeln aus allen
Ländern, dahin ich sie verstoßen habe, und will sie wiederbringen zu
ihren Hürden, dass sie sollen wachsen und viel werden. \bibleverse{4}
...
\bibleverse{5} Siehe, es kommt die Zeit, spricht der HErr, dass ich dem
...
geführt hat! \footnote{\textbf{23:7} Jer 16,14-15} \bibleverse{8}
...
heiligen Worten; \bibleverse{10} dass das Land so voll Ehebrecher ist,
...
nicht. \bibleverse{11} Denn beide, Propheten und Priester, sind Schälke;
und auch in meinem Hause finde ich ihre Bosheit, spricht der HErr.
\bibleverse{12} Darum ist ihr Weg wie ein glatter Weg im Finstern,
...
\bibleverse{15} Darum spricht der HErr Zebaoth von den Propheten also:
...
\bibleverse{16} So spricht der HErr Zebaoth: Gehorchet nicht den Worten
...
ihres Herzens Gesicht und nicht aus des HErrn Munde. \footnote{\textbf{23:16}
  Jer 6,14} \bibleverse{17} Sie sagen denen, die mich lästern: „Der HErr
...
kommen.`` \footnote{\textbf{23:17} Jer 7,24} \bibleverse{18} Aber wer
...
Wer hat sein Wort vernommen und gehört? \footnote{\textbf{23:18} Jes
  40,13} \bibleverse{19} Siehe, es wird ein Wetter des HErrn mit Grimm
...
Sinn hat; zur letzten Zeit werdet ihr's wohl erfahren. \bibleverse{21}
...
\bibleverse{22} Denn wo sie bei meinem Rat geblieben wären und hätten
meine Worte meinem Volk gepredigt, so hätten sie dasselbe von seinem
bösen Wesen und von seinem bösen Leben bekehrt.

\bibleverse{23} Bin ich nur ein Gott, der nahe ist, spricht der HErr,
und nicht auch ein Gott von ferneher? \bibleverse{24} Meinst du, dass
...
reimen sich Stroh und Weizen zusammen? spricht der HErr. \bibleverse{29}
...
HErr, die mein Wort stehlen einer dem anderen. \bibleverse{31} Siehe,
ich will an die Propheten, spricht der HErr, die ihr eigenes Wort führen
und sprechen: Er hat's gesagt. \bibleverse{32} Siehe, ich will an die,
...
HErr. \bibleverse{34} Und wo ein Prophet oder Priester oder das Volk
wird sagen: „Das ist die Last des HErrn``, den will ich heimsuchen und
sein Haus dazu. \bibleverse{35} Also sollt ihr aber einer mit dem
anderen reden und untereinander sagen: „Was antwortet der HErr, und was
sagt der HErr?{}`` \bibleverse{36} Und nennt's nicht mehr „Last des
...
unseres Gottes, verkehrt. \bibleverse{37} Darum sollt ihr zum Propheten
also sagen: Was antwortet dir der HErr, und was sagt der HErr?
\bibleverse{38} Weil ihr aber sprechet: „Last des HErrn``, darum spricht
...
des HErrn``: \bibleverse{39} siehe, so will ich euch hinwegnehmen und
euch samt der Stadt, die ich euch und euren Vätern gegeben habe, von
meinem Angesicht wegwerfen \bibleverse{40} und will euch ewige Schande
...
\bibleverse{1} Siehe, der HErr zeigte mir zwei Feigenkörbe, gestellt vor
...
\bibleverse{2} In dem einen Korbe waren sehr gute Feigen, wie die ersten
reifen Feigen sind; im anderen Korbe waren sehr schlechte Feigen, dass
man sie nicht essen konnte, so schlecht waren sie.

\bibleverse{3} Und der HErr sprach zu mir: Jeremia, was siehest du? Ich
...
\bibleverse{4} Da geschah des HErrn Wort zu mir und sprach:
\bibleverse{5} So spricht der HErr, der Gott Israels: Gleichwie diese
...
Land, \bibleverse{6} und will sie gnädig ansehen, und will sie wieder in
...
\bibleverse{7} und will ihnen ein Herz geben, dass sie mich kennen
...
\footnote{\textbf{24:8} Jer 29,17} \bibleverse{9} Und will ihnen Unglück
...
allen Orten, dahin ich sie verstoßen werde; \footnote{\textbf{24:9} Jer
  29,18} \bibleverse{10} und will Schwert, Hunger und Pestilenz unter
...
\bibleverse{1} Dies ist das Wort, welches zu Jeremia geschah über das
...
\bibleverse{2} welches auch der Prophet Jeremia redete zu dem ganzen
Volk Juda und zu allen Bürgern zu Jerusalem und sprach: \bibleverse{3}
...
\bibleverse{4} So hat der HErr auch zu euch gesandt alle seine Knechte,
die Propheten, fleißig; aber ihr habt nie hören wollen noch eure Ohren
neigen, dass ihr gehorchtet, \bibleverse{5} da er sprach: Bekehret euch,
...
und ewiglich bleiben. \footnote{\textbf{25:5} Jer 18,11} \bibleverse{6}
...
\bibleverse{7} Aber ihr wolltet mir nicht gehorchen, spricht der HErr,
...
\bibleverse{8} Darum so spricht der HErr Zebaoth: Weil ihr denn meine
Worte nicht hören wollt, \bibleverse{9} siehe, so will ich ausschicken
...
Spott und zur ewigen Wüste machen, \bibleverse{10} und will herausnehmen
...
Stimme der Mühle und das Licht der Lampe, \footnote{\textbf{25:10} Jer
  16,9} \bibleverse{11} dass dieses ganze Land wüst und zerstört liegen
...
\bibleverse{13} Also will ich über dieses Land bringen alle meine Worte,
...
\bibleverse{14} Und sie sollen auch großen Völkern und großen Königen
...
\bibleverse{15} Denn also spricht zu mir der HErr, der Gott Israels:
...
allen Völkern, zu denen ich dich sende, \footnote{\textbf{25:15} Jer
  51,7; Jes 51,17; Offb 14,10} \bibleverse{16} dass sie trinken, taumeln
und toll werden vor dem Schwert, das ich unter sie schicken will.

\bibleverse{17} Und ich nahm den Becher von der Hand des HErrn und
schenkte allen Völkern, zu denen mich der HErr sandte, \bibleverse{18}
...
denn heutigestages steht; \bibleverse{19} auch Pharao, dem König in
Ägypten, samt seinen Knechten, seinen Fürsten und seinem ganzen Volk;
\bibleverse{20} allen Ländern gegen Abend, allen Königen im Lande Uz,
allen Königen in der Philister Lande, samt Askalon, Gaza, Ekron und den
Übrigen zu Asdod; \bibleverse{21} denen zu Edom, denen von Moab, den
Kindern Ammon; \bibleverse{22} allen Königen zu Tyrus, allen Königen zu
Sidon, den Königen auf den Inseln jenseits des Meeres; \bibleverse{23}
denen von Dedan, denen von Thema, denen von Bus und allen, die das Haar
rundumher abschneiden; \bibleverse{24} allen Königen in Arabien, allen
Königen gegen Abend, die in der Wüste wohnen; \bibleverse{25} allen
Königen in Simri, allen Königen in Elam, allen Königen in Medien;
\bibleverse{26} allen Königen gegen Mitternacht, in der Nähe und Ferne,
...
\bibleverse{27} Und sprich zu ihnen: So spricht der HErr Zebaoth, der
...
will. \bibleverse{28} Und wo sie den Becher nicht wollen von deiner Hand
nehmen und trinken, so sprich zu ihnen: Also spricht der HErr Zebaoth:
Nun sollt ihr trinken! \bibleverse{29} Denn siehe, in der Stadt, die
...
\footnote{\textbf{25:29} Jer 49,12; 1Petr 4,17}
...
des Landes, des Hall erschallen wird bis an der Welt Ende. \footnote{\textbf{25:30}
  Joe 4,16; Am 1,2; Hos 11,10} \bibleverse{31} Der HErr hat zu rechten
mit den Heiden und will mit allem Fleisch Gericht halten; die Gottlosen
wird er dem Schwert übergeben, spricht der HErr.

\bibleverse{32} So spricht der HErr Zebaoth: Siehe, es wird eine Plage
kommen von einem Volk zum anderen, und ein großes Wetter wird erweckt
werden aus einem fernen Lande. \bibleverse{33} Da werden die
...
\footnote{\textbf{25:33} Jer 7,33} \bibleverse{34} Heulet nun, ihr
...
\bibleverse{37} und ihre Auen, die so wohl standen, verderbt sind vor
dem grimmigen Zorn des HErrn. \bibleverse{38} Er hat seine Hütte
...
\bibleverse{2} So spricht der HErr: Tritt in den Vorhof am Hause des
...
und tue nichts davon; \bibleverse{3} ob sie vielleicht hören wollen und
...
Wandels willen. \bibleverse{4} Und sprich zu ihnen: So spricht der HErr:
Werdet ihr mir nicht gehorchen, dass ihr in meinem Gesetz wandelt, das
ich euch vorgelegt habe, \bibleverse{5} dass ihr hört auf die Worte
...
\bibleverse{6} so will ich's mit diesem Hause machen wie mit Silo und
...
Jeremia, dass er solche Worte redete im Hause des HErrn, \bibleverse{8}
...
Volk und sprachen: Du musst sterben! \bibleverse{9} Warum weissagst du
...
des HErrn. \bibleverse{11} Und die Priester und Propheten sprachen vor
...
das er wider euch geredet hat. \bibleverse{14} Siehe, ich bin in euren
Händen; ihr mögt es machen mit mir, wie es euch recht und gut dünkt.
\bibleverse{15} Doch sollt ihr wissen: wo ihr mich tötet, so werdet ihr
...
\bibleverse{19} Doch ließ ihn Hiskia, der König Judas, und das ganze
...
\bibleverse{20} So war auch einer, der im Namen des HErrn weissagte,
Uria, der Sohn Semajas, von Kirjath-Jearim. Derselbe weissagte wider
diese Stadt und wider dieses Land gleichwie Jeremia. \bibleverse{21} Da
...
fürchtete sich und floh und zog nach Ägypten. \bibleverse{22} Aber der
König Jojakim schickte Leute nach Ägypten, Elnathan, den Sohn Achbors,
und andere mit ihm; \bibleverse{23} die führten ihn aus Ägypten und
...
\bibleverse{2} So spricht der HErr zu mir: Mache dir ein Joch und hänge
es an deinen Hals \bibleverse{3} und schicke es zum König in Edom, zum
...
\bibleverse{4} und befiehl ihnen, dass sie ihren Herren sagen: So
spricht der HErr Zebaoth, der Gott Israels: So sollt ihr euren Herren
sagen: \bibleverse{5} Ich habe die Erde gemacht und Menschen und Vieh,
die auf Erden sind, durch meine große Kraft und meinen ausgestreckten
Arm und gebe sie, wem ich will. \bibleverse{6} Nun aber habe ich alle
...
sie ihm dienen sollen. \bibleverse{7} Und sollen alle Völker dienen ihm
...
seine Hand umbringe. \bibleverse{9} Darum so gehorcht nicht euren
...
Volk, so dem König zu Babel nicht dienen will? \bibleverse{14} Darum
...
weissagen euch falsch. \bibleverse{17} Gehorchet ihnen nicht, sondern
dienet dem König zu Babel, so werdet ihr lebendig bleiben. Warum soll
doch diese Stadt zur Wüste werden? \bibleverse{18} Sind sie aber
...
\bibleverse{19} Denn also spricht der HErr Zebaoth von den Säulen und
vom Meer und von dem Gestühl und von den Gefäßen, die noch übrig sind in
dieser Stadt, \footnote{\textbf{27:19} Jer 52,17} \bibleverse{20} welche
...
allen Fürsten in Juda und Jerusalem, \footnote{\textbf{27:20} 2Kö
  24,14-15} \bibleverse{21} -- denn so spricht der HErr Zebaoth, der
Gott Israels, von den Gefäßen, die noch übrig sind im Hause des HErrn
und im Hause des Königs in Juda und zu Jerusalem: \bibleverse{22} Sie
...
\bibleverse{2} So spricht der HErr Zebaoth, der Gott Israels: Ich habe
das Joch des Königs zu Babel zerbrochen; \bibleverse{3} und ehe zwei
...
Babel geführt, wiederum an diesen Ort bringen; \bibleverse{4} Dazu
...
standen, \bibleverse{6} und sagte: Amen! der HErr tue also; der HErr
...
Gefangenen. \bibleverse{7} Aber doch höre auch dieses Wort, das ich vor
deinen Ohren rede und vor den Ohren des ganzen Volks: \bibleverse{8} Die
...
Unglück und von Pestilenz; \bibleverse{9} wenn aber ein Prophet von
...
\bibleverse{12} Aber des HErrn Wort geschah zu Jeremia, nachdem der
...
eisernes Joch an jenes Statt gemacht. \bibleverse{14} Denn so spricht
...
gemacht, dass dieses Volk auf Lügen sich verlässt. \bibleverse{16} Darum
...
\bibleverse{1} Dies sind die Worte in dem Brief, den der Prophet Jeremia
...
von Jerusalem hatte weggeführt gen Babel \bibleverse{2} (nachdem der
...
\bibleverse{3} durch Eleasa, den Sohn Saphans, und Gemarja, den Sohn
...
\bibleverse{4} So spricht der HErr Zebaoth, der Gott Israels, zu allen
Gefangenen, die ich habe von Jerusalem lassen wegführen gen Babel:
\bibleverse{5} Bauet Häuser, darin ihr wohnen mögt, pflanzet Gärten,
daraus ihr die Früchte essen mögt; \bibleverse{6} nehmet Weiber und
...
\bibleverse{8} Denn so spricht der HErr Zebaoth, der Gott Israels: Lasst
...
und gehorcht euren Träumen nicht, die euch träumen. \footnote{\textbf{29:8}
  Jer 14,14} \bibleverse{9} Denn sie weissagen euch falsch in meinem
Namen; ich habe sie nicht gesandt, spricht der HErr. \bibleverse{10}
...
ich euch wieder an diesen Ort bringe. \bibleverse{11} Denn ich weiß
...
wartet. \bibleverse{12} Und ihr werdet mich anrufen und hingehen und
mich bitten, und ich will euch erhören. \bibleverse{13} Ihr werdet mich
...
\bibleverse{15} Zwar meinet ihr, der HErr habe euch zu Babel Propheten
erweckt. \bibleverse{16} Aber also spricht der HErr vom König, der auf
...
\bibleverse{17} -- ja, also spricht der HErr Zebaoth: Siehe, ich will
...
\footnote{\textbf{29:17} Jer 24,8} \bibleverse{18} und will hinter ihnen
...
verstoßen werde, \footnote{\textbf{29:18} Jer 24,9-10} \bibleverse{19}
...
\footnote{\textbf{29:20} Jer 29,4} \bibleverse{21} So spricht der HErr
...
Babel; der soll sie totschlagen lassen vor euren Augen, \footnote{\textbf{29:21}
  Jer 29,8} \bibleverse{22} dass man wird aus ihnen einen Fluch machen
...
ließ, \bibleverse{23} darum dass sie eine Torheit in Israel begingen und
...
\bibleverse{25} So spricht der HErr Zebaoth, der Gott Israels: Darum
...
alle Priester und gesagt: \bibleverse{26} Der HErr hat dich zum Priester
...
\bibleverse{27} Nun, warum strafst du denn nicht Jeremia von Anathoth,
der euch weissagt? \bibleverse{28} darum dass er zu uns gen Babel
...
geschah des HErrn Wort zu Jeremia und sprach: \bibleverse{31} Sende hin
...
\bibleverse{32} darum spricht der HErr also: Siehe, ich will Semaja von
...
\bibleverse{1} Dies ist das Wort, das vom HErrn geschah zu Jeremia:
\bibleverse{2} So spricht der HErr, der Gott Israels: Schreibe dir alle
Worte in ein Buch, die ich zu dir rede. \bibleverse{3} Denn siehe, es
...
\bibleverse{4} Dies sind aber die Worte, welche der HErr redet von
Israel und Juda: \bibleverse{5} So spricht der HErr: Wir hören ein
Geschrei des Schreckens; es ist eitel Furcht da und kein Friede.
\bibleverse{6} Forschet doch und sehet, ob ein Mann gebären könne? Wie
...
\bibleverse{7} Es ist ja ein großer Tag, und seinesgleichen ist nicht
...
\footnote{\textbf{30:8} Jer 27,12} \bibleverse{9} sondern sie werden dem
HErrn, ihrem Gott, dienen und ihrem König David, welchen ich ihnen
erwecken will. \footnote{\textbf{30:9} Jer 23,5; Hes 34,23}
\bibleverse{10} Darum fürchte du dich nicht, mein Knecht Jakob, spricht
...
haben, und niemand soll ihn schrecken. \footnote{\textbf{30:10} Jer
  46,27; Jes 44,2} \bibleverse{11} Denn ich bin bei dir, spricht der
...
\bibleverse{12} Denn also spricht der HErr: Dein Schade ist verzweifelt
böse, und deine Wunden sind unheilbar. \footnote{\textbf{30:12} Jer
  15,18} \bibleverse{13} Deine Sache behandelt niemand, dass er dich
...
\bibleverse{16} Darum alle, die dich gefressen haben, sollen gefressen
...
geplündert haben, sollen geplündert werden. \footnote{\textbf{30:16} Jes
  33,1} \bibleverse{17} Aber dich will ich wieder gesund machen und
...
\bibleverse{18} So spricht der HErr: Siehe, ich will das Gefängnis der
...
\bibleverse{19} Und soll von dannen herausgehen Lob- und Freudengesang;
denn ich will sie mehren und nicht mindern, ich will sie herrlich machen
und nicht geringer. \bibleverse{20} Ihre Söhne sollen sein gleichwie
vormals und ihre Gemeinde vor mir gedeihen; denn ich will heimsuchen
alle, die sie plagen. \bibleverse{21} Und ihr Fürst soll aus ihnen
...
der HErr. \bibleverse{22} Und ihr sollt mein Volk sein, und ich will
euer Gott sein. \footnote{\textbf{30:22} Jer 24,7} \bibleverse{23}
...
Ungewitter wird den Gottlosen auf den Kopf fallen. \footnote{\textbf{30:23}
  Jer 23,19} \bibleverse{24} Des HErrn grimmiger Zorn wird nicht
...
\bibleverse{1} Zu derselben Zeit, spricht der HErr, will ich aller
Geschlechter Israels Gott sein, und sie sollen mein Volk sein.
\footnote{\textbf{31:1} Jer 31,33; Jer 24,7}

\bibleverse{2} So spricht der HErr: Das Volk, so übriggeblieben ist vom
Schwert, hat Gnade gefunden in der Wüste; Israel zieht hin zu seiner
Ruhe.

\bibleverse{3} Der HErr ist mir erschienen von ferne: Ich habe dich je
und je geliebt; darum habe ich dich zu mir gezogen aus lauter Güte.
\bibleverse{4} Wohlan, ich will dich wiederum bauen, dass du sollst
gebaut heißen, du Jungfrau Israel; du sollst noch fröhlich pauken und
herausgehen an den Tanz. \bibleverse{5} Du sollst wiederum Weinberge
...
\bibleverse{7} Denn also spricht der HErr: Rufet über Jakob mit Freuden
und jauchzet über das Haupt unter den Heiden; rufet laut, rühmet und
sprecht: HErr, hilf deinem Volk, den Übrigen in Israel! \bibleverse{8}
...
\bibleverse{9} Sie werden weinend kommen und betend, so will ich sie
...
\footnote{\textbf{31:9} 2Kor 6,18}

\hypertarget{en-la-patria}{%
\subsection{En la patria}\label{en-la-patria}}

\bibleverse{10} Höret, ihr Heiden, des HErrn Wort und verkündigt es fern
...
\bibleverse{11} Denn der HErr wird Jakob erlösen und von der Hand des
Mächtigen erretten. \bibleverse{12} Und sie werden kommen und auf der
...
sollen. \bibleverse{13} Alsdann werden die Jungfrauen fröhlich am Reigen
...
ihrer Betrübnis. \bibleverse{14} Und ich will der Priester Herz voller
...
\bibleverse{15} So spricht der HErr: Man hört eine klägliche Stimme und
...
\bibleverse{16} Aber der HErr spricht also: Lass dein Schreien und
...
Feindes; \bibleverse{17} und deine Nachkommen haben viel Gutes zu
...
\bibleverse{18} Ich habe wohl gehört, wie Ephraim klagt: „Du hast mich
...
\bibleverse{19} Da ich bekehrt ward, tat ich Buße; denn nachdem ich
...
Jugend.`` \bibleverse{20} Ist nicht Ephraim mein teurer Sohn und mein
...
\bibleverse{21} Richte dir Denkmale auf, setze dir Zeichen und richte
...
\bibleverse{22} Wie lange willst du in der Irre gehen, du abtrünnige
...
\bibleverse{23} So spricht der HErr Zebaoth, der Gott Israels: Man wird
...
Gerechtigkeit, du heiliger Berg! \bibleverse{24} Und Juda samt allen
seinen Städten sollen darin wohnen, dazu Ackerleute und die mit Herden
umherziehen; \bibleverse{25} denn ich will die müden Seelen erquicken
...
\bibleverse{27} Siehe, es kommt die Zeit, spricht der HErr, dass ich das
Haus Israel und das Haus Juda besäen will mit Menschen und mit Vieh.
\bibleverse{28} Und gleichwie ich über sie gewacht habe, auszureuten, zu
...
\bibleverse{29} Zu derselben Zeit wird man nicht mehr sagen: „Die Väter
haben Herlinge gegessen, und der Kinder Zähne sind stumpf geworden``;
\bibleverse{30} sondern ein jeglicher wird um seiner Missetat willen
...
\bibleverse{31} Siehe, es kommt die Zeit, spricht der HErr, da will ich
mit dem Hause Israel und mit dem Hause Juda einen neuen Bund machen;
\footnote{\textbf{31:31} Hebr 8,8-12} \bibleverse{32} nicht wie der Bund
...
\bibleverse{33} sondern das soll der Bund sein, den ich mit dem Hause
...
mein Volk sein, so will ich ihr Gott sein; \bibleverse{34} und wird
...
\bibleverse{35} So spricht der HErr, der die Sonne dem Tage zum Licht
...
Name --: \bibleverse{36} Wenn solche Ordnungen vergehen vor mir, spricht
der HErr, so soll auch aufhören der Same Israels, dass er nicht mehr ein
Volk vor mir sei ewiglich. \bibleverse{37} So spricht der HErr: Wenn man
...
\bibleverse{38} Siehe, es kommt die Zeit, spricht der HErr, dass die
Stadt des HErrn soll gebaut werden vom Turm Hananeel an bis ans Ecktor;
\footnote{\textbf{31:38} Sach 14,10} \bibleverse{39} und die Richtschnur
wird neben demselben weiter herausgehen bis an den Hügel Gareb und sich
gen Goath wenden; \bibleverse{40} und das ganze Tal der Leichen und der
...
\bibleverse{1} Dies ist das Wort, das vom HErrn geschah zu Jeremia im
zehnten Jahr Zedekias, des Königs in Juda, welches ist das achtzehnte
Jahr Nebukadnezars. \bibleverse{2} Dazumal belagerte das Heer des Königs
...
\bibleverse{4} und Zedekia, der König Judas, soll den Chaldäern nicht
...
\bibleverse{5} Und er wird Zedekia gen Babel führen; da soll er auch
...
\bibleverse{6} Und Jeremia sprach: Es ist des HErrn Wort geschehen zu
mir und spricht: \bibleverse{7} Siehe, Hanameel, der Sohn Sallums,
...
\bibleverse{8} Also kam Hanameel, meines Oheims Sohn, wie der HErr
...
\bibleverse{14} So spricht der HErr Zebaoth, der Gott Israels: Nimm
...
\bibleverse{15} Denn so spricht der HErr Zebaoth, der Gott Israels: Noch
...
gegeben, betete ich zum HErrn und sprach: \bibleverse{17} Ach Herr HErr,
...
\bibleverse{18} der du wohltust vielen Tausenden und vergiltst die
...
starker Gott; HErr Zebaoth ist dein Name; \footnote{\textbf{32:18} 2Mo
  20,5-6} \bibleverse{19} groß von Rat und mächtig von Tat, und deine
...
\footnote{\textbf{32:19} Röm 2,6} \bibleverse{20} der du in Ägyptenland
...
\bibleverse{21} und hast dein Volk Israel aus Ägyptenland geführt durch
Zeichen und Wunder, durch eine mächtige Hand, durch ausgestreckten Arm
und durch großen Schrecken; \bibleverse{22} und hast ihnen dieses Land
gegeben, welches du ihren Vätern geschworen hattest, dass du es ihnen
geben wolltest, ein Land, darin Milch und Honig fließt; \bibleverse{23}
...
das siehest du, \bibleverse{25} und du sprichst zu mir, Herr HErr:
...
\bibleverse{26} Und des HErrn Wort geschah zu Jeremia und sprach:
\bibleverse{27} Siehe, ich, der HErr, bin ein Gott alles Fleisches;
sollte mir etwas unmöglich sein? \footnote{\textbf{32:27} 4Mo 16,22; Jer
  32,17} \bibleverse{28} Darum so spricht der HErr also: Siehe, ich gebe
...
Königs zu Babel; und er soll sie gewinnen. \footnote{\textbf{32:28} Jer
  32,3} \bibleverse{29} Und die Chaldäer, die wider diese Stadt
...
\bibleverse{36} Und nun um deswillen spricht der HErr, der Gott Israels,
...
\bibleverse{42} Denn so spricht der HErr: Gleichwie ich über dieses Volk
habe kommen lassen all dies große Unglück, also will ich auch alles Gute
über sie kommen lassen, das ich ihnen verheißen habe. \bibleverse{43}
...
werde in der Chaldäer Hände gegeben. \bibleverse{44} Dennoch wird man
...
\bibleverse{1} Und des HErrn Wort geschah zu Jeremia zum andernmal, da
er noch im Vorhof des Gefängnisses verschlossen war, und sprach:
\footnote{\textbf{33:1} Jer 32,2} \bibleverse{2} So spricht der HErr,
der solches macht, tut und ausrichtet -- HErr ist sein Name --:
\bibleverse{3} Rufe mich an, so will ich dir antworten und will dir
anzeigen große und gewaltige Dinge, die du nicht weißt. \bibleverse{4}
...
zu machen zur Wehr, \bibleverse{5} und von denen, die hereingekommen
...
um all ihrer Bosheit willen: \bibleverse{6} Siehe, ich will sie heilen
...
\bibleverse{10} So spricht der HErr: An diesem Ort, davon ihr sagt: Er
...
noch Bürger noch Vieh darin sind, \bibleverse{11} wird man dennoch
...
\bibleverse{12} So spricht der HErr Zebaoth: An diesem Ort, der so wüst
...
\bibleverse{13} In Städten auf den Gebirgen und in Städten in Gründen
...
\bibleverse{14} Siehe, es kommt die Zeit, spricht der HErr, dass ich das
gnädige Wort erwecken will, welches ich dem Hause Israel und dem Hause
Juda geredet habe. \bibleverse{15} In denselben Tagen und zu derselben
...
soll Recht und Gerechtigkeit anrichten auf Erden. \footnote{\textbf{33:15}
  Jer 23,5; Jes 4,2} \bibleverse{16} Zu derselben Zeit soll Juda
...
\bibleverse{17} Denn so spricht der HErr: Es soll nimmermehr fehlen, es
soll einer von David sitzen auf dem Stuhl des Hauses Israel. \footnote{\textbf{33:17}
  2Sam 7,12; 1Kö 9,5} \bibleverse{18} Desgleichen soll's nimmermehr
...
\bibleverse{19} Und des HErrn Wort geschah zu Jeremia und sprach:
\bibleverse{20} So spricht der HErr: Wenn mein Bund aufhören wird mit
Tag und Nacht, dass nicht Tag und Nacht sei zu seiner Zeit,
\bibleverse{21} so wird auch mein Bund aufhören mit meinem Knechte
...
\bibleverse{23} Und des HErrn Wort geschah zu Jeremia und sprach:
\bibleverse{24} Hast du nicht gesehen, was dieses Volk redet und
...
mein Volk sein. \bibleverse{25} So spricht der HErr: Halte ich meinen
Bund nicht mit Tag und Nacht noch die Ordnungen des Himmels und der
Erde, \bibleverse{26} so will ich auch verwerfen den Samen Jakobs und
...
stritt wider Jerusalem und alle ihre Städte, und sprach: \bibleverse{2}
...
Feuer verbrennen. \bibleverse{3} Und du sollst seiner Hand nicht
...
\bibleverse{4} Doch aber höre, Zedekia, du König Judas, des HErrn Wort:
So spricht der HErr von dir: Du sollst nicht durchs Schwert sterben,
\footnote{\textbf{34:4} Jer 52,11} \bibleverse{5} sondern du sollst im
...
\bibleverse{8} Dies ist das Wort, das vom HErrn geschah zu Jeremia,
...
\bibleverse{9} dass ein jeglicher seinen Knecht und ein jeglicher seine
Magd, so Hebräer und Hebräerin wären, sollte freigeben, dass kein Jude
den anderen leibeigen hielte. \bibleverse{10} Da gehorchten alle Fürsten
...
leibeigen halten, und gaben sie los. \bibleverse{11} Aber darnach
...
\bibleverse{12} Da geschah des HErrn Wort zu Jeremia vom HErrn und
sprach: \bibleverse{13} So spricht der HErr, der Gott Israels: Ich habe
einen Bund gemacht mit euren Vätern, da ich sie aus Ägyptenland, aus dem
Diensthause, führte und sprach: \bibleverse{14} Im siebenten Jahr soll
...
gehorchten mir nicht und neigten ihre Ohren nicht. \footnote{\textbf{34:14}
  2Mo 21,2; 5Mo 15,12} \bibleverse{15} So habt ihr euch heute bekehrt
...
mir im Hause, das nach meinem Namen genannt ist. \bibleverse{16} Aber
...
\bibleverse{17} Darum spricht der HErr also: Ihr gehorchtet mir nicht,
...
Königreich auf Erden bleiben lassen. \bibleverse{18} Und will die Leute,
...
\bibleverse{1} Dies ist das Wort, das vom HErrn geschah zu Jeremia zur
Zeit Jojakims, des Sohnes Josias, des Königs in Juda, und sprach:
\bibleverse{2} Gehe hin zu dem Hause der Rechabiter und rede mit ihnen
...
Haus der Rechabiter \bibleverse{4} und führte sie in des HErrn Haus, in
...
Sohnes Sallums, des Torhüters. \bibleverse{5} Und ich setzte den Kindern
...
\bibleverse{12} Da geschah des HErrn Wort zu Jeremia und sprach:
\bibleverse{13} So spricht der HErr Zebaoth, der Gott Israels: Gehe hin
...
HErr. \bibleverse{14} Die Worte Jonadabs, des Sohnes Rechabs, die er
...
doch gehorchtet ihr mir nicht. \bibleverse{15} So habe ich auch stets zu
...
\footnote{\textbf{35:15} Jer 25,4-7} \bibleverse{16} so doch die Kinder
...
\bibleverse{17} Darum so spricht der HErr, der Gott Zebaoth und der Gott
...
getan, was er euch geboten hat, \bibleverse{19} darum spricht der HErr
...
\bibleverse{1} Im vierten Jahr Jojakims, des Sohnes Josias, des Königs
in Juda, geschah dieses Wort zu Jeremia vom HErrn und sprach:
\footnote{\textbf{36:1} Jer 25,1} \bibleverse{2} Nimm ein Buch und
...
nämlich von der Zeit Josias an bis auf diesen Tag; \bibleverse{3} ob
...
zu ihm geredet hatte. \footnote{\textbf{36:4} Jer 32,12} \bibleverse{5}
Und Jeremia gebot Baruch und sprach: Ich bin gefangen, dass ich nicht
kann in des HErrn Haus gehen. \bibleverse{6} Du aber gehe hinein und
...
\bibleverse{7} ob sie vielleicht sich mit Beten vor dem HErrn demütigen
...
Buche läse im Hause des HErrn. \bibleverse{9} Es begab sich aber im
...
\bibleverse{10} Und Baruch las aus dem Buche die Reden Jeremias im Hause
...
alle Reden des HErrn gehört hatte aus dem Buche, \bibleverse{12} ging er
...
samt allen Fürsten. \bibleverse{13} Und Michaja zeigte ihnen an alle
Reden, die er gehört hatte, da Baruch las aus dem Buche vor den Ohren
des Volks. \bibleverse{14} Da sandten alle Fürsten Judi, den Sohn
...
Reden dem König anzeigen. \bibleverse{17} Und sie fragten den Baruch:
...
\bibleverse{27} Da geschah des HErrn Wort zu Jeremia, nachdem der König
das Buch und die Reden, so Baruch hatte geschrieben aus dem Munde
Jeremias, verbrannt hatte, und sprach: \bibleverse{28} Nimm dir wiederum
...
\footnote{\textbf{36:29} Jer 25,9-11; Jer 7,20; Jer 9,9} \bibleverse{30}
...
\footnote{\textbf{36:30} Jer 22,19} \bibleverse{31} und ich will ihn und
...
\bibleverse{2} Aber er und seine Knechte und das Volk im Lande
...
\bibleverse{6} Und des HErrn Wort geschah zum Propheten Jeremia und
sprach: \bibleverse{7} So spricht der HErr, der Gott Israels: So sagt
...
Ägypten ziehen; \bibleverse{8} und die Chaldäer werden wiederkommen und
wider diese Stadt streiten und sie gewinnen und mit Feuer verbrennen.

\bibleverse{9} Darum spricht der HErr also: Betrüget eure Seelen nicht,
dass ihr denkt, die Chaldäer werden von uns abziehen; sie werden nicht
abziehen. \bibleverse{10} Und wenn ihr schon schlüget das ganze Heer der
...
in den Kerker geworfen haben? \bibleverse{19} Wo sind nun eure
Propheten, die euch weissagten und sprachen: Der König zu Babel wird
nicht über euch noch über dieses Land kommen? \bibleverse{20} Und nun,
...
\footnote{\textbf{38:1} Jer 21,1} \bibleverse{2} So spricht der HErr:
...
bleiben und wird sein Leben wie eine Beute davonbringen. \footnote{\textbf{38:2}
  Jer 21,9} \bibleverse{3} Denn also spricht der HErr: Diese Stadt soll
...
\bibleverse{17} Und Jeremia sprach zu Zedekia: So spricht der HErr, der
...
\bibleverse{18} wirst du aber nicht hinausgehen zu den Fürsten des
...
und du wirst lebend bleiben. \bibleverse{21} Wirst du aber nicht
hinausgehen, so ist dies das Wort, das mir der HErr gezeigt hat:
\bibleverse{22} Siehe, alle Weiber, die noch vorhanden sind in dem Hause
...
\bibleverse{1} Und es geschah, dass Jerusalem gewonnen ward. Denn im
...
belagerten es. \bibleverse{2} Und im elften Jahr Zedekias, am neunten
Tage des vierten Monats, brach man in die Stadt; \bibleverse{3} und
...
Fürsten des Königs zu Babel. \bibleverse{4} Als sie nun Zedekia, der
...
\bibleverse{15} Es war auch des HErrn Wort geschehen zu Jeremia, als er
noch im Vorhof des Gefängnisses gefangen lag, und hatte gesprochen:
\bibleverse{16} Gehe hin und sage Ebed-Melech, dem Mohren: So spricht
...
es sehen zur selben Zeit. \bibleverse{17} Aber dich will ich erretten
zur selben Zeit, spricht der HErr, und sollst den Leuten nicht zuteil
werden, vor welchen du dich fürchtest. \bibleverse{18} Denn ich will dir
...
Unglück über diese Stätte geredet \bibleverse{3} und hat's auch kommen
...
widerfahren. \bibleverse{4} Und nun siehe, ich habe dich heute
...
und dir gefällt, da zieh hin. \bibleverse{5} Denn weiter hinaus wird
...
\bibleverse{1} Aber im siebenten Monat kam Ismael, der Sohn Nethanjas,
...
und sie aßen daselbst zu Mizpa miteinander. \bibleverse{2} Und Ismael,
...
gesetzt hatte; \footnote{\textbf{41:2} Jer 40,5} \bibleverse{3} dazu
...
sich, dass sie es brächten zum Hause des HErrn. \bibleverse{6} Und
...
zu Gedalja, dem Sohn Ahikams, kommen. \bibleverse{7} Da sie aber mitten
in die Stadt kamen, ermordete sie Ismael, der Sohn Nethanjas, und die
Männer, die bei ihm waren, und warf sie in den Brunnen. \bibleverse{8}
...
\bibleverse{1} Da traten herzu alle Hauptleute des Heeres, Johanan, der
Sohn Kareahs, Jesanja, der Sohn Hosajas, samt dem ganzen Volk, klein und
groß, \bibleverse{2} und sprachen zum Propheten Jeremia: Lass doch unser
...
uns selbst siehst mit deinen Augen), \bibleverse{3} dass uns der HErr,
...
\bibleverse{5} Und sie sprachen zu Jeremia: Der HErr sei ein gewisser
und wahrhaftiger Zeuge zwischen uns, wo wir nicht tun werden alles, was
dir der HErr, dein Gott, an uns befehlen wird. \bibleverse{6} Es sei
...
\bibleverse{7} Und nach zehn Tagen geschah des HErrn Wort zu Jeremia.
\bibleverse{8} Da rief er Johanan, den Sohn Kareahs, und alle Hauptleute
des Heeres, die bei ihm waren, und alles Volk, klein und groß,
\bibleverse{9} und sprach zu ihnen: So spricht der HErr, der Gott
Israels, zu dem ihr mich gesandt habt, dass ich euer Gebet vor ihn
sollte bringen: \bibleverse{10} Werdet ihr in diesem Lande bleiben, so
...
und von seiner Hand errette. \bibleverse{12} Ich will euch
...
\bibleverse{15} nun so höret des HErrn Wort, ihr Übrigen aus Juda! So
...
\bibleverse{16} so soll euch das Schwert, vor dem ihr euch fürchtet, in
...
\bibleverse{17} Denn sie seien, wer sie wollen, die ihr Angesicht
...
\bibleverse{18} Denn so spricht der HErr Zebaoth, der Gott Israels:
...
\bibleverse{19} Das Wort des HErrn gilt euch, ihr Übrigen aus Juda, dass
ihr nicht nach Ägypten ziehet. Darum so wisset, dass ich euch heute
bezeuge; \bibleverse{20} ihr werdet sonst euer Leben verwahrlosen. Denn
...
wird, das zeige uns an, so wollen wir darnach tun. \bibleverse{21} Das
...
befohlen hat. \bibleverse{22} So sollt ihr nun wissen, dass ihr durch
...
\bibleverse{1} Da Jeremia alle Worte des HErrn, ihres Gottes, hatte
ausgeredet zu allem Volk, wie ihm denn der HErr, ihr Gott, alle diese
Worte an sie befohlen hatte, \bibleverse{2} sprachen Asarja, der Sohn
...
dass sie im Lande Juda wären geblieben; \bibleverse{5} sondern Johanan,
...
\bibleverse{8} Und des HErrn Wort geschah zu Jeremia zu Thachpanhes und
sprach: \bibleverse{9} Nimm große Steine und verscharre sie im
Ziegelofen, der vor der Tür am Hause Pharaos ist zu Thachpanhes, dass
die Männer aus Juda zusehen; \bibleverse{10} und sprich zu ihnen: So
...
und er soll sein Gezelt darüberschlagen. \bibleverse{11} Und er soll
...
\footnote{\textbf{43:11} Jer 15,2} \bibleverse{12} Und ich will die
...
Kleid anzieht, und mit Frieden von dannen ziehen. \footnote{\textbf{43:12}
  Jer 46,25} \bibleverse{13} Er soll die Bildsäulen zu Beth-Semes in
...
\bibleverse{1} Dies ist das Wort, das zu Jeremia geschah an alle Juden,
...
Noph und im Lande Pathros wohnten, und sprach: \footnote{\textbf{44:1}
  Jer 43,7} \bibleverse{2} So spricht der HErr Zebaoth, der Gott
...
sie wüst, und wohnt niemand darin; \bibleverse{3} und das um ihrer
...
eure Väter kannten. \bibleverse{4} Und ich sandte stets zu euch alle
meine Knechte, die Propheten, und ließ euch sagen: Tut doch nicht solche
Gräuel, die ich hasse. \bibleverse{5} Aber sie gehorchten nicht, neigten
auch ihre Ohren nicht, dass sie von ihrer Bosheit sich bekehrt und
anderen Göttern nicht geräuchert hätten. \bibleverse{6} Darum ging auch
...
\bibleverse{7} Nun, so spricht der HErr, der Gott Zebaoth, der Gott
...
und nichts von euch übrigbleibe, \bibleverse{8} und erzürnt mich so
...
\bibleverse{11} Darum spricht der HErr Zebaoth, der Gott Israels, also:
Siehe, ich will mein Angesicht wider euch richten zum Unglück, und ganz
Juda soll ausgerottet werden. \bibleverse{12} Und ich will die Übrigen
...
\bibleverse{13} Ich will auch die Einwohner in Ägyptenland mit Schwert,
Hunger und Pestilenz heimsuchen, gleichwie ich zu Jerusalem getan habe,
\bibleverse{14} dass aus den Übrigen Judas keiner soll entrinnen noch
...
\bibleverse{16} Nach dem Wort, das du im Namen des HErrn uns sagest,
wollen wir dir nicht gehorchen; \bibleverse{17} sondern wir wollen tun
...
wohl und sahen kein Unglück. \bibleverse{18} Seit der Zeit aber, dass
...
\bibleverse{22} dass er nicht mehr leiden konnte euren bösen Wandel und
...
\bibleverse{25} So spricht der HErr Zebaoth, der Gott Israels: Ihr und
...
\bibleverse{26} So höret nun des HErrn Wort, ihr alle aus Juda, die ihr
...
„So wahr der Herr HErr lebt!{}`` \bibleverse{27} Siehe, ich will über
...
mit ihnen habe. \bibleverse{28} Welche aber dem Schwert entrinnen, die
...
\bibleverse{29} Und zum Zeichen, spricht der HErr, dass ich euch an
diesem Ort heimsuchen will, damit ihr wisset, dass mein Wort soll wahr
werden über euch zum Unglück, \bibleverse{30} so spricht der HErr also:
...
in Juda, und sprach: \bibleverse{2} So spricht der HErr Zebaoth, der
Gott Israels, von dir, Baruch: \bibleverse{3} Du sprichst: Weh mir, wie
hat mir der HErr Jammer zu meinem Schmerz hinzugefügt! Ich seufze mich
müde und finde keine Ruhe.

\bibleverse{4} Sage ihm also: So spricht der HErr: Siehe, was ich gebaut
habe, das breche ich ab; und was ich gepflanzt habe, das reute ich aus,
nämlich dieses mein ganzes Land. \bibleverse{5} Und du begehrst dir
...
\bibleverse{1} Dies ist das Wort des HErrn, das zu dem Propheten Jeremia
...
HErr. \bibleverse{6} Der Schnelle kann nicht entfliehen noch der Starke
entrinnen. Gegen Mitternacht am Wasser Euphrat sind sie gefallen und
darniedergelegt. \bibleverse{7} Wer ist der, der heraufzieht wie der
Nil, und seine Wellen erheben sich wie Wasserwellen? \bibleverse{8}
...
und die Stadt verderben samt denen, die darin wohnen. \bibleverse{9}
...
Schützen aus Lud! \bibleverse{10} Denn dies ist der Tag des Herrn HErrn
...
gegen Mitternacht am Wasser Euphrat. \footnote{\textbf{46:10} 5Mo 32,42;
  Jes 34,5} \bibleverse{11} Gehe hinauf gen Gilead und hole Salbe,
...
\bibleverse{12} Deine Schande ist unter die Heiden erschollen, deines
...
\bibleverse{13} Dies ist das Wort des HErrn, das er zu dem Propheten
...
der Karmel am Meer ist. \bibleverse{19} Nimm dein Wandergerät, du
...
\bibleverse{24} Die Tochter Ägyptens steht mit Schanden; denn sie ist
dem Volk von Mitternacht in die Hände gegeben.

\bibleverse{25} Der HErr Zebaoth, der Gott Israels, spricht: Siehe, ich
...
\footnote{\textbf{46:25} Jer 43,12} \bibleverse{26} dass ich sie gebe in
...
\bibleverse{27} Aber du, mein Knecht Jakob, fürchte dich nicht, und du,
...
ihn schrecken. \bibleverse{28} Darum fürchte dich nicht, du, Jakob, mein
...
\bibleverse{1} Dies ist das Wort des HErrn, das zum Propheten Jeremia
...
werden schreien und alle Einwohner im Lande heulen \bibleverse{3} vor
...
umsehen nach den Kindern, so verzagt werden sie sein \bibleverse{4} vor
...
\bibleverse{5} Gaza wird kahl werden, und Askalon samt den Übrigen in
ihren Gründen wird verderbt. Wie lange ritzest du dich? \footnote{\textbf{47:5}
  Am 1,6-8; Zeph 2,4; Sach 9,5; Jer 41,5; Jer 48,37} \bibleverse{6} O du
Schwert des HErrn, wann willst du doch aufhören? Fahre doch in deine
Scheide und ruhe und sei still! \bibleverse{7} Aber wie kannst du
...
\bibleverse{1} Wider Moab. So spricht der HErr Zebaoth, der Gott
...
\bibleverse{2} Der Trotz Moabs ist aus, den sie an Hesbon hatten; denn
...
Schwert wird hinter dich kommen. \bibleverse{3} Man hört ein Geschrei zu
Horonaim von Verstören und großem Jammer. \bibleverse{4} Moab ist
zerschlagen! Man hört ihre Kleinen schreien; \bibleverse{5} denn sie
gehen mit Weinen den Weg hinauf gen Luhith, und die Feinde hören ein
Jammergeschrei den Weg von Horonaim herab: \bibleverse{6} „Hebt euch weg
...
\bibleverse{7} Darum dass du dich auf deine Gebäude verlässest und auf
...
gefangen wegziehen samt seinen Priestern und Fürsten. \footnote{\textbf{48:7}
  1Kö 11,7} \bibleverse{8} Denn der Verstörer wird über alle Städte
...
gesagt. \bibleverse{9} Gebt Moab Federn: er wird ausgehen, als flöge er;
und seine Städte werden wüst liegen, dass niemand darin wohnen wird.
\bibleverse{10} Verflucht sei, der des HErrn Werk lässig tut; verflucht
...
\bibleverse{11} Moab ist von seiner Jugend auf sicher gewesen und auf
...
und sein Geruch nicht verändert worden. \bibleverse{12} Darum siehe,
...
Krüge zerschmettern. \bibleverse{13} Und Moab soll über dem Kamos zu
Schanden werden, gleichwie das Haus Israel über Beth-El zu Schanden
geworden ist, darauf sie sich doch verließen. \bibleverse{14} Wie dürft
ihr sagen: Wir sind die Helden und die rechten Kriegsleute?
\bibleverse{15} so doch Moab muss verstört und ihre Städte erstiegen
werden und ihre beste Mannschaft zur Schlachtbank herabgehen muss,
spricht der König, welcher heißt der HErr Zebaoth. \bibleverse{16} Denn
...
\bibleverse{17} Habt doch Mitleid mit ihnen alle, die ihr um sie her
wohnt und ihren Namen kennt, und sprecht: „Wie ist die starke Rute und
der herrliche Stab so zerbrochen!{}`` \bibleverse{18} Herab von der
...
zerreißen. \bibleverse{19} Tritt auf die Straße und schaue, du
Einwohnerin Aroers; frage die, die da fliehen und entrinnen, und sprich:
„Wie geht's?{}`` \bibleverse{20} Ach, Moab ist verwüstet und verderbt!
Heulet und schreiet; sagt's am Arnon, dass Moab verstört sei!
\bibleverse{21} Die Strafe ist über das ebene Land gegangen, nämlich
über Holon, Jahza, Mephaath, \bibleverse{22} Dibon, Nebo,
Beth-Diblathaim, \bibleverse{23} Kirjathaim, Beth-Gamul, Beth-Meon,
\bibleverse{24} Karioth, Bozra und über alle Städte im Lande Moab, sie
liegen fern oder nahe. \bibleverse{25} Das Horn Moabs ist abgehauen, und
...
\bibleverse{26} Macht es trunken (denn es hat sich wider den HErrn
erhoben), dass es speien und die Hände ringen müsse, auf dass es auch
zum Gespött werde. \footnote{\textbf{48:26} Jer 25,15} \bibleverse{27}
...
müssen. \bibleverse{28} O ihr Einwohner in Moab, verlasst die Städte und
wohnt in den Felsen und tut wie die Tauben, die da nisten in den hohlen
Löchern! \bibleverse{29} Man hat immer gesagt von dem stolzen Moab, dass
es sehr stolz sei, hoffärtig, hochmütig, trotzig und übermütig.
\bibleverse{30} Aber der HErr spricht: Ich kenne seinen Zorn wohl, dass
er nicht soviel vermag und untersteht sich, mehr zu tun, denn sein
Vermögen ist. \bibleverse{31} Darum muss ich über Moab heulen und über
das ganze Moab schreien und über die Leute zu Kir-Heres klagen.
\bibleverse{32} Mehr als über Jaser muss ich über dich, du Weinstock zu
...
\bibleverse{33} Freude und Wonne ist aus dem Felde weg und aus dem Lande
...
\bibleverse{35} Und ich will, spricht der HErr, in Moab damit ein Ende
machen, dass sie nicht mehr auf den Höhen opfern und ihren Göttern
räuchern sollen. \bibleverse{36} Darum seufzt mein Herz über Moab wie
Flöten, und über die Leute zu Kir-Heres seufzt mein Herz wie Flöten;
denn das Gut, das sie gesammelt, ist zu Grunde gegangen. \bibleverse{37}
...
Gefäß, spricht der HErr. \bibleverse{39} O wie ist es verderbt, wie
...
\bibleverse{40} Denn so spricht der HErr: Siehe, er fliegt daher wie ein
Adler und breitet seine Flügel aus über Moab. \bibleverse{41} Karioth
...
Kindsnöten. \bibleverse{42} Denn Moab muss vertilgt werden, dass sie
kein Volk mehr seien, darum dass es sich wider den HErr erhoben hat.
\bibleverse{43} Schrecken, Grube und Strick kommt über dich, du
Einwohner in Moab, spricht der HErr. \bibleverse{44} Wer dem Schrecken
...
lassen ein Jahr ihrer Heimsuchung, spricht der HErr. \footnote{\textbf{48:44}
  Jes 24,17-18} \bibleverse{45} Die aus der Schlacht entrinnen, werden
...
\bibleverse{46} Weh dir, Moab! verloren ist das Volk des Kamos; denn man
hat deine Söhne und Töchter genommen und gefangen weggeführt.
\bibleverse{47} Aber in der letzten Zeit will ich das Gefängnis Moabs
...
\bibleverse{1} Wider die Kinder Ammon spricht der HErr also: Hat denn
...
das Land Gad, und sein Volk wohnt in jener Städten? \footnote{\textbf{49:1}
  Hes 25,2-7; Am 1,13-15; Zeph 2,8-11; 1Kö 11,5} \bibleverse{2} Darum
...
spricht der HErr. \bibleverse{3} Heule, o Hesbon! denn Ai ist verstört.
...
Priestern und Fürsten. \bibleverse{4} Was trotzest du auf deine Auen?
...
machen? \bibleverse{5} Siehe, spricht der Herr HErr Zebaoth: Ich will
...
sei, der die Flüchtigen sammle. \bibleverse{6} Aber darnach will ich
...
\bibleverse{7} Wider Edom. So spricht der HErr Zebaoth: Ist denn keine
...
Weisheit so leer geworden? \footnote{\textbf{49:7} Jes 21,11; Jes
  34,5-15; Hes 25,12-14; Am 1,11; Am 1,1-12; Ob 1,-1} \bibleverse{8}
...
Heimsuchung. \bibleverse{9} Es sollen Weinleser über dich kommen, die
dir kein Nachlesen lassen; und Diebe des Nachts sollen über dich kommen,
die sollen ihnen genug verderben. \bibleverse{10} Denn ich habe Esau
...
\bibleverse{12} Denn so spricht der HErr: Siehe, die, die es nicht
...
\bibleverse{14} Ich habe gehört vom HErrn, dass eine Botschaft unter die
Heiden gesandt sei: Sammelt euch und kommt her wider sie, macht euch auf
zum Streit! \bibleverse{15} Denn siehe, ich habe dich gering gemacht
unter den Heiden und verachtet unter den Menschen. \bibleverse{16} Dein
...
herunterstürzen, spricht der HErr. \bibleverse{17} Also soll Edom wüst
werden, dass alle die, die vorübergehen, sich wundern und pfeifen werden
über alle ihre Plage; \footnote{\textbf{49:17} Jer 50,13}
\bibleverse{18} gleichwie Sodom und Gomorra samt ihren Nachbarn
...
\bibleverse{19} Denn siehe, er kommt herauf wie ein Löwe vom stolzen
...
widerstehen kann? \footnote{\textbf{49:19} Jer 50,44} \bibleverse{20} So
...
\bibleverse{21} dass die Erde beben wird, wenn's ineinander fällt, und
ihr Geschrei wird man am Schilfmeer hören. \bibleverse{22} Siehe, er
...
untergehen zur selben Zeit, spricht der HErr Zebaoth. \bibleverse{27}
...
\bibleverse{28} Wider Kedar und die Königreiche Hazors, welche
...
\bibleverse{29} Man wird ihnen ihre Hütten und Herden nehmen; ihr
Gezelt, alle Geräte und Kamele werden sie wegführen; und man wird über
sie rufen: Schrecken um und um! \bibleverse{30} Fliehet, hebet euch
...
euch und meint euch. \footnote{\textbf{49:30} Jer 49,8} \bibleverse{31}
...
Unglück über sie kommen lassen, spricht der HErr, \bibleverse{33} dass
...
\bibleverse{34} Dies ist das Wort des HErrn, welches geschah zu Jeremia,
dem Propheten, wider Elam im Anfang des Königreichs Zedekias, des Königs
in Juda, und sprach: \footnote{\textbf{49:34} Jer 25,25} \bibleverse{35}
So spricht der HErr Zebaoth: Siehe, ich will den Bogen Elams zerbrechen,
ihre vornehmste Gewalt, \bibleverse{36} und will die vier Winde aus den
...
\bibleverse{38} Meinen Stuhl will ich in Elam aufrichten und will beide,
den König und die Fürsten, daselbst umbringen, spricht der HErr.
\bibleverse{39} Aber in der letzten Zeit will ich das Gefängnis Elams
...
\bibleverse{1} Dies ist das Wort, welches der HErr durch den Propheten
Jeremia geredet hat wider Babel und das Land der Chaldäer: \footnote{\textbf{50:1}
  Jes 13,-1; Jes 14,1-14} \bibleverse{2} Verkündiget unter den Heiden
...
\bibleverse{3} Denn es zieht von Mitternacht ein Volk herauf wider sie,
welches wird ihr Land zur Wüste machen, dass niemand darin wohnen wird,
sondern beide, Leute und Vieh, davonfliehen werden. \bibleverse{4} In
...
HErrn, ihren Gott, suchen. \bibleverse{5} Sie werden forschen nach dem
...
\bibleverse{6} Denn mein Volk ist wie eine verlorene Herde; ihre Hirten
...
haben. \bibleverse{7} Es fraßen sie alle, die sie antrafen; und ihre
...
HErrn, der ihrer Väter Hoffnung ist. \bibleverse{8} Fliehet aus Babel
und ziehet aus der Chaldäer Lande und stellet euch als Böcke vor der
Herde her. \footnote{\textbf{50:8} Jer 51,6; Jer 51,45} \bibleverse{9}
...
eines guten Kriegers, der nicht fehlt. \bibleverse{10} Und das
Chaldäerland soll ein Raub werden, dass alle, die sie berauben, sollen
genug davon haben, spricht der HErr; \bibleverse{11} darum dass ihr euch
des freuet und rühmet, dass ihr mein Erbteil geplündert habt, und hüpfet
wie die jungen Kälber und wiehert wie die starken Gäule. \bibleverse{12}
...
dürr und öde. \bibleverse{13} Denn vor dem Zorn des HErrn muss sie
...
werden sich verwundern und pfeifen über all ihre Plage. \footnote{\textbf{50:13}
  Jer 51,37; Jer 49,17} \bibleverse{14} Rüstet euch wider Babel umher,
alle Schützen, schießet in sie, sparet die Pfeile nicht; denn sie hat
wider den HErrn gesündigt. \bibleverse{15} Jauchzet über sie um und um!
...
wie sie getan hat. \bibleverse{16} Rottet aus von Babel beide, den
...
\bibleverse{18} Darum spricht der HErr Zebaoth, der Gott Israels, also:
Siehe, ich will den König zu Babel heimsuchen und sein Land, gleichwie
ich den König von Assyrien heimgesucht habe. \bibleverse{19} Israel aber
...
werden soll. \bibleverse{20} Zur selben Zeit und in denselben Tagen wird
...
\bibleverse{21} Zieh hinauf wider das Land, das alles verbittert hat;
...
habe! \bibleverse{22} Es ist ein Kriegsgeschrei im Lande und großer
Jammer. \bibleverse{23} Wie geht's zu, dass der Hammer der ganzen Welt
zerbrochen und zerschlagen ist? Wie geht's zu, dass Babel eine Wüste
geworden ist unter allen Heiden? \bibleverse{24} Ich habe dir
...
getrotzt. \bibleverse{25} Der HErr hat seinen Schatz aufgetan und die
Waffen seines Zorns hervorgebracht; denn der Herr HErr Zebaoth hat etwas
auszurichten in der Chaldäer Lande. \bibleverse{26} Kommt her wider sie,
ihr vom Ende, öffnet ihre Kornhäuser, werfet sie in einen Haufen und
verbannet sie, dass ihr nichts übrigbleibe! \bibleverse{27} Erwürget
alle ihre Rinder, führt sie hinab zu Schlachtbank! Weh ihnen! denn ihr
Tag ist gekommen, die Zeit ihrer Heimsuchung. \bibleverse{28} Man hört
...
Gottes, die Rache seines Tempels. \bibleverse{29} Rufet viele wider
...
Heiligen in Israel. \footnote{\textbf{50:29} Jer 50,15} \bibleverse{30}
...
\bibleverse{31} Siehe, du Stolzer, ich will an dich, spricht der Herr
HErr Zebaoth; denn dein Tag ist gekommen, die Zeit deiner Heimsuchung.
\bibleverse{32} Da soll der Stolze stürzen und fallen, dass ihn niemand
...
\bibleverse{33} So spricht der HErr Zebaoth: Siehe, die Kinder Israel
...
\bibleverse{34} Aber ihr Erlöser ist stark, der heißt HErr Zebaoth; der
...
\bibleverse{35} Schwert soll kommen, spricht der HErr, über die Chaldäer
und über die Einwohner zu Babel und über ihre Fürsten und über ihre
Weisen! \bibleverse{36} Schwert soll kommen über ihre Weissager, dass
sie zu Narren werden; Schwert soll kommen über ihre Starken, dass sie
verzagen! \bibleverse{37} Schwert soll kommen über ihre Rosse und Wagen
...
\bibleverse{38} Trockenheit soll kommen über ihre Wasser, dass sie
...
niemand darin wohne noch ein Mensch darin hause. \footnote{\textbf{50:40}
  1Mo 19,24-25} \bibleverse{41} Siehe, es kommt ein Volk von Mitternacht
her; viele Heiden und viele Könige werden vom Ende der Erde sich
aufmachen. \footnote{\textbf{50:41} Jer 50,9} \bibleverse{42} Die haben
...
\bibleverse{43} Wenn der König zu Babel ihr Gerücht hören wird, so
werden ihm die Fäuste entsinken; ihm wird so angst und bange werden wie
einer Frau in Kindsnöten. \bibleverse{44} Siehe, er kommt herauf wie ein
...
mir widerstehen kann? \bibleverse{45} So höret nun den Ratschlag des
...
sie fortschleifen werden und ihre Wohnung zerstören. \bibleverse{46} Und
...
\bibleverse{1} So spricht der HErr: Siehe, ich will einen scharfen Wind
erwecken wider Babel und wider ihre Einwohner, die sich wider mich
gesetzt haben. \bibleverse{2} Ich will auch Worfler gen Babel schicken,
...
\bibleverse{3} denn ihre Schützen werden nicht schießen, und ihre
Geharnischten werden sich nicht wehren können. So verschonet nun ihre
junge Mannschaft nicht, verbannet all ihr Heer, \bibleverse{4} dass die
Erschlagenen daliegen im Lande der Chaldäer und die Erstochenen auf
ihren Gassen! \bibleverse{5} Denn Israel und Juda sollen nicht Witwen
von ihrem Gott, dem HErrn Zebaoth, gelassen werden. Denn jener Land hat
sich hoch verschuldet am Heiligen in Israel. \bibleverse{6} Fliehet aus
...
getrunken, darum sind die Heiden so toll geworden. \footnote{\textbf{51:7}
  Jer 25,15; Offb 17,4; Offb 18,3} \bibleverse{8} Wie plötzlich ist
...
ihren Wunden, ob sie vielleicht möchte heil werden! \footnote{\textbf{51:8}
  Offb 18,2} \bibleverse{9} Wir heilen Babel; aber sie will nicht heil
...
an die Wolken. \bibleverse{10} Der HErr hat unsere Gerechtigkeit
...
HErrn, die Rache seines Tempels. \bibleverse{12} Ja, steckt nun Panier
...
Einwohner zu Babel geredet hat. \bibleverse{13} Die du an großen Wassern
wohnst und große Schätze hast, dein Ende ist gekommen, und dein Geiz ist
aus! \footnote{\textbf{51:13} Offb 17,1} \bibleverse{14} Der HErr
...
\bibleverse{15} Er hat die Erde durch seine Kraft gemacht und den
Weltkreis durch seine Weisheit bereitet und den Himmel ausgebreitet
durch seinen Verstand. \bibleverse{16} Wenn er donnert, so ist da Wasser
...
Vorratskammern. \bibleverse{17} Alle Menschen sind Narren mit ihrer
Kunst, und alle Goldschmiede bestehen mit Schanden mit ihren Bildern;
denn ihre Götzen sind Trügerei und haben kein Leben. \bibleverse{18} Es
ist eitel Nichts und verführerisches Werk; sie müssen umkommen, wenn sie
heimgesucht werden. \bibleverse{19} Aber also ist der nicht, der Jakobs
...
\bibleverse{20} Du bist mein Hammer, meine Kriegswaffe; durch dich
zerschmettere ich die Heiden und zerstöre die Königreiche; \footnote{\textbf{51:20}
  Jer 50,23; Jes 10,5} \bibleverse{21} durch dich zerschmettere ich
Rosse und Reiter und zerschmettere Wagen und Fuhrmänner; \bibleverse{22}
durch dich zerschmettere ich Männer und Weiber und zerschmettere Alte
und Junge und zerschmettere Jünglinge und Jungfrauen; \bibleverse{23}
...
Augen, spricht der HErr. \bibleverse{25} Siehe, ich will an dich, du
...
und will einen verbrannten Berg aus dir machen, \bibleverse{26} dass man
...
\bibleverse{27} Werfet Panier auf im Lande, blaset die Posaune unter den
...
\bibleverse{28} Heiliget die Heiden wider sie, die Könige aus Medien
samt allen ihren Fürsten und Herren und das ganze Land ihrer Herrschaft,
\bibleverse{29} dass das Land erbebe und erschrecke; denn die Gedanken
des HErrn wollen erfüllt werden wider Babel, dass er das Land Babel zur
Wüste mache, darin niemand wohne. \bibleverse{30} Die Helden zu Babel
...
angesteckt und ihre Riegel zerbrochen. \bibleverse{31} Es läuft hier
...
ans Ende \bibleverse{32} und die Furten eingenommen und die Seen
ausgebrannt sind und die Kriegsleute seien blöde geworden.

\bibleverse{33} Denn also spricht der HErr Zebaoth, der Gott Israels:
...
\bibleverse{34} Nebukadnezar, der König zu Babel, hat mich gefressen und
...
Köstlichsten; er hat mich verstoßen. \bibleverse{35} Nun aber komme über
...
spricht Jerusalem. \bibleverse{36} Darum spricht der HErr also: Siehe,
ich will dir deine Sache ausführen und dich rächen; ich will ihr Meer
austrocknen und ihre Brunnen versiegen lassen. \bibleverse{37} Und Babel
soll zum Steinhaufen und zur Wohnung der Schakale werden, zum Wunder und
zum Anpfeifen, dass niemand darin wohne. \bibleverse{38} Sie sollen
miteinander brüllen wie die Löwen und schreien wie die jungen Löwen.
\bibleverse{39} Ich will sie mit ihrem Trinken in die Hitze setzen und
...
HErr. \bibleverse{40} Ich will sie herunterführen wie Lämmer zur
...
\bibleverse{41} Wie ist Sesach so gewonnen und die Berühmte in aller
Welt so eingenommen! Wie ist Babel so zum Wunder geworden unter den
Heiden! \bibleverse{42} Es ist ein Meer über Babel gegangen, und es ist
mit seiner Wellen Menge bedeckt. \bibleverse{43} Ihre Städte sind zur
Wüste und zu einem dürren, öden Lande geworden, zu einem Lande, darin
niemand wohnt und darin kein Mensch wandelt. \bibleverse{44} Denn ich
...
laufen; denn es sind auch die Mauern zu Babel zerfallen. \footnote{\textbf{51:44}
  Jer 50,2} \bibleverse{45} Ziehet heraus, mein Volk, und errette ein
jeglicher seine Seele vor dem grimmigen Zorn des HErrn! \footnote{\textbf{51:45}
  Jer 51,6} \bibleverse{46} Euer Herz möchte sonst weich werden und
...
\bibleverse{47} Darum siehe, es kommt die Zeit, dass ich die Götzen zu
Babel heimsuchen will und ihr ganzes Land zu Schanden werden soll und
ihre Erschlagenen darin liegen werden. \bibleverse{48} Himmel und Erde
...
von Mitternacht gekommen sind, spricht der HErr. \footnote{\textbf{51:48}
  Offb 18,20} \bibleverse{49} Und wie Babel in Israel die Erschlagenen
gefällt hat, also sollen zu Babel die Erschlagenen fallen im ganzen
Lande. \bibleverse{50} So ziehet nun hin, die ihr dem Schwert entronnen
...
HErrn kamen. \bibleverse{52} Darum siehe, die Zeit kommt, spricht der
HErr, dass ich ihre Götzen heimsuchen will, und im ganzen Lande sollen
die tödlich Verwundeten seufzen. \bibleverse{53} Und wenn Babel gen
...
\bibleverse{54} Man hört ein Geschrei zu Babel und einen großen Jammer
in der Chaldäer Lande; \bibleverse{55} denn der HErr verstört Babel und
verderbt sie mit großem Getümmel; ihre Wellen brausen wie die großen
Wasser, es erschallt ihr lautes Toben. \bibleverse{56} Denn es ist über
...
\footnote{\textbf{51:56} 5Mo 32,35} \bibleverse{57} Ich will ihre
...
\bibleverse{58} So spricht der HErr Zebaoth: Die Mauern der großen Babel
...
dass sie ewiglich wüst sei. \bibleverse{63} Und wenn du das Buch hast
...
\bibleverse{1} Zedekia war einundzwanzig Jahre alt, da er König ward,
und regierte elf Jahre zu Jerusalem. Seine Mutter hieß Hamutal, eine
Tochter Jeremias zu Libna. \bibleverse{2} Und er tat was dem HErrn übel
gefiel, gleich wie Jojakim getan hatte. \bibleverse{3} Denn es ging des
...
Jerusalem \bibleverse{13} und verbrannte des HErrn Haus und des Königs
Haus und alle Häuser zu Jerusalem; alle großen Häuser verbrannte er mit
Feuer. \bibleverse{14} Und das ganze Heer der Chaldäer, das bei dem
...
\bibleverse{17} Aber die ehernen Säulen am Hause des HErrn und das
Gestühl und das eherne Meer am Hause des HErrn zerbrachen die Chaldäer
und führten all das Erz davon gen Babel. \bibleverse{18} Und die Kessel,
Schaufeln, Messer, Becken, Kellen und alle ehernen Gefäße, die man im
Gottesdienst pflegte zu brauchen, nahmen sie weg. \bibleverse{19} Dazu
...
\footnote{\textbf{52:20} 1Kö 7,15-47} \bibleverse{21} Der zwei Säulen
...
inwendig hohl; \bibleverse{22} und stand auf jeglicher ein eherner
