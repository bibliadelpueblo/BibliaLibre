...
mir, spricht der Herr \textsc{Herr}. \bibleverse{23} Wie darfst du denn
...
weiden sollen mit Lehre und Weisheit. \footnote{\textbf{24:7} Jer
  31,33-34} \bibleverse{16} Und es soll geschehen, wenn ihr gewachsen
...
ist doch nicht Friede. \textsuperscript{b} \bibleverse{15} Darum werden
...
\textsuperscript{b} \bibleverse{14} so will ich dem Hause, das nach
...
\footnote{\textbf{7:33} Jer 19,7; Jer 9,21} \bibleverse{15} und will
...
gehe. \textsuperscript{b} \bibleverse{24} Aber sie wollen nicht hören
...
sich. \textsuperscript{c} \bibleverse{25} Ja, von dem Tage an, da ich
eure Väter aus Ägyptenland geführt habe, bis auf diesen Tag habe ich
stets zu euch gesandt alle meine Knechte, die Propheten. \bibleverse{26}
...
wird. \textsuperscript{b} \bibleverse{33} Und die Leichname dieses Volks
...
ist mehr Schaden da. \footnote{\textbf{8:15} Jer 14,19} \bibleverse{16}
...
wohnen. \bibleverse{17} Denn siehe, ich will Schlangen und Basilisken
...
Bilder und fremde, unnütze Gottesdienste? \bibleverse{20} „Die Ernte ist
...
Galle tränken; \textsuperscript{b} \bibleverse{15} ich will sie unter
...
\footnote{\textbf{9:15} 3Mo 26,33} \bibleverse{16} So spricht der
...
der Werkmeister macht Götter mit dem Beil \footnote{\textbf{10:3} Jes
  44,10-20} \bibleverse{4} und schmückt sie mit Silber und Gold und
heftet sie mit Nägeln und Hämmern, dass sie nicht umfallen.
\bibleverse{5} Es sind ja nichts als überzogene Säulen. Sie können nicht
...
\bibleverse{25} Schütte aber deinen Zorn über die Heiden, so dich nicht
...
mein vergessen hast und verlässest dich auf Lügen, \bibleverse{26} so
will ich auch deine Säume hoch aufdecken, dass man deine Schande sehen
muss. \bibleverse{27} Denn ich habe gesehen deine Ehebrecherei, dein
...
ihre Häupter. \footnote{\textbf{14:4} Joe 1,11} \bibleverse{5} Denn auch
die Hinden, die auf dem Felde werfen, verlassen die Jungen, weil kein
Gras wächst. \bibleverse{6} Das Wild steht auf den Hügeln und schnappt
...
wohnt. \textsuperscript{b} \bibleverse{7} Gesegnet aber ist der Mann,
der sich auf den \textsc{Herrn} verlässt und des Zuversicht der
\textsc{Herr} ist. \footnote{\textbf{17:7} Ps 146,5} \bibleverse{8} Der
...
Tun, nach den Früchten seiner Werke. \footnote{\textbf{17:10} Ps 7,10;
  Röm 2,6} \bibleverse{11} Denn gleichwie ein Vogel, der sich über Eier
...
hören noch sich ziehen lassen. \textsuperscript{b} \bibleverse{24} So
...
heiliget, dass ihr keine Arbeit an demselben Tage tut: \bibleverse{25}
...
\textsuperscript{b} \bibleverse{4} darum dass sie mich verlassen und
...
\textsuperscript{c} \bibleverse{6} Darum siehe, es wird die Zeit kommen,
...
dieselben rauben, nehmen und gen Babel bringen. \footnote{\textbf{20:5}
  Jes 39,6} \bibleverse{6} Und du, Pashur, sollst mit allen deinen
...
\textsuperscript{b} \bibleverse{13} Singet dem \textsc{Herrn}, rühmt den
...
\footnote{\textbf{21:1} Jer 29,25} \bibleverse{2} Frage doch den
...
Gewalt, und vergießt nicht unschuldig Blut an dieser Stätte. \footnote{\textbf{22:3}
  Jer 21,12} \bibleverse{4} Werdet ihr solches tun, so sollen durch die
Tore dieses Hauses einziehen Könige, die auf Davids Stuhl sitzen, zu
Wagen und zu Rosse, samt ihren Knechten und ihrem Volk.
\textsuperscript{b} \bibleverse{5} Werdet ihr aber solchem nicht
...
hinausgezogen ist: Er wird nicht wieder herkommen, \footnote{\textbf{22:11}
  2Chr 36,3-4} \bibleverse{12} sondern muss sterben an dem Ort, dahin er
...
ach Edler!{}`` \footnote{\textbf{22:18} Jer 34,5} \bibleverse{19} Er
...
und zerstreuet! spricht der \textsc{Herr}. \footnote{\textbf{23:1} Hes
  13,2-16; Hes 34,1-34; Sach 11,5} \bibleverse{2} Darum spricht der
...
\bibleverse{7} Darum siehe, es wird die Zeit kommen, spricht der
\textsc{Herr}, dass man nicht mehr sagen wird: So wahr der \textsc{Herr}
lebt, der die Kinder Israel aus Ägyptenland geführt hat!
\textsuperscript{c} \bibleverse{8} sondern: So wahr der \textsc{Herr}
...
\bibleverse{18} Aber wer ist im Rat des \textsc{Herrn} gestanden, der
sein Wort gesehen und gehört habe? Wer hat sein Wort vernommen und
gehört? \textsuperscript{c} \bibleverse{19} Siehe, es wird ein Wetter
des \textsc{Herrn} mit Grimm kommen und ein schreckliches Ungewitter den
Gottlosen auf den Kopf fallen. \textsuperscript{d} \bibleverse{20} Und
...
Jerusalem und gen Babel gebracht. \footnote{\textbf{24:1} Jer 29,2; 2Kö
  24,14-15} \bibleverse{2} In dem einen Korbe waren sehr gute Feigen,
...
dem grimmigen Zorn des \textsc{Herrn}. \bibleverse{38} Er hat seine
...
Juda und Jerusalem, \textsuperscript{b} \bibleverse{21} -- denn so
...
in Juda und zu Jerusalem: \bibleverse{22} Sie sollen gen Babel geführt
...
\bibleverse{19} darum dass sie meinen Worten nicht gehorchen, spricht
...
\footnote{\textbf{31:34} Jer 33,8; Jes 43,25} \bibleverse{22} dass man
...
Ahab, welche der König zu Babel auf Feuer braten ließ, \bibleverse{23}
...
welchen ich ihnen erwecken will. \textsuperscript{b} \bibleverse{10}
...
\bibleverse{11} Denn ich bin bei dir, spricht der \textsc{Herr}, dass
...
will euer Gott sein. \textsuperscript{b} \bibleverse{23} Siehe, es wird
...
\bibleverse{24} Des \textsc{Herrn} grimmiger Zorn wird nicht nachlassen,
...
nach der Frucht seines Wesens; \textsuperscript{b} \bibleverse{20} der
...
gewinnen. \textsuperscript{b} \bibleverse{29} Und die Chaldäer, die
...
sprach: \footnote{\textbf{33:1} Jer 32,2} \bibleverse{2} So spricht der
\textsc{Herr}, der solches macht, tut und ausrichtet -- \textsc{Herr}
ist sein Name --: \bibleverse{3} Rufe mich an, so will ich dir antworten
und will dir anzeigen große und gewaltige Dinge, die du nicht weißt.
\bibleverse{4} Denn so spricht der \textsc{Herr}, der Gott Israels, von
den Häusern dieser Stadt und von den Häusern der Könige Judas, welche
abgebrochen sind, Bollwerke zu machen zur Wehr, \bibleverse{5} und von
...
dieser Stadt verborgen um all ihrer Bosheit willen: \bibleverse{6}
Siehe, ich will sie heilen und gesund machen und will ihnen Frieden und
Treue die Fülle gewähren. \bibleverse{7} Denn ich will das Gefängnis
Judas und das Gefängnis Israels wenden und will sie bauen wie von Anfang
\textsuperscript{b} \bibleverse{8} und will sie reinigen von aller
...
\textsuperscript{c} \bibleverse{9} Und das soll mir ein fröhlicher Name,
...
Frost liegen; \textsuperscript{b} \bibleverse{31} und ich will ihn und
...
davonbringen. \textsuperscript{b} \bibleverse{3} Denn also spricht der
...
\textsuperscript{b} \bibleverse{13} Er soll die Bildsäulen zu Beth-Semes
...
Noph und im Lande Pathros wohnten, und sprach: \footnote{\textbf{44:1}
  Jer 43,7} \bibleverse{2} So spricht der \textsc{Herr} Zebaoth, der
...
sind sie wüst, und wohnt niemand darin; \bibleverse{3} und das um ihrer
...
\textsuperscript{b} \bibleverse{12} Deine Schande ist unter die Heiden
...
hat's gesagt. \bibleverse{9} Gebt Moab Federn: er wird ausgehen, als
flöge er; und seine Städte werden wüst liegen, dass niemand darin wohnen
wird. \bibleverse{10} Verflucht sei, der des \textsc{Herrn} Werk lässig
...
\bibleverse{27} Denn Israel hat dein Gespött sein müssen, als wäre es
unter den Dieben gefunden; und weil du solches wider dasselbe redest,
sollst du auch weg müssen. \bibleverse{28} O ihr Einwohner in Moab,
verlasst die Städte und wohnt in den Felsen und tut wie die Tauben, die
da nisten in den hohlen Löchern! \bibleverse{29} Man hat immer gesagt
von dem stolzen Moab, dass es sehr stolz sei, hoffärtig, hochmütig,
trotzig und übermütig. \bibleverse{30} Aber der \textsc{Herr} spricht:
Ich kenne seinen Zorn wohl, dass er nicht soviel vermag und untersteht
sich, mehr zu tun, denn sein Vermögen ist. \bibleverse{31} Darum muss
ich über Moab heulen und über das ganze Moab schreien und über die Leute
zu Kir-Heres klagen. \bibleverse{32} Mehr als über Jaser muss ich über
...
Weinlese gefallen; \bibleverse{33} Freude und Wonne ist aus dem Felde
...
wird. \textsuperscript{b} \bibleverse{46} Weh dir, Moab! verloren ist
das Volk des Kamos; denn man hat deine Söhne und Töchter genommen und
gefangen weggeführt. \bibleverse{47} Aber in der letzten Zeit will ich
...
wundern und pfeifen werden über alle ihre Plage; \footnote{\textbf{49:17}
  Jer 50,13} \bibleverse{18} gleichwie Sodom und Gomorra samt ihren
...
widerstehen kann? \textsuperscript{e} \bibleverse{20} So höret nun den
...
\bibleverse{31} Wohlauf, ziehet herauf wider ein Volk, das genug hat und
sicher wohnt, spricht der \textsc{Herr}; sie haben weder Tür noch Riegel
und wohnen allein. \bibleverse{32} Ihre Kamele sollen geraubt und die
...
\bibleverse{35} So spricht der \textsc{Herr} Zebaoth: Siehe, ich will
den Bogen Elams zerbrechen, ihre vornehmste Gewalt, \bibleverse{36} und
...
soll, dahin nicht Vertriebene aus Elam kommen werden. \bibleverse{37}
...
ihnen her schicken, bis ich sie aufreibe. \bibleverse{38} Meinen Stuhl
will ich in Elam aufrichten und will beide, den König und die Fürsten,
daselbst umbringen, spricht der \textsc{Herr}. \bibleverse{39} Aber in
...
\textsuperscript{b} \bibleverse{3} Denn es zieht von Mitternacht ein
...
werden. \bibleverse{4} In denselben Tagen und zur selben Zeit, spricht
...
\bibleverse{5} Sie werden forschen nach dem Wege gen Zion, dahin sich
kehren: Kommt, wir wollen uns zum \textsc{Herrn} fügen mit einem ewigen
Bunde, des nimmermehr vergessen werden soll! \bibleverse{6} Denn mein
...
Hügel gegangen sind und ihre Hürden vergessen haben. \bibleverse{7} Es
...
der Herde her. \textsuperscript{c} \bibleverse{9} Denn siehe, ich will
...
den \textsc{Herrn} gesündigt. \bibleverse{15} Jauchzet über sie um und
...
ihr, tut ihr, wie sie getan hat. \bibleverse{16} Rottet aus von Babel
...
\textsc{Herr}. \bibleverse{31} Siehe, du Stolzer, ich will an dich,
...
Ende der Erde sich aufmachen. \textsuperscript{b} \bibleverse{42} Die
...
um sie sein werden am Tage ihres Unglücks; \footnote{\textbf{51:2} Jer
  15,7} \bibleverse{3} denn ihre Schützen werden nicht schießen, und
ihre Geharnischten werden sich nicht wehren können. So verschonet nun
ihre junge Mannschaft nicht, verbannet all ihr Heer, \bibleverse{4} dass
...
Land hat sich hoch verschuldet am Heiligen in Israel. \bibleverse{6}
...
Babel zur Wüste mache, darin niemand wohne. \bibleverse{30} Die Helden
...
sind angesteckt und ihre Riegel zerbrochen. \bibleverse{31} Es läuft
...
gewonnen sei bis ans Ende \bibleverse{32} und die Furten eingenommen und
...
bezahlt ihr. \footnote{\textbf{51:56} 5Mo 32,35} \bibleverse{57} Ich
