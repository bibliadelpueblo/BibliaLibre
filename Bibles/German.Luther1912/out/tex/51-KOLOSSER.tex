...
Evangelium, \footnote{\textbf{1:5} 1Petr 1,3-4} \bibleverse{6} das zu
...
in der Wahrheit; \bibleverse{7} wie ihr denn gelernt habt von Epaphras,
unserem lieben Mitdiener, welcher ist ein treuer Diener Christi für
euch, \bibleverse{8} der uns auch eröffnet hat eure Liebe im Geist.
...
fruchtbar seid in allen guten Werken \footnote{\textbf{1:10} Eph 4,1;
  Phil 1,27} \bibleverse{11} und wachset in der Erkenntnis Gottes und
gestärkt werdet mit aller Kraft nach seiner herrlichen Macht zu aller
Geduld und Langmütigkeit mit Freuden, \bibleverse{12} und danksaget dem
Vater, der uns tüchtig gemacht hat zu dem Erbteil der Heiligen im Licht;
\footnote{\textbf{1:12} Eph 1,11; 1Petr 1,4} \bibleverse{13} welcher uns
...
Erstgeborene vor allen Kreaturen. \footnote{\textbf{1:15} Hebr 1,3; Offb
  3,14} \bibleverse{16} Denn durch ihn ist alles geschaffen, was im
...
alles durch ihn und zu ihm geschaffen. \footnote{\textbf{1:16} Joh 1,3;
  Joh 1,10; Hebr 1,2} \bibleverse{17} Und er ist vor allem, und es
besteht alles in ihm. \footnote{\textbf{1:17} Apg 26,23; 1Kor 15,20;
  Offb 1,5; Eph 1,22} \bibleverse{18} Und er ist das Haupt des Leibes,
...
die Vernunft in bösen Werken, \footnote{\textbf{1:21} Röm 5,10; Eph
  2,12-13; Eph 4,18} \bibleverse{22} hat er nun versöhnt mit dem Leibe
...
unsträflich und ohne Tadel vor ihm selbst; \footnote{\textbf{1:22} Eph
  5,27} \bibleverse{23} so ihr anders bleibet im Glauben, gegründet und
...
Christo, für seinen Leib, welcher ist die Gemeinde, \footnote{\textbf{1:24}
  Eph 3,13; 2Tim 2,10} \bibleverse{25} deren Diener ich geworden bin
nach dem göttlichen Predigtamt, das mir gegeben ist unter euch, dass ich
das Wort Gottes reichlich predigen soll, \bibleverse{26} nämlich das
Geheimnis, das verborgen gewesen ist von der Welt her und von den Zeiten
her, nun aber ist es offenbart seinen Heiligen, \bibleverse{27} denen
...
unvernünftigen Reden. \footnote{\textbf{2:4} Röm 16,18} \bibleverse{5}
...
das Haupt aller Fürstentümer und Obrigkeiten; \footnote{\textbf{2:10}
  Eph 1,21} \bibleverse{11} in welchem ihr auch beschnitten seid mit der
...
Fleisch, nämlich mit der Beschneidung Christi, \footnote{\textbf{2:11}
  Röm 2,29; Röm 6,5; 1Petr 3,21} \bibleverse{12} indem ihr mit ihm
...
Toten. \footnote{\textbf{2:12} Kol 3,1; Röm 6,4} \bibleverse{13} Und er
...
\footnote{\textbf{2:13} Eph 2,1; Eph 2,5} \bibleverse{14} und ausgetilgt
...
geheftet; \footnote{\textbf{2:14} Eph 2,15} \bibleverse{15} und hat
...
Sabbate; \footnote{\textbf{2:16} Röm 14,1-12} \bibleverse{17} welches
ist der Schatten von dem, das zukünftig war; aber der Körper selbst ist
in Christo. \footnote{\textbf{2:17} Hebr 8,5; Hebr 10,1} \bibleverse{18}
...
\bibleverse{19} und hält sich nicht an dem Haupt, aus welchem der ganze
...
\bibleverse{21} „Du sollst``, sagen sie, „das nicht angreifen, du sollst
das nicht kosten, du sollst das nicht anrühren``, \bibleverse{22} was
sich doch alles unter den Händen verzehrt; es sind der Menschen Gebote
und Lehren, \footnote{\textbf{2:22} Jes 29,13; Mt 15,9} \bibleverse{23}
...
droben ist, da Christus ist, sitzend zu der Rechten Gottes. \footnote{\textbf{3:1}
  Kol 2,12} \bibleverse{2} Trachtet nach dem, was droben ist, nicht nach
dem, was auf Erden ist. \footnote{\textbf{3:2} Mt 6,33} \bibleverse{3}
Denn ihr seid gestorben, und euer Leben ist verborgen mit Christo in
Gott. \footnote{\textbf{3:3} Röm 6,2} \bibleverse{4} Wenn aber Christus,
euer Leben, sich offenbaren wird, dann werdet ihr auch offenbar werden
mit ihm in der Herrlichkeit.

\footnote{\textbf{3:4} 1Kor 15,43}
...
Abgötterei, \footnote{\textbf{3:5} Eph 5,3} \bibleverse{6} um welcher
willen kommt der Zorn Gottes über die Kinder des Unglaubens; \footnote{\textbf{3:6}
  Eph 5,6} \bibleverse{7} in welchem auch ihr vordem gewandelt habt, da
ihr darin lebtet. \bibleverse{8} Nun aber leget alles ab von euch: den
Zorn, Grimm, Bosheit, Lästerung, schandbare Worte aus eurem Munde.
\footnote{\textbf{3:8} Eph 4,29; Eph 4,31} \bibleverse{9} Lüget nicht
untereinander; zieht den alten Menschen mit seinen Werken aus
\footnote{\textbf{3:9} Eph 4,22-25} \bibleverse{10} und ziehet den neuen
...
\bibleverse{15} Und der Friede Gottes regiere in euren Herzen, zu
...
\bibleverse{16} Lasset das Wort Christi unter euch reichlich wohnen in
...
Danksagung; \footnote{\textbf{4:2} Röm 12,12; 1Thes 5,17} \bibleverse{3}
...
\footnote{\textbf{4:3} Kol 1,26-27; Röm 15,30; 1Kor 16,9; Eph 6,19;
  2Thes 3,1} \bibleverse{4} auf dass ich es offenbare, wie ich soll
reden.
...
empfangen habt (wenn er zu euch kommt, nehmt ihn auf!) \footnote{\textbf{4:10}
  Apg 12,12; Apg 12,25; Apg 16,29; Apg 27,2} \bibleverse{11} und Jesus,
...
bestehet vollkommen und erfüllt mit allem Willen Gottes. \footnote{\textbf{4:12}
  Kol 1,7; Phim 1,23} \bibleverse{13} Ich gebe ihm Zeugnis, dass er
großen Fleiß hat um euch und um die zu Laodizea und zu Hierapolis.
\footnote{\textbf{4:13} Offb 1,11; Offb 3,14} \bibleverse{14} Es grüßt
euch Lukas, der Arzt, der Geliebte, und Demas. \footnote{\textbf{4:14}
  2Tim 4,10-11; Phim 1,24} \bibleverse{15} Grüßet die Brüder zu Laodizea
und den Nymphas und die Gemeinde in seinem Hause. \bibleverse{16} Und
...
\bibleverse{17} Und saget Archippus: Siehe auf das Amt, das du empfangen
