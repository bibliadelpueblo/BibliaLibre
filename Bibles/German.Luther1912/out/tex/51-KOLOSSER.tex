...
\textsuperscript{c} \bibleverse{18} Und er ist das Haupt des Leibes,
...
Fülle wohnen sollte \textsuperscript{d} \bibleverse{20} und alles durch
...
\bibleverse{23} so ihr anders bleibet im Glauben, gegründet und fest und
...
die Hoffnung der Herrlichkeit. \footnote{\textbf{2:22} Jes 29,13; Mt
  15,9} \bibleverse{28} Den verkündigen wir und vermahnen alle Menschen
und lehren alle Menschen mit aller Weisheit, auf dass wir darstellen
einen jeglichen Menschen vollkommen in Christo Jesu; \bibleverse{29}
...
\bibleverse{12} indem ihr mit ihm begraben seid durch die Taufe; in
...
\bibleverse{13} Und er hat euch auch mit ihm lebendig gemacht, da ihr
tot waret in den Sünden und in eurem unbeschnittenen Fleisch; und hat
uns geschenkt alle Sünden \textsuperscript{d} \bibleverse{14} und
...
das Kreuz geheftet; \textsuperscript{e} \bibleverse{15} und hat
...
in Christo. \textsuperscript{b} \bibleverse{18} Lasst euch niemand das
...
Ursache aufgeblasen in seinem fleischlichen Sinn \bibleverse{19} und
...
und Lehren, \textsuperscript{b} \bibleverse{23} welche haben einen
...
dem, was auf Erden ist. \textsuperscript{b} \bibleverse{3} Denn ihr seid
gestorben, und euer Leben ist verborgen mit Christo in Gott. \footnote{\textbf{3:3}
  Röm 6,2} \bibleverse{4} Wenn aber Christus, euer Leben, sich
...
\textsuperscript{b} \bibleverse{7} in welchem auch ihr vordem gewandelt
habt, da ihr darin lebtet. \bibleverse{8} Nun aber leget alles ab von
euch: den Zorn, Grimm, Bosheit, Lästerung, schandbare Worte aus eurem
Munde. \footnote{\textbf{3:8} Eph 4,29; Eph 4,31} \bibleverse{9} Lüget
nicht untereinander; zieht den alten Menschen mit seinen Werken aus
\textsuperscript{d} \bibleverse{10} und ziehet den neuen an, der da
erneuert wird zur Erkenntnis nach dem Ebenbilde des, der ihn geschaffen
hat; \textsuperscript{e} \bibleverse{11} da nicht ist Grieche, Jude,
...
\textsuperscript{b} \bibleverse{16} Lasset das Wort Christi unter euch
...
\textsuperscript{b} \bibleverse{4} auf dass ich es offenbare, wie ich
soll reden.
...
\bibleverse{15} Grüßet die Brüder zu Laodizea und den Nymphas und die
Gemeinde in seinem Hause. \bibleverse{16} Und wenn der Brief bei euch
gelesen ist, so schafft, dass er auch in der Gemeinde zu Laodizea
gelesen werde und dass ihr den von Laodizea lest. \bibleverse{17} Und
