...
einzunehmen, \bibleverse{7} diente das Volk dem \textsc{Herrn}, solange
...
hatte. \footnote{\textbf{2:7} Jos 24,31} \bibleverse{8} Da nun Josua,
der Sohn Nuns, gestorben war, der Knecht des \textsc{Herrn}, als er 110
Jahre alt war, \bibleverse{9} begruben sie ihn in den Grenzen seines
Erbteile zu Thimnath-Heres auf dem Gebirge Ephraim, mitternachtwärts vom
Berge Gaas. \bibleverse{10} Da auch alle, die zu der Zeit gelebt hatten,
...
Israel getan hatte. \bibleverse{11} Da taten die Kinder Israel übel vor
dem \textsc{Herrn} und dienten den Baalim \bibleverse{12} und verließen
...
\bibleverse{13} denn sie verließen je und je den \textsc{Herrn} und
dienten Baal und den Astharoth. \bibleverse{14} So ergrimmte der Zorn
...
Und sie konnten nicht mehr ihren Feinden widerstehen; \bibleverse{15}
...
hatte. Und sie wurden hart gedrängt. \footnote{\textbf{2:15} 3Mo 26,17;
  5Mo 28,20} \bibleverse{16} Wenn dann der \textsc{Herr} Richter
auferweckte, die ihnen halfen aus der Räuber Hand, \footnote{\textbf{18:30}
  1Kö 12,29} \bibleverse{17} so gehorchten sie den Richtern auch nicht,
...
Geboten zu gehorchen, und taten nicht wie dieselben. \bibleverse{18}
...
Wehklagen über die, die sie zwangen und drängten. \bibleverse{19} Wenn
...
halsstarrigen Wesen. \bibleverse{20} Darum ergrimmte denn des
...
meiner Stimme nicht, \bibleverse{21} so will ich auch hinfort die Heiden
nicht vertreiben, die Josua hat gelassen, da er starb, \bibleverse{22}
...
sind, oder nicht. \textsuperscript{c} \bibleverse{23} Also ließ der
...
dir von den Kindern Naphthali und Sebulon? \bibleverse{7} Denn ich will
...
\bibleverse{4} \textsc{Herr}, da du von Seir auszogst und einhergingst
...
\bibleverse{5} Die Berge ergossen sich vor dem \textsc{Herrn}, der Sinai
...
die ihr auf dem Wege gehet: singet! \footnote{\textbf{5:10} Ri 10,4; Ri
  12,14} \bibleverse{11} Da die Schützen schreien zwischen den
...
\bibleverse{14} Aus Ephraim die, die ihre Wurzel haben in Amalek, und
nach dir Benjamin in deinem Volk; von Machir zogen Gebieter herab und
von Sebulon, die den Führerstab hielten. \bibleverse{15} Und Fürsten zu
...
\bibleverse{16} Warum bleibst du zwischen den Hürden, zu hören das
Blöken der Herden, und hältst groß von dir und sonderst dich von uns?
\bibleverse{17} Gilead blieb jenseits des Jordans. Und warum wohnt Dan
unter den Schiffen? Asser saß an der Anfurt des Meers und blieb an
seinen zerrissenen Ufern. \bibleverse{18} Sebulons Volk aber wagte seine
...
\bibleverse{9} Und der \textsc{Herr} sprach in derselben Nacht zu ihm:
Stehe auf und gehe hinab zum Lager; denn ich habe es in deine Hände
gegeben. \bibleverse{10} Fürchtest du dich aber hinabzugehen, so lass
deinen Diener Pura mit dir hinabgehen zum Lager, \bibleverse{11} dass du
...
der \textsc{Herr} soll Herr über euch sein. \bibleverse{24} Gideon aber
...
alles Land der Amoriter, die in demselben Lande wohnten. \bibleverse{22}
Und sie nahmen alles Gebiet der Amoriter ein vom Arnon an bis an den
Jabbok und von der Wüste an bis an den Jordan. \bibleverse{23} So hat
nun der \textsc{Herr}, der Gott Israels, die Amoriter vertrieben vor
seinem Volk Israel; und du willst ihr Land einnehmen? \bibleverse{24} Du
...
uns vertrieben hat. \bibleverse{25} Meinst du, dass du besser recht
...
auch je gerechtet oder gestritten wider Israel? \footnote{\textbf{11:25}
  4Mo 22,2} \bibleverse{26} Dieweil Israel nun 300 Jahre gewohnt hat in
...
\bibleverse{27} Ich habe nichts an dir gesündigt, und du tust so übel an
...
\bibleverse{29} Da kam der Geist des \textsc{Herrn} auf Jephthah, und er
...
\bibleverse{25} Und der Geist des \textsc{Herrn} fing an, ihn zu treiben
...
\footnote{\textbf{14:6} Ri 13,25} \bibleverse{7} Da er nun hinabkam,
redete er mit dem Weibe, und sie gefiel Simson in seinen Augen.
\bibleverse{8} Und nach etlichen Tagen kam er wieder, dass er sie nähme;
und trat aus dem Wege, dass er das Aas des Löwen besähe. Siehe, da war
ein Bienenschwarm in dem Leibe des Löwen und Honig. \bibleverse{9} Und
...
hatte. \bibleverse{10} Und da sein Vater hinabkam zu dem Weibe, machte
Simson daselbst eine Hochzeit, wie die Jünglinge zu tun pflegen.
\bibleverse{11} Und da sie ihn sahen, gaben sie ihm 30 Gesellen zu, die
...
dass die Bande an seinen Händen zerschmolzen. \footnote{\textbf{15:14}
  Ri 14,6} \bibleverse{15} Und er fand einen frischen Eselskinnbacken;
...
Esels Kinnbacken habe ich 1000 Mann geschlagen. \bibleverse{17} Und da
