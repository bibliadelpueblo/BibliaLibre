...
\bibleverse{1} Nach dem Tod Josuas fragten die Kinder Israel den HErrn
und sprachen: Wer soll unter uns zuerst hinaufziehen, Krieg zu führen
wider die Kanaaniter? \footnote{\textbf{1:1} Ri 20,18}

\bibleverse{2} Der HErr sprach: Juda soll hinaufziehen. Siehe, ich habe
...
\bibleverse{4} Da nun Juda hinaufzog, gab der HErr die Kanaaniter und
Pheresiter in ihre Hände, und sie schlugen zu Besek 10.000 Mann.
\bibleverse{5} Und fanden den Adoni-Besek zu Besek und stritten wider
ihn und schlugen die Kanaaniter und Pheresiter. \bibleverse{6} Aber
Adoni-Besek floh, und sie jagten ihm nach; und da sie ihn ergriffen,
hieben sie ihm die Daumen ab an seinen Händen und Füßen. \bibleverse{7}
...
er. \bibleverse{8} Aber die Kinder Juda stritten wider Jerusalem und
...
\bibleverse{16} Und die Kinder des Keniters, Moses Schwagers, zogen
...
\bibleverse{17} Und Juda zog hin mit seinem Bruder Simeon, und schlugen
die Kanaaniter zu Zephath und verbannten sie und nannten die Stadt
Horma. \footnote{\textbf{1:17} 4Mo 21,2} \bibleverse{18} Dazu gewann
Juda Gaza mit seinem Zugehör und Askalon mit seinem Zugehör und Ekron
mit seinem Zugehör. \bibleverse{19} Und der HErr war mit Juda, dass er
das Gebirge einnahm; denn er konnte die Einwohner im Grunde nicht
vertreiben, darum dass sie eiserne Wagen hatten. \bibleverse{20} Und sie
gaben dem Kaleb Hebron, wie Mose gesagt hatte; und er vertrieb daraus
die drei Söhne des Enak. \bibleverse{21} Aber die Kinder Benjamin
...
Beth-El, und der HErr war mit ihnen. \bibleverse{23} Und das Haus
...
\bibleverse{1} Es kam aber der Engel des HErrn herauf von Gilgal gen
...
wollte meinen Bund mit euch nicht brechen ewiglich; \bibleverse{2} ihr
...
\bibleverse{3} Da sprach ich auch: Ich will sie nicht vertreiben vor
euch, dass sie euch zum Strick werden und ihre Götter zum Netz.
\footnote{\textbf{2:3} Jos 23,13}

\bibleverse{4} Und da der Engel des HErrn solche Worte geredet hatte zu
...
\bibleverse{6} Als Josua das Volk von sich gelassen hatte und die Kinder
Israel hingezogen waren, ein jeglicher in sein Erbteil, das Land
einzunehmen, \bibleverse{7} diente das Volk dem HErrn, solange Josua
...
\footnote{\textbf{2:7} Jos 24,31} \bibleverse{8} Da nun Josua, der Sohn
Nuns, gestorben war, der Knecht des HErrn, als er 110 Jahre alt war,
\bibleverse{9} begruben sie ihn in den Grenzen seines Erbteile zu
Thimnath-Heres auf dem Gebirge Ephraim, mitternachtwärts vom Berge Gaas.
\bibleverse{10} Da auch alle, die zu der Zeit gelebt hatten, zu ihren
...
\bibleverse{11} Da taten die Kinder Israel übel vor dem HErrn und
dienten den Baalim \bibleverse{12} und verließen den HErrn, ihrer Väter
...
\bibleverse{13} denn sie verließen je und je den HErrn und dienten Baal
und den Astharoth. \bibleverse{14} So ergrimmte der Zorn des HErrn über
...
mehr ihren Feinden widerstehen; \bibleverse{15} sondern wo sie hinaus
...
\footnote{\textbf{2:15} 3Mo 26,17; 5Mo 28,20} \bibleverse{16} Wenn dann
der HErr Richter auferweckte, die ihnen halfen aus der Räuber Hand,
\footnote{\textbf{2:16} Apg 13,20} \bibleverse{17} so gehorchten sie den
...
\bibleverse{18} Wenn aber der HErr ihnen Richter erweckte, so war der
...
sie zwangen und drängten. \bibleverse{19} Wenn aber der Richter starb,
...
\bibleverse{20} Darum ergrimmte denn des HErrn Zorn über Israel, dass er
sprach: Weil dieses Volk meinen Bund übertreten hat, den ich ihren
Vätern geboten habe, und gehorchen meiner Stimme nicht, \bibleverse{21}
so will ich auch hinfort die Heiden nicht vertreiben, die Josua hat
gelassen, da er starb, \bibleverse{22} dass ich Israel durch sie
...
wie ihre Väter geblieben sind, oder nicht. \footnote{\textbf{2:22} Ri
  3,1; Ri 3,4; 5Mo 8,2} \bibleverse{23} Also ließ der HErr diese Heiden,
...
\bibleverse{1} Dies sind die Heiden, die der HErr ließ bleiben, dass er
durch sie Israel versuchte, alle, die nicht wussten um die Kriege
Kanaans, \bibleverse{2} und dass die Geschlechter der Kinder Israel
...
die er ihren Vätern geboten hatte durch Mose. \bibleverse{5} Da nun die
Kinder Israel also wohnten unter den Kanaanitern, Hethitern, Amoritern,
Pheresitern, Hevitern und Jebusitern, \bibleverse{6} nahmen sie jener
...
\bibleverse{7} Und die Kinder Israel taten übel vor dem HErrn und
vergaßen des HErrn, ihres Gottes, und dienten den Baalim und den
Ascheroth. \bibleverse{8} Da ergrimmte der Zorn des HErrn über Israel,
...
acht Jahre. \bibleverse{9} Da schrien die Kinder Israel zu dem HErrn;
...
\bibleverse{10} Und der Geist des HErrn kam auf ihn, und er ward Richter
...
darum dass sie übel taten vor dem HErrn. \bibleverse{13} Und er sammelte
...
\bibleverse{14} Und die Kinder Israel dienten Eglon, dem König der
Moabiter, 18 Jahre. \bibleverse{15} Da schrien sie zu dem HErrn; und der
...
Wort an dich. Da stand er auf vom Stuhl. \bibleverse{21} Ehud aber
reckte seine linke Hand aus und nahm das Schwert von seiner rechten
Hüfte und stieß es ihm in seinen Bauch, \bibleverse{22} dass auch das
Heft der Schneide nach hineinfuhr und das Fett das Heft verschloss; denn
er zog das Schwert nicht aus seinem Bauch. \bibleverse{23} Aber Ehud
...
\bibleverse{28} und sprach zu ihnen: Jaget mir nach; denn der HErr hat
...
ließen niemand hinüber \bibleverse{29} und schlugen die Moabiter zu der
Zeit, bei 10.000 Mann, allzumal die besten und streitbare Männer, dass
nicht einer entrann. \bibleverse{30} Also wurden die Moabiter zu der
...
da Ehud gestorben war. \bibleverse{2} Und der HErr verkaufte sie in die
...
\bibleverse{3} Und die Kinder Israel schrien zum HErrn; denn er hatte
...
\bibleverse{4} Zu der Zeit war Richterin in Israel die Prophetin Debora,
das Weib Lapidoths. \bibleverse{5} Und sie wohnte unter der Palme
Deboras zwischen Rama und Beth-El auf dem Gebirge Ephraim. Und die
Kinder Israel kamen zu ihr hinauf vor Gericht. \bibleverse{6} Diese
...
den Kindern Naphthali und Sebulon? \bibleverse{7} Denn ich will Sisera,
...
\bibleverse{12} Da ward Sisera angesagt, dass Barak, der Sohn Abinoams,
auf den Berg Thabor gezogen wäre. \bibleverse{13} Und er rief alle seine
...
10.000 Mann ihm nach. \bibleverse{15} Aber der HErr erschreckte den
...
\bibleverse{16} Barak aber jagte nach den Wagen und dem Heer bis gen
...
war entschlummert, ward ohnmächtig und starb. \bibleverse{22} Da aber
...
\bibleverse{23} Also dämpfte Gott zu der Zeit Jabin, der Kanaaniter
König, vor den Kindern Israel. \bibleverse{24} Und die Hand der Kinder
...
\bibleverse{1} Da sang Debora und Barak, der Sohn Abinoams, zu der Zeit
und sprachen: \bibleverse{2} Lobet den HErrn, dass Israel wieder frei
...
\bibleverse{4} HErr, da du von Seir auszogst und einhergingst vom Felde
Edoms, da erzitterte die Erde, der Himmel troff, und die Wolken troffen
von Wasser. \footnote{\textbf{5:4} 5Mo 33,2; Hab 3,3-6} \bibleverse{5}
Die Berge ergossen sich vor dem HErrn, der Sinai vor dem HErrn, dem Gott
Israels.

\footnote{\textbf{5:5} Ps 68,9}
...
\bibleverse{6} Zu den Zeiten Samgars, des Sohnes Anaths, zu den Zeiten
...
\bibleverse{7} Es gebrach, an Regiment gebrach's in Israel, bis dass
ich, Debora, aufkam, bis ich aufkam, eine Mutter in Israel.
\bibleverse{8} Ein Neues hat Gott erwählt, er hat die Tore bestritten.
...
\bibleverse{9} Mein Herz ist mit den Gebietern Israels, mit denen, die
willig waren unter dem Volk. Lobet den HErrn! \bibleverse{10} Die ihr
...
\bibleverse{11} Da die Schützen schreien zwischen den Schöpf-Rinnen, da
...
Abinoams! \bibleverse{13} Da zog herab, was übrig war von Herrlichen im
Volk; der HErr zog mit mir herab unter den Helden. \bibleverse{14} Aus
...
Führerstab hielten. \bibleverse{15} Und Fürsten zu Isaschar waren mit
Debora. Und Isaschar war wie Barak, in den Grund gesandt ihm nach. Ruben
hielt hoch von sich und sonderte sich von uns. \bibleverse{16} Warum
bleibst du zwischen den Hürden, zu hören das Blöken der Herden, und
hältst groß von dir und sonderst dich von uns? \bibleverse{17} Gilead
...
\bibleverse{18} Sebulons Volk aber wagte seine Seele in den Tod,
Naphthali auch auf der Höhe des Gefildes.

\hypertarget{la-batalla}{%
\subsection{La batalla}\label{la-batalla}}

\bibleverse{19} Die Könige kamen und stritten; da stritten die Könige
der Kanaaniter zu Thaanach am Wasser Megiddos; aber sie brachten keinen
Gewinn davon. \bibleverse{20} Vom Himmel ward wider sie gestritten; die
Sterne in ihren Bahnen stritten wider Sisera. \footnote{\textbf{5:20} Ri
  4,15; 2Mo 14,25; Jos 10,14; Jos 10,42} \bibleverse{21} Der Bach Kison
wälzte sie, der Bach Kedumim, der Bach Kison. Tritt, meine Seele, auf
die Starken! \bibleverse{22} Da rasselten der Pferde Füße von dem Jagen
ihrer mächtigen Reiter. \bibleverse{23} Fluchet der Stadt Meros, sprach
...
\bibleverse{24} Gesegnet sei unter den Weibern Jael, das Weib Hebers,
des Keniters; gesegnet sei sie in der Hütte unter den Weibern!
\bibleverse{25} Milch gab sie, da er Wasser forderte, und Butter brachte
sie dar in einer herrlichen Schale. \bibleverse{26} Sie griff mit ihrer
...
\bibleverse{27} Zu ihren Füßen krümmte er sich, fiel nieder und legte
...
\bibleverse{28} Die Mutter Siseras sah zum Fenster hinaus und heulte
durchs Gitter: Warum verzieht sein Wagen, dass er nicht kommt? Wie
bleiben die Räder seiner Wagen so dahinten? \bibleverse{29} Die
weisesten unter ihren Frauen antworteten, da sie ihre Klageworte immer
wiederholte: \bibleverse{30} Sollen sie denn nicht finden und austeilen
...
\bibleverse{31} Also müssen umkommen, HErr, alle deine Feinde! Die ihn
...
\bibleverse{1} Und da die Kinder Israel übel taten vor dem HErrn, gab
sie der HErr unter die Hand der Midianiter sieben Jahre. \bibleverse{2}
...
\bibleverse{3} Und wenn Israel etwas säte, so kamen die Midianiter und
Amalekiter und die aus dem Morgenlande herauf über sie \bibleverse{4}
...
Schafe noch Ochsen noch Esel. \bibleverse{5} Denn sie kamen herauf mit
...
verderbten. \bibleverse{6} Also ward Israel sehr gering vor den
...
\bibleverse{7} Als sie aber zu dem HErrn schrien um der Midianiter
willen, \bibleverse{8} sandte der HErr einen Propheten zu ihnen, der
sprach zu ihnen: So spricht der HErr, der Gott Israels: Ich habe euch
aus Ägypten geführt und aus dem Diensthause gebracht \bibleverse{9} und
...
gegeben \bibleverse{10} und sprach zu euch: Ich bin der HErr, euer Gott;
...
\bibleverse{11} Und der Engel des HErrn kam und setzte sich unter eine
...
\bibleverse{12} Da erschien ihm der Engel des HErrn und sprach zu ihm:
Der HErr mit dir, du streitbarer Held!

\bibleverse{13} Gideon aber sprach zu ihm: Mein Herr, ist der HErr mit
...
\bibleverse{14} Der HErr aber wandte sich zu ihm und sprach: Gehe hin in
...
\bibleverse{16} Der HErr aber sprach zu ihm: Ich will mit dir sein, dass
...
\bibleverse{21} Da reckte der Engel des HErrn den Stecken aus, den er in
...
\bibleverse{22} Da nun Gideon sah, dass es der Engel des HErrn war,
sprach er: Ach Herr HErr! habe ich also den Engel des HErrn von
Angesicht gesehen?

\bibleverse{23} Aber der HErr sprach zu ihm: Friede sei mit dir! Fürchte
dich nicht; du wirst nicht sterben. \footnote{\textbf{6:23} Ri 13,22}

\bibleverse{24} Da baute Gideon daselbst dem HErrn einen Altar und hieß
...
\bibleverse{25} Und in derselben Nacht sprach der HErr zu ihm: Nimm
...
Vaters ist, und haue um das Ascherabild, das dabeisteht, \bibleverse{26}
...
Ascherabild dabei abgehauen hat. \bibleverse{31} Joas aber sprach zu
...
so rechte er um sich selbst, dass sein Altar zerbrochen ist. \footnote{\textbf{6:31}
  1Kö 18,21} \bibleverse{32} Von dem Tag an hieß man ihn Jerubbaal und
...
sich im Grunde Jesreel, \bibleverse{34} erfüllte der Geist des HErrn den
Gideon; und er ließ die Posaune blasen und rief die Abiesriter, dass sie
ihm folgten, \bibleverse{35} und sandte Botschaft zu ganz Manasse und
...
\bibleverse{1} Da machte sich Jerubbaal, das ist Gideon, früh auf und
...
\bibleverse{2} Der HErr aber sprach zu Gideon: Des Volks ist zu viel,
...
\bibleverse{3} So lass nun ausrufen vor den Ohren des Volks und sagen:
...
\bibleverse{4} Und der HErr sprach zu Gideon: Des Volks ist noch zu
...
ziehen soll, der soll nicht ziehen. \bibleverse{5} Und er führte das
...
desgleichen, wer auf seine Knie fällt, zu trinken. \bibleverse{6} Da war
die Zahl derer, die geleckt hatten aus der Hand zum Mund, 300 Mann; das
andere Volk alles hatte kniend getrunken. \bibleverse{7} Und der HErr
...
\bibleverse{9} Und der HErr sprach in derselben Nacht zu ihm: Stehe auf
und gehe hinab zum Lager; denn ich habe es in deine Hände gegeben.
\bibleverse{10} Fürchtest du dich aber hinabzugehen, so lass deinen
Diener Pura mit dir hinabgehen zum Lager, \bibleverse{11} dass du
...
Schwert des HErrn und Gideons! \bibleverse{21} Und ein jeglicher stand
auf seinem Ort um das Lager her. Da ward das ganze Heer laufend, und
schrien und flohen. \bibleverse{22} Und indem die 300 Mann bliesen die
...
\bibleverse{7} Gideon sprach: Wohlan, wenn der HErr Sebah und Zalmuna in
...
der HErr soll Herr über euch sein. \bibleverse{24} Gideon aber sprach zu
...
hatte von der Hand aller ihrer Feinde umher, \bibleverse{35} und taten
...
mit Abimelech. \bibleverse{40} Aber Abimelech jagte ihn, dass er floh
vor ihm; und fielen viel Erschlagene bis an die Tür des Tors.
\bibleverse{41} Und Abimelech blieb zu Aruma. Sebul aber verjagte den
...
\bibleverse{42} Am Morgen aber ging das Volk heraus aufs Feld. Da das
Abimelech ward angesagt, \bibleverse{43} nahm er das Kriegsvolk und
...
und schlug sie. \bibleverse{44} Abimelech aber und die Haufen, die bei
...
ihm nicht. \bibleverse{7} Da ergrimmte der Zorn des HErrn über Israel,
und er verkaufte sie unter die Hand der Philister und der Kinder Ammon.
\bibleverse{8} Und sie zertraten und zerschlugen die Kinder Israel von
dem Jahr an wohl 18 Jahre, nämlich alle Kinder Israel jenseits des
Jordans, im Lande der Amoriter, das in Gilead liegt. \bibleverse{9} Dazu
...
\bibleverse{10} Da schrien die Kinder Israel zu dem HErrn und sprachen:
Wir haben an dir gesündigt; denn wir haben unseren Gott verlassen und
den Baalim gedient.

\bibleverse{11} Aber der HErr sprach zu den Kindern Israel: Haben euch
nicht auch gezwungen die Ägypter, die Amoriter, die Kinder Ammon, die
Philister, \bibleverse{12} die Sidonier, die Amalekiter und Maoniter,
...
\bibleverse{15} Aber die Kinder Israel sprachen zu dem HErrn: Wir haben
gesündigt, mache es nur du mit uns, wie dir's gefällt; allein errette
uns zu dieser Zeit. \bibleverse{16} Und sie taten von sich die fremden
...
\bibleverse{10} Die Ältesten von Gilead sprachen zu Jephthah: Der HErr
...
Jahza und stritt mit Israel. \bibleverse{21} Der HErr aber, der Gott
...
demselben Lande wohnten. \bibleverse{22} Und sie nahmen alles Gebiet der
Amoriter ein vom Arnon an bis an den Jabbok und von der Wüste an bis an
den Jordan. \bibleverse{23} So hat nun der HErr, der Gott Israels, die
Amoriter vertrieben vor seinem Volk Israel; und du willst ihr Land
einnehmen? \bibleverse{24} Du solltest deren Land einnehmen, die dein
Gott Kamos vertriebe, und uns lassen einnehmen das Land aller, die der
HErr, unser Gott, vor uns vertrieben hat. \bibleverse{25} Meinst du,
...
\footnote{\textbf{11:25} 4Mo 22,2} \bibleverse{26} Dieweil Israel nun
...
dieser Zeit? \bibleverse{27} Ich habe nichts an dir gesündigt, und du
...
\bibleverse{29} Da kam der Geist des HErrn auf Jephthah, und er zog
durch Gilead und Manasse und durch Mizpe, das in Gilead liegt, und von
Mizpe, das in Gilead liegt, auf die Kinder Ammon.

\bibleverse{30} Und Jephthah gelobte dem HErrn ein Gelübde und sprach:
Gibst du die Kinder Ammon in meine Hand: \bibleverse{31} was zu meiner
...
streiten. Und der HErr gab sie in seine Hände. \bibleverse{33} Und er
...
Ammon. \bibleverse{37} Und sie sprach zu ihrem Vater: Du wollest mir das
...
\bibleverse{1} Und die Kinder Israel taten fürder übel vor dem HErrn;
...
nicht. \bibleverse{3} Und der Engel des HErrn erschien dem Weibe und
sprach zu ihr: Siehe, du bist unfruchtbar und gebierst nicht; aber du
wirst schwanger werden und einen Sohn gebären. \bibleverse{4} So hüte
dich nun, dass du nicht Wein noch starkes Getränk trinkest und nichts
Unreines essest; \bibleverse{5} denn du wirst schwanger werden und einen
...
\bibleverse{8} Da bat Manoah den HErrn und sprach: Ach HErr, lass den
...
\bibleverse{13} Der Engel des HErrn sprach zu Manoah: Vor allem, was ich
dem Weibe gesagt habe, soll sie sich hüten. \bibleverse{14} Sie soll
...
\bibleverse{15} Manoah sprach zu dem Engel des HErrn: Lass dich doch
halten; wir wollen dir ein Ziegenböcklein zurichten. \footnote{\textbf{13:15}
  Ri 6,18}

\bibleverse{16} Aber der Engel des HErrn antwortete Manoah: Wenn du
...
\bibleverse{17} Und Manoah sprach zum Engel des HErrn: Wie heißest du?
dass wir dich preisen, wenn nun kommt, was du geredet hast.

\bibleverse{18} Aber der Engel des HErrn sprach zu ihm: Warum fragst du
...
Weib sahen, fielen sie zur Erde auf ihr Angesicht. \bibleverse{21} Und
der Engel des HErrn erschien nicht mehr Manoah und seinem Weibe. Da
erkannte Manoah, dass es der Engel des HErrn war, \bibleverse{22} und
sprach zu seinem Weibe: Wir müssen des Todes sterben, dass wir Gott
gesehen haben.

\bibleverse{23} Aber sein Weib antwortete ihm: Wenn der HErr Lust hätte,
...
uns solches hören lassen, wie jetzt geschehen ist. \bibleverse{24} Und
...
\bibleverse{25} Und der Geist des HErrn fing an, ihn zu treiben im Lager
...
kam ein junger Löwe brüllend ihm entgegen. \bibleverse{6} Und der Geist
...
an seinem Vater noch seiner Mutter, was er getan hatte. \footnote{\textbf{14:6}
  Ri 13,25} \bibleverse{7} Da er nun hinabkam, redete er mit dem Weibe,
und sie gefiel Simson in seinen Augen. \bibleverse{8} Und nach etlichen
...
des Löwen und Honig. \bibleverse{9} Und er nahm ihn in seine Hand und aß
...
Honig aus des Löwen Leibe genommen hatte. \bibleverse{10} Und da sein
Vater hinabkam zu dem Weibe, machte Simson daselbst eine Hochzeit, wie
die Jünglinge zu tun pflegen. \bibleverse{11} Und da sie ihn sahen,
...
sie sagte das Rätsel ihres Volkes Kindern. \bibleverse{18} Da sprachen
...
\bibleverse{19} Und der Geist des HErrn geriet über ihn, und er ging
...
seinem Zorn und ging herauf in seines Vaters Haus. \bibleverse{20} Aber
...
will ich mich an euch rächen und darnach aufhören, -- \bibleverse{8} und
...
\bibleverse{9} Da zogen die Philister hinauf und lagerten sich in Juda
...
seine Hand aus und nahm ihn und schlug damit 1000 Mann. \bibleverse{16}
Und Simson sprach: Da liegen sie bei Haufen; durch eines Esels
Kinnbacken habe ich 1000 Mann geschlagen. \bibleverse{17} Und da er das
ausgeredet hatte, warf er den Kinnbacken aus seiner Hand und hieß die
Stätte Ramath-Lehi (das ist Kinnbackenhöhe).

\bibleverse{18} Da ihn aber sehr dürstete, rief er den HErrn an und
...
ihn zerplagte, ward seine Seele matt bis an den Tod, \bibleverse{17} und
...
\bibleverse{28} Simson aber rief den HErrn an und sprach: Herr HErr,
gedenke mein und stärke mich doch, Gott, diesmal, dass ich für meine
beiden Augen mich einmal räche an den Philistern! \bibleverse{29} Und er
...
\bibleverse{30} und sprach: Meine Seele sterbe mit den Philistern! und
...
\bibleverse{1} Es war ein Mann auf dem Gebirge Ephraim, mit Namen Micha.
\bibleverse{2} Der sprach zu seiner Mutter: Die 1100 Silberlinge, die
...
\bibleverse{7} Es war aber ein Jüngling von Bethlehem-Juda unter dem
...
\bibleverse{1} Zu der Zeit war kein König in Israel. Und der Stamm der
...
\bibleverse{2} Und die Kinder Dan sandten aus ihren Geschlechtern von
...
\bibleverse{27} Sie aber nahmen, was Micha gemacht hatte, und den
...
Stadt mit Feuer. \bibleverse{28} Und war niemand, der sie errettete;
...
sie die Stadt und wohnten darin \bibleverse{29} und nannten sie Dan nach
dem Namen ihres Vaters Dan, der Israel geboren war. (Und die Stadt hieß
vorzeiten Lais.) \footnote{\textbf{18:29} Jos 19,47} \bibleverse{30} Und
...
wurden. \footnote{\textbf{18:30} 1Kö 12,29} \bibleverse{31} Also setzten
...
niemand will mich beherbergen. \bibleverse{19} Wir haben Stroh und
...
\bibleverse{22} Und da ihr Herz nun guter Dinge war, siehe, da kamen die
...
\bibleverse{1} Da zogen die Kinder Israel aus und versammelten sich
...
\bibleverse{2} und traten zuhauf die Obersten des ganzen Volks aller
Stämme Israels in der Gemeinde Gottes, 400.000 Mann zu Fuß, die das
Schwert auszogen. \bibleverse{3} Aber die Kinder Benjamin hörten, dass
...
lagerten sich vor Gibea. \bibleverse{20} Und ein jeder Mann von Israel
ging heraus, zu streiten mit Benjamin, und schickten sich, zu streiten
wider Gibea. \bibleverse{21} Da fielen die Kinder Benjamin heraus aus
Gibea und schlugen des Tages unter Israel 22.000 zu Boden.
\bibleverse{22} Aber das Volk der Männer von Israel ermannte sich und
stellte sich auf, noch weiter zu streiten am selben Ort, da sie sich des
vorigen Tages gestellt hatten. \bibleverse{23} Und die Kinder Israel
...
Benjamin des anderen Tages, \bibleverse{25} fielen die Benjaminiter
...
dem HErrn. \footnote{\textbf{20:26} Ri 20,18} \bibleverse{27} Und die
Kinder Israel fragten den HErrn (es war aber daselbst die Lade des
Bundes Gottes zu der Zeit, \bibleverse{28} und Pinehas, der Sohn
...
Gibea umher. \bibleverse{30} Und zogen also die Kinder Israel hinauf des
dritten Tages gegen die Kinder Benjamin und stellten sich wider Gibea
wie zuvor zweimal. \bibleverse{31} Da fuhren die Kinder Benjamin heraus,
...
\bibleverse{35} Also schlug der HErr den Benjamin vor den Kindern
Israel, dass die Kinder Israel auf den Tag verderbten 25.100 Mann in
Benjamin, die alle das Schwert führten. \bibleverse{36} Denn da die
...
Gibea aufgestellt hatten. \bibleverse{37} Und der Hinterhalt eilte auch
und brach hervor auf Gibea zu und zog hinan und schlug die ganze Stadt
mit der Schärfe des Schwerts. \bibleverse{38} Sie hatten aber abgeredet
...
vor Gott, und sie hoben auf ihre Stimme und weinten sehr \footnote{\textbf{21:2}
  Ri 20,18} \bibleverse{3} und sprachen: O HErr, Gott von Israel, warum
...
zum HErrn gen Mizpa, der sollte des Todes sterben. \bibleverse{6} Und es
reute die Kinder Israel über Benjamin, ihre Brüder, und sie sprachen:
Heute ist ein Stamm von Israel abgebrochen. \bibleverse{7} Wie wollen
...
Weiber geben. \footnote{\textbf{21:7} Ri 21,1} \bibleverse{8} Und
...
Gemeinde niemand gewesen von Jabes in Gilead. \bibleverse{9} Denn sie
zählten das Volk, und siehe, da war kein Bürger da von Jabes in Gilead.
\bibleverse{10} Da sandte die Gemeinde 12.000 Mann dahin von streitbaren
...
\bibleverse{11} Doch also sollt ihr tun: alles, was männlich ist, und
alle Weiber, die beim Mann gelegen haben, verbannt. \bibleverse{12} Und
...
\bibleverse{15} Da reute es das Volk über Benjamin, dass der HErr einen
Riss gemacht hatte in den Stämmen Israels. \bibleverse{16} Und die
...
vertilgt. \bibleverse{17} Und sie sprachen: Die Übrigen von Benjamin
müssen ja ihr Erbe behalten, dass nicht ein Stamm ausgetilgt werde von
Israel. \bibleverse{18} Und wir können ihnen unsere Töchter nicht zu
Weibern geben; denn die Kinder Israel haben geschworen und gesagt:
Verflucht sei, wer den Benjaminitern ein Weib gibt! \bibleverse{19} Und
...
von Lebona. \bibleverse{20} Und sie geboten den Kindern Benjamin und
sprachen: Gehet hin und lauert in den Weinbergen. \bibleverse{21} Wenn
...
\bibleverse{22} Wenn aber ihre Väter oder Brüder kommen, mit uns zu
