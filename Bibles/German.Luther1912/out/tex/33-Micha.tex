...
Höhen im Lande, \footnote{\textbf{4:9} Jer 8,19} \bibleverse{4} dass die
...
\textsuperscript{b} \bibleverse{3} Er wird unter großen Völkern richten
...
\bibleverse{4} Ein jeglicher wird unter seinem Weinstock und Feigenbaum
wohnen ohne Scheu; denn der Mund des HErrn Zebaoth hat's geredet.
\textsuperscript{c} \bibleverse{5} Denn ein jegliches Volk wandelt im
...
Welt ist. \textsuperscript{b} \bibleverse{4} Und er wird unser Friede
...
\textsuperscript{b} \bibleverse{11} Zu der Zeit werden deine Mauern
gebaut werden, und Gottes Wort wird weit auskommen. \bibleverse{12} Und
