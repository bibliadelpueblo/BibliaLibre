...
\bibleverse{1} Dies ist das Wort des HErrn, welches geschah zu Micha von
...
gesehen hat über Samaria und Jerusalem. \footnote{\textbf{1:1} Jer
  26,18; Jes 1,1} \bibleverse{2} Höret, alle Völker! merke auf, Land,
und alles, was darinnen ist! denn Gott der HErr hat mit euch zu reden,
ja, der Herr aus seinem heiligen Tempel. \bibleverse{3} Denn siehe, der
HErr wird ausgehen aus seinem Ort und herabfahren und treten auf die
Höhen im Lande, \footnote{\textbf{1:3} Am 4,13} \bibleverse{4} dass die
...
\bibleverse{5} Das alles um der Übertretung willen Jakobs und um der
...
kommen auch bis an das Tor Jerusalems. \bibleverse{13} Du Stadt Lachis,
...
\bibleverse{14} Du wirst dich müssen scheiden von Moreseth-Gath. Mit der
Stadt Achsib wird's den Königen Israels fehlgehen. \bibleverse{15} Ich
will dir, Maresa, den rechten Erben bringen und die Herrlichkeit Israels
soll kommen bis gen Adullam. \bibleverse{16} Lass die Haare abscheren
...
jeden Erbe. \bibleverse{3} Darum spricht der HErr also: Siehe, ich
...
wahr, meine Reden sind freundlich den Frommen. \footnote{\textbf{2:7} Am
  6,3} \bibleverse{8} Aber mein Volk hat sich aufgemacht wie ein Feind,
denn sie rauben beides, Rock und Mantel, denen, die sicher dahergehen,
gleich wie die, die aus dem Kriege kommen. \bibleverse{9} Ihr treibt die
...
\bibleverse{4} Darum, wenn ihr nun zum HErrn schreien werdet, wird er
...
\bibleverse{5} So spricht der HErr wider die Propheten, die mein Volk
...
ein Krieg kommen. \bibleverse{6} Darum soll euer Gesicht zur Nacht und
euer Wahrsagen zur Finsternis werden. Die Sonne soll über den Propheten
untergehen und der Tag über ihnen finster werden. \bibleverse{7} Und die
...
\bibleverse{8} Ich aber bin voll Kraft und Geistes des HErrn, voll
...
unter uns? Es kann kein Unglück über uns kommen. \footnote{\textbf{3:11}
  Jer 7,4} \bibleverse{12} Darum wird Zion um euretwillen wie ein Acker
...
\bibleverse{1} In den letzten Tagen aber wird der Berg, darauf des HErrn
...
sein, und die Völker werden dazu laufen, \footnote{\textbf{4:1} Jes
  2,2-4} \bibleverse{2} und viele Heiden werden gehen und sagen: Kommt,
...
\footnote{\textbf{4:2} Lk 24,47} \bibleverse{3} Er wird unter großen
...
mehr kriegen lernen. \bibleverse{4} Ein jeglicher wird unter seinem
...
\bibleverse{6} Zur selben Zeit, spricht der HErr, will ich die Lahmen
versammeln und die Verstoßenen zuhauf bringen und die ich geplagt habe.
\bibleverse{7} Und will die Lahmen machen, dass sie Erben haben sollen,
...
eine in Kindsnöten? \footnote{\textbf{4:9} Jer 8,19} \bibleverse{10}
...
sehen. \bibleverse{12} Aber sie wissen des HErrn Gedanken nicht und
...
verbannen und ihre Habe dem Herrscher der ganzen Welt. \bibleverse{14}
...
Welt ist. \footnote{\textbf{5:3} Hes 34,23} \bibleverse{4} Und er wird
...
\bibleverse{9} Zur selben Zeit, spricht der HErr, will ich deine Rosse
...
\bibleverse{1} Höret doch, was der HErr sagt: Mache dich auf und rechte
vor den Bergen und lass die Hügel deine Stimme hören! \bibleverse{2}
...
strafen. \bibleverse{3} Was habe ich dir getan, mein Volk, und womit
habe ich dich beleidigt? Das sage mir! \footnote{\textbf{6:3} Jer 2,5}
\bibleverse{4} Habe ich dich doch aus Ägyptenland geführt und aus dem
Diensthause erlöst und vor dir her gesandt Mose, Aaron und Mirjam.
\bibleverse{5} Mein Volk, denke doch daran, was Balak, der König in
...
\bibleverse{6} Womit soll ich den HErrn versöhnen, mich bücken vor dem
hohen Gott? Soll ich mit Brandopfern und jährigen Kälbern ihn versöhnen?
\footnote{\textbf{6:6} Jes 1,11; Am 5,21; Am 1,5-22} \bibleverse{7} Wird
...
geben, meines Leibes Frucht für die Sünde meiner Seele? \bibleverse{8}
...
\bibleverse{9} Es wird des HErrn Stimme über die Stadt rufen; aber wer
deinen Namen fürchtet, dem wird's gelingen. Höret, ihr Stämme, was
gepredigt wird! \bibleverse{10} Noch bleibt unrecht Gut in des Gottlosen
Hause und das heillose geringe Maß. \footnote{\textbf{6:10} Am 8,5}
\bibleverse{11} Oder sollte ich die unrechte Waage und falsche Gewichte
im Beutel billigen, \bibleverse{12} durch welche ihre Reichen viel
Unrecht tun? Und ihre Einwohner gehen mit Lügen um und haben falsche
Zungen in ihrem Halse. \bibleverse{13} Darum will ich dich auch übel
plagen und dich um deiner Sünden willen wüst machen. \bibleverse{14} Du
...
ich doch dem Schwert überantworten. \bibleverse{15} Du sollst säen, und
nicht ernten; du sollst Öl keltern, und dich damit nicht salben, und
Most keltern, und nicht Wein trinken. \bibleverse{16} Denn man hält die
...
sind sein eigenes Hausgesinde. \footnote{\textbf{7:6} Jer 9,3-4; Mt
  10,35-36} \bibleverse{7} Ich aber will auf den HErrn schauen und des
...
der HErr mein Licht. \bibleverse{9} Ich will des HErrn Zorn tragen --
...
an seiner Gnade sehe. \footnote{\textbf{7:9} Jer 14,7} \bibleverse{10}
...
sehen, dass sie dann wie Kot auf der Gasse zertreten wird. \footnote{\textbf{7:10}
  Ps 79,10} \bibleverse{11} Zu der Zeit werden deine Mauern gebaut
werden, und Gottes Wort wird weit auskommen. \bibleverse{12} Und zur
...
einem Gebirge zum anderen. \bibleverse{13} Denn das Land wird wüst sein
