...
liebe Brüder, also sein. \textsuperscript{b} \bibleverse{11} Quillt auch
ein Brunnen aus einem Loch süß und bitter? \bibleverse{12} Kann auch,
...
\textsuperscript{b} \bibleverse{6} Er gibt aber desto reichlicher Gnade.
Darum sagt sie: „Gott widerstehet den Hoffärtigen, aber den Demütigen
gibt er Gnade.`` \footnote{\textbf{5:4} 5Mo 24,14-15} \bibleverse{7} So
seid nun Gott untertänig. Widerstehet dem Teufel, so fliehet er von
euch; \footnote{\textbf{5:16} Apg 12,5} \bibleverse{8} nahet euch zu
...
machet eure Herzen keusch, ihr Wankelmütigen. \footnote{\textbf{4:8}
  Sach 1,3; Jes 1,16} \bibleverse{9} Seid elend und traget Leid und
weinet; euer Lachen verkehre sich in Weinen und eure Freude in
Traurigkeit. \bibleverse{10} Demütiget euch vor Gott, so wir er euch
...
\textsuperscript{b} \bibleverse{15} Dafür ihr sagen solltet: So der Herr
...
mottenfräßig geworden. \footnote{\textbf{5:14} Mk 6,13} \bibleverse{3}
...
Zebaoth. \textsuperscript{c} \bibleverse{5} Ihr habt wohlgelebt auf
Erden und eure Wollust gehabt und eure Herzen geweidet am Schlachttag.
\textsuperscript{d} \bibleverse{6} Ihr habt verurteilt den Gerechten und
...
Herrn. \textsuperscript{b} \bibleverse{15} Und das Gebet des Glaubens
...
viel, wenn es ernstlich ist. \textsuperscript{d} \bibleverse{17} Elia
...
Monate. \textsuperscript{e} \bibleverse{18} Und er betete abermals, und
...
Wahrheit, und jemand bekehrte ihn, \textsuperscript{a} \bibleverse{20}
