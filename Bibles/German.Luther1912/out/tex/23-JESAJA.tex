...
von mir abgefallen. \bibleverse{3} Ein Ochse kennt seinen Herrn und ein
...
noch verbunden noch mit Öl gelindert sind. \bibleverse{7} Euer Land ist
...
\bibleverse{8} Was aber noch übrig ist von der Tochter Zion, ist wie ein
Häuslein im Weinberge, wie eine Nachthütte in den Kürbisgärten, wie eine
verheerte Stadt. \bibleverse{9} Wenn uns der \textsc{Herr} Zebaoth nicht
...
wie Wolle werden. \bibleverse{19} Wollt ihr mir gehorchen, so sollt ihr
des Landes Gut genießen. \bibleverse{20} Weigert ihr euch aber und seid
...
erhaben werden, und werden alle Heiden dazu laufen \bibleverse{3} und
...
\bibleverse{11} Denn alle hohen Augen werden erniedrigt werden, und die
...
sich aufmachen wird, zu schrecken die Erde. \bibleverse{20} Zu der Zeit
...
sie werden die Frucht ihrer Werke essen. \bibleverse{11} Weh aber den
Gottlosen! denn sie haben es übel, und es wird ihnen vergolten werden,
wie sie es verdienen. \bibleverse{12} Kinder sind Gebieter meines
...
werden in Israel. \bibleverse{3} Und wer da wird übrig sein zu Zion und
übrigbleiben zu Jerusalem, der wird heilig heißen, ein jeglicher, der
geschrieben ist unter die Lebendigen zu Jerusalem. \bibleverse{4} Dann
...
und ein Feuer anzünden wird. \bibleverse{5} Und der \textsc{Herr} wird
...
\bibleverse{26} Denn er wird ein Panier aufwerfen fern unter den Heiden
und dieselben locken vom Ende der Erde. Und siehe, eilend und schnell
kommen sie daher, \bibleverse{27} und ist keiner unter ihnen müde oder
schwach, keiner schlummert noch schläft; keinem geht der Gürtel auf von
seinen Lenden, und keinem zerreißt ein Schuhriemen. \bibleverse{28} Ihre
...
\bibleverse{29} Ihr Brüllen ist wie das der Löwen, und sie brüllen wie
junge Löwen; sie werden daherbrausen und den Raub erhaschen und
davonbringen, dass niemand retten wird, \bibleverse{30} und werden über
...
Rufens, und das Haus ward voll Rauch. \bibleverse{5} Da sprach ich: Weh
...
\bibleverse{5} dass die Syrer wider dich einen bösen Ratschlag gemacht
haben samt Ephraim und dem Sohn Remaljas und sagen: \bibleverse{6} Wir
wollen hinauf nach Juda und es erschrecken und hineinbrechen und zum
König darin machen den Sohn Tabeels. \bibleverse{7} Denn also spricht
der Herr \textsc{Herr}: Es soll nicht bestehen noch also gehen;
\bibleverse{8} sondern wie Damaskus das Haupt ist in Syrien, so soll
Rezin das Haupt zu Damaskus sein. Und über fünfundsechzig Jahre soll es
mit Ephraim aus sein, dass sie nicht mehr ein Volk seien. \bibleverse{9}
...
Flucht; rüstet euch und gebt doch die Flucht! \bibleverse{10} Beschließt
...
Schrecken sein, \bibleverse{14} so wird er ein Heiligtum sein, aber ein
Stein des Anstoßes und ein Fels des Ärgernisses den beiden Häusern
Israel, zum Strick und Fall den Bürgern zu Jerusalem, \bibleverse{15}
...
Lebendigen fragen? \bibleverse{20} Ja, nach dem Gesetz und Zeugnis!
Werden sie das nicht sagen, so werden sie die Morgenröte nicht haben,
\bibleverse{21} sondern werden im Lande umhergehen, hart geschlagen und
hungrig. Wenn sie aber Hunger leiden, werden sie zürnen und fluchen
ihrem König und ihrem Gott \bibleverse{22} und werden über sich gaffen
...
Finstern. \bibleverse{23} Doch es wird nicht dunkel bleiben über denen,
...
Kopf und Schwanz, beide, Ast und Stumpf, auf einen Tag. \bibleverse{14}
Die alten und vornehmen Leute sind der Kopf; die Propheten aber, so
falsch lehren, sind der Schwanz. \bibleverse{15} Denn die Leiter dieses
Volks sind Verführer; und die sich leiten lassen, sind verloren.
\bibleverse{16} Darum kann sich der Herr über die junge Mannschaft nicht
...
Zorn noch nicht ab; seine Hand ist noch ausgereckt. \bibleverse{17} Denn
...
Stecken ist! \bibleverse{6} Ich will ihn senden wider ein Heuchelvolk
und ihm Befehl tun wider das Volk meines Zorns, dass er's beraube und
austeile und zertrete es wie Kot auf der Gasse, \bibleverse{7} wiewohl
er's nicht so meint und sein Herz nicht so denkt; sondern sein Herz
steht, zu vertilgen und auszurotten nicht wenig Völker. \bibleverse{8}
Denn er spricht: Sind meine Fürsten nicht allzumal Könige?
\bibleverse{9} Ist Kalno nicht wie Karchemis? ist Hamath nicht wie
Arpad? ist nicht Samaria wie Damaskus? \bibleverse{10} Wie meine Hand
gefunden hat die Königreiche der Götzen, so doch ihre Götzen stärker
waren, denn die zu Jerusalem und Samaria sind: \bibleverse{11} sollte
ich nicht Jerusalem tun und ihren Götzen, wie ich Samaria und ihren
Götzen getan habe? \bibleverse{12} Wenn aber der Herr all sein Werk
...
Pracht seiner hoffärtigen Augen, \bibleverse{13} darum dass er spricht:
...
\bibleverse{14} und meine Hand hat gefunden die Völker wie ein
...
Schnabel aufsperrt oder zischt. \bibleverse{15} Mag sich auch eine Axt
...
Stecken höbe den, der kein Holz ist! \bibleverse{16} Darum wird der Herr
...
Feuer. \bibleverse{17} Und das Licht Israels wird ein Feuer sein, und
sein Heiliger wird eine Flamme sein, und sie wird seine Dornen und
Hecken anzünden und verzehren auf einen Tag. \bibleverse{18} Und die
...
\bibleverse{19} dass die übrigen Bäume seines Waldes können gezählt
werden und ein Knabe sie kann aufschreiben. \bibleverse{20} Zu der Zeit
...
der Wahrheit. \bibleverse{21} Die Übriggebliebenen werden sich bekehren,
ja, die Übriggebliebenen in Jakob, zu Gott, dem Starken. \bibleverse{22}
...
Mastvieh miteinander treiben. \bibleverse{7} Kühe und Bären werden auf
der Weide gehen, dass ihre Jungen beieinander liegen; und Löwen werden
Stroh essen wie die Ochsen. \bibleverse{8} Und ein Säugling wird seine
Lust haben am Loch der Otter, und ein Entwöhnter wird seine Hand stecken
in die Höhle des Basilisken. \bibleverse{9} Man wird nirgend Schaden tun
...
\bibleverse{3} Ich habe meinen Geheiligten geboten und meine Starken
gerufen zu meinem Zorn, die da fröhlich sind in meiner Herrlichkeit.
\bibleverse{4} Es ist ein Geschrei einer Menge auf den Bergen wie eines
...
Streit, \bibleverse{5} sie kommen aus fernen Landen vom Ende des
...
wie eine Verwüstung vom Allmächtigen. \bibleverse{7} Darum werden alle
Hände lass und aller Menschen Herz wird feige sein. \bibleverse{8}
...
Mensch werter denn Goldes Stücke aus Ophir. \bibleverse{13} Darum will
...
\bibleverse{14} Und sie sollen sein wie ein verscheuchtes Reh und wie
eine Herde ohne Hirten, dass sich ein jeglicher zu seinem Volk kehren
und ein jeglicher in sein Land fliehen wird, \bibleverse{15} darum dass,
wer sich da finden lässt, erstochen wird, und wer dabei ist, durchs
Schwert fallen wird. \bibleverse{16} Es sollen auch ihre Kinder vor
...
erbarmen noch der Kinder schonen. \bibleverse{19} Also soll Babel, das
schönste unter den Königreichen, die herrliche Pracht der Chaldäer,
umgekehrt werden von Gott wie Sodom und Gomorra, \bibleverse{20} dass
...
sein dem Allerhöchsten.`` \bibleverse{15} Ja, zur Hölle fährst du, zur
tiefsten Grube. \bibleverse{16} Wer dich sieht, wird dich schauen und
betrachten (und sagen): „Ist das der Mann, der die Welt zittern und die
Königreiche beben machte? \bibleverse{17} der den Erdboden zur Wüste
...
alle Nacht. \bibleverse{9} Und siehe, da kommt einer, der fährt auf
...
\bibleverse{22} dass sie versammelt werden als Gefangene in die Grube
und verschlossen werden im Kerker und nach langer Zeit wieder
heimgesucht werden. \bibleverse{23} Und der Mond wird sich schämen, und
...
\textsc{Herr}, vor deinem Angesicht. \bibleverse{18} Da sind wir auch
...
vorübergehe. \bibleverse{21} Denn siehe, der \textsc{Herr} wird ausgehen
...
nicht. \bibleverse{17} Und ich will das Recht zur Richtschnur und die
...
\bibleverse{7} Und wie ein Nachtgesicht im Traum, so soll sein die Menge
aller Heiden, die wider Ariel streiten, samt allem ihrem Heer und
Bollwerk, und die ihn ängsten. \bibleverse{8} Denn gleichwie einem
...
werden. \bibleverse{18} Und zu derselben Zeit werden die Tauben hören
die Worte des Buches, und die Augen der Blinden werden aus Dunkel und
Finsternis sehen, \bibleverse{19} und die Elenden werden wieder Freude
...
noch zur Linken! \bibleverse{22} Und ihr werdet entweihen eure
...
\bibleverse{9} Und sein Fels wird vor Furcht wegziehen, und seine
...
\bibleverse{16} der wird in der Höhe wohnen, und Felsen werden seine
...
für ein Trotz, darauf du dich verlässest? \bibleverse{5} Ich achte, du
...
\bibleverse{6} Verlässest du dich auf den zerbrochenen Rohrstab Ägypten,
...
auf ihn verlassen. \bibleverse{7} Willst du aber mir sagen: Wir
...
Jerusalem gesagt: Vor diesem Altar sollt ihr anbeten? \bibleverse{8}
...
darauf reiten. \bibleverse{9} Wie willst du denn bleiben vor einem
Hauptmann, der geringsten Diener einem meines Herrn? Und du verlässest
dich auf Ägypten um der Wagen und Reiter willen. \bibleverse{10} Dazu,
...
\bibleverse{25} Ich habe gegraben und getrunken die Wasser und werde mit
...
\bibleverse{19} sondern allein, die da leben, loben dich, wie ich jetzt
tue. Der Vater wird den Kindern deine Wahrheit kundtun. \bibleverse{20}
...
unserem Gott! \bibleverse{4} Alle Täler sollen erhöht werden, und alle
Berge und Hügel sollen erniedrigt werden, und was ungleich ist, soll
eben, und was höckericht ist, soll schlicht werden; \bibleverse{5} denn
...
Blume auf dem Felde. \bibleverse{7} Das Gras verdorrt, die Blume
...
Vergeltung ist vor ihm. \bibleverse{11} Er wird seine Herde weiden wie
...
ihn aus wie eine Hütte, darin man wohnt; \bibleverse{23} Der die Fürsten
zunichte macht und die Richter auf Erden eitel macht, \bibleverse{24}
...
sie ein Windwirbel wie Stoppeln wegführt. \bibleverse{25} Wem wollt ihr
...
habe, du Samen Abrahams, meines Geliebten, \bibleverse{9} der ich dich
...
dich, und verwerfe dich nicht, -- \bibleverse{10} fürchte dich nicht,
...
ist der Heilige in Israel. \bibleverse{15} Siehe, ich habe dich zum
...
\bibleverse{16} Du sollst sie zerstreuen, dass sie der Wind wegführe und
...
lasset uns doch hören, was zukünftig ist! \bibleverse{23} Verkündiget
...
miteinander schauen. \bibleverse{24} Siehe, ihr seid aus nichts, und
...
Finsternis, aus dem Kerker. \bibleverse{8} Ich, der \textsc{Herr}, das
ist mein Name; und will meine Ehre keinem anderen geben noch meinen Ruhm
den Götzen. \bibleverse{9} Siehe, was ich zuvor habe verkündigt, ist
...
ihr sehet! \bibleverse{19} Wer ist so blind wie mein Knecht, und wer ist
so taub wie mein Bote, den ich sende? Wer ist so blind wie der
Vollkommene und so blind wie der Knecht des \textsc{Herrn}?
\bibleverse{20} Man predigt wohl viel, aber sie halten's nicht; man sagt
ihnen genug, aber sie wollen's nicht hören. \bibleverse{21} Der
\textsc{Herr} wollte ihnen wohl um seiner Gerechtigkeit willen, dass er
das Gesetz herrlich und groß mache. \bibleverse{22} Aber es ist ein
...
hat, und die Tauben, die doch Ohren haben. \bibleverse{9} Lasst alle
...
man's hören und sagen: Es ist die Wahrheit. \bibleverse{10} Ihr aber
...
Lust an deiner Arbeit im Weihrauch; \bibleverse{24} mir hast du nicht um
...
Mühe gemacht mit deinen Missetaten. \bibleverse{25} Ich, ich tilge deine
Übertretungen um meinetwillen und gedenke deiner Sünden nicht.
\bibleverse{26} Erinnere mich; lass uns miteinander rechten; sage an,
wie du gerecht willst sein. \bibleverse{27} Deine Voreltern haben
...
Wasser, bis er matt wird. \bibleverse{13} Der andere zimmert Holz, und
...
der im Hause wohne. \bibleverse{14} Er geht frisch daran unter den
...
\bibleverse{15} und die den Leuten Brennholz gibt, davon man nimmt, dass
...
kniet davor nieder. \bibleverse{16} Die Hälfte verbrennt er im Feuer,
...
Lust am Feuer. \bibleverse{17} Aber das Übrige macht er zum Gott, dass
es sein Götze sei, davor er kniet und niederfällt und betet und spricht:
Errette mich; denn du bist mein Gott! \bibleverse{18} Sie wissen nichts
und verstehen nichts; denn sie sind verblendet, dass ihre Augen nicht
sehen und ihre Herzen nicht merken können, \bibleverse{19} und gehen
...
zum Gräuel machen und sollte knien vor einem Klotz? \bibleverse{20} Er
...
vergiss mein nicht. \bibleverse{22} Ich vertilge deine Missetaten wie
...
Strömen: Vertrocknet! \bibleverse{28} der ich spreche von Kores: Der ist
...
und zum Weibe: Warum gebierst du? \bibleverse{11} So spricht der
...
und ist sonst kein Gott mehr. \bibleverse{15} Fürwahr, du bist ein
verborgener Gott, du Gott Israels, der Heiland. \bibleverse{16} Aber die
Götzenmacher müssen allesamt mit Schanden und Hohn bestehen und
miteinander schamrot hingehen. \bibleverse{17} Israel aber wird erlöst
...
außer mir. \bibleverse{22} Wendet euch zu mir, so werdet ihr selig,
...
solle? \bibleverse{6} Sie schütten das Gold aus dem Beutel und wägen dar
das Silber mit der Waage und lohnen dem Goldschmied, dass er einen Gott
daraus mache, vor dem sie knien und anbeten. \bibleverse{7} Sie heben
...
ich tue alles, was mir gefällt. \bibleverse{11} Ich rufe einen Adler vom
...
allzu schwer, \bibleverse{7} und dachtest: Ich bin eine Königin
...
\bibleverse{5} Darum habe ich dir's verkündigt zuvor und habe dir es
...
\bibleverse{6} Solches alles hast du gehört und siehst es, und
verkündigst es doch nicht. Ich habe dir von nun an Neues sagen lassen
und Verborgenes, das du nicht wusstest. \bibleverse{7} Nun ist's
...
bin's, ich bin der Erste, dazu auch der Letzte. \bibleverse{13} Meine
Hand hat den Erdboden gegründet, und meine Rechte hat den Himmel
ausgespannt; was ich rufe, das steht alles da. \bibleverse{14} Sammelt
...
seinen Arm an den Chaldäern beweisen. \bibleverse{15} Ich, ja, ich habe
...
Fels, das Wasser herausrann. \bibleverse{22} Aber die Gottlosen, spricht
...
aufrichtest und die verstörten Erbe austeilest; \bibleverse{9} zu sagen
...
\bibleverse{10} Sie werden weder hungern noch dürsten, sie wird keine
Hitze noch Sonne stechen, denn ihr Erbarmer wird sie führen und wird sie
an die Wasserquellen leiten. \bibleverse{11} Ich will alle meine Berge
zum Wege machen, und meine Pfade sollen gebahnt sein. \bibleverse{12}
Siehe, diese werden von ferne kommen, und siehe, jene von Mitternacht
und diese vom Meer und jene vom Lande Sinim. \bibleverse{13} Jauchzet,
...
vergessen. \bibleverse{16} Siehe, in die Hände habe ich dich gezeichnet;
deine Mauern sind immerdar vor mir. \bibleverse{17} Deine Baumeister
werden eilen; aber deine Zerbrecher und Verstörer werden sich
davonmachen. \bibleverse{18} Hebe deine Augen auf umher und siehe: alle
...
werden und wirst sie um dich legen wie eine Braut. \bibleverse{19} Denn
...
\bibleverse{20} dass die Kinder deiner Unfruchtbarkeit werden noch sagen
vor deinen Ohren: Der Raum ist mir zu eng; rücke hin, dass ich bei dir
wohnen möge. \bibleverse{21} Du aber wirst sagen in deinem Herzen: Wer
...
\bibleverse{5} Der Herr \textsc{Herr} hat mir das Ohr geöffnet; und ich
bin nicht ungehorsam und gehe nicht zurück. \bibleverse{6} Ich hielt
...
\bibleverse{7} Aber der Herr \textsc{Herr} hilft mir; darum werde ich
...
\bibleverse{8} Er ist nahe, der mich gerechtspricht; wer will mit mir
hadern? Lasst uns zusammentreten; wer ist, der Recht zu mir hat? Der
komme her zu mir! \bibleverse{9} Siehe, der Herr \textsc{Herr} hilft
...
\bibleverse{10} Bist du es nicht, der das Meer, der großen Tiefe Wasser,
austrocknete, der den Grund des Meeres zum Wege machte, dass die
Erlösten dadurch gingen? \bibleverse{11} Also werden die Erlösten des
...
die wie Gras vergehen, \bibleverse{13} und vergissest des
...
zu Zion: Dein Gott ist König! \bibleverse{8} Deine Wächter rufen laut
mit ihrer Stimme und rühmen miteinander; denn man wird's mit Augen
sehen, wenn der \textsc{Herr} Zion bekehrt. \bibleverse{9} Lasst
...
sehr hoch erhaben sein. \bibleverse{14} Gleichwie sich viele an dir
ärgern werden, weil seine Gestalt hässlicher ist denn anderer Leute und
sein Ansehen denn der Menschenkinder, \bibleverse{15} also wird er viele
...
\bibleverse{12} Darum will ich ihm große Menge zur Beute geben, und er
...
Steinen \bibleverse{13} und alle deine Kinder gelehrt vom \textsc{Herrn}
und großen Frieden deinen Kindern. \bibleverse{14} Du sollst durch
...
bei ihm ist viel Vergebung. \bibleverse{8} Denn meine Gedanken sind
nicht eure Gedanken, und eure Wege sind nicht meine Wege, spricht der
\textsc{Herr}; \bibleverse{9} sondern soviel der Himmel höher ist denn
die Erde, so sind auch meine Wege höher denn eure Wege und meine
Gedanken denn eure Gedanken. \bibleverse{10} Denn gleichwie der Regen
...
Samen, zu säen, und Brot, zu essen: \bibleverse{11} also soll das Wort,
...
sende. \bibleverse{12} Denn ihr sollt in Freuden ausziehen und im
...
seinem Stande. \bibleverse{12} „Kommt her, lasst uns Wein holen und uns
...
Same des Ehebrechers und der Hure! \bibleverse{4} An wem wollt ihr nun
...
falscher Same, \bibleverse{5} die ihr in der Brunst zu den Götzen lauft
unter alle grünen Bäume und schlachtet die Kinder an den Bächen, unter
den Felsklippen? \bibleverse{6} Dein Wesen ist an den glatten
Bachsteinen, die sind dein Teil; ihnen schüttest du dein Trankopfer, da
du Speisopfer opferst. Sollte ich mich darüber trösten? \bibleverse{7}
Du machst dein Lager auf einem hohen, erhabenen Berg und gehst daselbst
auch hinauf, zu opfern. \bibleverse{8} Und hinter die Tür und den
...
liebst ihr Lager, wo du sie ersiehst. \bibleverse{9} Du ziehst mit Öl
zum König und machst viel deiner Würze und sendest deine Botschaft in
die Ferne und bist erniedrigt bis zur Hölle. \bibleverse{10} Du
...
müde. \bibleverse{11} Vor wem bist du so in Sorge und fürchtest dich
...
so gar nicht fürchtest? \bibleverse{12} Ich will aber deine
Gerechtigkeit anzeigen und deine Werke, dass sie dir nichts nütze sein
sollen. \bibleverse{13} Wenn du rufen wirst, so lass dir deine
...
Geist der Gedemütigten und das Herz der Zerschlagenen: \bibleverse{16}
...
spricht der \textsc{Herr}, und ich will sie heilen. \bibleverse{20} Aber
die Gottlosen sind wie ein ungestümes Meer, das nicht still sein kann,
und dessen Wellen Kot und Unflat auswerfen. \bibleverse{21} Die
...
von deinem Fleisch. \bibleverse{8} Alsdann wird dein Licht hervorbrechen
...
werde, was dir gefällt, oder leeres Geschwätz; \bibleverse{14} alsdann
...
Töchter auf dem Arme hergetragen werden. \bibleverse{5} Dann wirst du
...
Heiden zu dir kommt. \bibleverse{6} Denn die Menge der Kamele wird dich
...
verkündigen. \bibleverse{7} Alle Herden in Kedar sollen zu dir
...
\bibleverse{12} Denn welche Heiden oder Königreiche dir nicht dienen
...
der Mächtige in Jakob, bin dein Erlöser. \bibleverse{17} Ich will Gold
...
\bibleverse{18} Man soll keinen Frevel mehr hören in deinem Lande noch
...
Weingärtner sein. \bibleverse{6} Ihr aber sollt Priester des
...
rühmen. \bibleverse{7} Für eure Schmach soll Zwiefältiges kommen, und
...
haben. \bibleverse{8} Denn ich bin der \textsc{Herr}, der das Rechte
...
\bibleverse{9} Und man soll ihren Samen kennen unter den Heiden und ihre
...
sei \bibleverse{7} und ihr von ihm nicht schweiget, bis dass Jerusalem
zugerichtet und gesetzt werde zum Lobe auf Erden. \bibleverse{8} Der
...
vor ihm! \bibleverse{12} Man wird sie nennen das heilige Volk, die
...
Heiland. \bibleverse{9} Wer sie ängstete, der ängstete ihn auch; und der
...
der seinen heiligen Geist unter sie gab? \bibleverse{12} der Mose bei
...
\bibleverse{13} der sie führte durch die Tiefen wie die Rosse in der
Wüste, die nicht straucheln? \bibleverse{14} Wie das Vieh ins Feld
...
Widersacher zertreten dein Heiligtum. \bibleverse{19} Wir sind geworden
...
\bibleverse{8} \textsc{Herr}, zürne nicht zu sehr und denke nicht ewig
der Sünde. Siehe doch das an, dass wir alle dein Volk sind.
\bibleverse{9} Die Städte deines Heiligtums sind zur Wüste geworden;
Zion ist zur Wüste geworden, Jerusalem liegt zerstört. \bibleverse{10}
...
hatten, ist zu Schanden gemacht. \bibleverse{11} \textsc{Herr}, willst
...
Herzen nehmen; \bibleverse{18} sondern sie werden sich ewiglich freuen
und fröhlich sein über dem, was ich schaffe. Denn siehe, ich will
Jerusalem schaffen zur Wonne und ihr Volk zur Freude, \bibleverse{19}
...
noch die Stimme des Klagens. \bibleverse{20} Es sollen nicht mehr dasein
...
Sünder hundert Jahre alt verflucht werden. \bibleverse{21} Sie werden
Häuser bauen und bewohnen; sie werden Weinberge pflanzen und ihre
Früchte essen. \bibleverse{22} Sie sollen nicht bauen, was ein anderer
...
wird alt werden bei meinen Auserwählten. \bibleverse{23} Sie sollen
...
traurig gewesen seid! \bibleverse{11} Denn dafür sollt ihr saugen und
satt werden von den Brüsten ihres Trostes; ihr sollt dafür saugen und
euch ergötzen an der Fülle ihrer Herrlichkeit. \bibleverse{12} Denn also
...
den Knien wird man euch freundlich halten. \bibleverse{13} Ich will euch
...
euer Same und Name stehen. \bibleverse{23} Und alles Fleisch wird einen
Neumond nach dem anderen und einen Sabbat nach dem anderen kommen,
anzubeten vor mir, spricht der \textsc{Herr}. \bibleverse{24} Und sie
