...
\bibleverse{2} Höret, ihr Himmel! und Erde, nimm zu Ohren! denn der HErr
redet: Ich habe Kinder auferzogen und erhöht, und sie sind von mir
abgefallen. \footnote{\textbf{1:2} 5Mo 32,1; 5Mo 32,5-6} \bibleverse{3}
...
den Heiligen in Israel lästern, zurückweichen! \bibleverse{5} Was soll
man weiter euch schlagen, so ihr des Abweichens nur desto mehr macht?
Das ganze Haupt ist krank, das ganze Herz ist matt. \bibleverse{6} Von
...
Öl gelindert sind. \footnote{\textbf{1:6} 5Mo 28,25} \bibleverse{7} Euer
...
verheert ist. \bibleverse{8} Was aber noch übrig ist von der Tochter
Zion, ist wie ein Häuslein im Weinberge, wie eine Nachthütte in den
Kürbisgärten, wie eine verheerte Stadt. \bibleverse{9} Wenn uns der HErr
...
\bibleverse{10} Höret des HErrn Wort, ihr Fürsten von Sodom! Nimm zu
...
Lämmer und Böcke. \footnote{\textbf{1:11} Ps 50,8; Spr 21,27; Jer 6,20;
  Am 5,22} \bibleverse{12} Wenn ihr hereinkommt, zu erscheinen vor mir,
...
\bibleverse{24} Darum spricht der Herr HErr Zebaoth, der Mächtige in
Israel: O weh! Ich werde mich trösten an meinen Feinden und mich rächen
an meinen Widersachern; \bibleverse{25} und muss meine Hand gegen dich
kehren und deinen Schaum aufs lauterste ausfegen und all dein Blei
ausscheiden \footnote{\textbf{1:25} Jes 1,22; Mal 3,2-3} \bibleverse{26}
...
Stadt heißen. \footnote{\textbf{1:26} Sach 8,3} \bibleverse{27} Zion
muss durch Recht erlöst werden und ihre Gefangenen durch Gerechtigkeit,
\footnote{\textbf{1:27} Jes 46,13} \bibleverse{28} dass die Übertreter
und Sünder miteinander zerbrochen werden, und die den HErrn verlassen,
umkommen. \bibleverse{29} Denn sie müssen zu Schanden werden über den
Eichen, daran ihr Lust habt, und schamrot werden über den Gärten, die
ihr erwählt, \bibleverse{30} wenn ihr sein werdet wie eine Eiche mit
dürren Blättern und wie ein Garten ohne Wasser, \bibleverse{31} wenn der
...
\bibleverse{2} Es wird zur letzten Zeit der Berg, da des HErrn Haus ist,
...
und werden alle Heiden dazu laufen \footnote{\textbf{2:2} Jer 3,17; Mi
  4,1-3} \bibleverse{3} und viele Völker hingehen und sagen: Kommt,
...
\footnote{\textbf{2:3} Joh 4,22} \bibleverse{4} Und er wird richten
...
mehr kriegen lernen. \footnote{\textbf{2:4} Jes 9,4} \bibleverse{5}
...
\bibleverse{12} Denn der Tag des HErrn Zebaoth wird gehen über alles
Hoffärtige und Hohe und über alles Erhabene, dass es erniedrigt werde;
\bibleverse{13} auch über alle hohen und erhabenen Zedern auf dem
...
\bibleverse{20} Zu der Zeit wird jedermann wegwerfen seine silbernen und
goldenen Götzen, die er sich hatte machen lassen, anzubeten, in die
Löcher der Maulwürfe und der Fledermäuse, \bibleverse{21} auf dass er
...
schrecken die Erde. \bibleverse{22} So lasset nun ab von dem Menschen,
...
\bibleverse{1} Denn siehe, der Herr HErr Zebaoth wird von Jerusalem und
Juda nehmen allerlei Vorrat, allen Vorrat des Brots und allen Vorrat des
Wassers, \footnote{\textbf{3:1} 3Mo 26,26; Hes 4,16} \bibleverse{2}
Starke und Kriegsleute, Richter, Propheten, Wahrsager und Älteste,
\bibleverse{3} Hauptleute über fünfzig und vornehme Leute, Räte und
weise Werkleute und kluge Redner. \bibleverse{4} Und ich will ihnen
Jünglinge zu Fürsten geben, und Kindische sollen über sie herrschen.
\footnote{\textbf{3:4} Pred 10,16} \bibleverse{5} Und das Volk wird
...
geringe Mann wider den geehrten. \bibleverse{6} Dann wird einer seinen
Bruder aus seines Vaters Hause ergreifen: Du hast Kleider; sei unser
Fürst, hilf du diesem Einsturz! \bibleverse{7} Er aber wird zu der Zeit
...
Majestät widerstreben. \bibleverse{9} Ihres Wesens haben sie kein Hehl
...
\bibleverse{13} Aber der HErr steht da, zu rechten, und ist aufgetreten,
die Völker zu richten. \bibleverse{14} Und der HErr geht ins Gericht mit
...
\bibleverse{15} Warum zertretet ihr mein Volk und zerschlaget die Person
...
\bibleverse{16} Und der HErr spricht: Darum, dass die Töchter Zions
...
ihren Füßen, \bibleverse{17} so wird der HErr den Scheitel der Töchter
Zions kahl machen, und der HErr wird ihr Geschmeide wegnehmen.

\bibleverse{18} Zu der Zeit wird der HErr den Schmuck an den köstlichen
Schuhen wegnehmen und die Heftel, die Spangen, \bibleverse{19} die
Kettlein, die Armspangen, die Hauben, \bibleverse{20} die Flitter, die
Gebräme, die Schnürlein, die Bisamäpfel, die Ohrenspangen,
\bibleverse{21} die Ringe, die Haarbänder, \bibleverse{22} die
Feierkleider, die Mäntel, die Schleier, die Beutel, \bibleverse{23} die
Spiegel, die Koller, die Borten, die Überwürfe; \bibleverse{24} und es
...
\footnote{\textbf{4:1} 1Mo 30,23; 1Sam 1,5-6}
...
\bibleverse{2} In der Zeit wird des HErrn Zweig lieb und wert sein und
die Frucht der Erde herrlich und schön bei denen, die erhalten werden in
Israel. \footnote{\textbf{4:2} Jes 11,1} \bibleverse{3} Und wer da wird
...
Jerusalem. \footnote{\textbf{4:3} Lk 10,20} \bibleverse{4} Dann wird der
...
\bibleverse{6} und wird eine Hütte sein zum Schatten des Tages vor der
...
\bibleverse{7} Des HErrn Zebaoth Weinberg aber ist das Haus Israel, und
...
werden und die großen und feinen öde stehen? \bibleverse{10} Denn zehn
...
schauen nicht auf das Geschäft seiner Hände! \footnote{\textbf{5:12} Am
  6,5; Am 1,6; Ps 28,5} \bibleverse{13} Darum wird mein Volk müssen
...
werden, \bibleverse{16} aber der HErr Zebaoth erhöht werde im Recht und
Gott, der Heilige, geheiligt werde in Gerechtigkeit. \bibleverse{17} Da
...
\bibleverse{25} Darum ist der Zorn des HErrn ergrimmt über sein Volk,
...
sein Zorn nicht ab, sondern seine Hand ist noch ausgereckt. \footnote{\textbf{5:25}
  Jes 9,11} \bibleverse{26} Denn er wird ein Panier aufwerfen fern unter
den Heiden und dieselben locken vom Ende der Erde. Und siehe, eilend und
schnell kommen sie daher, \bibleverse{27} und ist keiner unter ihnen
...
\bibleverse{28} Ihre Pfeile sind scharf und alle ihre Bogen gespannt.
Ihrer Rosse Hufe sind wie Felsen geachtet und ihre Wagenräder wie ein
Sturmwind. \bibleverse{29} Ihr Brüllen ist wie das der Löwen, und sie
brüllen wie junge Löwen; sie werden daherbrausen und den Raub erhaschen
und davonbringen, dass niemand retten wird, \bibleverse{30} und werden
...
\bibleverse{1} Des Jahres, da der König Usia starb, sah ich den HErrn
sitzen auf einem hohen und erhabenen Stuhl, und sein Saum füllte den
Tempel. \bibleverse{2} Seraphim standen über ihm; ein jeglicher hatte
sechs Flügel: mit zweien deckten sie ihr Antlitz, mit zweien deckten sie
ihre Füße, und mit zweien flogen sie. \bibleverse{3} Und einer rief zum
...
\bibleverse{12} Denn der HErr wird die Leute fern wegtun, dass das Land
sehr verlassen wird. \bibleverse{13} Und ob noch der zehnte Teil darin
...
\bibleverse{3} Aber der HErr sprach zu Jesaja: Gehe hinaus, Ahas
entgegen, du und dein Sohn Sear-Jasub, an das Ende der Wasserleitung des
oberen Teiches, am Wege beim Acker des Walkmüllers, \bibleverse{4} und
...
Rezins und der Syrer und des Sohnes Remaljas, \footnote{\textbf{7:4} Jes
  30,15} \bibleverse{5} dass die Syrer wider dich einen bösen Ratschlag
gemacht haben samt Ephraim und dem Sohn Remaljas und sagen:
\bibleverse{6} Wir wollen hinauf nach Juda und es erschrecken und
hineinbrechen und zum König darin machen den Sohn Tabeels.
\bibleverse{7} Denn also spricht der Herr HErr: Es soll nicht bestehen
noch also gehen; \bibleverse{8} sondern wie Damaskus das Haupt ist in
...
ein Volk seien. \bibleverse{9} Und wie Samaria das Haupt ist in Ephraim,
...
\bibleverse{10} Und der HErr redete abermals zu Ahas und sprach:
\bibleverse{11} Fordere dir ein Zeichen vom HErrn, deinem Gott, es sei
...
\footnote{\textbf{7:15} Jes 7,21-22} \bibleverse{16} Denn ehe der Knabe
...
\bibleverse{17} Aber der HErr wird über dich, über dein Volk und über
...
\bibleverse{18} Denn zu der Zeit wird der HErr zischen der Fliege am
Ende der Wasser in Ägypten und der Biene im Lande Assur, \bibleverse{19}
dass sie kommen und alle sich legen an die trockenen Bäche und in die
Steinklüfte und in alle Hecken und in alle Büsche.

\bibleverse{20} Zu derselben Zeit wird der HErr das Haupt und die Haare
...
\bibleverse{1} Und der HErr sprach zu mir: Nimm vor dich eine große
Tafel und schreib darauf mit Menschengriffel: Raubebald, Eilebeute!
\bibleverse{2} Und ich nahm mir zwei treue Zeugen, den Priester Uria und
...
Eilebeute! \bibleverse{4} Denn ehe der Knabe rufen kann: „Lieber Vater!
...
\bibleverse{5} Und der HErr redete weiter mit mir und sprach:
...
\bibleverse{11} Denn so sprach der HErr zu mir, da seine Hand über mich
kam und unterwies mich, dass ich nicht sollte wandeln auf dem Wege
dieses Volks, und sprach: \bibleverse{12} Ihr sollt nicht sagen: Bund.
dieses Volk redet von nichts denn von Bund. Fürchtet ihr euch nicht
also, wie sie tun, und lasset euch nicht grauen; \bibleverse{13} sondern
heiliget den HErrn Zebaoth. Den lasset eure Furcht und Schrecken sein,
\footnote{\textbf{8:13} Jes 29,23; Mt 10,28; 1Petr 3,15} \bibleverse{14}
...
Bürgern zu Jerusalem, \footnote{\textbf{8:14} Jes 28,16; Röm 9,33; 1Petr
  2,7-8} \bibleverse{15} dass ihrer viele sich daran stoßen, fallen,
...
Jüngern. \bibleverse{17} Denn ich hoffe auf den HErrn, der sein Antlitz
verborgen hat vor dem Hause Jakob; ich aber harre sein. \bibleverse{18}
...
werden sie zürnen und fluchen ihrem König und ihrem Gott \footnote{\textbf{8:21}
  Offb 16,9; Offb 16,11} \bibleverse{22} und werden über sich gaffen und
...
Finstern. \footnote{\textbf{8:22} Jes 5,30} \bibleverse{23} Doch es wird
...
Stelle setzen. \bibleverse{10} Denn der HErr wird Rezins Kriegsvolk
wider sie erhöhen und ihre Feinde zuhauf rotten: \bibleverse{11} die
...
ist noch ausgereckt. \bibleverse{12} So kehrt sich das Volk auch nicht
...
\bibleverse{13} Darum wird der HErr abhauen von Israel beide, Kopf und
...
\bibleverse{18} Im Zorn des HErrn Zebaoth ist das Land verfinstert, dass
das Volk ist wie Speise des Feuers; keiner schont des anderen.
\bibleverse{19} Rauben sie zur Rechten, so leiden sie Hunger; essen sie
zur Linken, so werden sie nicht satt. Ein jeglicher frisst das Fleisch
seines Arms: \bibleverse{20} Manasse den Ephraim, Ephraim den Manasse,
...
\footnote{\textbf{10:10} Jes 36,18-20} \bibleverse{11} sollte ich nicht
Jerusalem tun und ihren Götzen, wie ich Samaria und ihren Götzen getan
habe? \bibleverse{12} Wenn aber der Herr all sein Werk ausgerichtet hat
...
hebt; als ob der Stecken höbe den, der kein Holz ist! \footnote{\textbf{10:15}
  Jes 10,5} \bibleverse{16} Darum wird der Herr HErr Zebaoth unter die
Fetten Assurs die Darre senden, und seine Herrlichkeit wird er anzünden,
dass sie brennen wird wie ein Feuer. \bibleverse{17} Und das Licht
...
Tag. \bibleverse{18} Und die Herrlichkeit seines Waldes und seines
Baumgartens soll zunichte werden, von den Seelen bis aufs Fleisch, und
wird zergehen und verschwinden, \bibleverse{19} dass die übrigen Bäume
seines Waldes können gezählt werden und ein Knabe sie kann aufschreiben.
\bibleverse{20} Zu der Zeit werden die Übriggebliebenen in Israel und
...
Heiligen in Israel, in der Wahrheit. \bibleverse{21} Die
...
\bibleverse{23} Denn der Herr HErr Zebaoth wird ein Verderben gehen
lassen, wie beschlossen ist, im ganzen Lande. \footnote{\textbf{10:23}
  Jes 28,22}

\bibleverse{24} Darum spricht der Herr HErr Zebaoth: Fürchte dich nicht,
...
\bibleverse{26} Alsdann wird der HErr Zebaoth eine Geißel über ihn
...
\bibleverse{33} Aber siehe, der Herr HErr Zebaoth wird die Äste mit
...
\bibleverse{3} Und Wohlgeruch wird ihm sein die Furcht des HErrn. Er
wird nicht richten, nach dem seine Augen sehen, noch Urteil sprechen,
nach dem seine Ohren hören, \bibleverse{4} sondern wird mit
...
dem Odem seiner Lippen den Gottlosen töten. \bibleverse{5} Gerechtigkeit
...
die Kinder Ammon werden gehorsam sein. \bibleverse{15} Und der HErr wird
...
zerschlagen, dass man mit Schuhen dadurchgehen kann. \bibleverse{16} Und
...
\bibleverse{1} Zu derselben Zeit wirst du sagen: Ich danke dir, HErr,
dass du zornig bist gewesen über mich und dein Zorn sich gewendet hat
und tröstest mich. \bibleverse{2} Siehe, Gott ist mein Heil, ich bin
sicher und fürchte mich nicht; denn Gott der HErr ist meine Stärke und
mein Psalm und ist mein Heil. \bibleverse{3} Ihr werdet mit Freuden
Wasser schöpfen aus den Heilsbrunnen \footnote{\textbf{12:3} Sach 13,1;
  Ps 46,5} \bibleverse{4} und werdet sagen zu derselben Zeit: Danket dem
...
verkündiget, wie sein Name so hoch ist. \footnote{\textbf{12:4} 1Chr
  16,8; Ps 105,1} \bibleverse{5} Lobsinget dem HErrn, denn er hat sich
herrlich bewiesen; solches sei kund in allen Landen. \bibleverse{6}
...
Zebaoth rüstet ein Heer zum Streit, \bibleverse{5} sie kommen aus fernen
Landen vom Ende des Himmels, -- ja, der HErr selbst, samt den Werkzeugen
seines Zorns, zu verderben das ganze Land.

\bibleverse{6} Heulet, denn des HErrn Tag ist nahe; er kommt wie eine
...
\bibleverse{9} Denn siehe, des HErrn Tag kommt grausam, zornig, grimmig,
...
den Tag seines Zorns. \bibleverse{14} Und sie sollen sein wie ein
...
und Gomorra, \footnote{\textbf{13:19} 1Mo 19,24-25} \bibleverse{20} dass
...
da aufschlagen; \bibleverse{21} sondern Wüstentiere werden sich da
lagern, und ihre Häuser voll Eulen sein, und Strauße werden da wohnen,
und Feldgeister werden da hüpfen \bibleverse{22} und wilde Hunde in
...
\bibleverse{1} Denn der HErr wird sich über Jakob erbarmen und Israel
...
\bibleverse{3} Und zu der Zeit, wenn dir der HErr Ruhe geben wird von
...
ein Ende! \bibleverse{5} Der HErr hat die Rute der Gottlosen zerbrochen,
die Rute der Herrscher, \bibleverse{6} welche die Völker schlug im Grimm
ohne Aufhören und mit Wüten herrschte über die Heiden und verfolgte ohne
Barmherzigkeit. \bibleverse{7} Nun ruht doch alle Welt und ist still und
jauchzt fröhlich. \bibleverse{8} Auch freuen sich die Tannen über dich
...
\bibleverse{22} Und ich will über sie kommen, spricht der HErr Zebaoth,
und zu Babel ausrotten ihr Gedächtnis, ihre Übriggebliebenen, Kind und
Kindeskind, spricht der HErr, \bibleverse{23} und will Babel machen zum
...
\bibleverse{24} Der HErr Zebaoth hat geschworen und gesagt: Was gilt's?
es soll gehen, wie ich denke, und soll bleiben, wie ich es im Sinn habe:
\bibleverse{25} dass Assur zerschlagen werde in meinem Lande und ich ihn
zertrete auf meinen Bergen, auf dass sein Joch von ihnen genommen werde
und seine Bürde von ihrem Halse komme. \bibleverse{26} Das ist der
Anschlag, den er hat über alle Lande, und das ist die ausgereckte Hand
über alle Heiden. \bibleverse{27} Denn der HErr Zebaoth hat's
...
weinend herab. \footnote{\textbf{15:3} Jes 22,1} \bibleverse{4} Hesbon
und Eleale schreien, dass man's zu Jahza hört. Darum wehklagen die
Gerüsteten in Moab; denn es geht ihrer Seele übel. \bibleverse{5} Mein
...
\bibleverse{13} Das ist's, was der HErr dazumal wider Moab geredet hat.
\bibleverse{14} Nun aber redet der HErr und spricht: In drei Jahren, wie
...
spricht der HErr, der Gott Israels. \bibleverse{7} Zu der Zeit wird sich
der Mensch halten zu dem, der ihn gemacht hat, und seine Augen werden
auf den Heiligen in Israel schauen, \bibleverse{8} und wird sich nicht
...
Sonnensäulen. \bibleverse{9} Zu der Zeit werden die Städte ihrer Stärke
sein wie verlassene Burgen im Wald und auf der Höhe, so verlassen wurden
vor den Kindern Israel, und werden wüst sein. \bibleverse{10} Denn du
...
Reben. \bibleverse{11} Zur Zeit des Pflanzens wirst du sein wohl warten,
...
\bibleverse{4} Denn so spricht der HErr zu mir: Ich will stillhalten und
schauen in meinem Sitz wie bei heller Hitze im Sonnenschein, wie bei
Taugewölk in der Hitze der Ernte. \bibleverse{5} Denn vor der Ernte,
wenn die Blüte vorüber ist und die Traube reift, wird man die Ranken mit
Hippen abschneiden und die Reben wegnehmen und abhauen, \bibleverse{6}
...
allerlei Tiere im Lande darin liegen. \bibleverse{7} Zu der Zeit wird
...
\bibleverse{1} Dies ist die Last über Ägypten: Siehe, der HErr wird auf
...
HErr Zebaoth über Ägypten beschlossen hat. \bibleverse{13} Aber die
...
\bibleverse{14} Denn der HErr hat einen Schwindelgeist unter sie
...
schwingen wird. \bibleverse{17} Und Ägypten wird sich fürchten vor dem
...
\bibleverse{19} Zu derselben Zeit wird des HErrn Altar mitten in
Ägyptenland sein und ein Malstein des HErrn an den Grenzen,
\bibleverse{20} welcher wird ein Zeichen und Zeugnis sein dem HErrn
...
errette. \bibleverse{21} Denn der HErr wird den Ägyptern bekannt werden,
...
\bibleverse{22} Und der HErr wird die Ägypter plagen und heilen; denn
...
deinen Füßen. Und er tat also, ging nackt und barfuß. \footnote{\textbf{20:2}
  Hes 24,24} \bibleverse{3} Da sprach der HErr: Gleichwie mein Knecht
Jesaja nackt und barfuß geht, zum Zeichen und Wunder dreier Jahre über
Ägypten und Mohrenland, \bibleverse{4} also wird der König von Assyrien
...
\bibleverse{5} Und sie werden erschrecken und mit Schanden bestehen über
dem Mohrenland, darauf sie sich verließen, und über den Ägyptern,
welcher sie sich rühmten. \bibleverse{6} Und die Einwohner dieser Küste
...
\bibleverse{6} Denn der HErr sagte zu mir also: Gehe hin, stelle einen
Wächter, der da schaue und ansage. \bibleverse{7} Er sieht aber Reiter
reiten auf Rossen, Eseln und Kamelen und hat mit großem Fleiß Achtung
darauf. \bibleverse{8} Und wie ein Löwe ruft er: Herr, ich stehe auf der
Warte immerdar des Tages und stelle mich auf meine Hut alle Nacht.
\footnote{\textbf{21:8} Hab 2,1} \bibleverse{9} Und siehe, da kommt
...
Bogen, vor dem großen Streit. \bibleverse{16} Denn also spricht der HErr
zu mir: Noch in einem Jahr, wie des Tagelöhners Jahre sind, soll alle
Herrlichkeit Kedars untergehen, \bibleverse{17} und der übrigen Schützen
...
willen der Mauer und des Geschreies am Berge. \bibleverse{6} Denn Elam
fährt daher mit Köcher, Wagen, Leuten und Reitern, und Kir glänzt daher
mit Schilden. \bibleverse{7} Und es wird geschehen, dass deine
auserwählten Täler werden voll Wagen sein, und Reiter werden sich lagern
vor die Tore. \bibleverse{8} Da wird der Vorhang Judas aufgedeckt
werden, dass man schauen wird zu der Zeit nach den Rüstungen im Hause
des Waldes. \bibleverse{9} Und ihr werdet der Risse an der Stadt Davids
viel sehen und werdet das Wasser des unteren Teiches sammeln;
\footnote{\textbf{22:9} Jes 7,3} \bibleverse{10} ihr werdet auch die
Häuser zu Jerusalem zählen; ja, ihr werdet die Häuser abbrechen, die
Mauer zu befestigen, \footnote{\textbf{22:10} Jer 33,4} \bibleverse{11}
...
\bibleverse{12} Darum wird der Herr HErr Zebaoth zu der Zeit rufen
lassen, dass man weine und klage und sich das Haar abschere und Säcke
anziehe. \bibleverse{13} Wiewohl jetzt, siehe, ist's eitel Freude und
...
\bibleverse{15} So spricht der Herr HErr Zebaoth: Gehe hinein zum
Schatzmeister Sebna, dem Hofmeister, und sprich zu ihm: \bibleverse{16}
...
Wohnung in den Felsen machen lässt? \bibleverse{17} Siehe, der HErr wird
dich wegwerfen, wie ein Starker einen wegwirft, und wird dich greifen
\bibleverse{18} und dich umtreiben wie eine Kugel auf weitem Lande.
Daselbst wirst du sterben; daselbst werden deine köstlichen Wagen
bleiben, du Schmach des Hauses deines Herrn! \bibleverse{19} Und ich
...
Herrlichsten im Lande? \bibleverse{9} Der HErr Zebaoth hat's also
...
gebeut über Kanaan, zu vertilgen ihre Mächtigen, \bibleverse{12} und
...
auf Erden. \bibleverse{18} Aber ihr Kaufhandel und Hurenlohn werden dem
...
\bibleverse{1} Siehe, der HErr macht das Land leer und wüst und wirft
um, was darin ist, und zerstreut seine Einwohner. \bibleverse{2} Und es
...
Mahnenden wie dem Schuldner. \bibleverse{3} Denn das Land wird leer und
...
ist aus, und die Freude der Harfe hat ein Ende. \footnote{\textbf{24:8}
  Jer 7,34; Jer 16,9} \bibleverse{9} Man singt nicht beim Weintrinken,
und gutes Getränk ist bitter denen, die es trinken. \bibleverse{10} Die
leere Stadt ist zerbrochen; alle Häuser sind zugeschlossen, dass niemand
hineingeht. \bibleverse{11} Man klagt um den Wein auf den Gassen, dass
alle Freude weg ist, alle Wonne des Landes dahin ist. \bibleverse{12}
...
vom Meer her über der Herrlichkeit des HErrn. \bibleverse{15} So preiset
nun den HErrn in den Gründen, in den Inseln des Meeres den Namen des
HErrn, des Gottes Israels. \bibleverse{16} Wir hören Lobgesänge vom Ende
...
\footnote{\textbf{24:20} Jes 19,14}
...
\bibleverse{21} Zu der Zeit wird der HErr heimsuchen das hohe Heer, das
...
\bibleverse{1} HErr, du bist mein Gott! dich preise ich; ich lobe deinen
Namen, denn du tust Wunder; dein Ratschlüsse von alters her sind treu
und wahrhaftig. \bibleverse{2} Denn du machst die Stadt zum Steinhaufen,
...
\bibleverse{3} Darum ehrt dich ein mächtiges Volk: die Städte gewaltiger
Heiden fürchten dich. \bibleverse{4} Denn du bist der Geringen Stärke,
...
eine Wand. \footnote{\textbf{25:4} Jes 4,6} \bibleverse{5} Du demütigst
...
\bibleverse{6} Und der HErr Zebaoth wird allen Völkern machen auf diesem
Berge ein fettes Mahl, ein Mahl von reinem Wein, von Fett, von Mark, von
Wein, darin keine Hefe ist. \bibleverse{7} Und er wird auf diesem Berge
die Hülle wegtun, damit alle Völker verhüllt sind, und die Decke, mit
der alle Heiden zugedeckt sind. \bibleverse{8} Er wird den Tod
...
\footnote{\textbf{25:9} Ps 48,15} \bibleverse{10} Denn die Hand des
...
gerechte Volk, das den Glauben bewahrt! \footnote{\textbf{26:2} Ps
  118,19} \bibleverse{3} Du erhältst stets Frieden nach gewisser Zusage;
denn man verlässt sich auf dich. \bibleverse{4} Verlasset euch auf den
HErrn ewiglich; denn Gott der HErr ist ein Fels ewiglich. \footnote{\textbf{26:4}
  5Mo 32,4} \bibleverse{5} Und er beugt die, die in der Höhe wohnen; die
hohe Stadt erniedrigt er, ja er stößt sie zur Erde, dass sie im Staube
liegt, \bibleverse{6} dass sie mit Füßen zertreten wird, ja mit Füßen
...
deinem Gedächtnis. \bibleverse{9} Von Herzen begehre ich dein des
...
\bibleverse{10} Aber wenn den Gottlosen Gnade widerfährt, so lernen sie
nicht Gerechtigkeit, sondern tun nur übel im richtigen Lande; denn sie
sehen des HErrn Herrlichkeit nicht. \bibleverse{11} HErr, deine Hand ist
...
Feuer, mit dem du deine Feinde verzehrst, verzehren. \bibleverse{12}
...
\bibleverse{13} HErr, unser Gott, es herrschen wohl andere Herren über
uns denn du; aber wir gedenken doch allein dein und deines Namens.
\bibleverse{14} Die Toten werden nicht lebendig, die Verstorbenen stehen
nicht auf; denn du hast sie heimgesucht und vertilgt, und zunichte
gemacht all ihr Gedächtnis. \bibleverse{15} Aber du, HErr, fährst fort
unter den Heiden, du fährst immer fort unter den Heiden, beweisest deine
Herrlichkeit und kommst ferne bis an der Welt Enden. \bibleverse{16}
...
\bibleverse{17} Gleichwie eine Schwangere, wenn sie bald gebären soll,
...
\bibleverse{18} Da sind wir auch schwanger und ist uns bange, dass wir
...
auf dem Erdboden wollen nicht geboren werden. \footnote{\textbf{26:18}
  Mi 4,10} \bibleverse{19} Aber deine Toten werden leben, meine
...
\bibleverse{1} Zu der Zeit wird der HErr heimsuchen mit seinem harten,
...
Weins: \footnote{\textbf{27:2} Jes 5,1} \bibleverse{3} Ich, der HErr,
behüte ihn und feuchte ihn bald, dass man seine Blätter nicht vermisse;
ich will ihn Tag und Nacht behüten. \bibleverse{4} Gott zürnt nicht mit
mir. Ach, dass ich möchte mit den Hecken und Dornen kriegen! so wollte
ich unter sie fallen und sie auf einen Haufen anstecken. \bibleverse{5}
...
noch Sonnensäulen mehr bleiben. \footnote{\textbf{27:9} Jes 31,7; 3Mo
  26,30} \bibleverse{10} Denn die feste Stadt muss einsam werden, die
schönen Häuser verödet und verlassen werden wie eine Wüste, dass Kälber
daselbst weiden und ruhen und daselbst Reiser abfressen. \bibleverse{11}
...
\bibleverse{12} Zu der Zeit wird der HErr worfeln von dem Ufer des
...
\bibleverse{5} Zu der Zeit wird der HErr Zebaoth sein eine liebliche
Krone und ein herrlicher Kranz den Übriggebliebenen seines Volks
\bibleverse{6} und ein Geist des Rechts dem, der zu Gericht sitzt, und
...
\bibleverse{14} So höret nun des HErrn Wort, ihr Spötter, die ihr
herrschet über dies Volk, das zu Jerusalem ist. \bibleverse{15} Denn ihr
...
gemacht. \bibleverse{16} Darum spricht der Herr HErr: Siehe, ich lege in
...
der wohl gegründet ist. Wer glaubt, der flieht nicht. \footnote{\textbf{28:16}
  Ps 118,22; Röm 9,33; Röm 10,11; 1Petr 2,6} \bibleverse{17} Und ich
...
Schirm wegschwemmen, \bibleverse{18} dass euer Bund mit dem Tode los
...
wegnehmen. \bibleverse{19} Kommt sie des Morgens, so geschieht's des
Morgens; also auch, sie komme des Tags oder des Nachts. Denn allein die
Anfechtung lehrt aufs Wort merken. \bibleverse{20} Denn das Bett ist so
eng, dass nichts übrig ist, und die Decke so kurz, dass man sich drein
schmiegen muss. \bibleverse{21} Denn der HErr wird sich aufmachen wie
...
\bibleverse{22} So lasset nun euer Spotten, auf dass eure Bande nicht
...
ausdrischt. \bibleverse{29} Solches geschieht auch vom HErrn Zebaoth;
...
unversehens geschehen. \bibleverse{6} Denn vom HErrn Zebaoth wird
...
starkem Getränk! \bibleverse{10} Denn der HErr hat euch einen Geist des
harten Schlafs eingeschenkt und eure Augen zugetan; eure Propheten und
Fürsten samt den Sehern hat er verhüllt, \bibleverse{11} dass euch aller
...
\bibleverse{12} oder gleich als wenn man's gäbe dem, der nicht lesen
...
\bibleverse{13} Und der HErr spricht: Darum dass dieses Volk zu mir naht
...
\bibleverse{15} Weh, die verborgen sein wollen vor dem HErrn, ihr
...
Augen der Blinden werden aus Dunkel und Finsternis sehen, \footnote{\textbf{29:18}
  Jes 35,5} \bibleverse{19} und die Elenden werden wieder Freude haben
am HErrn, und die Armen unter den Menschen werden fröhlich sein in dem
Heiligen Israels, \bibleverse{20} wenn die Tyrannen ein Ende haben und
es mit den Spöttern aus sein wird und vertilgt sein werden alle die, die
wachen, Mühsal anzurichten, \bibleverse{21} welche die Leute sündigen
...
\bibleverse{22} Darum spricht der HErr, der Abraham erlöst hat, zum
...
\bibleverse{1} Weh den abtrünnigen Kindern, spricht der HErr, die ohne
mich ratschlagen und ohne meinen Geist Schutz suchen, zu Häufen eine
Sünde über die andere; \bibleverse{2} die hinabziehen nach Ägypten und
fragen meinen Mund nicht, dass sie sich stärken mit der Macht Pharaos
und sich beschirmen unter dem Schatten Ägyptens! \bibleverse{3} Denn es
soll euch die Stärke Pharaos zur Schande geraten und der Schutz unter
dem Schatten Ägyptens zum Hohn. \bibleverse{4} Ihre Fürsten sind wohl zu
Zoan gewesen und ihre Botschafter gen Hanes gekommen; \bibleverse{5}
...
die nicht hören wollen des HErrn Gesetz, \bibleverse{10} sondern sagen
...
Täuscherei; \bibleverse{11} weichet vom Wege, gehet aus der Bahn; lasset
den Heiligen Israels aufhören bei uns! \bibleverse{12} Darum spricht der
Heilige Israels also: Weil ihr dieses Wort verwerft und verlasst euch
auf Frevel und Mutwillen und trotzt darauf, \bibleverse{13} so soll euch
...
\bibleverse{14} wie wenn ein Topf zerschmettert würde, den man zerstößt
...
\bibleverse{15} Denn so spricht der Herr HErr, der Heilige in Israel:
...
\bibleverse{18} Darum harret der HErr, dass er euch gnädig sei, und hat
...
\bibleverse{27} Siehe, des HErrn Name kommt von fern! Sein Zorn brennt
und ist sehr schwer; seine Lippen sind voll Grimm und seine Zunge wie
ein verzehrend Feuer, \bibleverse{28} und sein Odem wie eine Wasserflut,
...
her treiben. \bibleverse{29} Da werdet ihr singen wie in der Nacht eines
heiligen Festes und euch von Herzen freuen, wie wenn man mit Flötenspiel
geht zum Berge des HErrn, zum Hort Israels. \bibleverse{30} Und der HErr
...
\bibleverse{31} Denn Assur wird erschrecken vor der Stimme des HErrn,
der ihn mit der Rute schlägt. \bibleverse{32} Und es wird die Rute ganz
...
\bibleverse{33} Denn die Grube ist von gestern her zugerichtet; ja sie
...
Heiligen in Israel und fragen nichts nach dem HErrn! \footnote{\textbf{31:1}
  Jes 30,1-2} \bibleverse{2} Er aber ist weise und bringt Unglück herzu
...
der Bösen und wider die Hilfe der Übeltäter. \footnote{\textbf{31:2} Am
  3,6; 4Mo 23,19} \bibleverse{3} Denn Ägypten ist Mensch und nicht Gott,
...
\bibleverse{4} Denn so spricht der HErr zu mir: Gleichwie ein Löwe und
...
zu streiten auf dem Berge Zion und auf seinem Hügel. \bibleverse{5} Und
der HErr Zebaoth wird Jerusalem beschirmen, wie die Vögel tun mit
Flügeln, schützen, erretten, darin umgehen und aushelfen. \bibleverse{6}
Kehret um, ihr Kinder Israel, zu dem, von welchem ihr sehr abgewichen
seid! \bibleverse{7} Denn zu der Zeit wird ein jeglicher seine silbernen
...
und der Stammelnden Zunge wird fertig und reinlich reden. \footnote{\textbf{32:4}
  Jes 35,6} \bibleverse{5} Es wird nicht mehr ein Narr Fürst heißen noch
ein Geiziger Herr genannt werden. \bibleverse{6} Denn ein Narr redet von
...
und den Durstigen das Trinken wehre. \bibleverse{7} Und des Geizigen
...
\bibleverse{8} Aber die Fürsten werden fürstliche Gedanken haben und
darüber halten.
...
dich wieder berauben. \bibleverse{2} HErr, sei uns gnädig, denn auf dich
harren wir; sei ihr Arm alle Morgen, dazu unser Heil zur Zeit der
Trübsal! \bibleverse{3} Lass fliehen die Völker vor dem großen Getümmel
und die Heiden zerstreut werden, wenn du dich erhebst. \footnote{\textbf{33:3}
  Ps 68,2} \bibleverse{4} Da wird man euch aufraffen wie einen Raub, wie
man die Heuschrecken aufrafft und wie die Käfer zerscheucht werden, wenn
man sie überfällt. \bibleverse{5} Der HErr ist erhaben; denn er wohnt in
der Höhe. Er hat Zion voll Gericht und Gerechtigkeit gemacht.
\bibleverse{6} Und es wird zu deiner Zeit Glaube sein, Reichtum an Heil,
...
\bibleverse{10} Nun will ich mich aufmachen, spricht der HErr; nun will
ich mich emporrichten, nun will ich mich erheben. \bibleverse{11} Mit
Stroh gehet ihr schwanger, Stoppeln gebäret ihr; Feuer wird euch mit
eurem Mut verzehren. \bibleverse{12} Und die Völker werden zu Kalk
verbrannt werden, wie man abgehauene Dornen mit Feuer ansteckt.
\bibleverse{13} So höret nun ihr, die ihr ferne seid, was ich getan
...
\bibleverse{21} Denn der HErr wird mächtig daselbst bei uns sein, gleich
als wären da weite Wassergräben, darüber kein Schiff mit Rudern fahren
noch Galeeren schiffen können. \bibleverse{22} Denn der HErr ist unser
Richter, der HErr ist unser Meister, der HErr ist unser König; der hilft
uns! \bibleverse{23} Lasst sie ihre Stricke spannen, sie werden doch
...
auch die Lahmen rauben werden. \bibleverse{24} Und kein Einwohner wird
...
Gewächs! \bibleverse{2} Denn der HErr ist zornig über alle Heiden und
grimmig über all ihr Heer. Er wird sie verbannen und zum Schlachten
überantworten. \bibleverse{3} Und ihre Erschlagenen werden hingeworfen
...
\footnote{\textbf{34:4} Offb 14,11; Offb 19,3}
...
\bibleverse{6} Des HErrn Schwert ist voll Blut und dick von Fett, vom
...
\bibleverse{7} Da werden die Einhörner samt ihnen herunter müssen und
die Farren samt den gemästeten Ochsen. Denn ihr Land wird trunken werden
von Blut und ihre Erde dick werden von Fett. \bibleverse{8} Denn es ist
der Tag der Rache des HErrn und das Jahr der Vergeltung, zu rächen Zion.
\bibleverse{9} Da werden Edoms Bäche zu Pech werden und seine Erde zu
Schwefel; ja sein Land wird zu brennendem Pech werden, \bibleverse{10}
...
dadurch gehen wird in Ewigkeit; \bibleverse{11} sondern Rohrdommeln und
...
Richtblei, dass es öde sei, \bibleverse{12} dass seine Herren heißen
müssen Herren ohne Land und alle seine Fürsten ein Ende haben;
\bibleverse{13} und werden Dornen wachsen in seinen Palästen, Nesseln
...
Schakale und Weide für die Strauße. \footnote{\textbf{34:13} Jes
  13,21-22} \bibleverse{14} Da werden untereinander laufen Wüstentiere
...
\bibleverse{15} Die Natter wird auch daselbst nisten und legen, brüten
und aushecken unter seinem Schatten; auch werden die Weihen daselbst
zusammenkommen. \bibleverse{16} Suchet nun in dem Buch des HErrn und
...
Geist ist's, der es zusammenbringt. \bibleverse{17} Er wirft das Los für
...
Gottes. \bibleverse{3} Stärket die müden Hände und erquicket die
...
euch helfen. \footnote{\textbf{35:4} Ps 94,1} \bibleverse{5} Alsdann
...
\bibleverse{6} alsdann werden die Lahmen springen wie ein Hirsch, und
der Stummen Zunge wird Lob sagen. Denn es werden Wasser in der Wüste hin
und wieder fließen und Ströme im dürren Lande. \bibleverse{7} Und wo es
...
Gras und Rohr und Schilf stehen. \bibleverse{8} Und es wird daselbst
...
man darauf gehe, dass auch die Toren nicht irren mögen. \footnote{\textbf{35:8}
  Jes 62,10} \bibleverse{9} Es wird da kein Löwe sein, und wird kein
reißendes Tier darauf treten noch daselbst gefunden werden; sondern man
wird frei sicher daselbst gehen. \bibleverse{10} Die Erlösten des HErrn
...
\bibleverse{10} Dazu, meinst du, dass ich ohne den HErrn bin
...
Assyrien gegeben werden. \bibleverse{16} Gehorchet Hiskia nicht! Denn so
...
Feigenbaum essen und aus seinem Brunnen trinken, \bibleverse{17} bis
...
\bibleverse{18} Lasst euch Hiskia nicht bereden, dass er sagt: Der HErr
...
errettet von der Hand des Königs von Assyrien? \footnote{\textbf{36:18}
  Jes 10,10; Jes 37,12} \bibleverse{19} Wo sind die Götter zu Hamath und
...
\bibleverse{2} und sandte Eljakim, den Hofmeister, und Sebna, den
Schreiber, samt den Ältesten der Priester, mit Säcken umhüllt, zu dem
Propheten Jesaja, dem Sohn des Amoz, \bibleverse{3} dass sie zu ihm
...
gekommen sind und ist keine Kraft da, zu gebären. \bibleverse{4} Dass
...
haben. \bibleverse{7} Siehe, ich will ihm einen anderen Mut machen, und
...
vor dem HErrn. \bibleverse{15} Und Hiskia betete zum HErrn und sprach:
\bibleverse{16} HErr Zebaoth, du Gott Israels, der du über den Cherubim
sitzest, du bist allein Gott über alle Königreiche auf Erden, du hast
Himmel und Erde gemacht. \bibleverse{17} HErr neige deine Ohren und höre
...
\bibleverse{18} Wahr ist's, HErr, die Könige von Assyrien haben wüst
gemacht alle Königreiche samt ihren Landen \bibleverse{19} und haben
...
\bibleverse{20} Nun aber, HErr, unser Gott, hilf uns von seiner Hand,
...
hast des Königs Sanherib halben von Assyrien, \bibleverse{22} so ist es
...
Israel. \bibleverse{24} Durch deine Knechte hast du den HErrn geschändet
...
äußersten Höhe gekommen, an den Wald seines Baumgartens. \footnote{\textbf{37:24}
  Jes 14,8} \bibleverse{25} Ich habe gegraben und getrunken die Wasser
...
\bibleverse{33} Darum spricht der HErr also vom König von Assyrien: Er
...
schütten; \bibleverse{34} sondern des Weges, den er gekommen ist, soll
er wieder heimkehren, dass er in diese Stadt nicht komme, spricht der
HErr. \bibleverse{35} Denn ich will diese Stadt schützen, dass ich ihr
...
\bibleverse{36} Da fuhr aus der Engel des HErrn und schlug im
...
HErrn \bibleverse{3} und sprach: Gedenke doch, HErr, wie ich vor dir
gewandelt habe in der Wahrheit, mit vollkommenem Herzen, und habe getan,
was dir gefallen hat. Und Hiskia weinte sehr.

\bibleverse{4} Da geschah das Wort des HErrn zu Jesaja und sprach:
\bibleverse{5} Gehe hin und sage Hiskia: So spricht der HErr, der Gott
...
\bibleverse{6} und will dich samt dieser Stadt erretten von der Hand des
Königs von Assyrien; denn ich will diese Stadt wohl verteidigen.
\bibleverse{7} Und habe dir das zum Zeichen von dem HErrn, dass der HErr
solches tun wird, was er geredet hat: \bibleverse{8} Siehe, ich will den
...
die ihre Zeit leben. \footnote{\textbf{38:11} Ps 27,13} \bibleverse{12}
...
Faden; du machst's mit mir ein Ende den Tag vor Abend. \footnote{\textbf{38:12}
  Hi 7,6} \bibleverse{13} Ich dachte: Möchte ich bis morgen Leben! Aber
...
\bibleverse{14} Ich winselte wie ein Kranich und wie eine Schwalbe und
...
Wahrheit kundtun. \bibleverse{20} HErr, hilf mir, so wollen wir meine
...
\bibleverse{5} Und Jesaja sprach zu Hiskia: Höre das Wort des HErrn
Zebaoth: \bibleverse{6} Siehe, es kommt die Zeit, dass alles, was in
...
HErr. \bibleverse{7} Dazu werden sie von deinen Kindern, die von dir
...
\bibleverse{8} Und Hiskia sprach zu Jesaja: Das Wort des HErrn ist gut,
...
\footnote{\textbf{40:3} Lk 3,4-6; Joh 1,23} \bibleverse{4} Alle Täler
...
werden; \bibleverse{5} denn die Herrlichkeit des HErrn soll offenbart
...
\bibleverse{8} Das Gras verdorrt, die Blume verwelkt; aber das Wort
...
\bibleverse{10} Denn siehe, der Herr HErr kommt gewaltig, und sein Arm
wird herrschen. Siehe, sein Lohn ist bei ihm, und seine Vergeltung ist
vor ihm. \footnote{\textbf{40:10} Jes 62,11} \bibleverse{11} Er wird
...
\bibleverse{13} Wer unterrichtet den Geist des HErrn, und welcher
Ratgeber unterweist ihn? \footnote{\textbf{40:13} 1Kor 2,16; Röm 11,34}
\bibleverse{14} Wen fragt er um Rat, der ihm Verstand gebe und lehre ihn
den Weg des Rechts und lehre ihn die Erkenntnis und unterweise ihn den
Weg des Verstandes? \bibleverse{15} Siehe, die Heiden sind geachtet wie
ein Tropfen, der im Eimer bleibt, und wie ein Scherflein, das in der
Waage bleibt. Siehe, die Inseln sind wie ein Stäublein. \bibleverse{16}
...
vorüber? \bibleverse{28} Weißt du nicht? hast du nicht gehört? Der HErr,
...
noch matt; sein Verstand ist unausforschlich. \footnote{\textbf{40:28}
  Jes 45,12; Jes 40,13} \bibleverse{29} Er gibt dem Müden Kraft, und
Stärke genug dem Unvermögenden. \bibleverse{30} Die Knaben werden müde
und matt, und die Jünglinge fallen; \bibleverse{31} aber die auf den
...
Erste und der Letzte. \bibleverse{5} Da das die Inseln sahen, fürchteten
sie sich, und die Enden der Erde erschraken; sie nahten und kamen herzu.
\bibleverse{6} Einer half dem anderen und sprach zu seinem Nächsten: Sei
getrost! \bibleverse{7} Der Zimmermann nahm den Goldschmied zu sich und
...
\bibleverse{13} Denn ich bin der HErr, dein Gott, der deine rechte Hand
...
Heilige in Israel. \footnote{\textbf{41:14} Jes 43,3} \bibleverse{15}
...
Spreu machen. \bibleverse{16} Du sollst sie zerstreuen, dass sie der
...
ich, der Gott Israels, will sie nicht verlassen. \bibleverse{18} Sondern
...
Wasserquellen; \bibleverse{19} ich will in der Wüste geben Zedern,
Akazien, Myrten und Kiefern; ich will auf dem Gefilde geben Tannen,
Buchen und Buchsbaum miteinander, \bibleverse{20} auf dass man sehe und
...
\bibleverse{21} So lasset eure Sache herkommen, spricht der HErr;
bringet her, worauf ihr stehet, spricht der König in Jakob.
\bibleverse{22} Lasset sie herzutreten und uns verkündigen, was künftig
...
doch hören, was zukünftig ist! \footnote{\textbf{41:22} Jes 43,8-9; Jes
  44,7} \bibleverse{23} Verkündiget uns, was hernach kommen wird, so
wollen wir merken, dass ihr Götter seid. Wohlan, tut Gutes oder Schaden,
so wollen wir davon reden und miteinander schauen. \bibleverse{24}
...
\footnote{\textbf{42:3} Ps 34,19} \bibleverse{4} Er wird nicht matt
...
\bibleverse{5} So spricht Gott, der HErr, der die Himmel schafft und
...
\bibleverse{6} Ich, der HErr, habe dich gerufen in Gerechtigkeit und
habe dich bei deiner Hand gefasst und habe dich behütet und habe dich
zum Bund unter das Volk gegeben, zum Licht der Heiden, \bibleverse{7}
...
\footnote{\textbf{42:7} Jes 35,5} \bibleverse{8} Ich, der HErr, das ist
mein Name; und will meine Ehre keinem anderen geben noch meinen Ruhm den
Götzen. \footnote{\textbf{42:8} 2Mo 3,15; Jes 48,11} \bibleverse{9}
...
\bibleverse{10} Singet dem HErrn ein neues Lied, seinen Ruhm an der Welt
Ende, die auf dem Meer fahren und was darinnen ist, die Inseln und die
darin wohnen! \bibleverse{11} Rufet laut, ihr Wüsten und die Städte
darin samt den Dörfern, da Kedar wohnt; es sollen jauchzen, die in
Felsen wohnen, und rufen von den Höhen der Berge! \bibleverse{12} Lasset
sie dem HErrn die Ehre geben und seinen Ruhm in den Inseln verkündigen.
\bibleverse{13} Der HErr wird ausziehen wie ein Riese; er wird den Eifer
aufwecken wie ein Kriegsmann; er wird jauchzen und tönen; er wird seinen
Feinden obliegen. \bibleverse{14} Ich schweige wohl eine Zeitlang und
bin still und halte an mich; nun aber will ich wie eine Gebärerin
schreien; ich will sie verwüsten und alle verschlingen. \bibleverse{15}
...
\bibleverse{16} Aber die Blinden will ich auf dem Wege leiten, den sie
...
HErrn? \footnote{\textbf{42:19} Jes 41,8} \bibleverse{20} Man predigt
wohl viel, aber sie halten's nicht; man sagt ihnen genug, aber sie
wollen's nicht hören. \footnote{\textbf{42:20} Jes 53,1} \bibleverse{21}
Der HErr wollte ihnen wohl um seiner Gerechtigkeit willen, dass er das
Gesetz herrlich und groß mache. \bibleverse{22} Aber es ist ein
...
nicht wandeln und gehorchten seinem Gesetz nicht? \bibleverse{25} Darum
...
\footnote{\textbf{43:2} Ps 66,12} \bibleverse{3} Denn ich bin der HErr,
...
dich als Lösegeld gegeben, Mohren und Seba an deine Statt. \footnote{\textbf{43:3}
  Spr 11,8} \bibleverse{4} Weil du so wert bist vor meinen Augen
...
\bibleverse{5} So fürchte dich nun nicht; denn ich bin bei dir. Ich will
...
Wahrheit. \footnote{\textbf{43:9} Jes 41,22-26} \bibleverse{10} Ihr aber
...
\footnote{\textbf{43:10} Jes 41,8} \bibleverse{11} Ich, ich bin der
HErr, und ist außer mir kein Heiland. \footnote{\textbf{43:11} Jes 44,6;
  5Mo 32,39} \bibleverse{12} Ich habe es verkündigt und habe auch
...
\footnote{\textbf{43:12} Jes 43,10} \bibleverse{13} Auch bin ich, ehe
...
\bibleverse{14} So spricht der HErr, euer Erlöser, der Heilige in
...
gejagt. \bibleverse{15} Ich bin der HErr, euer Heiliger, der ich Israel
...
\bibleverse{16} So spricht der HErr, der im Meer Weg und in starken
Wassern Bahn macht, \bibleverse{17} der ausziehen lässt Wagen und Ross,
Heer und Macht, dass sie auf einem Haufen daliegen und nicht aufstehen,
dass sie verlöschen, wie ein Docht verlischt: \bibleverse{18} Gedenket
nicht an das Alte und achtet nicht auf das Vorige! \bibleverse{19} Denn
...
der Einöde, \footnote{\textbf{43:19} Jes 41,18} \bibleverse{20} dass
...
Volk, meine Auserwählten. \bibleverse{21} dieses Volk habe ich mir
...
\footnote{\textbf{43:26} Jes 58,2; Jer 2,35} \bibleverse{27} Deine
...
Jesurun, den ich erwählt habe! \footnote{\textbf{44:2} 5Mo 32,15; 5Mo
  33,5} \bibleverse{3} Denn ich will Wasser gießen auf das Durstige und
...
meinen Segen auf deine Nachkommen, \footnote{\textbf{44:3} Jes 32,15;
  Joe 3,1} \bibleverse{4} dass sie wachsen sollen wie Gras, wie die
Weiden an den Wasserbächen. \bibleverse{5} Dieser wird sagen: Ich bin
...
\bibleverse{6} So spricht der HErr, der König Israels, und sein Erlöser,
der HErr Zebaoth: Ich bin der Erste, und ich bin der Letzte, und außer
mir ist kein Gott. \bibleverse{7} Und wer ist mir gleich, der da rufe
...
\footnote{\textbf{44:7} Jes 41,22} \bibleverse{8} Fürchtet euch nicht
...
\bibleverse{23} Jauchzet ihr Himmel, denn der HErr hat's getan; rufe, du
...
\bibleverse{24} So spricht der HErr, dein Erlöser, der dich von
...
\bibleverse{1} So spricht der HErr zu seinem Gesalbten, dem Kores, den
...
Namen genannt habe, \bibleverse{4} um Jakobs, meines Knechtes, willen
...
\bibleverse{5} Ich bin der HErr, und sonst keiner mehr; kein Gott ist
außer mir. Ich habe dich gerüstet, da du mich noch nicht kanntest,
\footnote{\textbf{45:5} Jes 44,6} \bibleverse{6} auf dass man erfahre,
von der Sonne Aufgang und der Sonne Niedergang, dass außer mir keiner
sei. Ich bin der HErr, und keiner mehr; \bibleverse{7} der ich das Licht
...
du? \bibleverse{11} So spricht der HErr, der Heilige in Israel und ihr
Meister: Fraget mich um das Zukünftige; weiset meine Kinder und das Werk
meiner Hände zu mir! \bibleverse{12} Ich habe die Erde gemacht und den
...
\bibleverse{14} So spricht der HErr: Der Ägypter Handel und der Mohren
...
der Heiland. \footnote{\textbf{45:15} Röm 11,33} \bibleverse{16} Aber
...
miteinander schamrot hingehen. \footnote{\textbf{45:16} Jes 44,9; Jes
  44,11} \bibleverse{17} Israel aber wird erlöst durch den HErrn, durch
...
\bibleverse{18} Denn so spricht der HErr, der den Himmel geschaffen hat,
...
keiner mehr. \bibleverse{19} Ich habe nicht im Verborgenen geredet, im
...
und verkündigt, was da recht ist. \bibleverse{20} Lass sich versammeln
...
\bibleverse{21} Verkündiget und machet euch herzu, ratschlaget
...
\footnote{\textbf{45:21} Jes 45,5} \bibleverse{22} Wendet euch zu mir,
so werdet ihr selig, aller Welt Enden; denn ich bin Gott, und keiner
mehr. \bibleverse{23} Ich schwöre bei mir selbst, und ein Wort der
...
sich alle Knie beugen und alle Zungen schwören \footnote{\textbf{45:23}
  Röm 14,11; Phil 2,10-11} \bibleverse{24} und sagen: Im HErrn habe ich
...
die ihm widerstehen, müssen zu Schanden werden. \footnote{\textbf{45:24}
  Jer 23,6} \bibleverse{25} Denn im HErrn wird gerecht aller Same
...
Wahrheit noch Gerechtigkeit. \bibleverse{2} Denn sie nennen sich aus der
...
Willen an Babel und seinen Arm an den Chaldäern beweisen. \footnote{\textbf{48:14}
  Jes 41,2} \bibleverse{15} Ich, ja, ich habe es gesagt, ich habe ihn
...
nun sendet mich der Herr HErr und sein Geist. \bibleverse{17} So spricht
...
den du gehst. \bibleverse{18} O dass du auf meine Gebote merktest, so
würde dein Friede sein wie ein Wasserstrom, und deine Gerechtigkeit wie
Meereswellen; \footnote{\textbf{48:18} 5Mo 5,26} \bibleverse{19} und
...
\bibleverse{21} Sie hatten keinen Durst, da er sie leitete in der Wüste:
er ließ ihnen Wasser aus dem Fels fließen; er riss den Fels, das Wasser
herausrann. \footnote{\textbf{48:21} 2Mo 17,6} \bibleverse{22} Aber die
...
Namens gedacht, da ich noch im Schoß der Mutter war, \bibleverse{2} und
...
und mich in seinen Köcher gesteckt \footnote{\textbf{49:2} Offb 1,16;
  Jes 51,16} \bibleverse{3} und spricht zu mir: Du bist mein Knecht,
Israel, durch welchen ich will gepriesen werden. \footnote{\textbf{49:3}
  Jes 49,5; Jes 42,1; Jes 41,8} \bibleverse{4} Ich aber dachte, ich
...
\footnote{\textbf{49:4} 1Kö 19,10} \bibleverse{5} Und nun spricht der
...
\bibleverse{8} So spricht der HErr: Ich habe dich erhört zur gnädigen
...
verstörten Erbe austeilest; \footnote{\textbf{49:8} Ps 69,14; 2Kor 6,2;
  Jes 42,6} \bibleverse{9} zu sagen den Gefangenen: Geht heraus! und zu
denen in der Finsternis: Kommt hervor! dass sie am Wege weiden und auf
allen Hügeln ihr Weide haben. \bibleverse{10} Sie werden weder hungern
...
\bibleverse{11} Ich will alle meine Berge zum Wege machen, und meine
Pfade sollen gebahnt sein. \bibleverse{12} Siehe, diese werden von ferne
kommen, und siehe, jene von Mitternacht und diese vom Meer und jene vom
Lande Sinim. \footnote{\textbf{49:12} Lk 13,29} \bibleverse{13}
...
\bibleverse{14} Zion aber spricht: Der HErr hat mich verlassen, der HErr
hat mein vergessen. \bibleverse{15} Kann auch ein Weib ihres Kindleins
...
\footnote{\textbf{49:15} 1Kö 3,26; Jer 31,20} \bibleverse{16} Siehe, in
die Hände habe ich dich gezeichnet; deine Mauern sind immerdar vor mir.
\bibleverse{17} Deine Baumeister werden eilen; aber deine Zerbrecher und
Verstörer werden sich davonmachen. \bibleverse{18} Hebe deine Augen auf
...
\bibleverse{19} Denn dein wüstes, verstörtes und zerbrochenes Land wird
dir alsdann zu eng werden, darin zu wohnen, wenn deine Verderber fern
von dir weichen, \bibleverse{20} dass die Kinder deiner Unfruchtbarkeit
...
\bibleverse{21} Du aber wirst sagen in deinem Herzen: Wer hat mir diese
...
\bibleverse{22} So spricht der Herr HErr: Siehe, ich will meine Hand zu
...
Achseln hertragen. \bibleverse{23} Und Könige sollen deine Pfleger, und
...
hadern und deinen Kindern helfen. \bibleverse{26} Und ich will deine
...
\bibleverse{1} So spricht der HErr: Wo ist der Scheidebrief eurer
...
\footnote{\textbf{50:1} 5Mo 24,1; Jes 54,6; Jes 52,3} \bibleverse{2}
...
vor Wassermangel stinken und Durstes sterben. \footnote{\textbf{50:2}
  Jes 59,1; 4Mo 11,23; 2Mo 14,21} \bibleverse{3} Ich kleide den Himmel
...
\bibleverse{4} Der Herr HErr hat mir eine gelehrte Zunge gegeben, dass
...
Morgen; er weckt mir das Ohr, dass ich höre wie ein Jünger. \footnote{\textbf{50:4}
  Mt 7,28-29; Mt 11,28} \bibleverse{5} Der Herr HErr hat mir das Ohr
geöffnet; und ich bin nicht ungehorsam und gehe nicht zurück.
\footnote{\textbf{50:5} Ps 40,7} \bibleverse{6} Ich hielt meinen Rücken
...
mein Angesicht verbarg ich nicht vor Schmach und Speichel. \footnote{\textbf{50:6}
  Mt 26,67-68; Joh 19,1} \bibleverse{7} Aber der Herr HErr hilft mir;
...
Schanden werde. \bibleverse{8} Er ist nahe, der mich gerechtspricht; wer
will mit mir hadern? Lasst uns zusammentreten; wer ist, der Recht zu mir
hat? Der komme her zu mir! \bibleverse{9} Siehe, der Herr HErr hilft
...
\bibleverse{10} Wer ist unter euch, der den HErrn fürchtet, der seines
...
Gott. \bibleverse{11} Siehe, ihr alle, die ihr ein Feuer anzündet, mit
...
Brunnens Gruft, daraus ihr gegraben seid. \footnote{\textbf{51:1} Jes
  48,1} \bibleverse{2} Schauet Abraham an, euren Vater, und Sara, von
...
\bibleverse{3} Denn der HErr tröstet Zion, er tröstet alle ihre Wüsten
...
\bibleverse{9} Wohlauf, wohlauf, ziehe Macht an, du Arm des HErrn!
...
Stolzen zerhauen und den Drachen verwundet hat? \footnote{\textbf{51:9}
  2Mo 14,14; 2Mo 15,7} \bibleverse{10} Bist du es nicht, der das Meer,
...
machte, dass die Erlösten dadurch gingen? \footnote{\textbf{51:10} 2Mo
  14,21-22} \bibleverse{11} Also werden die Erlösten des HErrn
...
\bibleverse{13} und vergissest des HErrn, der dich gemacht hat, der den
...
verderben. Wo bleibt nun der Grimm des Wüterichs? \bibleverse{14} Der
Gefangene wird eilends losgegeben, dass er nicht hinsterbe zur Grube,
auch keinen Mangel an Brot habe. \bibleverse{15} Denn ich bin der HErr,
dein Gott, der das Meer bewegt, dass seine Wellen wüten; sein Name heißt
HErr Zebaoth. \bibleverse{16} Ich lege mein Wort in deinen Mund und
...
trösten? \footnote{\textbf{51:19} Jes 47,9} \bibleverse{20} Deine Kinder
...
voll des Zorns vom HErrn und des Scheltens von deinem Gott. \footnote{\textbf{51:20}
  Kla 2,11; Kla 2,19} \bibleverse{21} Darum höre dies, du Elende und
Trunkene, doch nicht von Wein! \bibleverse{22} So spricht dein
...
Grimmes; du sollst ihn nicht mehr trinken, \footnote{\textbf{51:22} Jes
  51,17} \bibleverse{23} sondern ich will ihn deinen Schindern in die
...
Tochter Zion! \bibleverse{3} Denn also spricht der HErr: Ihr seid
umsonst verkauft; ihr sollt auch ohne Geld gelöst werden. \footnote{\textbf{52:3}
  Jes 50,1} \bibleverse{4} Denn so spricht der Herr HErr: Mein Volk zog
am ersten hinab nach Ägypten, dass es daselbst ein Gast wäre; und Assur
hat ihm ohne Ursache Gewalt getan. \bibleverse{5} Aber wie tut man mir
...
wird immer täglich gelästert. \bibleverse{6} Darum soll mein Volk meinen
...
\bibleverse{9} Lasst fröhlich sein und miteinander rühmen das Wüste zu
Jerusalem; denn der HErr hat sein Volk getröstet und Jerusalem gelöst.
\bibleverse{10} Der HErr hat offenbart seinen heiligen Arm vor den Augen
aller Heiden, dass aller Welt Enden sehen das Heil unseres Gottes.
\footnote{\textbf{52:10} Jes 53,1} \bibleverse{11} Weicht, weicht, zieht
...
\bibleverse{2} Denn er schoss auf vor ihm wie ein Reis und wie eine
...
\footnote{\textbf{53:2} Jes 11,1} \bibleverse{3} Er war der
...
\bibleverse{4} Fürwahr, er trug unsere Krankheit und lud auf sich unsere
Schmerzen. Wir aber hielten ihn für den, der geplagt und von Gott
geschlagen und gemartert wäre. \footnote{\textbf{53:4} Mt 8,17}
\bibleverse{5} Aber er ist um unserer Missetat willen verwundet und um
...
Frieden hätten, und durch seine Wunden sind wir geheilt. \footnote{\textbf{53:5}
  1Petr 2,24} \bibleverse{6} Wir gingen alle in der Irre wie Schafe, ein
jeglicher sah auf seinen Weg; aber der HErr warf unser aller Sünde auf
ihn. \footnote{\textbf{53:6} 1Petr 2,25; 2Kor 5,21} \bibleverse{7} Da er
...
seinem Scherer und seinen Mund nicht auftut. \footnote{\textbf{53:7} Joh
  1,29; Apg 8,32} \bibleverse{8} Er ist aber aus Angst und Gericht
...
geplagt war. \bibleverse{9} Und man gab ihm bei Gottlosen sein Grab und
...
noch Betrug in seinem Munde gewesen ist. \footnote{\textbf{53:9} 1Petr
  2,22; 1Jo 3,5} \bibleverse{10} Aber der HErr wollte ihn also
...
hat mehr Kinder, als die den Mann hat, spricht der HErr. \footnote{\textbf{54:1}
  Jes 49,20; Gal 4,27} \bibleverse{2} Mache den Raum deiner Hütte weit,
und breite aus die Teppiche deiner Wohnung; spare nicht! Dehne deine
Seile lang und stecke deine Nägel fest! \bibleverse{3} Denn du wirst
ausbrechen zur Rechten und zur Linken, und dein Same wird die Heiden
erben und in den verwüsteten Städten wohnen. \bibleverse{4} Fürchte dich
...
gedenken. \bibleverse{5} Denn der dich gemacht hat, ist dein Mann --
...
\bibleverse{6} Denn der HErr hat dich zu sich gerufen wie ein
...
\bibleverse{7} Ich habe dich einen kleinen Augenblick verlassen; aber
mit großer Barmherzigkeit will ich dich sammeln. \footnote{\textbf{54:7}
  Ps 30,6} \bibleverse{8} Ich habe mein Angesicht im Augenblick des
...
dein erbarmen, spricht der HErr, dein Erlöser. \footnote{\textbf{54:8}
  Jes 60,10} \bibleverse{9} Denn solches soll mir sein wie das Wasser
...
\bibleverse{10} Denn es sollen wohl Berge weichen und Hügel hinfallen;
...
\footnote{\textbf{54:13} Joh 6,45} \bibleverse{14} Du sollst durch
...
\footnote{\textbf{54:15} Röm 8,31} \bibleverse{16} Siehe, ich schaffe
...
Verderber sie zunichte mache. \bibleverse{17} Einer jeglichen Waffe, die
...
\bibleverse{6} Suchet den HErrn, solange er zu finden ist; rufet ihn an,
solange er nahe ist. \bibleverse{7} Der Gottlose lasse von seinem Wege
...
Vergebung. \footnote{\textbf{55:7} Hes 33,11; Ps 130,4} \bibleverse{8}
Denn meine Gedanken sind nicht eure Gedanken, und eure Wege sind nicht
meine Wege, spricht der HErr; \bibleverse{9} sondern soviel der Himmel
höher ist denn die Erde, so sind auch meine Wege höher denn eure Wege
und meine Gedanken denn eure Gedanken. \bibleverse{10} Denn gleichwie
...
gibt Samen, zu säen, und Brot, zu essen: \bibleverse{11} also soll das
...
ich's sende. \footnote{\textbf{55:11} Mt 13,8} \bibleverse{12} Denn ihr
...
\bibleverse{13} Es sollen Tannen für Hecken wachsen und Myrten für
...
\bibleverse{1} So spricht der HErr: Haltet das Recht und tut
...
sagen: Siehe, ich bin ein dürrer Baum. \footnote{\textbf{56:3} Jes 14,1;
  5Mo 23,2} \bibleverse{4} Denn so spricht der HErr von den
Verschnittenen, welche meine Sabbate halten und erwählen, was mir wohl
gefällt, und meinen Bund fest fassen: \bibleverse{5} Ich will ihnen in
...
der nicht vergehen soll. \bibleverse{6} Und die Fremden, die sich zum
...
nicht entweihe, und meinen Bund festhält, \bibleverse{7} die will ich zu
...
denn mein Haus wird heißen ein Bethaus allen Völkern. \footnote{\textbf{56:7}
  Mk 11,17} \bibleverse{8} Der Herr HErr, der die Verstoßenen aus Israel
...
schweigen, dass du mich so gar nicht fürchtest? \footnote{\textbf{57:11}
  Ps 50,21} \bibleverse{12} Ich will aber deine Gerechtigkeit anzeigen
und deine Werke, dass sie dir nichts nütze sein sollen. \bibleverse{13}
...
Angesicht ein Geist wehen, und ich will Odem machen. \footnote{\textbf{57:16}
  Ps 103,9} \bibleverse{17} Ich war zornig über die Untugend ihres
Geizes und schlug sie, verbarg mich und zürnte; da gingen sie hin und
her im Wege ihres Herzens. \bibleverse{18} Aber da ich ihre Wege ansah,
heilte ich sie und leitete sie und gab ihnen wieder Trost und denen, die
über jene Leid trugen. \bibleverse{19} Ich will Frucht der Lippen
...
auswerfen. \footnote{\textbf{57:20} Jud 1,13} \bibleverse{21} Die
...
\footnote{\textbf{58:2} Jes 43,26} \bibleverse{3} „Warum fasten wir, und
...
und treibet alle eure Arbeiter. \bibleverse{4} Siehe, ihr fastet, dass
...
\footnote{\textbf{58:8} Jes 58,10; Ps 37,6} \bibleverse{9} Dann wirst du
...
noch mit Fingern zeigen noch übel reden \footnote{\textbf{58:9} Jes
  30,19} \bibleverse{10} und wirst den Hungrigen lassen finden dein Herz
...
\bibleverse{12} und soll durch dich gebaut werden, was lange wüst
...
dir gefällt, oder leeres Geschwätz; \footnote{\textbf{58:13} Jes 56,2;
  Jes 56,4} \bibleverse{14} alsdann wirst du Lust haben am HErrn, und
...
\bibleverse{1} Siehe, des HErrn Hand ist nicht zu kurz, dass er nicht
helfen könne, und seine Ohren sind nicht hart geworden, dass er nicht
höre; \footnote{\textbf{59:1} Jes 50,2} \bibleverse{2} sondern eure
...
\bibleverse{8} sie kennen den Weg des Friedens nicht, und ist kein Recht
...
Sünden: \bibleverse{13} mit Übertreten und Lügen wider den HErrn und
Zurückkehren von unserem Gott und mit Reden zum Frevel und Ungehorsam,
mit Trachten und Dichten falscher Worte aus dem Herzen. \bibleverse{14}
...
ihm übel, dass kein Recht ist. \bibleverse{16} Und er sieht, dass
...
des HErrn treibt. \bibleverse{20} Denn denen zu Zion wird ein Erlöser
kommen und denen, die sich bekehren von den Sünden in Jakob, spricht der
HErr. \footnote{\textbf{59:20} Jes 1,27; Röm 11,26}

\bibleverse{21} Und ich mache solchen Bund mit ihnen, spricht der HErr:
...
die Herrlichkeit des HErrn geht auf über dir. \bibleverse{2} Denn siehe,
...
\bibleverse{3} Und die Heiden werden in deinem Lichte wandeln und die
...
Weihrauch bringen und des HErrn Lob verkündigen. \footnote{\textbf{60:6}
  Ps 72,10; Mt 2,1-11} \bibleverse{7} Alle Herden in Kedar sollen zu dir
...
\bibleverse{17} Ich will Gold anstatt des Erzes und Silber anstatt des
...
Gerechtigkeit. \footnote{\textbf{60:17} Jes 52,7} \bibleverse{18} Man
...
haben. \bibleverse{21} Und dein Volk sollen eitel Gerechte sein; sie
werden das Erdreich ewiglich besitzen, als die der Zweig meiner
Pflanzung und ein Werk meiner Hände sind zum Preise. \bibleverse{22} Aus
...
\bibleverse{1} Der Geist des Herrn HErrn ist über mir, darum dass mich
...
Freiheit, den Gebundenen, dass ihnen geöffnet werde, \footnote{\textbf{61:1}
  Mt 11,5; Lk 4,18-19} \bibleverse{2} zu verkündigen ein gnädiges Jahr
des HErrn und einen Tag der Rache unseres Gottes, zu trösten alle
Traurigen, \footnote{\textbf{61:2} 3Mo 25,10; Jes 63,4} \bibleverse{3}
...
\bibleverse{7} Für eure Schmach soll Zwiefältiges kommen, und für die
...
\bibleverse{8} Denn ich bin der HErr, der das Rechte liebt, und hasse
...
sein, und einen ewigen Bund will ich mit ihnen machen. \footnote{\textbf{61:8}
  Jes 54,10; Jes 55,3} \bibleverse{9} Und man soll ihren Samen kennen
...
\bibleverse{10} Ich freue mich im HErrn, und meine Seele ist fröhlich in
...
\bibleverse{3} Und du wirst sein eine schöne Krone in der Hand des HErrn
und ein königlicher Hut in der Hand deines Gottes. \bibleverse{4} Man
...
lieben Mann. \bibleverse{5} Denn wie ein Mann ein Weib liebhat, so
...
\footnote{\textbf{62:6} Jes 52,8} \bibleverse{7} und ihr von ihm nicht
schweiget, bis dass Jerusalem zugerichtet und gesetzt werde zum Lobe auf
Erden. \bibleverse{8} Der HErr hat geschworen bei seiner Rechten und bei
...
trinken lassen; \footnote{\textbf{62:8} Jes 65,21-22} \bibleverse{9}
...
Panier auf über die Völker! \bibleverse{11} Siehe, der HErr lässt sich
...
\bibleverse{3} „Ich trete die Kelter allein, und ist niemand unter den
...
habe all mein Gewand besudelt. \footnote{\textbf{63:3} Offb 14,20; Joe
  4,13} \bibleverse{4} Denn ich habe einen Tag der Rache mir
vorgenommen; das Jahr, die Meinen zu erlösen, ist gekommen. \footnote{\textbf{63:4}
  Jes 13,9; Jes 34,8; Jes 61,2} \bibleverse{5} Und ich sah mich um, und
...
\bibleverse{7} Ich will der Gnade des HErrn gedenken und des Lobes des
...
großen Gnade. \bibleverse{8} Denn er sprach: Sie sind ja mein Volk,
Kinder, die nicht falsch sind. Darum war er ihr Heiland. \footnote{\textbf{63:8}
  5Mo 32,5; 5Mo 32,20} \bibleverse{9} Wer sie ängstete, der ängstete ihn
...
unser Erlöser; von alters her ist das dein Name. \bibleverse{17} Warum
...
der Stämme willen deines Erbes. \bibleverse{18} Sie besitzen dein
heiliges Volk schier ganz; deine Widersacher zertreten dein Heiligtum.
\footnote{\textbf{63:18} Ps 79,1} \bibleverse{19} Wir sind geworden wie
...
\bibleverse{7} Aber nun, HErr, du bist unser Vater; wir sind Ton, du
bist unser Töpfer; und wir alle sind deiner Hände Werk. \footnote{\textbf{64:7}
  Jes 63,16; Jes 45,9} \bibleverse{8} HErr, zürne nicht zu sehr und
denke nicht ewig der Sünde. Siehe doch das an, dass wir alle dein Volk
sind. \bibleverse{9} Die Städte deines Heiligtums sind zur Wüste
geworden; Zion ist zur Wüste geworden, Jerusalem liegt zerstört.
\bibleverse{10} Das Haus unserer Heiligkeit und Herrlichkeit, darin dich
unsere Väter gelobt haben, ist mit Feuer verbrannt; und alles, was wir
Schönes hatten, ist zu Schanden gemacht. \bibleverse{11} HErr, willst du
...
nachwandelt auf einem Wege, der nicht gut ist. \footnote{\textbf{65:2}
  Spr 1,24; Jer 3,17} \bibleverse{3} Ein Volk, das mich entrüstet, ist
immer vor meinem Angesicht, opfert in den Gärten und räuchert auf den
Ziegelsteinen, \bibleverse{4} sitzt unter den Gräbern und bleibt über
Nacht in den Höhlen, fressen Schweinefleisch und haben Gräuelsuppen in
ihren Töpfen \footnote{\textbf{65:4} Jes 66,17; 3Mo 11,7} \bibleverse{5}
...
das den ganzen Tag brenne. \bibleverse{6} Siehe, es steht vor mir
geschrieben: Ich will nicht schweigen, sondern bezahlen; ja, ich will
ihnen in ihren Busen bezahlen, \bibleverse{7} beide, ihre Missetaten und
...
zumessen ihr voriges Tun in ihren Busen. \bibleverse{8} So spricht der
...
\bibleverse{9} sondern will aus Jakob Samen wachsen lassen und aus Juda,
der meinen Berg besitze; denn meine Auserwählten sollen ihn besitzen,
und meine Knechte sollen daselbst wohnen. \bibleverse{10} Und Saron soll
...
\bibleverse{11} Aber ihr, die ihr den HErrn verlasset und meines
heiligen Berges vergesset und richtet dem Gad einen Tisch und schenkt
vom Trankopfer voll ein der Meni, -- \bibleverse{12} wohlan ich will
...
erwähltet, was mir nicht gefiel. \bibleverse{13} Darum spricht der Herr
...
\bibleverse{19} und ich will fröhlich sein über Jerusalem und mich
...
Stimme des Weinens noch die Stimme des Klagens. \footnote{\textbf{65:19}
  Jes 25,8} \bibleverse{20} Es sollen nicht mehr dasein Kinder, die nur
...
alt verflucht werden. \footnote{\textbf{65:20} Sach 8,4} \bibleverse{21}
Sie werden Häuser bauen und bewohnen; sie werden Weinberge pflanzen und
ihre Früchte essen. \footnote{\textbf{65:21} Jes 62,8} \bibleverse{22}
...
Auserwählten. \footnote{\textbf{65:22} 5Mo 28,30} \bibleverse{23} Sie
...
\bibleverse{24} Und soll geschehen, ehe sie rufen, will ich antworten;
wenn sie noch reden, will ich hören. \bibleverse{25} Wolf und Lamm
...
\bibleverse{1} So spricht der HErr: Der Himmel ist mein Stuhl und die
...
\footnote{\textbf{66:2} Jes 57,15} \bibleverse{3} Wer einen Ochsen
...
an ihren Gräueln. \footnote{\textbf{66:3} 3Mo 17,4} \bibleverse{4} Darum
...
\bibleverse{5} Höret des HErrn Wort, die ihr euch fürchtet vor seinem
...
bezahlt. \bibleverse{7} Sie gebiert, ehe ihr wehe wird; sie ist genesen
eines Knaben, ehe denn ihre Kindsnot kommt. \bibleverse{8} Wer hat
...
ja Zion ihre Kinder ohne Wehen geboren. \bibleverse{9} Sollte ich das
...
Herrlichkeit. \bibleverse{12} Denn also spricht der HErr: Siehe, ich
...
halten. \footnote{\textbf{66:12} Jes 60,4} \bibleverse{13} Ich will euch
...
\bibleverse{15} Denn siehe, der HErr wird kommen mit Feuer und seine
Wagen wie ein Wetter, dass er vergelte im Grimm seines Zorns und mit
Schelten in Feuerflammen. \bibleverse{16} Denn der HErr wird durchs
...
reinem Gefäß bringen zum Hause des HErrn. \footnote{\textbf{66:20} Jes
  60,3-7} \bibleverse{21} Und ich will auch aus ihnen nehmen Priester
...
und Name stehen. \^{}\^{} \bibleverse{23} Und alles Fleisch wird einen
Neumond nach dem anderen und einen Sabbat nach dem anderen kommen,
anzubeten vor mir, spricht der HErr. \bibleverse{24} Und sie werden
