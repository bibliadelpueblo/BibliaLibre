...
Befehl Gottes, unseres Heilandes, \footnote{\textbf{1:14} 1Tim 4,7; 2Tim
  4,4} \bibleverse{4} dem Titus, meinem rechtschaffenen Sohn nach unser
...
ungehorsam sind. \textsuperscript{b} \bibleverse{7} Denn ein Bischof
...
treiben; \footnote{\textbf{2:3} 1Tim 3,11} \bibleverse{8} sondern
gastfrei, gütig, züchtig, gerecht, heilig, keusch, \bibleverse{9} und
...
der Wahrheit abwenden. \textsuperscript{b} \bibleverse{15} Den Reinen
...
\bibleverse{16} Sie sagen, sie erkennen Gott; aber mit den Werken
...
der Geduld; \footnote{\textbf{3:2} Phil 4,5} \bibleverse{3} den alten
...
\textsuperscript{c} \bibleverse{4} dass sie die jungen Weiber lehren
züchtig sein, ihre Männer lieben, Kinder lieben, \bibleverse{5} sittig
...
alle Menschen. \textsuperscript{b} \bibleverse{3} Denn wir waren auch
...
und hassten uns untereinander. \textsuperscript{c} \bibleverse{4} Da
aber erschien die Freundlichkeit und Leutseligkeit Gottes, unseres
Heilandes, -- \textsuperscript{d} \bibleverse{5} nicht um der Werke
...
ihnen nichts gebreche. \textsuperscript{b} \bibleverse{14} Lass aber
