...
Zeit gelebt hatten, \footnote{\textbf{4:25} Jos 5,2} \bibleverse{7}
...
Bund mit Abraham, Isaak und Jakob; \textsuperscript{b} \bibleverse{25}
...
\bibleverse{7} Und der \textsc{Herr} sprach: Ich habe gesehen das Elend
...
widerfahren ist, \bibleverse{17} und habe gesagt: Ich will euch aus dem
...
fließt. \bibleverse{18} Und wenn sie deine Stimme hören, so sollst du
...
\bibleverse{19} Aber ich weiß, dass euch der König in Ägypten nicht wird
ziehen lassen, außer durch eine starke Hand. \bibleverse{20} Denn ich
...
\bibleverse{21} Und ich will diesem Volk Gnade geben vor den Ägyptern,
dass, wenn ihr auszieht, ihr nicht leer auszieht; \bibleverse{22}
...
\bibleverse{4} Aber der \textsc{Herr} sprach zu ihm: Strecke deine Hand
...
der Gott Jakobs. \bibleverse{6} Und der \textsc{Herr} sprach weiter zu
...
\bibleverse{11} Der \textsc{Herr} sprach zu ihm: Wer hat dem Menschen
...
\footnote{\textbf{4:11} Ps 94,9} \bibleverse{12} So geh nun hin: Ich
...
dich sieht, wir er sich von Herzen freuen. \bibleverse{15} Du sollst zu
...
\bibleverse{19} Auch sprach der \textsc{Herr} zu ihm in Midian: Gehe hin
...
nicht lassen wird. \textsuperscript{b} \bibleverse{22} Und du sollst zu
ihm sagen: So sagt der \textsc{Herr}: Israel ist mein erstgeborener
Sohn; \footnote{\textbf{8:6} 2Mo 9,14; 2Mo 15,11} \bibleverse{23} und
...
\textsc{Herr} entgegen und wollte ihn töten. \footnote{\textbf{4:24} 1Mo
  17,14} \bibleverse{25} Da nahm Zippora einen Stein und beschnitt ihrem
...
\bibleverse{2} Pharao antwortete: Wer ist der \textsc{Herr}, des Stimme
...
\bibleverse{18} So gehet nun hin und frönet; Stroh soll man euch nicht
...
\textsc{Herr} \bibleverse{3} und bin erschienen Abraham, Isaak und Jakob
als der allmächtige Gott; aber mein Name \textsc{Herr} ist ihnen nicht
offenbart worden. \bibleverse{4} Auch habe ich einen Bund mit ihnen
...
Wallfahrt, darin sie Fremdlinge gewesen sind. \footnote{\textbf{6:4} 1Mo
  12,7} \bibleverse{5} Auch habe ich gehört die Wehklage der Kinder
Israel, welche die Ägypter mit Frönen beschweren, und habe an meinen
Bund gedacht. \bibleverse{6} Darum sage den Kindern Israel: Ich bin der
...
hören? Dazu bin ich von unbeschnittenen Lippen. \footnote{\textbf{6:12}
  2Mo 6,30; 2Mo 4,10} \bibleverse{13} Also redete der \textsc{Herr} mit
...
\textsuperscript{b} \bibleverse{22} Die Kinder Usiels sind diese:
Misael, Elzaphan, Sithri. \textsuperscript{c} \bibleverse{23} Aaron nahm
zum Weibe Eliseba, die Tochter Amminadabs, Nahessons Schwester; die
gebar ihm Nadab, Abihu, Eleasar, Ithamar. \textsuperscript{d}
\bibleverse{24} Die Kinder Korahs sind diese: Assir, Elkana, Abiasaph.
Das sind die Geschlechter der Korahiter. \footnote{\textbf{6:24} 4Mo
  25,7} \bibleverse{25} Eleasar aber, Aarons Sohn, der nahm von den
Töchtern Putiels ein Weib; die gebar ihm den Pinehas. Das sind die
Häupter unter den Vätern der Leviten-Geschlechter. \bibleverse{26} Das
ist der Aaron und Mose, zu denen der \textsc{Herr} sprach: Führet die
Kinder Israel aus Ägyptenland mit ihrem Heer. \bibleverse{27} Sie sind's
...
\bibleverse{28} Und des Tages redete der \textsc{Herr} mit Mose in
Ägyptenland \bibleverse{29} und sprach zu Ihm: Ich bin der
...
Prophet sein. \footnote{\textbf{7:1} 2Mo 4,16} \bibleverse{2} Du sollst
...
\bibleverse{4} Und Pharao wird euch nicht hören, auf dass ich meine Hand
in Ägypten beweise und führe mein Heer, mein Volk, die Kinder Israel,
aus Ägyptenland durch große Gerichte. \bibleverse{5} Und die Ägypter
...
\bibleverse{6} Mose und Aaron taten, wie ihnen der \textsc{Herr} geboten
hatte. \bibleverse{7} Und Mose war 80 Jahre alt und Aaron 83 Jahre alt,
...
\bibleverse{11} Da forderte Pharao die Weisen und Zauberer; und die
ägyptischen Zauberer taten auch also mit ihrem Beschwören:
\bibleverse{12} ein jeglicher warf seinen Stab von sich, da wurden
...
\bibleverse{14} Und der \textsc{Herr} sprach zu Mose: Das Herz Pharaos
ist hart; er weigert sich, das Volk zu lassen. \bibleverse{15} Gehe hin
...
Schlange ward, \bibleverse{16} und sprich zu ihm: Der \textsc{Herr}, der
...
\bibleverse{18} dass die Fische im Strom sterben sollen und der Strom
stinken; und den Ägyptern wird ekeln, zu trinken das Wasser aus dem
Strom. \bibleverse{19} Und der \textsc{Herr} sprach zu Mose: Sage Aaron:
...
nicht, wie denn der \textsc{Herr} geredet hatte. \footnote{\textbf{7:22}
  2Mo 7,11} \bibleverse{23} Und Pharao wandte sich und ging heim und
nahm's nicht zu Herzen. \bibleverse{24} Aber alle Ägypter gruben nach
Wasser um den Strom her, zu trinken; denn das Wasser aus dem Strom
konnten sie nicht trinken. \bibleverse{25} Und das währte sieben Tage
lang, dass der \textsc{Herr} den Strom schlug. \bibleverse{26} Der
...
\footnote{\textbf{8:3} 2Mo 7,11} \bibleverse{4} Da forderte Pharao Mose
...
dass es dem \textsc{Herrn} opfere. \textsuperscript{b} \bibleverse{5}
...
unser Gott, \textsuperscript{c} \bibleverse{7} so sollen die Frösche von
...
Menschen als an Vieh. \footnote{\textbf{8:14} 2Mo 9,11} \bibleverse{15}
...
diene; \footnote{\textbf{8:16} 2Mo 5,1} \bibleverse{17} wo nicht, siehe,
...
darauf ist, voll Ungeziefer werden sollen. \bibleverse{18} Und ich will
...
der \textsc{Herr} bin auf Erden allenthalben; \bibleverse{19} und will
...
\footnote{\textbf{8:22} 1Mo 43,32} \bibleverse{23} Drei Tagereisen
wollen wir gehen in die Wüste und dem \textsc{Herrn}, unserem Gott,
opfern, wie er uns gesagt hat. \textsuperscript{b} \bibleverse{24}
...
\bibleverse{2} Wo du dich des weigerst und sie weiter aufhältst,
\bibleverse{3} siehe, so wird die Hand des \textsc{Herrn} sein über dein
Vieh auf dem Felde, über Pferde, über Esel, über Kamele, über Ochsen,
über Schafe, mit einer sehr schweren Pestilenz. \bibleverse{4} Und der
...
haben. \bibleverse{5} Und der \textsc{Herr} bestimmte eine Zeit und
sprach: Morgen wird der \textsc{Herr} solches auf Erden tun.
\bibleverse{6} Und der \textsc{Herr} tat solches des Morgens, und es
starb allerlei Vieh der Ägypter; aber des Viehs der Kinder Israel starb
nicht eins. \bibleverse{7} Und Pharao sandte darnach, und siehe, es war
...
\bibleverse{8} Da sprach der \textsc{Herr} zu Mose und Aaron: Nehmet
eure Fäuste voll Ruß aus dem Ofen, und Mose sprenge ihn gen Himmel vor
Pharao, \bibleverse{9} dass es über ganz Ägyptenland stäube und böse
...
Blattern als an allen Ägyptern. \bibleverse{12} Aber der \textsc{Herr}
...
\footnote{\textbf{9:13} 2Mo 5,1} \bibleverse{14} ich will sonst diesmal
...
allen Landen. \textsuperscript{b} \bibleverse{15} Denn ich hätte schon
jetzt meine Hand ausgereckt und dich und dein Volk mit Pestilenz
geschlagen, dass du von der Erde vertilgt würdest. \bibleverse{16} Aber
...
Name verkündigt werde in allen Landen. \footnote{\textbf{9:16} 2Mo 7,3;
  2Mo 14,4; Röm 9,17} \bibleverse{17} Du trittst mein Volk noch unter
dich und willst's nicht lassen. \bibleverse{18} Siehe, ich will morgen
...
\bibleverse{19} Und nun sende hin und verwahre dein Vieh, und alles, was
...
\footnote{\textbf{9:23} Offb 16,21} \bibleverse{24} dass Hagel und Feuer
untereinander fuhren, so grausam, dass desgleichen in ganz Ägyptenland
nie gewesen war, seitdem Leute darin gewesen sind. \bibleverse{25} Und
...
alle Bäume auf dem Felde. \bibleverse{26} Allein im Lande Gosen, da die
...
gerecht, ich aber und mein Volk sind Gottlose. \bibleverse{28} Bittet
...
Erde des \textsc{Herrn} sei. \bibleverse{30} Ich weiß aber, dass du und
...
mir zu dienen? \footnote{\textbf{10:3} 2Mo 5,3} \bibleverse{4} Weigerst
du dich, mein Volk zu lassen, siehe, so will ich morgen Heuschrecken
kommen lassen an allen Orten, \bibleverse{5} dass sie das Land bedecken,
...
grünenden Bäume fressen auf dem Felde \bibleverse{6} und sollen erfüllen
...
\bibleverse{10} Er sprach zu ihnen: O ja, der \textsc{Herr} sei mit
euch! Sollte ich euch und eure Kinder dazu ziehen lassen? Sehet da, ob
ihr nicht Böses vorhabt! \bibleverse{11} Nicht also, sondern ihr Männer
...
\textsc{Herrn}, eurem Gott, und an euch; \footnote{\textbf{10:16} 2Mo
  9,27} \bibleverse{17} vergebt mir meine Sünde nur noch diesmal und
bittet den \textsc{Herrn}, euren Gott, dass er doch nur diesen Tod von
mir wegnehme. \textsuperscript{b}

\bibleverse{18} Und er ging aus von Pharao und bat den \textsc{Herrn}.
\footnote{\textbf{10:18} 4Mo 11,2} \bibleverse{19} Da wendete der
...
übrigblieb an allen Orten Ägyptens. \bibleverse{20} Aber der
...
\bibleverse{21} Der \textsc{Herr} sprach zu Mose: Recke deine Hand gen
...
\bibleverse{26} Unser Vieh soll mit uns gehen und nicht eine Klaue
...
\bibleverse{3} Und der \textsc{Herr} gab dem Volk Gnade vor den
...
\footnote{\textbf{11:7} 2Mo 9,4; 2Mo 9,26} \bibleverse{8} Dann werden zu
...
\bibleverse{9} Der \textsc{Herr} aber sprach zu Mose: Pharao hört euch
nicht, auf dass viele Wunder geschehen in Ägyptenland. \bibleverse{10}
...
\textsuperscript{b} \bibleverse{8} Und sollt also das Fleisch essen in
...
\footnote{\textbf{12:12} 4Mo 33,4} \bibleverse{13} Und das Blut soll
...
Erstgeburt des Viehs. \footnote{\textbf{12:29} 2Mo 4,23} \bibleverse{30}
...
darin nicht ein Toter war. \bibleverse{31} Und er forderte Moses und
...
\textsc{Herrn}, wie ihr gesagt habt. \bibleverse{32} Nehmet auch mit
...
\bibleverse{47} Die ganze Gemeinde Israel soll solches tun.
\bibleverse{48} So aber ein Fremdling bei dir wohnt und dem
...
sollst du nicht Sauerteig essen. \bibleverse{4} Heute seid ihr
...
\bibleverse{6} Sieben Tage sollst du ungesäuertes Brot essen, und am
siebenten Tage ist des \textsc{Herrn} Fest. \textsuperscript{b}
\bibleverse{7} Darum sollst du sieben Tage ungesäuertes Brot essen, dass
bei dir kein Sauerteig noch gesäuertes Brot gesehen werde an allen
deinen Orten. \textsuperscript{c} \bibleverse{8} Ihr sollt euren Söhnen
...
mächtiger Hand aus Ägypten, von dem Diensthause, geführt. \footnote{\textbf{13:14}
  2Mo 12,26} \bibleverse{15} Denn da Pharao hart war, uns loszulassen,
...
\bibleverse{16} Und das soll dir ein Zeichen in deiner Hand sein und ein
...
lagerten sich in Etham, vorn an der Wüste. \bibleverse{21} Und der
...
ihnen leuchtete, zu reisen Tag und Nacht. \bibleverse{22} Die
...
\bibleverse{15} Der \textsc{Herr} sprach zu Mose: Was schreist du zu
mir? Sage den Kindern Israel, dass sie ziehen. \bibleverse{16} Du aber
...
Trockenen. \bibleverse{17} Siehe, ich will das Herz der Ägypter
...
\bibleverse{18} Und die Ägypter sollen innewerden, dass ich der
...
\footnote{\textbf{14:19} 2Mo 13,21} \bibleverse{20} und kam zwischen das
...
\textsuperscript{b} \bibleverse{25} und stieß die Räder von ihren Wagen,
...
\bibleverse{26} Aber der \textsc{Herr} sprach zu Mose: Recke deine Hand
aus über das Meer, dass das Wasser wieder herfalle über die Ägypter,
über ihre Wagen und Reiter. \bibleverse{27} Da reckte Mose seine Hand
...
mitten ins Meer, \bibleverse{28} dass das Wasser wiederkam und bedeckte
...
ihnen für Mauern zur Rechten und zur Linken. \bibleverse{30} Also half
der \textsc{Herr} Israel an dem Tage von der Ägypter Hand. Und sie sahen
die Ägypter tot am Ufer des Meeres \bibleverse{31} und die große Hand,
...
\footnote{\textbf{15:1} Offb 15,3} \bibleverse{2} Der \textsc{Herr} ist
...
\textsuperscript{b} \bibleverse{3} Der \textsc{Herr} ist der rechte
Kriegsmann; \textsc{Herr} ist sein Name. \textsuperscript{c}
\bibleverse{4} Die Wagen Pharaos und seine Macht warf er ins Meer; seine
auserwählten Hauptleute versanken im Schilfmeer. \bibleverse{5} Die
Tiefe hat sie bedeckt; sie fielen zu Grund wie die Steine.
\bibleverse{6} \textsc{Herr}, deine rechte Hand tut große Wunder;
\textsc{Herr}, deine rechte Hand hat die Feinde zerschlagen.
\bibleverse{7} Und mit deiner großen Herrlichkeit hast du deine
Widersacher gestürzt; denn da du deinen Grimm ausließest, verzehrte er
sie wie Stoppeln. \textsuperscript{d} \bibleverse{8} Durch dein Blasen
taten sich die Wasser empor, und die Fluten standen in Haufen; die Tiefe
wallte voneinander mitten im Meer. \bibleverse{9} Der Feind gedachte:
...
sie verderben. \bibleverse{10} Da ließest du deinen Wind blasen, und das
Meer bedeckte sie, und sie sanken unter wie Blei im mächtigen Wasser.
\bibleverse{11} \textsc{Herr}, wer ist dir gleich unter den Göttern? Wer
ist dir gleich, der so mächtig, heilig, schrecklich, löblich und
wundertätig sei? \bibleverse{12} Da du deine rechte Hand ausrecktest,
verschlang sie die Erde. \bibleverse{13} Du hast geleitet durch deine
Barmherzigkeit dein Volk, das du erlöset hast, und hast sie geführt
durch deine Stärke zu deiner heiligen Wohnung. \bibleverse{14} Da das
die Völker hörten, erbebten sie; Angst kam die Philister an;
\textsuperscript{e} \bibleverse{15} da erschraken die Fürsten Edoms;
...
sprach: Was sollen wir trinken? \bibleverse{25} Er schrie zu dem
...
Recht und versuchte sie \bibleverse{26} und sprach: Wirst du der Stimme
...
\bibleverse{16} Das ist's aber, was der \textsc{Herr} geboten hat: Ein
...
viel, der andere wenig. \bibleverse{18} Aber da man's mit dem Gomer maß,
...
gesammelt, soviel er für sich essen mochte. \footnote{\textbf{16:18}
  2Kor 8,15} \bibleverse{19} Und Mose sprach zu ihnen: Niemand lasse
etwas davon übrig bis morgen. \textsuperscript{b} \bibleverse{20} Aber
...
\bibleverse{24} Und sie ließen's bleiben bis morgen, wie Mose geboten
hatte; da ward's nicht stinkend und war auch kein Wurm darin.
\bibleverse{25} Da sprach Mose: Esset das heute, denn es ist heute der
...
nichts. \bibleverse{28} Da sprach der \textsc{Herr} zu Mose: Wie lange
weigert ihr euch, zu halten meine Gebote und Gesetze? \bibleverse{29}
...
\bibleverse{30} Also feierte das Volk am siebenten Tage.
...
\bibleverse{32} Und Mose sprach: Das ist's, was der \textsc{Herr}
...
da ich euch aus Ägyptenland führte. \bibleverse{33} Und Mose sprach zu
...
\bibleverse{34} Wie der \textsc{Herr} dem Mose geboten hatte, also ließ
es Aaron daselbst vor dem Zeugnis, dass es behalten werde.
\bibleverse{35} Und die Kinder Israel aßen Man 40 Jahre, bis dass sie zu
dem Lande kamen, da sie wohnen sollten; bis an die Grenze des Landes
Kanaan aßen sie Man. \footnote{\textbf{16:35} Jos 5,12} \bibleverse{36}
...
deine Hand, mit dem du den Strom schlugst, und gehe hin. \footnote{\textbf{17:5}
  2Mo 7,20} \bibleverse{6} Siehe, ich will daselbst stehen vor dir auf
...
Israel. \textsuperscript{b} \bibleverse{7} Da hieß man den Ort Massa und
...
\footnote{\textbf{18:1} 2Mo 3,1} \bibleverse{2} nahm er Zippora, Moses
...
sprach: Ich bin ein Gast geworden in fremdem Lande) \footnote{\textbf{18:3}
  2Mo 2,22} \bibleverse{4} und der andere Elieser (denn er sprach: Der
Gott meines Vaters ist meine Hilfe gewesen und hat mich errettet von dem
Schwert Pharaos). \bibleverse{5} Da nun Jethro, Moses Schwiegervater,
und seine Söhne und sein Weib zu ihm kamen in die Wüste, an den Berg
Gottes, da er sich gelagert hatte, \bibleverse{6} ließ er Mose sagen:
...
war, und dass sie der \textsc{Herr} errettet hätte. \bibleverse{9}
...
\bibleverse{10} Und Jethro sprach: Gelobt sei der \textsc{Herr}, der
euch errettet hat von der Ägypter und Pharaos Hand, der weiß sein Volk
von der Ägypter Hand zu erretten. \bibleverse{11} Nun weiß ich, dass der
\textsc{Herr} größer ist denn alle Götter, darum dass sie Hochmut an
ihnen geübt haben. \bibleverse{12} Und Jethro, Moses Schwiegervater,
...
vor allen Völkern; denn die ganze Erde ist mein. \footnote{\textbf{19:5}
  5Mo 7,6} \bibleverse{6} Und ihr sollt mir ein priesterlich Königreich
...
\bibleverse{8} Und alles Volk antwortete zugleich und sprach: Alles, was
...
des Todes sterben. \footnote{\textbf{19:12} 2Mo 34,3} \bibleverse{13}
...
wie ein Rauch vom Ofen, dass der ganze Berg sehr bebte. \bibleverse{19}
Und der Posaune Ton ward immer stärker. Mose redete, und Gott antwortete
ihm laut. \textsuperscript{b} \bibleverse{20} Als nun der \textsc{Herr}
...
\bibleverse{21} Da sprach der \textsc{Herr} zu ihm: Steig hinab und
bezeuge dem Volk, dass sie nicht durchbrechen zum \textsc{Herrn}, ihn zu
sehen, und viele aus ihnen fallen. \bibleverse{22} Dazu die Priester,
...
\textsuperscript{b} \bibleverse{6} und tue Barmherzigkeit an vielen
...
\bibleverse{7} Du sollst den Namen des \textsc{Herrn}, deines Gottes,
...
bestimmen, dahin er fliehen soll. \textsuperscript{b} \bibleverse{14} Wo
...
\textsuperscript{b} \bibleverse{22} Wirst du aber seine Stimme hören und
...
von dir wenden. \textsuperscript{c} \bibleverse{26} Es soll nichts
Unträchtiges noch Unfruchtbares sein in deinem Lande, und ich will dich
lassen alt werden. \bibleverse{27} Ich will meinen Schrecken vor dir her
senden und alles Volk verzagt machen, dahin du kommst, und will dir alle
deine Feinde in die Flucht geben. \bibleverse{28} Ich will Hornissen vor
dir her senden, die vor dir her ausjagen die Heviter, Kanaaniter und
Hethiter. \bibleverse{29} Ich will sie nicht auf ein Jahr ausstoßen vor
dir, auf dass nicht das Land wüst werde und sich wilde Tiere wider dich
mehren; \bibleverse{30} einzeln nacheinander will ich sie vor dir her
ausstoßen, bis du wächsest und das Land besitzest. \bibleverse{31} Und
...
\textsuperscript{d} \bibleverse{32} Du sollst mit ihnen oder mit ihren
Göttern keinen Bund machen; \textsuperscript{e} \bibleverse{33} sondern
...
\bibleverse{4} Da schrieb Mose alle Worte des \textsc{Herrn} und machte
...
Säulen nach den zwölf Stämmen Israels \footnote{\textbf{24:4} 2Mo 34,27;
  1Kö 18,31} \bibleverse{5} und sandte hin Jünglinge aus den Kindern
Israel, dass sie Brandopfer darauf opferten und Dankopfer dem
\textsc{Herrn} von Farren. \textsuperscript{b} \bibleverse{6} Und Mose
nahm die Hälfte des Blutes und tat's in ein Becken, die andere Hälfte
sprengte er auf den Altar. \bibleverse{7} Und nahm das Buch des Bundes
...
\bibleverse{12} Und der \textsc{Herr} sprach zu Mose: Komm herauf zu mir
...
\bibleverse{17} Und das Ansehen der Herrlichkeit des \textsc{Herrn} war
wie ein verzehrendes Feuer auf der Spitze des Berges vor den Kindern
Israel. \textsuperscript{b} \bibleverse{18} Und Mose ging mitten in die
...
Zeugnisses in dem Allerheiligsten. \textsuperscript{b} \bibleverse{35}
...
schütten und ihn salben. \textsuperscript{b} \bibleverse{8} Und seine
...
\bibleverse{11} Und du sollst den Farren schlachten vor dem
...
sollst es auf dem Altar anzünden. \bibleverse{14} Aber des Farren
...
\textsc{Herrn}. \bibleverse{25} Darnach nimm's von ihren Händen und
...
Geruch, ein Feuer dem \textsc{Herrn}. \bibleverse{42} Das ist das
...
reden will. \bibleverse{43} Daselbst will ich mich den Kindern Israel
bezeugen und geheiligt werden in meiner Herrlichkeit. \bibleverse{44} So
will ich die Hütte des Stifts mit dem Altar heiligen und Aaron und seine
Söhne mir zu Priestern weihen. \bibleverse{45} Und will unter den
Kindern Israel wohnen und ihr Gott sein, \bibleverse{46} dass sie wissen
...
\bibleverse{8} Desgleichen, wenn er die Lampen anzündet gegen Abend,
soll er solch Räuchwerk auch räuchern. Das soll das tägliche Räuchopfer
sein vor dem \textsc{Herrn} bei euren Nachkommen. \bibleverse{9} Ihr
sollt kein fremdes Räuchwerk darauf tun, auch kein Brandopfer noch
Speisopfer und kein Trankopfer darauf opfern. \bibleverse{10} Und Aaron
...
\bibleverse{12} Wenn du die Häupter der Kinder Israel zählst, so soll
...
\bibleverse{13} Es soll aber ein jeglicher, der mit in der Zahl ist,
...
sein. \bibleverse{14} Wer in der Zahl ist von 20 Jahren und darüber, der
soll solch Hebopfer dem \textsc{Herrn} geben. \bibleverse{15} Der Reiche
...
ihre Seelen. \bibleverse{16} Und du sollst solch Geld der Versöhnung
...
\bibleverse{26} Und sollst damit salben die Hütte des Stifts und die
Lade des Zeugnisses, \bibleverse{27} den Tisch mit allem seinem Geräte,
den Leuchter mit seinem Geräte, den Räucheraltar, \bibleverse{28} den
Brandopferaltar mit allem seinem Geräte und das Handfass mit seinem Fuß.
\bibleverse{29} Und sollst sie also weihen, dass sie hochheilig seien;
denn wer sie anrühren will, der ist dem Heiligtum verfallen.
\bibleverse{30} Aaron und seine Söhne sollst du auch salben und sie mir
zu Priestern weihen. \textsuperscript{b} \bibleverse{31} Und sollst mit
den Kindern Israel reden und sprechen: Dieses Öl soll mir eine heilige
Salbe sein bei euren Nachkommen. \bibleverse{32} Auf Menschenleib soll's
nicht gegossen werden, sollst auch seinesgleichen nicht machen; denn es
ist heilig, darum soll's euch heilig sein. \bibleverse{33} Wer ein
...
\bibleverse{34} Und der \textsc{Herr} sprach zu Mose: Nimm zu dir
Spezerei; Balsam, Stakte, Galban und reinen Weihrauch, von einem so viel
als vom anderen, \bibleverse{35} und mache Räuchwerk daraus, nach der
Kunst des Salbenbereiters gemengt, dass es rein und heilig sei.
\bibleverse{36} Und du sollst es zu Pulver stoßen und sollst davon tun
...
sondern es soll dir heilig sein dem \textsc{Herrn}. \bibleverse{38} Wer
...
\bibleverse{4} kunstreich zu arbeiten an Gold, Silber, Erz,
\bibleverse{5} kunstreich Steine zu schneiden und einzusetzen, und
kunstreich zu zimmern am Holz, zu machen allerlei Werk. \bibleverse{6}
...
sie machen sollen alles, was ich dir geboten habe: \bibleverse{7} die
Hütte des Stifts, die Lade des Zeugnisses, den Gnadenstuhl darauf und
alle Geräte der Hütte, \bibleverse{8} den Tisch und sein Gerät, den
feinen Leuchter und all sein Gerät, den Räucheraltar, \bibleverse{9} den
Brandopferaltar mit allem seinem Geräte, das Handfass mit seinem Fuß,
\bibleverse{10} die Amtskleider und die heiligen Kleider des Priesters
Aaron und die Kleider seiner Söhne, priesterlich zu dienen,
\bibleverse{11} das Salböl und das Räuchwerk von Spezerei zum Heiligtum.
...
\bibleverse{12} Und der \textsc{Herr} redete mit Mose und sprach:
\bibleverse{13} Sage den Kindern Israel und sprich: Haltet meinen
...
heiligt. \footnote{\textbf{31:13} 2Mo 20,8} \bibleverse{14} Darum so
...
ausgerottet werden von seinem Volk. \textsuperscript{b} \bibleverse{15}
...
soll des Todes sterben. \bibleverse{16} Darum sollen die Kinder Israel
den Sabbat halten, dass sie ihn auch bei ihren Nachkommen halten zum
ewigen Bund. \bibleverse{17} Er ist ein ewiges Zeichen zwischen mir und
...
\bibleverse{18} Und da der \textsc{Herr} ausgeredet hatte mit Mose auf
...
\bibleverse{9} Und der \textsc{Herr} sprach zu Mose: Ich sehe, dass es
ein halsstarriges Volk ist. \bibleverse{10} Und nun lass mich, dass mein
...
\bibleverse{14} Also gereute den \textsc{Herrn} das Übel, das er drohte
seinem Volk zu tun.
...
kommt heimzusuchen. \footnote{\textbf{32:34} 2Mo 33,2; 2Mo 33,12; 2Mo
  33,14} \bibleverse{35} Also strafte der \textsc{Herr} das Volk, dass
...
\bibleverse{3} dich zu bringen in das Land, darin Milch und Honig
...
vor das Lager. \footnote{\textbf{33:7} 2Mo 29,42} \bibleverse{8} Und
...
kam. \bibleverse{9} Und wenn Mose in die Hütte kam, so kam die
Wolkensäule hernieder und stand in der Hütte Tür und redete mit Mose.
\textsuperscript{b} \bibleverse{10} Und alles Volk sah die Wolkensäule
in der Hütte Tür stehen, und standen auf und neigten sich, ein jeglicher
in seiner Hütte Tür. \bibleverse{11} Der \textsc{Herr} aber redete mit
...
\bibleverse{12} Und Mose sprach zu dem \textsc{Herrn}: Siehe, du
...
Namen, und du hast Gnade vor meinen Augen gefunden. \footnote{\textbf{33:12}
  2Mo 33,2-5} \bibleverse{13} Habe ich denn Gnade vor deinen Augen
...
\bibleverse{20} Und sprach weiter: Mein Angesicht kannst du nicht sehen;
denn kein Mensch wird leben, der mich sieht. \textsuperscript{b}
\bibleverse{21} Und der \textsc{Herr} sprach weiter: Siehe, es ist ein
Raum bei mir; da sollst du auf dem Fels stehen. \textsuperscript{c}
\bibleverse{22} Wenn denn nun meine Herrlichkeit vorübergeht, will ich
dich in der Felskluft lassen stehen und meine Hand ob dir halten, bis
ich vorübergehe. \textsuperscript{d} \bibleverse{23} Und wenn ich meine
...
\footnote{\textbf{34:1} 2Mo 32,19} \bibleverse{2} Und sei morgen bereit,
dass du früh auf den Berg Sinai steigest und daselbst zu mir tretest auf
des Berges Spitze. \bibleverse{3} Und lass niemand mit dir
...
\bibleverse{9} und sprach: Habe ich, \textsc{Herr}, Gnade vor deinen
...
\bibleverse{28} Und er war allda bei dem \textsc{Herrn} 40 Tage und 40
...
hatte auf dem Berge Sinai. \bibleverse{33} Und da er solches alles mit
ihnen geredet hatte, legte er eine Decke auf sein Angesicht.
\bibleverse{34} Und wenn er hineinging vor den \textsc{Herrn}, mit ihm
...
\bibleverse{35} so sahen dann die Kinder Israel sein Angesicht an, dass
...
\textsc{Herrn}. Wer an dem arbeitet, soll sterben. \footnote{\textbf{35:2}
  2Mo 20,8-11; 2Mo 31,12-17} \bibleverse{3} Ihr sollt kein Feuer
...
\footnote{\textbf{35:11} 2Mo 31,7-11} \bibleverse{12} die Lade mit ihren
Stangen, den Gnadenstuhl und Vorhang; \bibleverse{13} den Tisch mit
seinen Stangen und allem seinem Geräte und die Schaubrote;
\bibleverse{14} den Leuchter, zu leuchten, und sein Gerät und seine
Lampen und das Öl zum Licht; \bibleverse{15} den Räucheraltar mit seinen
Stangen, die Salbe und Spezerei zum Räuchwerk; das Tuch vor der Wohnung
Tür; \bibleverse{16} den Brandopferaltar mit seinem ehernen Gitter,
Stangen und allem seinem Geräte; das Handfass mit seinem Fuße;
\bibleverse{17} den Umhang des Vorhofs mit seinen Säulen und Füßen und
das Tuch des Tors am Vorhof; \bibleverse{18} die Nägel der Wohnung und
des Vorhofs mit ihren Seilen; \bibleverse{19} die Kleider des Amts zum
...
hatte, \textsuperscript{b} \bibleverse{23} und mit ihm Oholiab, der Sohn
...
\footnote{\textbf{39:30} 2Mo 29,6; 3Mo 8,9} \bibleverse{31} Und banden
...
Mose geboten hatte. \bibleverse{33} Und sie brachten die Wohnung zu
Mose: die Hütte und alle ihre Geräte, Haken, Bretter, Riegel, Säulen,
Füße, \bibleverse{34} die Decke von rötlichen Widderfellen, die Decke
von Dachsfellen und den Vorhang; \bibleverse{35} die Lade des Zeugnisses
mit ihren Stangen, den Gnadenstuhl; \bibleverse{36} den Tisch und alle
seine Geräte und die Schaubrote; \bibleverse{37} den schönen Leuchter
...
\bibleverse{42} Alles, wie der \textsc{Herr} dem Mose geboten hatte,
taten die Kinder Israel an allem diesem Dienst. \bibleverse{43} Und Mose
...
\bibleverse{1} Und der \textsc{Herr} redete mit Mose und sprach:
\footnote{\textbf{40:1} 2Mo 25,1-31} \bibleverse{2} Du sollst die
Wohnung der Hütte des Stifts aufrichten am ersten Tage des ersten
Monats. \bibleverse{3} Und sollst darein setzen die Lade des Zeugnisses
und vor die Lade den Vorhang hängen. \bibleverse{4} Und sollst den Tisch
darbringen und ihn zubereiten und den Leuchter darstellen und die Lampen
daraufsetzen. \bibleverse{5} Und sollst den goldenen Räucheraltar setzen
...
\bibleverse{37} Wenn sich aber die Wolke nicht aufhob, so zogen sie
nicht bis an den Tag, da sie sich aufhob. \bibleverse{38} Denn die Wolke
