...
Leben, und das Leben war das Licht der Menschen. \footnote{\textbf{2:22}
  Hos 6,2} \bibleverse{5} Und das Licht scheint in der Finsternis, und
...
\bibleverse{8} Er war nicht das Licht, sondern dass er zeugte von dem
Licht. \bibleverse{9} Das war das wahrhaftige Licht, welches alle
...
\textsuperscript{b} \bibleverse{18} Niemand hat Gott je gesehen; der
...
\textsuperscript{b} \bibleverse{18} Wer an ihn glaubt, der wird nicht
...
glaubt nicht an den Namen des eingeborenen Sohnes Gottes. \footnote{\textbf{3:29}
  Mt 9,15} \bibleverse{19} Das ist aber das Gericht, dass das Licht in
...
das Licht, auf dass seine Werke nicht gestraft werden. \footnote{\textbf{3:20}
  Eph 5,13} \bibleverse{21} Wer aber die Wahrheit tut, der kommt an das
...
\textsuperscript{b} \bibleverse{29} Wer die Braut hat, der ist der
...
erfüllt. \textsuperscript{c} \bibleverse{30} Er muss wachsen, ich aber
...
Hand gegeben. \textsuperscript{b} \bibleverse{36} Wer an den Sohn
...
\textsuperscript{b} \bibleverse{45} Da er nun nach Galiläa kam, nahmen
...
\bibleverse{47} Und es war ein Königischer, des Sohn lag krank zu
...
war todkrank. \bibleverse{48} Und Jesus sprach zu ihm: Wenn ihr nicht
...
Bethesda und hat fünf Hallen, \textsuperscript{b} \bibleverse{3} in
welchem lagen viele Kranke, Blinde, Lahme, Verdorrte, die warteten, wann
sich das Wasser bewegte. \bibleverse{4} (Denn ein Engel fuhr herab zu
...
welcherlei Seuche er behaftet war. \bibleverse{5} Es war aber ein Mensch
daselbst, achtunddreißig Jahre lang krank gelegen. \bibleverse{6} Da
...
verwundern werdet. \textsuperscript{b} \bibleverse{21} Denn wie der
...
\textsuperscript{c} \bibleverse{27} und hat ihm Macht gegeben, auch das
Gericht zu halten, darum dass er des Menschen Sohn ist.
\textsuperscript{d} \bibleverse{28} Verwundert euch des nicht. Denn es
...
Gestalt gesehen, \footnote{\textbf{6:38} Joh 4,34} \bibleverse{38} und
...
geschrieben. \textsuperscript{b} \bibleverse{47} So ihr aber seinen
...
\textsuperscript{b} \bibleverse{39} Das ist aber der Wille des Vaters,
...
\textsuperscript{c} \bibleverse{40} Denn das ist der Wille des, der mich
...
\bibleverse{48} Ich bin das Brot des Lebens. \textsuperscript{b}
\bibleverse{49} Eure Väter haben Manna gegessen in der Wüste und sind
gestorben. \footnote{\textbf{6:49} 1Kor 10,3-5} \bibleverse{50} Dies ist
das Brot, das vom Himmel kommt, auf dass, wer davon isset, nicht sterbe.
\bibleverse{51} Ich bin das lebendige Brot, vom Himmel gekommen. Wer von
...
Juden Fest, die Laubhütten. \textsuperscript{b} \bibleverse{3} Da
...
\textsuperscript{c} \bibleverse{4} Niemand tut etwas im Verborgenen und
...
den Menschen am Sabbat. \textsuperscript{b} \bibleverse{23} So ein
...
Menschen habe am Sabbat gesund gemacht? \bibleverse{24} Richtet nicht
...
\textsuperscript{b} \bibleverse{39} Das sagte er aber von dem Geist,
...
Soll Christus aus Galiläa kommen? \textsuperscript{b} \bibleverse{42}
...
\textsuperscript{d} \bibleverse{44} Es wollten aber etliche ihn greifen;
...
\textsuperscript{b} \bibleverse{16} So ich aber richte, so ist mein
Gericht recht; denn ich bin nicht allein, sondern ich und der Vater, der
mich gesandt hat. \bibleverse{17} Auch steht in eurem Gesetz
geschrieben, dass zweier Menschen Zeugnis wahr sei. \textsuperscript{c}
\bibleverse{18} Ich bin's, der ich von mir selbst zeuge; und der Vater,
...
da niemand wirken kann. \textsuperscript{b} \bibleverse{5} Dieweil ich
bin in der Welt, bin ich das Licht der Welt. \footnote{\textbf{11:11} Mt
  9,24} \bibleverse{6} Da er solches gesagt, spützte er auf die Erde und
machte einen Kot aus dem Speichel und schmierte den Kot auf des Blinden
Augen \textsuperscript{d} \bibleverse{7} und sprach zu ihm: Gehe hin zu
...
unsinnig; was höret ihr ihm zu? \textsuperscript{b} \bibleverse{21} Die
...
gesagt habe. \textsuperscript{b} \bibleverse{27} Denn meine Schafe hören
meine Stimme, und ich kenne sie; und sie folgen mir, \bibleverse{28} und
ich gebe ihnen das ewige Leben; und sie werden nimmermehr umkommen, und
niemand wird sie mir aus meiner Hand reißen. \bibleverse{29} Der Vater,
der mir sie gegeben hat, ist größer denn alles; und niemand kann sie aus
meines Vaters Hand reißen. \bibleverse{30} Ich und der Vater sind eins.
...
\textsuperscript{b} \bibleverse{11} Solches sagte er, und darnach
...
zusammenbrächte.) \textsuperscript{b} \bibleverse{53} Von dem Tage an
ratschlagten sie, wie sie ihn töteten. \bibleverse{54} Jesus aber
...
\textsuperscript{b} \bibleverse{26} Wer mir dienen will, der folge mir
...
will ich sie alle zu mir ziehen. \textsuperscript{b} \bibleverse{33}
...
\textsuperscript{b} \bibleverse{43} Denn sie hatten lieber die Ehre bei
...
\bibleverse{4} stand er vom Abendmahl auf, legte seine Kleider ab und
nahm einen Schurz und umgürtete sich. \bibleverse{5} Darnach goss er
Wasser in ein Becken, hob an, den Jüngern die Füße zu waschen, und
trocknete sie mit dem Schurz, damit er umgürtet war. \bibleverse{6} Da
...
\bibleverse{16} Wahrlich, wahrlich ich sage euch: Der Knecht ist nicht
größer denn sein Herr, noch der Apostel größer denn der ihn gesandt hat.
\footnote{\textbf{13:16} Mt 10,24} \bibleverse{17} So ihr solches
wisset, selig seid ihr, so ihr's tut. \textsuperscript{d}
\bibleverse{18} Nicht sage ich von euch allen; ich weiß, welche ich
erwählt habe. Aber es muss die Schrift erfüllt werden: „Der mein Brot
isset, der tritt mich mit Füßen.`` \bibleverse{19} Jetzt sage ich's
euch, ehe denn es geschieht, auf dass, wenn es geschehen ist, ihr
glaubet, dass ich es bin. \bibleverse{20} Wahrlich, wahrlich ich sage
...
seid, wo ich bin. \textsuperscript{b} \bibleverse{4} Und wo ich hin
...
\bibleverse{14} Was ihr bitten werdet in meinem Namen, das will ich tun.
\bibleverse{15} Liebet ihr mich, so haltet meine Gebote.
\textsuperscript{c} \bibleverse{16} Und ich will den Vater bitten, und
er soll euch einen anderen Tröster geben, dass er bei euch bleibe
ewiglich: \footnote{\textbf{17:23} 1Kor 6,17} \bibleverse{17} den Geist
...
und wird in euch sein. \textsuperscript{e} \bibleverse{18} Ich will euch
nicht Waisen lassen; ich komme zu euch. \bibleverse{19} Es ist noch um
...
lässt für seine Freunde. \textsuperscript{b} \bibleverse{14} Ihr seid
meine Freunde, wenn ihr tut, was ich euch gebiete. \footnote{\textbf{17:5}
  Joh 1,1; Phil 2,6} \bibleverse{15} Ich sage hinfort nicht, dass ihr
...
meinem Vater gehört, habe ich euch kundgetan. \bibleverse{16} Ihr habt
...
\textsuperscript{c} \bibleverse{22} Wenn ich nicht gekommen wäre und
...
\bibleverse{23} Wer mich hasst, der hasst auch meinen Vater.
\textsuperscript{e} \bibleverse{24} Hätte ich nicht die Werke getan
...
\bibleverse{11} um das Gericht, dass der Fürst dieser Welt gerichtet
...
euch verkündigen. \footnote{\textbf{17:21} Gal 3,28} \bibleverse{14}
...
erkennen. \textsuperscript{b} \bibleverse{4} Ich habe dich verklärt auf
Erden und vollendet das Werk, das du mir gegeben hast, dass ich es tun
sollte. \bibleverse{5} Und nun verkläre mich du, Vater, bei dir selbst
...
erfüllet würde. \textsuperscript{c} \bibleverse{13} Nun aber komme ich
zu dir und rede solches in der Welt, auf dass sie in ihnen haben meine
Freude vollkommen. \textsuperscript{d} \bibleverse{14} Ich habe ihnen
...
\bibleverse{18} Gleichwie du mich gesandt hast in die Welt, so sende ich
sie auch in die Welt. \footnote{\textbf{17:18} Joh 20,21}
\bibleverse{19} Ich heilige mich selbst für sie, auf dass auch sie
...
\bibleverse{22} Und ich habe ihnen gegeben die Herrlichkeit, die du mir
gegeben hast, dass sie eins seien, gleichwie wir eins sind,
\textsuperscript{c} \bibleverse{23} ich in ihnen und du in mir, auf dass
...
\bibleverse{24} Vater, ich will, dass, wo ich bin, auch die bei mir
...
gegründet ward. \textsuperscript{e} \bibleverse{25} Gerechter Vater, die
...
Pfunden. \footnote{\textbf{20:31} 1Jo 5,13} \bibleverse{40} Da nahmen
sie den Leichnam Jesu und banden ihn in leinene Tücher mit den
Spezereien, wie die Juden pflegen zu begraben. \bibleverse{41} Es war
aber an der Stätte, da er gekreuzigt ward, ein Garten, und im Garten ein
neues Grab, in welches niemand je gelegt war. \bibleverse{42} Dahin
