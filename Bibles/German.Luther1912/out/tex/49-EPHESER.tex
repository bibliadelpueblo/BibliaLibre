...
Geliebten, \footnote{\textbf{1:6} Mt 3,17} \bibleverse{7} an welchem wir
...
Reichtum seiner Gnade, \footnote{\textbf{1:7} Kol 1,14; Eph 2,7; Eph
  3,8; Eph 3,16} \bibleverse{8} welche uns reichlich widerfahren ist
durch allerlei Weisheit und Klugheit; \bibleverse{9} und er hat uns
...
er sich vorgesetzt hatte in ihm, \footnote{\textbf{1:9} Eph 3,3-999; Röm
  16,25; Kol 1,26-27} \bibleverse{10} dass es ausgeführt würde, da die
...
Christo, beides, das im Himmel und auf Erden ist, durch ihn, \footnote{\textbf{1:10}
  Gal 4,4} \bibleverse{11} durch welchen wir auch zum Erbteil gekommen
...
\bibleverse{12} auf dass wir etwas seien zu Lob seiner Herrlichkeit, die
wir zuvor auf Christum hofften; \bibleverse{13} durch welchen auch ihr
...
mit dem Heiligen Geist der Verheißung, \bibleverse{14} welcher ist das
Pfand unseres Erbes zu unserer Erlösung, dass wir sein Eigentum würden
zu Lob seiner Herrlichkeit.

\footnote{\textbf{1:14} 2Kor 1,22; 2Kor 5,5}
...
Rechten im Himmel \footnote{\textbf{1:20} Ps 110,1} \bibleverse{21} über
...
\footnote{\textbf{1:21} Phil 2,9; Kol 2,10; Röm 8,38-39} \bibleverse{22}
...
\bibleverse{23} welche da ist sein Leib, nämlich die Fülle des, der
...
\bibleverse{2} in welchen ihr vordem gewandelt habt nach dem Lauf dieser
...
\footnote{\textbf{2:2} Tit 3,3; Eph 6,12; Joh 12,31} \bibleverse{3}
...
anderen; \footnote{\textbf{2:3} Kol 3,6; 1Petr 4,3} \bibleverse{4} Aber
Gott, der da reich ist an Barmherzigkeit, durch seine große Liebe, damit
er uns geliebt hat, \bibleverse{5} da wir tot waren in den Sünden, hat
er uns samt Christo lebendig gemacht (denn aus Gnade seid ihr selig
geworden) \bibleverse{6} und hat uns samt ihm auferweckt und samt ihm in
das himmlische Wesen gesetzt in Christo Jesu, \bibleverse{7} auf dass er
...
Gnade durch seine Güte gegen uns in Christo Jesu. \footnote{\textbf{2:7}
  Eph 1,7} \bibleverse{8} Denn aus Gnade seid ihr selig geworden durch
den Glauben, und das nicht aus euch: Gottes Gabe ist es, \footnote{\textbf{2:8}
  Gal 2,16; Röm 3,23-24} \bibleverse{9} nicht aus den Werken, auf dass
sich nicht jemand rühme. \footnote{\textbf{2:9} Röm 3,28; 1Kor 1,19}
\bibleverse{10} Denn wir sind sein Werk, geschaffen in Christo Jesu zu
...
Hand geschieht, \footnote{\textbf{2:11} Eph 5,8} \bibleverse{12} dass
...
keine Hoffnung hattet und waret ohne Gott in der Welt. \footnote{\textbf{2:12}
  Röm 9,4; 1Thes 4,13} \bibleverse{13} Nun aber seid ihr, die ihr in
...
durch sein Fleisch wegnahm die Feindschaft, \footnote{\textbf{2:14} Jes
  9,5; Gal 3,28} \bibleverse{15} nämlich das Gesetz, das in Geboten
...
\bibleverse{16} und dass er beide versöhnte mit Gott in einem Leibe
durch das Kreuz und hat die Feindschaft getötet durch sich selbst.
\bibleverse{17} Und er ist gekommen, hat verkündigt im Evangelium den
Frieden euch, die ihr ferne waret, und denen, die nahe waren;
\footnote{\textbf{2:17} Jes 57,19} \bibleverse{18} denn durch ihn haben
wir den Zugang alle beide in einem Geiste zum Vater. \footnote{\textbf{2:18}
  Eph 3,12} \bibleverse{19} So seid ihr nun nicht mehr Gäste und
Fremdlinge, sondern Bürger mit den Heiligen und Gottes Hausgenossen,
\footnote{\textbf{2:19} Eph 3,6; Hebr 12,22-23} \bibleverse{20} erbaut
...
euch Heiden, \footnote{\textbf{3:1} Phil 1,7; Phil 1,13} \bibleverse{2}
wie ihr ja gehört habt von dem Amt der Gnade Gottes, die mir an euch
gegeben ist, \footnote{\textbf{3:2} Gal 2,7} \bibleverse{3} dass mir ist
...
\bibleverse{4} daran ihr, so ihr's leset, merken könnt mein Verständnis
des Geheimnisses Christi, \bibleverse{5} welches nicht kundgetan ist in
den vorigen Zeiten den Menschenkindern, wie es nun offenbart ist seinen
heiligen Aposteln und Propheten durch den Geist, \bibleverse{6} nämlich,
...
Verheißung in Christo durch das Evangelium, \footnote{\textbf{3:6} Eph
  2,13; Eph 2,18-19; Apg 15,7-9} \bibleverse{7} dessen Diener ich
geworden bin nach der Gabe aus der Gnade Gottes, die mir nach seiner
mächtigen Kraft gegeben ist; \bibleverse{8} mir, dem allergeringsten
unter allen Heiligen, ist gegeben diese Gnade, unter den Heiden zu
verkündigen den unausforschlichen Reichtum Christi \bibleverse{9} und zu
...
geschaffen hat durch Jesum Christum, \footnote{\textbf{3:9} Eph 1,9-10;
  Röm 16,25-26; Kol 1,16} \bibleverse{10} auf dass jetzt kund würde den
...
\bibleverse{11} nach dem Vorsatz von der Welt her, welche er bewiesen
hat in Christo Jesu, unserem Herrn, \bibleverse{12} durch welchen wir
haben Freudigkeit und Zugang in aller Zuversicht durch den Glauben an
ihn. \footnote{\textbf{3:12} Röm 5,2} \bibleverse{13} Darum bitte ich,
...
durch seinen Geist an dem inwendigen Menschen, \footnote{\textbf{3:16}
  Eph 1,7; Eph 6,10; 2Kor 4,16} \bibleverse{17} dass Christus wohne
...
\bibleverse{3} und seid fleißig, zu halten die Einigkeit im Geist durch
...
\bibleverse{5} ein Herr, ein Glaube, eine Taufe; \footnote{\textbf{4:5}
  1Kor 8,6} \bibleverse{6} ein Gott und Vater unser aller, der da ist
über euch allen und durch euch alle und in euch allen. \footnote{\textbf{4:6}
  1Kor 12,6} \bibleverse{7} Einem jeglichen aber unter uns ist gegeben
die Gnade nach dem Maß der Gabe Christi. \footnote{\textbf{4:7} Röm
  12,3; Röm 12,6; 1Kor 12,11} \bibleverse{8} Darum heißt es: „Er ist
...
\bibleverse{9} dass er aber aufgefahren ist, was ist's, denn dass er
zuvor ist hinuntergefahren in die untersten Örter der Erde? \footnote{\textbf{4:9}
  1Petr 3,18-22} \bibleverse{10} Der hinuntergefahren ist, das ist
...
\footnote{\textbf{4:11} 1Kor 12,28; Apg 21,8} \bibleverse{12} dass die
...
\bibleverse{13} bis dass wir alle hinankommen zu einerlei Glauben und
Erkenntnis des Sohnes Gottes und ein vollkommener Mann werden, der da
sei im Maße des vollkommenen Alters Christi, \bibleverse{14} auf dass
...
womit sie uns erschleichen, uns zu verführen. \footnote{\textbf{4:14}
  1Kor 14,20; Hebr 13,9} \bibleverse{15} Lasset uns aber rechtschaffen
...
\bibleverse{16} von welchem aus der ganze Leib zusammengefügt ist und
...
Sinnes, \footnote{\textbf{4:17} Röm 1,21-24} \bibleverse{18} deren
...
ihres Herzens; \footnote{\textbf{4:18} Eph 2,12} \bibleverse{19} welche
...
im Geist eures Gemüts \footnote{\textbf{4:23} Röm 12,2} \bibleverse{24}
...
\footnote{\textbf{4:25} Sach 8,16} \bibleverse{26} Zürnet, und sündiget
nicht; lasset die Sonne nicht über eurem Zorn untergehen. \footnote{\textbf{4:26}
  Ps 4,5; Jak 1,19; Jak 1,1-20} \bibleverse{27} Gebet auch nicht Raum
dem Lästerer. \bibleverse{28} Wer gestohlen hat der stehle nicht mehr,
...
sei zu hören. \footnote{\textbf{4:29} Eph 5,4; Kol 4,6} \bibleverse{30}
...
seid auf den Tag der Erlösung. \footnote{\textbf{4:30} Eph 1,13-14; Jes
  63,10} \bibleverse{31} Alle Bitterkeit und Grimm und Zorn und Geschrei
und Lästerung sei ferne von euch samt aller Bosheit. \footnote{\textbf{4:31}
  Kol 3,8} \bibleverse{32} Seid aber untereinander freundlich, herzlich
...
\footnote{\textbf{5:1} Lk 6,36} \bibleverse{2} und wandelt in der Liebe,
...
von euch gesagt werden, wie den Heiligen zusteht, \footnote{\textbf{5:3}
  Kol 3,5} \bibleverse{4} auch nicht schandbare Worte und Narrenteidinge
...
Unglaubens. \footnote{\textbf{5:6} Kol 3,6} \bibleverse{7} Darum seid
nicht ihr Mitgenossen. \bibleverse{8} Denn ihr waret vordem Finsternis;
nun aber seid ihr ein Licht in dem Herrn. \bibleverse{9} Wandelt wie die
...
Gerechtigkeit und Wahrheit, \footnote{\textbf{5:9} Mt 5,14; Joh 12,36;
  Gal 5,22; Phil 1,11; 1Thes 5,5} \bibleverse{10} und prüfet, was da sei
...
\footnote{\textbf{5:12} Röm 1,24} \bibleverse{13} Das alles aber wird
...
die Unweisen, sondern als die Weisen, \footnote{\textbf{5:15} Mt 10,16;
  Kol 4,5} \bibleverse{16} und kaufet die Zeit aus; denn es ist böse
Zeit. \bibleverse{17} Darum werdet nicht unverständig, sondern
...
voll Geistes: \footnote{\textbf{5:18} Lk 21,34} \bibleverse{19} redet
...
und spielet dem Herrn in euren Herzen \footnote{\textbf{5:19} Ps 33,2-3;
  Kol 3,16} \bibleverse{20} und saget Dank allezeit für alles Gott und
dem Vater in dem Namen unseres Herrn Jesu Christi,

\footnote{\textbf{5:20} 1Thes 5,18}
...
\footnote{\textbf{5:22} 1Tim 2,11; Tit 2,5; 1Mo 3,16} \bibleverse{23}
...
ist der Gemeinde, und er ist seines Leibes Heiland. \footnote{\textbf{5:23}
  1Kor 11,3; Eph 1,22-23} \bibleverse{24} Aber wie nun die Gemeinde ist
...
\bibleverse{27} auf dass er sie sich selbst darstellte als eine
...
oder des etwas, sondern dass sie heilig sei und unsträflich. \footnote{\textbf{5:27}
  2Kor 11,2; Kol 1,22} \bibleverse{28} Also sollen auch die Männer ihre
Weiber lieben wie ihre eigenen Leiber. Wer sein Weib liebt, der liebt
sich selbst. \bibleverse{29} Denn niemand hat jemals sein eigen Fleisch
...
von seinem Fleisch und von seinem Gebein. \footnote{\textbf{5:30} Eph
  1,23} \bibleverse{31} „Um deswillen wird ein Mensch verlassen Vater
und Mutter und seinem Weibe anhangen, und werden die zwei ein Fleisch
sein.`` \bibleverse{32} Das Geheimnis ist groß; ich sage aber von
Christo und der Gemeinde. \bibleverse{33} Doch auch ihr, ja ein
...
\bibleverse{3} „auf dass dir's wohl gehe und du lange lebest auf
Erden.``
...
Furcht und Zittern, in Einfalt eures Herzens, als Christo; \footnote{\textbf{6:5}
  1Tim 6,1-2; Tit 2,9; Tit 1,2-10; 1Petr 2,18} \bibleverse{6} nicht mit
...
gutem Willen. \bibleverse{7} Lasset euch dünken, dass ihr dem Herrn
dienet und nicht den Menschen, \bibleverse{8} und wisset: Was ein
...
der Macht seiner Stärke. \footnote{\textbf{6:10} Eph 3,16; 1Kor 16,13;
  1Jo 2,14; 2Tim 2,1} \bibleverse{11} Ziehet an den Harnisch Gottes,
...
dem Himmel. \footnote{\textbf{6:12} Lk 22,31; Eph 2,2} \bibleverse{13}
...
möget. \bibleverse{14} So stehet nun, umgürtet an euren Lenden mit
Wahrheit und angezogen mit dem Panzer der Gerechtigkeit \bibleverse{15}
und an den Beinen gestiefelt, als fertig, zu treiben das Evangelium des
Friedens. \bibleverse{16} Vor allen Dingen aber ergreifet den Schild des
Glaubens, mit welchem ihr auslöschen könnt alle feurigen Pfeile des
Bösewichtes; \footnote{\textbf{6:16} 1Petr 5,9; 1Jo 5,4} \bibleverse{17}
...
Geheimnis des Evangeliums, \footnote{\textbf{6:19} Kol 4,3; 2Thes 3,1;
  Apg 4,29} \bibleverse{20} dessen Bote ich bin in der Kette, auf dass
...
und getreuer Diener in dem Herrn, \footnote{\textbf{6:21} Apg 20,4; 2Tim
  4,12; Tit 3,12; Kol 4,7-8} \bibleverse{22} welchen ich gesandt habe zu
