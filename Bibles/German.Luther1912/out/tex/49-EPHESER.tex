...
Reichtum seiner Gnade, \footnote{\textbf{2:2} Tit 3,3; Eph 6,12; Joh
  12,31} \bibleverse{8} welche uns reichlich widerfahren ist durch
allerlei Weisheit und Klugheit; \bibleverse{9} und er hat uns wissen
...
Christo, beides, das im Himmel und auf Erden ist, durch ihn, \footnote{\textbf{3:6}
  Eph 2,13; Eph 2,18-19; Apg 15,7-9} \bibleverse{11} durch welchen wir
...
\footnote{\textbf{1:11} Kol 1,12} \bibleverse{12} auf dass wir etwas
seien zu Lob seiner Herrlichkeit, die wir zuvor auf Christum hofften;
\bibleverse{13} durch welchen auch ihr gehört habt das Wort der
...
Verheißung, \bibleverse{14} welcher ist das Pfand unseres Erbes zu
...
\footnote{\textbf{3:2} Gal 2,7} \bibleverse{22} und hat alle Dinge unter
seine Füße getan und hat ihn gesetzt zum Haupt der Gemeinde über alles,
\textsuperscript{c} \bibleverse{23} welche da ist sein Leib, nämlich die
...
\footnote{\textbf{2:12} Röm 9,4; 1Thes 4,13} \bibleverse{3} unter
...
\textsuperscript{c} \bibleverse{4} Aber Gott, der da reich ist an
Barmherzigkeit, durch seine große Liebe, damit er uns geliebt hat,
\bibleverse{5} da wir tot waren in den Sünden, hat er uns samt Christo
lebendig gemacht (denn aus Gnade seid ihr selig geworden) \bibleverse{6}
und hat uns samt ihm auferweckt und samt ihm in das himmlische Wesen
gesetzt in Christo Jesu, \bibleverse{7} auf dass er erzeigte in den
zukünftigen Zeiten den überschwenglichen Reichtum seiner Gnade durch
seine Güte gegen uns in Christo Jesu. \textsuperscript{d} \bibleverse{8}
Denn aus Gnade seid ihr selig geworden durch den Glauben, und das nicht
aus euch: Gottes Gabe ist es, \textsuperscript{e} \bibleverse{9} nicht
...
\textsuperscript{b} \bibleverse{13} Nun aber seid ihr, die ihr in
...
\bibleverse{15} nämlich das Gesetz, das in Geboten gestellt war, auf
dass er aus zweien einen neuen Menschen in ihm selber schüfe und Frieden
machte, \textsuperscript{d} \bibleverse{16} und dass er beide versöhnte
mit Gott in einem Leibe durch das Kreuz und hat die Feindschaft getötet
durch sich selbst. \bibleverse{17} Und er ist gekommen, hat verkündigt
im Evangelium den Frieden euch, die ihr ferne waret, und denen, die nahe
waren; \textsuperscript{e} \bibleverse{18} denn durch ihn haben wir den
Zugang alle beide in einem Geiste zum Vater. \textsuperscript{f}
\bibleverse{19} So seid ihr nun nicht mehr Gäste und Fremdlinge, sondern
Bürger mit den Heiligen und Gottes Hausgenossen, \textsuperscript{g}
\bibleverse{20} erbaut auf den Grund der Apostel und Propheten, da Jesus
Christus der Eckstein ist, \footnote{\textbf{2:20} Mt 16,18; Jes 28,16;
  1Petr 2,4-6} \bibleverse{21} auf welchem der ganze Bau
ineinandergefügt wächst zu einem heiligen Tempel in dem Herrn,
\bibleverse{22} auf welchem auch ihr mit erbaut werdet zu einer
...
gegeben ist, \textsuperscript{b} \bibleverse{3} dass mir ist kund
geworden dieses Geheimnis durch Offenbarung, wie ich droben aufs
kürzeste geschrieben habe, \textsuperscript{c} \bibleverse{4} daran ihr,
so ihr's leset, merken könnt mein Verständnis des Geheimnisses Christi,
\bibleverse{5} welches nicht kundgetan ist in den vorigen Zeiten den
Menschenkindern, wie es nun offenbart ist seinen heiligen Aposteln und
Propheten durch den Geist, \bibleverse{6} nämlich, dass die Heiden
Miterben seien und mit eingeleibt und Mitgenossen seiner Verheißung in
Christo durch das Evangelium, \textsuperscript{d} \bibleverse{7} dessen
Diener ich geworden bin nach der Gabe aus der Gnade Gottes, die mir nach
seiner mächtigen Kraft gegeben ist; \bibleverse{8} mir, dem
...
\bibleverse{9} und zu erleuchten jedermann, welche da sei die
...
\textsuperscript{e} \bibleverse{10} auf dass jetzt kund würde den
Fürstentümern und Herrschaften in dem Himmel an der Gemeinde die
mannigfaltige Weisheit Gottes, \textsuperscript{f} \bibleverse{11} nach
dem Vorsatz von der Welt her, welche er bewiesen hat in Christo Jesu,
unserem Herrn, \bibleverse{12} durch welchen wir haben Freudigkeit und
Zugang in aller Zuversicht durch den Glauben an ihn. \textsuperscript{g}
\bibleverse{13} Darum bitte ich, dass ihr nicht müde werdet um meiner
...
und gegründet werdet, \textsuperscript{b} \bibleverse{18} auf dass ihr
...
das Band des Friedens: \textsuperscript{b} \bibleverse{4} ein Leib und
ein Geist, wie ihr auch berufen seid auf einerlei Hoffnung eurer
Berufung; \textsuperscript{c} \bibleverse{5} ein Herr, ein Glaube, eine
Taufe; \footnote{\textbf{4:5} 1Kor 8,6} \bibleverse{6} ein Gott und
Vater unser aller, der da ist über euch allen und durch euch alle und in
euch allen. \textsuperscript{e} \bibleverse{7} Einem jeglichen aber
unter uns ist gegeben die Gnade nach dem Maß der Gabe Christi.
\textsuperscript{f} \bibleverse{8} Darum heißt es: „Er ist aufgefahren
in die Höhe und hat das Gefängnis gefangengeführt und hat den Menschen
Gaben gegeben.`` \textsuperscript{g} \bibleverse{9} dass er aber
aufgefahren ist, was ist's, denn dass er zuvor ist hinuntergefahren in
die untersten Örter der Erde? \textsuperscript{h} \bibleverse{10} Der
...
Christi erbaut werde, \footnote{\textbf{4:26} Ps 4,5; Jak 1,19; Jak
  1,1-20} \bibleverse{13} bis dass wir alle hinankommen zu einerlei
...
\bibleverse{14} auf dass wir nicht mehr Kinder seien und uns bewegen und
...
\footnote{\textbf{5:10} Röm 12,1; Phil 1,10} \bibleverse{15} Lasset uns
aber rechtschaffen sein in der Liebe und wachsen in allen Stücken an
dem, der das Haupt ist, Christus, \textsuperscript{d} \bibleverse{16}
...
ihres Herzens; \textsuperscript{b} \bibleverse{19} welche ruchlos sind
und ergeben sich der Unzucht und treiben allerlei Unreinigkeit samt dem
Geiz. \bibleverse{20} Ihr aber habt Christum nicht also gelernt,
\bibleverse{21} so ihr anders von ihm gehört habt und in ihm gelehrt,
wie in Jesu ein rechtschaffenes Wesen ist. \bibleverse{22} So legt nun
von euch ab nach dem vorigen Wandel den alten Menschen, der durch Lüste
im Irrtum sich verderbt. \bibleverse{23} Erneuert euch aber im Geist
eures Gemüts \textsuperscript{c} \bibleverse{24} und ziehet den neuen
...
\textsuperscript{b} \bibleverse{27} Gebet auch nicht Raum dem Lästerer.
...
Dürftigen. \textsuperscript{c} \bibleverse{29} Lasset kein faul
...
\bibleverse{30} Und betrübet nicht den heiligen Geist Gottes, mit dem
ihr versiegelt seid auf den Tag der Erlösung. \footnote{\textbf{4:30}
  Eph 1,13-14; Jes 63,10} \bibleverse{31} Alle Bitterkeit und Grimm und
Zorn und Geschrei und Lästerung sei ferne von euch samt aller Bosheit.
\textsuperscript{f} \bibleverse{32} Seid aber untereinander freundlich,
...
Gerechtigkeit und Wahrheit, \textsuperscript{b} \bibleverse{10} und
...
\textsuperscript{d} \bibleverse{13} Das alles aber wird offenbar, wenn's
vom Licht gestraft wird; denn alles, was offenbar ist, das ist Licht.
\textsuperscript{e} \bibleverse{14} Darum heißt es: „Wache auf, der du
...
voll Geistes: \textsuperscript{b} \bibleverse{19} redet untereinander in
...
\bibleverse{20} und saget Dank allezeit für alles Gott und dem Vater in
...
\textsuperscript{b} \bibleverse{28} Also sollen auch die Männer ihre
...
\bibleverse{31} „Um deswillen wird ein Mensch verlassen Vater und Mutter
und seinem Weibe anhangen, und werden die zwei ein Fleisch sein.``
\bibleverse{32} Das Geheimnis ist groß; ich sage aber von Christo und
der Gemeinde. \bibleverse{33} Doch auch ihr, ja ein jeglicher habe lieb
...
dem Himmel. \textsuperscript{b} \bibleverse{13} Um deswillen ergreifet
den Harnisch Gottes, auf dass ihr an dem bösen Tage Widerstand tun und
alles wohl ausrichten und das Feld behalten möget. \bibleverse{14} So
stehet nun, umgürtet an euren Lenden mit Wahrheit und angezogen mit dem
Panzer der Gerechtigkeit \bibleverse{15} und an den Beinen gestiefelt,
als fertig, zu treiben das Evangelium des Friedens. \bibleverse{16} Vor
allen Dingen aber ergreifet den Schild des Glaubens, mit welchem ihr
auslöschen könnt alle feurigen Pfeile des Bösewichtes;
\textsuperscript{c} \bibleverse{17} und nehmet den Helm des Heils und
das Schwert des Geistes, welches ist das Wort Gottes.
\textsuperscript{d} \bibleverse{18} Und betet stets in allem Anliegen
mit Bitten und Flehen im Geist, und wachet dazu mit allem Anhalten und
Flehen für alle Heiligen \bibleverse{19} und für mich, auf dass mir
...
\bibleverse{20} dessen Bote ich bin in der Kette, auf dass ich darin
