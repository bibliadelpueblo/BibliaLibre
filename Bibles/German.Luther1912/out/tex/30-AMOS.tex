...
\bibleverse{6} So spricht der \textsc{Herr}: Um drei und vier Frevels
willen Gazas will ich ihrer nicht schonen, darum dass sie die Gefangenen
alle weggeführt und an Edom überantwortet haben; \bibleverse{7} sondern
ich will ein Feuer in die Mauern zu Gaza schicken, das soll ihre Paläste
verzehren. \bibleverse{8} Und ich will die Einwohner aus Asdod und den,
...
\bibleverse{4} So spricht der \textsc{Herr}: Um drei und vier Frevel
...
\bibleverse{10} Sie achten keines Rechts, spricht der \textsc{Herr},
...
Morgens und eure Zehnten des dritten Tages, \bibleverse{5} und räuchert
...
ihr euch nicht zu mir, spricht der \textsc{Herr}. \bibleverse{7} Auch
...
nicht beregnet ward, verdorrte. \bibleverse{8} Und es zogen zwei, drei
...
Suchet mich, so werdet ihr leben. \bibleverse{5} Suchet nicht Beth-El
...
niemand löschen könne zu Beth-El; \bibleverse{7} die ihr das Recht in
...
\textsc{Herr}; \bibleverse{9} der über den Starken eine Verstörung
anrichtet und bringt eine Verstörung über die feste Stadt.
\bibleverse{10} Aber sie sind dem gram, der sie im Tor straft, und
halten den für einen Gräuel, der heilsam lehrt. \bibleverse{11} Darum,
...
Weinbergen gepflanzt habt. \bibleverse{12} Denn ich weiß euer
...
\bibleverse{13} Darum muss der Kluge zur selben Zeit schweigen; denn es
ist eine böse Zeit.
...
ihr rühmet. \bibleverse{15} Hasset das Böse und liebet das Gute;
...
\bibleverse{18} Weh denen, die des \textsc{Herrn} Tag begehren! Was soll
er euch? Denn des \textsc{Herrn} Tag ist Finsternis und nicht Licht.
\bibleverse{19} Gleich als wenn jemand vor dem Löwen flöhe, und ein Bär
begegnete ihm; und er käme in ein Haus und lehnte sich mit der Hand an
die Wand, und eine Schlange stäche ihn. \bibleverse{20} Denn des
...
mag ich auch eure feisten Dankopfer nicht ansehen. \bibleverse{23} Tue
nur weg von mir das Geplärr deiner Lieder; denn ich mag dein
Psalterspiel nicht hören! \bibleverse{24} Es soll aber das Recht
...
im Lande verderbt \bibleverse{5} und sprecht: „Wann will denn der
...
steigern und die Waage fälschen, \bibleverse{6} auf dass wir die Armen
um Geld und die Dürftigen um ein Paar Schuhe unter uns bringen und Spreu
für Korn verkaufen?{}`` \bibleverse{7} Der \textsc{Herr} hat geschworen
wider die Hoffart Jakobs: Was gilt's, ob ich solcher ihrer Werke ewig
vergessen werde? \bibleverse{8} Sollte nicht um solches willen das Land
...
\bibleverse{9} Zur selben Zeit, spricht der Herr \textsc{Herr}, will ich
die Sonne am Mittag untergehen lassen und das Land am hellen Tage lassen
finster werden. \bibleverse{10} Ich will eure Feiertage in Trauern und
...
\bibleverse{11} Siehe, es kommt die Zeit, spricht der Herr
...
\bibleverse{5} Denn der Herr \textsc{Herr} Zebaoth ist ein solcher: Wenn
...
überschwemmt werden wie mit dem Fluss Ägyptens. \bibleverse{6} Er ist's,
...
\bibleverse{8} Siehe, die Augen des Herrn \textsc{Herrn} sehen auf das
...
\bibleverse{9} Denn siehe, ich will befehlen und das Haus Israel unter
allen Heiden sichten lassen, gleichwie man mit einem Sieb sichtet, und
kein Körnlein soll auf die Erde fallen. \bibleverse{10} Alle Sünder in
meinem Volk sollen durchs Schwert sterben, die da sagen: Es wird das
Unglück nicht so nahe sein noch uns begegnen. \bibleverse{11} Zur selben
...
sie bauen wie sie vorzeiten gewesen ist, \bibleverse{12} auf dass sie
...
\bibleverse{13} Siehe, es kommt die Zeit, spricht der \textsc{Herr},
...
fruchtbar sein. \bibleverse{14} Denn ich will das Gefängnis meines
