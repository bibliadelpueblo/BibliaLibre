...
\bibleverse{1} Dies ist's, was Amos, der unter den Hirten zu Thekoa war,
...
\bibleverse{2} Und er sprach: Der HErr wird aus Zion brüllen und seine
...
\bibleverse{3} So spricht der HErr: Um drei und vier Frevel willen der
...
\bibleverse{4} sondern ich will ein Feuer schicken in das Haus Hasaels,
das soll die Paläste Benhadads verzehren. \bibleverse{5} Und ich will
...
\bibleverse{6} So spricht der HErr: Um drei und vier Frevels willen
...
weggeführt und an Edom überantwortet haben; \footnote{\textbf{1:6} 2Chr
  28,17-18; Jer 47,1} \bibleverse{7} sondern ich will ein Feuer in die
Mauern zu Gaza schicken, das soll ihre Paläste verzehren. \bibleverse{8}
...
\bibleverse{9} So spricht der HErr: Um drei und vier Frevel willen der
...
\bibleverse{10} sondern ich will ein Feuer in die Mauern zu Tyrus
...
\bibleverse{11} So spricht der HErr: Um drei und vier Frevel willen
...
wütet in seinem Zorn und seinen Grimm ewig hält; \bibleverse{12} sondern
...
\bibleverse{13} So spricht der HErr: Um drei und vier Frevel willen der
...
machten; \footnote{\textbf{1:13} Jer 49,1-6} \bibleverse{14} sondern ich
...
kommen wird zur Zeit des Sturms. \bibleverse{15} Da wird dann ihr König
...
\bibleverse{1} So spricht der HErr: Um drei und vier Frevel willen Moabs
will ich ihrer nicht schonen, darum dass sie die Gebeine des Königs zu
Edom haben zu Asche verbrannt; \bibleverse{2} sondern ich will ein Feuer
schicken nach Moab, das soll die Paläste zu Karioth verzehren; und Moab
soll sterben im Getümmel und Geschrei und Posaunenhall. \bibleverse{3}
...
\bibleverse{4} So spricht der HErr: Um drei und vier Frevel willen Judas
...
welchen ihre Väter nachgefolgt sind; \bibleverse{5} sondern ich will ein
...
\bibleverse{6} So spricht der HErr: Um drei und vier Frevel willen
Israels will ich ihrer nicht schonen, darum dass sie die Gerechten um
Geld und die Armen um ein Paar Schuhe verkaufen. \bibleverse{7} Sie
...
entheiligen. \footnote{\textbf{2:7} Am 8,4} \bibleverse{8} Und bei allen
...
\bibleverse{9} Und ich habe doch den Amoriter vor ihnen her vertilgt,
...
vertilgte oben seine Frucht und unten seine Wurzel. \footnote{\textbf{2:9}
  4Mo 21,21-28} \bibleverse{10} Auch habe ich euch aus Ägyptenland
geführt und vierzig Jahre in der Wüste geleitet, dass ihr der Amoriter
Land besäßet. \bibleverse{11} Und habe aus euren Kindern Propheten
auferweckt und Gottgeweihte aus euren Jünglingen. Ist's nicht also, ihr
Kinder Israel? spricht der HErr. \bibleverse{12} So gebt ihr den
...
sollt nicht weissagen! \footnote{\textbf{2:12} Am 7,13; Am 1,7-16; Jer
  11,21} \bibleverse{13} Siehe, ich will's unter euch knarren machen,
wie ein Wagen voll Garben knarrt, \bibleverse{14} dass der, der schnell
ist, soll nicht entfliehen noch der Starke etwas vermögen und der
Mächtige nicht soll sein Leben erretten können; \bibleverse{15} und die
...
\bibleverse{16} und der unter den Starken der mannhafteste ist, soll
...
\bibleverse{1} Höret, was der HErr mit euch redet, ihr Kinder Israel,
mit allen Geschlechtern, die ich aus Ägyptenland geführt habe:
\bibleverse{2} Aus allen Geschlechtern auf Erden habe ich allein euch
...
\bibleverse{3} Mögen auch zwei miteinander wandeln, sie seien denn eins
untereinander? \bibleverse{4} Brüllt auch ein Löwe im Walde, wenn er
keinen Raub hat? Schreit auch ein junger Löwe aus seiner Höhle, er habe
denn etwas gefangen? \bibleverse{5} Fällt auch ein Vogel in den Strick
auf der Erde, da kein Vogler ist? Hebt man auch den Strick auf von der
Erde, der noch nichts gefangen hat? \bibleverse{6} Bläst man auch die
...
auch ein Unglück in der Stadt, dass der HErr nicht tue? \footnote{\textbf{3:6}
  Jes 45,7; Kla 3,37} \bibleverse{7} Denn der Herr HErr tut nichts, er
offenbare denn sein Geheimnis den Propheten, seinen Knechten.
\bibleverse{8} Der Löwe brüllt; wer sollte sich nicht fürchten? Der Herr
...
\bibleverse{9} Verkündigt in den Palästen zu Asdod und in den Palästen
...
\bibleverse{10} Sie achten keines Rechts, spricht der HErr, sammeln
Schätze von Frevel und Raub in ihren Palästen.

\bibleverse{11} Darum spricht der Herr HErr also: Man wird dieses Land
ringsumher bedrängen und dich von deiner Macht herunterreißen und deine
Häuser plündern.

\bibleverse{12} So spricht der HErr: Gleichwie ein Hirte dem Löwen zwei
...
\bibleverse{13} Höret und zeuget im Hause Jakob, spricht der Herr HErr,
der Gott Zebaoth. \bibleverse{14} Denn zu der Zeit, wenn ich die Sünden
...
\bibleverse{15} und will beide, Winterhaus und Sommerhaus, schlagen, und
...
\bibleverse{1} Höret dieses Wort, ihr fetten Kühe, die ihr auf dem Berge
Samarias seid und den Dürftigen Unrecht tut und untertretet die Armen
und sprecht zu euren Herren: Bringe her, lass uns saufen! \bibleverse{2}
...
Nachkommen mit Fischhaken. \bibleverse{3} Und ihr werdet zu den Lücken
...
\bibleverse{4} Ja, kommt her gen Beth-El und treibt Sünde, und gen
...
Morgens und eure Zehnten des dritten Tages, \footnote{\textbf{4:4} 5Mo
  14,28} \bibleverse{5} und räuchert vom Sauerteig zum Dankopfer und
...
\bibleverse{6} Darum habe ich euch auch in allen euren Städten müßige
Zähne gegeben und Mangel am Brot an allen euren Orten; doch bekehrtet
ihr euch nicht zu mir, spricht der HErr. \bibleverse{7} Auch habe ich
...
\bibleverse{8} Und es zogen zwei, drei Städte zu einer Stadt, dass sie
Wasser trinken möchten, und konnten nicht genug finden; doch bekehrtet
ihr euch nicht zu mir, spricht der HErr.

\bibleverse{9} Ich plagte euch mit dürrer Zeit und mit Brandkorn; so
...
\bibleverse{10} Ich schickte Pestilenz unter euch gleicherweise wie in
...
\bibleverse{11} Ich kehrte unter euch um, wie Gott Sodom und Gomorra
...
\bibleverse{12} Darum will ich dir weiter also tun, Israel. Weil ich
denn dir also tun will, so schicke dich, Israel, und begegne deinem
Gott. \bibleverse{13} Denn siehe, er ist's, der die Berge macht, den
...
\bibleverse{1} Höret, ihr vom Hause Israel, dieses Wort! denn ich muss
dies Klagelied über euch machen: \bibleverse{2} Die Jungfrau Israel ist
gefallen, dass sie nicht wieder aufstehen wird; sie ist zu Boden
gestoßen, und ist niemand, der ihr aufhelfe.

\bibleverse{3} Denn so spricht der Herr HErr: Die Stadt, da tausend
...
\bibleverse{4} Darum so spricht der HErr zum Hause Israel: Suchet mich,
so werdet ihr leben. \bibleverse{5} Suchet nicht Beth-El und kommet
...
\footnote{\textbf{5:5} Am 4,4; Hos 4,15} \bibleverse{6} Suchet den
...
Beth-El; \bibleverse{7} die ihr das Recht in Wermut verkehrt und die
...
\bibleverse{8} Er macht die Plejaden und den Orion; der aus der
...
\footnote{\textbf{5:8} Hi 38,31; Am 9,6} \bibleverse{9} der über den
Starken eine Verstörung anrichtet und bringt eine Verstörung über die
feste Stadt. \bibleverse{10} Aber sie sind dem gram, der sie im Tor
straft, und halten den für einen Gräuel, der heilsam lehrt.
\bibleverse{11} Darum, weil ihr die Armen unterdrückt und nehmt das Korn
...
in den feinen Weinbergen gepflanzt habt. \footnote{\textbf{5:11} Zeph
  1,13} \bibleverse{12} Denn ich weiß euer Übertreten, des viel ist, und
eure Sünden, die stark sind, wie ihr die Gerechten drängt und Blutgeld
nehmt und die Armen im Tor unterdrückt. \bibleverse{13} Darum muss der
Kluge zur selben Zeit schweigen; denn es ist eine böse Zeit.

\bibleverse{14} Suchet das Gute und nicht das Böse, auf dass ihr leben
möget, so wird der HErr, der Gott Zebaoth, bei euch sein, wie ihr
rühmet. \bibleverse{15} Hasset das Böse und liebet das Gute; bestellet
...
\bibleverse{16} Darum, so spricht der HErr, der Gott Zebaoth, der Herr:
...
zum Wehklagen, wer da weinen kann. \bibleverse{17} In allen Weinbergen
...
\bibleverse{18} Weh denen, die des HErrn Tag begehren! Was soll er euch?
Denn des HErrn Tag ist Finsternis und nicht Licht. \footnote{\textbf{5:18}
  Joe 2,11} \bibleverse{19} Gleich als wenn jemand vor dem Löwen flöhe,
und ein Bär begegnete ihm; und er käme in ein Haus und lehnte sich mit
der Hand an die Wand, und eine Schlange stäche ihn. \bibleverse{20} Denn
...
\bibleverse{21} Ich bin euren Feiertagen gram und verachte sie und mag
eure Versammlungen nicht riechen. \bibleverse{22} Und ob ihr mir gleich
...
mag ich auch eure feisten Dankopfer nicht ansehen. \footnote{\textbf{5:22}
  Mi 6,6-7} \bibleverse{23} Tue nur weg von mir das Geplärr deiner
Lieder; denn ich mag dein Psalterspiel nicht hören! \bibleverse{24} Es
soll aber das Recht offenbart werden wie Wasser und die Gerechtigkeit
wie ein starker Strom.

\bibleverse{25} Habt ihr vom Hause Israel mir in der Wüste die vierzig
Jahre lang Schlachtopfer und Speisopfer geopfert? \bibleverse{26} Ihr
truget den Sikkuth, euren König, und Chiun, euer Bild, den Stern eurer
Götter, welche ihr euch selbst gemacht hattet. \bibleverse{27} So will
...
\bibleverse{1} Weh den Stolzen zu Zion und denen, die sich auf den Berg
Samarias verlassen, den Vornehmsten des Erstlings unter den Völkern, und
zu denen das Haus Israel kommt! \bibleverse{2} Gehet hin gen Kalne und
...
und ihre Grenze weiter denn eure Grenze. \bibleverse{3} Die ihr euch
weit vom bösen Tag achtet und trachtet immer nach Frevelregiment,
\footnote{\textbf{6:3} Ps 10,5} \bibleverse{4} und schlaft auf
...
Lämmer aus der Herde und die gemästeten Kälber, \footnote{\textbf{6:4}
  Am 3,15} \bibleverse{5} und spielet auf dem Psalter und erdichtet euch
Lieder wie David, \footnote{\textbf{6:5} Jes 5,12} \bibleverse{6} und
trinket Wein aus den Schalen und salbet euch mit Balsam und bekümmert
euch nicht um den Schaden Josephs. \bibleverse{7} Darum sollen sie nun
...
\bibleverse{8} Denn der Herr HErr hat geschworen bei seiner Seele,
...
allem, was darin ist. \bibleverse{9} Und wenngleich zehn Männer in einem
Hause übrigbleiben, sollen sie doch sterben,

\bibleverse{10} dass einen jeglichen sein Vetter und der ihn verbrennen
...
denn man darf des Namens des HErrn nicht gedenken. \bibleverse{11} Denn
...
gewinnen. \bibleverse{12} Wer kann mit Rossen rennen oder mit Ochsen
...
\bibleverse{13} und tröstet euch des, das so gar nichts ist, und
sprecht: Sind wir denn nicht stark genug mit unseren Hörnern?
\bibleverse{14} Darum siehe, ich will über euch vom Hause Israel ein
...
\bibleverse{1} Der Herr HErr zeigte mir ein Gesicht, und siehe, da stand
...
\bibleverse{2} Als sie nun das Kraut im Lande gar abgefressen hatten,
sprach ich: Ach Herr HErr, sei gnädig! Wer will Jakob wieder aufhelfen?
denn er ist ja gering.

\bibleverse{3} Da reute es den HErrn, und er sprach: Wohlan, es soll
nicht geschehen.

\bibleverse{4} Der Herr HErr zeigte mir ein Gesicht, und siehe, der Herr
HErr rief dem Feuer, damit zu strafen; das verzehrte die große Tiefe und
fraß das Ackerland. \bibleverse{5} Da sprach ich: Ach Herr HErr, lass
ab! Wer will Jakob wieder aufhelfen? denn er ist ja gering.

\bibleverse{6} Da reute den HErrn das auch, und der Herr HErr sprach: Es
...
\bibleverse{7} Er zeigte mir abermals ein Gesicht, und siehe, der HErr
stand auf einer Mauer, mit einer Bleischnur gemessen; und er hatte die
Bleischnur in seiner Hand. \bibleverse{8} Und der HErr sprach zu mir:
...
\bibleverse{9} sondern die Höhen Isaaks sollen verwüstet und die
...
\bibleverse{10} Da sandte Amazja, der Priester zu Beth-El, zu Jerobeam,
...
\footnote{\textbf{7:10} Jer 38,4} \bibleverse{11} Denn so spricht Amos:
Jerobeam wird durchs Schwert sterben, und Israel wird aus seinem Lande
gefangen weggeführt werden.

\bibleverse{12} Und Amazja sprach zu Amos: Du Schauer, gehe weg und
flieh ins Land Juda und iss Brot daselbst und weissage daselbst.
\bibleverse{13} Und weissage nicht mehr zu Beth-El; denn es ist des
Königs Heiligtum und des Königreichs Haus.

\bibleverse{14} Amos antwortete und sprach zu Amazja: Ich bin kein
Prophet, auch keines Propheten Sohn, sondern ich bin ein Hirt, der
Maulbeeren abliest; \footnote{\textbf{7:14} Am 1,1} \bibleverse{15} aber
der HErr nahm mich von der Herde und sprach zu mir: Gehe hin und
weissage meinem Volk Israel! \bibleverse{16} So höre nun des HErrn Wort.
Du sprichst: Weissage nicht wider Israel und predige nicht wider das
Haus Isaak! \bibleverse{17} Darum spricht der HErr also: Dein Weib wird
...
\bibleverse{2} Und er sprach: Was siehest du, Amos? Ich aber antwortete:
...
\bibleverse{3} Und die Lieder in dem Palaste sollen in ein Heulen
...
\bibleverse{4} Höret dies, die ihr den Armen unterdrückt und die Elenden
im Lande verderbt \footnote{\textbf{8:4} Am 2,7} \bibleverse{5} und
...
verringern und den Preis steigern und die Waage fälschen, \footnote{\textbf{8:5}
  Neh 10,32; Neh 13,15} \bibleverse{6} auf dass wir die Armen um Geld
und die Dürftigen um ein Paar Schuhe unter uns bringen und Spreu für
Korn verkaufen?{}`` \footnote{\textbf{8:6} Am 2,6} \bibleverse{7} Der
HErr hat geschworen wider die Hoffart Jakobs: Was gilt's, ob ich solcher
ihrer Werke ewig vergessen werde? \bibleverse{8} Sollte nicht um solches
...
\bibleverse{9} Zur selben Zeit, spricht der Herr HErr, will ich die
Sonne am Mittag untergehen lassen und das Land am hellen Tage lassen
finster werden. \footnote{\textbf{8:9} Jer 15,9} \bibleverse{10} Ich
...
\bibleverse{11} Siehe, es kommt die Zeit, spricht der Herr HErr, dass
...
\bibleverse{12} dass sie hin und her von einem Meer zum anderen, von
Mitternacht gegen Morgen umlaufen und des HErrn Wort suchen, und doch
nicht finden werden. \footnote{\textbf{8:12} Mi 3,7} \bibleverse{13} Zu
der Zeit werden die schönen Jungfrauen und die Jünglinge verschmachten
vor Durst, \bibleverse{14} die jetzt schwören bei dem Fluch Samarias und
...
\bibleverse{1} Ich sah den Herrn auf dem Altar stehen, und er sprach:
...
\bibleverse{2} Und wenn sie sich gleich in die Hölle vergrüben, soll sie
doch meine Hand von dort holen; und wenn sie gen Himmel führen, will ich
sie doch herunterstoßen; \bibleverse{3} und wenn sie sich gleich
...
stechen sollen; \bibleverse{4} und wenn sie vor ihren Feinden hin
...
\bibleverse{5} Denn der Herr HErr Zebaoth ist ein solcher: Wenn er ein
...
überschwemmt werden wie mit dem Fluss Ägyptens. \footnote{\textbf{9:5}
  Am 8,8} \bibleverse{6} Er ist's, der seinen Saal in den Himmel baut
...
\bibleverse{8} Siehe, die Augen des Herrn HErrn sehen auf das sündige
Königreich, dass ich's vom Erdboden vertilge; wiewohl ich das Haus Jakob
nicht ganz und gar vertilgen will, spricht der HErr. \bibleverse{9} Denn
...
die Erde fallen. \bibleverse{10} Alle Sünder in meinem Volk sollen
durchs Schwert sterben, die da sagen: Es wird das Unglück nicht so nahe
sein noch uns begegnen. \footnote{\textbf{9:10} Am 6,3} \bibleverse{11}
...
und will sie bauen wie sie vorzeiten gewesen ist, \bibleverse{12} auf
...
\bibleverse{13} Siehe, es kommt die Zeit, spricht der HErr, dass man
...
sein. \bibleverse{14} Denn ich will das Gefängnis meines Volkes Israel
...
\^{}\^{} \bibleverse{15} Denn ich will sie in ihr Land pflanzen, dass
