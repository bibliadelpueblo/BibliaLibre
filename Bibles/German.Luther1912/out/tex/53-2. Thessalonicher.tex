...
\footnote{\textbf{1:1} 1Thes 1,1} \bibleverse{2} Gnade sei mit euch und
...
\footnote{\textbf{1:4} 2Kor 7,4} \bibleverse{5} welches anzeigt, dass
...
\bibleverse{6} nach dem es recht ist bei Gott, zu vergelten Trübsal
denen, die euch Trübsal antun, \footnote{\textbf{1:6} Röm 12,19; Offb
  18,6-7} \bibleverse{7} euch aber, die ihr Trübsal leidet, Ruhe mit
uns, wenn nun der Herr Jesus wird offenbart werden vom Himmel samt den
Engeln seiner Kraft \textsuperscript{d} \bibleverse{8} und mit
...
\footnote{\textbf{1:8} Röm 2,8} \bibleverse{9} welche werden Pein
...
\bibleverse{3} Lasset euch niemand verführen in keinerlei Weise; denn er
...
\bibleverse{4} der da ist der Widersacher und sich überhebt über alles,
...
\textsuperscript{d} \bibleverse{10} und mit allerlei Verführung zur
...
\bibleverse{11} Darum wird ihnen Gott kräftige Irrtümer senden, dass sie
glauben der Lüge, \bibleverse{12} auf dass gerichtet werden alle, die
...
der Heiligung des Geistes und im Glauben der Wahrheit, \footnote{\textbf{2:13}
  Röm 8,30} \bibleverse{14} darein er euch berufen hat durch unser
Evangelium zum herrlichen Eigentum unseres Herrn Jesu Christi.
\bibleverse{15} So stehet nun, liebe Brüder, und haltet an den
...
Herrn laufe und gepriesen werde wie bei euch, \footnote{\textbf{3:1} Kol
  4,3; Eph 6,18-19; 1Thes 5,25} \bibleverse{2} und dass wir erlöst
werden von den unverständigen und argen Menschen. Denn der Glaube ist
nicht jedermanns Ding. \bibleverse{3} Aber der Herr ist treu; der wird
euch stärken und bewahren vor dem Argen. \bibleverse{4} Wir versehen uns
aber zu euch in dem Herrn, dass ihr tut und tun werdet, was wir euch
gebieten. \textsuperscript{b} \bibleverse{5} Der Herr aber richte eure
...
\footnote{\textbf{3:7} 1Thes 1,6} \bibleverse{8} haben auch nicht
...
beschwerlich wären. \textsuperscript{b} \bibleverse{9} Nicht darum, dass
wir des nicht Macht haben, sondern dass wir uns selbst zum Vorbilde euch
gäben, uns nachzufolgen. \textsuperscript{c} \bibleverse{10} Und da wir
...
arbeiten, der soll auch nicht essen. \footnote{\textbf{3:10} 1Mo 3,19;
  2Mo 20,9} \bibleverse{11} Denn wir hören, dass etliche unter euch
...
zu tun. \footnote{\textbf{3:13} Gal 6,9} \bibleverse{14} So aber jemand
...
\bibleverse{15} doch haltet ihn nicht als einen Feind, sondern vermahnet
...
\bibleverse{18} Die Gnade unseres Herrn Jesus Christus sei mit euch
allen! Amen.
