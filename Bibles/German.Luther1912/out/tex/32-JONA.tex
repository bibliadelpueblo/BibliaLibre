...
\bibleverse{1} Es geschah das Wort des HErrn zu Jona, dem Sohn
...
\bibleverse{3} Aber Jona machte sich auf und floh vor dem HErrn und
...
\bibleverse{4} Da ließ der HErr einen großen Wind aufs Meer kommen, und
es erhob sich ein großes Ungewitter auf dem Meer, dass man meinte, das
Schiff würde zerbrechen. \bibleverse{5} Und die Schiffsleute fürchteten
...
hinunter in das Schiff gestiegen, lag und schlief. \bibleverse{6} Da
...
HErrn floh; denn er hatte es ihnen gesagt. \bibleverse{11} Da sprachen
...
\bibleverse{14} Da riefen sie zu dem HErrn und sprachen: Ach HErr, lass
...
\bibleverse{15} Und sie nahmen Jona und warfen ihn ins Meer; das stand
das Meer still von seinem Wüten. \bibleverse{16} Und die Leute
...
\bibleverse{1} Aber der HErr verschaffte einen großen Fisch, Jona zu
verschlingen. Und Jona war im Leibe des Fisches drei Tage und drei
Nächte. \footnote{\textbf{2:1} Mt 12,40; Mt 16,4}

\bibleverse{2} Und Jona betete zu dem HErrn, seinem Gott, im Leibe des
Fisches. \bibleverse{3} Und sprach: Ich rief zu dem HErrn in meiner
Angst, und er antwortete mir; ich schrie aus dem Bauche der Hölle, und
du hörtest meine Stimme. \bibleverse{4} Du warfest mich in die Tiefe
mitten im Meer, dass die Fluten mich umgaben; alle deine Wogen und
Wellen gingen über mich, \footnote{\textbf{2:4} Ps 42,8} \bibleverse{5}
...
\bibleverse{6} Wasser umgaben mich bis an mein Leben, die Tiefe umringte
mich; Schilf bedeckte mein Haupt. \footnote{\textbf{2:6} Ps 18,5; Ps
  69,2} \bibleverse{7} Ich sank hinunter zu der Berge Gründen, die Erde
...
\bibleverse{8} Da meine Seele bei mir verzagte, gedachte ich an den
HErrn; und mein Gebet kam zu dir in deinen heiligen Tempel. \footnote{\textbf{2:8}
  Ps 142,4} \bibleverse{9} Die da halten an dem Nichtigen, verlassen
...
bezahlen; denn die Hilfe ist des HErrn. \footnote{\textbf{2:10} Ps
  50,14; Ps 116,17-18} \bibleverse{11} Und der HErr sprach zum Fisch,
...
\bibleverse{1} Und es geschah das Wort des HErrn zum andernmal zu Jona
und sprach: \bibleverse{2} Mache dich auf, gehe in die große Stadt
...
Tagereisen groß. \footnote{\textbf{3:3} Jon 4,11} \bibleverse{4} Und da
...
\bibleverse{2} und betete zum HErrn und sprach: Ach HErr, das ist's, was
...
reuen. \footnote{\textbf{4:2} 2Mo 34,6} \bibleverse{3} So nimm doch nun,
...
würde. \bibleverse{6} Gott der HErr aber verschaffte einen Rizinus, der
...
\bibleverse{7} Aber Gott verschaffte einen Wurm des Morgens, da die
...
\bibleverse{10} Und der HErr sprach: Dich jammert des Rizinus, daran du
nicht gearbeitet hast, hast ihn auch nicht aufgezogen, welcher in einer
Nacht ward und in einer Nacht verdarb; \bibleverse{11} und mich sollte
