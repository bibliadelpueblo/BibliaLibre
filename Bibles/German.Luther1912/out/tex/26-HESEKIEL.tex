...
\bibleverse{3} Da geschah des \textsc{Herrn} Wort zu Hesekiel, dem Sohn
...
umher glänzte; und mitten in dem Feuer war es lichthell. \bibleverse{5}
Und darin war es gestaltet wie vier Tiere, und dieselben waren anzusehen
wie Menschen. \bibleverse{6} Und ein jegliches hatte vier Angesichter
und vier Flügel. \bibleverse{7} Und ihre Beine standen gerade, und ihre
Füße waren gleich wie Rinderfüße und glänzten wie helles glattes Erz.
\bibleverse{8} Und sie hatten Menschenhände unter ihren Flügeln an ihren
vier Seiten; denn sie hatten alle vier ihre Angesichter und ihre Flügel.
\bibleverse{9} Und je einer der Flügel rührte an den anderen; und wenn
...
denn es war der Geist der Tiere in den Rädern. \bibleverse{21} Wenn sie
...
gestaltet. \bibleverse{27} Und ich sah, und es war lichthell, und
...
\bibleverse{28} Gleichwie der Regenbogen sieht in den Wolken, wenn es
...
sagen: So spricht der Herr \textsc{Herr}! \bibleverse{5} Sie gehorchen
oder lassen's. Es ist wohl ein ungehorsames Haus; dennoch sollen sie
wissen, dass ein Prophet unter ihnen ist. \bibleverse{6} Und du
...
ungehorsames Haus sind, \bibleverse{7} sondern du sollst ihnen meine
...
\textsc{Herrn} an ihrem Ort! \bibleverse{13} Und war ein Rauschen von
...
\bibleverse{14} Da hob mich der Wind auf und führte mich weg. Und ich
fuhr dahin in bitterem Grimm, und des \textsc{Herrn} Hand hielt mich
fest. \bibleverse{15} Und ich kam zu den Gefangenen, die am Wasser
...
\bibleverse{16} Und da die sieben Tage um waren, geschah des
\textsc{Herrn} Wort zu mir und sprach: \bibleverse{17} Du Menschenkind,
...
\bibleverse{18} Wenn ich dem Gottlosen sage: Du musst des Todes sterben,
...
deiner Hand fordern. \bibleverse{19} Wo du aber den Gottlosen warnst und
...
\bibleverse{21} Wo du aber den Gerechten warnst, dass er nicht sündigen
...
\bibleverse{22} Und daselbst kam des \textsc{Herrn} Hand über mich, und
...
Hause! \bibleverse{25} Und du, Menschenkind, siehe, man wird dir Stricke
anlegen und dich damit binden, dass du nicht ausgehen sollst unter sie.
\bibleverse{26} Und ich will dir die Zunge an deinem Gaumen kleben
lassen, dass du verstummen sollst und nicht mehr sie strafen könnest;
denn es ist ein ungehorsames Haus. \bibleverse{27} Wenn ich aber mit dir
...
\bibleverse{13} Und der \textsc{Herr} sprach: Also müssen die Kinder
Israel ihr unreines Brot essen unter den Heiden, dahin ich sie verstoßen
werde.

\bibleverse{14} Ich aber sprach: Ach Herr \textsc{Herr}! siehe, meine
...
\bibleverse{5} So spricht der Herr \textsc{Herr}: Das ist Jerusalem, das
...
\bibleverse{7} Darum spricht der Herr \textsc{Herr} also: Weil ihr's
...
Heiden Weise tut, die um euch her sind, \bibleverse{8} so spricht der
Herr \textsc{Herr} also: Siehe, ich will auch an dich und will Recht
über dich gehen lassen, dass die Heiden zusehen sollen; \bibleverse{9}
und will also mit dir umgehen, wie ich nie getan und hinfort nicht tun
werde, um aller deiner Gräuel willen: \bibleverse{10} dass in dir die
...
alle Winde zerstreut werden. \bibleverse{11} Darum, so wahr als ich
...
gnädig sein. \bibleverse{12} Es soll ein drittes Teil an der Pestilenz
...
\textsc{Herr}) \bibleverse{16} und wenn ich böse Pfeile des Hungers
...
größer werden lasse und den Vorrat des Brots wegnehme. \bibleverse{17}
...
\bibleverse{4} dass eure Altäre verwüstet und eure Sonnensäulen
...
\bibleverse{10} und sie sollen erfahren, dass ich der \textsc{Herr} sei
...
\bibleverse{11} So spricht der Herr \textsc{Herr}: Schlage deine Hände
...
fallen müssen! \bibleverse{12} Wer fern ist, wird an der Pestilenz
...
meinen Grimm unter ihnen vollenden, \bibleverse{13} dass ihr erfahren
...
\bibleverse{14} Ich will meine Hand wider sie ausstrecken und das Land
...
\bibleverse{1} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
\bibleverse{2} Du Menschenkind, so spricht der Herr \textsc{Herr} vom
...
\bibleverse{5} So spricht der Herr \textsc{Herr}: Siehe, es kommt ein
Unglück über das andere! \bibleverse{6} Das Ende kommt, es kommt das
Ende, es ist erwacht über dich; siehe, es kommt! \bibleverse{7} Es geht
...
wird. \bibleverse{8} Nun will ich bald meinen Grimm über dich schütten
und meinen Zorn an dir vollenden und will dich richten, wie du verdient
hast, und dir geben, was deinen Gräueln allen gebührt. \bibleverse{9}
...
sein Leben erhalten, um seiner Missetat willen. \bibleverse{14} Lasst
...
\bibleverse{20} Sie haben aus ihren edlen Kleinoden, damit sie Hoffart
trieben, Bilder ihrer Gräuel und Scheuel gemacht; darum will ich's ihnen
zum Unflat machen \bibleverse{21} und will's Fremden in die Hände geben,
dass sie es rauben, und den Gottlosen auf Erden zur Ausbeute, dass sie
es entheiligen sollen. \bibleverse{22} Ich will mein Angesicht davon
...
sieht, da stand ein Bild zu Verdruss dem Hausherrn. \bibleverse{4} Und
...
Hauses Israel, allenthalben umher an der Wand gemacht; \bibleverse{11}
...
sondern der \textsc{Herr} hat das Land verlassen. \bibleverse{13} Und er
...
\bibleverse{14} Und er führte mich hinein zum Tor an des \textsc{Herrn}
Hause, das gegen Mitternacht steht; und siehe, daselbst saßen Weiber,
die weinten über den Thammus. \bibleverse{15} Und er sprach zu:
...
die Leinwand anhatte und das Schreibzeug an seiner Seite. \bibleverse{4}
...
verlassen, und der \textsc{Herr} sieht uns nicht. \bibleverse{10} Darum
...
anzusehen wie ein Thron. \bibleverse{2} Und er sprach zu dem Mann in der
...
Herrlichkeit des \textsc{Herrn}. \bibleverse{5} Und man hörte die Flügel
...
\bibleverse{18} Und die Herrlichkeit des \textsc{Herrn} ging wieder aus
von der Schwelle am Hause und stellte sich über die Cherubim.
\bibleverse{19} Da schwangen die Cherubim ihre Flügel und erhoben sich
...
\bibleverse{5} Und der Geist des \textsc{Herrn} fiel auf mich, und er
...
\bibleverse{6} Ihr habt viele erschlagen in dieser Stadt, und ihre
Gassen liegen voll Toter.

\bibleverse{7} Darum spricht der Herr \textsc{Herr} also: Die ihr darin
getötet habt, die sind das Fleisch, und sie ist der Topf; aber ihr
müsset hinaus. \bibleverse{8} Das Schwert, das ihr fürchtet, das will
ich über euch kommen lassen, spricht der Herr \textsc{Herr}.
\bibleverse{9} Ich will euch von dort herausstoßen und den Fremden in
die Hand geben und will euch euer Recht tun. \bibleverse{10} Ihr sollt
durchs Schwert fallen; an der Grenze Israels will ich euch richten, und
sollt erfahren, dass ich der \textsc{Herr} bin. \bibleverse{11} Die
...
\bibleverse{14} Da geschah des \textsc{Herrn} Wort zu mir und sprach:
...
\bibleverse{16} Darum sprich du: So spricht der Herr \textsc{Herr}: Ja,
...
\bibleverse{17} Darum sprich: So sagt der Herr \textsc{Herr}: Ich will
...
\bibleverse{20} auf dass sie in meinen Sitten wandeln und meine Rechte
halten und darnach tun. Und sie sollen mein Volk sein, so will ich ihr
Gott sein. \bibleverse{21} Denen aber, die nach ihres Herzens Scheueln
...
über ihnen. \bibleverse{23} Und die Herrlichkeit des \textsc{Herrn}
erhob sich aus der Stadt und stellte sich auf den Berg, der gegen Morgen
vor der Stadt liegt. \bibleverse{24} Und ein Wind hob mich auf und
...
\bibleverse{25} Und ich sagte den Gefangenen alle Worte des
...
\bibleverse{8} Und frühmorgens geschah des \textsc{Herrn} Wort zu mir
und sprach: \bibleverse{9} Menschenkind, hat das Haus Israel, das
ungehorsame Haus, nicht zu dir gesagt: Was machst du?

\bibleverse{10} So sprich zu ihnen: So spricht der Herr \textsc{Herr}:
...
mit keinem Auge das Land sehe. \bibleverse{13} Ich will auch mein Netz
...
soll daselbst sterben. \bibleverse{14} Und alle, die um ihn her sind,
seine Gehilfen und all sein Anhang, will ich unter alle Winde zerstreuen
und das Schwert hinter ihnen her ausziehen.

\bibleverse{15} Also sollen sie erfahren, dass ich der \textsc{Herr}
...
\bibleverse{17} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
...
was darin ist, um des Frevels willen aller Einwohner. \bibleverse{20}
...
\bibleverse{21} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
...
hinfort nichts aus der Weissagung? \bibleverse{23} Darum sprich zu
...
ihnen: Die Zeit ist nahe und alles, was geweissagt ist. \bibleverse{24}
Denn es soll hinfort kein falsches Gesicht und keine Weissagung mit
Schmeichelworten mehr sein im Hause Israel. \bibleverse{25} Denn ich bin
...
\bibleverse{26} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
...
\bibleverse{28} Darum sprich zu ihnen: So spricht der Herr
...
\textsc{Herrn} Wort! \bibleverse{3} So spricht der Herr \textsc{Herr}:
Weh den tollen Propheten, die ihrem eigenen Geist folgen und haben keine
Gesichte! \bibleverse{4} O Israel, deine Propheten sind wie die Füchse
in den Wüsten! \bibleverse{5} Sie treten nicht vor die Lücken und machen
sich nicht zur Hürde um das Haus Israel und stehen nicht im Streit am
Tage des \textsc{Herrn}. \bibleverse{6} Ihr Gesicht ist nichts, und ihr
...
dass ihr Wort bestehe. \bibleverse{7} Ist's nicht also, dass euer
...
\bibleverse{8} Darum spricht der Herr \textsc{Herr} also: Weil ihr das
predigt, woraus nichts wird, und Lügen weissagt, so will ich an euch,
spricht der Herr \textsc{Herr}. \bibleverse{9} Und meine Hand soll
...
tünchen sie dieselbe mit losem Kalk. \bibleverse{11} Sprich zu den
...
Windwirbel wird es zerreißen. \bibleverse{12} Siehe, so wird die Wand
einfallen. Was gilt's? dann wird man zu euch sagen: Wo ist nun das
Getünchte, das ihr getüncht habt?

\bibleverse{13} So spricht der Herr \textsc{Herr}: Ich will einen
...
\bibleverse{14} Also will ich die Wand umwerfen; die ihr mit losem Kalk
...
ich der \textsc{Herr} sei. \bibleverse{15} Also will ich meinen Grimm
vollenden an der Wand und an denen, die sie mit losem Kalk tünchen, und
will zu euch sagen: Hier ist weder Wand noch Tüncher. \bibleverse{16}
...
wider sie \bibleverse{18} und sprich: So spricht der Herr \textsc{Herr}:
...
Leben \bibleverse{19} und entheiligt mich in meinem Volk um eine
...
\bibleverse{20} Darum spricht der Herr \textsc{Herr}: Siehe, ich will an
...
ihr sollt erfahren, dass ich der \textsc{Herr} sei. \bibleverse{22}
...
bleiben: \bibleverse{23} darum sollt ihr nicht mehr unnütze Lehre
...
setzten sich vor mir. \bibleverse{2} Da geschah des \textsc{Herrn} Wort
zu mir und sprach: \bibleverse{3} Menschenkind, diese Leute hangen mit
...
verdient hat mit seiner großen Abgötterei, \bibleverse{5} auf dass ich
...
\textsc{Herr}, selbst antworten; \bibleverse{8} und will mein Angesicht
...
ausstrecken und ihn aus meinem Volk Israel ausrotten. \bibleverse{10}
Also sollen sie beide ihre Missetat tragen; wie die Missetat des
Fragers, also soll auch sein die Missetat des Propheten, \bibleverse{11}
...
\bibleverse{12} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
...
ich Menschen und Vieh darin ausrotte. \bibleverse{14} Und wenn dann
...
könnte vor den Tieren, \bibleverse{16} und diese drei Männer wären auch
...
\bibleverse{21} Denn so spricht der Herr \textsc{Herr}: So ich meine
...
anderem Holz oder eine Rebe vor anderem Holz im Walde? \bibleverse{3}
Nimmt man es auch und macht etwas daraus? Macht man auch nur einen Nagel
daraus, daran man etwas hängen kann? \bibleverse{4} Siehe, man wirft's
...
\bibleverse{5} Siehe, da es noch ganz war, konnte man nichts daraus
...
\bibleverse{6} Darum spricht der Herr \textsc{Herr}: Gleichwie ich das
...
\bibleverse{7} und will mein Angesicht wider sie setzen, dass das Feuer
...
Angesicht wider sie setze \bibleverse{8} und das Land wüst mache, darum
...
Gräuel und sprich: \bibleverse{3} So spricht der Herr \textsc{Herr} zu
...
\bibleverse{16} Und nahmst von deinen Kleidern und machtest dir bunte
Altäre daraus und triebst deine Hurerei darauf, wie nie geschehen ist
noch geschehen wird. \bibleverse{17} Du nahmst auch dein schönes Gerät,
das ich dir von meinem Gold und Silber gegeben hatte, und machtest dir
Mannsbilder daraus und triebst deine Hurerei mit ihnen. \bibleverse{18}
Und nahmst deine gestickten Kleider und bedecktest sie damit und mein Öl
und Räuchwerk legtest du ihnen vor. \bibleverse{19} Meine Speise, die
...
der Herr \textsc{Herr}) \bibleverse{24} bautest du dir Götzenkapellen
und machtest dir Altäre auf allen Gassen; \bibleverse{25} und vornan auf
...
\bibleverse{35} Darum, du Hure, höre des \textsc{Herrn} Wort!
\bibleverse{36} So spricht der Herr \textsc{Herr}: Weil du denn so milde
...
deiner Kinder, welche du ihnen opferst: \bibleverse{37} darum, siehe,
...
dass sie deine Blöße ganz sehen sollen. \bibleverse{38} Und will das
Recht der Ehebrecherinnen und Blutvergießerinnen über dich gehen und
dein Blut vergießen lassen mit Grimm und Eifer. \bibleverse{39} Und will
...
Gerät dir nehmen und dich nackt und bloß sitzen lassen. \bibleverse{40}
Und sie sollen Haufen Leute über dich bringen, die dich steinigen und
mit ihren Schwertern zerhauen \bibleverse{41} und deine Häuser mit Feuer
...
zugeben, \bibleverse{42} und will meinen Mut an dir kühlen und meinen
...
Hethitern und euer Vater ein Amoriter. \bibleverse{46} Samaria ist dein
...
wohnt; \bibleverse{47} wiewohl du dennoch nicht gelebt hast nach ihrem
Wesen noch getan nach ihren Gräueln. Es fehlt nicht viel, dass du es
ärger gemacht hast denn sie in allem deinem Wesen. \bibleverse{48} So
...
da ich begann dareinzusehen. \bibleverse{51} So hat auch Samaria nicht
...
alle deine Gräuel, die du getan hast. \bibleverse{52} So trage auch nun
...
\bibleverse{59} Denn also spricht der Herr \textsc{Herr}: Ich will dir
...
aufrichten. \bibleverse{61} Da wirst du an deine Wege gedenken und dich
...
\bibleverse{62} Sondern ich will meinen Bund mit dir aufrichten, dass du
erfahren sollst, dass ich der \textsc{Herr} sei, \bibleverse{63} auf
...
ein Gleichnis \bibleverse{3} und sprich: So spricht der Herr
...
von der Zeder \bibleverse{4} und brach das oberste Reis ab und führte es
...
\bibleverse{9} So sprich nun: Also sagt der Herr \textsc{Herr}: Sollte
...
\bibleverse{11} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
...
Babel. \bibleverse{13} Und nahm einen vom königlichen Geschlecht und
machte einen Bund mit ihm und nahm einen Eid von ihm; aber die
Gewaltigen im Lande nahm er weg, \bibleverse{14} damit das Königreich
...
\bibleverse{16} So wahr ich lebe, spricht der Herr \textsc{Herr}, an dem
...
\bibleverse{19} Darum spricht der Herr \textsc{Herr} also; So wahr als
ich lebe, so will ich meinen Eid, den er verachtet hat, und meinen Bund,
den er gebrochen hat, auf seinen Kopf bringen. \bibleverse{20} Denn ich
...
\bibleverse{21} Und alle seine Flüchtigen, die ihm anhingen, sollen
...
\bibleverse{22} So spricht der Herr \textsc{Herr}: Ich will auch von dem
...
dem Schatten seiner Zweige bleiben möge. \bibleverse{24} Und sollen alle
...
\bibleverse{3} So wahr als ich lebe, spricht der Herr \textsc{Herr},
solches Sprichwort soll nicht mehr unter euch gehen in Israel.
\bibleverse{4} Denn siehe, alle Seelen sind mein; des Vaters Seele ist
...
den Nackten kleidet, \bibleverse{8} der nicht wuchert, der nicht Zins
nimmt, der seine Hand vom Unrechten kehrt, der zwischen den Leuten recht
urteilt, \bibleverse{9} der nach meinen Rechten wandelt und meine Gebote
...
\bibleverse{25} Doch sprecht ihr: Der \textsc{Herr} handelt nicht recht.
So höret nun, ihr vom Hause Israel: Ist's nicht also, dass ich recht
habe und ihr unrecht habt? \bibleverse{26} Denn wenn der Gerechte sich
...
\bibleverse{27} Wiederum, wenn sich der Gottlose kehrt von seiner
Ungerechtigkeit, die er getan hat, und tut nun recht und wohl, der wird
seine Seele lebendig erhalten. \bibleverse{28} Denn weil er sieht und
bekehrt sich von aller seiner Bosheit, die er getan hat, so soll er
leben und nicht sterben. \bibleverse{29} Doch sprechen die vom Hause
...
müsset um der Missetat willen. \bibleverse{31} Werfet von euch alle eure
...
\bibleverse{32} Denn ich habe keinen Gefallen am Tode des Sterbenden,
...
Ketten nach Ägyptenland. \bibleverse{5} Da nun die Mutter sah, dass ihre
Hoffnung verloren war, da sie lange gehofft hatte, nahm sie ein anderes
aus ihren Jungen und machte einen jungen Löwen daraus. \bibleverse{6} Da
er unter den Löwen wandelte, ward er ein junger Löwe; der gewöhnte sich
auch, die Leute zu zerreißen und zu fressen. \bibleverse{7} Er verderbte
ihre Paläste und verwüstete ihre Städte, dass das Land und was darin
ist, vor der Stimme seines Brüllens sich entsetzte. \bibleverse{8} Da
legten sich die Heiden aus allen Ländern ringsumher und warfen ein Netz
über ihn und fingen ihn in ihren Gruben \bibleverse{9} und stießen ihn
...
Wasser, \bibleverse{11} dass seine Reben so stark wurden, dass sie zu
Herrenzeptern gut waren, und er ward hoch unter den Reben. Und da man
sah, dass er so hoch war und viel Reben hatte, \bibleverse{12} ward er
...
und verbrannt wurden. \bibleverse{13} Nun aber ist er gepflanzt in der
...
\bibleverse{2} Da geschah des \textsc{Herrn} Wort zu mir und sprach:
...
\bibleverse{5} und sprich zu ihnen: So spricht der Herr \textsc{Herr}:
...
Gott. \bibleverse{6} Ich erhob aber zur selben Zeit meine Hand, dass ich
...
\bibleverse{7} und sprach zu ihnen: Ein jeglicher werfe weg die Gräuel
...
\bibleverse{12} Ich gab ihnen auch meine Sabbate zum Zeichen zwischen
...
vor welchen ich sie hatte ausgeführt. \bibleverse{15} Und ich hob auch
...
fließt, ein edles Land vor allen Ländern, \bibleverse{16} darum dass sie
...
Herzens. \bibleverse{17} Aber mein Auge verschonte sie, dass ich sie
...
Rechte sollt ihr halten und darnach tun; \bibleverse{20} und meine
...
mich noch weiter gelästert und mir getrotzt. \bibleverse{28} Denn da ich
...
\bibleverse{30} Darum sprich zum Hause Israel: So spricht der Herr
\textsc{Herr}: Ihr verunreinigt euch in dem Wesen eurer Väter und treibt
Abgötterei mit ihren Gräueln \bibleverse{31} und verunreinigt euch an
...
ausgestrecktem Arm und mit ausgeschüttetem Grimm \bibleverse{34} und
...
ausgeschüttetem Grimm, \bibleverse{35} und will euch bringen in die
Wüste der Völker und daselbst mit euch rechten von Angesicht zu
Angesicht. \bibleverse{36} Wie ich mit euren Vätern in der Wüste bei
Ägypten gerechtet habe, ebenso will ich auch mit euch rechten, spricht
der Herr \textsc{Herr}. \bibleverse{37} Ich will euch wohl unter die
Rute bringen und euch in die Bande des Bundes zwingen \bibleverse{38}
...
\bibleverse{39} Darum, ihr vom Hause Israel, so spricht der Herr
...
hinfort ungeschändet mit euren Opfern und Götzen. \bibleverse{40} Denn
...
ihr mir heiligt. \bibleverse{41} Ihr werdet mir angenehm sein mit dem
...
werden vor den Heiden. \bibleverse{42} Und ihr werdet erfahren, dass ich
...
\bibleverse{43} Daselbst werdet ihr gedenken an euer Wesen und an all
euer Tun, darin ihr verunreinigt seid, und werdet Missfallen haben über
alle eure Bosheit, die ihr getan habt. \bibleverse{44} Und werdet
...
\bibleverse{4} Und alles Fleisch soll sehen, dass ich, der
\textsc{Herr}, es angezündet habe und niemand löschen kann.
\bibleverse{5} Und ich sprach: Ach Herr \textsc{Herr}, sie sagen von
mir: Dieser redet eitel Rätselworte. \bibleverse{6} Und des
\textsc{Herrn} Wort geschah zu mir und sprach: \bibleverse{7} Du
Menschenkind, richte dein Angesicht wider Jerusalem und predige wider
die Heiligtümer und weissage wider das Land Israel \bibleverse{8} und
...
dir ausrotten beide, Gerechte und Ungerechte. \bibleverse{9} Weil ich
...
Mitternacht. \bibleverse{10} Und soll alles Fleisch erfahren, dass ich,
der \textsc{Herr}, mein Schwert habe aus seiner Scheide gezogen; und es
soll nicht wieder eingesteckt werden. \bibleverse{11} Und du,
Menschenkind, sollst seufzen, bis dir die Lenden weh tun, ja, bitterlich
sollst du seufzen, dass sie es sehen. \bibleverse{12} Und wenn sie zu
...
\textsc{Herr}. \bibleverse{13} Und des \textsc{Herrn} Wort geschah zu
mir und sprach: \bibleverse{14} Du Menschenkind, weissage und sprich: So
spricht der \textsc{Herr}: Sprich: Das Schwert, ja, das Schwert ist
geschärft und gefegt. \bibleverse{15} Es ist geschärft, dass es
...
Kinder! \bibleverse{16} Aber er hat ein Schwert zu fegen gegeben, dass
man es fassen soll; es ist geschärft und gefegt, dass man's dem
Totschläger in die Hand gebe. \bibleverse{17} Schreie und heule, du
...
auf deine Lenden. \bibleverse{18} Denn er hat sie oft gezüchtigt; was
hat's geholfen? Es will der bösen Kinder Rute nicht helfen, spricht der
Herr \textsc{Herr}. \bibleverse{19} Und du, Menschenkind, weissage und
...
auch treffen wird in den Kammern, dahin sie fliehen. \bibleverse{20} Ich
...
zur Schlacht! \bibleverse{21} Haue drein, zur Rechten und Linken, was
vor dir ist! \bibleverse{22} Da will ich dann mit meinen Händen darob
frohlocken und meinen Zorn gehen lassen. Ich, der \textsc{Herr}, habe es
gesagt. \bibleverse{23} Und des \textsc{Herrn} Wort geschah zu mir und
sprach: \bibleverse{24} Du Menschenkind, mache zwei Wege, durch welche
kommen soll das Schwert des Königs zu Babel; sie sollen aber alle beide
aus einem Lande gehen. \bibleverse{25} Und stelle ein Zeichen vorn an
...
Stadt Jerusalem. \bibleverse{26} Denn der König zu Babel wird sich an
...
Leber an. \bibleverse{27} Und die Wahrsagung wird auf die rechte Seite
...
er sie gewinne. \bibleverse{29} Darum spricht der Herr \textsc{Herr}
...
\bibleverse{30} Und du, Fürst in Israel, der du verdammt und verurteilt
bist, dessen Tag daherkommen wird, wenn die Missetat zum Ende gekommen
ist, \bibleverse{31} so spricht der Herr \textsc{Herr}: Tue weg den Hut
...
der sich erniedrigt, soll erhöht werden. \bibleverse{32} Ich will die
Krone zunichte, zunichte, zunichte machen, bis der komme, der sie haben
soll; dem will ich sie geben. \bibleverse{33} Und du, Menschenkind,
...
soll blinken, \bibleverse{34} darum dass du falsche Gesichte dir sagen
...
Stadt und ihr anzeigen alle ihre Gräuel? \bibleverse{3} Sprich: So
...
dadurch du dich verunreinigst! \bibleverse{4} Du verschuldest dich an
...
zum Hohn in allen Ländern machen. \bibleverse{5} In der Nähe und in der
Ferne sollen sie dein spotten, dass du ein schändlich Gerücht haben und
großen Jammer leiden müssest. \bibleverse{6} Siehe, die Fürsten in
Israel, ein jeglicher ist mächtig bei dir, Blut zu vergießen.
\bibleverse{7} Vater und Mutter verachten sie, den Fremdlingen tun sie
Gewalt und Unrecht, die Witwen und die Waisen schinden sie.
\bibleverse{8} Du verachtest meine Heiligtümer und entheiligst meine
Sabbate. \bibleverse{9} Verräter sind in dir, auf dass sie Blut
vergießen. Sie essen auf den Bergen und handeln mutwillig in dir;
\bibleverse{10} sie decken auf die Blöße der Väter und nötigen die
Weiber in ihrer Krankheit \bibleverse{11} und treiben untereinander,
...
Schwestern, ihres Vaters Töchter; \bibleverse{12} sie nehmen Geschenke,
...
vergessen mein also, spricht der Herr \textsc{Herr}. \bibleverse{13}
Siehe, ich schlage meine Hände zusammen über den Geiz, den du treibst,
und über das Blut, das in dir vergossen ist. \bibleverse{14} Meinst du
...
es geredet und will's auch tun \bibleverse{15} und will dich zerstreuen
unter die Heiden und dich verstoßen in die Länder und will deinem Unflat
ein Ende machen, \bibleverse{16} dass du bei den Heiden musst verflucht
geachtet werden und erfahren, dass ich der \textsc{Herr} sei.
\bibleverse{17} Und des \textsc{Herrn} Wort geschah zu mir und sprach:
\bibleverse{18} Du Menschenkind, das Haus Israel ist mir zu Schlacken
geworden und sind alle Erz, Zinn, Eisen und Blei im Ofen; ja, zu
Silberschlacken sind sie geworden. \bibleverse{19} Darum spricht der
Herr \textsc{Herr} also: Weil ihr denn alle Schlacken geworden seid,
siehe, so will ich euch alle gen Jerusalem zusammentun. \bibleverse{20}
...
\bibleverse{21} Ja, ich will euch sammeln und das Feuer meines Zorns
...
Grimm über euch ausgeschüttet habe. \bibleverse{23} Und des
\textsc{Herrn} Wort geschah zu mir und sprach: \bibleverse{24} Du
...
\bibleverse{25} Die Propheten, die darin sind, haben sich gerottet, die
Seelen zu fressen wie ein brüllender Löwe, wenn er raubt; sie reißen Gut
und Geld an sich und machen der Witwen viel darin. \bibleverse{26} Ihre
...
\bibleverse{29} Das Volk im Lande übt Gewalt; rauben getrost und
schinden die Armen und Elenden und tun den Fremdlingen Gewalt und
Unrecht. \bibleverse{30} Ich suchte unter ihnen, ob jemand sich zur
Mauer machte und wider den Riss stünde vor mir für das Land, dass ich's
nicht verderbte; aber ich fand keinen. \bibleverse{31} Darum schüttete
...
gestraft wäre. \bibleverse{11} Da es aber ihre Schwester Oholiba sah,
entbrannte sie noch viel ärger denn jene und trieb die Hurerei mehr denn
ihre Schwester; \bibleverse{12} und entbrannte gegen die Kinder Assur,
...
dich bringen, \bibleverse{23} nämlich die Kinder Babels und alle
...
die alle auf Rossen reiten. \bibleverse{24} Und sie werden über dich
...
Recht. \bibleverse{25} Ich will meinen Eifer über dich gehen lassen,
...
verbrennen. \bibleverse{26} Sie sollen dir deine Kleider ausziehen und
deinen Schmuck wegnehmen. \bibleverse{27} Also will ich deiner Unzucht
...
\bibleverse{28} Denn so spricht der Herr \textsc{Herr}: Siehe, ich will
dich überantworten, denen du feind geworden und deren du müde bist.
\bibleverse{29} Die sollen wie Feinde mit dir umgehen und alles nehmen,
was du erworben hast, und dich nackt und bloß lassen, dass die Schande
deiner Unzucht und Hurerei offenbar werde. \bibleverse{30} Solches wird
dir geschehen um deiner Hurerei willen, die du mit den Heiden getrieben,
an deren Götzen du dich verunreinigt hast. \bibleverse{31} Du bist auf
dem Wege deiner Schwester gegangen; darum gebe ich dir auch deren Kelch
in deine Hand. \bibleverse{32} So spricht der Herr \textsc{Herr}: Du
...
wird. \bibleverse{33} Du musst dich des starken Tranks und Jammers
vollsaufen; denn der Kelch deiner Schwester Samaria ist ein Kelch des
Jammers und Trauerns. \bibleverse{34} Denselben musst du rein
austrinken, darnach die Scherben zerwerfen und deine Brüste zerreißen;
denn ich habe es geredet, spricht der Herr \textsc{Herr}.
\bibleverse{35} Darum so spricht der Herr \textsc{Herr}: Darum, dass du
mein vergessen und mich hinter deinen Rücken geworfen hast, so trage
auch nun deine Unzucht und deine Hurerei. \bibleverse{36} Und der
\textsc{Herr} sprach zu mir: Du Menschenkind, willst du nicht Ohola und
Oholiba strafen und ihnen zeigen ihre Gräuel? \bibleverse{37} Wie sie
...
verbrannten sie denselben zum Opfer. \bibleverse{38} Überdas haben sie
mir das getan: sie haben meine Heiligtümer verunreinigt dazumal und
meine Sabbate entheiligt. \bibleverse{39} Denn da sie ihre Kinder den
...
begangen. \bibleverse{40} Sie haben auch Boten geschickt nach Leuten,
...
zu Ehren \bibleverse{41} und saßest auf einem herrlichen Polster, vor
welchem stand ein Tisch zugerichtet; darauf legtest du mein Räuchwerk
und mein Öl. \bibleverse{42} Daselbst erhob sich ein großes
...
und schöne Kronen auf ihre Häupter. \bibleverse{43} Ich aber gedachte:
Sie ist der Ehebrecherei gewohnt von alters her; sie kann von der
Hurerei nicht lassen. \bibleverse{44} Denn man geht zu ihr ein, wie man
zu einer Hure eingeht; ebenso geht man zu Ohola und Oholiba, den
unzüchtigen Weibern. \bibleverse{45} Darum werden sie die Männer
...
Hände sind voll Blut. \bibleverse{46} Also spricht der Herr
\textsc{Herr}: Führe einen großen Haufen über sie herauf und gib sie zu
Raub und Beute, \bibleverse{47} dass die Leute sie steinigen und mit
ihren Schwertern erstechen und ihre Söhne und Töchter erwürgen und ihre
Häuser mit Feuer verbrennen. \bibleverse{48} Also will ich der Unzucht
...
\bibleverse{1} Und es geschah das Wort des \textsc{Herrn} zu mir im
neunten Jahr, am zehnten Tage des zehnten Monats, und sprach:
\bibleverse{2} Du Menschenkind, schreib diesen Tag an, ja, eben diesen
Tag; denn der König zu Babel hat sich eben an diesem Tage wider
Jerusalem gelagert. \bibleverse{3} Und gib dem ungehorsamen Volk ein
Gleichnis und sprich zu ihnen: So spricht der Herr \textsc{Herr}: Setze
einen Topf zu, setze zu und gieß Wasser hinein; \bibleverse{4} tue die
...
\bibleverse{5} nimm das Beste von der Herde und mache ein Feuer
...
\bibleverse{6} Darum spricht der Herr \textsc{Herr}: O der mörderischen
...
darum losen, welches zuerst heraus soll. \bibleverse{7} Denn ihr Blut
...
einem großen Feuer machen! \bibleverse{10} Trage nur viel Holz her,
zünde das Feuer an, dass das Fleisch gar werde, und würze es wohl, und
die Knochenstücke sollen anbrennen. \bibleverse{11} Lege auch den Topf
...
\bibleverse{12} Aber wie sehr er brennt, will sein Rost doch nicht
abgehen, denn es ist zuviel des Rosts; er muss im Feuer verschmelzen.
\bibleverse{13} Deine Unreinigkeit ist so verhärtet, dass, ob ich dich
...
rein werden, bis mein Grimm sich an dir gekühlt habe. \bibleverse{14}
...
der Herr \textsc{Herr}. \bibleverse{15} Und des \textsc{Herrn} Wort
geschah zu mir und sprach: \bibleverse{16} Du Menschenkind, siehe, ich
will dir deiner Augen Lust nehmen durch eine Plage. Aber du sollst nicht
klagen noch weinen noch eine Träne lassen. \bibleverse{17} Heimlich
...
gesagt: \bibleverse{21} Sage dem Hause Israel, dass der Herr
...
werden durchs Schwert fallen. \bibleverse{22} Und müsset tun, wie ich
getan habe: euren Mund sollt ihr nicht verhüllen und das Trauerbrot
nicht essen, \bibleverse{23} sondern sollt euren Schmuck auf euer Haupt
...
Ammon und weissage wider sie \bibleverse{3} und sprich zu den Kindern
...
über das Haus Juda: „Es ist gefangen weggeführt!{}``, \bibleverse{4}
...
\bibleverse{5} Und will Rabba zum Kamelstall machen und das Land der
Kinder Ammon zu Schafhürden machen; und ihr sollt erfahren, dass ich der
\textsc{Herr} bin. \bibleverse{6} Denn so spricht der Herr
...
dich gefreut hast, \bibleverse{7} darum siehe, ich will meine Hand über
...
sollst erfahren, dass ich der \textsc{Herr} bin. \bibleverse{8} So
spricht der Herr \textsc{Herr}: Darum dass Moab und Seir sprechen:
Siehe, das Haus Juda ist eben wie alle Heiden! \bibleverse{9} siehe, so
...
\bibleverse{10} und will es den Kindern des Morgenlandes zum Erbe geben
samt dem Lande der Kinder Ammon, dass man der Kinder Ammon nicht mehr
gedenken soll unter den Heiden. \bibleverse{11} Und will das Recht gehen
lassen über Moab; und sie sollen erfahren, dass ich der \textsc{Herr}
bin. \bibleverse{12} So spricht der Herr \textsc{Herr}: Darum dass sich
Edom am Hause Juda gerächt hat und sich verschuldet mit seinem Rächen,
\bibleverse{13} darum spricht der Herr \textsc{Herr} also: Ich will
...
fällen; \bibleverse{14} und will mich an Edom rächen durch mein Volk
...
\bibleverse{15} So spricht der Herr \textsc{Herr}: Darum dass die
Philister sich gerächt haben und den alten Hass gebüßt nach allem ihrem
Willen am Schaden meines Volks, \bibleverse{16} darum spricht der Herr
...
Meeres umbringen; \bibleverse{17} und will große Rache an ihnen üben und
...
\bibleverse{2} Du Menschenkind, darum dass Tyrus spricht über Jerusalem:
„Ha! die Pforte der Völker ist zerbrochen; es ist zu mir gewandt; ich
werde nun voll werden, weil sie wüst ist!{}``, \bibleverse{3} darum
...
erhebt mit seinen Wellen. \bibleverse{4} Die sollen die Mauern zu Tyrus
verderben und ihre Türme abbrechen; ja ich will auch ihren Staub von ihr
wegfegen und will einen bloßen Fels aus ihr machen \bibleverse{5} und
...
Raub werden. \bibleverse{6} Und ihre Töchter, die auf dem Felde liegen,
sollen durchs Schwert erwürgt werden und sollen erfahren, dass ich der
\textsc{Herr} bin. \bibleverse{7} Denn so spricht der Herr
...
mit Rossen, Wagen, Reitern und mit großem Haufen Volks. \bibleverse{8}
...
aufschütten und Schilde wider dich rüsten. \bibleverse{9} Er wird mit
Sturmböcken deine Mauern zerstoßen und deine Türme mit seinen Werkzeugen
umreißen. \bibleverse{10} Der Staub von der Menge seiner Pferde wird
...
wie man pflegt in eine zerrissene Stadt einzuziehen. \bibleverse{11} Er
...
reißen. \bibleverse{12} Sie werden dein Gut rauben und deinen Handel
...
\bibleverse{13} Also will ich mit dem Getön deines Gesanges ein Ende
...
Herr \textsc{Herr}. \bibleverse{15} So spricht der Herr \textsc{Herr}
...
ermordet werden. \bibleverse{16} Alle Fürsten am Meer werden herab von
...
Fall. \bibleverse{17} Sie werden über dich wehklagen und von dir sagen:
...
lassen, dass dich große Wasser bedecken, \bibleverse{20} und will dich
...
Ich will dich, du Prächtige im Lande der Lebendigen, \bibleverse{21} ja,
...
Tyrus, du sprichst: Ich bin die Allerschönste. \bibleverse{4} Deine
Grenzen sind mitten im Meer und deine Bauleute haben dich aufs
allerschönste zugerichtet. \bibleverse{5} Sie haben all dein Tafelwerk
aus Zypressenholz vom Senir gemacht und die Zedern von dem Libanon
führen lassen und deine Mastbäume daraus gemacht \bibleverse{6} und
deine Ruder von Eichen aus Basan und deine Bänke von Elfenbein, gefasst
in Buchsbaumholz aus den Inseln der Chittiter. \bibleverse{7} Dein Segel
...
\bibleverse{14} Die von Thogarma haben dir Rosse und Wagenpferde und
Maulesel auf deine Märkte gebracht. \bibleverse{15} Die von Dedan sind
deine Händler gewesen, und hast allenthalben in den Inseln gehandelt;
die haben dir Elfenbein und Ebenholz verkauft. \bibleverse{16} Die Syrer
...
Märkte gebracht. \bibleverse{17} Juda und das Land Israel haben auch mit
dir gehandelt und haben dir Weizen von Minnith und Balsam und Honig und
Öl und Mastix auf deine Märkte gebracht. \bibleverse{18} Dazu hat auch
Damaskus bei dir geholt deine Arbeit und allerlei Ware um Wein von
Helbon und köstliche Wolle. \bibleverse{19} Dan und Javan und Mehusal
haben auch auf deine Märkte gebracht Eisenwerk, Kassia und Kalmus, dass
du damit handeltest. \bibleverse{20} Dedan hat mit dir gehandelt mit
Decken zum Reiten. \bibleverse{21} Arabien und alle Fürsten von Kedar
haben mit dir gehandelt mit Schafen, Widdern und Böcken. \bibleverse{22}
...
wäre es eines Gottes Herz: \bibleverse{3} siehe, du hältst dich für
klüger denn Daniel, dass dir nichts verborgen sei \bibleverse{4} und
habest durch deine Klugheit und deinen Verstand solche Macht zuwege
gebracht und Schätze von Gold und Silber gesammelt \bibleverse{5} und
...
\bibleverse{6} darum spricht der Herr \textsc{Herr} also: Weil sich denn
dein Herz erhebt, als wäre es eines Gottes Herz, \bibleverse{7} darum,
...
deine große Ehre zu Schanden machen. \bibleverse{8} Sie sollen dich
hinunter in die Grube stoßen, dass du mitten auf dem Meer sterbest wie
die Erschlagenen. \bibleverse{9} Was gilt's, ob du dann vor deinem
Totschläger werdest sagen: „Ich bin Gott``, so du doch nicht Gott,
sondern ein Mensch und in deiner Totschläger Hand bist? \bibleverse{10}
Du sollst sterben wie die Unbeschnittenen von der Hand der Fremden; denn
ich habe es geredet, spricht der Herr \textsc{Herr}. \bibleverse{11} Und
des \textsc{Herrn} Wort geschah zu mir und sprach: \bibleverse{12} Du
...
voller Weisheit und aus der Maßen schön. \bibleverse{13} Du bist im
...
deine Pauken und Pfeifen. \bibleverse{14} Du bist wie ein Cherub, der
...
und nimmermehr aufkommen kannst. \bibleverse{20} Und des \textsc{Herrn}
Wort geschah zu mir und sprach: \bibleverse{21} Du Menschenkind, richte
dein Angesicht wider Sidon und weissage wider sie \bibleverse{22} und
...
sollen erfahren, dass ich der \textsc{Herr} bin. \bibleverse{24} Und
...
dass sie erfahren, dass ich der Herr \textsc{Herr} bin. \bibleverse{25}
...
\bibleverse{26} und sollen sicher darin wohnen und Häuser bauen und
...
geschah des \textsc{Herrn} Wort zu mir und sprach: \bibleverse{2} Du
Menschenkind, richte dein Angesicht wider Pharao, den König in Ägypten,
und weissage wider ihn und wider ganz Ägyptenland. \bibleverse{3}
...
gemacht. \bibleverse{4} Aber ich will dir ein Gebiss ins Maul legen und
...
deinen Schuppen hangen. \bibleverse{5} Ich will dich mit den Fischen aus
...
dem Lande und den Vögeln des Himmels zur Speise werden. \bibleverse{6}
...
sind. \bibleverse{7} Wenn sie ihn in die Hand fassten, so brach er und
stach sie durch die Seite; wenn sie sich aber darauf lehnten, so
zerbrach er und stach sie in die Lenden. \bibleverse{8} Darum spricht
der Herr \textsc{Herr} also: Siehe, ich will das Schwert über dich
kommen lassen und Leute und Vieh in dir ausrotten. \bibleverse{9} Und
...
mein, und ich bin's, der's tut. \bibleverse{10} Darum, siehe, ich will
...
\bibleverse{11} dass weder Vieh noch Leute darin gehen oder da wohnen
sollen vierzig Jahre lang. \bibleverse{12} Denn ich will Ägyptenland
...
\bibleverse{13} Doch so spricht der Herr \textsc{Herr}: Wenn die vierzig
Jahre aus sein werden, will ich die Ägypter wieder sammeln aus den
Völkern, darunter sie zerstreut sollen werden, \bibleverse{14} und will
...
erfahren, dass ich der Herr \textsc{Herr} bin. \bibleverse{17} Und es
begab sich im siebenundzwanzigsten Jahr, am ersten Tage des ersten
Monats, geschah des \textsc{Herrn} Wort zu mir und sprach:
\bibleverse{18} Du Menschenkind, Nebukadnezar, der König zu Babel, hat
...
seinem Heer seine Arbeit vor Tyrus belohnt worden. \bibleverse{19} Darum
...
\bibleverse{20} Zum Lohn für seine Arbeit, die er getan hat, will ich
ihm das Land Ägypten geben; denn sie haben mir gedient, spricht der Herr
\textsc{Herr}. \bibleverse{21} Zur selben Zeit will ich das Horn des
...
\textsc{Herr}: Heulet: „O weh des Tages!{}`` \bibleverse{3} Denn der Tag
ist nahe, ja, des \textsc{Herrn} Tag ist nahe, ein finsterer Tag; die
Zeit der Heiden kommt. \bibleverse{4} Und das Schwert soll über Ägypten
...
umgerissen werden. \bibleverse{5} Mohrenland und Libyen und Lud mit
allerlei Volk und Chub und die aus dem Lande des Bundes sind, sollen
samt ihnen durchs Schwert fallen. \bibleverse{6} So spricht der
...
Schwert fallen, spricht der Herr \textsc{Herr}. \bibleverse{7} Und sie
sollen wie andere wüste Länder wüst werden, und ihre Städte unter
anderen wüsten Städten wüst liegen, \bibleverse{8} dass sie erfahren,
dass ich der \textsc{Herr} sei, wenn ich ein Feuer in Ägypten mache,
dass alle, die ihnen helfen, verstört werden. \bibleverse{9} Zur selben
...
kommt gewiss. \bibleverse{10} So spricht der Herr \textsc{Herr}: Ich
will die Menge in Ägypten wegräumen durch Nebukadnezar, den König zu
Babel. \bibleverse{11} Denn er und sein Volk mit ihm, die Tyrannen der
...
Erschlagener liege. \bibleverse{12} Und ich will die Wasserströme
...
es geredet. \bibleverse{13} So spricht der Herr \textsc{Herr}: Ich will
...
Ägyptenland schicken. \bibleverse{14} Ich will Pathros wüst machen und
ein Feuer zu Zoan anzünden und das Recht über No gehen lassen
\bibleverse{15} und will meinen Grimm ausschütten über Sin, die Festung
Ägyptens, und will die Menge zu No ausrotten. \bibleverse{16} Ich will
ein Feuer in Ägypten anzünden, und Sin soll angst und bange werden, und
No soll zerrissen und Noph täglich geängstet werden. \bibleverse{17} Die
junge Mannschaft zu On und Bubastus sollen durchs Schwert fallen und die
Weiber gefangen weggeführt werden. \bibleverse{18} Thachpanhes wird
...
weggeführt werden. \bibleverse{19} Und ich will das Recht über Ägypten
gehen lassen, dass sie erfahren, dass ich der \textsc{Herr} sei.
\bibleverse{20} Und es begab sich im elften Jahr, am siebenten Tage des
ersten Monats, geschah des \textsc{Herrn} Wort zu mir und sprach:
...
dass ihm das Schwert aus seiner Hand entfallen muss; \bibleverse{23} und
ich will die Ägypter unter die Heiden zerstreuen und in die Länder
verjagen. \bibleverse{24} Aber die Arme des Königs zu Babel will ich
...
Verwundeter. \bibleverse{25} Ja, ich will die Arme des Königs zu Babel
...
die Hand gebe, dass er's über Ägyptenland zücke, \bibleverse{26} und ich
...
\bibleverse{2} Du Menschenkind, sage zu Pharao, dem König von Ägypten,
und zu allem seinem Volk: Wem meinst du denn, dass du gleich seist in
deiner Herrlichkeit? \bibleverse{3} Siehe, Assur war wie ein Zedernbaum
auf dem Libanon, von schönen Ästen und dick von Laub und sehr hoch, dass
sein Wipfel hoch stand unter großen, dichten Zweigen. \bibleverse{4} Die
...
Bäumen im Felde. \bibleverse{5} Darum ist er höher geworden als alle
Bäume im Felde und kriegte viel Äste und lange Zweige; denn er hatte
Wasser genug, sich auszubreiten. \bibleverse{6} Alle Vögel des Himmels
...
\bibleverse{7} Er hatte schöne, große und lange Äste; denn seine Wurzeln
hatten viel Wasser. \bibleverse{8} Und war ihm kein Zedernbaum gleich in
...
er war so schön wie kein Baum im Garten Gottes. \bibleverse{9} Ich hatte
ihn so schön gemacht, dass er so viel Äste kriegte, dass ihn alle
lustigen Bäume im Garten Gottes neideten. \bibleverse{10} Darum spricht
...
erhob, dass er so hoch geworden war, \bibleverse{11} darum gab ich ihn
...
\bibleverse{12} dass Fremde ihn ausrotten sollten, nämlich die Tyrannen
...
mussten und ihn verlassen; \bibleverse{13} und alle Vögel des Himmels
auf seinem umgefallenen Stamm saßen und alle Tiere im Felde sich legten
auf seine Äste; \bibleverse{14} auf dass sich forthin kein Baum am
...
andere Menschen, die in die Grube fahren. \bibleverse{15} So spricht der
Herr \textsc{Herr}: Zu der Zeit, da er hinunter in die Hölle fuhr, da
machte ich ein Trauern, dass ihn die Tiefe bedeckte und seine Ströme
...
über ihm. \bibleverse{16} Ich erschreckte die Heiden, da sie ihn hörten
...
gönnten's ihm wohl. \bibleverse{17} Denn sie mussten auch mit ihm
...
\bibleverse{3} So spricht der Herr \textsc{Herr}: Ich will mein Netz
über dich auswerfen durch einen großen Haufen Volks, die dich sollen in
mein Garn jagen; \bibleverse{4} und will dich aufs Land ziehen und aufs
Feld werfen, dass alle Vögel des Himmels auf dir sitzen sollen und alle
Tiere auf Erden von dir satt werden. \bibleverse{5} Und will dein Aas
auf die Berge werfen und mit deiner Höhe die Täler ausfüllen.
\bibleverse{6} Das Land, darin du schwimmst, will ich von deinem Blut
rot machen bis an die Berge hinan, dass die Bäche von dir voll werden.
\bibleverse{7} Und wenn du nun ganz dahin bist, so will ich den Himmel
verhüllen und seine Sterne verfinstern und die Sonne mit Wolken
überziehen, und der Mond soll nicht scheinen. \bibleverse{8} Alle
...
\bibleverse{9} Dazu will ich vieler Völker Herz erschreckt machen, wenn
ich die Heiden deine Plage erfahren lasse und viele Länder, die du nicht
kennst. \bibleverse{10} Viele Völker sollen sich über dich entsetzen,
...
entfallen wird über deinem Fall. \bibleverse{11} Denn so spricht der
Herr \textsc{Herr}: Das Schwert des Königs zu Babel soll dich treffen.
\bibleverse{12} Und ich will dein Volk fällen durch das Schwert der
Helden, durch allerlei Tyrannen der Heiden; die sollen die Herrlichkeit
Ägyptens verheeren, dass all ihr Volk vertilgt werde. \bibleverse{13}
...
\bibleverse{14} Alsdann will ich ihre Wasser lauter machen, dass ihre
Ströme fließen wie Öl, spricht der Herr \textsc{Herr}, \bibleverse{15}
...
dass ich der \textsc{Herr} sei. \bibleverse{16} Das wird der Jammer
...
Herr \textsc{Herr}. \bibleverse{17} Und im zwölften Jahr, am fünfzehnten
Tage desselben Monats, geschah des \textsc{Herrn} Wort zu mir und
sprach: \bibleverse{18} Du Menschenkind, beweine das Volk in Ägypten und
stoße es mit den Töchtern der starken Heiden hinab unter die Erde zu
denen, die in die Grube gefahren sind. \bibleverse{19} Wo ist nun deine
Wollust? Hinunter, und lege dich zu den Unbeschnittenen! \bibleverse{20}
...
\bibleverse{21} Von ihm werden sagen in der Hölle die starken Helden mit
ihren Gehilfen, die alle hinuntergefahren sind und liegen da unter den
Unbeschnittenen und mit dem Schwert Erschlagenen. \bibleverse{22}
...
ganze Welt fürchtete. \bibleverse{24} Da liegt auch Elam mit allem
...
tragen mit denen, die in die Grube gefahren sind. \bibleverse{25} Man
...
sind, und unter den Erschlagenen bleiben. \bibleverse{26} Da liegt
...
die ganze Welt fürchten musste; \bibleverse{27} und alle anderen Helden,
...
\bibleverse{28} So musst du freilich auch unter den Unbeschnittenen
zerschmettert werden und unter denen, die mit dem Schwert erschlagen
sind, liegen. \bibleverse{29} Da liegt Edom mit seinen Königen und allen
...
\bibleverse{31} Diese wird Pharao sehen und sich trösten über all sein
Volk, die unter ihm mit dem Schwert erschlagen sind, und über sein
ganzes Heer, spricht der Herr \textsc{Herr}. \bibleverse{32} Denn es
...
ihr vom Hause Israel? \bibleverse{12} Und du, Menschenkind, sprich zu
...
Gerechte nicht leben, wenn er sündigt. \bibleverse{13} Denn wenn ich zu
...
Böses tut: so soll er leben und nicht sterben, \bibleverse{16} und aller
seiner Sünden, die er getan hat, soll nicht gedacht werden; denn er tut
nun, was recht und gut ist; darum soll er leben. \bibleverse{17} Aber
dein Volk spricht: Der \textsc{Herr} urteilt nicht recht, obwohl doch
sie unrecht haben. \bibleverse{18} Denn wenn der Gerechte sich kehrt von
seiner Gerechtigkeit und tut Böses, so stirbt er ja billig darum.
\bibleverse{19} Und wennre sich der Gottlose bekehrt von seinem
gottlosen Wesen und tut, was recht und gut ist, so soll er ja billig
leben. \bibleverse{20} Doch sprecht ihr: Der \textsc{Herr} urteilt nicht
recht, obwohl ich doch euch vom Hause Israel einen jeglichen nach seinem
Wesen richte. \bibleverse{21} Und es begab sich im zwölften Jahr unserer
...
\bibleverse{22} Und die Hand des \textsc{Herrn} war über mir des Abends,
...
schweigen musste. \bibleverse{23} Und des \textsc{Herrn} Wort geschah zu
mir und sprach: \bibleverse{24} Du Menschenkind, die Einwohner dieser
...
uns zu. \bibleverse{25} Darum sprich zu ihnen: So spricht der Herr
...
besitzen? \bibleverse{26} Ja, ihr fahret immer fort mit Morden und übet
Gräuel, und einer schändet dem anderen sein Weib; und ihr meint, ihr
wollt das Land besitzen? \bibleverse{27} So sprich zu ihnen: So spricht
...
ihrer Gräuel willen, die sie üben. \bibleverse{30} Und du, Menschenkind,
...
\textsc{Herr} sage! \bibleverse{31} Und sie werden zu dir kommen in die
...
Herde weiden? \bibleverse{3} Aber ihr fresset das Fette und kleidet euch
mit der Wolle und schlachtet das Gemästete; aber die Schafe wollt ihr
nicht weiden. \bibleverse{4} Der Schwachen wartet ihr nicht, und die
...
streng und hart herrschet ihr über sie. \bibleverse{5} Und meine Schafe
sind zerstreut, als die keinen Hirten haben, und allen wilden Tieren zur
Speise geworden und gar zerstreut. \bibleverse{6} Und gehen irre hin und
...
\bibleverse{7} Darum höret, ihr Hirten, des \textsc{Herrn} Wort!
\bibleverse{8} So wahr ich lebe, spricht der Herr \textsc{Herr}, weil
...
aber meine Schafe wollen sie nicht weiden: \bibleverse{9} darum, ihr
Hirten, höret des \textsc{Herrn} Wort! \bibleverse{10} So spricht der
...
nicht mehr fressen sollen. \bibleverse{11} Denn so spricht der Herr
\textsc{Herr}: Siehe, ich will mich meiner Herde selbst annehmen und sie
suchen. \bibleverse{12} Wie ein Hirte seine Schafe sucht, wenn sie von
...
trüb und finster war. \bibleverse{13} Ich will sie von allen Völkern
...
zwischen Widdern und Böcken. \bibleverse{18} Ist's euch nicht genug, so
...
\bibleverse{19} dass meine Schafe essen müssen, was ihr mit euren Füßen
zertreten habt, und trinken, was ihr mit euren Füßen trüb gemacht habt?
\bibleverse{20} Darum so spricht der Herr \textsc{Herr} zu ihnen: Siehe,
...
und soll ihr Hirte sein, \bibleverse{24} und ich, der \textsc{Herr},
will ihr Gott sein; aber mein Knecht David soll der Fürst unter ihnen
sein; das sage ich, der \textsc{Herr}. \bibleverse{25} Und ich will
...
schlafen sollen. \bibleverse{26} Ich will sie und alles, was um meinen
Hügel her ist, segnen und auf sie regnen lassen zu rechter Zeit; das
sollen gnädige Regen sein, \bibleverse{27} dass die Bäume auf dem Felde
...
von der Hand derer, denen sie dienen mussten. \bibleverse{28} Und sie
...
\textsc{Herr}. \bibleverse{31} Ja, ihr Menschen sollt die Herde meiner
...
Seir und weissage dawider, \bibleverse{3} und sprich zu ihm: So spricht
...
\bibleverse{4} Ich will deine Städte öde machen, dass du sollst zur
Wüste werden und erfahren, dass ich der \textsc{Herr} bin.
\bibleverse{5} Darum dass ihr ewige Feindschaft tragt wider die Kinder
Israel und triebet sie ins Schwert zur Zeit, da es ihnen übel ging und
ihre Missetat zum Ende gekommen war, \bibleverse{6} darum, so wahr ich
...
ich der \textsc{Herr} bin. \bibleverse{10} Und darum dass du sprichst:
Diese beiden Völker mit beiden Ländern müssen mein werden, und wir
wollen sie einnehmen -- obgleich der \textsc{Herr} da wohnt --,
\bibleverse{11} darum, so wahr ich lebe, spricht der Herr \textsc{Herr},
...
ich dich gestraft habe. \bibleverse{12} Und du sollst erfahren, dass
...
verderben gegeben.`` \bibleverse{13} Und ihr habt euch wider mich
gerühmt und heftig wider mich geredet; das habe ich gehört.
\bibleverse{14} So spricht nun der Herr \textsc{Herr}: Ich will dich zur
Wüste machen, dass sich alles Land freuen soll. \bibleverse{15} Und wie
...
sprich: Höret des \textsc{Herrn} Wort, ihr Berge Israels! \bibleverse{2}
So spricht der Herr \textsc{Herr}: Darum dass der Feind über euch rühmt:
Ha! die ewigen Höhen sind nun unser Erbe geworden! \bibleverse{3} darum
...
Geschrei geworden, \bibleverse{4} darum höret, ihr Berge Israels, das
...
Spott geworden sind: \bibleverse{5} ja, so spricht der Herr
...
und zu plündern. \bibleverse{6} Darum weissage von dem Lande Israel und
...
\bibleverse{7} Darum spricht der Herr \textsc{Herr} also: Ich hebe meine
Hand auf, dass eure Nachbarn, die Heiden umher, ihre Schande tragen
sollen. \bibleverse{8} Aber ihr Berge Israels sollt wieder grünen und
...
erfahren, dass ich der \textsc{Herr} sei. \bibleverse{12} Ich will euch
...
\bibleverse{13} So spricht der Herr \textsc{Herr}: Weil man das von euch
...
Volk ohne Erben machen, spricht der Herr \textsc{Herr}. \bibleverse{15}
...
mehr ohne Erben machen, spricht der Herr \textsc{Herr}. \bibleverse{16}
Und des \textsc{Herrn} Wort geschah weiter zu mir: \bibleverse{17} Du
...
die Unreinigkeit eines Weibes in ihrer Krankheit, \bibleverse{18} da
...
\bibleverse{19} Und ich zerstreute sie unter die Heiden und zerstäubte
sie in die Länder und richtete sie nach ihrem Wesen und Tun.
\bibleverse{20} Und sie hielten sich wie die Heiden, zu denen sie kamen,
...
\bibleverse{21} Aber ich schonte meines heiligen Namens, welchen das
...
habt unter den Heiden, zu welchen ihr gekommen seid. \bibleverse{23}
...
sei. \bibleverse{24} Denn ich will euch aus den Heiden holen und euch
aus allen Landen versammeln und wieder in euer Land führen.
\bibleverse{25} Und will reines Wasser über euch sprengen, dass ihr rein
werdet; von all eurer Unreinigkeit und von allen euren Götzen will ich
euch reinigen. \bibleverse{26} Und ich will euch ein neues Herz und
einen neuen Geist in euch geben und will das steinerne Herz aus eurem
Fleisch wegnehmen und euch ein fleischernes Herz geben; \bibleverse{27}
...
darnach tun. \bibleverse{28} Und ihr sollt wohnen im Lande, das ich
euren Vätern gegeben habe, und sollt mein Volk sein, und ich will euer
Gott sein. \bibleverse{29} Ich will euch von aller eurer Unreinigkeit
...
mehr verspotten mit der Teuerung. \bibleverse{31} Alsdann werdet ihr an
euer böses Wesen gedenken und an euer Tun, das nicht gut war, und wird
euch eure Sünde und Abgötterei gereuen. \bibleverse{32} Solches will ich
...
vom Hause Israel, über eurem Wesen. \bibleverse{33} So spricht der Herr
...
wieder gebaut werden. \bibleverse{34} Das verwüstete Land soll wieder
...
sage es und tue es auch. \bibleverse{37} So spricht der Herr
...
eine Herde. \bibleverse{38} Wie eine heilige Herde, wie eine Herde zu
...
\bibleverse{1} Und des \textsc{Herrn} Hand kam über mich, und er führte
mich hinaus im Geist des \textsc{Herrn} und stellte mich auf ein weites
Feld, das voller Totengebeine lag. \bibleverse{2} Und er führte mich
allenthalben dadurch. Und siehe, des Gebeins lag sehr viel auf dem Feld;
und siehe, sie waren sehr verdorrt. \bibleverse{3} Und er sprach zu mir:
Du Menschenkind, meinst du auch, dass diese Gebeine wieder lebendig
werden? Und ich sprach: Herr \textsc{Herr}, das weißt du wohl.
\bibleverse{4} Und er sprach zu mir: Weissage von diesen Gebeinen und
sprich zu ihnen: Ihr verdorrten Gebeine, höret des \textsc{Herrn} Wort!
\bibleverse{5} So spricht der Herr \textsc{Herr} von diesen Gebeinen:
Siehe, ich will einen Odem in euch bringen, dass ihr sollt lebendig
werden. \bibleverse{6} Ich will euch Adern geben und Fleisch lassen über
...
\textsc{Herr} bin. \bibleverse{7} Und ich weissagte, wie mir befohlen
...
Gebein. \bibleverse{8} Und ich sah, und siehe, es wuchsen Adern und
Fleisch darauf, und sie wurden mit Haut überzogen; es war aber noch kein
Odem in ihnen. \bibleverse{9} Und er sprach zu mir: Weissage zum Winde;
...
bringen; \bibleverse{13} und ihr sollt erfahren, dass ich der
\textsc{Herr} bin, wenn ich eure Gräber geöffnet und euch, mein Volk,
aus denselben gebracht habe. \bibleverse{14} Und ich will meinen Geist
...
und tue es auch, spricht der \textsc{Herr}. \bibleverse{15} Und des
\textsc{Herrn} Wort geschah zu mir und sprach: \bibleverse{16} Du
...
Israel, seiner Zugetanen. \bibleverse{17} Und tue eins zum anderen
zusammen, dass es ein Holz werde in deiner Hand. \bibleverse{18} So nun
dein Volk zu dir wird sagen und sprechen: Willst du uns nicht zeigen,
was du damit meinst? \bibleverse{19} So sprich zu ihnen: So spricht der
...
eins in meiner Hand sein. \bibleverse{20} Und sollst also die Hölzer,
darauf du geschrieben hast, in deiner Hand halten, dass sie zusehen,
\bibleverse{21} und sollst zu ihnen sagen: So spricht der Herr
...
wieder in ihr Land bringen \bibleverse{22} und will ein Volk aus ihnen
...
zerteilt sein; \bibleverse{23} sollen sich auch nicht mehr verunreinigen
...
\bibleverse{24} Und mein Knecht David soll ihr König und ihrer aller
einiger Hirte sein. Und sie sollen wandeln in meinen Rechten und meine
Gebote halten und darnach tun. \bibleverse{25} Und sie sollen wieder in
...
\bibleverse{3} und sprich: So spricht der Herr \textsc{Herr}: Siehe, ich
...
Volk mit dir. \bibleverse{10} So spricht der Herr \textsc{Herr}: Zu der
...
Mauern dasitzen und haben weder Riegel noch Tore``, \bibleverse{12} auf
...
geschickt hat und mitten auf der Erde wohnt. \bibleverse{13} Das reiche
...
großen Raub treibest. \bibleverse{14} Darum so weissage, du
...
wohnen wird? \bibleverse{15} So wirst du kommen aus deinem Ort, von den
Enden gegen Mitternacht, du und großes Volk mit dir, alle zu Rosse, ein
großer Haufe und ein mächtiges Heer, \bibleverse{16} und wirst
...
dir, o Gog, geheiligt werde vor ihren Augen. \bibleverse{17} So spricht
...
weissagten, dass ich dich über sie kommen lassen wollte. \bibleverse{18}
...
meinem Grimm. \bibleverse{19} Und ich rede solches in meinem Eifer und
im Feuer meines Zorns. Denn zur selben Zeit wird großes Zittern sein im
Lande Israel, \bibleverse{20} dass vor meinem Angesicht zittern sollen
...
Felswände und alle Mauern zu Boden fallen. \bibleverse{21} Ich will aber
...
sein. \bibleverse{22} Und ich will ihn richten mit Pestilenz und Blut
...
\bibleverse{23} Also will ich denn herrlich, heilig und bekannt werden
...
oberste Fürst bist in Mesech und Thubal. \bibleverse{2} Siehe, ich will
dich herumlenken und locken und aus den Enden von Mitternacht bringen
und auf die Berge Israels kommen lassen. \bibleverse{3} Und ich will dir
...
\bibleverse{6} Und ich will Feuer werfen über Magog und über die, die in
den Inseln sicher wohnen; und sollen's erfahren, dass ich der
\textsc{Herr} bin. \bibleverse{7} Denn ich will meinen heiligen Namen
...
\textsc{Herr} bin, der Heilige in Israel. \bibleverse{8} Siehe, es ist
gekommen und geschehen, spricht der Herr \textsc{Herr}; das ist der Tag,
davon ich geredet habe. \bibleverse{9} Und die Bürger in den Städten
...
werden sieben Jahre lang Feuer damit machen, \bibleverse{10} dass sie
...
der Herr \textsc{Herr}. \bibleverse{11} Und soll zu der Zeit geschehen,
...
begraben hat; und soll heißen „Gogs Haufental``. \bibleverse{12} Es wird
sie aber das Haus Israel begraben sieben Monden lang, damit das Land
gereinigt werde. \bibleverse{13} Ja, alles Volk im Lande wird an ihnen
zu begraben haben, und sie werden Ruhm davon haben des Tages, da ich
meine Herrlichkeit erzeige, spricht der Herr \textsc{Herr}.
\bibleverse{14} Und sie werden Leute aussondern, die stets im Lande
...
forschen. \bibleverse{15} Und die, die im Lande umhergehen und eines
Menschen Gebein sehen, werden dabei ein Mal aufrichten, bis es die
Totengräber auch in Gogs Haufental begraben. \bibleverse{16} So soll
auch die Stadt heißen Hamona. Also werden sie das Land reinigen.
\bibleverse{17} Nun, du Menschenkind, so spricht der Herr \textsc{Herr}:
...
\bibleverse{18} Fleisch der Starken sollt ihr fressen, und Blut der
Fürsten auf Erden sollt ihr saufen, der Widder, der Hammel, der Böcke,
der Ochsen, die allzumal feist und wohl gemästet sind. \bibleverse{19}
...
\bibleverse{20} Sättiget euch nun an meinem Tisch von Rossen und
Reitern, von Starken und allerlei Kriegsleuten, spricht der Herr
\textsc{Herr}. \bibleverse{21} Und ich will meine Herrlichkeit unter die
...
\bibleverse{22} und also das Haus Israel erfahre, dass ich, der
...
\bibleverse{25} Darum so spricht der Herr \textsc{Herr}: Nun will ich
das Gefängnis Jakobs wenden und mich des ganzen Hauses Israel erbarmen
und um meinen heiligen Namen eifern. \bibleverse{26} Sie aber werden
...
niemand schrecke, \bibleverse{27} und ich sie wieder aus den Völkern
gebracht und aus den Landen ihrer Feinde versammelt habe und ich an
ihnen geheiligt worden bin vor den Augen vieler Heiden. \bibleverse{28}
...
versammeln und nicht einen von ihnen dort gelassen habe. \bibleverse{29}
...
\textsc{Herrn} Hand über mich und führte mich dahin. \bibleverse{2}
...
Mittag. \bibleverse{3} Und da er mich dahingebracht hatte, siehe, da war
ein Mann, des Ansehen war wie Erz; der hatte eine leinene Schnur und
eine Messrute in seiner Hand und stand unter dem Tor. \bibleverse{4} Und
...
verkündigest dem Hause Israel. \bibleverse{5} Und siehe, es ging eine
...
dienen. \bibleverse{47} Und er maß den Vorhof, nämlich hundert Ellen
...
Allerheiligste. \bibleverse{5} Und er maß die Wand des Hauses sechs
Ellen dick. Daran waren Gänge allenthalben herum, geteilt in Gemächer,
die waren allenthalben vier Ellen weit. \bibleverse{6} Und derselben
...
\bibleverse{7} Und die Gänge rings um das Haus her mit ihren Gemächern
waren umso weiter, je höher sie lagen; und aus dem unteren ging man in
den mittleren und aus dem mittleren in den obersten. \bibleverse{8} Und
ich sah am Hause eine Erhöhung ringsumher als Grundlage der Gänge, die
hatte eine volle Rute von sechs Ellen bis an den Rand. \bibleverse{9}
Und die Breite der Wand außen an den Gängen war fünf Ellen; und es war
ein freigelassener Raum an den Gemächern am Hause. \bibleverse{10} Und
die Breite bis zu den Kammern war zwanzig Ellen um das Haus herum.
\bibleverse{11} Und es waren zwei Türen an den Gängen nach dem
...
Tisch, der vor dem \textsc{Herrn} stehen soll. \bibleverse{23} Und die
Türen am Tempel und am Allerheiligsten \bibleverse{24} hatten zwei
...
an Umgang dreifach. \bibleverse{4} Und inwendig vor den Kammern war ein
Weg zehn Ellen breit vor den Türen der Kammern; die lagen alle gegen
Mitternacht. \bibleverse{5} Und die oberen Kammern waren enger als die
unteren und mittleren Kammern; denn die Umgänge nahmen Raum von ihnen
weg. \bibleverse{6} Denn es war drei Gemächer hoch, und sie hatten keine
...
\bibleverse{5} Da hob mich ein Wind auf und brachte mich in den inneren
Vorhof; und siehe, die Herrlichkeit des \textsc{Herrn} erfüllte das
Haus. \bibleverse{6} Und ich hörte einen mit mir reden vom Hause heraus,
und ein Mann stand neben mir. \bibleverse{7} Der sprach zu mir: Du
...
ihrer Könige in ihren Höhen, \bibleverse{8} welche ihre Schwelle an
...
in meinem Zorn verzehrt habe. \bibleverse{9} Nun aber sollen sie ihre
Abgötterei und die Leichen ihrer Könige fern von mir wegtun; und ich
will ewiglich unter ihnen wohnen. \bibleverse{10} Und du, Menschenkind,
...
darauf sprenge. \bibleverse{19} Und den Priestern von Levi aus dem Samen
...
\bibleverse{24} Und sollst sie beide vor dem \textsc{Herrn} opfern; und
die Priester sollen Salz darauf streuen und sollen sie also opfern dem
\textsc{Herrn} zum Brandopfer. \bibleverse{25} Also sollst du sieben
...
ohne Fehl sind, opfern. \bibleverse{26} Und sollen also sieben Tage lang
den Altar versöhnen und ihn reinigen und ihre Hände füllen.
\bibleverse{27} Und nach denselben Tagen sollen die Priester am achten
...
zugeschlossen bleiben. \bibleverse{3} Doch den Fürsten ausgenommen; denn
...
herausgehen. \bibleverse{4} Darnach führte er mich zum Tor gegen
...
Angesicht. \bibleverse{5} Und der \textsc{Herr} sprach zu mir: Du
...
Israel, mit allen euren Gräueln, \bibleverse{7} denn ihr führt fremde
...
\bibleverse{10} sondern die Leviten, die von mir gewichen sind und samt
Israel von mir irregegangen nach ihren Götzen, die sollen ihre Sünde
tragen, \bibleverse{11} und sollen in meinem Heiligtum dienen als Hüter
...
müssen ihre Sünde tragen. \bibleverse{13} Und sie sollen nicht zu mir
...
Gräuel, die sie geübt haben. \bibleverse{14} Darum habe ich sie zu
...
\textsc{Herr}. \bibleverse{16} Und sie sollen hineingehen in mein
Heiligtum und vor meinen Tisch treten, mir zu dienen und meine Sitten zu
halten. \bibleverse{17} Und wenn sie durch die Tore des inneren Vorhofs
...
\bibleverse{18} Und sollen leinenen Schmuck auf ihrem Haupt haben und
...
soweit er reicht. \bibleverse{2} Und von diesem sollen zum Heiligtum
kommen je 500 Ruten ins Gevierte und dazu ein freier Raum umher 50
Ellen. \bibleverse{3} Und auf dem Platz, der 25.000 Ruten lang und
10.000 breit ist, soll das Heiligtum stehen, das Allerheiligste.
\bibleverse{4} Das übrige aber vom geheiligten Lande soll den Priestern
...
\bibleverse{5} Aber die Leviten, die vor dem Hause dienen, sollen auch
25.000 Ruten lang und 10.000 breit haben zu ihrem Teil, dass sie da
wohnen. \bibleverse{6} Und der Stadt sollt ihr auch einen Platz lassen
für das ganze Haus Israel, 5000 Ruten breit und 25.000 lang, neben dem
geheiligten Lande. \bibleverse{7} Dem Fürsten aber sollt ihr auch einen
...
reichen als die Teile der Stämme. \bibleverse{8} Das soll sein eigen
...
\bibleverse{9} Denn so spricht der Herr \textsc{Herr}: Ihr habt's lange
...
spricht der Herr \textsc{Herr}. \bibleverse{10} Ihr sollt rechtes
Gewicht und rechte Scheffel und rechtes Maß haben. \bibleverse{11} Epha
...
soll man sie beide messen. \bibleverse{12} Aber ein Lot soll zwanzig
Gera haben; und eine Mina macht zwanzig Lot, fünfundzwanzig Lot und
fünfzehn Lot. \bibleverse{13} Das soll nun das Hebopfer sein, das ihr
heben sollt, nämlich den sechsten Teil eines Epha von einem Homer Weizen
und den sechsten Teil eines Epha von einem Homer Gerste. \bibleverse{14}
...
Versöhnung für sie, spricht der Herr \textsc{Herr}. \bibleverse{16}
...
\bibleverse{18} So spricht der Herr \textsc{Herr}: Am ersten Tage des
...
\bibleverse{23} Aber die sieben Tage des Festes soll er dem
...
\bibleverse{24} Zum Speisopfer aber soll er je ein Epha zu einem Farren
und ein Epha zu einem Widder opfern und je ein Hin Öl zu einem Epha.
\bibleverse{25} Am fünfzehnten Tage des siebenten Monats soll er sieben
...
\bibleverse{1} So spricht der Herr \textsc{Herr}: Das Tor am inneren
...
Abend. \bibleverse{3} Desgleichen das Volk im Lande soll an der Tür
desselben Tors anbeten vor dem \textsc{Herrn} an den Sabbaten und
Neumonden. \bibleverse{4} Das Brandopfer aber, das der Fürst vor dem
\textsc{Herrn} opfern soll am Sabbattage, soll sein sechs Lämmer, die
ohne Fehl seien, und ein Widder ohne Fehl; \bibleverse{5} und je ein
...
Öl zu einem Epha. \bibleverse{8} Und wenn der Fürst hineingeht, soll er
durch die Halle des Tors hineingehen und desselben Weges wieder
herausgehen. \bibleverse{9} Aber das Volk im Lande, das vor den
...
sich hinausgehen. \bibleverse{10} Der Fürst aber soll mit ihnen hinein
und heraus gehen.
...
herausgeht, soll man das Tor nach ihm zuschließen. \bibleverse{13} Und
...
ewiges Recht sein vom täglichem Opfer. \bibleverse{15} Und also sollen
sie das Lamm samt dem Speisopfer und Öl alle Morgen opfern zum täglichen
Brandopfer. \bibleverse{16} So spricht der Herr \textsc{Herr}: Wenn der
...
jemand von seinem Eigentum zerstreut werde. \bibleverse{19} Und er
...
Wasser, dass mir's an die Knöchel ging. \bibleverse{4} Und maß abermals
...
mir an die Lenden ging. \bibleverse{5} Da maß er noch tausend Ellen, und
...
\bibleverse{13} So spricht der Herr \textsc{Herr}: Dies sind die
Grenzen, nach denen ihr das Land sollt austeilen den zwölf Stämmen
Israels; denn zwei Teile gehören dem Stamm Joseph. \bibleverse{14} Und
...
\bibleverse{15} Dies ist nun die Grenze des Landes gegen Mitternacht:
von dem großen Meer an des Weges nach Hethlon gen Zedad, \bibleverse{16}
...
\bibleverse{9} Und davon sollt ihr dem \textsc{Herrn} einen Teil
...
soll mittendarin stehen. \bibleverse{11} Das soll geheiligt sein den
...
geheiligt. \bibleverse{15} Aber die übrigen 5000 Ruten in die Breite
...
stehen. \bibleverse{16} Und das soll ihr Maß sein: 4500 Ruten gegen
Mitternacht und gegen Mittag, desgleichen gegen Morgen und gegen Abend
auch 4500. \bibleverse{17} Die Vorstadt aber soll haben 250 Ruten gegen
Mitternacht und gegen Mittag, desgleichen auch gegen Morgen und gegen
Abend 250 Ruten. \bibleverse{18} Aber das Übrige an der Länge neben dem
...
Stadt arbeiten. \bibleverse{19} Und die Arbeiter aus allen Stämmen
