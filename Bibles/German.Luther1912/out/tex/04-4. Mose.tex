\hypertarget{erste-zuxe4hlung-der-kriegstuxfcchtigen-muxe4nner}{%
...
\bibleverse{1} Und der HErr redete mit Mose in der Wüste Sinai in der
Hütte des Stifts am ersten Tage des zweiten Monats im zweiten Jahr, da
sie aus Ägyptenland gegangen waren, und sprach: \bibleverse{2} Nehmet
...
\bibleverse{3} von 20 Jahren an und darüber, was ins Heer zu ziehen
taugt in Israel; ihr sollt sie zählen nach ihren Heeren, du und Aaron.
\bibleverse{4} Und sollt zu euch nehmen je vom Stamm einen Hauptmann
über sein Vaterhaus. \bibleverse{5} Dies sind aber die Namen der
...
Jahren an und darüber, von Haupt zu Haupt, \bibleverse{19} wie der HErr
dem Mose geboten hatte, und zählten sie in der Wüste Sinai.

\hypertarget{die-ergebnisse-der-zuxe4hlung}{%
...
darunter gezählt. \bibleverse{48} Und der HErr redete mit Mose und
sprach: \bibleverse{49} Den Stamm Levi sollst du nicht zählen noch ihre
Summe nehmen unter den Kindern Israel, \bibleverse{50} sondern du sollst
...
sollen sein pflegen und um die Wohnung her sich lagern. \footnote{\textbf{1:50}
  4Mo 4,-1; 4Mo 3,23-38} \bibleverse{51} Und wenn man reisen soll, so
...
\bibleverse{52} Die Kinder Israel sollen sich lagern, ein jeglicher in
sein Lager und zu dem Panier seiner Schar. \bibleverse{53} Aber die
...
\bibleverse{54} Und die Kinder Israel taten alles, wie der HErr dem Mose
geboten hatte.
...
\bibleverse{1} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{2} Die Kinder Israel sollen vor der Hütte des Stifts umher
...
\bibleverse{34} Und die Kinder Israel taten alles, wie der HErr dem Mose
...
der HErr mit Mose redete auf dem Berge Sinai. \footnote{\textbf{3:1} 2Mo
  6,23} \bibleverse{2} Und dies sind die Namen der Söhne Aarons: der
...
\bibleverse{4} Aber Nadab und Abihu starben vor dem HErrn, da sie
...
\bibleverse{5} Und der HErr redete mit Mose und sprach: \bibleverse{6}
Bringe den Stamm Levi herzu und stelle sie vor den Priester Aaron, dass
sie ihm dienen \footnote{\textbf{3:6} 2Mo 32,29} \bibleverse{7} und
seiner und der ganzen Gemeinde Hut warten vor der Hütte des Stifts und
dienen am Dienst der Wohnung \bibleverse{8} und warten alles Gerätes der
Hütte des Stifts und der Hut der Kinder Israel, zu dienen am Dienst der
Wohnung. \bibleverse{9} Und sollst die Leviten Aaron und seinen Söhnen
zuordnen zum Geschenk von den Kindern Israel. \bibleverse{10} Aaron aber
...
\bibleverse{11} Und der HErr redete mit Mose und sprach: \bibleverse{12}
...
dass die Leviten sollen mein sein. \bibleverse{13} Denn die Erstgeburten
...
\hypertarget{zuxe4hlung-lagerplatz-anfuxfchrer-und-dienstordnung-der-muxe4nnlichen-leviten}{%
...
\bibleverse{14} Und der HErr redete mit Mose in der Wüste Sinai und
sprach: \bibleverse{15} Zähle die Kinder Levi nach ihren Vaterhäusern
und Geschlechtern, alles, was männlich ist, einen Monat alt und darüber.

\bibleverse{16} Also zählte sie Mose nach dem Wort des HErrn, wie er
geboten hatte.
...
\bibleverse{40} Und der HErr sprach zu Mose: Zähle alle Erstgeburt, was
männlich ist unter den Kindern Israel, einen Monat alt und darüber, und
nimm die Zahl ihrer Namen. \bibleverse{41} Und sollst die Leviten mir,
...
\bibleverse{42} Und Mose zählte, wie ihm der HErr geboten hatte, alle
Erstgeburt unter den Kindern Israel; \bibleverse{43} und fand sich die
Zahl der Namen aller Erstgeburt, was männlich war, einen Monat alt und
darüber, in ihrer Summe 22.273.

\bibleverse{44} Und der HErr redete mit Mose und sprach: \bibleverse{45}
...
\footnote{\textbf{3:45} 4Mo 3,12} \bibleverse{46} Aber als Lösegeld von
den 273 Erstgeburten der Kinder Israel, die über der Leviten Zahl sind,
\footnote{\textbf{3:46} 4Mo 3,39; 4Mo 3,43} \bibleverse{47} sollst du je
fünf Silberlinge nehmen von Haupt zu Haupt nach dem Lot des Heiligtums
(20 Gera hat ein Lot) \bibleverse{48} und sollst das Geld für die, die
...
\bibleverse{1} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{2} Nimm die Summe der Kinder Kahath aus den Kindern Levi
nach ihren Geschlechtern und Vaterhäusern, \bibleverse{3} von 30 Jahren
...
\bibleverse{17} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{18} Ihr sollt den Stamm der Geschlechter der Kahathiter
nicht lassen sich verderben unter den Leviten; \bibleverse{19} sondern
...
\bibleverse{20} Sie sollen aber nicht hineingehen, zu schauen das
Heiligtum auch nur einen Augenblick, dass sie nicht sterben.

\bibleverse{21} Und der HErr redete mit Mose und sprach: \bibleverse{22}
Nimm die Summe der Kinder Gerson auch nach ihren Vaterhäusern und
Geschlechtern, \bibleverse{23} von 30 Jahren an und darüber bis ins 50.
...
\bibleverse{1} Und der HErr redete mit Mose und sprach: \bibleverse{2}
...
\footnote{\textbf{5:2} 3Mo 13,46; 3Mo 15,2} \bibleverse{3} Beide, Mann
...
\hypertarget{veruntreuungen-und-deren-suxfchne}{%
...
versündigt, so hat die Seele eine Schuld auf sich; \footnote{\textbf{5:6}
  3Mo 5,21-26} \bibleverse{7} und sie sollen ihre Sünde bekennen, die
...
verschuldigt haben. \bibleverse{8} Ist aber niemand da, dem man's
bezahlen sollte, so soll man's dem HErrn geben für den Priester außer
dem Widder der Versöhnung, dadurch er versöhnt wird. \bibleverse{9}
Desgleichen soll alle Hebe von allem, was die Kinder Israel heiligen und
dem Priester opfern, sein sein. \bibleverse{10} Und wer etwas heiligt,
...
Weib untreu würde und sich an ihm versündigte \bibleverse{13} und jemand
...
überführen, denn sie ist nicht dabei ergriffen, \bibleverse{14} und der
Eifergeist entzündet ihn, dass er um sein Weib eifert, sie sei unrein
oder nicht unrein, \bibleverse{15} so soll er sie zum Priester bringen
...
Eiferopfer und Rügeopfer, das Missetat rügt. \bibleverse{16} Da soll sie
der Priester herzuführen und vor den HErrn stellen \bibleverse{17} und
heiliges Wasser nehmen in ein irdenes Gefäß und Staub vom Boden der
Wohnung ins Wasser tun. \footnote{\textbf{5:17} 2Mo 30,18}
\bibleverse{18} Und soll das Weib vor den HErrn stellen und ihr Haupt
...
HErrn weben und auf dem Altar opfern, nämlich: \bibleverse{26} er soll
...
\bibleverse{31} Und der Mann soll unschuldig sein an der Missetat; aber
...
besonderes Gelübde tut, dem HErrn sich zu enthalten, \bibleverse{3} der
...
essen. \footnote{\textbf{6:3} Lk 1,15} \bibleverse{4} Solange solch ein
...
\bibleverse{6} Die ganze Zeit über, die er dem HErrn gelobt hat, soll er
zu keinem Toten gehen. \bibleverse{7} Er soll sich auch nicht
...
Haupt. \footnote{\textbf{6:7} 3Mo 21,11} \bibleverse{8} Die ganze Zeit
...
sein Haupt desselben Tages heiligen, \bibleverse{12} dass er dem HErrn
...
des Stifts. \bibleverse{14} Und er soll bringen sein Opfer dem HErrn,
...
\bibleverse{15} und einen Korb mit ungesäuerten Kuchen von Semmelmehl,
mit Öl gemengt, und ungesäuerte Fladen, mit Öl bestrichen, und ihre
Speisopfer und Trankopfer. \bibleverse{16} Und der Priester soll's vor
den HErrn bringen und soll sein Sündopfer und sein Brandopfer machen.
\bibleverse{17} Und den Widder soll er zum Dankopfer machen dem HErrn
samt dem Korbe mit dem ungesäuerten Brot; und soll auch sein Speisopfer
und sein Trankopfer machen. \bibleverse{18} Und der Geweihte soll das
...
dem Dankopfer ist. \bibleverse{19} Und der Priester soll den gekochten
...
\bibleverse{22} Und der HErr redete mit Mose und sprach: \bibleverse{23}
Sage Aaron und seinen Söhnen und sprich: Also sollt ihr sagen zu den
Kindern Israel, wenn ihr sie segnet: \bibleverse{24} Der HErr segne dich
und behüte dich; \footnote{\textbf{6:24} Ps 121,-1} \bibleverse{25} der
HErr lasse sein Angesicht leuchten über dir und sei dir gnädig;
\footnote{\textbf{6:25} Ps 80,4} \bibleverse{26} der HErr hebe sein
...
gezählt waren. \bibleverse{3} Und sie brachten ihre Opfer vor den HErrn,
...
\bibleverse{4} Und der HErr sprach zu Mose: \bibleverse{5} Nimm's von
...
\bibleverse{11} Und der HErr sprach zu Mose: Lass einen jeglichen
...
\bibleverse{4} Der Leuchter aber war getriebenes Gold, beide, sein
Schaft und seine Blumen; nach dem Gesicht, das der HErr dem Mose gezeigt
hatte, also machte er den Leuchter.

\hypertarget{die-weihe-der-leviten-als-einer-heiligen-gabe-an-gott}{%
...
\bibleverse{5} Und der HErr redete mit Mose und sprach: \bibleverse{6}
Nimm die Leviten aus den Kindern Israel und reinige sie. \bibleverse{7}
...
Hände auf die Leviten legen, \bibleverse{11} und Aaron soll die Leviten
...
gemacht werden, die Leviten zu versöhnen. \bibleverse{13} Und sollst die
Leviten vor Aaron und seine Söhne stellen und vor dem HErrn weben,
\bibleverse{14} und sollst sie also aussondern von den Kindern Israel,
...
rein wurden. \footnote{\textbf{8:21} 4Mo 8,11} \bibleverse{22} Darnach
...
\bibleverse{23} Und der HErr redete mit Mose und sprach: \bibleverse{24}
Das ist's, was den Leviten gebührt: von 25 Jahren und darüber taugen sie
zum Amt und Dienst in der Hütte des Stifts; \bibleverse{25} aber von dem
50. Jahr an sollen sie ledig sein vom Amt des Dienstes und sollen nicht
mehr dienen, \bibleverse{26} sondern ihren Brüdern helfen des Dienstes
...
\bibleverse{1} Und der HErr redete mit Mose in der Wüste Sinai im
...
Mose geboten hatte, so taten die Kinder Israel. \bibleverse{6} Da waren
...
Tages \bibleverse{7} und sprachen zu ihm: Wir sind unrein geworden an
...
\bibleverse{9} Und der HErr redete mit Mose und sprach: \bibleverse{10}
...
soll dennoch dem HErrn Passah halten, \bibleverse{11} aber im zweiten
Monat, am 14. Tage gegen Abend, und soll's neben ungesäuertem Brot und
bitteren Kräutern essen, \bibleverse{12} und sie sollen nichts davon
übriglassen bis morgen, auch kein Bein daran zerbrechen, und sollen's
nach aller Weise des Passah halten. \bibleverse{13} Wer aber rein und
...
\bibleverse{14} Und wenn ein Fremdling bei euch wohnt und auch dem HErrn
...
\bibleverse{18} Nach dem Wort des HErrn zogen die Kinder Israel, und
nach seinem Wort lagerten sie sich. Solange die Wolke auf der Wohnung
blieb, so lange lagen sie still. \bibleverse{19} Und wenn die Wolke
viele Tage verzog auf der Wohnung, so taten die Kinder Israel nach dem
Gebot des HErrn und zogen nicht. \bibleverse{20} Und wenn's war, dass
...
\bibleverse{21} Wenn die Wolke da war von Abend bis an den Morgen und
sich dann erhob, so zogen sie; oder wenn sie sich des Tages oder des
Nachts erhob, so zogen sie auch. \bibleverse{22} Wenn sie aber zwei Tage
...
\bibleverse{23} Denn nach des HErrn Mund lagen sie, und nach des HErrn
...
\bibleverse{3} Wenn man mit beiden schlicht bläst, soll sich zu dir
...
\bibleverse{13} Es brachen aber auf die ersten nach dem Wort des HErrn
durch Mose; \bibleverse{14} nämlich das Panier des Lagers der Kinder
Juda zog am ersten mit ihrem Heer, und über ihr Heer war Nahesson, der
Sohn Amminadabs; \bibleverse{15} und über das Heer des Stammes der
Kinder Isaschar war Nathanael, der Sohn Zuars; \bibleverse{16} und über
das Heer des Stammes der Kinder Sebulon war Eliab, der Sohn Helons.
\bibleverse{17} Da zerlegte man die Wohnung, und zogen die Kinder Gerson
und Merari und trugen die Wohnung. \bibleverse{18} Darnach zog das
Panier des Lagers Rubens mit ihrem Heer, und über ihr Heer war Elizur,
der Sohn Sedeurs; \bibleverse{19} und über das Heer des Stammes der
Kinder Simeon war Selumiel, der Sohn Zuri-Saddais; \bibleverse{20} und
...
\bibleverse{32} Und wenn du mit uns ziehst: was der HErr Gutes an uns
...
ihnen zu weisen, wo sie ruhen sollten. \bibleverse{34} Und die Wolke des
HErrn war des Tages über ihnen, wenn sie aus dem Lager zogen.
\bibleverse{35} Und wenn die Lade zog, so sprach Mose: HErr, stehe auf!
lass deine Feinde zerstreut und die dich hassen, flüchtig werden vor
dir! \footnote{\textbf{10:35} Ps 68,2; Ps 132,8} \bibleverse{36} Und
...
äußersten Lager. \bibleverse{2} Da schrie das Volk zu Mose, und Mose bat
den HErrn; da verschwand das Feuer. \bibleverse{3} Und man hieß die
...
\hypertarget{die-klage-moses-vor-gott}{%
...
Zorn des HErrn sehr, und Mose ward auch bange. \bibleverse{11} Und Mose
...
auf mich legst? \bibleverse{12} Habe ich nun all das Volk empfangen oder
...
\bibleverse{13} Woher soll ich Fleisch nehmen, dass ich allem diesem
Volk gebe? Sie weinen vor mir und sprechen: Gib uns Fleisch, dass wir
essen. \bibleverse{14} Ich vermag alles das Volk nicht allein zu
ertragen; denn es ist mir zu schwer. \bibleverse{15} Und willst du also
...
\bibleverse{16} Und der HErr sprach zu Mose: Sammle mir 70 Männer unter
...
\bibleverse{17} so will ich herniederkommen und mit dir daselbst reden
...
esset, \footnote{\textbf{11:18} 2Mo 19,10} \bibleverse{19} nicht einen
Tag, nicht zwei, nicht fünf, nicht zehn, nicht zwanzig Tage lang,
\bibleverse{20} sondern einen Monat lang, bis dass es euch zur Nase
...
\bibleverse{23} Der HErr aber sprach zu Mose: Ist denn die Hand des
...
\bibleverse{24} Und Mose ging heraus und sagte dem Volk des HErrn Worte
und versammelte 70 Männer unter den Ältesten des Volks und stellte sie
um die Hütte her. \bibleverse{25} Da kam der HErr hernieder in der Wolke
...
\bibleverse{31} Da fuhr aus der Wind von dem HErrn und ließ Wachteln
...
Erde. \bibleverse{32} Da machte sich das Volk auf denselben ganzen Tag
...
hängten sie auf um das Lager her. \bibleverse{33} Da aber das Fleisch
...
Plage. \bibleverse{34} Daher heißt diese Stätte Lustgräber, darum dass
...
Weibe genommen hatte, \bibleverse{2} und sprachen: Redet denn der HErr
allein durch Mose? Redet er nicht auch durch uns? Und der HErr hörte es.
\bibleverse{3} Aber Mose war ein sehr geplagter Mensch über alle
Menschen auf Erden.
...
\bibleverse{4} Und plötzlich sprach der HErr zu Mose und zu Aaron und zu
Mirjam: Gehet heraus, ihr drei, zu der Hütte des Stifts. Und sie gingen
alle drei heraus.

\bibleverse{5} Da kam der HErr hernieder in der Wolkensäule und trat in
der Hütte Tür und rief Aaron und Mirjam; und die gingen beide hinaus.
\footnote{\textbf{12:5} 2Mo 16,10} \bibleverse{6} Und er sprach: Höret
...
\bibleverse{7} Aber nicht also mein Knecht Mose, der in meinem ganzen
Hause treu ist. \bibleverse{8} Mündlich rede ich mit ihm, und er sieht
...
reden? \footnote{\textbf{12:8} 2Mo 33,11; 2Mo 33,23} \bibleverse{9} Und
...
\bibleverse{13} Mose aber schrie zu dem HErrn und sprach: Ach Gott,
heile sie! \footnote{\textbf{12:13} 2Mo 15,26}

\bibleverse{14} Der HErr sprach zu Mose: Wenn ihr Vater ihr ins
...
\bibleverse{1} Und der HErr redet mit Mose und sprach: \bibleverse{2}
...
\bibleverse{4} Und hießen also: Sammua, der Sohn Sakkurs, des Stammes
Ruben; \bibleverse{5} Saphat, der Sohn Horis, des Stammes Simeon;
\bibleverse{6} Kaleb, der Sohn Jephunnes, des Stammes Juda; \footnote{\textbf{13:6}
  Jos 14,7} \bibleverse{7} Jigeal, der Sohn Josephs, des Stammes
Isaschar; \bibleverse{8} Hosea, der Sohn Nuns, des Stammes Ephraim;
\bibleverse{9} Palti, der Sohn Raphus, des Stammes Benjamin;
\bibleverse{10} Gaddiel, der Sohn Sodis, des Stammes Sebulon;
...
\bibleverse{21} Sie gingen hinauf und erkundeten das Land von der Wüste
Zin bis gen Rehob, da man gen Hamath geht. \bibleverse{22} Sie gingen
...
vor Zoan in Ägypten. \bibleverse{23} Und sie kamen bis an den Bach Eskol
...
\bibleverse{24} Der Ort heißt Bach Eskol um der Traube willen, die die
Kinder Israel daselbst abschnitten. \bibleverse{25} Und sie kehrten um,
als sie das Land erkundet hatten, nach 40 Tagen,

\hypertarget{ruxfcckkehr-und-bericht-der-ausgesandten}{%
...
nach Ägypten? \footnote{\textbf{14:3} Ps 106,24} \bibleverse{4} Und
...
erkunden, ist sehr gut. \bibleverse{8} Wenn der HErr uns gnädig ist, so
wird er uns in das Land bringen und es uns geben, ein Land, darin Milch
und Honig fließt. \footnote{\textbf{14:8} 4Mo 13,27} \bibleverse{9}
...
\bibleverse{11} Und der HErr sprach zu Mose: Wie lange lästert mich
...
\bibleverse{13} Mose aber sprach zu dem HErrn: So werden's die Ägypter
hören; denn du hast dieses Volk mit deiner Kraft mitten aus ihnen
geführt. \bibleverse{14} Und man wird es sagen zu den Einwohnern dieses
...
Feuersäule des Nachts. \bibleverse{15} Würdest du nun dieses Volk töten,
wie einen Mann, so würden die Heiden sagen, die solch Gerücht von dir
hörten, und sprechen: \bibleverse{16} Der HErr konnte mitnichten dieses
Volk in das Land bringen, das er ihnen geschworen hatte; darum hat er
sie geschlachtet in der Wüste. \bibleverse{17} So lass nun die Kraft des
HErrn groß werden, wie du gesagt hast und gesprochen: \bibleverse{18}
...
\bibleverse{20} Und der HErr sprach: Ich habe es vergeben, wie du gesagt
hast. \bibleverse{21} Aber so wahr als ich lebe, so soll alle Welt der
Herrlichkeit des HErrn voll werden. \bibleverse{22} Denn alle die
...
und meiner Stimme nicht gehorcht haben, \bibleverse{23} deren soll
...
soll es sehen, der mich verlästert hat. \footnote{\textbf{14:23} Ps
  95,11; Hebr 3,17-19} \bibleverse{24} Aber meinen Knecht Kaleb, darum
...
\hypertarget{die-strafe-gottes-fuxfcr-volk-und-kundschafter}{%
\subsection{Die Strafe Gottes für Volk und
Kundschafter}\label{die-strafe-gottes-fuxfcr-volk-und-kundschafter}}

\bibleverse{26} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{27} Wie lange murrt diese böse Gemeinde wider mich? Denn ich
habe das Murren der Kinder Israel, das sie wider mich gemurrt haben,
gehört. \bibleverse{28} Darum sprich zu ihnen: So wahr ich lebe, spricht
der HErr, ich will euch tun, wie ihr vor meinen Ohren gesagt habt.
\bibleverse{29} Eure Leiber sollen in dieser Wüste verfallen; und alle,
die ihr gezählt seid von 20 Jahren und darüber, die ihr wider mich
gemurrt habt, \bibleverse{30} sollt nicht in das Land kommen, darüber
ich meine Hand gehoben habe, dass ich euch darin wohnen ließe, außer
Kaleb, dem Sohn Jephunnes, und Josua, dem Sohn Nuns. \bibleverse{31}
...
\bibleverse{32} Aber ihr samt euren Leibern sollt in dieser Wüste
verfallen. \bibleverse{33} Und eure Kinder sollen Hirten sein in dieser
Wüste 40 Jahre und eure Untreue tragen, bis dass eure Leiber aufgerieben
werden in der Wüste, \bibleverse{34} nach der Zahl der 40 Tage, darin
...
ich die Hand abziehe. \footnote{\textbf{14:34} Jer 2,19} \bibleverse{35}
...
\bibleverse{36} Also starben durch die Plage vor dem HErrn alle die
Männer, die Mose gesandt hatte, das Land zu erkunden, und wiedergekommen
waren und wider ihn murren machten die ganze Gemeinde, \bibleverse{37}
damit dass sie dem Lande ein Geschrei machten, dass es böse wäre.
\bibleverse{38} Aber Josua, der Sohn Nuns, und Kaleb, der Sohn
Jephunnes, blieben lebendig aus den Männern, die gegangen waren, das
Land zu erkunden. \footnote{\textbf{14:38} 4Mo 14,30}

\hypertarget{die-reue-des-volkes-der-verungluxfcckte-versuch-in-das-feindliche-land-einzudringen}{%
...
HErrn? Es wird euch nicht gelingen. \bibleverse{42} Ziehet nicht hinauf
-- denn der HErr ist nicht unter Euch --, dass ihr nicht geschlagen
werdet vor euren Feinden. \bibleverse{43} Denn die Amalekiter und
...
dem Lager. \bibleverse{45} Da kamen die Amalekiter und Kanaaniter, die
...
eurer Wohnung kommt, das ich euch geben werde, \bibleverse{3} und wollt
...
\bibleverse{4} wer nun seine Gabe dem HErrn opfern will, der soll das
Speisopfer tun, ein Zehntel Semmelmehl, mit einem viertel Hin Öl;
\bibleverse{5} und Wein zum Trankopfer, auch ein viertel Hin, zu dem
...
das sollst du dem HErrn zum süßen Geruch opfern. \bibleverse{8} Willst
du aber ein Rind zum Brandopfer oder zum besonderen Gelübdeopfer oder
zum Dankopfer dem HErrn machen, \bibleverse{9} so sollst du zu dem Rind
...
das ist ein Opfer dem HErrn zum süßen Geruch. \bibleverse{11} Also
sollst du tun mit einem Ochsen, mit einem Widder, mit einem Schaf oder
mit einer Ziege. \bibleverse{12} Darnach die Zahl dieser Opfer ist,
...
dem HErrn opfere ein Opfer zum süßen Geruch. \bibleverse{14} Und wenn
...
tut. \bibleverse{15} Der ganzen Gemeinde sei eine Satzung, euch sowohl
als den Fremdlingen; eine ewige Satzung soll das sein euren Nachkommen,
dass vor dem HErrn der Fremdling sei wie ihr. \bibleverse{16} Ein
...
\bibleverse{17} Und der HErr redete mit Mose und sprach: \bibleverse{18}
Rede mit den Kindern Israel und sprich zu ihnen: Wenn ihr in das Land
kommt, darein ich euch bringen werde, \bibleverse{19} dass ihr esset von
...
\bibleverse{21} also sollt ihr auch dem HErrn eures Teiges Erstling zur
...
tut, die der HErr zu Mose geredet hat, \bibleverse{23} alles, was der
HErr euch durch Mose geboten hat, von dem Tage an, da er anfing zu
gebieten auf eure Nachkommen; \bibleverse{24} wenn nun ohne Wissen der
...
einen Ziegenbock zum Sündopfer. \bibleverse{25} Und der Priester soll
...
versöhne und ihr vergeben werde. \bibleverse{29} Und es soll ein Gesetz
...
soll ausgerottet werden aus ihrem Volk; \bibleverse{31} denn sie hat des
...
\bibleverse{35} Der HErr aber sprach zu Mose: Der Mann soll des Todes
...
\bibleverse{37} Und der HErr sprach zu Mose: \bibleverse{38} Rede mit
...
auf die Quasten an die Zipfel tun; \bibleverse{39} und sollen euch die
...
euren Augen euch umtreiben lasset und abgöttisch werdet. \bibleverse{40}
...
Gemeinde, Ratsherren und namhafte Leute. \footnote{\textbf{16:2} 4Mo
  12,1-2} \bibleverse{3} Und sie versammelten sich wider Mose und Aaron
...
\hypertarget{mose-tritt-der-rotte-korahs-entgegen-und-kuxfcndigt-ihnen-ein-gottesurteil-am-heiligtum-an}{%
...
ihm nahen soll; welchen er erwählt, der soll zu ihm nahen. \footnote{\textbf{16:5}
  2Tim 2,19} \bibleverse{6} Das tut: nehmet euch Pfannen, Korah und
seine ganze Rotte, \bibleverse{7} und legt Feuer darein und tut
...
\bibleverse{15} Da ergrimmte Mose sehr und sprach zu dem HErrn: Wende
...
morgen vor dem HErrn sein; du, sie auch und Aaron. \bibleverse{17} Und
...
\bibleverse{20} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{21} Scheidet euch von dieser Gemeinde, dass ich sie
plötzlich vertilge.
...
HErr nicht gesandt; \bibleverse{30} wird aber der HErr etwas Neues
...
\bibleverse{35} Dazu fuhr das Feuer aus von dem HErrn und fraß die 250
...
aufhebe aus dem Brand und streue das Feuer hin und her; \bibleverse{3}
...
den Kindern Israel zum Zeichen sein. \bibleverse{4} Und Eleasar, der
Priester, nahm die ehernen Pfannen, die die Verbrannten geopfert hatten,
und schlug sie zu Blechen, den Altar zu überziehen, \bibleverse{5} zum
...
Volk getötet. \bibleverse{7} Und da sich die Gemeinde versammelte wider
...
\bibleverse{8} Und Mose und Aaron gingen herzu vor die Hütte des Stifts.
\bibleverse{9} Und der HErr redete mit Mose und sprach:

\bibleverse{10} Hebt euch aus dieser Gemeinde; ich will sie plötzlich
vertilgen! Und sie fielen auf ihr Angesicht. \footnote{\textbf{17:19}
  2Mo 25,22} \bibleverse{11} Und Mose sprach zu Aaron: Nimm die Pfanne
...
gewehrt. \bibleverse{16} Und der HErr redete mit Mose und sprach:
\bibleverse{17} Sage den Kindern Israel und nimm von ihnen zwölf
...
\footnote{\textbf{18:1} 2Mo 28,38; 3Mo 16,32-33} \bibleverse{20} Und
welchen ich erwählen werde, des Stecken wird grünen, dass ich das Murren
der Kinder Israel, das sie wider euch murren, stille. \bibleverse{21}
...
\bibleverse{22} Und Mose legte die Stecken vor den HErrn in der Hütte
des Zeugnisses. \bibleverse{23} Des Morgens aber, da Mose in die Hütte
des Zeugnisses ging, fand er den Stecken Aarons des Hauses Levi grünen
und die Blüte aufgegangen und Mandeln tragen. \bibleverse{24} Und Mose
...
dass ihr Murren von mir aufhöre, dass sie nicht sterben. \bibleverse{26}
...
\bibleverse{28} Wer sich naht zu der Wohnung des HErrn, der stirbt.
...
\bibleverse{1} Und der HErr sprach zu Aaron: Du und deine Söhne und
...
\textsuperscript{a} \bibleverse{2} Aber deine Brüder des Stammes Levis,
...
\textsuperscript{b} \bibleverse{3} Und sie sollen deines Dienstes und
...
ihr, sterbet; \bibleverse{4} sondern sie sollen bei dir sein, dass sie
des Dienstes warten an der Hütte des Stifts in allem Amt der Hütte; und
kein Fremder soll sich zu euch tun. \bibleverse{5} So wartet nun des
Dienstes des Heiligtums und des Dienstes des Altars, dass hinfort nicht
mehr ein Wüten komme über die Kinder Israel. \bibleverse{6} Denn siehe,
...
\bibleverse{8} Und der HErr sagte zu Aaron: Siehe, ich habe dir gegeben
...
und deinen Söhnen zum ewigen Recht. \footnote{\textbf{18:8} 3Mo 2,3; 3Mo
  2,10; 3Mo 6,9-11; 3Mo 6,19-22; 3Mo 7,6-10} \bibleverse{9} Das sollst
...
Söhnen ein Hochheiliges sein. \bibleverse{10} An einem hochheiligen Ort
sollst du es essen. Was männlich ist, soll davon essen; denn es soll dir
heilig sein. \bibleverse{11} Ich habe auch das Hebopfer ihrer Gabe an
...
davon essen. \bibleverse{12} Alles beste Öl und alles Beste vom Most und
Korn, nämlich ihre Erstlinge, die sie dem HErrn geben, habe ich dir
gegeben. \bibleverse{13} Die erste Frucht, die sie dem HErrn bringen von
...
\bibleverse{14} Alles Verbannte in Israel soll dein sein. \footnote{\textbf{18:14}
  3Mo 27,28} \bibleverse{15} Alles, was die Mutter bricht unter allem
...
zum Opfer des süßen Geruchs dem HErrn. \bibleverse{18} Ihr Fleisch soll
dein sein, wie auch die Webebrust und die rechte Schulter dein ist.
\bibleverse{19} Alle Hebopfer, die die Kinder Israel heiligen dem HErrn,
...
\bibleverse{20} Und der HErr sprach zu Aaron: Du sollst in ihrem Lande
nichts besitzen, auch kein Teil unter ihnen haben; denn ich bin dein
Teil und dein Erbgut unter den Kindern Israel. \bibleverse{21} Den
...
\bibleverse{25} Und der HErr redete mit Mose und sprach: \bibleverse{26}
...
Zehnten; \bibleverse{27} und sollt solch euer Hebopfer achten, als gäbet
ihr Korn aus der Scheune und Fülle aus der Kelter. \bibleverse{28} Also
...
dem Priester Aaron gebet. \bibleverse{29} Von allem, was euch gegeben
wird, sollt ihr dem HErrn allerlei Hebopfer geben, von allem Besten das,
was davon geheiligt wird. \bibleverse{30} Und sprich zu ihnen: Wenn ihr
...
\bibleverse{1} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{2} Diese Weise soll ein Gesetz sein, das der HErr geboten
...
besprengt; darum ist er unrein. \bibleverse{21} Und dies soll ihnen ein
...
unrein sein bis an den Abend. \bibleverse{22} Und alles, was der Unreine
...
\bibleverse{2} Und die Gemeinde hatte kein Wasser, und sie versammelten
sich wider Mose und Aaron. \footnote{\textbf{20:2} 2Mo 17,1-7}
\bibleverse{3} Und das Volk haderte mit Mose und sprach: Ach, dass wir
umgekommen wären, da unsere Brüder umkamen vor dem HErrn! \bibleverse{4}
Warum habt ihr die Gemeinde des HErrn in diese Wüste gebracht, dass wir
hier sterben mit unserem Vieh? \bibleverse{5} Und warum habt ihr uns aus
...
\bibleverse{7} Und der HErr redete mit Mose und sprach: \bibleverse{8}
...
ihr Vieh. \bibleverse{9} Da nahm Mose den Stab vor dem HErrn, wie er ihm
geboten hatte. \bibleverse{10} Und Mose und Aaron versammelten die
...
werden wir euch auch Wasser bringen aus diesem Fels? \footnote{\textbf{20:10}
  Ps 106,33} \bibleverse{11} Und Mose hob seine Hand auf und schlug den
Fels mit dem Stab zweimal. Da ging viel Wasser heraus, dass die Gemeinde
trank und ihr Vieh. \bibleverse{12} Der HErr aber sprach zu Mose und
...
\bibleverse{22} Und die Kinder Israel brachen auf von Kades und kamen
mit der ganzen Gemeinde an den Berg Hor. \bibleverse{23} Und der HErr
redete mit Mose und Aaron am Berge Hor, an den Grenzen des Landes der
Edomiter, und sprach: \bibleverse{24} Lass sich Aaron sammeln zu seinem
...
dem Haderwasser. \bibleverse{25} Nimm aber Aaron und seinen Sohn Eleasar
und führe sie auf den Berg Hor \bibleverse{26} und zieh Aaron seine
...
\bibleverse{27} Da tat Mose, wie ihm der HErr geboten hatte, und sie
stiegen auf den Berg Hor vor der ganzen Gemeinde. \bibleverse{28} Und
...
stiegen herab vom Berge. \bibleverse{29} Und da die ganze Gemeinde sah,
...
\bibleverse{2} Da gelobte Israel dem HErrn ein Gelübde und sprach: Wenn
...
verbannen. \footnote{\textbf{21:2} 5Mo 13,16; Jos 6,17; Ri 1,17; 1Sam
  15,3} \bibleverse{3} Und der HErr erhörte die Stimme Israels und gab
...
vor dieser mageren Speise. \bibleverse{6} Da sandte der HErr feurige
Schlangen unter das Volk; die bissen das Volk, dass viel Volks in Israel
starb. \footnote{\textbf{21:6} 1Kor 10,9} \bibleverse{7} Da kamen sie zu
...
nehme. Mose bat für das Volk. \bibleverse{8} Da sprach der HErr zu Mose:
Mache dir eine eherne Schlange und richte sie zum Zeichen auf; wer
gebissen ist und sieht sie an, der soll leben. \bibleverse{9} Da machte
...
\bibleverse{14} Daher heißt es in dem Buch von den Kriegen des HErrn:
„Das Vaheb in Supha und die Bäche Arnon \bibleverse{15} und die Quelle
der Bäche, welche reicht hinan zur Stadt Ar und lenkt sich und ist die
Grenze Moabs.`` \bibleverse{16} Und von da zogen sie zum Brunnen. Das
ist der Brunnen, davon der HErr zu Mose sagte: Sammle das Volk, ich will
ihnen Wasser geben. \bibleverse{17} Da sang Israel das Lied: „Brunnen,
steige auf! Singet von ihm! \bibleverse{18} Das ist der Brunnen, den die
...
\bibleverse{19} und von Matthana gen Nahaliel; und von Nahaliel gen
Bamoth; \bibleverse{20} und von Bamoth in das Tal, das im Felde Moab
liegt, zu dem hohen Berge Pisga, der gegen die Wüste sieht.

\bibleverse{21} Und Israel sandte Boten zu Sihon, dem König der
...
zu streiten in Edrei. \bibleverse{34} Und der HErr sprach zu Mose:
...
der Amoriter, getan hast, der zu Hesbon wohnte. \footnote{\textbf{21:34}
  Ps 136,17-22} \bibleverse{35} Und sie schlugen ihn und seine Söhne und
...
Fürsten der Moabiter bei Bileam. \bibleverse{9} Und Gott kam zu Bileam
und sprach: Wer sind die Leute, die bei dir sind? \bibleverse{10} Bileam
sprach zu Gott: Balak, der Sohn Zippors, der Moabiter König, hat zu mir
gesandt: \bibleverse{11} Siehe, ein Volk ist aus Ägypten gezogen und
bedeckt das Angesicht der Erde; so komm nun und fluche ihm, ob ich mit
ihm streiten möge und sie vertreiben. \bibleverse{12} Gott aber sprach
zu Bileam: Gehe nicht mit ihnen, verfluche das Volk auch nicht; denn es
ist gesegnet. \bibleverse{13} Da stand Bileam des Morgens auf und sprach
zu den Fürsten Balaks: Gehet hin in euer Land; denn der HErr will's
nicht gestatten, dass ich mit euch ziehe. \bibleverse{14} Und die
...
erfahre, was der HErr weiter mit mir reden werde. \bibleverse{20} Da kam
...
sagen werde, sollst du tun. \bibleverse{21} Da stand Bileam des Morgens
auf und sattelte seine Eselin und zog mit den Fürsten der Moabiter.
\bibleverse{22} Aber der Zorn Gottes ergrimmte, dass er hinzog. Und der
...
Bileam aber schlug sie, dass sie in den Weg sollte gehen. \footnote{\textbf{22:23}
  1Mo 3,24; Jos 5,13} \bibleverse{24} Da trat der Engel des HErrn in den
Pfad bei den Weinbergen, da auf beiden Seiten Wände waren.
\bibleverse{25} Und da die Eselin den Engel des HErrn sah, drängte sie
sich an die Wand und klemmte Bileam den Fuß an der Wand; und er schlug
sie noch mehr. \bibleverse{26} Da ging der Engel des HErrn weiter und
trat an einen engen Ort, da kein Weg war zu weichen, weder zur Rechten
noch zur Linken. \bibleverse{27} Und da die Eselin den Engel des HErrn
sah, fiel sie auf ihre Knie unter Bileam. Da ergrimmte der Zorn Bileams,
und er schlug die Eselin mit dem Stabe. \bibleverse{28} Da tat der HErr
der Eselin den Mund auf, und sie sprach zu Bileam: Was habe ich dir
getan, dass du mich geschlagen hast nun dreimal? \bibleverse{29} Bileam
sprach zur Eselin: dass du mich höhnest! ach, dass ich jetzt ein Schwert
in der Hand hätte, ich wollte dich erwürgen! \bibleverse{30} Die Eselin
...
tun? Er sprach: Nein. \bibleverse{31} Da öffnete der HErr dem Bileam die
...
Angesicht. \bibleverse{32} Und der Engel des HErrn sprach zu ihm: Warum
...
\bibleverse{33} Und die Eselin hat mich gesehen und ist mir dreimal
...
\bibleverse{34} Da sprach Bileam zu dem Engel des HErrn: Ich habe
...
\bibleverse{35} Der Engel des HErrn sprach zu ihm: Zieh hin mit den
Männern; aber nichts anderes, denn was ich dir sagen werde, sollst du
reden. Also zog Bileam mit den Fürsten Balaks. \bibleverse{36} Da Balak
...
äußersten Grenze, \bibleverse{37} und sprach zu ihm: Habe ich nicht zu
dir gesandt und dich fordern lassen? Warum bist du denn nicht zu mir
gekommen? Meinst du, ich könnte dich nicht ehren? \bibleverse{38} Bileam
...
zeigt. Und ging hin eilend. \bibleverse{4} Und Gott begegnete Bileam; er
aber sprach zu ihm: Sieben Altäre habe ich zugerichtet und je auf einem
Altar einen Farren und einen Widder geopfert. \bibleverse{5} Der HErr
aber gab das Wort dem Bileam in den Mund und sprach: Gehe wieder zu
Balak und rede also. \bibleverse{6} Und da er wieder zu ihm kam, siehe,
da stand er bei seinem Brandopfer samt allen Fürsten der Moabiter.
\bibleverse{7} Da hob er an seinen Spruch und sprach: Aus Syrien hat
mich Balak, der Moabiter König, holen lassen von dem Gebirge gegen
Aufgang: Komm, verfluche mir Jakob! komm schilt Israel! \bibleverse{8}
Wie soll ich fluchen, dem Gott nicht flucht? Wie soll ich schelten, den
der HErr nicht schilt? \bibleverse{9} Denn von der Höhe der Felsen sehe
...
\bibleverse{10} Wer kann zählen den Staub Jakobs und die Zahl des
vierten Teils Israels? Meine Seele müsse sterben des Todes der
Gerechten, und mein Ende werde wie dieser Ende! \bibleverse{11} Da
...
\bibleverse{16} Und der HErr begegnete Bileam und gab ihm das Wort in
...
ihm: Was hat der HErr gesagt? \bibleverse{18} Und er hob an seinen
Spruch und sprach: Stehe auf, Balak, und höre! nimm zu Ohren was ich
sage, du Sohn Zippors! \bibleverse{19} Gott ist nicht ein Mensch, dass
...
Drommeten des Königs unter ihm. \bibleverse{22} Gott hat sie aus Ägypten
geführt; seine Freudigkeit ist wie eines Einhorns. \bibleverse{23} Denn
es ist kein Zauberer in Jakob und kein Wahrsager in Israel. Zu seiner
Zeit wird Jakob gesagt und Israel, was Gott tut. \bibleverse{24} Siehe,
...
ich tun? \bibleverse{27} Balak sprach zu ihm: Komm doch, ich will dich
...
Höhe des Berges Peor, welcher gegen die Wüste sieht. \footnote{\textbf{23:28}
  4Mo 25,3} \bibleverse{29} Und Bileam sprach zu Balak: Baue mir hier
sieben Altäre und schaffe mir sieben Farren und sieben Widder.
\footnote{\textbf{23:29} 4Mo 23,1} \bibleverse{30} Balak tat, wie Bileam
sagte, und opferte je auf einem Altar einen Farren und einen Widder.

\hypertarget{section-23}{%
\section{24}\label{section-23}}

\bibleverse{1} Da nun Bileam sah, dass es dem HErrn gefiel, dass er
Israel segnete, ging er nicht aus, wie vormals, nach Zauberei, sondern
richtete sein Angesicht stracks zu der Wüste, \bibleverse{2} hob auf
seine Augen und sah Israel, wie sie lagen nach ihren Stämmen. Und der
Geist Gottes kam auf ihn, \bibleverse{3} und er hob an seinen Spruch und
sprach: Es sagt Bileam, der Sohn Beors, es sagt der Mann, dem die Augen
geöffnet sind, \footnote{\textbf{24:3} 1Sam 9,9} \bibleverse{4} es sagt
...
die Augen geöffnet werden, wenn er niederkniet: \footnote{\textbf{24:4}
  Jes 50,4} \bibleverse{5} Wie fein sind deine Hütten, Jakob, und deine
Wohnungen, Israel! \bibleverse{6} Wie die Täler, die sich ausbreiten,
...
verwehrt. \bibleverse{12} Bileam antwortete ihm: Habe ich nicht auch zu
...
reden? \bibleverse{14} Und nun siehe, ich ziehe zu meinem Volk. So komm,
ich will dir verkündigen, was dieses Volk deinem Volk tun wird zur
letzten Zeit. \bibleverse{15} Und er hob an seinen Spruch und sprach: Es
sagt Bileam, der Sohn Beors, es sagt der Mann, dem die Augen geöffnet
sind, \footnote{\textbf{24:15} 4Mo 24,3-4} \bibleverse{16} es sagt der
...
wenn er niederkniet: \bibleverse{17} Ich sehe ihn, aber nicht jetzt; ich
...
der Moabiter und verstören alle Kinder des Getümmels. \bibleverse{18}
...
Israel aber wird Sieg haben. \footnote{\textbf{24:18} 2Sam 8,14; Am
  9,11; Am 1,9-12} \bibleverse{19} Aus Jakob wird der Herrscher kommen
und umbringen, was übrig ist von den Städten. \footnote{\textbf{24:19}
  Mi 5,1; Mi 5,7-8} \bibleverse{20} Und da er sah die Amalekiter, hob er
...
\bibleverse{21} Und da er die Keniter sah, hob er an seinen Spruch und
sprach: Fest ist deine Wohnung, und hast dein Nest in einen Fels gelegt.
\footnote{\textbf{24:21} 1Sam 15,6; Ob 1,3} \bibleverse{22} Aber, o
Kain, du wirst verbrannt werden, wenn Assur dich gefangen wegführen
wird. \bibleverse{23} Und er hob abermals an seinen Spruch und sprach:
Ach, wer wird leben, wenn Gott solches tun wird? \bibleverse{24} Und
Schiffe aus Chittim werden verderben den Assur und Eber; er aber wird
auch umkommen. \footnote{\textbf{24:24} 1Makk 1,1} \bibleverse{25} Und
...
HErrn Zorn über Israel, \footnote{\textbf{25:3} 5Mo 4,3} \bibleverse{4}
...
gewandt werde. \footnote{\textbf{25:4} 2Sam 21,6; 2Sam 21,9; 5Mo
  21,22-23} \bibleverse{5} Und Mose sprach zu den Richtern Israels:
Erwürge ein jeglicher seine Leute, die sich an den Baal-Peor gehängt
haben. \bibleverse{6} Und siehe, ein Mann aus den Kindern Israel kam und
...
Plage 24.000. \footnote{\textbf{25:9} 1Kor 10,8} \bibleverse{10} Und der
HErr redete mit Mose und sprach: \bibleverse{11} Pinehas, der Sohn
...
meinem Eifer die Kinder Israel vertilgte. \bibleverse{12} Darum sage:
Siehe, ich gebe ihm meinen Bund des Friedens; \bibleverse{13} und er
...
hat. \footnote{\textbf{25:13} Ps 106,30-31} \bibleverse{14} Der
...
Midianitern. \bibleverse{16} Und der HErr redete mit Mose und sprach:
\bibleverse{17} Tut den Midianitern Schaden und schlagt sie; \footnote{\textbf{25:17}
  4Mo 31,2-10} \bibleverse{18} denn sie haben euch Schaden getan mit
...
\bibleverse{1} Und es geschah, nach der Plage sprach der HErr zu Mose
und Eleasar, dem Sohn des Priesters Aaron: \bibleverse{2} Nehmt die
...
\bibleverse{4} die 20 Jahre alt waren und darüber, wie der HErr dem Mose
geboten hatte und den Kindern Israel, die aus Ägypten gezogen waren.
\bibleverse{5} Ruben, der Erstgeborene Israels. Die Kinder Rubens aber
...
\bibleverse{10} und die Erde ihren Mund auftat und sie verschlang mit
Korah, da die Rotte starb, da das Feuer 250 Männer fraß und sie ein
Zeichen wurden. \bibleverse{11} Aber die Kinder Korahs starben nicht.
\bibleverse{12} Die Kinder Simeons in ihren Geschlechtern waren: Nemuel,
...
kommt; \bibleverse{13} Serah, daher das Geschlecht der Serahiter kommt;
Saul, daher das Geschlecht der Sauliter kommt. \bibleverse{14} Das sind
die Geschlechter von Simeon, 22.200. \bibleverse{15} Die Kinder Gads in
...
Geschlecht der Suniter kommt; \bibleverse{16} Osni, daher das Geschlecht
der Osniter kommt; Eri, daher das Geschlecht der Eriter kommt;
\bibleverse{17} Arod, daher das Geschlecht der Aroditer kommt; Ariel,
daher das Geschlecht der Arieliter kommt. \bibleverse{18} Das sind die
Geschlechter der Kinder Gads, an ihrer Zahl 40.500 \bibleverse{19} Die
Kinder Judas: Ger und Onan, welche beide starben im Lande Kanaan.
\footnote{\textbf{26:19} 1Mo 38,7; 1Mo 38,10} \bibleverse{20} Es waren
...
Serah, daher das Geschlecht der Serahiter kommt. \bibleverse{21} Aber
die Kinder des Perez waren: Hezron, daher das Geschlecht der Hezroniter
kommt; Hamul, daher das Geschlecht der Hamuliter kommt. \bibleverse{22}
Das sind die Geschlechter Judas, an ihrer Zahl 76.500. \bibleverse{23}
...
Phuvaniter kommt; \bibleverse{24} Jasub, daher das Geschlecht der
Jasubiter kommt; Simron, daher das Geschlecht der Simroniter kommt.
\bibleverse{25} Das sind die Geschlechter Isaschars, an der Zahl 64.300.
\bibleverse{26} Die Kinder Sebulons in ihren Geschlechtern waren: Sered,
...
\bibleverse{27} Das sind die Geschlechter Sebulons, an ihrer Zahl
60.500. \bibleverse{28} Die Kinder Josephs in ihren Geschlechtern waren:
Manasse und Ephraim. \bibleverse{29} Die Kinder aber Manasses waren:
...
Gilead, daher kommt das Geschlecht der Gileaditer. \footnote{\textbf{26:29}
  Jos 17,1-3} \bibleverse{30} Dies sind aber die Kinder Gileads: Hieser,
daher kommt das Geschlecht der Hieseriter; Helek, daher kommt das
Geschlecht der Helekiter; \bibleverse{31} Asriel, daher kommt das
...
\bibleverse{65} Denn der HErr hatte ihnen gesagt, sie sollten des Todes
...
Sünde gestorben, und hatte keine Söhne. \footnote{\textbf{27:3} 4Mo
  16,2; 4Mo 26,65} \bibleverse{4} Warum soll denn unseres Vaters Name
unter seinem Geschlecht untergehen, weil er keinen Sohn hat? Gebt uns
auch ein Gut unter unseres Vaters Brüdern! \bibleverse{5} Mose brachte
ihre Sache vor den HErrn. \bibleverse{6} Und der HErr sprach zu ihm:
...
\bibleverse{12} Und der HErr sprach zu Mose: Steig auf dies Gebirge
Abarim und besiehe das Land, das ich den Kindern Israel gebe werde.
\footnote{\textbf{27:12} 5Mo 32,48-49} \bibleverse{13} Und wenn du es
...
\bibleverse{16} Der HErr, der Gott der Geister alles Fleisches, wolle
...
\footnote{\textbf{27:17} Mt 9,36} \bibleverse{18} Und der HErr sprach zu
...
ist, und lege deine Hände auf ihn \footnote{\textbf{27:18} 5Mo 3,21; 5Mo
  34,9} \bibleverse{19} und stelle ihn vor den Priester Eleasar und vor
die ganze Gemeinde und gebiete ihm vor ihren Augen, \bibleverse{20} und
...
\bibleverse{21} Und er soll treten vor den Priester Eleasar, der soll
...
\bibleverse{22} Mose tat, wie ihm der HErr geboten hatte, und nahm Josua
...
\bibleverse{23} und legte seine Hand auf ihn und gebot ihm, wie der HErr
...
Sinai opfertet, zum süßen Geruch ein Feuer dem HErrn. \bibleverse{7}
Dazu sein Trankopfer je zu einem Lamm ein viertel Hin. Im Heiligtum soll
man den Wein des Trankopfers opfern dem HErrn. \bibleverse{8} Das andere
...
\bibleverse{15} Dazu soll man einen Ziegenbock zum Sündopfer dem HErrn
machen außer dem täglichen Brandopfer und seinem Trankopfer. \footnote{\textbf{28:15}
  4Mo 28,22} \bibleverse{16} Aber am 14. Tage des ersten Monats ist das
...
\bibleverse{19} und sollt dem HErrn Brandopfer tun: zwei junge Farren,
...
täglichen Brandopfer, dazu sein Trankopfer. \bibleverse{25} Und der
siebente Tag soll bei euch heilig heißen, dass ihr zusammenkommt; keine
Dienstarbeit sollt ihr da tun. \bibleverse{26} Und der Tag der
...
\bibleverse{27} und sollt dem HErrn Brandopfer tun zum süßen Geruch:
...
sieben jährige Lämmer ohne Fehl; \bibleverse{3} dazu ihr Speisopfer:
drei Zehntel Semmelmehl, mit Öl gemengt, zu dem Farren, zwei Zehntel zu
dem Widder, \bibleverse{4} und ein Zehntel auf ein jegliches Lamm der
sieben Lämmer; \bibleverse{5} auch einen Ziegenbock zum Sündopfer, euch
zu versöhnen -- \bibleverse{6} außer dem Brandopfer des Monats und
...
Geruch. Das ist ein Opfer dem HErrn. \bibleverse{7} Der zehnte Tag
...
\footnote{\textbf{29:7} 3Mo 23,27-32} \bibleverse{8} sondern Brandopfer
dem HErrn zum süßen Geruch opfern: einen jungen Farren, einen Widder,
sieben jährige Lämmer ohne Fehl; \bibleverse{9} mit ihren Speisopfern:
drei Zehntel Semmelmehl, mit Öl gemengt, zu dem Farren, zwei Zehntel zu
dem Widder, \bibleverse{10} und ein Zehntel je zu einem der sieben
Lämmer; \bibleverse{11} dazu einen Ziegenbock zum Sündopfer, -- außer
...
feiern \footnote{\textbf{29:12} 3Mo 23,34-43} \bibleverse{13} und sollt
...
\bibleverse{39} Solches sollt ihr dem HErrn tun auf eure Feste,
...
\bibleverse{1} Und Mose sagte den Kindern Israel alles, was ihm der HErr
geboten hatte. \bibleverse{2} Und Mose redete mit den Fürsten der Stämme
der Kinder Israel und sprach: das ist's, was der HErr geboten hat:
\bibleverse{3} Wenn jemand dem HErrn ein Gelübde tut oder einen Eid
...
\bibleverse{4} Wenn ein Weib dem HErrn ein Gelübde tut und sich
verbindet, solange sie in ihres Vaters Hause und ledig ist,
\bibleverse{5} und ihr Gelübde und Verbündnis, das sie nimmt auf ihre
...
\bibleverse{6} Wo aber ihr Vater ihr wehrt des Tages, wenn er's hört, so
...
\bibleverse{7} Wird sie aber eines Mannes und hat ein Gelübde auf sich
...
Missetat tragen. \bibleverse{17} Das sind die Satzungen, die der HErr
...
\bibleverse{3} Da redete Mose mit dem Volk und sprach: Rüstet unter euch
Leute zum Heer wider die Midianiter, dass sie den HErrn rächen an den
Midianitern, \bibleverse{4} aus jeglichem Stamm 1000, dass ihr aus allen
Stämmen Israels in das Heer schickt. \bibleverse{5} Und sie nahmen aus
...
was männlich war. \footnote{\textbf{31:7} 2Mo 20,13} \bibleverse{8} Dazu
...
den Sohn Beors, erwürgten sie auch mit dem Schwert. \footnote{\textbf{31:8}
  Jos 13,21-22; 4Mo 22,5} \bibleverse{9} Und die Kinder Israel nahmen
...
\footnote{\textbf{31:16} 4Mo 25,1; Offb 2,14} \bibleverse{17} So
...
die Männer erkannt und beigelegen haben; \footnote{\textbf{31:17} Ri
  21,11} \bibleverse{18} aber alle Kinder, die weiblich sind und nicht
Männer erkannt haben, die lasst für euch leben. \bibleverse{19} Und
...
\bibleverse{28} Du sollst aber dem HErrn heben von den Kriegsleuten, die
...
\bibleverse{31} Und Mose und Eleasar, der Priester, taten, wie der HErr
dem Mose geboten hatte. \bibleverse{32} Und es war die übrige Ausbeute,
die das Kriegsvolk geraubt hatte, 675.000 Schafe, \bibleverse{33} 72.000
Rinder,
...
\bibleverse{39} Desgleichen 30.500 Esel; davon wurden dem HErrn 61.
\bibleverse{40} Desgleichen Menschenseelen, 16.000 Seelen; davon wurden
dem HErrn 32 Seelen. \bibleverse{41} Und Mose gab solche Hebe des HErrn
dem Priester Eleasar, wie ihm der HErr geboten hatte. \bibleverse{42}
...
\bibleverse{50} Darum bringen wir dem HErrn Geschenke, was ein jeglicher
...
\bibleverse{52} Und alles Goldes Hebe, das sie dem HErrn hoben, war
...
\bibleverse{4} das der HErr geschlagen hat vor der Gemeinde Israel, ist
gut zur Weide; und wir, deine Knechte, haben Vieh. \bibleverse{5} Und
...
\bibleverse{6} Mose sprach zu ihnen: Eure Brüder sollen in den Streit
ziehen, und ihr wollt hier bleiben? \bibleverse{7} Warum macht ihr der
Kinder Israel Herzen abwendig, dass sie nicht hinüberziehen in das Land,
das ihnen der HErr geben wird? \bibleverse{8} Also taten auch eure
Väter, da ich sie aussandte von Kades-Barnea, das Land zu schauen;
\footnote{\textbf{32:8} 4Mo 13,-1} \bibleverse{9} und da sie
...
wollten, das ihnen der HErr geben wollte. \bibleverse{10} Und des HErrn
Zorn ergrimmte zur selben Zeit, und er schwur und sprach:
\bibleverse{11} Diese Leute, die aus Ägypten gezogen sind, von zwanzig
...
HErrn treulich nachgefolgt. \bibleverse{13} Also ergrimmte des HErrn
...
vor dem HErrn. \bibleverse{14} Und siehe, ihr seid aufgetreten an eurer
Väter Statt, dass der Sünder desto mehr seien und ihr auch den Zorn und
Grimm des HErrn noch mehr macht wider Israel. \bibleverse{15} Denn wo
...
wollt, dass ihr euch rüstet zum Streit vor dem HErrn, \footnote{\textbf{32:20}
  Jos 1,13-15} \bibleverse{21} so ziehet über den Jordan vor dem HErrn,
wer unter euch gerüstet ist, bis dass er seine Feinde austreibe von
seinem Angesicht \bibleverse{22} und das Land untertan werde dem HErrn;
...
\bibleverse{23} Wo ihr aber nicht also tun wollt, siehe, so werdet ihr
euch an dem HErrn versündigen und werdet eurer Sünde innewerden, wenn
sie euch finden wird. \bibleverse{24} So bauet nun Städte für eure
...
\bibleverse{32} Wir wollen gerüstet ziehen vor dem HErrn ins Land Kanaan
...
Befehl des HErrn, und dies sind die Reisen ihres Zuges. \bibleverse{3}
...
\footnote{\textbf{33:3} 2Mo 1,11; 2Mo 14,8} \bibleverse{4} als sie eben
...
der HErr hatte auch an ihren Göttern Gericht geübt. \footnote{\textbf{33:4}
  2Mo 12,12} \bibleverse{5} Als sie von Raemses auszogen, lagerten sie
sich in Sukkoth. \footnote{\textbf{33:5} 2Mo 12,37} \bibleverse{6} Und
zogen aus von Sukkoth und lagerten sich in Etham, welches liegt an dem
Ende der Wüste. \footnote{\textbf{33:6} 2Mo 13,20} \bibleverse{7} Von
...
Wasserbrunnen und 70 Palmen; und lagerten sich daselbst. \footnote{\textbf{33:9}
  2Mo 15,27} \bibleverse{10} Von Elim zogen sie aus und lagerten sich an
das Schilfmeer. \bibleverse{11} Von dem Schilfmeer zogen sie aus und
...
sich in Rithma. \footnote{\textbf{33:18} 4Mo 12,16} \bibleverse{19} Von
...
\footnote{\textbf{33:49} 4Mo 25,1} \bibleverse{50} Und der HErr redete
...
Kanaan nach seinen Grenzen. \bibleverse{3} Die Ecke gegen Mittag soll
...
vom Ende des Salzmeeres, das gegen Morgen liegt, \footnote{\textbf{34:3}
  Jos 15,1} \bibleverse{4} und das die Grenze sich lenke mittagwärts von
...
Stamm zu geben. \bibleverse{14} Denn der Stamm der Kinder Ruben nach
...
und der halbe Stamm Manasse haben ihr Teil genommen. \footnote{\textbf{34:14}
  4Mo 32,33} \bibleverse{15} Also haben die zwei Stämme und der halbe
Stamm ihr Erbteil dahin, diesseits des Jordans gegenüber Jericho gegen
Morgen. \bibleverse{16} Und der HErr redete mit Mose und sprach:
...
\bibleverse{1} Und der HErr redete mit Mose auf den Gefilde der Moabiter
am Jordan gegenüber Jericho und sprach: \bibleverse{2} Gebiete den
Kindern Israel, dass sie den Leviten Städte geben von ihren Erbgütern
zur Wohnung; \bibleverse{3} dazu die Vorstädte um die Städte her sollt
...
draußen vor der Stadtmauer umher haben. \bibleverse{5} So sollt ihr nun
...
Mitte sei. Das sollen ihre Vorstädte sein. \bibleverse{6} Und unter den
...
dieselben sollt ihr noch 42 Städte geben, \footnote{\textbf{35:6} 2Mo
  21,13; 5Mo 4,41; 5Mo 19,2; 5Mo 19,9; Jos 20,-1} \bibleverse{7} dass
alle Städte, die ihr den Leviten gebt, seien 48 mit ihren Vorstädten.
\bibleverse{8} Und sollt derselben desto mehr geben von denen, die viel
...
wird, soll Städte den Leviten geben. \bibleverse{9} Und der HErr redete
mit Mose und sprach: \bibleverse{10} Rede mit den Kindern Israel und
sprich zu ihnen: Wenn ihr über den Jordan ins Land Kanaan kommt,
\bibleverse{11} sollt ihr Städte auswählen, dass sie Freistädte seien,
wohin fliehe, wer einen Totschlag unversehens tut. \bibleverse{12} Und
...
Gemeinde vor Gericht gestanden sei. \bibleverse{13} Und der Städte, die
ihr geben werdet zu Freistädten, sollen sechs sein. \bibleverse{14} Drei
sollt ihr geben diesseits des Jordans und drei im Lande Kanaan.
\bibleverse{15} Das sind die sechs Freistädte, den Kindern Israel und
den Fremdlingen und den Beisassen unter euch, dass dahin fliehe, wer
einen Totschlag getan hat unversehens. \bibleverse{16} Wer jemand mit
einem Eisen schlägt, dass er stirbt, der ist ein Totschläger und soll
des Todes sterben. \bibleverse{17} Wirft er ihn mit einem Stein, mit dem
jemand mag getötet werden, dass er davon stirbt, so ist er ein
Totschläger und soll des Todes sterben. \bibleverse{18} Schlägt er ihn
...
hat. \footnote{\textbf{35:25} 3Mo 21,10} \bibleverse{26} Wird aber der
...
Bruders, seinen Töchtern geben soll. \textsuperscript{a} \bibleverse{3}
...
hat recht geredet. \bibleverse{6} Das ist's, was der HErr gebietet den
...
der Kinder Israel. \bibleverse{10} Wie der HErr dem Mose geboten hatte,
so taten die Töchter Zelophehads, \bibleverse{11} Mahela, Thirza, Hogla,
Milka und Noa, und freiten die Kinder ihrer Vettern, \textsuperscript{b}
\bibleverse{12} des Geschlechts der Kinder Manasses, des Sohnes Josephs.
Also blieb ihr Erbteil an dem Stamm des Geschlechts ihres Vaters.
\bibleverse{13} Das sind die Gebote und Rechte, die der HErr gebot durch
