...
Finsternis. \footnote{\textbf{1:5} Jak 1,17} \bibleverse{6} Wenn wir
...
Finsternis, so lügen wir und tun nicht die Wahrheit. \footnote{\textbf{1:6}
  1Jo 2,4} \bibleverse{7} Wenn wir aber im Licht wandeln, wie er im
...
Christi, seines Sohnes, macht uns rein von aller Sünde. \footnote{\textbf{1:7}
  Hebr 9,14; Offb 1,5} \bibleverse{8} Wenn wir sagen, wir haben keine
Sünde, so verführen wir uns selbst, und die Wahrheit ist nicht in uns.
\bibleverse{9} Wenn wir aber unsere Sünden bekennen, so ist er treu und
gerecht, dass er uns die Sünden vergibt und reinigt uns von aller
Untugend. \footnote{\textbf{1:9} Spr 28,13} \bibleverse{10} Wenn wir
...
bei dem Vater, Jesum Christum, der gerecht ist. \footnote{\textbf{2:1}
  Röm 8,34; Hebr 7,25} \bibleverse{2} Und derselbe ist die Versöhnung
...
die der ganzen Welt. \footnote{\textbf{2:2} 1Jo 4,10; Kol 1,20; Joh
  11,51-52} \bibleverse{3} Und an dem merken wir, dass wir ihn kennen,
wenn wir seine Gebote halten. \bibleverse{4} Wer da sagt: Ich kenne ihn,
-- und hält seine Gebote nicht, der ist ein Lügner, und in solchem ist
keine Wahrheit. \bibleverse{5} Wer aber sein Wort hält, in solchem ist
wahrlich die Liebe Gottes vollkommen. Daran erkennen wir, dass wir in
ihm sind. \footnote{\textbf{2:5} Joh 14,21; Joh 14,23} \bibleverse{6}
...
Wort, das ihr von Anfang gehört habt. \footnote{\textbf{2:7} Joh 13,34;
  2Jo 1,-1} \bibleverse{8} Wiederum ein neues Gebot schreibe ich euch,
...
und das wahre Licht scheint jetzt. \footnote{\textbf{2:8} Joh 8,12; Röm
  13,12} \bibleverse{9} Wer da sagt, er sei im Licht, und hasst seinen
...
\footnote{\textbf{2:15} Jak 4,4} \bibleverse{16} Denn alles, was in der
Welt ist: des Fleisches Lust und der Augen Lust und hoffärtiges Leben,
ist nicht vom Vater, sondern von der Welt. \bibleverse{17} Und die Welt
...
geworden; daher erkennen wir, dass die letzte Stunde ist. \footnote{\textbf{2:18}
  Mt 24,24; 1Petr 4,7; 2Thes 2,3-4} \bibleverse{19} Sie sind von uns
...
werden, dass nicht alle von uns sind. \footnote{\textbf{2:19} Apg 20,30;
  1Kor 11,19} \bibleverse{20} Und ihr habt die Salbung von dem, der
heilig ist, und wisset alles. \bibleverse{21} Ich habe euch nicht
geschrieben, als wüsstet ihr die Wahrheit nicht; sondern ihr wisset sie
und wisset, dass keine Lüge aus der Wahrheit kommt. \bibleverse{22} Wer
...
\bibleverse{23} Wer den Sohn leugnet, der hat auch den Vater nicht; wer
...
\bibleverse{29} Wenn ihr wisset, dass er gerecht ist, so erkennet auch,
...
\bibleverse{2} Meine Lieben, wir sind nun Gottes Kinder; und es ist noch
...
\bibleverse{3} Und ein jeglicher, der solche Hoffnung hat zu ihm, der
...
\footnote{\textbf{3:5} Joh 1,29; Joh 8,46; 1Petr 2,24; Jes 53,4-5; Jes
  53,9} \bibleverse{6} Wer in ihm bleibt, der sündigt nicht; wer da
...
der ist gerecht, gleichwie Er gerecht ist. \footnote{\textbf{3:7} 1Jo
  2,29} \bibleverse{8} Wer Sünde tut, der ist vom Teufel; denn der
...
geboren. \footnote{\textbf{3:9} 1Jo 5,18} \bibleverse{10} Daran wird's
...
liebhat. \bibleverse{11} Denn das ist die Botschaft, die ihr gehört habt
von Anfang, dass wir uns untereinander lieben sollen. \bibleverse{12}
...
hasst. \footnote{\textbf{3:13} Mt 5,11; Joh 15,18-19} \bibleverse{14}
...
\footnote{\textbf{3:14} Joh 5,24} \bibleverse{15} Wer seinen Bruder
...
lassen. \footnote{\textbf{3:16} Joh 15,13} \bibleverse{17} Wenn aber
...
\bibleverse{24} Und wer seine Gebote hält, der bleibt in ihm und er in
...
\bibleverse{2} Daran sollt ihr den Geist Gottes erkennen: ein jeglicher
Geist, der da bekennt, dass Jesus Christus ist in das Fleisch gekommen,
der ist von Gott; \bibleverse{3} und ein jeglicher Geist, der da nicht
...
\bibleverse{4} Kindlein, ihr seid von Gott und habt jene überwunden;
...
die Welt hört sie. \footnote{\textbf{4:5} Joh 15,19} \bibleverse{6} Wir
...
\bibleverse{10} Darin steht die Liebe: nicht, dass wir Gott geliebt
haben, sondern dass er uns geliebt hat und gesandt seinen Sohn zur
Versöhnung für unsere Sünden. \bibleverse{11} Ihr Lieben, hat uns Gott
also geliebt, so sollen wir uns auch untereinander lieben.
\bibleverse{12} Niemand hat Gott jemals gesehen. Wenn wir uns
...
uns, dass er uns von seinem Geist gegeben hat. \footnote{\textbf{4:13}
  1Jo 3,24} \bibleverse{14} Und wir haben gesehen und zeugen, dass der
Vater den Sohn gesandt hat zum Heiland der Welt. \footnote{\textbf{4:14}
  Joh 3,17} \bibleverse{15} Welcher nun bekennt, dass Jesus Gottes Sohn
...
sieht, wie kann er Gott lieben, den er nicht sieht? \footnote{\textbf{4:20}
  1Jo 3,17} \bibleverse{21} Und dies Gebot haben wir von ihm, dass wer
...
halten; und seine Gebote sind nicht schwer. \footnote{\textbf{5:3} Joh
  14,15; Joh 14,23-24; Mt 11,30} \bibleverse{4} Denn alles, was von Gott
...
Geist ist's, der da zeugt; denn der Geist ist die Wahrheit. \footnote{\textbf{5:6}
  Joh 1,33; Joh 19,34-35; 1Jo 1,7} \bibleverse{7} Denn drei sind, die da
zeugen: der Geist und das Wasser und das Blut; \bibleverse{8} und die
drei sind beisammen. \bibleverse{9} Wenn wir der Menschen Zeugnis
annehmen, so ist Gottes Zeugnis größer; denn Gottes Zeugnis ist das, das
er gezeugt hat von seinem Sohn. \bibleverse{10} Wer da glaubt an den
...
wenn wir etwas bitten nach seinem Willen, so hört er uns. \footnote{\textbf{5:14}
  Joh 14,13} \bibleverse{15} Und wenn wir wissen, dass er uns hört, was
...
\bibleverse{19} Wir wissen, dass wir von Gott sind und die ganze Welt im
Argen liegt. \footnote{\textbf{5:19} Gal 1,4} \bibleverse{20} Wir wissen
