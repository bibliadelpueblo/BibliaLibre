...
Finsternis, so lügen wir und tun nicht die Wahrheit. \footnote{\textbf{2:8}
  Joh 8,12; Röm 13,12} \bibleverse{7} Wenn wir aber im Licht wandeln,
...
\footnote{\textbf{1:7} Hebr 9,14; Offb 1,5} \bibleverse{8} Wenn wir
...
\bibleverse{10} Wenn wir sagen, wir haben nicht gesündigt, so machen wir
...
die der ganzen Welt. \textsuperscript{b} \bibleverse{3} Und an dem
...
\textsuperscript{c} \bibleverse{6} Wer da sagt, dass er in ihm bleibt,
...
und das wahre Licht scheint jetzt. \textsuperscript{b} \bibleverse{9}
Wer da sagt, er sei im Licht, und hasst seinen Bruder, der ist noch in
der Finsternis. \footnote{\textbf{3:9} 1Jo 5,18} \bibleverse{10} Wer
seinen Bruder liebt, der bleibt im Licht, und ist kein Ärgernis bei ihm.
\bibleverse{11} Wer aber seinen Bruder hasst, der ist in der Finsternis
...
werden, dass nicht alle von uns sind. \footnote{\textbf{3:17} 5Mo 15,7;
  1Jo 4,20} \bibleverse{20} Und ihr habt die Salbung von dem, der heilig
ist, und wisset alles. \bibleverse{21} Ich habe euch nicht geschrieben,
als wüsstet ihr die Wahrheit nicht; sondern ihr wisset sie und wisset,
dass keine Lüge aus der Wahrheit kommt. \bibleverse{22} Wer ist ein
Lügner, wenn nicht, der da leugnet, dass Jesus der Christus sei? Das ist
der Widerchrist, der den Vater und den Sohn leugnet. \bibleverse{23} Wer
...
sehen, wie er ist. \footnote{\textbf{5:19} Gal 1,4} \bibleverse{3} Und
...
die Werke des Teufels zerstöre. \textsuperscript{b} \bibleverse{9} Wer
...
\textsuperscript{c} \bibleverse{10} Daran wird's offenbar, welche die
Kinder Gottes und die Kinder des Teufels sind. Wer nicht recht tut, der
ist nicht von Gott, und wer nicht seinen Bruder liebhat. \bibleverse{11}
...
\textsuperscript{b} \bibleverse{15} Wer seinen Bruder hasst, der ist ein
...
Gebot gegeben hat. \textsuperscript{b} \bibleverse{24} Und wer seine
...
die Welt hört sie. \textsuperscript{b} \bibleverse{6} Wir sind von Gott,
...
\bibleverse{15} Welcher nun bekennt, dass Jesus Gottes Sohn ist, in dem
bleibt Gott und er in Gott. \textsuperscript{c} \bibleverse{16} Und wir
...
zeugt von seinem Sohn. \textsuperscript{b} \bibleverse{11} Und das ist
das Zeugnis, dass uns Gott das ewige Leben hat gegeben; und solches
Leben ist in seinem Sohn. \bibleverse{12} Wer den Sohn Gottes hat, der
...
Argen liegt. \textsuperscript{b} \bibleverse{20} Wir wissen aber, dass
