...
\bibverse{2} Ich habe euch lieb, spricht der HERR. So sprecht ihr:
``Womit hast du uns lieb?'' Ist nicht Esau Jakobs Bruder? spricht der
HERR; und doch habe ich Jakob lieb

\bibverse{3} und hasse Esau und habe sein Gebirge öde gemacht und sein
Erbe den Schakalen zur Wüste. \bibverse{4} Und ob Edom sprechen würde:
...
ewiglich. \bibverse{5} Das sollen eure Augen sehen, und ihr werdet
sagen: Der HERR ist herrlich in den Grenzen Israels. \bibverse{6} Ein
...
sprecht ihr: ``Womit verachten wir deinen Namen?'' \bibverse{7} Damit
...
verachtet.'' \bibverse{8} Und wenn ihr ein blindes opfert, so muß es
