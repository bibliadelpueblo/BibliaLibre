...
\bibleverse{1} Dies ist das Gesicht Obadjas. So spricht der Herr HErr
...
\bibleverse{2} Siehe, ich habe dich gering gemacht unter den Heiden und
sehr verachtet. \bibleverse{3} Der Hochmut deines Herzens hat dich
...
stoßen? \bibleverse{4} Wenn du gleich in die Höhe führest wie ein Adler
und machtest dein Nest zwischen den Sternen, dennoch will ich dich von
dort herunterstürzen, spricht der HErr. \bibleverse{5} Wenn Diebe oder
...
kommen, so sollen sie dir kein Nachlesen übriglassen. \bibleverse{6} Wie
sollen sie dann Esau ausforschen und seine Schätze suchen!
\bibleverse{7} Alle deine eigenen Bundesgenossen werden dich zum Lande
...
\bibleverse{8} Was gilt's? spricht der HErr, ich will zur selben Zeit
die Weisen zu Edom zunichte machen und die Klugheit auf dem Gebirge
Esau. \bibleverse{9} Und deine Starken zu Theman sollen zagen, auf dass
...
\bibleverse{10} Um des Frevels willen, an deinem Bruder Jakob begangen,
sollst du zu allen Schanden werden und ewiglich ausgerottet sein.
\footnote{\textbf{1:10} Joe 4,19} \bibleverse{11} Zu der Zeit, da du
...
warst du gleich wie deren einer. \bibleverse{12} Du sollst nicht mehr so
...
deinem Maul nicht so stolz reden zur Zeit Ihrer Angst; \bibleverse{13}
...
Jammers; \bibleverse{14} du sollst nicht stehen an den Wegscheiden,
...
\bibleverse{15} Denn der Tag des HErrn ist nahe über alle Heiden. Wie du
...
dir's wieder auf deinen Kopf kommen. \footnote{\textbf{1:15} Joe 1,15;
  Jer 50,15; Jer 50,29} \bibleverse{16} Denn wie ihr auf meinem heiligen
...
gewesen. \footnote{\textbf{1:16} Jer 25,15} \bibleverse{17} Aber auf dem
...
Haus Jakob soll seine Besitzer besitzen. \footnote{\textbf{1:17} Joe
  3,5; Joe 4,17} \bibleverse{18} Und das Haus Jakob soll ein Feuer
...
\bibleverse{19} Und die gegen Mittag werden das Gebirge Esau, und die in
...
Gilead. \bibleverse{20} Und die Vertriebenen dieses Heeres der Kinder
...
Städte gegen Mittag besitzen. \bibleverse{21} Und es werden Heilande
