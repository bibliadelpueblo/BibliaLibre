...
süßen Geruch. \footnote{\textbf{7:9} 3Mo 2,4-5; 3Mo 2,7} \bibleverse{13}
...
den Mist, \bibleverse{12} das soll er alles hinausführen aus dem Lager,
...
des Stifts stellen. \textsuperscript{b} \bibleverse{15} Und die Ältesten
...
\textsuperscript{b} \bibleverse{25} Aber für seine Schuld soll er dem
...
\bibleverse{3} Und der Priester soll seinen leinenen Rock anziehen und
...
neben den Altar schütten, \textsuperscript{b} \bibleverse{4} und soll
seine Kleider darnach ausziehen und andere Kleider anziehen und die
Asche hinaustragen aus dem Lager an eine reine Stätte.
\textsuperscript{c} \bibleverse{5} Das Feuer auf dem Altar soll brennen
...
Dankopfer darauf anzünden. \bibleverse{6} Ewig soll das Feuer auf dem
Altar brennen und nimmer verlöschen. \bibleverse{7} Und das ist das
...
opfert. \textsuperscript{b} \bibleverse{10} Und alles Speisopfer, das
...
alles, was darin war, und weihte es \textsuperscript{c} \bibleverse{11}
...
\textsc{Herrn}. \bibleverse{3} Und rede mit den Kindern Israel und
sprich: Nehmt einen Ziegenbock zum Sündopfer und ein Kalb und ein Schaf,
beide ein Jahr alt und ohne Fehl, zum Brandopfer \bibleverse{4} und
...
\textsc{Herrn} allem Volk. \textsuperscript{b} \bibleverse{24} Und ein
...
besehen und für unrein urteilen. \textsuperscript{b} \bibleverse{4} Wenn
...
sieben Tage \bibleverse{5} und am siebenten Tage besehen. Ist's, dass
das Mal bleibt, wie er's zuvor gesehen hat, und hat nicht
weitergefressen an der Haut, \bibleverse{6} so soll ihn der Priester
...
\bibleverse{7} Wenn aber der Grind weiterfrisst in der Haut, nachdem er
vom Priester besehen worden ist, ob er rein sei, und wird nun zum
andernmal vom Priester besehen, -- \bibleverse{8} wenn dann da der
...
unrein. \footnote{\textbf{15:2} 4Mo 5,2} \bibleverse{3} Dann aber ist er
...
sie anlegen. \textsuperscript{b} \bibleverse{5} Und soll von der
...
unrein, die umher lagern. \textsuperscript{b} \bibleverse{17} Kein
...
\textsuperscript{b} \bibleverse{12} Darum habe ich gesagt den Kindern
...
\bibleverse{4} sondern nach meinen Rechten sollt ihr tun, und meine
Satzungen sollt ihr halten, dass ihr darin wandelt; denn ich bin der
\textsc{Herr}, euer Gott. \bibleverse{5} Darum sollt ihr meine Satzungen
...
ist des \textsc{Herrn} Passah. \textsuperscript{b} \bibleverse{6} Und am
15. desselben Monats ist das Fest der ungesäuerten Brote des
\textsc{Herrn}; da sollt ihr sieben Tage ungesäuertes Brot essen.
\bibleverse{7} Der erste Tag soll heilig unter euch heißen, da ihr
zusammenkommt; da sollt ihr keine Dienstarbeit tun. \bibleverse{8} Und
...
\footnote{\textbf{24:2} 2Mo 27,20} \bibleverse{3} außen vor dem Vorhang
...
ewiges Recht euren Nachkommen. \bibleverse{4} Er soll die Lampen auf dem
...
\textsc{Herrn}. \textsuperscript{b} \bibleverse{13} Und der
\textsc{Herr} redete mit Mose und sprach: \bibleverse{14} Führe den
...
\textsuperscript{b} \bibleverse{20} Schade um Schade, Auge um Auge, Zahn
um Zahn; wie er hat einen Menschen verletzt, so soll man ihm wieder tun.
\bibleverse{21} Also dass, wer ein Vieh erschlägt, der soll's bezahlen;
wer aber einen Menschen erschlägt, der soll sterben. \bibleverse{22} Es
...
seinem Geschlecht kommen; \textsuperscript{b} \bibleverse{11} denn das
...
das Land gedenken, \textsuperscript{b} \bibleverse{43} das von ihnen
...
\bibleverse{44} Auch wenn sie schon in der Feinde Land sind, habe ich
...
gelten; denn ich bin der \textsc{Herr}, ihr Gott. \bibleverse{45} Und
...
\bibleverse{3} so soll das eine Schätzung sein: ein Mannsbild, 20 Jahre
alt bis ins 60. Jahr, sollst du schätzen auf 50 Silberlinge nach dem Lot
des Heiligtums, \bibleverse{4} ein Weibsbild auf 30 Silberlinge.
\bibleverse{5} Von 5 Jahren an bis auf 20 Jahre sollst du ihn schätzen
auf 20 Silberlinge, wenn's ein Mannsbild ist, ein Weibsbild aber auf
zehn Silberlinge. \bibleverse{6} Von einem Monat an bis auf fünf Jahre
sollst du ihn schätzen auf fünf Silberlinge, wenn's ein Mannsbild ist,
ein Weibsbild aber auf drei Silberlinge. \bibleverse{7} Ist er aber 60
...
\bibleverse{8} Ist er aber zu arm zu solcher Schätzung, so soll er sich
