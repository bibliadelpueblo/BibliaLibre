\hypertarget{vorschriften-betreffend-der-brandopfer}{%
...
\bibleverse{1} Und der HErr rief Mose und redete mit ihm aus der Hütte
des Stifts und sprach: \bibleverse{2} Rede mit den Kindern Israel und
...
dem HErrn angenehm sei von ihm, \bibleverse{4} und lege seine Hand auf
des Brandopfers Haupt, so wird es angenehm sein und ihn versöhnen.
\footnote{\textbf{1:4} 2Mo 29,10} \bibleverse{5} Und er soll das junge
...
der Hütte des Stifts ist. \bibleverse{6} Und man soll dem Brandopfer die
Haut abziehen, und es soll in Stücke zerhauen werden; \bibleverse{7} und
die Söhne Aarons, des Priesters, sollen ein Feuer auf dem Altar machen
und Holz obendarauf legen \bibleverse{8} und sollen die Stücke, den Kopf
und das Fett, auf das Holz legen, das auf dem Feuer auf dem Altar liegt.
\bibleverse{9} Das Eingeweide aber und die Schenkel soll man mit Wasser
...
umhersprengen. \bibleverse{12} Und man soll es in Stücke zerhauen, und
der Priester soll sie samt dem Kopf und dem Fett auf das Holz und Feuer,
das auf dem Altar ist, legen. \bibleverse{13} Aber das Eingeweide und
...
\bibleverse{14} Will er aber von Vögeln dem HErrn ein Brandopfer tun, so
tue er's von Turteltauben oder von jungen Tauben. \bibleverse{15} Und
...
Wand des Altars. \bibleverse{16} Und seinen Kropf mit seinen Federn soll
man neben dem Altar gegen Morgen auf den Aschenhaufen werfen;
\bibleverse{17} und soll seine Flügel spalten, aber nicht abbrechen. Und
...
\bibleverse{1} Wenn eine Seele dem HErrn ein Speisopfer tun will, so
soll es von Semmelmehl sein, und sie sollen Öl darauf gießen und
Weihrauch darauf legen \bibleverse{2} und es also bringen zu den
...
\bibleverse{3} Das übrige aber vom Speisopfer soll Aarons und seiner
...
\bibleverse{8} und sollst das Speisopfer, das du von solcherlei machen
willst dem HErrn, zu dem Priester bringen; der soll es zu dem Altar
bringen \bibleverse{9} und des Speisopfers einen Teil abheben zum
Gedächtnis und anzünden auf dem Altar. Das ist ein Feuer zum süßen
Geruch dem HErrn. \bibleverse{10} Das Übrige aber soll Aarons und seiner
Söhne sein. Das soll ein Hochheiliges sein von den Feuern des HErrn.

\bibleverse{11} Alle Speisopfer, die ihr dem HErrn opfern wollt, sollt
...
\bibleverse{12} Unter den Erstlingen sollt ihr sie dem HErrn bringen;
aber auf den Altar sollen sie nicht kommen zum süßen Geruch. \footnote{\textbf{2:12}
  4Mo 18,12} \bibleverse{13} Alle deine Speisopfer sollst du salzen, und
...
\bibleverse{14} Willst du aber ein Speisopfer dem HErrn tun von den
...
und also das Speisopfer deiner ersten Früchte opfern; \footnote{\textbf{2:14}
  5Mo 26,2-3} \bibleverse{15} und sollst Öl darauf tun und Weihrauch
darauf legen, so ist's ein Speisopfer. \bibleverse{16} Und der Priester
...
\hypertarget{heilsopfer-vom-rindvieh}{%
\subsection{Heilsopfer vom Rindvieh}\label{heilsopfer-vom-rindvieh}}

\hypertarget{section-2}{%
\section{3}\label{section-2}}

\bibleverse{1} Ist aber sein Opfer ein Dankopfer von Rindern, es sei ein
Ochse oder eine Kuh, soll er eins opfern vor dem HErrn, das ohne Fehl
sei. \bibleverse{2} Und soll seine Hand auf desselben Haupt legen und es
schlachten vor der Tür der Hütte des Stifts. Und die Priester, Aarons
Söhne, sollen das Blut auf den Altar umhersprengen. \bibleverse{3} Und
er soll von dem Dankopfer dem HErrn opfern, nämlich das Fett, welches
das Eingeweide bedeckt, und alles Fett am Eingeweide \bibleverse{4} und
die zwei Nieren mit dem Fett, das daran ist, an den Lenden, und das Netz
um die Leber, an den Nieren abgerissen. \bibleverse{5} Und Aarons Söhne
...
\bibleverse{6} Will er aber dem HErrn ein Dankopfer von kleinem Vieh
tun, es sei ein Widder oder Schaf, so soll's ohne Fehl sein.
\bibleverse{7} Ist's ein Lämmlein, soll er's vor den HErrn bringen
\bibleverse{8} und soll seine Hand auf desselben Haupt legen und es
...
Eingeweide bedeckt, und alles Fett am Eingeweide, \bibleverse{10} die
zwei Nieren mit dem Fett, das daran ist, an den Lenden, und das Netz um
die Leber, an den Nieren abgerissen. \bibleverse{11} Und der Priester
...
HErrn, \bibleverse{13} soll er seine Hand auf ihr Haupt legen und sie
schlachten vor der Hütte des Stifts. Und die Söhne Aarons sollen das
Blut auf den Altar umhersprengen, \bibleverse{14} und er soll davon
opfern ein Opfer dem HErrn, nämlich das Fett, welches das Eingeweide
bedeckt, und alles Fett am Eingeweide, \bibleverse{15} die zwei Nieren
mit dem Fett, das daran ist, an den Lenden, und das Netz über der Leber,
an den Nieren abgerissen. \bibleverse{16} Und der Priester soll's
...
\bibleverse{3} nämlich so der Priester, der gesalbt ist, sündigen würde,
...
zum Sündopfer. \bibleverse{4} Und soll den Farren vor die Tür der Hütte
des Stifts bringen vor den HErrn und seine Hand auf desselben Haupt
legen und ihn schlachten vor dem HErrn. \bibleverse{5} Und der Priester,
der gesalbt ist, soll von des Farren Blut nehmen und es in die Hütte des
Stifts bringen \bibleverse{6} und soll seinen Finger in das Blut tauchen
und damit siebenmal sprengen vor dem HErrn, vor dem Vorhang im Heiligen.
\bibleverse{7} Und soll von dem Blut tun auf die Hörner des
...
Tür der Hütte des Stifts steht. \footnote{\textbf{4:7} 2Mo 30,1; 2Mo
  30,6; 2Mo 40,6} \bibleverse{8} Und alles Fett des Sündopfers soll er
abheben, nämlich das Fett, welches das Eingeweide bedeckt, und alles
Fett am Eingeweide, \bibleverse{9} die zwei Nieren mit dem Fett, das
daran ist, an den Lenden, und das Netz über der Leber, an den Nieren
abgerissen, \bibleverse{10} gleichwie er's abhebt vom Ochsen im
Dankopfer; und soll es anzünden auf dem Brandopferaltar. \bibleverse{11}
Aber das Fell des Farren mit allem Fleisch samt Kopf und Schenkeln und
das Eingeweide und den Mist, \bibleverse{12} das soll er alles
...
\hypertarget{opfer-bei-versuxfcndigung-der-ganzen-gemeinde}{%
...
verschuldeten, \footnote{\textbf{4:13} 4Mo 15,24} \bibleverse{14} und
...
Stifts stellen. \footnote{\textbf{4:14} Röm 8,3} \bibleverse{15} Und die
Ältesten von der Gemeinde sollen ihre Hände auf sein Haupt legen vor dem
HErrn und den Farren schlachten vor dem HErrn. \bibleverse{16} Und der
Priester, der gesalbt ist, soll Blut vom Farren in die Hütte des Stifts
bringen \bibleverse{17} und mit seinem Finger hineintauchen und
siebenmal sprengen vor dem HErrn vor dem Vorhang. \bibleverse{18} Und
...
\bibleverse{19} Alles sein Fett aber soll er abheben und auf dem Altar
anzünden. \bibleverse{20} Und soll mit dem Farren tun, wie er mit dem
Farren des Sündopfers getan hat. Und soll also der Priester sie
versöhnen, so wird's ihnen vergeben. \bibleverse{21} Und soll den Farren
...
etwas, dass er sich verschuldet, \bibleverse{23} und er wird seiner
...
schlachtet vor dem HErrn. Das sei sein Sündopfer. \bibleverse{25} Da
...
Blut an den Boden des Brandopferaltars gießen. \bibleverse{26} Aber
...
\hypertarget{opfer-bei-versuxfcndigung-eines-gewuxf6hnlichen-israeliten}{%
...
sie nicht tun sollte, und sich also verschuldet, \bibleverse{28} und
ihrer Sünde innewird, die sie getan hat, die soll zum Opfer eine Ziege
bringen ohne Fehl für die Sünde, die sie getan hat, \bibleverse{29} und
soll ihre Hand auf des Sündopfers Haupt legen und es schlachten an der
Stätte des Brandopfers. \bibleverse{30} Und der Priester soll von dem
...
\bibleverse{31} All sein Fett aber soll er abreißen, wie er das Fett des
...
\bibleverse{8} und bringe sie dem Priester. Der soll die erste zum
Sündopfer machen und ihr den Kopf abkneipen hinter dem Genick, und nicht
abbrechen; \bibleverse{9} und sprenge mit dem Blut des Sündopfers an die
Seite des Altars und lasse das übrige Blut ausbluten an des Altars
Boden. Das ist das Sündopfer. \bibleverse{10} Die andere aber soll er
...
Altar zum Feuer dem HErrn. Das ist ein Sündopfer. \bibleverse{13} Und
...
\hypertarget{vorschriften-in-betreff-der-schuldopfer-bei-veruntreuung-heiliger-abgaben}{%
...
\bibleverse{14} Und der HErr redete mit Mose und sprach: \bibleverse{15}
...
sei nach dem Lot des Heiligtums, zum Schuldopfer. \bibleverse{16} Dazu
...
verschuldet und ist einer Missetat schuldig \bibleverse{18} und soll
...
wusste es nicht, so wird's ihm vergeben. \bibleverse{19} Das ist das
Schuldopfer; verschuldet hat er sich an dem HErrn. \footnote{\textbf{5:19}
  Jes 53,10}

\bibleverse{20} Und der HErr redete mit Mose und sprach: \bibleverse{21}
...
Unrecht an sich gebracht, \bibleverse{22} oder wenn er, was verloren
...
bringen, der eines Schuldopfers wert ist. \footnote{\textbf{5:25} 3Mo
  5,15} \bibleverse{26} So soll ihn der Priester versöhnen vor dem
HErrn, so wird ihm vergeben alles, was er getan hat, daran er sich
verschuldet hat.

\hypertarget{vorschriften-fuxfcr-die-priester-betreffend-des-tuxe4glichen-brandopfers}{%
...
darauf erhalten werden. \footnote{\textbf{6:2} 3Mo 1,1} \bibleverse{3}
...
schütten, \footnote{\textbf{6:3} 2Mo 28,42} \bibleverse{4} und soll
...
Asche hinaustragen aus dem Lager an eine reine Stätte. \footnote{\textbf{6:4}
  3Mo 4,12} \bibleverse{5} Das Feuer auf dem Altar soll brennen und
...
darauf anzünden. \bibleverse{6} Ewig soll das Feuer auf dem Altar
...
\bibleverse{7} Und das ist das Gesetz des Speisopfers, das Aarons Söhne
opfern sollen vor dem HErrn auf dem Altar. \bibleverse{8} Es soll einer
...
dem Altar zum süßen Geruch, ein Gedächtnis dem HErrn. \bibleverse{9} Das
...
\bibleverse{10} Sie sollen's nicht mit Sauerteig backen; denn es ist ihr
...
\bibleverse{11} Was männlich ist unter den Kindern Aarons, die sollen's
essen. Das sei ein ewiges Recht euren Nachkommen an den Opfern des
HErrn: es soll sie niemand anrühren, er sei denn geweiht.

\hypertarget{vorschriften-betreffend-des-speisopfers-des-hohenpriesters}{%
...
Abends. \bibleverse{14} In der Pfanne mit Öl sollst du es machen und
geröstet darbringen; und in Stücken gebacken sollst du solches opfern
zum süßen Geruch dem HErrn. \bibleverse{15} Und der Priester, der unter
...
\bibleverse{1} Und dies ist das Gesetz des Schuldopfers. Ein
Hochheiliges ist es. \bibleverse{2} An der Stätte, da man das Brandopfer
...
\bibleverse{3} Und all sein Fett soll man opfern, den Schwanz und das
Fett, welches das Eingeweide bedeckt, \bibleverse{4} die zwei Nieren mit
dem Fett, das daran ist, an den Lenden, und das Netz über der Leber, an
den Nieren abgerissen. \bibleverse{5} Und der Priester soll's auf dem
Altar anzünden zum Feuer dem HErrn. Das ist ein Schuldopfer.
\bibleverse{6} Was männlich ist unter den Priestern, die sollen das
...
\bibleverse{8} Welcher Priester jemandes Brandopfer opfert, des soll des
Brandopfers Fell sein, das er geopfert hat. \footnote{\textbf{7:8} 3Mo
  1,6} \bibleverse{9} Und alles Speisopfer, das im Ofen oder auf dem
Rost oder in der Pfanne gebacken ist, soll dem Priester gehören, der es
opfert. \footnote{\textbf{7:9} 3Mo 2,4-5; 3Mo 2,7} \bibleverse{10} Und
...
HErrn opfert. \footnote{\textbf{7:11} 3Mo 3,-1} \bibleverse{12} Wollen
...
\bibleverse{13} Sie sollen aber solches Opfer tun auf Kuchen von
gesäuertem Brot mit ihrem Lob- und Dankopfer, \bibleverse{14} und sollen
einen von den allen dem HErrn zur Hebe opfern, und es soll dem Priester
gehören, der das Blut des Dankopfers sprengt. \bibleverse{15} Und das
...
Volk. \bibleverse{21} Und wenn eine Seele etwas Unreines anrührt, es sei
...
Ochsen, Lämmern und Ziegen. \bibleverse{24} Aber das Fett vom Aas, und
was vom Wild zerrissen ist, macht euch zu allerlei Nutz; aber essen
sollt ihr's nicht. \footnote{\textbf{7:24} 2Mo 22,30} \bibleverse{25}
Denn wer das Fett isst von dem Vieh, davon man dem HErrn Opfer bringt,
dieselbe Seele soll ausgerottet werden von ihrem Volk. \bibleverse{26}
Ihr sollt auch kein Blut essen, weder vom Vieh noch von Vögeln, überall,
wo ihr wohnt. \bibleverse{27} Welche Seele würde irgendein Blut essen,
die soll ausgerottet werden von ihrem Volk.

\hypertarget{bestimmungen-uxfcber-die-opferanteile-der-priester-bei-den-heilsopfern}{%
...
\bibleverse{28} Und der HErr redete mit Mose und sprach: \bibleverse{29}
...
\bibleverse{30} Er soll's aber mit seiner Hand herzubringen zum Opfer
...
\bibleverse{31} Und der Priester soll das Fett anzünden auf dem Altar,
aber die Brust soll Aarons und seiner Söhne sein. \bibleverse{32} Und
die rechte Schulter sollen sie dem Priester geben zur Hebe von ihren
Dankopfern. \bibleverse{33} Und welcher unter Aarons Söhnen das Blut der
Dankopfer opfert und das Fett, des soll die rechte Schulter sein zu
seinem Teil. \bibleverse{34} Denn die Webebrust und die Hebeschulter
...
sein dem HErrn, \bibleverse{36} die der HErr gebot am Tage, da er sie
salbte, dass sie ihnen gegeben werden sollte von den Kindern Israel, zum
ewigen Recht allen ihren Nachkommen. \bibleverse{37} Dies ist das Gesetz
...
\bibleverse{38} das der HErr dem Mose gebot auf dem Berge Sinai des
...
ungesäuertem Brot, \bibleverse{3} und versammle die ganze Gemeinde vor
die Tür der Hütte des Stifts.

\bibleverse{4} Mose tat, wie ihm der HErr gebot, und versammelte die
Gemeinde vor die Tür der Hütte des Stifts \bibleverse{5} und sprach zu
...
\bibleverse{6} Und nahm Aaron und seine Söhne und wusch sie mit Wasser
\bibleverse{7} und legte ihm den leinenen Rock an und gürtete ihn mit
dem Gürtel und zog ihm den Purpurrock an und tat ihm den Leibrock an und
Gürtete ihn über den Leibrock her \bibleverse{8} und tat ihm das
...
Krone, wie der HErr dem Mose geboten hatte. \footnote{\textbf{8:9} 2Mo
  28,36; 2Mo 39,30} \bibleverse{10} Und Mose nahm das Salböl und salbte
...
\hypertarget{das-brandopfer}{%
\subsection{Das Brandopfer}\label{das-brandopfer}}

\bibleverse{18} Und brachte herzu einen Widder zum Brandopfer. Und Aaron
und seine Söhne legten ihre Hände auf sein Haupt. \footnote{\textbf{8:18}
  3Mo 1,10-13} \bibleverse{19} Da schlachtete er ihn. Und Mose sprengte
das Blut auf den Altar umher, \bibleverse{20} zerhieb den Widder in
Stücke und zündete an das Haupt, die Stücke und das Fett \bibleverse{21}
...
\bibleverse{22} Er brachte auch herzu den anderen Widder des Füllopfers.
Und Aaron und seine Söhne legten ihre Hände auf sein Haupt.
\bibleverse{23} Da schlachtete er ihn. Und Mose nahm von seinem Blut und
...
\bibleverse{24} Und brachte herzu Aarons Söhne und tat von dem Blut auf
...
Altar umher. \bibleverse{25} Und nahm das Fett und den Schwanz und alles
Fett am Eingeweide und das Netz über der Leber, die zwei Nieren mit dem
Fett daran und die rechte Schulter; \bibleverse{26} dazu nahm er von dem
...
und auf die rechte Schulter. \bibleverse{27} Und gab das allesamt auf
die Hände Aarons und seiner Söhne und webte es zum Webeopfer vor dem
HErrn. \bibleverse{28} Und nahm alles wieder von ihren Händen und
zündete es an auf dem Altar oben auf dem Brandopfer. Ein Füllopfer war
es zum süßen Geruch, ein Feuer dem HErrn. \bibleverse{29} Und Mose nahm
...
hatte. \bibleverse{30} Und Mose nahm von dem Salböl und dem Blut auf dem
...
\hypertarget{vorschriften-betreffend-des-opfermahles-und-der-siebentuxe4gigen-absonderung}{%
...
versöhnt seid. \bibleverse{35} Und sollt vor der Tür der Hütte des
...
\bibleverse{36} Und Aaron und seine Söhne taten alles, was der HErr
...
\bibleverse{1} Und am achten Tage rief Mose Aaron und seine Söhne und
die Ältesten in Israel \footnote{\textbf{9:1} 3Mo 8,33} \bibleverse{2}
...
HErrn. \bibleverse{6} Da sprach Mose: Das ist's, was der HErr geboten
hat, dass ihr es tun sollt, so wird euch des HErrn Herrlichkeit
erscheinen. \bibleverse{7} Und Mose sprach zu Aaron: Tritt zum Altar und
...
er an auf dem Altar, wie der HErr dem Mose geboten hatte. \footnote{\textbf{9:10}
  3Mo 4,8-12} \bibleverse{11} Und das Fleisch und das Fell verbrannte er
mit Feuer draußen vor dem Lager. \bibleverse{12} Darnach schlachtete er
das Brandopfer; und Aarons Söhne brachten das Blut zu ihm, und er
sprengte es auf den Altar umher. \bibleverse{13} Und sie brachten das
Brandopfer zu ihm zerstückt und den Kopf; und er zündete es an auf dem
Altar. \bibleverse{14} Und er wusch das Eingeweide und die Schenkel und
...
\bibleverse{15} Darnach brachte er herzu des Volks Opfer und nahm den
...
\hypertarget{zwiefache-segnung-des-volkes-erscheinen-der-herrlichkeit-des-herrn-das-feuer-gottes-verzehrt-die-opfer-aarons}{%
...
\bibleverse{22} Und Aaron hob seine Hand auf zum Volk und segnete sie;
und er stieg herab, da er das Sündopfer, Brandopfer und Dankopfer
gemacht hatte. \footnote{\textbf{9:22} 4Mo 22,1-27} \bibleverse{23} Und
...
HErrn allem Volk. \footnote{\textbf{9:23} 2Mo 40,34} \bibleverse{24} Und
...
hatte. \bibleverse{2} Da fuhr ein Feuer aus von dem HErrn und verzehrte
sie, dass sie starben vor dem HErrn. \footnote{\textbf{10:2} 4Mo 16,35;
  2Chr 26,16-20}

\bibleverse{3} Da sprach Mose zu Aaron: Das ist's, was der HErr gesagt
...
\hypertarget{vorschriften-fuxfcr-die-priester-betreffs-ausuxfcbung-von-trauergebruxe4uchen}{%
...
Brand, den der HErr getan hat. \bibleverse{7} Ihr aber sollt nicht
...
\bibleverse{8} Der HErr aber redete mit Aaron und sprach: \bibleverse{9}
...
sterbet. Das sei ein ewiges Recht allen euren Nachkommen, \footnote{\textbf{10:9}
  Hes 44,21; 1Tim 3,3; Tit 1,7} \bibleverse{10} auf dass ihr könnt
unterscheiden, was heilig und unheilig, was unrein und rein ist,
\bibleverse{11} und dass ihr die Kinder Israel lehret alle Rechte, die
...
Altar; denn es ist ein Hochheiliges. \bibleverse{13} Ihr sollt's aber an
heiliger Stätte essen; denn das ist dein Recht und deiner Söhne Recht an
den Opfern des HErrn; denn so ist's mir geboten. \bibleverse{14} Aber
...
deinen Kindern gegeben an den Dankopfern der Kinder Israel. \footnote{\textbf{10:14}
  3Mo 7,34} \bibleverse{15} Denn die Hebeschulter und die Webebrust soll
...
\bibleverse{1} Und der HErr redete mit Mose und Aaron und sprach zu
ihnen: \bibleverse{2} Redet mit den Kindern Israel und sprecht: Das sind
die Tiere, die ihr essen sollt unter allen Tieren auf Erden. \footnote{\textbf{11:2}
  1Mo 7,2; Apg 10,14-15; Kol 2,16; 1Tim 4,4} \bibleverse{3} Alles, was
...
\bibleverse{43} Macht eure Seelen nicht zum Scheusal und verunreinigt
euch nicht an ihnen, dass ihr euch besudelt. \bibleverse{44} Denn ich
...
irgendeinem kriechenden Tier, das auf Erden schleicht. \bibleverse{45}
...
ihre Krankheit leidet. \bibleverse{3} Und am achten Tage soll man das
Fleisch seiner Vorhaut beschneiden. \footnote{\textbf{12:3} 1Mo
  17,11-12; Joh 7,22; Lk 2,21} \bibleverse{4} Und sie soll daheimbleiben
...
aus sind. \bibleverse{5} Gebiert sie aber ein Mägdlein, so soll sie zwei
...
\footnote{\textbf{13:1} 5Mo 24,8} \bibleverse{2} Wenn einem Menschen an
...
Priestern. \bibleverse{3} Und wenn der Priester das Mal an der Haut des
...
urteilen. \footnote{\textbf{13:3} 3Mo 14,37} \bibleverse{4} Wenn aber
...
Tage \bibleverse{5} und am siebenten Tage besehen. Ist's, dass das Mal
bleibt, wie er's zuvor gesehen hat, und hat nicht weitergefressen an der
Haut, \bibleverse{6} so soll ihn der Priester abermals sieben Tage
...
soll seine Kleider waschen, so ist er rein. \bibleverse{7} Wenn aber der
...
\bibleverse{8} wenn dann da der Priester sieht, dass der Grind
...
\hypertarget{ungefuxe4hrlicher-ausschlag-aussatz-der-kahlkuxf6pfe}{%
...
mit dem Log Öl; und soll solches vor dem HErrn weben \bibleverse{13} und
...
\bibleverse{14} Und der Priester soll von dem Blut nehmen vom
...
Fußes. \footnote{\textbf{14:14} 3Mo 8,23} \bibleverse{15} Darnach soll
er von dem Log Öl nehmen und es in seine, des Priesters, linke Hand
gießen \bibleverse{16} und mit seinem rechten Finger in das Öl tauchen,
das in seiner linken Hand ist, und sprengen vom Öl mit seinem Finger
siebenmal vor dem HErrn. \bibleverse{17} Vom übrigen Öl aber in seiner
...
auf das Blut des Schuldopfers. \bibleverse{18} Das übrige Öl aber in
...
das Log Öl und soll's alles weben vor dem HErrn \bibleverse{25} und das
...
HErrn. \bibleverse{28} Von dem Übrigen aber in seiner Hand soll er dem
...
oben auf das Blut des Schuldopfers. \bibleverse{29} Das übrige Öl aber
in seiner Hand soll er dem Gereinigten auf das Haupt tun, ihn zu
versöhnen vor dem HErrn; \bibleverse{30} und darnach aus der einen
...
\bibleverse{33} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{34} Wenn ihr in das Land Kanaan kommt, das ich euch zur
Besitzung gebe, und ich werde irgend in einem Hause eurer Besitzung ein
Aussatzmal geben, \bibleverse{35} so soll der kommen, des das Haus ist,
...
\bibleverse{1} Und der HErr redete mit Mose und Aaron und sprach:
\bibleverse{2} Redet mit den Kindern Israel und sprecht zu ihnen: Wenn
ein Mann an seinem Fleisch einen Fluss hat, derselbe ist unrein.
\footnote{\textbf{15:2} 4Mo 5,2} \bibleverse{3} Dann aber ist er unrein
...
\bibleverse{15} Und der Priester soll aus einer ein Sündopfer, aus der
...
\bibleverse{1} Und der HErr redete mit Mose, nachdem die zwei Söhne
Aarons gestorben waren, da sie vor dem HErrn opferten, \footnote{\textbf{16:1}
  3Mo 10,1-2} \bibleverse{2} und sprach: Sage deinem Bruder Aaron, dass
...
\hypertarget{die-suxfchnegebruxe4uche}{%
...
\bibleverse{7} und darnach die zwei Böcke nehmen und vor den HErrn
stellen vor der Tür der Hütte des Stifts, \bibleverse{8} und soll das
Los werfen über die zwei Böcke: ein Los dem HErrn und das andere dem
Asasel. \bibleverse{9} Und soll den Bock, auf welchen des HErrn Los
fällt, opfern zum Sündopfer. \bibleverse{10} Aber den Bock, auf welchen
...
hinter den Vorhang bringen \bibleverse{13} und das Räuchwerk aufs Feuer
tun vor dem HErrn, dass der Nebel vom Räuchwerk den Gnadenstuhl bedecke,
der auf dem Zeugnis ist, dass er nicht sterbe. \bibleverse{14} Und soll
...
\footnote{\textbf{16:18} 2Mo 30,10} \bibleverse{19} und soll mit seinem
...
HErrn. \footnote{\textbf{16:30} Hebr 10,3} \bibleverse{31} Darum soll's
euch ein großer Sabbat sein, und ihr sollt euren Leib kasteien. Ein
ewiges Recht sei das. \bibleverse{32} Es soll aber solche Versöhnung tun
...
heiligen Kleider, \bibleverse{33} und soll also versöhnen das heiligste
...
\bibleverse{3} Welcher aus dem Haus Israel einen Ochsen oder Lamm oder
Ziege schlachtet, in dem Lager oder draußen vor dem Lager,
\bibleverse{4} und es nicht vor die Tür der Hütte des Stifts bringt,
...
solcher Mensch soll ausgerottet werden aus seinem Volk. \bibleverse{5}
...
\bibleverse{6} Und der Priester soll das Blut auf den Altar des HErrn
sprengen vor der Tür der Hütte des Stifts und das Fett anzünden zum
süßen Geruch dem HErrn. \bibleverse{7} Und mitnichten sollen sie ihre
...
\hypertarget{behandlung-des-blutes-jagdbaren-wildes-und-des-fleisches-gefallener-oder-zerrissener-tiere}{%
...
Gott. \bibleverse{3} Ihr sollt nicht tun nach den Werken des Landes
...
nicht halten; \footnote{\textbf{18:3} 2Mo 23,24} \bibleverse{4} sondern
nach meinen Rechten sollt ihr tun, und meine Satzungen sollt ihr halten,
dass ihr darin wandelt; denn ich bin der HErr, euer Gott. \bibleverse{5}
...
\hypertarget{verbot-der-blutschande-aufzuxe4hlung-der-verbotenen-ehen}{%
...
\hypertarget{allerlei-vorschriften-auf-grund-der-zehn-gebote}{%
...
\bibleverse{5} Und wenn ihr dem HErrn wollt ein Dankopfer tun, so sollt
ihr es opfern, dass es ihm gefallen könne. \footnote{\textbf{19:5} 3Mo
  22,18-20} \bibleverse{6} Ihr sollt es desselben Tages essen, da ihr's
...
\bibleverse{7} Wird aber jemand am dritten Tage davon essen, so ist er
ein Gräuel und wird nicht angenehm sein. \bibleverse{8} Und der Esser
...
denn sie ist nicht frei gewesen. \bibleverse{21} Er soll aber für seine
Schuld dem HErrn vor die Tür der Hütte des Stifts einen Widder zum
Schuldopfer bringen; \bibleverse{22} und der Priester soll ihn versöhnen
...
sein, ein Preisopfer dem HErrn; \bibleverse{25} im fünften Jahr aber
...
Elle, mit Gewicht, mit Maß. \bibleverse{36} Rechte Waage, rechte Pfunde,
...
HErr, euer Gott. \footnote{\textbf{20:7} 3Mo 19,2} \bibleverse{8} Und
...
\bibleverse{1} Und der HErr sprach zu Mose: Sage den Priestern, Aarons
...
\bibleverse{2} außer an seinem Blutsfreunde, der ihm am nächsten
angehört, als: an seiner Mutter, an seinem Vater, an seinem Sohne, an
seiner Tochter, an seinem Bruder \bibleverse{3} und an seiner Schwester,
die noch eine Jungfrau und noch bei ihm ist und keines Mannes Weib
gewesen ist; an der mag er sich verunreinigen. \bibleverse{4} Sonst soll
...
seines Gottes opfere. \bibleverse{18} Denn keiner, an dem ein Fehl ist,
soll herzutreten; er sei blind, lahm, mit einer seltsamen Nase, mit
ungewöhnlichem Glied, \bibleverse{19} oder der an einem Fuß oder einer
Hand gebrechlich ist \bibleverse{20} oder höckerig ist oder ein Fell auf
dem Auge hat oder schielt oder den Grind oder Flechten hat oder der
gebrochen ist. \bibleverse{21} Welcher nun von Aarons, des Priesters,
...
seines Gottes nicht nahen, dass er es opfere. \bibleverse{22} Doch soll
er das Brot seines Gottes essen, von dem Heiligen und vom Hochheiligen.
\bibleverse{23} Aber zum Vorhang soll er nicht kommen noch zum Altar
...
heben, \bibleverse{16} auf dass sie nicht mit Missetat und Schuld
...
wollen, das ihm von euch angenehm sei --, \bibleverse{19} das soll ein
Männlein und ohne Fehl sein, von Rindern oder Lämmern oder Ziegen.
\bibleverse{20} Alles, was einen Fehl hat, sollt ihr nicht opfern; denn
es wird von euch nicht angenehm sein. \footnote{\textbf{22:20} 5Mo
  15,21; 5Mo 17,1; Mal 1,8} \bibleverse{21} Und wer ein Dankopfer dem
...
sei; es soll keinen Fehl haben. \bibleverse{22} Ist's blind oder
...
auf den Altar des HErrn. \bibleverse{23} Einen Ochsen oder Schaf, die zu
lange oder zu kurze Glieder haben, magst du von freiem Willen opfern;
aber angenehm mag's nicht sein zum Gelübde. \bibleverse{24} Du sollst
...
tun. \bibleverse{25} Du sollst auch solcher keins von eines Fremdlings
...
\bibleverse{26} Und der HErr redete mit Mose und sprach: \bibleverse{27}
...
HErrn opfern, so ist's angenehm. \bibleverse{28} Es sei ein Ochs oder
Schaf, so soll man's nicht mit seinem Jungen auf einen Tag schlachten.
\footnote{\textbf{22:28} 5Mo 22,6-7}

\bibleverse{29} Wenn ihr aber wollt dem HErrn ein Lobopfer tun, das von
euch angenehm sei, \bibleverse{30} so sollt ihr's desselben Tages essen
...
der HErr. \bibleverse{32} Dass ihr meinen heiligen Namen nicht
...
bin der HErr, der euch heiligt, \footnote{\textbf{22:32} 3Mo 22,9; 3Mo
  22,16} \bibleverse{33} der euch aus Ägyptenland geführt hat, dass ich
euer Gott wäre, ich, der HErr.

\hypertarget{gesetze-fuxfcr-die-feier-des-sabbats-und-der-jahresfeste}{%
...
\bibleverse{4} Dies sind aber die Feste des HErrn, die ihr heilige Feste
heißen sollt, da ihr zusammenkommt. \footnote{\textbf{23:4} 2Mo 23,14-19}
\bibleverse{5} Am 14. Tage des ersten Monats gegen Abend ist des HErrn
Passah. \footnote{\textbf{23:5} 2Mo 12,-1} \bibleverse{6} Und am 15.
desselben Monats ist das Fest der ungesäuerten Brote des HErrn; da sollt
ihr sieben Tage ungesäuertes Brot essen. \bibleverse{7} Der erste Tag
soll heilig unter euch heißen, da ihr zusammenkommt; da sollt ihr keine
Dienstarbeit tun. \bibleverse{8} Und sieben Tage sollt ihr dem HErrn
...
der Erstlinge eurer Ernte zu dem Priester bringen. \bibleverse{11} Da
...
\footnote{\textbf{23:11} Mt 28,1; 1Kor 15,20} \bibleverse{12} Und ihr
sollt des Tages, da eure Garbe gewebt wird, ein Brandopfer dem HErrn tun
von einem Lamm, das ohne Fehl und jährig sei, \bibleverse{13} samt dem
...
\bibleverse{14} Und sollt kein neues Brot noch geröstete oder frische
...
neues Speisopfer dem HErrn opfern, \bibleverse{17} und sollt's aus euren
Wohnungen opfern, nämlich zwei Webebrote von zwei Zehntel Semmelmehl,
gesäuert und gebacken, zu Erstlingen dem HErrn. \bibleverse{18} Und
...
Geruchs dem HErrn. \bibleverse{19} Dazu sollt ihr machen einen
Ziegenbock zum Sündopfer und zwei jährige Lämmer zum Dankopfer.
\bibleverse{20} Und der Priester soll's weben samt den Erstlingsbroten
vor dem HErrn; die sollen samt den zwei Lämmern dem HErrn heilig sein
und dem Priester gehören. \bibleverse{21} Und sollt diesen Tag ausrufen;
...
da ihr zusammenkommt; \bibleverse{25} da sollt ihr keine Dienstarbeit
...
\bibleverse{28} und sollt keine Arbeit tun an diesem Tage; denn es ist
der Versöhnungstag, dass ihr versöhnt werdet vor dem HErrn, eurem Gott.
\bibleverse{29} Denn wer seinen Leib nicht kasteit an diesem Tage, der
soll aus seinem Volk ausgerottet werden. \bibleverse{30} Und wer dieses
Tages irgendeine Arbeit tut, den will ich vertilgen aus seinem Volk.
\bibleverse{31} Darum sollt ihr keine Arbeit tun. Das soll ein ewiges
Recht sein euren Nachkommen in allen ihren Wohnungen. \bibleverse{32} Es
...
\bibleverse{33} Und der HErr redete mit Mose und sprach: \bibleverse{34}
...
\bibleverse{35} Der erste Tag soll heilig heißen, dass ihr
zusammenkommt; keine Dienstarbeit sollt ihr tun. \bibleverse{36} Sieben
...
\hypertarget{abschluuxdf-des-festkalenders}{%
\subsection{Abschluß des
Festkalenders}\label{abschluuxdf-des-festkalenders}}

\bibleverse{37} Das sind die Feste des HErrn, die ihr sollt für heilig
...
\bibleverse{38} außer was die Sabbate des HErrn und eure Gaben und
...
es auch Sabbat. \bibleverse{40} Und sollt am ersten Tage Früchte nehmen
...
\bibleverse{41} Und sollt also dem HErrn das Fest halten sieben Tage des
Jahres. Das soll ein ewiges Recht sein bei euren Nachkommen, dass sie im
siebenten Monat also feiern. \bibleverse{42} Sieben Tage sollt ihr in
Laubhütten wohnen; wer einheimisch ist in Israel, der soll in Laubhütten
wohnen, \bibleverse{43} dass eure Nachkommen wissen, wie ich die Kinder
...
Baumöl zur Leuchte, dass man täglich Lampen aufsetze \footnote{\textbf{24:2}
  2Mo 27,20} \bibleverse{3} außen vor dem Vorhang des Zeugnisses in der
...
\bibleverse{4} Er soll die Lampen auf dem feinen Leuchter zurichten vor
dem HErrn täglich.
...
\bibleverse{7} Und sollst auf dieselben legen reinen Weihrauch, dass er
sei bei den Broten zum Gedächtnis, ein Feuer dem HErrn. \bibleverse{8}
Alle Sabbate für und für soll er sie zurichten vor dem HErrn, von den
Kindern Israel zum ewigen Bund. \bibleverse{9} Und sie sollen Aarons und
...
\footnote{\textbf{24:12} 4Mo 15,34} \bibleverse{13} Und der HErr redete
mit Mose und sprach: \bibleverse{14} Führe den Flucher hinaus vor das
Lager und lass alle, die es gehört haben, ihre Hände auf sein Haupt
legen und lass ihn die ganze Gemeinde steinigen. \bibleverse{15} Und
sage den Kindern Israel: Welcher seinem Gott flucht, der soll seine
Sünde tragen. \bibleverse{16} Welcher des HErrn Namen lästert, der soll
...
\bibleverse{1} Und der HErr redete mit Mose auf dem Berge Sinai und
sprach: \bibleverse{2} Rede mit den Kindern Israel und sprich zu ihnen:
Wenn ihr in das Land kommt, das ich euch geben werde, so soll das Land
seinen Sabbat dem HErrn feiern, \bibleverse{3} dass du sechs Jahre dein
Feld besäest und sechs Jahre deinen Weinberg beschneidest und sammlest
die Früchte ein; \bibleverse{4} aber im siebenten Jahr soll das Land
seinen großen Sabbat dem HErrn feiern, darin du dein Feld nicht besäen
noch deinen Weinberg beschneiden sollst. \bibleverse{5} Was aber von
...
ein Sabbatjahr des Landes ist. \bibleverse{6} Aber was das Land während
...
\bibleverse{7} dein Vieh und die Tiere in deinem Lande; alle Früchte
sollen Speise sein.
...
\hypertarget{einluxf6sung-oder-ruxfcckfall-von-land--und-hausbesitz}{%
...
\bibleverse{1} Ihr sollt euch keinen Götzen machen noch Bild und sollt
...
nicht mehr gelten; denn ich bin der HErr, ihr Gott. \bibleverse{45} Und
...
\bibleverse{9} Ist's aber ein Vieh, das man dem HErrn opfern kann:
alles, was man davon dem HErrn gibt, ist heilig. \bibleverse{10} Man
...
so sollen sie beide dem HErrn heilig sein. \bibleverse{11} Ist aber das
Tier unrein, dass man's dem HErrn nicht opfern darf, so soll man's vor
den Priester stellen, \bibleverse{12} und der Priester soll's schätzen,
ob es gut oder böse sei; und es soll bei des Priesters Schätzung
bleiben. \bibleverse{13} Will's aber jemand lösen, der soll den Fünften
über die Schätzung geben.

\bibleverse{14} Wenn jemand sein Haus heiligt, dass es dem HErrn heilig
sei, das soll der Priester schätzen, ob's gut oder böse sei; und darnach
es der Priester schätzt, so soll's bleiben. \bibleverse{15} So es aber
...
\bibleverse{16} Wenn jemand ein Stück Acker von seinem Erbgut dem HErrn
heiligt, so soll es geschätzt werden nach der Aussaat. Ist die Aussaat
ein Homer Gerste, so soll es 50 Silberlinge gelten. \bibleverse{17}
Heiligt er seinen Acker vom Halljahr an, so soll er nach seinem Wert
gelten. \bibleverse{18} Hat er ihn aber nach dem Halljahr geheiligt, so
soll der Priester das Geld berechnen nach den übrigen Jahren zum
Halljahr und ihn darnach geringer schätzen. \bibleverse{19} Will aber
...
\bibleverse{20} Will er ihn aber nicht lösen, sondern verkauft ihn einem
anderen, so soll er ihn nicht mehr lösen können; \bibleverse{21} sondern
...
\bibleverse{22} Wenn aber jemand dem HErrn einen Acker heiligt, den er
gekauft hat und der nicht sein Erbgut ist, \bibleverse{23} so soll der
...
\bibleverse{24} Aber im Halljahr soll er wieder gelangen an den, von dem
er ihn gekauft hat, dass er sein Erbgut im Lande sei. \bibleverse{25}
...
\bibleverse{26} Die Erstgeburt unter dem Vieh, die dem HErrn ohnehin
gebührt, soll niemand dem HErrn heiligen, es sei ein Ochs oder Schaf;
denn es ist des HErrn. \footnote{\textbf{27:26} 2Mo 13,2}
\bibleverse{27} Ist es aber unreines Vieh, so soll man's lösen nach
...
\footnote{\textbf{27:30} 4Mo 18,21} \bibleverse{31} Will aber jemand
seinen Zehnten lösen, der soll den Fünften darübergeben. \bibleverse{32}
Und alle Zehnten von Rindern und Schafen, von allem, was unter dem
Hirtenstabe geht, das ist ein heiliger Zehnt dem HErrn. \bibleverse{33}
...
\bibleverse{34} Dies sind die Gebote, die der HErr dem Mose gebot an die
