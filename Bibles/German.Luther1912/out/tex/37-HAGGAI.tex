...
Josua, dem Sohn Jozadaks, dem Hohenpriester, und sprach: \footnote{\textbf{1:1}
  Esr 4,24; Esr 5,1-2} \bibverse{2} So spricht der HErr Zebaoth: Dieses
...
\bibverse{4} Aber eure Zeit ist da, dass ihr in getäfelten Häusern
wohnt, -- und dies Haus muss wüst stehen? \footnote{\textbf{1:4} 2Sam
  7,2} \bibverse{5} Nun, so spricht der HErr Zebaoth: Schauet, wie es
euch geht! \bibverse{6} Ihr säet viel, und bringet wenig ein; ihr esset,
...
über euch den Tau verhalten und das Erdreich sein Gewächs. \footnote{\textbf{1:10}
  1Kö 17,1} \bibverse{11} Und ich habe die Dürre gerufen über Land und
...
Jahr des Königs Darius. \# 2 \bibverse{1} Am einundzwanzigsten Tage des
siebenten Monats geschah des HErrn Wort durch den Propheten Haggai und
sprach: \bibverse{2} Sage zu Serubabel, dem Sohn Sealthiels, dem Fürsten
Judas, und zu Josua, dem Sohn Jozadaks, dem Hohenpriester, und zum
übrigen Volk und sprich: \bibverse{3} Wer ist unter euch übriggeblieben,
...
\bibverse{4} Und nun Serubabel, sei getrost! spricht der HErr; sei
...
spricht der HErr Zebaoth. \bibverse{5} Nach dem Wort, da ich mit euch
einen Bund machte, da ihr aus Ägypten zogt, soll mein Geist unter euch
bleiben. Fürchtet euch nicht! \bibverse{6} Denn so spricht der HErr
...
spricht der HErr Zebaoth. \bibverse{8} Denn mein ist Silber und Gold,
spricht der HErr Zebaoth. \bibverse{9} Es soll die Herrlichkeit dieses
...
\bibverse{14} Da antwortete Haggai und sprach: Ebenalso sind dies Volk
...
\bibverse{16} dass, wenn einer zum Kornhaufen kam, der zwanzig Maß haben
...
Eimer zu schöpfen, so waren kaum zwanzig da. \footnote{\textbf{2:16}
  Haggai 1,6} \bibverse{17} Denn ich plagte euch mit Dürre, Brandkorn
und Hagel in all eurer Arbeit; dennoch kehrtet ihr euch nicht zu mir,
spricht der HErr. \footnote{\textbf{2:17} Haggai 1,11} \bibverse{18} So
...
des HErrn gegründet ist; schauet darauf! \bibverse{19} Denn kein Same
...
durch des anderen Schwert. \bibverse{23} Zur selben Zeit, spricht der
