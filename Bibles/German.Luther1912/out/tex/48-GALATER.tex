...
\bibleverse{15} Da es aber Gott wohl gefiel, der mich von meiner Mutter
Leibe an hat ausgesondert und berufen durch seine Gnade, \footnote{\textbf{4:7}
  Röm 8,16-17} \bibleverse{16} dass er seinen Sohn offenbarte in mir,
...
Blut, \footnote{\textbf{1:16} Mt 16,17; Gal 2,7} \bibleverse{17} kam
...
Jerusalem mit Barnabas und nahm Titus auch mit mir. \footnote{\textbf{2:1}
  Apg 15,1-29; Apg 4,36} \bibleverse{2} Ich zog aber hinauf aus einer
...
\bibleverse{3} Aber es ward auch Titus nicht gezwungen, sich beschneiden
zu lassen, der mit mir war, obwohl er ein Grieche war. \bibleverse{4}
...
in Christo Jesu, dass sie uns gefangennähmen, \bibleverse{5} wichen wir
...
\bibleverse{7} sondern dagegen, da sie sahen, dass mir vertraut war das
Evangelium an die Heiden, gleichwie dem Petrus das Evangelium an die
Juden \footnote{\textbf{6:2} 2Kor 11,29} \bibleverse{8} (denn der mit
Petrus kräftig gewesen ist zum Apostelamt unter den Juden, der ist mit
mir auch kräftig gewesen unter den Heiden), \bibleverse{9} und da sie
...
unter die Juden gingen, \bibleverse{10} allein dass wir der Armen
...
durch den Glauben an Christum Jesum. \footnote{\textbf{3:26} Joh 1,12;
  Röm 8,17} \bibleverse{27} Denn wieviel euer auf Christum getauft sind,
die haben Christum angezogen. \textsuperscript{b} \bibleverse{28} Hier
...
\textsuperscript{c} \bibleverse{29} Seid ihr aber Christi, so seid ihr
...
getan, \footnote{\textbf{4:4} Mk 1,15; Eph 1,10} \bibleverse{5} auf dass
er die, die unter dem Gesetz waren, erlöste, dass wir die Kindschaft
empfingen. \bibleverse{6} Weil ihr denn Kinder seid, hat Gott gesandt
den Geist seines Sohnes in eure Herzen, der schreit: Abba, lieber Vater!
\bibleverse{7} Also ist nun hier kein Knecht mehr, sondern eitel Kinder;
...
Hagar; \textsuperscript{c} \bibleverse{25} denn Hagar heißt in Arabien
der Berg Sinai und kommt überein mit Jerusalem, das zu dieser Zeit ist
und dienstbar ist mit seinen Kindern. \bibleverse{26} Aber das
Jerusalem, das droben ist, das ist die Freie; die ist unser aller
Mutter. \bibleverse{27} Denn es steht geschrieben: „Sei fröhlich, du
...
Gesetz nicht. \textsuperscript{b} \bibleverse{24} Welche aber Christo
...
Christi erfüllen. \textsuperscript{b} \bibleverse{3} So aber jemand sich
...
\textsuperscript{c} \bibleverse{5} Denn ein jeglicher wird seine Last
