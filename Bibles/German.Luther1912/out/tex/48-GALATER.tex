...
\bibleverse{8} Aber so auch wir oder ein Engel vom Himmel euch würde
Evangelium predigen anders, denn das wir euch gepredigt haben, der sei
verflucht! \bibleverse{9} Wie wir jetzt gesagt haben, so sagen wir auch
...
nicht! \bibleverse{21} Darnach kam ich in die Länder Syrien und
Zilizien. \bibleverse{22} Ich war aber unbekannt von Angesicht den
christlichen Gemeinden in Judäa. \bibleverse{23} Sie hatten aber allein
gehört, dass, der uns vordem verfolgte, der predigt jetzt den Glauben,
welchen er vordem verstörte, \bibleverse{24} und priesen Gott über mir.
...
\bibleverse{1} Darnach über vierzehn Jahre zog ich abermals hinauf gen
...
\bibleverse{6} Gleichwie Abraham hat Gott geglaubt und es ist ihm
gerechnet zur Gerechtigkeit. \bibleverse{7} So erkennet ihr ja, dass,
die des Glaubens sind, das sind Abrahams Kinder. \bibleverse{8} Die
...
offenbart werden. \bibleverse{24} Also ist das Gesetz unser Zuchtmeister
...
\bibleverse{25} Nun aber der Glaube gekommen ist, sind wir nicht mehr
unter dem Zuchtmeister. \bibleverse{26} Denn ihr seid alle Gottes Kinder
durch den Glauben an Christum Jesum. \bibleverse{27} Denn wieviel euer
auf Christum getauft sind, die haben Christum angezogen. \bibleverse{28}
...
\bibleverse{29} Seid ihr aber Christi, so seid ihr ja Abrahams Same und
...
\bibleverse{31} So sind wir nun, liebe Brüder, nicht der Magd Kinder,
sondern der Freien.
...
Kreuzes aufgehört. \bibleverse{12} Wollte Gott, dass sie auch
...
sind widereinander, dass ihr nicht tut, was ihr wollt. \bibleverse{18}
Regiert euch aber der Geist, so seid ihr nicht unter dem Gesetz.
\bibleverse{19} Offenbar sind aber die Werke des Fleisches, als da sind:
Ehebruch, Hurerei, Unreinigkeit, Unzucht, \bibleverse{20} Abgötterei,
Zauberei, Feindschaft, Hader, Neid, Zorn, Zank, Zwietracht, Rotten,
Hass, Mord, \bibleverse{21} Saufen, Fressen und dergleichen, von welchen
...
wandeln. \bibleverse{26} Lasset uns nicht eitler Ehre geizig sein,
...
\bibleverse{5} Denn ein jeglicher wird seine Last tragen.
...
werden wir auch ernten ohne Aufhören. \bibleverse{10} Als wir denn nun
...
dem Kreuz Christi verfolgt werden. \bibleverse{13} Denn auch sie selbst,
...
Kreatur. \bibleverse{16} Und wie viele nach dieser Regel einhergehen,
