...
diesem Ort; \footnote{\textbf{1:4} 2Kö 23,5; Hos 10,5} \bibleverse{5}
...
\textsuperscript{b} \bibleverse{6} und die vom \textsc{Herrn} abfallen,
...
Schlachtopfer zubereitet und seine Gäste dazu geladen. \footnote{\textbf{1:7}
  Hab 2,20} \bibleverse{8} Und am Tage des Schlachtopfers des
\textsc{Herrn} will ich heimsuchen die Fürsten und des Königs Kinder und
alle, die ein fremdes Kleid tragen. \bibleverse{9} Auch will ich zur
...
werden die Starken alsdann bitterlich schreien. \footnote{\textbf{1:14}
  Joe 1,15} \bibleverse{15} Denn dieser Tag ist ein Tag des Grimmes, ein
...
des \textsc{Herrn} über euch komme. \bibleverse{3} Suchet den
...
\bibleverse{9} Wohlan, so wahr ich lebe! spricht der \textsc{Herr}
...
Namen trauen. \footnote{\textbf{3:12} Hes 6,8} \bibleverse{13} Die
...
mit Schall fröhlich sein. \textsuperscript{a} \bibleverse{18} Die
Geängsteten, die auf kein Fest kommen, will ich zusammenbringen; denn
sie gehören dir zu und müssen Schmach tragen. \bibleverse{19} Siehe, ich
...
\bibleverse{20} Zu der Zeit will ich euch hereinbringen und euch zu der
