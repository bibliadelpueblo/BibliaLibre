...
die sich auf Recht und Händel verstanden; \footnote{\textbf{1:13} 1Chr
  12,32} \bibleverse{14} die nächsten aber bei ihm waren Charsena,
...
Vormund war. \footnote{\textbf{2:20} Est 2,10} \bibleverse{21} Zur
...
trachteten, ihre Hände an den König Ahasveros zu legen. \bibleverse{22}
Das ward Mardochai kund, und er sagte es an der Königin Esther, und
Esther sagte es dem König in Mardochais Namen. \bibleverse{23} Und da
...
\bibleverse{8} Und Haman sprach zum König Ahasveros: Es ist ein Volk,
...
\bibleverse{9} Gefällt es dem König, so lasse er schreiben, dass man sie
...
zu legen. \footnote{\textbf{6:2} Est 2,21-23} \bibleverse{3} Und der
