...
\bibleverse{1} Dies ist der Ausspruch, das Wort des \textsc{Herrn} an
Israel, durch die Hand Maleachis: \bibleverse{2} Ich habe euch Liebe
erwiesen, spricht der \textsc{Herr}. So sprechet ihr: Womit hast du uns
Liebe erwiesen? \bibleverse{3} Ist nicht Esau Jakobs Bruder? spricht der
...
Wüste gegeben. \bibleverse{4} Wenn aber Edom spräche: ``Wir sind zwar
...
``das Volk, über das der \textsc{Herr} ewiglich zürnt''. \bibleverse{5}
Wenn eure Augen das sehen, so werdet ihr sagen: Der \textsc{Herr} sei
hochgepriesen über Israels Grenzen hinaus! \bibleverse{6} Ein Sohn soll
...
verächtlich macht. \bibleverse{7} Und fragt ihr: ``Womit haben wir
...
geringzuschätzen!'' \bibleverse{8} Und wenn ihr ein blindes Tier zum
...
\textsc{Herr} der Heerscharen. \bibleverse{9} Und nun besänftiget doch
...
\bibleverse{10} Es schließe doch lieber gleich jemand von euch die Türen
...
nicht! \bibleverse{11} Denn vom Aufgang der Sonne bis zu ihrem
...
mein Name unter den Heiden, spricht der \textsc{Herr} der Heerscharen.
\bibleverse{12} Ihr aber entheiligt ihn damit, daß ihr sagt: ``Der Tisch
des Herrn darf verunreinigt werden, und die Speise, die von ihm kommt,
ist geringzuschätzen!'' \bibleverse{13} Und ihr sprecht: ``Siehe, ist es
...
wohlgefällig annehmen? spricht der Herr. \bibleverse{14} Nein, verflucht
...
\bibleverse{2} Wenn ihr nicht hören wollt und es euch nicht von Herzen
...
denn ihr nehmt es nicht zu Herzen! \bibleverse{3} Siehe, ich schelte
euch die Saat und will euch Kot ins Angesicht streuen, den Kot eurer
Feste, und man wird euch zu ihm hintragen; \bibleverse{4} und ihr sollt
erfahren, daß ich euch diesen Befehl gesandt habe, auf daß mein Bund mit
Levi bestehe, spricht der \textsc{Herr} der Heerscharen. \bibleverse{5}
...
vor meinem Namen. \bibleverse{6} Das Gesetz der Wahrheit war in seinem
...
Umkehr von der Missetat. \bibleverse{7} Denn des Priesters Lippen sollen
...
\bibleverse{8} Ihr aber seid vom Wege abgewichen, ihr seid schuld, daß
viele am Gesetz Anstoß genommen haben, ihr habt den Bund mit Levi
mißbraucht, spricht der \textsc{Herr} der Heerscharen. \bibleverse{9}
...
die Person ansehet. \bibleverse{10} Haben wir nicht alle einen Vater?
Hat uns nicht ein Gott erschaffen? Warum sind wir denn so treulos, einer
gegen den andern, und entweihen den Bund unsrer Väter? \bibleverse{11}
...
\bibleverse{12} Der \textsc{Herr} wolle dem Manne, der solches tut,
Zeugen und Verteidiger ausrotten aus den Zelten Jakobs, und jeden, der
dem \textsc{Herrn} der Heerscharen Speisopfer darbringt! \bibleverse{13}
...
Händen annehmen mag. \bibleverse{14} Und ihr fragt: ``Warum?'' Weil der
...
Weib deines Bundes ist! \bibleverse{15} Und hat er sie nicht eins
...
werde dem Weibe seiner Jugend untreu! \bibleverse{16} Denn ich hasse die
...
\bibleverse{17} Ihr habt den \textsc{Herrn} bemüht mit euren Reden; und
...
\bibleverse{1} Siehe, ich sende meinen Engel, der vor mir her den Weg
...
kommt, spricht der \textsc{Herr} der Heerscharen! \bibleverse{2} Wer
...
Lauge der Wäscher. \bibleverse{3} Er wird sitzen und schmelzen und das
...
in Gerechtigkeit; \bibleverse{4} und das Speisopfer von Juda und
Jerusalem wird dem \textsc{Herrn} wohlgefallen, wie in der grauen
Vorzeit und wie in den längst vergangenen Jahren. \bibleverse{5} Und ich
...
\textsc{Herr} der Heerscharen. \bibleverse{6} Denn ich, der
\textsc{Herr}, verändere mich nicht, darum seid ihr, Kinder Jakobs,
nicht aufgerieben worden. \bibleverse{7} Seit den Tagen eurer Väter seid
...
\bibleverse{8} Soll ein Mensch Gott berauben, wie ihr mich beraubet?
Aber ihr fragt: ``Wessen haben wir dich beraubt?'' Der Zehnten und der
Abgaben! \bibleverse{9} Mit dem Fluch seid ihr belegt worden, denn mich
habt ihr betrogen, ihr, das ganze Volk! \bibleverse{10} Bringet aber den
...
Fülle herabschütten werde! \bibleverse{11} Und ich will für euch den
...
\textsc{Herr} der Heerscharen. \bibleverse{12} Also werden alle Nationen
euch selig preisen; denn ihr werdet ein Land der Wonne werden, spricht
der \textsc{Herr} der Heerscharen. \bibleverse{13} Ihr habt harte Worte
wider mich ausgestoßen, spricht der \textsc{Herr}. Und ihr fragt noch:
``Was haben wir untereinander wider dich geredet?'' \bibleverse{14} Ihr
habt gesagt: ``Es ist umsonst, daß man Gott dient, und was nützt es uns,
seine Ordnung zu halten und vor dem \textsc{Herrn} der Heerscharen in
Trauer einherzugehen? \bibleverse{15} Und nun preisen wir die
Übermütigen selig; denn die Uebeltäter stehen aufrecht und die, welche
Gott versucht haben, kommen davon!'' \bibleverse{16} Da besprachen sich
...
\bibleverse{17} Und sie werden von mir, spricht der \textsc{Herr} der
...
schont, der ihm dient. \bibleverse{18} Da werdet ihr wiederum sehen, was
...
\bibleverse{1} Denn siehe, der Tag kommt, brennend wie ein Ofen! Da
...
übrigbleibt. \bibleverse{2} Euch aber, die ihr meinen Namen fürchtet,
...
Stall! \bibleverse{3} Und ihr werdet die Gottlosen zertreten; denn sie
werden wie Asche sein unter euren Fußsohlen am Tage, da ich handle,
spricht der \textsc{Herr} der Heerscharen. \bibleverse{4} Seid eingedenk
des Gesetzes Moses, meines Knechtes, das ich ihm auf dem Horeb für ganz
Israel befohlen habe, der Pflichten und der Rechte! \bibleverse{5}
Siehe, ich sende euch den Propheten Elia, ehe denn da komme der große
und furchtbare Tag des \textsc{Herrn}; \bibleverse{6} der soll das Herz
