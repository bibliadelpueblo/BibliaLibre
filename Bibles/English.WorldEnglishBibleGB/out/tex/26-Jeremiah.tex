...
God,\footnote{2:17 The Hebrew word rendered ``God'' is ``אֱלֹהִ֑ים''
  (Elohim).} when he led you by the way? \bibverse{18} Now what do you
...
i.e., the Euphrates River \bibverse{19} ``Your own wickedness will
...
Armies. \bibverse{20} ``For long ago I broke off your yoke, and burst
...
name Pashhur, but Magormissabib.\footnote{20:3 ``Magormissabib'' means
  ``surrounded by terror''} \bibverse{4} For the LORD says, `Behold, I
...
them captive to Babylon, and will kill them with the sword. \bibverse{5}
