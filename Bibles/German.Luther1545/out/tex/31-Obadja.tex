...
deinem Herzen: Wer will mich zu Boden stoßen? \bibverse{4} Wenn du denn
...
der HErr. \bibverse{5} Wenn Diebe oder Verstörer zu Nacht über dich
...
Nachlesen überbleiben lassen. \bibverse{6} Wie sollen sie den Esau
ausforschen und seine Schätze suchen! \bibverse{7} Alle deine eigenen
...
Brot essen, werden dich verraten, ehe du es merken wirst. \bibverse{8}
Was gilt's? spricht der HErr, ich will zur selbigen Zeit die Weisen zu
Edom zunichte machen und die Klugheit auf dem Gebirge Esau. \bibverse{9}
Denn deine Starken zu Theman sollen zagen, auf daß sie alle auf dem
Gebirge Esau durch den Mord ausgerottet werden \bibverse{10} um des
Frevels willen, an deinem Bruder Jakob begangen. \bibverse{11} Zu der
...
du zu allen Schanden werden und ewiglich ausgerottet sein. \bibverse{12}
...
Zeit ihrer Angst. \bibverse{13} Du sollst nicht zum Tor meines Volks
...
schicken zur Zeit seines Jammers; \bibverse{14} du sollst nicht stehen
an den Wegscheiden, seine Entronnenen zu morden; du sollst seine Übrigen
nicht verraten zur Zeit der Angst. \bibverse{15} Denn der Tag des HErrn
...
\bibverse{16} Denn wie ihr auf meinem heiligen Berge getrunken habt, so
sollen alle Heiden täglich trinken; ja, sie sollen's aussaufen und
verschlingen, daß es sei, als wäre nie nichts dagewesen. \bibverse{17}
...
\bibverse{18} Und das Haus Jakob soll ein Feuer werden und das Haus
...
geredet. \bibverse{19} Und die gegen Mittag werden das Gebirge Esau und
...
\bibverse{20} Und die Vertriebenen dieses Heers der Kinder Israel, so
...
besitzen. \bibverse{21} Und werden Heilande heraufkommen auf den Berg
